(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function i(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=i(r);fetch(r.href,n)}})();const h="/api",gt="portal_sesion",Mt="portal_carrito",dt=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],lt=document.getElementById("app"),s={sesion:null,data:null,carrito:[],tab:localStorage.getItem("pc_active_tab")||"tienda",filtroCat:"",busqueda:"",modoCompartir:!1,compartirSeleccion:[]},O=t=>parseFloat(t)||0,w=t=>"$"+Math.round(t).toLocaleString("es-MX"),f=t=>String(t??"").replace(/"/g,"&quot;").replace(/</g,"&lt;"),xt=t=>{try{const e=new URL(String(t??""),window.location.origin);return e.protocol==="http:"||e.protocol==="https:"?e.href:""}catch{return""}};function A(){var e;const t=(e=s.sesion)==null?void 0:e.token;return t?{"Content-Type":"application/json",Authorization:"Bearer "+t}:{"Content-Type":"application/json"}}function yt(t){return t&&t.status===401?(Tt(),!0):!1}function Bt(){var t;try{s.sesion=JSON.parse(localStorage.getItem(gt)||"null")}catch{s.sesion=null}try{s.carrito=JSON.parse(localStorage.getItem(Mt)||"[]")}catch{s.carrito=[]}(t=s.sesion)!=null&&t.cliente_id?Lt():ot()}let tt="telefono",V="pedir",K={};function ot(){const t=tt==="telefono",e=V==="codigo"?`
    ...
    </div>`,V==="pedir"){const i=document.getElementById("l-send");i&&(i.onclick=mt);const o=document.getElementById("l-dato");o&&o.addEventListener("keydown",r=>{r.key==="Enter"&&mt()})}else{const i=document.getElementById("l-verify");i&&(i.onclick=$t);const o=document.getElementById("l-codigo");o&&o.addEventListener("keydown",r=>{r.key==="Enter"&&$t()}),document.getElementById("l-resend").onclick=r=>{r.preventDefault(),mt()},document.getElementById("l-back").onclick=r=>{r.preventDefault(),V="pedir",ot()}}document.getElementById("l-demo").onclick=i=>{i.preventDefault(),Ht()},Ot()}window.__loginMetodo=t=>{tt=t,V="pedir",ot()};async function Ot(){var t;try{window._seoConfig||(window._seoConfig=await fetch(h+"/seo/config").then(o=>o.json()).catch(()=>({})));const e=(t=window._seoConfig)==null?void 0:t.google_client_id;if(!e||(await Dt(),typeof google>"u"))return;google.accounts.id.initialize({client_id:e,callback:Nt,auto_select:!1});const i=document.getElementById("g-login-btn");i&&google.accounts.id.renderButton(i,{theme:"outline",size:"large",width:300,locale:"es_MX",text:"continue_with"})}catch{}}function Dt(){return new Promise(t=>{var i,o;if((o=(i=window.google)==null?void 0:i.accounts)!=null&&o.id)return t();const e=document.createElement("script");e.src="https://accounts.google.com/gsi/client",e.async=!0,e.defer=!0,e.onload=t,e.onerror=t,document.head.appendChild(e)})}async function Nt(t){const e=t==null?void 0:t.credential;if(!e)return T("Error al conectar con Google");try{const i=await fetch(h+"/portal/login/google",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id_token:e})}),o=await i.json();if(!i.ok||!o.token)return T(o.error||"No se pudo entrar con Google");vt(o)}catch{T("Error conectando con Google")}}function T(t){const e=document.getElementById("l-err");e&&(e.textContent=t,e.style.display="block")}function vt(t){s.sesion={nombre:t.cliente.nombre,cliente_id:t.cliente.id,tipo:t.cliente.tipo,token:t.token,demo:!!t.demo},localStorage.setItem(gt,JSON.stringify(s.sesion)),Lt()}async function mt(){T("");const t=(document.getElementById("l-dato").value||"").trim();if(!t)return T(tt==="telefono"?"Escribe tu teléfono":"Escribe tu correo");const e=document.getElementById("l-send");e.disabled=!0,e.textContent="Enviando...";try{const i=await fetch(h+"/portal/otp/solicitar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({metodo:tt,valor:t})}),o=await i.json();if(!i.ok){T(o.error||"No se pudo enviar el código"),e.disabled=!1,e.textContent="Enviarme un código";return}K={valor:t,destino:o.destino,canal:o.canal,enviado:o.enviado},V="codigo",ot()}catch{T("Error conectando con el servidor"),e.disabled=!1,e.textContent="Enviarme un código"}}async function $t(){T("");const t=(document.getElementById("l-codigo").value||"").replace(/\D/g,"");if(t.length<4)return T("Escribe el código que te enviamos");const e=document.getElementById("l-verify");e.disabled=!0,e.textContent="Entrando...";try{const i=await fetch(h+"/portal/otp/verificar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({metodo:tt,valor:K.valor,codigo:t})}),o=await i.json();if(!i.ok||!o.token){T(o.error||"Código incorrecto"),e.disabled=!1,e.textContent="Entrar";return}vt(o)}catch{T("Error conectando con el servidor"),e.disabled=!1,e.textContent="Entrar"}}async function Ht(){T("");try{const t=await fetch(h+"/portal/demo-login",{method:"POST",headers:{"Content-Type":"application/json"},body:"{}"}),e=await t.json();if(!t.ok||!e.token)return T(e.error==="Demo deshabilitado"?"Demo deshabilitado en el servidor (activa PORTAL_DEMO=1).":e.error||"No se pudo cargar el demo");vt(e)}catch{T("Error cargando demo")}}function Tt(){localStorage.removeItem(gt),s.sesion=null,ot()}async function Lt(){lt.innerHTML='<div class="spinner">Cargando catálogo…</div>';try{const[t,e,i,o]=await Promise.all([fetch(h+"/productos/").then(n=>n.json()),fetch(h+"/variantes/").then(n=>n.json()),fetch(h+"/inventario/").then(n=>n.json()).catch(()=>[]),fetch(h+"/portal/pedidos",{headers:A()}).then(n=>n.ok?n.json():[]).catch(()=>[])]),r={};(Array.isArray(i)?i:[]).forEach(n=>{r[n.variante_id]=(r[n.variante_id]||0)+(n.cantidad||0)}),s.data={productos:(Array.isArray(t)?t:[]).filter(n=>n.activo&&!/^oferta/i.test(n.nombre||"")&&!/^oferta/i.test(n.sku_interno||"")).map(n=>Rt(n)),variantes:Array.isArray(e)?e:[],stockPorVar:r};try{await Kt(o)}catch{}qt();try{const n=localStorage.getItem("pc_active_product_id");n&&It(n)}catch{}}catch{lt.innerHTML=`<div class="empty"><div class="ic">😕</div><p>No se pudo cargar. Reintenta.</p>
    ...
    ${q()}
    <div id="toast" class="toast"></div>`,J(s.tab||"tienda")}function q(){const t=[{id:"inicio",ic:"🏠",label:"Inicio"},{id:"tienda",ic:"👠",label:"Tienda"},{id:"catalogos",ic:"📖",label:"Catálogos"},{id:"carrito",ic:"🛒",label:"Carrito"},{id:"pedidos",ic:"🛍️",label:"Pedidos"},{id:"maya",ic:"💬",label:"Maya"}],e=et();return`<div class="bottomnav">${t.map(i=>`
    <button data-tab="${i.id}" class="${s.tab===i.id?"active":""}" onclick="window.__nav('${i.id}')">
      <span class="ic">${i.ic}${i.id==="carrito"&&e?`<span class="badge">${e}</span>`:""}</span>
      <span>${i.label}</span>
    </button>`).join("")}</div>`}window.__nav=J;function J(t,e){var r;if(!e&&s.tab&&s.tab!==t&&window._zmPushBack){const n=s.tab;window._zmPushBack(()=>J(n,!0))}s.tab=t;try{localStorage.setItem("pc_active_tab",t)}catch{}const i=document.querySelector(".bottomnav");i&&(i.outerHTML=q());const o=document.getElementById("tb-sub");o&&(o.textContent=(r=s.sesion)!=null&&r.nombre?`Hola, ${s.sesion.nombre.split(" ")[0]}`:""),t==="carrito"?Vt():_t(),t==="inicio"?Ft():t==="tienda"?at():t==="catalogos"?ae():t==="carrito"?W():t==="pedidos"?te():t==="maya"?ie():t==="cuenta"&&oe()}const B=()=>document.getElementById("page");async function Ft(){var i,o;const t=et(),e=ht();B().innerHTML=`
    ...
    <div class="chips" style="margin-bottom:12px;display:flex;align-items:center;flex-wrap:wrap;gap:6px">
      ...
      <button onclick="pcToggleModoCompartir()" style="margin-left:auto;padding:6px 12px;border-radius:100px;border:1px solid ${s.modoCompartir?"#25D366":"#d1d5db"};background:${s.modoCompartir?"#25D366":"#f3f4f6"};color:${s.modoCompartir?"white":"#374151"};font-weight:700;font-size:0.75rem;cursor:pointer;display:flex;align-items:center;gap:4px">📲 ${s.modoCompartir?"Modo Selección":"Compartir varios"}</button>
    </div>
    ...
    ${s.modoCompartir?s.compartirSeleccion.length===0?"":`
      ...
      </div>`}).join("")}}window.pcToggleModoCompartir=()=>{s.modoCompartir=!s.modoCompartir,s.modoCompartir||(s.compartirSeleccion=[]),at()};window.pcToggleSeleccionCompartir=t=>{const e=s.compartirSeleccion.indexOf(t);e>-1?s.compartirSeleccion.splice(e,1):s.compartirSeleccion.push(t),at()};window.pcCancelarSeleccionCompartir=()=>{s.modoCompartir=!1,s.compartirSeleccion=[],at()};window.pcCompartirVariosWhatsApp=async()=>{var i;const t=document.getElementById("pc-bulk-share-btn");if(!t)return;const e=t.innerHTML;t.innerHTML="⏳ Procesando...",t.disabled=!0;try{const o=s.data.productos.filter(a=>s.compartirSeleccion.includes(a.id));if(!o.length){alert("Selecciona al menos un producto.");return}const r=[];for(const a of o){const c=s.data.variantes.filter(l=>l.producto_id===a.id),d=a.imagen_principal||((i=c[0])==null?void 0:i.foto_url);if(d)try{const v=await(await fetch(d)).blob(),u=d.split(".").pop().split("?")[0]||"jpg",k=`Zapatillas_May_${a.nombre.split(" ")[0]}_${a.sku_interno||a.id}.${u}`;r.push(new File([v],k,{type:v.type}))}catch(l){console.error("No se pudo descargar imagen:",d,l)}}let n=`*Catálogo de Zapatillas May* 👠✨

`;if(o.forEach((a,c)=>{const d=a.nombre.split(" ")[0],l=a.sku_interno||"",v=a.precio_mayoreo3,u=a.precio_mayoreo6;n+=`*${c+1}. Modelo ${d}* (${l})
`,v&&(n+=`   💵 3-5 pares: ${w(v)} c/u
`),u&&(n+=`   🔥 6+ pares: ${w(u)} c/u
`),n+=`   🔗 Ver modelo: https://tienda-zapatillas-may.vercel.app/?p=${a.id}

`}),n+="¡Pide los tuyos por WhatsApp! 📲",navigator.share&&navigator.canShare&&navigator.canShare({files:r}))await navigator.share({files:r,title:"Modelos de Zapatillas May",text:n});else{const a=`https://wa.me/?text=${encodeURIComponent(n)}`;window.open(a,"_blank"),alert("Tu navegador no permite compartir archivos directamente. Se abrirá WhatsApp con los detalles y se descargarán las imágenes seleccionadas a tu dispositivo para que las subas.");for(let c=0;c<r.length;c++){const d=document.createElement("a");d.href=URL.createObjectURL(r[c]),d.download=r[c].name,document.body.appendChild(d),d.click(),document.body.removeChild(d),await new Promise(l=>setTimeout(l,400))}}}catch(o){alert("Error al compartir: "+o.message)}finally{t.innerHTML=e,t.disabled=!1,window.pcCancelarSeleccionCompartir()}};let S={productoId:null,color:null,modo:"variado"},z=1;window.__abrir=It;function Ut(t){const e=s.data.variantes.filter(o=>o.producto_id===t),i=[...new Set(e.map(o=>o.color).filter(Boolean))];return i.length?i.some(o=>Gt(t,o)):!1}function Gt(t,e){return it(t,e)>=1}function it(t,e){if(!e)return 0;const i=s.data.variantes.filter(n=>n.producto_id===t&&n.color===e);if(!i.length)return 0;const o=i.some(n=>n.talla&&(n.talla.includes(".5")||n.talla.includes("½")||n.talla.includes("/")));let r=0;for(let n=1;n<=6;n++)if(o){if(i.filter(d=>(s.data.stockPorVar[d.id]||0)>=n).length>=6){r=n;continue}let c=0;if(i.forEach(d=>{const l=s.data.stockPorVar[d.id]||0;c+=Math.min(l,2*n)}),c>=6*n)r=n;else break}else{let a=0;if(i.forEach(c=>{const d=s.data.stockPorVar[c.id]||0;a+=Math.min(d,2*n)}),a>=6*n)r=n;else break}return r}function zt(t,e,i){const o=s.data.variantes.filter(c=>c.producto_id===t&&c.color===e).sort((c,d)=>dt.indexOf(c.talla)-dt.indexOf(d.talla)),r=o.some(c=>c.talla&&(c.talla.includes(".5")||c.talla.includes("½")||c.talla.includes("/"))),n={};if(r){const c=o.filter(d=>(s.data.stockPorVar[d.id]||0)>=i);if(c.length>=6)return c.slice(0,6).forEach(d=>{n[d.id]=i}),n}let a=6*i;for(const c of o){const d=s.data.stockPorVar[c.id]||0,l=Math.min(d,2*i,a);if(l>0&&(n[c.id]=l,a-=l),a<=0)break}return n}function It(t){const e=s.data.productos.find(n=>n.id===t);if(!e)return;const i=s.data.variantes.filter(n=>n.producto_id===t),o=[...new Set(i.map(n=>n.color).filter(Boolean))];S={productoId:t,color:o[0]||null,modo:"variado"},z=1;const r=document.createElement("div");r.className="modal-overlay",r.id="pmodal",r.innerHTML=`
    <div class="modal">
      <div class="m-head">
      ...
      <div class="m-scroll">
        ...
        <div class="swatches" id="pm-swatches">
          ${o.map(n=>{var l;const a=i.filter(v=>v.color===n),c=a.map(v=>v.foto_url).find(Boolean),d=((l=a[0])==null?void 0:l.color_hex)||"#999";return`<div class="swatch ${n===S.color?"active":""}" data-color="${f(n)}" onclick="window.__pickColor('${f(n)}')">
    ...
    </div>`,document.body.appendChild(r),r.addEventListener("click",n=>{n.target===r&&history.back()}),window._zmPushBack&&window._zmPushBack(()=>{const n=document.getElementById("pmodal");n&&n.remove();try{localStorage.removeItem("pc_active_product_id")}catch{}});try{localStorage.setItem("pc_active_product_id",t)}catch{}S.color&&(jt(),nt())}function jt(){const t=document.getElementById("pm-mode");if(!t)return;const{productoId:e,color:i}=S,r=it(e,i)>=1,n=document.getElementById("pm-tier-corr");if(n&&(n.style.display=r?"":"none"),!r)S.modo==="corrida"&&(S.modo="variado"),t.innerHTML=`
      <button data-modo="variado" class="on" onclick="window.__modoModal('variado')">🧺 Surtido variado</button>
    `;else{const a=S.modo;t.innerHTML=`
    ...
    `}}window.__pickColor=t=>{S.color=t,z=1,document.querySelectorAll("#pm-swatches .swatch").forEach(r=>r.classList.toggle("active",r.dataset.color===t));const i=s.data.variantes.filter(r=>r.producto_id===S.productoId&&r.color===t).map(r=>r.foto_url).find(Boolean),o=document.getElementById("pm-img");o&&i&&(o.src=i),jt(),nt()};window.__modoModal=t=>{S.modo=t,z=1,document.querySelectorAll("#pm-mode button").forEach(e=>e.classList.toggle("on",e.dataset.modo===t)),nt()};function Xt(){const{productoId:t,color:e}=S;return s.data.variantes.filter(i=>i.producto_id===t&&i.color===e).sort((i,o)=>dt.indexOf(i.talla)-dt.indexOf(o.talla))}function nt(){const t=document.getElementById("pm-tallas");if(!t)return;const{color:e,modo:i,productoId:o}=S,r=s.data.productos.find(c=>c.id===o),n=Xt(),a=document.getElementById("pm-tallas-label");if(i==="corrida"){const c=it(o,e);z>c&&(z=Math.max(1,c)),a&&(a.textContent=`Corrida completa — ${e} · ${w(r.precio_corrida)} x par`),t.className="corrida-rows",t.innerHTML=`
    ...
    `}else a&&(a.textContent="Tallas — "+e),t.className="tallas",t.innerHTML=n.map(c=>{var v;const d=s.data.stockPorVar[c.id]||0,l=((v=s.carrito.find(u=>u.variante_id===c.id&&!u.es_corrida))==null?void 0:v.cantidad)||0;return`<button class="talla ${l?"on":""}" ${d<=0?"disabled":""} onclick="window.__addTalla('${c.id}')">
    ...
    `:t.innerHTML=`<button class="btn-primary" onclick="document.getElementById('pmodal').remove();window.__nav('carrito')">Listo · ver carrito</button>`)}window.__changeCorridaM=t=>{const{productoId:e,color:i}=S,o=it(e,i);z=Math.min(o,Math.max(1,z+t)),nt()};window.__agregarCorrida=()=>{const{productoId:t,color:e}=S,i=s.data.productos.find(a=>a.id===t),o=zt(t,e,z);let r=0;if(Object.entries(o).forEach(([a,c])=>{if(c<=0)return;const d=s.data.variantes.find(v=>v.id===a),l=s.carrito.find(v=>v.variante_id===a&&v.es_corrida);l?l.cantidad+=c:s.carrito.push({variante_id:a,producto_id:i.id,nombre:i.nombre,color:d.color,talla:d.talla,cantidad:c,es_corrida:!0,precio_menudeo:i.precio_menudeo,precio_mayoreo3:i.precio_mayoreo3,precio_mayoreo6:i.precio_mayoreo6,precio_corrida:i.precio_corrida,imagen:d.foto_url||i.imagen_principal||null,sku:i.sku_interno||null}),r+=c}),!r){I("Elige al menos una corrida");return}z=1,G(),document.getElementById("pmodal")?(history.back(),setTimeout(()=>J("carrito"),50)):J("carrito"),I("Corrida agregada · "+r+" pares")};window.__addTalla=t=>{const e=s.data.variantes.find(a=>a.id===t),i=s.data.productos.find(a=>a.id===e.producto_id),o=s.data.stockPorVar[t]||0,r=s.carrito.find(a=>a.variante_id===t&&!a.es_corrida);if(((r==null?void 0:r.cantidad)||0)>=o){I("Sin más stock ("+o+")");return}r?r.cantidad+=1:s.carrito.push({variante_id:t,producto_id:i.id,nombre:i.nombre,color:e.color,talla:e.talla,cantidad:1,es_corrida:!1,precio_menudeo:i.precio_menudeo,precio_mayoreo3:i.precio_mayoreo3,precio_mayoreo6:i.precio_mayoreo6,precio_corrida:i.precio_corrida,imagen:e.foto_url||i.imagen_principal||null,sku:i.sku_interno||null}),G(),nt(),document.querySelector(".bottomnav").outerHTML=q(),I("Agregado · "+et()+" pares")};function et(){return s.carrito.reduce((t,e)=>t+e.cantidad,0)}function bt(){return s.carrito.filter(t=>!t.es_corrida).reduce((t,e)=>t+e.cantidad,0)}function ft(t,e){return t.es_corrida?t.precio_corrida:e>=6?t.precio_mayoreo6:e>=3?t.precio_mayoreo3:t.precio_menudeo}function ht(){const t=bt();return s.carrito.reduce((e,i)=>e+i.cantidad*ft(i,t),0)}const pt="[carrito-respaldo]";let R=null,Ct=null,ct=null,Q=null;function _t(){ct&&(clearInterval(ct),ct=null),Q&&(window.removeEventListener("focus",Q),Q=null)}function Vt(){_t();const t=()=>Jt();ct=setInterval(t,8e3),Q=t,window.addEventListener("focus",Q)}async function Jt(){var e;if(s.tab!=="carrito"||!((e=s.sesion)!=null&&e.cliente_id)){_t();return}const t=document.activeElement;if(!(t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA")))try{const i=await fetch(h+"/portal/pedidos",{headers:A()}).then(c=>c.ok?c.json():null),o=(Array.isArray(i)?i:[]).find(c=>c.notes===pt),r=(o==null?void 0:o.pedido_items)||[],n=JSON.stringify(s.carrito.map(c=>[c.variante_id,c.cantidad,c.precio_unitario||c.precio_menudeo||0])),a=JSON.stringify(r.map(c=>{var d;return[c.variante_id||((d=c.variantes)==null?void 0:d.id),c.cantidad,c.precio_unitario]}));if(n===a)return;R=(o==null?void 0:o.id)||null,s.carrito=r.map(c=>{var v;const d=c.variantes,l=s.data.productos.find(u=>u.id===((d==null?void 0:d.producto_id)||c.producto_id));return{producto_id:(d==null?void 0:d.producto_id)||c.producto_id,variante_id:(d==null?void 0:d.id)||c.variante_id,nombre:((v=d==null?void 0:d.productos)==null?void 0:v.nombre)||c.nombre||(l==null?void 0:l.nombre)||"Producto",color:(d==null?void 0:d.color)||c.color,talla:(d==null?void 0:d.talla)||c.talla,cantidad:c.cantidad,es_corrida:!!c.es_corrida,precio_menudeo:(l==null?void 0:l.precio_menudeo)||0,precio_mayoreo3:(l==null?void 0:l.precio_mayoreo3)||0,precio_mayoreo6:(l==null?void 0:l.precio_mayoreo6)||0,precio_corrida:(l==null?void 0:l.precio_corrida)||0,imagen:(d==null?void 0:d.foto_url)||(l==null?void 0:l.imagen_principal)||null,sku:(l==null?void 0:l.sku_interno)||c.sku||null}}),wt(),s.tab==="carrito"&&W()}catch{}}function wt(){try{localStorage.setItem(Mt,JSON.stringify(s.carrito))}catch{}const t=document.querySelector(".bottomnav");t&&(t.outerHTML=q())}function G(){wt(),Wt()}function Wt(){clearTimeout(Ct),Ct=setTimeout(()=>{Zt().catch(()=>{})},1500)}async function Zt(){var e,i;if(!((e=s.sesion)!=null&&e.cliente_id))return;if(!s.carrito.length){if(R){const o=R;R=null,fetch(`${h}/pedidos/${o}/cancelar`,{method:"POST",headers:A()}).catch(()=>{})}return}let t=R;if(!t)try{const o=await fetch(h+"/portal/pedidos",{headers:A()}).then(n=>n.ok?n.json():[]),r=(Array.isArray(o)?o:[]).find(n=>n.notas===pt);r&&(t=r.id,R=t)}catch{}if(!t){const o=await fetch(`${h}/pedidos`,{method:"POST",headers:{"Content-Type":"application/json",...A()},body:JSON.stringify({cliente_id:s.sesion.cliente_id,status:"borrador",canal:"portal_mayoreo",total:0,notas:pt})});if(!o.ok)return;const r=await o.json();if(t=Array.isArray(r)?(i=r[0])==null?void 0:i.id:r==null?void 0:r.id,!t)return;R=t}try{const o=await fetch(`${h}/pedidos/${t}/items`,{headers:A()}).then(n=>n.ok?n.json():[]);for(const n of Array.isArray(o)?o:[])await fetch(`${h}/pedidos/${t}/items/${n.id}`,{method:"DELETE",headers:A()}).catch(()=>{});for(const n of s.carrito){const a=s.carrito.reduce((l,v)=>l+v.cantidad,0),c=s.data.productos.find(l=>l.id===n.producto_id);let d=n.precio_menudeo||0;c&&(n.es_corrida?d=c.precio_corrida:a>=6?d=c.precio_mayoreo6:a>=3&&(d=c.precio_mayoreo3)),await fetch(`${h}/pedidos/${t}/items`,{method:"POST",headers:{"Content-Type":"application/json",...A()},body:JSON.stringify({variante_id:n.variante_id,cantidad:n.cantidad,precio_unitario:d,subtotal:n.cantidad*d,nombre:n.nombre,color:n.color,talla:n.talla,es_corrida:!!n.es_corrida})}).catch(()=>{})}const r=ht();await fetch(`${h}/pedidos/${t}`,{method:"PATCH",headers:{"Content-Type":"application/json",...A()},body:JSON.stringify({total:r})}).catch(()=>{})}catch{}}async function Kt(t){const e=(Array.isArray(t)?t:[]).find(r=>r.notas===pt);if(!e)return;R=e.id;const i=e.pedido_items||[];if(!i.length)return;const o=[];i.forEach(r=>{var c;const n=r.variantes;if(!n||!n.id)return;const a=s.data.productos.find(d=>d.id===n.producto_id);o.push({producto_id:n.producto_id,variante_id:n.id,nombre:((c=n.productos)==null?void 0:c.nombre)||r.nombre||(a==null?void 0:a.nombre)||"Producto",color:n.color||r.color,talla:n.talla||r.talla,cantidad:r.cantidad,es_corrida:!!r.es_corrida,precio_menudeo:(a==null?void 0:a.precio_menudeo)||0,precio_mayoreo3:(a==null?void 0:a.precio_mayoreo3)||0,precio_mayoreo6:(a==null?void 0:a.precio_mayoreo6)||0,precio_corrida:(a==null?void 0:a.precio_corrida)||0,imagen:n.foto_url||(a==null?void 0:a.imagen_principal)||null,sku:(a==null?void 0:a.sku_interno)||r.sku||null})}),o.length&&(s.carrito=o,wt())}function Qt(){const t=bt();return s.carrito.every(e=>e.es_corrida)&&s.carrito.length?"Corrida":t>=6?"Mayoreo 6+":t>=3?"Mayoreo 3+":"Menudeo"}function W(){if(!s.carrito.length){B().innerHTML=`<div class="empty"><div class="ic">🛒</div><p>Tu carrito está vacío</p>
      <button class="btn-primary" style="max-width:220px;margin:14px auto 0" onclick="window.__nav('tienda')">Ver catálogo</button></div>`;return}const t=bt(),e=ht(),i=s.carrito.filter(a=>!a.es_corrida),o=s.carrito.filter(a=>a.es_corrida),r={};o.forEach(a=>{const c=`${a.producto_id}-${a.color}`;r[c]||(r[c]={key:c,es_grupo_corrida:!0,producto_id:a.producto_id,color:a.color,nombre:a.nombre,imagen:a.imagen,precio_corrida:a.precio_corrida,cantidad:0,items:[]}),r[c].cantidad+=a.cantidad,r[c].items.push(a)});const n=[...i.map((a,c)=>({...a,originalIdx:s.carrito.indexOf(a)})),...Object.values(r)];B().innerHTML=`
          ...
          <div class="row">
            <div class="r-top">
              ...
              <div style="flex:1;min-width:0">
                ...
                <div style="font-weight:700;color:var(--pink);margin-top:3px">${w(a.precio_corrida)} <span class="muted" style="font-size:.7rem;font-weight:600">x par</span></div>
              </div>
            ...
            <div class="qty" style="margin-top:10px">
              ...
              <button onclick="window.__qtyGrupoCorrida('${a.producto_id}', '${f(a.color)}', 1)">+</button>
              <span style="margin-left:auto;font-weight:700">${w(a.cantidad*a.precio_corrida)}</span>
            </div>
          </div>
        `:`
          <div class="row">
            <div class="r-top">
              ...
              <div style="flex:1;min-width:0">
                ...
                <div style="font-weight:700;color:var(--pink);margin-top:3px">${w(ft(a,t))} <span class="muted" style="font-size:.7rem;font-weight:600">x par</span></div>
              </div>
            ...
            <div class="qty" style="margin-top:10px">
              ...
              <span style="font-weight:700;min-width:26px;text-align:center">${a.cantidad}</span>
              <button onclick="window.__qty(${a.originalIdx},1)">+</button>
              <span style="margin-left:auto;font-weight:700">${w(a.cantidad*ft(a,t))}</span>
            </div>
          </div>
        `).join("")}
    ...
    </div>`}window.__qty=(t,e)=>{const i=s.carrito[t];if(i){if(e>0){const o=s.data.stockPorVar[i.variante_id]||0;if(s.carrito.filter(n=>n.variante_id===i.variante_id).reduce((n,a)=>n+a.cantidad,0)>=o){I("Sin más stock ("+o+")");return}}i.cantidad=Math.max(1,i.cantidad+e),G(),W(),document.querySelector(".bottomnav").outerHTML=q()}};window.__delItem=t=>{s.carrito.splice(t,1),G(),W(),document.querySelector(".bottomnav").outerHTML=q()};window.__qtyGrupoCorrida=(t,e,i)=>{const a=s.carrito.filter(u=>u.producto_id===t&&u.color===e&&u.es_corrida).reduce((u,_)=>u+_.cantidad,0)/6+i;if(a<=0){window.__delGrupoCorrida(t,e);return}const c=it(t,e);if(a>c){I(`Sin existencias para ${a} corridas (máximo ${c})`);return}const d=zt(t,e,a);s.carrito=s.carrito.filter(u=>!(u.producto_id===t&&u.color===e&&u.es_corrida));const l=s.data.productos.find(u=>u.id===t);Object.entries(d).forEach(([u,_])=>{if(_<=0)return;const k=s.data.variantes.find(D=>D.id===u);s.carrito.push({variante_id:u,producto_id:l.id,nombre:l.nombre,color:k.color,talla:k.talla,cantidad:_,es_corrida:!0,precio_menudeo:l.precio_menudeo,precio_mayoreo3:l.precio_mayoreo3,precio_mayoreo6:l.precio_mayoreo6,precio_corrida:l.precio_corrida,imagen:k.foto_url||l.imagen_principal||null})}),G(),W();const v=document.querySelector(".bottomnav");v&&(v.outerHTML=q())};window.__delGrupoCorrida=(t,e)=>{s.carrito=s.carrito.filter(o=>!(o.producto_id===t&&o.color===e&&o.es_corrida)),G(),W();const i=document.querySelector(".bottomnav");i&&(i.outerHTML=q())};window.__enviarPedido=async()=>{var t;if(s.carrito.length){if((t=s.sesion)!=null&&t.demo){I("Modo demo: no se envía pedido real");return}if(confirm("¿Enviar este pedido al negocio? Te confirmarán existencia y total."))try{const e=await fetch(h+"/portal/carrito",{method:"POST",headers:A(),body:JSON.stringify({items:s.carrito.map(o=>({variante_id:o.variante_id,cantidad:o.cantidad,es_corrida:!!o.es_corrida}))})});if(yt(e))return;const i=await e.json();if(!e.ok||!i.ok)throw new Error(i.error||"");s.carrito=[],G(),I(i.fusionado?"Se agregó a tu carrito anterior":"¡Pedido enviado!"),J("pedidos")}catch{alert("No se pudo enviar el pedido. Intenta de nuevo.")}}};async function te(){B().innerHTML='<div class="spinner">Cargando pedidos…</div>';let t=[];try{const e=await fetch(h+"/portal/pedidos",{headers:A()});if(yt(e))return;t=await e.json()}catch{}if(t=Array.isArray(t)?t.filter(e=>e.status!=="borrador"):[],!t.length){B().innerHTML='<div class="empty"><div class="ic">🛍️</div><p>Aún no tienes pedidos confirmados</p></div>';return}B().innerHTML=t.map(e=>{const i=e.pedido_items||[],o=i.reduce((n,a)=>n+(a.cantidad||0),0),r=e.created_at?new Date(e.created_at).toLocaleDateString("es-MX",{day:"2-digit",month:"short",year:"numeric"}):"";return`<div class="row">
    ...
    </div>`}).join("")}function ee(t){const e={borrador:["#eef2ff","#3730a3","Borrador"],pendiente_pago:["#fffbeb","#b45309","Por pagar"],confirmado:["#ecfdf5","#065f46","Confirmado"],pagado:["#ecfdf5","#065f46","Pagado"],enviado:["#eff6ff","#1d4ed8","Enviado"],entregado:["#f0fdf4","#15803d","Entregado"],cancelado:["#fef2f2","#991b1b","Cancelado"]},[i,o,r]=e[t]||["#f3f4f6","#374151",t||"—"];return`<span class="badge-status" style="background:${i};color:${o}">${r}</span>`}async function oe(){B().innerHTML='<div class="spinner">Cargando…</div>';let t=null;try{const e=await fetch(h+"/portal/me",{headers:A()});if(yt(e))return;t=await e.json()}catch{}t=t||{nombre:s.sesion.nombre,tipo:s.sesion.tipo},B().innerHTML=`
    <div class="row">
    ...
    </div>`}window.__switchSubTab=t=>{const e=document.getElementById("catalogos-general-content"),i=document.getElementById("catalogos-categorias-content"),o=document.getElementById("btn-cat-general"),r=document.getElementById("btn-cat-categorias");t==="categorias"?(e&&(e.style.display="none"),i&&(i.style.display="block"),o&&o.classList.remove("active"),r&&r.classList.add("active")):(e&&(e.style.display="block"),i&&(i.style.display="none"),o&&o.classList.add("active"),r&&r.classList.remove("active"))};window.__descargarPdfCategorias=async t=>{const e=t.getAttribute("data-categoria"),i=t.getAttribute("data-label"),o=document.getElementById("cat-pdf-msg"),r=document.querySelectorAll("#cat-pdf-btns button");r.forEach(n=>n.disabled=!0),o&&(o.style.display="block",o.textContent=`⏳ Cargando productos de ${i}...`);try{const n=s.data.productos.filter(m=>m.categoria&&String(m.categoria).trim().toLowerCase()===String(e).trim().toLowerCase());if(!n.length){o&&(o.textContent=`Sin productos activos en ${i}`),setTimeout(()=>{o&&(o.style.display="none")},3e3),r.forEach(m=>m.disabled=!1);return}const a=[];if(n.forEach(m=>{const C=s.data.variantes.filter(g=>g.producto_id===m.id&&g.activa!==!1),b=new Set;C.forEach(g=>{if(!g.color||b.has(g.color.trim().toUpperCase()))return;b.add(g.color.trim().toUpperCase());const L=g.foto_url||m.imagen_principal;L&&a.push({sku:m.sku_interno||"S/K",color:g.color.trim().toUpperCase(),imgUrl:L})}),b.size===0&&m.imagen_principal&&a.push({sku:m.sku_interno||"S/K",color:"ÚNICO",imgUrl:m.imagen_principal})}),!a.length){o&&(o.textContent=`Sin fotos disponibles para ${i}`),setTimeout(()=>{o&&(o.style.display="none")},3e3),r.forEach(m=>m.disabled=!1);return}o&&(o.textContent=`✏️ Generando catálogo PDF (${a.length} variantes)...`),window.jspdf||await new Promise((m,C)=>{const b=document.createElement("script");b.src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js",b.onload=m,b.onerror=C,document.head.appendChild(b)});const{jsPDF:c}=window.jspdf,d=2,l=3,v=d*l,u=1080,_=1440,k=40,D=80,p=24,$=32,x=(u-k*2-p*(d-1))/d,E=(_-D*2-$*(l-1))/l,j=E-50,X=m=>new Promise(C=>{if(!m)return C(null);const b=new Image;b.crossOrigin="anonymous",b.onload=()=>C(b),b.onerror=()=>C(null),b.src=m+(m.includes("?")?"&":"?")+"_t="+Date.now()}),rt=(m,C,b,g,L,M)=>{if(m.save(),m.fillStyle="#FFFFFF",m.fillRect(b,g,L,M),C){m.beginPath(),m.rect(b,g,L,M),m.clip();const F=C.naturalWidth/C.naturalHeight,ut=L/M;let Y,H,U,Z;F>ut?(H=M,Y=M*F,Z=g,U=b+(L-Y)/2):(Y=L,H=L/F,U=b,Z=g+(M-H)/2),m.drawImage(C,U,Z,Y,H)}else m.fillStyle="#F3F4F6",m.fillRect(b,g,L,M),m.fillStyle="#9CA3AF",m.font="20px sans-serif",m.textAlign="center",m.fillText("Sin imagen",b+L/2,g+M/2);m.restore()},N=[];for(let m=0;m<a.length;m+=v)N.push(a.slice(m,m+v));const y=new c({orientation:"portrait",unit:"px",format:[u,_]});let P=!0;for(let m=0;m<N.length;m++){o&&(o.textContent=`✏️ Generando página ${m+1} de ${N.length}...`);const C=N[m],b=document.createElement("canvas");b.width=u,b.height=_;const g=b.getContext("2d");g.fillStyle="#FAFAF8",g.fillRect(0,0,u,_),g.fillStyle="#2A1A0E",g.font="300 20px sans-serif",g.textAlign="center",g.letterSpacing="4px",g.fillText(`CATÁLOGO DE ${i.toUpperCase()}`,u/2,38),g.letterSpacing="0px",g.fillStyle="#C8967A",g.fillRect(k,48,u-k*2,1.5);for(let M=0;M<C.length;M++){const F=C[M],ut=M%d,Y=Math.floor(M/d),H=k+ut*(x+p),U=D+Y*(E+$),Z=await X(F.imgUrl);rt(g,Z,H,U,x,j),g.fillStyle="#E8DDD5",g.fillRect(H,U+j,x,1),g.fillStyle="#2A1A0E",g.textAlign="center",g.font="600 18px sans-serif",g.fillText(`${F.sku} ${F.color}`,H+x/2,U+j+28)}g.fillStyle="#C8967A",g.fillRect(k,_-48,u-k*2,1),g.fillStyle="#A07860",g.font="300 14px sans-serif",g.textAlign="center",g.fillText(`Página ${m+1} de ${N.length}`,u/2,_-30);const L=b.toDataURL("image/jpeg",.9);P||y.addPage([u,_]),y.addImage(L,"JPEG",0,0,u,_),P=!1}const st=`catalogo_${e}_${new Date().toISOString().slice(0,10)}.pdf`;y.save(st),o&&(o.textContent="✅ ¡Catálogo descargado!",setTimeout(()=>{o.style.display="none"},4e3))}catch(n){console.error("Error generating PDF:",n),o&&(o.textContent=`❌ Error al generar el PDF: ${n.message}`)}finally{r.forEach(n=>n.disabled=!1)}};async function Pt(t){const e=await fetch(h+"/catalogos/"+t+"/paginas").then(i=>i.json()).catch(()=>[]);return Array.isArray(e)?e:[]}window.__verCatalogo=async(t,e)=>{const i=await Pt(t),o=document.createElement("div");o.className="modal-overlay",o.id="catv",o.innerHTML=`
    <div class="modal">
      <div class="m-head">
        <div style="flex:1"><div style="font-weight:700">${f(e)}</div><div class="muted" style="font-size:.76rem">${i.length} páginas</div></div>
    ...
    </div>`,document.body.appendChild(o),o.addEventListener("click",r=>{r.target===o&&o.remove()})};window.__descargarCatalogo=async(t,e,i)=>{const o=i?i.textContent:"";i&&(i.disabled=!0,i.textContent="Descargando…");try{const r=await Pt(t);if(!r.length){I("Este catálogo no tiene páginas"),i&&(i.disabled=!1,i.textContent=o);return}const n=(e||"catalogo").replace(/[^\w]+/g,"_");let a=0;for(const c of r){a++;try{const l=await(await fetch(c.imagen_url)).blob(),v=URL.createObjectURL(l),u=document.createElement("a");u.href=v,u.download=`${n}_${String(c.pagina_numero||a).padStart(2,"0")}.jpg`,document.body.appendChild(u),u.click(),u.remove(),URL.revokeObjectURL(v),await new Promise(_=>setTimeout(_,300))}catch{window.open(c.imagen_url,"_blank")}}I("Descarga lista · "+r.length+" páginas")}catch{I("No se pudo descargar")}i&&(i.disabled=!1,i.textContent=o)};function ie(){s.mayaMsgs||(s.mayaMsgs=[]),B().innerHTML=`
    <div class="chat-wrap">
    ...
    </div>`,document.getElementById("maya-send").onclick=window.__mayaSend,document.getElementById("maya-in").addEventListener("keydown",t=>{t.key==="Enter"&&window.__mayaSend()}),setTimeout(()=>{const t=document.getElementById("maya-msgs");t&&(t.scrollTop=t.scrollHeight)},50)}function At(t){if(t.typing)return'<div class="msg bot typing">Maya está escribiendo…</div>';const e=(t.fotos||[]).map(i=>`<img src="${f(i)}" loading="lazy">`).join("");return`<div class="msg ${t.role==="me"?"me":"bot"}">${f(t.content)}${e}</div>`}function St(){const t=document.getElementById("maya-msgs");t&&(t.innerHTML=s.mayaMsgs.map(At).join(""),t.scrollTop=t.scrollHeight)}function ne(t){const e=[];let i=String(t||"").replace(/ENVIAR_FOTO:\[?(\S+?)\]?(?=\s|$)/g,(o,r)=>(e.push(r.replace(/[\[\]]/g,"")),""));return i=i.replace(/BUSCAR_COLORES:\[?[A-Za-z0-9_\-]+\]?/g,"").replace(/\n{3,}/g,`

`).trim(),{texto:i||"👍",fotos:e}}window.__mayaSend=async()=>{const t=document.getElementById("maya-in");if(!t)return;const e=(t.value||"").trim();if(!e)return;t.value="",s.mayaMsgs||(s.mayaMsgs=[]);const i=s.mayaMsgs.filter(o=>!o.typing).map(o=>({role:o.role==="me"?"user":"assistant",content:o.content}));s.mayaMsgs.push({role:"me",content:e}),s.mayaMsgs.push({role:"bot",typing:!0}),St();try{const r=await(await fetch(h+"/chatbot/mensaje",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mensaje:e,historial:i})})).json();s.mayaMsgs.pop();const{texto:n,fotos:a}=ne(r.respuesta);s.mayaMsgs.push({role:"bot",content:n,fotos:a})}catch{s.mayaMsgs.pop(),s.mayaMsgs.push({role:"bot",content:"Ups, no me pude conectar. Intenta de nuevo en un momento."})}St()};let Et=null;function I(t){const e=document.getElementById("toast");e&&(e.textContent=t,e.classList.add("show"),clearTimeout(Et),Et=setTimeout(()=>e.classList.remove("show"),1600))}window.abrirLightboxPC=function(t,e,i){if(!t)return;const o=document.getElementById("pc-lightbox");if(o&&o.remove(),!e||!e.length){const p=document.getElementById("pm-swatches");p&&(e=Array.from(p.querySelectorAll("img")).map($=>$.src)),(!e||!e.length)&&(e=[t]),e.includes(t)||(e=[t,...e])}let r=e.indexOf(t);r<0&&(r=0);const n=document.createElement("div");n.id="pc-lightbox",n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:19999;display:flex;flex-direction:column;align-items:center;justify-content:center;touch-action:none;user-select:none";let a=1,c=0,d=0,l=1,v=0;const u=()=>{a=1,c=0,d=0;const p=document.getElementById("lb-img");p&&(p.style.transform="",p.style.cursor="zoom-in")},_=()=>{const p=e.length;n.innerHTML=`
    ...
    `};window.pcCompartirImagenLB=async()=>{const p=e[r];if(p)try{const x=await(await fetch(p)).blob(),E=(x.type.split("/")[1]||"jpg").replace("jpeg","jpg"),j=new File([x],`zapatillasmay-${Date.now()}.${E}`,{type:x.type});navigator.canShare&&navigator.canShare({files:[j]})?await navigator.share({files:[j]}):navigator.share?await navigator.share({url:p}):window.pcDescargarImagenLB()}catch($){($==null?void 0:$.name)!=="AbortError"&&I("No se pudo compartir la imagen")}},window.pcDescargarImagenLB=async()=>{const p=e[r];if(p)try{const x=await(await fetch(p)).blob(),E=document.createElement("a");E.href=URL.createObjectURL(x);const j=i?i.replace(/[^A-Za-z0-9_-]/g,""):"";E.download=j?`Zapatillas_May_${j}.jpg`:`Zapatillas_May_${Date.now()}.jpg`,document.body.appendChild(E),E.click(),document.body.removeChild(E),URL.revokeObjectURL(E.href),I("Imagen descargada")}catch{window.open(p,"_blank")}},window.lbNav=p=>{p<0&&r===0||p>0&&r===e.length-1||(r=Math.max(0,Math.min(e.length-1,r+p)),u(),_(),k())},window.lbGoto=p=>{r=p,u(),_(),k()};const k=()=>{const p=document.getElementById("lb-img");if(!p)return;let $=!1,x=0,E=0,j=0;p.addEventListener("touchstart",y=>{if(y.touches.length===1){const P=new Date().getTime(),st=P-j;if(st<300&&st>0){a>1?u():(a=2.5,p.style.transform=`scale(${a})`,p.style.cursor="grab"),y.preventDefault();return}j=P,a>1?($=!0,x=y.touches[0].clientX-c,E=y.touches[0].clientY-d):x=y.touches[0].clientX}else y.touches.length===2&&($=!1,l=a,v=Math.hypot(y.touches[0].clientX-y.touches[1].clientX,y.touches[0].clientY-y.touches[1].clientY))},{passive:!1}),p.addEventListener("touchmove",y=>{if(y.touches.length===1&&a>1&&$)y.preventDefault(),c=y.touches[0].clientX-x,d=y.touches[0].clientY-E,p.style.transform=`scale(${a}) translate(${c/a}px, ${d/a}px)`;else if(y.touches.length===2){y.preventDefault();const P=Math.hypot(y.touches[0].clientX-y.touches[1].clientX,y.touches[0].clientY-y.touches[1].clientY);a=Math.max(1,Math.min(4,l*(P/v))),a<=1?u():(p.style.transform=`scale(${a}) translate(${c/a}px, ${d/a}px)`,p.style.cursor="grab")}},{passive:!1}),p.addEventListener("touchend",y=>{if($)$=!1;else if(a===1&&y.changedTouches.length===1){const P=y.changedTouches[0].clientX-x;Math.abs(P)>50&&window.lbNav(P<0?1:-1)}},{passive:!0}),p.addEventListener("wheel",y=>{y.preventDefault();const P=y.deltaY*-.005;a=Math.max(1,Math.min(4,a+P)),a<=1?u():(p.style.transform=`scale(${a}) translate(${c/a}px, ${d/a}px)`,p.style.cursor="grab")},{passive:!1});let X=!1,rt=0,N=0;p.addEventListener("mousedown",y=>{a>1&&(X=!0,rt=y.clientX-c,N=y.clientY-d,p.style.cursor="grabbing")}),window.addEventListener("mousemove",y=>{X&&a>1&&(c=y.clientX-rt,d=y.clientY-N,p.style.transform=`scale(${a}) translate(${c/a}px, ${d/a}px)`)}),window.addEventListener("mouseup",()=>{X&&(X=!1,p&&(p.style.cursor="grab"))})};n.addEventListener("click",p=>{p.target===n&&history.back()});const D=p=>{p.key==="ArrowRight"?window.lbNav(1):p.key==="ArrowLeft"?window.lbNav(-1):p.key==="Escape"&&history.back()};document.addEventListener("keydown",D),n.addEventListener("remove",()=>document.removeEventListener("keydown",D)),_(),document.body.appendChild(n),k(),window._zmPushBack&&window._zmPushBack(()=>{const p=document.getElementById("pc-lightbox");p&&p.remove(),document.removeEventListener("keydown",D)})};window._zmNavStack=[];window._zmPushBack=t=>{history.pushState({zmNav:window._zmNavStack.length+1},""),window._zmNavStack.push(t)};window.addEventListener("popstate",()=>{if(window._zmNavStack.length>0){const t=window._zmNavStack.pop();try{t()}catch{}}});Bt();
