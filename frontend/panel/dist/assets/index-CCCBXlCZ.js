(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function o(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=o(n);fetch(n.href,r)}})();const f="/api",xe=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],Me=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],Le=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],te=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"carritos",icon:"🛒",label:"Carritos",section:"Ventas"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"envio",icon:"🚚",label:"Envíos",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"},{id:"catalogos",icon:"📖",label:"Catálogos",section:"Catalogo",soloAdmin:!0},{id:"orden-home",icon:"🏠",label:"Orden en Home",section:"Catalogo",soloAdmin:!0},{id:"mercadolibre",icon:"🛒",label:"MercadoLibre",section:"Integraciones",soloAdmin:!0},{id:"analytics",icon:"📊",label:"Google Analytics",section:"Integraciones",soloAdmin:!0},{id:"referidos",icon:"🎁",label:"Referidos",section:"Ventas",soloAdmin:!0},{id:"carritos-abandonados",icon:"🛒",label:"Carritos abandonados",section:"Ventas",soloAdmin:!0}];var he;let K=((he=window._empleadoActual)==null?void 0:he.rol)==="admin"?"dashboard":"pos",me=1;function we(){var o,a;const e=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),t=((o=window._empleadoActual)==null?void 0:o.rol)==="admin"?"dashboard":"pos";K=e||t,document.querySelector("#app").innerHTML=`
  ...
  `,window.toggleSidebar=()=>{const n=document.getElementById("sidebar"),r=document.getElementById("sidebar-overlay"),i=n.classList.toggle("open");r.classList.toggle("active",i),document.body.style.overflow=i?"hidden":""},window._conversacionesInterval&&clearInterval(window._conversacionesInterval),window._conversacionesInterval=setInterval(async()=>{try{const r=await(await fetch(f+"/chatbot/chats")).json();window._chatsData||(window._chatsData={});const i=window._totalNoLeidos||0,s=r.reduce((d,l)=>d+(l.no_leidos||0),0);if(window._totalNoLeidos=s,r.forEach(d=>{window._chatsData&&(window._chatsData[d.telefono]=d)}),s>i){document.title=`(${s}) Zapatillas May`;const d=document.querySelector('[data-modulo="conversaciones"]');if(d){let l=d.querySelector(".nav-badge");l||(l=document.createElement("span"),l.className="nav-badge",l.style.cssText="background:#e91e8c;color:white;border-radius:100px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:auto",d.appendChild(l)),l.textContent=s}try{const l=new(window.AudioContext||window.webkitAudioContext),c=l.createOscillator(),p=l.createGain();c.connect(p),p.connect(l.destination),c.frequency.value=523,p.gain.setValueAtTime(.5,l.currentTime),p.gain.exponentialRampToValueAtTime(.001,l.currentTime+.2),c.start(l.currentTime),c.stop(l.currentTime+.2);const m=l.createOscillator(),u=l.createGain();m.connect(u),u.connect(l.destination),m.frequency.value=783,u.gain.setValueAtTime(.5,l.currentTime+.2),u.gain.exponentialRampToValueAtTime(.001,l.currentTime+.5),m.start(l.currentTime+.2),m.stop(l.currentTime+.5)}catch{}}if(window._chatActivo&&window._chatsData[window._chatActivo]){const d=window._chatsData[window._chatActivo],l=document.getElementById("mensajes-area");if(l){const c=l.scrollHeight-l.scrollTop<=l.clientHeight+50;l.innerHTML=[...d.mensajes].reverse().map(p=>{const m=p.tipo==="manual"||p.tipo==="imagen_saliente";return`
    ...
    `).join("")}
  `).join("")}async function $e(e){const t=document.getElementById("content");switch(t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>',e){case"catalogos":await ue();break;case"dashboard":t.innerHTML=Fe(),setTimeout(()=>Xe(),100);break;case"productos":await le();break;case"clientes":await Ne();break;case"carritos":await fe();break;case"pedidos":await Je();break;case"sucursales":await Re();break;case"inventario":await qe();break;case"pos":await ze();break;case"historial":await Ie();break;case"empleados":await Se();break;case"seo":await Ke();break;case"envio":await We();break;case"analisis":await He();break;case"crm":await _e();break;case"finanzas":await ae();break;case"proveedores":await Ee();break;case"ordenes":await oe();break;case"conversaciones":await cargarConversaciones();break;case"envios":await cargarEnviosMasivos();break;case"mercadolibre":await Ye();break;case"analytics":await et();break;case"orden-home":await Qe();break;case"referidos":await ge();break;case"carritos-abandonados":await Ue();break}}function De(){return setTimeout(()=>{document.querySelectorAll(".nav-item").forEach(a=>a.classList.remove("active"));const e=document.querySelector('[data-modulo="'+K+'"]');e&&e.classList.add("active");const t=document.getElementById("topbar-title"),o=te.find(a=>a.id===K);t&&o&&(t.textContent=o.label),$e(K)},100),'<div style="padding:2rem;color:#888;text-align:center">Cargando...</div>'}async function oe(){var t;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando sugerencias...</p>';try{const a=await(await fetch(f+"/sucursales/")).json(),n=(t=a[0])==null?void 0:t.id,[r,i]=await Promise.all([fetch(f+"/finanzas/sugerencias-recompra/"+n),fetch(f+"/finanzas/proveedores")]),s=await r.json(),d=await i.json(),l=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),c=new Date().toISOString().split("T")[0],p=s.filter(b=>{const h=l[b.producto_id];return h?h.hasta===null||h.hasta===void 0?!1:h.hasta<=c:!0}),m=s.length-p.length;window._ordenesData={sugerencias:p,proveedores:d,sucursalId:n},window._ordenSeleccion={};const u=p.filter(b=>b.urgente),g=p.filter(b=>!b.urgente),y=p.reduce((b,h)=>b+h.cantidad_sugerida*h.costo_unitario,0);e.innerHTML=`
...
¿Quieres reactivar todos?`)&&(localStorage.removeItem("ordenes_pospuestos"),oe())};window.guardarOrdenCompra2=async()=>{var r,i,s,d;const{seleccionados:e,sucursalId:t}=window._ordenModal||{};if(!e)return;const o=(r=document.getElementById("orden-fecha"))==null?void 0:r.value,a=((i=document.getElementById("orden-notas"))==null?void 0:i.value)||"",n={};e.forEach(l=>{var u,g;const c=l.proveedor_id||"sin-proveedor",p=((u=l.proveedor)==null?void 0:u.nombre)||"Sin proveedor";n[c]||(n[c]={nombre:p,items:[]});const m=l.variantes||[];if(m.length===0){const y=parseInt(((g=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:g.value)||l.cantidad_sugerida);n[c].items.push({variante_id:null,cantidad:y,costo_unitario:l.costo_unitario})}else m.forEach(y=>{var v;const b=document.getElementById("chk-var-"+y.id);if(!(b!=null&&b.checked))return;const h=parseInt(((v=document.getElementById("qty-var-"+y.id))==null?void 0:v.value)||0);h<=0||n[c].items.push({variante_id:y.id,cantidad:h,costo_unitario:l.costo_unitario})})});try{for(const[l,c]of Object.entries(n)){if(c.items.length===0)continue;const p=c.items.reduce((y,b)=>y+b.cantidad*b.costo_unitario,0),g=(s=(await(await fetch(f+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:l==="sin-proveedor"?null:l,sucursal_id:t,status:"borrador",total:p,notas:a,fecha_entrega_estimada:o||null})})).json())[0])==null?void 0:s.id;if(g)for(const y of c.items)await fetch(f+"/finanzas/ordenes/"+g+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...y,subtotal:y.cantidad*y.costo_unitario})})}(d=document.getElementById("modal-orden"))==null||d.remove(),alert("Orden de compra guardada"),oe()}catch(l){alert("Error guardando orden: "+l.message)}};function Fe(){return`
  ...
  `}async function ae(){var t,o,a,n,r,i;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando finanzas...</p>';try{const d=await(await fetch(f+"/sucursales/")).json(),l=(t=d[0])==null?void 0:t.id,[c,p,m,u,g,y,b]=await Promise.all([fetch(f+"/finanzas/caja/hoy/"+l),fetch(f+"/finanzas/reporte/"+l),fetch(f+"/finanzas/gastos/"+l),fetch(f+"/finanzas/estado-resultados/"+l),fetch(f+"/finanzas/flujo/"+l),fetch(f+"/finanzas/cuentas-por-cobrar"),fetch(f+"/finanzas/gastos-categorias/"+l)]),h=await c.json(),v=await p.json(),w=await m.json(),E=await u.json(),x=await g.json(),I=await y.json(),_=await b.json(),C=h.find(B=>B.status==="abierta"),j=new Date().toISOString().split("T")[0],M=w.filter(B=>{var $;return($=B.created_at)==null?void 0:$.startsWith(j)}),k=M.reduce((B,$)=>B+parseFloat($.monto||0),0),T=I.reduce((B,$)=>B+parseFloat($.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
    ...
    `:e==="flujo"?l.innerHTML=`
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;margin-bottom:1rem">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f5f5f5">
            <span style="font-size:0.82rem;color:#888">Gastos</span>
            <span style="font-weight:700;color:#c62828">-$${(((E=n.mes)==null?void 0:E.gastos)||0).toFixed(0)}</span>
          </div>
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            <span style="font-size:0.85rem;font-weight:700">Neto</span>
            <span style="font-weight:700;color:${(((x=n.mes)==null?void 0:x.neto)||0)>=0?"#2e7d32":"#c62828"};font-size:1.1rem">$${(((I=n.mes)==null?void 0:I.neto)||0).toFixed(0)}</span>
          </div>
        </div>
      </div>
    `:e==="caja"?l.innerHTML=`
...
Diferencia: $${(n=i.diferencia)==null?void 0:n.toFixed(2)}`),ae()):alert("Error: "+JSON.stringify(i))}catch{alert("Error cerrando caja")}};window.agregarGasto=e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",t.innerHTML=`
  ...
  `,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()})};window.guardarProveedor=async e=>{const t={nombre:document.getElementById("prov-nombre").value,contacto:document.getElementById("prov-contacto").value,telefono:document.getElementById("prov-telefono").value,email:document.getElementById("prov-email").value,ciudad:document.getElementById("prov-ciudad").value,direccion:document.getElementById("prov-direccion").value,notas:document.getElementById("prov-notas").value};if(!t.nombre){alert("El nombre es requerido");return}try{e?await fetch(f+"/finanzas/proveedores/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):await fetch(f+"/finanzas/proveedores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),document.querySelector('div[style*="position:fixed"]').remove(),Ee()}catch{alert("Error guardando proveedor")}};window.editarProveedor=async e=>{const a=(await(await fetch(f+"/finanzas/proveedores")).json()).find(n=>n.id===e);a&&mostrarFormProveedor(a)};async function He(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando análisis...</p>';try{const[t,o,a,n]=await Promise.all([fetch(f+"/productos/"),fetch(f+"/variantes/"),fetch(f+"/movimientos/"),fetch(f+"/inventario/")]),r=await t.json(),i=await o.json(),s=await a.json(),d=await n.json(),l=new Date,c=new Date(l-30*24*60*60*1e3),p=new Date(l-60*24*60*60*1e3),m=new Date(l-90*24*60*60*1e3),u={};s.filter(b=>b.tipo==="venta").forEach(b=>{const h=i.find(x=>x.id===b.variante_id);if(!h)return;const v=h.producto_id;u[v]||(u[v]={d30:0,d60:0,d90:0});const w=new Date(b.created_at),E=Math.abs(b.cantidad);w>=c&&(u[v].d30+=E),w>=p&&(u[v].d60+=E),w>=m&&(u[v].d90+=E)});const g=r.map(b=>{const h=u[b.id]||{d30:0,d60:0,d90:0},v=d.filter(_=>i.find(C=>C.id===_.variante_id&&C.producto_id===b.id)).reduce((_,C)=>_+C.cantidad,0),w=h.d30/4,E=w>0?Math.round(v/w*7):null;let x="gris",I="Sin ventas recientes";return h.d30>=6?(x="verde",I="Rota bien — considerar resurtido"):h.d30>=2?(x="amarillo",I="Rotacion moderada"):h.d90===0&&v>0?(x="rojo",I="Sin movimiento en 90 dias — revisar"):h.d30>0&&(x="amarillo",I="Rotacion lenta"),{...b,ventas:h,stockTotal:v,ventasSemana:w,diasInventario:E,semaforo:x,recomendacion:I}}).sort((b,h)=>h.ventas.d30-b.ventas.d30),y={verde:{bg:"#e8f5e9",color:"#2e7d32",texto:"🟢 Rota bien"},amarillo:{bg:"#fff8e1",color:"#f57f17",texto:"🟡 Rotacion lenta"},rojo:{bg:"#ffebee",color:"#c62828",texto:"🔴 Sin movimiento"},gris:{bg:"#f5f5f5",color:"#888",texto:"⚪ Sin datos"}};e.innerHTML=`
  ...
  <button class="btn btn-secondary" style="padding:4px 10px;font-size:0.75rem;background:#ffebee;border-color:#c62828;color:#c62828" onclick="filtrarRotacion('rojo')">🔴 Sin movimiento</button>
    ...
    `,window._rotacionData=g}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando análisis</p>'}}window.filtrarRotacion=e=>{document.querySelectorAll(".rotacion-item").forEach(t=>{t.style.display=e==="todos"||t.dataset.semaforo===e?"":"none"})};async function _e(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando CRM...</p>';try{const[t,o,a]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/"),fetch(f+"/crm/seguimientos/pendientes/todos")]),n=await t.json(),r=await o.json(),i=await a.json(),s=new Date,d=new Date(s-30*24*60*60*1e3),l=new Date(s-60*24*60*60*1e3),c=new Date(s-90*24*60*60*1e3),p=n.map(v=>{const w=r.filter(j=>j.cliente_id===v.id&&(j.status==="confirmado"||j.status==="pagado")),E=w.reduce((j,M)=>j+parseFloat(M.total||0),0),x=w.length>0?new Date(w[0].created_at):null,I=x?Math.floor((s-x)/(1e3*60*60*24)):null,_=w.filter(j=>new Date(j.created_at)>=d).length;let C="nuevo";return w.length===0?C="nuevo":E>=5e3&&_>=1?C="vip":I>90?C="inactivo":I>30?C="riesgo":_>=2?C="frecuente":C="activo",{...v,totalGastado:E,ultimoPedido:x,diasSinComprar:I,pedidos30:_,segmento:C,totalPedidos:w.length}}),m=p.filter(v=>v.segmento==="vip"),u=p.filter(v=>v.segmento==="riesgo").sort((v,w)=>w.totalGastado-v.totalGastado),g=p.filter(v=>v.segmento==="inactivo").sort((v,w)=>w.totalGastado-v.totalGastado),y=[...p].sort((v,w)=>w.totalGastado-v.totalGastado).slice(0,10),b=r.filter(v=>new Date(v.created_at).toDateString()===s.toDateString()&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,w)=>v+parseFloat(w.total||0),0),h=r.filter(v=>new Date(v.created_at)>=d&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,w)=>v+parseFloat(w.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
...
⚠️ Requiere que los productos estén en el catálogo de Meta Commerce.`;else if(d.style.background="#e8f5e9",d.style.borderColor="#a5d6a7",d.style.color="#333",o){let y;t==="personalizado"?y=(((g=document.getElementById("texto-personalizado"))==null?void 0:g.value)||"").replace("{nombre}","María"):y=o.mensaje("María"),d.textContent=y}}const l=document.getElementById("campana-count");l&&(l.textContent=r.length+" clientes");const c=document.getElementById("campana-lista");if(c){if(!r.length){c.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No hay clientes en este segmento con teléfono registrado</div>';return}window._campanaFiltrados=r,window._campanaPlantillaId=t,c.innerHTML=r.map((y,b)=>{var E;let h;t==="personalizado"?h=(((E=document.getElementById("texto-personalizado"))==null?void 0:E.value)||"").replace("{nombre}",y.nombre.split(" ")[0]):h=o.mensaje(y.nombre.split(" ")[0]);const v=encodeURIComponent(h),w=(y.lada||"52")+y.telefono.replace(/\D/g,"");return`
    ...
    <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);text-align:center">
      ...
      <p style="font-size:0.82rem;color:#888">Conectando con WhatsApp Business</p>
        ...
        </div>`};window._campanaJobId=g;const h=setInterval(async()=>{try{const w=await(await fetch(f+"/campanas/estado/"+g)).json();b(w),w.terminado&&(clearInterval(h),window._campanaUltimosResultados=w.resultados||[],setTimeout(()=>{const E=w.enviados||0,x=w.fallidos||0;l.innerHTML=`
              <div style="background:white;border-radius:16px;padding:2.5rem;max-width:400px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
                ...
                ${x>0?`
                  ...
                  <div style="background:#fff5f5;border-radius:8px;padding:0.75rem;margin-bottom:1rem;text-align:left;max-height:140px;overflow-y:auto">
                    ${w.resultados.filter(I=>!I.ok).map(I=>`
    ...
    `};window._campanaAvanzar=()=>{if(i++,i>=r.length){s.innerHTML=`
      ...
      `;return}d()},d(),document.body.appendChild(s)};async function Ne(){const e=document.getElementById("content");try{const[t,o]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/")]),a=await t.json(),n=await o.json(),r=new Date,i=new Date(r-30*24*60*60*1e3),s=new Date(r-90*24*60*60*1e3),d=a.map(u=>{const g=n.filter(_=>_.cliente_id===u.id&&(_.status==="confirmado"||_.status==="pagado")),y=g.reduce((_,C)=>_+parseFloat(C.total||0),0),b=g.length>0?new Date(g[0].created_at):null,h=g.filter(_=>new Date(_.created_at)>=i).length,v=b?Math.floor((r-b)/(1e3*60*60*24)):null;let w="nuevo",E="⚪ Nuevo",x="#f5f5f5",I="#888";return g.length===0?(w="nuevo",E="⚪ Sin compras",x="#f5f5f5",I="#888"):y>=5e3&&h>=1?(w="vip",E="⭐ VIP",x="#fff8e1",I="#f57f17"):v>90?(w="inactivo",E="🔴 Inactivo",x="#ffebee",I="#c62828"):v>30?(w="riesgo",E="🟡 En riesgo",x="#fff8e1",I="#f57f17"):h>=2?(w="frecuente",E="🟢 Frecuente",x="#e8f5e9",I="#2e7d32"):(w="activo",E="🔵 Activo",x="#e3f2fd",I="#1565c0"),{...u,totalGastado:y,ultimoPedido:b,pedidos30:h,diasSinComprar:v,segmento:w,segmentoLabel:E,segmentoBg:x,segmentoColor:I,totalPedidos:g.length}}).sort((u,g)=>g.totalGastado-u.totalGastado),l=d.filter(u=>u.segmento==="vip").length,c=d.filter(u=>u.segmento==="inactivo").length,p=d.filter(u=>u.segmento==="riesgo").length,m=d.filter(u=>u.segmento==="frecuente"||u.segmento==="activo").length;window._clientesData=d,e.innerHTML=`
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
  ...
  <div style="margin-bottom:1.5rem">
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">
      ...
      <select class="form-input" id="inv-talla" style="min-width:100px" onchange="renderInventario()">
        ...
        ${xe.map(c=>`<option value="${c}">${c}</option>`).join("")}
      </select>
...
`,renderInventario()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.renderInventario=()=>{const{sucursales:e,productos:t,variantes:o,inventario:a}=window._invData,n=(document.getElementById("inv-buscar")?document.getElementById("inv-buscar").value:"").toLowerCase(),r=document.getElementById("inv-categoria")?document.getElementById("inv-categoria").value:"",i=document.getElementById("inv-talla")?document.getElementById("inv-talla").value:"",s=document.getElementById("inv-estado")?document.getElementById("inv-estado").value:"",d=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],l=t.filter(m=>!(!m.activo||n&&!m.nombre.toLowerCase().includes(n)&&!(m.sku_interno||"").toLowerCase().includes(n)||r&&m.categoria!==r)),c=e.map(m=>{const u=a.filter(y=>y.sucursal_id===m.id),g=l.map(y=>{const b=o.filter(E=>E.producto_id===y.id);if(b.length===0)return"";const v=[...new Set(b.map(E=>E.color).filter(Boolean))].map(E=>{const x=b.filter(j=>j.color===E).sort((j,M)=>d.indexOf(j.talla)-d.indexOf(M.talla));if(i&&!x.find(j=>j.talla===i))return"";const I=x[0]?x[0].color_hex:"#888",_=x[0]?x[0].foto_url:null,C=x.map(j=>{const M=u.find(B=>B.variante_id===j.id),k=M?M.cantidad:null,T=M?M.stock_minimo:3;if(i&&j.talla!==i||s&&(s==="agotado"&&k!==0||s==="bajo"&&(k===null||k===0||k>T)||s==="disponible"&&(k===null||k===0||k<=T)))return"";let S,z;return k===null?(S="#f0f0f0",z="#aaa"):k===0?(S="#ffebee",z="#c62828"):k<=T?(S="#fff8e1",z="#f57f17"):(S="#e8f5e9",z="#2e7d32"),`
            <div style="display:flex;align-items:center;justify-content:space-between;background:${S};border-radius:10px;padding:8px 12px;border:1px solid ${z}30">
              <span style="font-size:0.85rem;font-weight:600;color:#555;min-width:44px">T${j.talla}</span>
              <div style="display:flex;align-items:center;gap:8px">
                <button onclick="cambiarStockInventario('${j.id}', '${m.id}', ${k!==null?k:0}, ${T}, -1)"
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div>
          ...
          <select class="form-input" id="f-categoria" required onchange="actualizarSKU()">
            ...
            ${Le.map(a=>`<option value="${a.value}" ${t.categoria===a.value?"selected":""}>${a.label}</option>`).join("")}
          </select>
        </div>
        <div>
...
${o.telefono?'<a href="https://wa.me/'+(o.lada||"52")+o.telefono.replace(/\D/g,"")+'" target="_blank" class="btn btn-secondary" style="background:#25D366;color:white;border-color:#25D366;margin-left:auto">WhatsApp</a>':""}      </div>
  ...
  `};window.guardarSalida=async()=>{const e=document.getElementById("sal").value,t=document.getElementById("sal-sucursal").value,o=document.getElementById("sal-cantidad").value,a=document.getElementById("sal-motivo").value;if(!e||!t||!o){alert("Por favor completa todos los campos");return}try{const r=await(await fetch(f+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:-parseInt(o),motivo:a})})).json();r.ok?(alert("Salida registrada. Anterior: "+r.cantidad_anterior+" pares ÔåÆ Nuevo: "+r.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(r))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const o=await(await fetch(f+"/sucursales/")).json(),n=await(await fetch(f+"/productos/")).json(),i=await(await fetch(f+"/variantes/")).json(),d=await(await fetch(f+"/inventario/")).json(),l=[...new Set(n.map(p=>p.categoria).filter(Boolean))],c=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:o,productos:n,variantes:i,inventario:d},e.innerHTML=`
    ...
    `,renderTablasMasivo()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:e,variantes:t,inventario:o}=window._invMasivo,a=document.getElementById("im-sucursal").value,n=document.getElementById("im-categoria").value,r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],i=e.filter(c=>!(n&&c.categoria!==n)),s=o.filter(c=>c.sucursal_id===a),d=i.map(c=>{const p=t.filter(g=>g.producto_id===c.id);if(p.length===0)return"";const u=[...new Set(p.map(g=>g.color).filter(Boolean))].map(g=>{const y=p.filter(h=>h.color===g).sort((h,v)=>r.indexOf(h.talla)-r.indexOf(v.talla));return`
        <div style="margin-bottom:1rem">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap">
            ${y.map(h=>{const v=s.find(I=>I.variante_id===h.id),w=v?v.cantidad:0,E=v?v.stock_minimo:3;let x="#ddd";return w===0?x="#ffcdd2":w<=E?x="#ffe082":x="#a5d6a7",`
                <div style="text-align:center">
  ...
  `};window.guardarTraspaso=async()=>{const e=document.getElementById("tra").value,t=document.getElementById("tra-origen").value,o=document.getElementById("tra-destino").value,a=document.getElementById("tra-cantidad").value;if(!e||!t||!o||!a){alert("Por favor completa todos los campos");return}if(t===o){alert("La sucursal origen y destino no pueden ser la misma");return}try{const r=await(await fetch(f+"/movimientos/traspaso",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_origen_id:t,sucursal_destino_id:o,cantidad:parseInt(a)})})).json();r.ok?(alert("Traspaso realizado correctamente. Se movieron "+r.cantidad_movida+" pares."),navegarA("inventario")):alert("Error: "+(r.error||JSON.stringify(r)))}catch{alert("Error conectando con el servidor")}};async function Je(){const e=document.getElementById("content");try{const o=await(await fetch(f+"/pedidos/")).json();e.innerHTML=`
      <div style="margin-bottom:1rem;display:flex;gap:8px;flex-wrap:wrap;align-items:center">
  ...
  `,document.body.appendChild(c),c.addEventListener("click",p=>{p.target===c&&c.remove()}),window._posSeleccion={productoId:e,color:null},window._posBuffer={}};window.mostrarCorridaModalPOS=e=>{const{variantes:t,inventario:o}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=o.filter(p=>p.sucursal_id===a),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],i=[...new Set(t.filter(p=>p.producto_id===e).map(p=>p.color).filter(Boolean))],s=document.querySelector(`button[onclick="mostrarCorridaModalPOS('${e}')"]`);s&&(s.style.display="none"),document.querySelectorAll("#pos-modal").forEach(p=>{p!==document.getElementById("pos-modal")&&p.remove()}),window._posSeleccion.color=null,window._corridaCantidades={};const d=document.getElementById("pos-tallas-panel");if(!d)return;const l=p=>{const m=t.filter(u=>u.producto_id===e&&u.color===p).sort((u,g)=>r.indexOf(u.talla)-r.indexOf(g.talla));m.filter(u=>{const g=n.find(y=>y.variante_id===u.id);return g&&g.cantidad>0}),d.innerHTML=`
    ...
    `)};window.sugerirCorrida=(e,t)=>{const{variantes:o,inventario:a}=window._posData,n=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=a.filter(c=>c.sucursal_id===n),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],s=o.filter(c=>c.producto_id===e&&c.color===t).sort((c,p)=>i.indexOf(c.talla)-i.indexOf(p.talla)),d=s.filter(c=>{const p=r.find(m=>m.variante_id===c.id);return p&&p.cantidad>0}),l=d.some(c=>c.talla.includes("."));if(s.forEach(c=>{window._corridaCantidades[c.id]=0}),l)d.slice(0,6).forEach(c=>{window._corridaCantidades[c.id]=1});else{const c=d.slice(0,5);c.length>=4?c.forEach((p,m)=>{window._corridaCantidades[p.id]=m===1||m===2?2:1}):d.slice(0,6).forEach(p=>{window._corridaCantidades[p.id]=Math.ceil(6/d.length)})}window.renderCorridaColor(t)};window.confirmarCorridaNueva=e=>{const{variantes:t}=window._posData,o=window._posData.productos.find(r=>r.id===e);if(!o)return;let a=0;if(Object.entries(window._corridaCantidades).forEach(([r,i])=>{var l;if(i<=0)return;const s=t.find(c=>c.id===r);if(!s)return;const d=window._posCarrito.find(c=>c.variante_id===r&&c.es_corrida);d?(d.cantidad+=i,d.es_corrida=!0):window._posCarrito.push({variante_id:r,producto_id:e,nombre:o.nombre,color:s.color,talla:s.talla,cantidad:i,precio_menudeo:parseFloat(o.precio_menudeo)||0,precio_mayoreo3:parseFloat(o.precio_mayoreo3)||parseFloat(o.precio_menudeo)-30,precio_mayoreo6:parseFloat(o.precio_mayoreo6)||parseFloat(o.precio_menudeo)-70,precio_corrida:parseFloat(o.precio_corrida)||parseFloat(o.precio_menudeo)-100,es_corrida:!0,imagen:((l=window._posData.variantes.find(c=>c.id===r))==null?void 0:l.foto_url)||o.imagen_principal||null,precio_unitario:parseFloat(o.precio_corrida)||parseFloat(o.precio_menudeo)-100}),a++}),a===0){alert("Agrega al menos una talla");return}const n=document.getElementById("pos-modal");n&&n.remove(),window._corridaCantidades={},renderCarritoPOS()};window.seleccionarColorModalPOS=(e,t)=>{const{variantes:o,inventario:a}=window._posData,n=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=a.filter(u=>u.sucursal_id===n),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._posSeleccion&&window._posSeleccion.color&&guardarBufferColor(e,window._posSeleccion.color),document.querySelectorAll('[id^="pos-color-btn-"]').forEach(u=>{u.style.borderColor="#ddd",u.style.background="transparent"});const s=document.getElementById("pos-color-btn-"+t.replace(/\s/g,"_"));s&&(s.style.borderColor="#E91E8C",s.style.background="#fce4f3"),window._posSeleccion.color=t;const d=o.filter(u=>u.producto_id===e&&u.color===t).sort((u,g)=>i.indexOf(u.talla)-i.indexOf(g.talla)),l=d[0]?d[0].foto_url:null,c=document.getElementById("pos-modal-img");c&&l&&(c.src=l);const p=window._posBuffer[t]||{},m=document.getElementById("pos-tallas-panel");m&&(m.innerHTML=`
      ...
      <div style="display:flex;flex-direction:column;gap:8px">
        ${d.map(u=>{const g=r.find(h=>h.variante_id===u.id),y=g?g.cantidad:0,b=p[u.id]||0;return`
            <div style="display:flex;align-items:center;gap:10px;opacity:${y===0?"0.4":"1"}">
...
`).join("")}
    ...
    <div style="background:white;border-radius:16px;max-width:400px;width:100%;padding:1.5rem;max-height:90vh;overflow-y:auto">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${d.map(c=>{const p=i.find(y=>y.variante_id===c.id),m=p?p.cantidad:0,u=window._posCarrito.find(y=>y.variante_id===c.id&&y.es_corrida),g=u?u.cantidad:0;return`
            <div style="display:flex;align-items:center;gap:10px">
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
        ...
        </tr>`}).join(""))};async function Xe(){try{const t=await(await fetch(f+"/pedidos/")).json(),a=await(await fetch(f+"/clientes/")).json(),r=await(await fetch(f+"/inventario/alertas")).json(),i=new Date;i.setHours(0,0,0,0);const s=new Date(i);s.setDate(s.getDate()-7);const d=new Date(i);d.setDate(d.getDate()-30);const l=t.filter($=>$.status==="confirmado"||$.status==="pagado"),c=l.filter($=>new Date($.created_at)>=i),p=l.filter($=>new Date($.created_at)>=s),m=c.reduce(($,P)=>$+parseFloat(P.total||0),0),u=p.reduce(($,P)=>$+parseFloat(P.total||0),0),g=a.filter($=>$.created_at&&new Date($.created_at)>=d).length,y=["Dom","Lun","Mar","Mie","Jue","Vie","Sab"],b={};y.forEach($=>b[$]=0),l.filter($=>new Date($.created_at)>=d).forEach($=>{const P=y[new Date($.created_at).getDay()];b[P]+=parseFloat($.total||0)});const h={};l.forEach($=>{h[$.canal||"sucursal"]=(h[$.canal||"sucursal"]||0)+parseFloat($.total||0)});const v={};l.forEach($=>{v[$.forma_pago||"efectivo"]=(v[$.forma_pago||"efectivo"]||0)+1});const w={};l.forEach($=>{w[$.empleado||"Admin"]=(w[$.empleado||"Admin"]||0)+parseFloat($.total||0)});const E={};l.forEach($=>{const P=new Date($.created_at).toLocaleDateString("es-MX",{month:"short",year:"numeric"});E[P]=(E[P]||0)+parseFloat($.total||0)});const x={};l.forEach($=>{$.clientes&&(x[$.clientes.nombre]=(x[$.clientes.nombre]||0)+parseFloat($.total||0))});const I=Object.entries(x).sort(($,P)=>P[1]-$[1]).slice(0,5),_=Object.entries(b).sort(($,P)=>P[1]-$[1])[0],C=Object.entries(w).sort(($,P)=>P[1]-$[1])[0];if(!document.getElementById("dashboard-contenido"))return;const M=l.filter($=>new Date($.created_at)>=d),k=M.reduce(($,P)=>$+parseFloat(P.total||0),0),T=[];for(let $=6;$>=0;$--){const P=new Date(i);P.setDate(P.getDate()-$);const O=P.toISOString().split("T")[0],L=P.toLocaleDateString("es-MX",{weekday:"short",day:"numeric"}),H=l.filter(D=>{var A;return(A=D.created_at)==null?void 0:A.startsWith(O)}).reduce((D,A)=>D+parseFloat(A.total||0),0);T.push({label:L,total:H,ds:O})}const S=($,P,O,L)=>{const H=document.getElementById($),D=document.getElementById($+"-sub");H&&(H.textContent=P,L&&(H.style.color=L)),D&&O&&(D.textContent=O)};S("kpi-ventas-hoy","$"+m.toLocaleString("es-MX",{maximumFractionDigits:0}),c.length+" pedidos","#C8967A"),S("kpi-pedidos-hoy",c.length,"confirmados"),S("kpi-ventas-7d","$"+u.toLocaleString("es-MX",{maximumFractionDigits:0}),p.length+" pedidos"),S("kpi-ventas-30d","$"+k.toLocaleString("es-MX",{maximumFractionDigits:0}),M.length+" pedidos"),S("kpi-clientes-nuevos",g,"últimos 30 días"),S("kpi-stock-bajo",r.length,r.length>0?"⚠ reabastecer":"✓ ok",r.length>0?"#f59e0b":"#10b981"),S("kpi-mejor-dia",_?_[0]:"—",_?"$"+_[1].toLocaleString("es-MX",{maximumFractionDigits:0}):""),S("kpi-total-clientes",a.length,"registrados");const z=document.getElementById("dash-top-clientes");z&&(z.innerHTML=I.length===0?'<p style="color:var(--text-muted);font-size:0.85rem">Sin datos aun</p>':I.map(([$,P],O)=>`
...
<div>
  ...
  <div style="display:flex;gap:1rem;flex-wrap:wrap">
    ...
    <div class="table-card">
      ...
      </div>`}catch(o){t.innerHTML='<p style="color:red">Error: '+o.message+"</p>"}}window._toggleGenProd=function(e){const{seleccionados:t}=window._generadorData,o=document.getElementById("gen-item-"+e),a=document.getElementById("gen-colores-"+e);t.has(e)?(t.delete(e),o.style.borderColor="transparent",a&&(a.style.opacity="0.35",a.style.pointerEvents="none")):(t.add(e),o.style.borderColor="#C8967A",a&&(a.style.opacity="1",a.style.pointerEvents="auto")),document.getElementById("gen-count").textContent=t.size+" seleccionados"};window._toggleColorGen=function(e,t){var n,r;const o=document.getElementById(`gen-col-${e}-${t}`);if(!o)return;const a=o.dataset.sel==="1";o.dataset.sel=a?"0":"1",o.style.borderColor=a?"#ccc":"#C8967A",o.style.opacity=a?"0.3":"1",o.title=(((r=(n=window._generadorData.coloresPorProd[e])==null?void 0:n[t])==null?void 0:r.color)||"")+(a?" (excluido)":"")};window._selTodosGenerador=function(){const{productos:e,seleccionados:t}=window._generadorData,o=t.size===e.length;t.clear(),e.forEach((a,n)=>{const r=document.getElementById("gen-item-"+n);o?r&&(r.style.borderColor="transparent"):(t.add(n),r&&(r.style.borderColor="#C8967A"))}),document.getElementById("gen-count").textContent=t.size+" seleccionados"};function se(e){return new Promise(t=>{const o=new Image;o.crossOrigin="anonymous",o.onload=()=>t(o),o.onerror=()=>t(null),o.src=e+(e.includes("?")?"&":"?")+"_t="+Date.now()})}function be(e,t,o,a,n,r){const i=t.split(" ");let s="",d=a;for(let l of i){const c=s+(s?" ":"")+l;e.measureText(c).width>n&&s?(e.fillText(s,o,d),s=l,d+=r):s=c}return s&&e.fillText(s,o,d),d+r}window.generarPaginasCanvas=async function(e){const{productos:t,variantes:o,seleccionados:a,coloresPorProd:n}=window._generadorData;if(!a.size){alert("Selecciona al menos un producto");return}const r=document.getElementById("gen-layout").value,i=r==="1e"?1:parseInt(r),s=[];Array.from(a).sort((b,h)=>b-h).forEach(b=>{const h=t[b],v=n?n[b]:[];if(!v||v.length<=1)s.push({prod:h,origIdx:b,colorFiltro:null,todosColSel:v||[]});else{const w=v.filter((x,I)=>{const _=document.getElementById(`gen-col-${b}-${I}`);return!_||_.dataset.sel!=="0"}),E=w.length>0?w:v;for(const x of E)s.push({prod:h,origIdx:b,colorFiltro:x.color,todosColSel:E})}});const d=b=>{const h=o.filter(v=>v.producto_id===b.prod.id&&v.activa!==!1);return b.colorFiltro?h.filter(v=>(v.color||"").trim()===b.colorFiltro):h},l=[];for(let b=0;b<s.length;b+=i)l.push(s.slice(b,b+i));const c=document.getElementById("btn-generar"),p=document.getElementById("gen-progress"),m=document.getElementById("gen-msg"),u=document.getElementById("gen-bar");c.disabled=!0,p.style.display="block";const{paginas:g}=window._catalogoPaginasData;let y=g.length>0?Math.max(...g.map(b=>b.pagina_numero))+1:1;for(let b=0;b<l.length;b++){const h=l[b],v=C=>(C==null?void 0:C.prod)??C,w=C=>(C==null?void 0:C.origIdx)??t.indexOf((C==null?void 0:C.prod)??C);m.textContent=`Generando página ${b+1} de ${l.length}...`,u.style.width=b/l.length*100+"%";const E=document.createElement("canvas");E.width=1080,E.height=1440;const x=E.getContext("2d");if(x.fillStyle="#FAFAF8",x.fillRect(0,0,1080,1440),x.fillStyle="#C8967A",x.fillRect(60,48,960,1),x.fillStyle="#2A1A0E",x.font="300 22px DM Sans, sans-serif",x.textAlign="center",x.letterSpacing="8px",x.fillText("ZAPATILLAS MAY",540,42),x.letterSpacing="0px",x.fillStyle="#C8967A",x.fillRect(60,58,960,1),r==="1e"){const C=h[0],j=v(C),M=d(C),k=[],T=new Set,S=A=>{A&&!T.has(A)&&(T.add(A),k.push(A))};M.length>0&&M[0].foto_url?S(M[0].foto_url):S(j.imagen_principal);for(const A of M)if(S(A.foto_url),Array.isArray(A.imagenes)&&A.imagenes.forEach(S),k.length>=3)break;const z=k.length,B=(C.todosColSel||[]).map(A=>({color:A.color,hex:A.hex})),$={negro:"#1C1C1C",blanco:"#F8F8F8",hueso:"#F0EBE1",beige:"#D9C9A8",camel:"#C19A6B","cafe claro":"#A0725A","cafe medio":"#7A4A30","cafe oscuro":"#4A2010",cafe:"#6B3A2A",chocolate:"#3D1C02",cognac:"#9B4421",taupe:"#8B7355",nude:"#D4A97A","nude claro":"#E8C9A8","nude oscuro":"#C0886A","nude rosa":"#DDA090","palo de rosa":"#D4A0A0",salmon:"#FA8072",coral:"#FF6B4A",rojo:"#CC2200",vino:"#722F37",bordo:"#800020","rosa claro":"#F9C0CB",rosa:"#F4607A",fusha:"#E91E8C",naranja:"#FF8C00",amarillo:"#F5C518",dorado:"#D4AF37",oro:"#CFB53B","oro rosa":"#E8B4B8",plateado:"#C0C0C0","azul claro":"#5B8DB8",azul:"#1E4080","azul marino":"#001F5B",turquesa:"#40C4AA",verde:"#2D6A4F","verde menta":"#98D8C8","gris claro":"#C8C8C8",gris:"#909090","gris oscuro":"#505050",morado:"#7B2D8B",lila:"#C8A0D8",multicolor:"#CCAA88"},P=({color:A,hex:R})=>{if(R&&R.startsWith("#"))return R;const F=(A||"").toLowerCase();if($[F])return $[F];for(const[N,G]of Object.entries($))if(F.includes(N))return G;return"#BBAA99"},O=(A,R,F,N,G)=>{if(x.save(),x.fillStyle="#FFFFFF",x.fillRect(R,F,N,G),A){x.beginPath(),x.rect(R,F,N,G),x.clip();const V=A.naturalWidth/A.naturalHeight,X=N/G;let q,U,Z,W;V>X?(Z=N,W=N/V,q=R,U=F+(G-W)/2):(W=G,Z=G*V,U=F,q=R+(N-Z)/2),x.drawImage(A,q,U,Z,W)}x.restore()},L=62,H=1080,D=L+H+12;if(z>=3){const[A,R,F]=await Promise.all(k.slice(0,3).map(se)),N=10,G=10,V=648,X=1080-V-N,q=Math.floor((H-G)/2);O(A,0,L,V,H),O(R,V+N,L,X,q),O(F,V+N,L+q+G,X,q)}else if(z===2){const[A,R]=await Promise.all(k.map(se)),F=10,N=Math.floor((1080-F)/2);O(A,0,L,N,H),O(R,N+F,L,N,H)}else{const[A]=await Promise.all([se(k[0])]);O(A,40,L,1e3,H)}if(x.fillStyle="#E8DDD5",x.fillRect(0,D,1080,1),x.fillStyle="#2A1A0E",x.textAlign="center",x.font="300 28px DM Sans, sans-serif",x.letterSpacing="3px",be(x,j.nombre.toUpperCase(),540,D+42,960,38),x.letterSpacing="0px",j.sku&&(x.fillStyle="#A07860",x.font="400 14px DM Mono, monospace",x.fillText(j.sku,540,D+66)),B.length>0){const F=Math.min(B.length,14),N=F*(11*2)+(F-1)*8;let G=Math.round(540-N/2+11);const V=D+100;for(let X=0;X<F;X++){const q=G+X*30;x.beginPath(),x.arc(q,V,11,0,Math.PI*2),x.fillStyle=P(B[X]),x.fill(),x.strokeStyle="rgba(0,0,0,0.18)",x.lineWidth=1.5,x.stroke()}}}else{const C=i<=2?i:2,j=i===4?2:1,M=80,k=100,T=i===1?0:20,S=i===4?20:0,z=i===1?40:28,B=(1080-z*2-T*(C-1))/C,$=(1440-M-k-S*(j-1))/j;for(let P=0;P<h.length;P++){const O=v(h[P]);w(h[P]);const L=P%C,H=Math.floor(P/C),D=z+L*(B+T),A=M+H*($+S),R=i===1?120:i===2?90:70,F=$-R,N=d(h[P]),G=N.length>0&&N[0].foto_url?N[0].foto_url:O.imagen_principal,V=await se(G);if(x.save(),x.fillStyle="#FFFFFF",x.fillRect(D,A,B,F),V){x.beginPath(),x.rect(D,A,B,F),x.clip();const U=V.naturalWidth/V.naturalHeight,Z=B/F;let W,ce,re,ie;U>Z?(re=B,ie=B/U,W=D,ce=A+(F-ie)/2):(ie=F,re=F*U,ce=A,W=D+(B-re)/2),x.drawImage(V,W,ce,re,ie)}x.restore(),x.fillStyle="#E8DDD5",x.fillRect(D,A+F,B,1);const X=A+F+R/2;x.fillStyle="#2A1A0E",x.textAlign="center";const q=i===1?34:i===2?24:19;x.font=`300 ${q}px DM Sans, sans-serif`,x.letterSpacing="2px",be(x,O.nombre.toUpperCase(),D+B/2,X-8,B-32,q+10),x.letterSpacing="0px",O.sku&&(x.fillStyle="#A07860",x.font=`400 ${i===1?18:13}px DM Mono, monospace`,x.fillText(O.sku,D+B/2,X+(i===1?36:26)))}}x.fillStyle="#C8967A",x.fillRect(60,1340,960,1),x.fillStyle="#A07860",x.font="300 18px DM Sans, sans-serif",x.textAlign="center",x.letterSpacing="3px",x.fillText("@ZAPATILLASMAY",540,1368),x.letterSpacing="0px",x.fillStyle="#C0A898",x.font="300 15px DM Sans, sans-serif",x.fillText("zapatillasmay.mx  ·  León, Guanajuato",540,1394);const I=await new Promise(C=>E.toBlob(C,"image/jpeg",.92)),_=new FormData;_.append("archivo",I,`catalogo-pag-${y}.jpg`);try{const j=await(await fetch(f+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:_})).json();j.url&&await fetch(f+"/catalogos/"+e+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:j.url,pagina_numero:y++})})}catch(C){console.error("Error subiendo página generada",C)}}u.style.width="100%",m.textContent=`✅ ${l.length} páginas generadas`,setTimeout(()=>{p.style.display="none"},2e3),c.disabled=!1,await gestionarPaginas(e,window._catalogoPaginasData.nombre)};window.descargarCatalogoPorCategoria=async function(e,t){const o=document.getElementById("cat-pdf-msg"),a=document.querySelectorAll("#cat-pdf-btns button");a.forEach(n=>n.disabled=!0),o&&(o.style.display="block",o.textContent=`⏳ Cargando productos de ${t}...`);try{const[n,r]=await Promise.all([fetch(f+`/productos/?categoria=eq.${e}&activo=eq.true&order=nombre.asc`),fetch(f+"/variantes/")]),i=await n.json(),s=await r.json();if(!i.length){o&&(o.textContent=`Sin productos activos en ${t}`),a.forEach(k=>k.disabled=!1);return}o&&(o.textContent=`✏️ Generando PDF (${i.length} productos)...`),window.jspdf||await new Promise((k,T)=>{const S=document.createElement("script");S.src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js",S.onload=k,S.onerror=T,document.head.appendChild(S)});const{jsPDF:d}=window.jspdf,l=2,c=2,p=l*c,m=1080,u=1440,g=40,y=16,b=70,h=80,v=(m-g*2-y*(l-1))/l,w=(u-b-h-y*(c-1))/c,E=60,x=k=>new Promise(T=>{if(!k)return T(null);const S=new Image;S.crossOrigin="anonymous",S.onload=()=>T(S),S.onerror=()=>T(null),S.src=k}),I=(k,T,S,z,B,$)=>{if(k.save(),k.fillStyle="#FFFFFF",k.fillRect(S,z,B,$),T){k.beginPath(),k.rect(S,z,B,$),k.clip();const P=T.naturalWidth/T.naturalHeight,O=B/$;let L,H,D,A;P>O?(D=B,A=B/P,L=S,H=z+($-A)/2):(A=$,D=$*P,H=z,L=S+(B-D)/2),k.drawImage(T,L,H,D,A)}k.restore()},_=[];for(let k=0;k<i.length;k+=p)_.push(i.slice(k,k+p));const C=new d({orientation:"portrait",unit:"px",format:[m,u]});let j=!0;for(let k=0;k<_.length;k++){o&&(o.textContent=`✏️ Página ${k+1} de ${_.length}...`);const T=_[k],S=document.createElement("canvas");S.width=m,S.height=u;const z=S.getContext("2d");z.fillStyle="#FAFAF8",z.fillRect(0,0,m,u),z.fillStyle="#C8967A",z.fillRect(g,36,m-g*2,1),z.fillStyle="#2A1A0E",z.font="300 20px sans-serif",z.textAlign="center",z.letterSpacing="8px",z.fillText("ZAPATILLAS MAY",m/2,32),z.letterSpacing="3px",z.font="400 13px sans-serif",z.fillStyle="#A07860",z.fillText(t.replace(/^[^\s]+\s/,"").toUpperCase(),m/2,54),z.letterSpacing="0px",z.fillStyle="#C8967A",z.fillRect(g,62,m-g*2,1);for(let $=0;$<T.length;$++){const P=T[$],O=$%l,L=Math.floor($/l),H=g+O*(v+y),D=b+L*(w+y),A=w-E,R=s.filter(V=>V.producto_id===P.id&&V.activa!==!1),F=R.length>0&&R[0].foto_url?R[0].foto_url:P.imagen_principal,N=await x(F);I(z,N,H,D,v,A),z.fillStyle="#E8DDD5",z.fillRect(H,D+A,v,1),z.fillStyle="#2A1A0E",z.textAlign="center",z.font="600 18px sans-serif";const G=P.nombre.length>28?P.nombre.substring(0,26)+"…":P.nombre;z.fillText(G.toUpperCase(),H+v/2,D+A+26),P.precio_menudeo&&(z.fillStyle="#C8967A",z.font="400 15px sans-serif",z.fillText(`$${Number(P.precio_menudeo).toFixed(0)} MXN`,H+v/2,D+A+48))}z.fillStyle="#C8967A",z.fillRect(g,u-h,m-g*2,1),z.fillStyle="#A07860",z.textAlign="center",z.font="300 16px sans-serif",z.letterSpacing="3px",z.fillText("@ZAPATILLASMAY",m/2,u-50),z.letterSpacing="0px",z.fillStyle="#C0A898",z.font="300 13px sans-serif",z.fillText("zapatillasmay.mx  ·  León, Guanajuato",m/2,u-28);const B=S.toDataURL("image/jpeg",.88);j||C.addPage(),C.addImage(B,"JPEG",0,0,m,u),j=!1}const M=`catalogo-${e}-zapatillasmay.pdf`;C.save(M),o&&(o.textContent=`✅ Descargado: ${M}`,setTimeout(()=>{o.style.display="none"},4e3))}catch(n){console.error(n),o&&(o.textContent="Error generando el PDF: "+n.message)}finally{a.forEach(n=>n.disabled=!1)}};window.subirPaginasCatalogo=async function(e,t){const o=Array.from(e.files||e);if(!o.length)return;const a=document.getElementById("upload-progress"),n=document.getElementById("upload-msg"),r=document.getElementById("upload-bar");a&&(a.style.display="block");const{paginas:i}=window._catalogoPaginasData;let s=i.length>0?Math.max(...i.map(d=>d.pagina_numero))+1:1;for(let d=0;d<o.length;d++){n&&(n.textContent=`Subiendo ${d+1} de ${o.length}...`),r&&(r.style.width=d/o.length*100+"%");try{const l=new FormData;l.append("archivo",o[d]);const p=await(await fetch(f+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:l})).json();p.url&&await fetch(f+"/catalogos/"+t+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:p.url,pagina_numero:s++})})}catch(l){console.error("Error subiendo página "+(d+1),l)}}r&&(r.style.width="100%"),n&&(n.textContent="✅ Listo"),setTimeout(()=>{a&&(a.style.display="none")},1500),e.value!==void 0&&(e.value=""),await gestionarPaginas(t,window._catalogoPaginasData.nombre)};window.moverPagina=async function(e,t){const{paginas:o,catalogoId:a,nombre:n}=window._catalogoPaginasData,r=o.findIndex(l=>l.id===e);if(r===-1)return;const i=t==="up"?r-1:r+1;if(i<0||i>=o.length)return;const s=o[r].pagina_numero,d=o[i].pagina_numero;await Promise.all([fetch(f+"/catalogos/paginas/"+o[r].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:d})}),fetch(f+"/catalogos/paginas/"+o[i].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:s})})]),await gestionarPaginas(a,n)};window.eliminarPagina=async function(e,t){confirm("¿Eliminar esta página?")&&(await fetch(f+"/catalogos/paginas/"+e,{method:"DELETE"}),await gestionarPaginas(t,window._catalogoPaginasData.nombre))};window.usarComoPortada=async function(e,t){await fetch(f+"/catalogos/"+t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({portada_url:e})}),alert("✅ Portada actualizada")};window.mlVerStock=async function(e){const t=e.innerHTML;e.innerHTML="⏳ Consultando...",e.disabled=!0;const o=document.getElementById("ml-resultado");try{const n=await(await fetch(f+"/ml/stock")).json();if(o.style.display="block",n.diferencias&&n.diferencias.length>0){const r=n.diferencias.map(i=>`${i.item_id} | SKU: ${i.seller_sku} | ML: ${i.qty_ml} | ERP: ${i.qty_erp}`).join(`
...
`})})),n.textContent=b}}catch(m){n.style.display="block",n.textContent="Error inesperado: "+m.message}finally{t.innerHTML=r,t.disabled=!1}}window.mlPublicarPreview=function(e){Pe(!0,e)};window.mlPublicarReal=function(e){confirm("¿Publicar TODAS las variantes activas de este producto en MercadoLibre? Esto creará nuevos items en tu cuenta.")&&Pe(!1,e)};window.descargarExcelTikTok=async function(e,t,o){const a=e.innerHTML;try{e.innerHTML="⏳ Generando...",e.disabled=!0;const n=await fetch(`${f}/tiktok/${t}`);if(!n.ok){const d=await n.text();throw new Error(`Error ${n.status}: ${d}`)}const r=await n.blob(),i=URL.createObjectURL(r),s=document.createElement("a");s.href=i,s.download=o,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(i)}catch(n){alert("Error al descargar el archivo: "+n.message)}finally{e.innerHTML=a,e.disabled=!1}};async function Ye(){const e=document.getElementById("content");e.innerHTML=`
  ...
  `,document.getElementById("ml-titulo").addEventListener("input",function(){document.getElementById("ml-titulo-count").textContent=this.value.length}),window.mlGenerarPreview=async()=>{var d,l,c,p;const o=document.getElementById("ml-sku").value.trim().toUpperCase(),a=document.getElementById("ml-listing").value,n=document.getElementById("ml-titulo").value.trim(),r=document.getElementById("ml-precio").value.trim(),i=r?parseFloat(r):null;if(!o){alert("Ingresa el SKU del producto");return}if(!n){alert("Ingresa el título para ML");return}if(n.length>60){alert("El título no puede superar 60 caracteres");return}if(i!==null&&(isNaN(i)||i<=0)){alert("El precio debe ser mayor a 0");return}const s=document.getElementById("ml-btn-preview");s.textContent="⏳ Generando...",s.disabled=!0;try{const m=await fetch(`${f}/ml/publicar`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sku_interno:o,listing_type:a,solo_preview:!0})}),u=await m.json();if(!m.ok){alert("Error: "+(u.detail||JSON.stringify(u)));return}const g=u.resultados||[];if(!g.length){alert("No se encontraron variantes activas");return}const y=document.getElementById("ml-descripcion"),b=((c=(l=(d=g[0])==null?void 0:d.preview)==null?void 0:l.description)==null?void 0:c.plain_text)||"";y.value.trim()||(y.value=b);const h={},v=[],w=new Set;for(const j of g){const M=j.color||"Sin color";h[M]||(h[M]=[]);for(const k of((p=j.preview)==null?void 0:p.pictures)||[])k.source&&(h[M].find(T=>T.source===k.source)||h[M].push(k),w.has(k.source)||(w.add(k.source),v.push(k)))}const E={},x=new Set;for(const j of Object.keys(h))E[j]=0,x.add(j);const I=Object.keys(h);if(I.length>0){const j=document.getElementById("ml-fotos-wrap"),M=document.getElementById("ml-fotos-grid"),k=()=>{T();const S=g.filter(z=>x.has(z.color||"Sin color"));t(S,n,i,E,y.value.trim(),h)},T=()=>{M.innerHTML=I.map(S=>{const z=h[S];if(!z.length)return"";const B=x.has(S),$=S.replace(/'/g,"\\'"),P=S.replace(/[^a-zA-Z0-9]/g,"_");return`
                ...
                <div style="display:flex;gap:8px;flex-wrap:wrap;padding-left:24px">
                  ${z.map((O,L)=>`
                    <div onclick="${B?`mlSeleccionarPortadaColor('${$}',${L})`:""}"
                         id="ml-foto-${P}-${L}"
                         style="cursor:${B?"pointer":"default"};border:3px solid ${L===E[S]&&B?"#3483fa":"#ddd"};border-radius:8px;overflow:hidden;width:80px;height:80px;position:relative;flex-shrink:0">
                      <img src="${O.source}" style="width:100%;height:100%;object-fit:cover">
                      ${L===E[S]&&B?'<div style="position:absolute;bottom:0;left:0;right:0;background:#3483fa;color:#fff;font-size:0.55rem;text-align:center;padding:2px;font-weight:700">PORTADA</div>':""}
                    </div>
                  `).join("")}
                </div>
              </div>`}).join("")};T(),j.style.display="block",window.mlToggleColor=S=>{x.has(S)?x.delete(S):x.add(S),k()},window.mlSeleccionarPortadaColor=(S,z)=>{E[S]=z,k()}}const _=g.filter(j=>x.has(j.color||"Sin color"));t(_,n,i,E,y.value.trim(),h);const C=document.getElementById("ml-variantes-wrap");C.style.display="block",C.scrollIntoView({behavior:"smooth",block:"start"})}catch(m){alert("Error de conexión: "+m.message)}finally{s.textContent="🔍 Generar preview",s.disabled=!1}};function t(o,a,n,r,i,s){const d=document.getElementById("ml-variantes-titulo"),l=document.getElementById("ml-variantes-list");d.textContent=`Paso 2 — Revisa y edita (${o.length} variantes, título aplicado a todas)`,l.innerHTML=o.map((c,p)=>{const m={...c.preview,family_name:a};if(delete m.title,n!==null&&(m.price=n),i&&(m.description={plain_text:i}),s){const u=c.color||"Sin color",g=s[u]||[],y=r&&r[u]||0;let b=[...g];if(y>0&&y<b.length){const[h]=b.splice(y,1);b.unshift(h)}if(b.length<3&&s){for(const[h,v]of Object.entries(s))if(h!==u){for(const w of v)if(b.find(E=>E.source===w.source)||b.push(w),b.length>=12)break;if(b.length>=12)break}}m.pictures=b.slice(0,12)}return`
      ...
      `).join("")||'<p style="color:#888">Sin detalles</p>'}catch(l){s.textContent="❌ Error de conexión",d.innerHTML=`<p style="color:red">${l.message}</p>`}finally{r.textContent="🚀 Publicar todas en ML",r.disabled=!1}}}let J=[],Q="";async function Qe(){const e=document.getElementById("content");e.innerHTML=`
    <style>
  ...
  `,await tt(),Y=setInterval(async()=>{document.getElementById("ga-activos")?await Be():(clearInterval(Y),Y=null)},3e4)}async function tt(){await Promise.all([Be(),ot(),at()]),document.getElementById("ga-ultima-act").textContent="Actualizado: "+new Date().toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}async function Be(){var e;try{const o=await(await fetch(`${f}/analytics/tiempo-real`)).json();if(!o.configurado){nt(o);return}const a=document.getElementById("ga-activos");if(!a)return;a.textContent=o.activos_ahora??0;const n=document.getElementById("ga-dispositivos");n&&o.por_dispositivo&&(n.textContent=Object.entries(o.por_dispositivo).map(([i,s])=>`${i}: ${s}`).join(" · "));const r=document.getElementById("ga-paginas-rt");r&&((e=o.por_pais)!=null&&e.length)?r.innerHTML='<div style="font-size:0.65rem;color:#aaa;margin-bottom:4px;text-transform:uppercase;letter-spacing:.05em">Por país</div>'+o.por_pais.map(i=>`
          ...
          </div>`).join(""):i.innerHTML='<p style="color:#bbb;font-size:0.82rem;margin:0">Sin datos de páginas aún</p>')}catch(t){console.warn("GA hoy:",t.message)}}async function at(){var e;try{const o=await(await fetch(`${f}/analytics/semana`)).json();if(!o.configurado||!((e=o.dias)!=null&&e.length))return;const a=document.getElementById("ga-chart");if(!a||!window.Chart)return;a._chartInstance&&a._chartInstance.destroy(),a._chartInstance=new Chart(a,{type:"bar",data:{labels:o.dias.map(n=>n.fecha),datasets:[{label:"Sesiones",data:o.dias.map(n=>n.sesiones),backgroundColor:"rgba(52,131,250,0.7)",borderRadius:4},{label:"Usuarios",data:o.dias.map(n=>n.usuarios),backgroundColor:"rgba(34,197,94,0.5)",borderRadius:4}]},options:{responsive:!0,plugins:{legend:{position:"top"}},scales:{y:{beginAtZero:!0,ticks:{precision:0}}}}})}catch(t){console.warn("GA semana:",t.message)}}function nt(e){const t=document.getElementById("ga-setup"),o=document.getElementById("ga-setup-body");!t||!o||(t.style.display="block",o.innerHTML=`
    ...
    `}catch(t){e.innerHTML=`<p style="padding:2rem;color:red">Error cargando referidos: ${t.message}</p>`}}function rt(e,t){const o=parseFloat(e.credito_disponible||0),a=e.referido_por?t[e.referido_por]||e.referido_por:"—",n=o>0?"#2e7d32":"#aaa";return`<tr id="ref-row-${e.id}" style="border-bottom:1px solid #f5f5f5">
...
Nuevo monto:`,o);if(a===null)return;const n=parseFloat(a);if(isNaN(n)||n<0)return alert("Monto inválido");try{(await fetch(f+"/clientes/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({credito_disponible:n})})).ok?await ge():alert("Error actualizando crédito")}catch(r){alert("Error: "+r.message)}};async function fe(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando carritos...</p>';try{const[t,o,a]=await Promise.all([fetch(f+"/pedidos/?status=borrador").then(r=>r.json()).catch(()=>[]),fetch(f+"/clientes/").then(r=>r.json()),fetch(f+"/sucursales/").then(r=>r.json())]),n=Array.isArray(t)?t.filter(r=>r.status==="borrador"&&(!r.canal||r.canal==="sucursal"||r.canal==="mayoreo")):[];e.innerHTML=`
    ...
    <div style="max-width:860px">
      ...
      <div class="table-card" style="padding:1.2rem">
        ...
        <div id="carrito-items-lista">
          ...
          ${(()=>{const m={};return a.forEach((u,g)=>{const y=u.variantes||{},b=y.productos||{},h=b.nombre||u.nombre||"—",v=y.color||u.color||"",w=!!u.es_corrida,E=w?"c|"+h+"|"+v:"s|"+u.id;m[E]||(m[E]={nombre:h,color:v,esCorrida:w,items:[],imagen:y.foto_url||b.imagen_principal||null}),m[E].items.push({...u,_idx:g})}),Object.values(m).map(u=>{const g=u.esCorrida,y=u.imagen;if(g){const b=u.items.reduce((E,x)=>E+x.cantidad,0),h=u.items.reduce((E,x)=>E+x.cantidad*x.precio_unitario,0),v=(h/b).toFixed(2),w=u.items.map(E=>E.id).join(",");return`
                  <div style="background:#fdf4ff;border-radius:8px;padding:12px;margin-bottom:8px;border:1px solid #e8d5f5">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
                      <span id="corrida-header-${w.replace(/,/g,"_").substring(0,20)}" style="font-size:0.85rem;color:#888">${b} pares · <strong style="color:#6a1b9a">$${h.toFixed(2)}</strong></span>
                      <div style="display:flex;align-items:center;gap:4px">
                        <span style="font-size:0.72rem;color:#888">$</span>
                    ...
                    <div id="corrida-detalle-${w.replace(/,/g,"_").substring(0,20)}" style="display:none;margin-top:10px;border-top:1px solid #e8d5f5;padding-top:10px">
                      ${u.items.map(E=>{const I=(E.variantes||{}).talla||E.talla||"?",_=i.find(j=>j.variante_id===E.variante_id&&(s?j.sucursal_id===s:!0)),C=_?_.cantidad:999;return`
                          <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px"
                               data-item-id="${E.id}" data-item-idx="${E._idx}" data-stock="${C}" data-precio="${E.precio_unitario}">
                  ...
                  </div>`}else{const b=u.items[0],h=b.variantes||{};h.productos;const v=h.talla||b.talla||"",w=i.find(x=>x.variante_id===b.variante_id&&(s?x.sucursal_id===s:!0)),E=w?w.cantidad:null;return`
  ...
  `).join("")};window.seleccionarModeloCorrida=(e,t)=>{const{variantes:o,productos:a,inventario:n,sucursalId:r}=window._carritoActivo,i=a.find(m=>m.id===e);document.getElementById("c-buscar-corrida").value=`${(i==null?void 0:i.nombre)||""} · ${t}`,document.getElementById("c-corrida-resultados").style.display="none";const s=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=o.filter(m=>m.producto_id===e&&m.color===t).sort((m,u)=>s.indexOf(m.talla)-s.indexOf(u.talla)),l=parseFloat(i==null?void 0:i.precio_menudeo)||0,c=parseFloat(i==null?void 0:i.precio_corrida)||(l>0?Math.round(l-100):0);document.getElementById("c-precio-corrida").value=c||"",window._corridaSeleccionada={productoId:e,color:t,variantes:d,prod:i,precioCorrida:c};const p=document.getElementById("c-corrida-tallas-grid");p.innerHTML=d.map(m=>{const u=n.find(b=>b.variante_id===m.id&&(r?b.sucursal_id===r:!0)),g=u?u.cantidad:null,y=g!==null&&g===0;return`
      <div style="display:flex;flex-direction:column;align-items:center;gap:4px;padding:8px 10px;border:2px solid ${y?"#fde":"#ddd"};border-radius:8px;background:${y?"#fff5f5":"white"};min-width:64px;opacity:${y?.5:1}">
        ...
        <div style="display:flex;align-items:center;gap:3px">
          <button type="button" onclick="this.nextElementSibling.value=Math.max(0,parseInt(this.nextElementSibling.value||0)-1);this.nextElementSibling.dispatchEvent(new Event('input'))"
            style="background:#eee;border:none;border-radius:3px;width:20px;height:20px;cursor:pointer;font-size:0.85rem;line-height:1" ${y?"disabled":""}>−</button>
          <input type="number" value="${y?0:1}" min="0" max="${g!==null?g:999}" data-variante="${m.id}"
            style="width:32px;text-align:center;border:1px solid ${y?"#fdd":"#ddd"};border-radius:4px;padding:2px;font-size:0.85rem;font-weight:700" ${y?"disabled":""}>
  ...
  `,window.hacerLogin=async()=>{const t=document.getElementById("login-email").value,o=document.getElementById("login-password").value,a=document.getElementById("btn-login");if(document.getElementById("login-error"),!t||!o){e("Por favor completa todos los campos");return}a.textContent="Verificando...",a.disabled=!0;try{const n=await fetch("/api/empleados/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:o})}),r=await n.json();n.ok?(sessionStorage.setItem(Ae,JSON.stringify(r)),r.token&&sessionStorage.setItem("erp_token",r.token),window._empleadoActual=r,we()):(e(r.error||"Email o contrasena incorrectos"),a.textContent="Iniciar sesion",a.disabled=!1)}catch{e("Error conectando con el servidor"),a.textContent="Iniciar sesion",a.disabled=!1}};function e(t){const o=document.getElementById("login-error");o&&(o.textContent=t,o.style.display="block")}}window.authHeaders=()=>{const e=sessionStorage.getItem("erp_token");return e?{"Content-Type":"application/json",Authorization:`Bearer ${e}`}:{"Content-Type":"application/json"}};const ve=sessionStorage.getItem(Ae);if(ve)try{window._empleadoActual=JSON.parse(ve),we()}catch{ye()}else ye();
