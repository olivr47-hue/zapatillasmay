(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function o(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=o(n);fetch(n.href,i)}})();const f="/api",Se=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],Xe=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],We=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],ie=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"carritos",icon:"🛒",label:"Carritos",section:"Ventas"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"envio",icon:"🚚",label:"Envíos",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"},{id:"catalogos",icon:"📖",label:"Catálogos",section:"Catalogo",soloAdmin:!0},{id:"orden-home",icon:"🏠",label:"Orden en Home",section:"Catalogo",soloAdmin:!0},{id:"generar-nombres",icon:"✏️",label:"Generar nombres",section:"Catalogo",soloAdmin:!0},{id:"mercadolibre",icon:"🛒",label:"MercadoLibre",section:"Integraciones",soloAdmin:!0},{id:"analytics",icon:"📊",label:"Google Analytics",section:"Integraciones",soloAdmin:!0},{id:"referidos",icon:"🎁",label:"Referidos",section:"Ventas",soloAdmin:!0},{id:"carritos-abandonados",icon:"🛒",label:"Carritos abandonados",section:"Ventas",soloAdmin:!0}];var ze;let te=((ze=window._empleadoActual)==null?void 0:ze.rol)==="admin"?"dashboard":"pos",ge=1;function Ie(){var i,s;const e=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),t=((i=window._empleadoActual)==null?void 0:i.rol)==="admin"?"dashboard":"pos";te=e||t,document.querySelector("#app").innerHTML=`
  ...
  `,window.toggleSidebar=()=>{const r=document.getElementById("sidebar"),d=document.getElementById("sidebar-overlay"),l=r.classList.toggle("open");d.classList.toggle("active",l),document.body.style.overflow=l?"hidden":""},window._conversacionesInterval&&clearInterval(window._conversacionesInterval),window._conversacionesInterval=setInterval(async()=>{try{const r=await window._recargarChats(),d=window._totalNoLeidos||0,l=r.reduce((c,p)=>c+(p.no_leidos||0),0);if(window._totalNoLeidos=l,l>d){document.title=`(${l}) Zapatillas May`;const c=document.querySelector('[data-modulo="conversaciones"]');if(c){let p=c.querySelector(".nav-badge");p||(p=document.createElement("span"),p.className="nav-badge",p.style.cssText="background:#e91e8c;color:white;border-radius:100px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:auto",c.appendChild(p)),p.textContent=l}try{const p=new(window.AudioContext||window.webkitAudioContext),m=p.createOscillator(),u=p.createGain();m.connect(u),u.connect(p.destination),m.frequency.value=523,u.gain.setValueAtTime(.5,p.currentTime),u.gain.exponentialRampToValueAtTime(.001,p.currentTime+.2),m.start(p.currentTime),m.stop(p.currentTime+.2);const g=p.createOscillator(),y=p.createGain();g.connect(y),y.connect(p.destination),g.frequency.value=783,y.gain.setValueAtTime(.5,p.currentTime+.2),y.gain.exponentialRampToValueAtTime(.001,p.currentTime+.5),g.start(p.currentTime+.2),g.stop(p.currentTime+.5)}catch{}}if(window._chatActivo&&window._chatsData[window._chatActivo]){const c=window._chatsData[window._chatActivo],p=document.getElementById("mensajes-area");if(p){const m=p.scrollHeight-p.scrollTop<=p.clientHeight+60;p.innerHTML=window._renderBurbujas(c),m&&(p.scrollTop=p.scrollHeight)}}}catch{}},8e3);let o=new Set;async function a(){try{const r=await fetch(f+"/pedidos/?status=pagado");if(!r.ok)return;const l=(await r.json()).filter(g=>g.mp_preference_id),c=l.length,p=document.getElementById("badge-pedidos-enviar");p&&(p.textContent=c,p.style.display=c>0?"inline":"none");const m=new Set(l.map(g=>g.id)),u=l.filter(g=>!o.has(g.id));u.length>0&&o.size>0&&u.forEach(g=>{const y=g.nombre_cliente||"Cliente",b=parseFloat(g.total||0).toLocaleString("es-MX",{maximumFractionDigits:0});n(`🛍️ Nuevo pedido de ${y} — $${b} MXN`)}),o=m}catch{}}function n(r){const d=document.createElement("div");d.style.cssText="position:fixed;bottom:24px;right:24px;background:#1a1a2e;color:white;padding:14px 20px;border-radius:12px;font-size:0.85rem;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3);z-index:9999;cursor:pointer;max-width:320px;line-height:1.4;border-left:4px solid #e53935",d.textContent=r,d.onclick=()=>{navegarA("pedidos"),d.remove()},document.body.appendChild(d),setTimeout(()=>d.remove(),8e3),Notification.permission==="granted"?new Notification("Zapatillas May — Panel",{body:r,icon:"/favicon.ico"}):Notification.permission==="default"&&Notification.requestPermission();try{const l=new AudioContext,c=l.createOscillator(),p=l.createGain();c.connect(p),p.connect(l.destination),c.frequency.setValueAtTime(880,l.currentTime),c.frequency.setValueAtTime(1100,l.currentTime+.1),p.gain.setValueAtTime(.15,l.currentTime),p.gain.exponentialRampToValueAtTime(.001,l.currentTime+.4),c.start(),c.stop(l.currentTime+.4)}catch{}}window._limpiarBadgePedidos=function(){const r=document.getElementById("badge-pedidos-enviar");r&&(r.style.display="none"),o=new Set([...o])},a(),setInterval(a,6e4),window.navegarA=r=>{var m;const d=((m=window._empleadoActual)==null?void 0:m.rol)==="admin",l=ie.find(u=>u.id===r);if(l!=null&&l.soloAdmin&&!d){alert("No tienes permisos para acceder a este módulo");return}te=r;try{localStorage.setItem("zm_panel_modulo",r)}catch{}const c=document.getElementById("sidebar"),p=document.getElementById("sidebar-overlay");c.classList.contains("open")&&(c.classList.remove("open"),p.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(u=>u.classList.remove("active")),document.querySelector('[data-modulo="'+r+'"]').classList.add("active"),document.getElementById("topbar-title").textContent=ie.find(u=>u.id===r).label,Te(r)}}function Ke(){var o;const e=((o=window._empleadoActual)==null?void 0:o.rol)==="admin";return[...new Set(ie.filter(a=>e||!a.soloAdmin).map(a=>a.section))].map(a=>`
    ...
    `).join("")}
  `).join("")}async function Te(e){var o;const t=document.getElementById("content");switch(t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>',e){case"catalogos":await xe();break;case"dashboard":t.innerHTML=Ye(),setTimeout(()=>it(),100);break;case"productos":await pe();break;case"clientes":await et();break;case"carritos":await Ee();break;case"pedidos":await Le(),(o=window._limpiarBadgePedidos)==null||o.call(window);break;case"sucursales":await tt();break;case"inventario":await ot();break;case"pos":await Oe();break;case"historial":await De();break;case"empleados":await Fe();break;case"seo":await dt();break;case"envio":await st();break;case"analisis":await Qe();break;case"crm":await Pe();break;case"finanzas":await se();break;case"proveedores":await je();break;case"ordenes":await re();break;case"conversaciones":await cargarConversaciones();break;case"envios":await cargarEnviosMasivos();break;case"mercadolibre":await ct();break;case"analytics":await mt();break;case"orden-home":await pt();break;case"generar-nombres":await ht();break;case"referidos":await $e();break;case"carritos-abandonados":await rt();break}}function Ze(){return setTimeout(()=>{document.querySelectorAll(".nav-item").forEach(a=>a.classList.remove("active"));const e=document.querySelector('[data-modulo="'+te+'"]');e&&e.classList.add("active");const t=document.getElementById("topbar-title"),o=ie.find(a=>a.id===te);t&&o&&(t.textContent=o.label),Te(te)},100),'<div style="padding:2rem;color:#888;text-align:center">Cargando...</div>'}async function re(){var t;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando sugerencias...</p>';try{const a=await(await fetch(f+"/sucursales/")).json(),n=(t=a[0])==null?void 0:t.id,[i,s]=await Promise.all([fetch(f+"/finanzas/sugerencias-recompra/"+n),fetch(f+"/finanzas/proveedores")]),r=await i.json(),d=await s.json(),l=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),c=new Date().toISOString().split("T")[0],p=r.filter(b=>{const h=l[b.producto_id];return h?h.hasta===null||h.hasta===void 0?!1:h.hasta<=c:!0}),m=r.length-p.length;window._ordenesData={sugerencias:p,proveedores:d,sucursalId:n},window._ordenSeleccion={};const u=p.filter(b=>b.urgente),g=p.filter(b=>!b.urgente),y=p.reduce((b,h)=>b+h.cantidad_sugerida*h.costo_unitario,0);e.innerHTML=`
...
¿Quieres reactivar todos?`)&&(localStorage.removeItem("ordenes_pospuestos"),re())};window.guardarOrdenCompra2=async()=>{var i,s,r,d;const{seleccionados:e,sucursalId:t}=window._ordenModal||{};if(!e)return;const o=(i=document.getElementById("orden-fecha"))==null?void 0:i.value,a=((s=document.getElementById("orden-notas"))==null?void 0:s.value)||"",n={};e.forEach(l=>{var u,g;const c=l.proveedor_id||"sin-proveedor",p=((u=l.proveedor)==null?void 0:u.nombre)||"Sin proveedor";n[c]||(n[c]={nombre:p,items:[]});const m=l.variantes||[];if(m.length===0){const y=parseInt(((g=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:g.value)||l.cantidad_sugerida);n[c].items.push({variante_id:null,cantidad:y,costo_unitario:l.costo_unitario})}else m.forEach(y=>{var v;const b=document.getElementById("chk-var-"+y.id);if(!(b!=null&&b.checked))return;const h=parseInt(((v=document.getElementById("qty-var-"+y.id))==null?void 0:v.value)||0);h<=0||n[c].items.push({variante_id:y.id,cantidad:h,costo_unitario:l.costo_unitario})})});try{for(const[l,c]of Object.entries(n)){if(c.items.length===0)continue;const p=c.items.reduce((y,b)=>y+b.cantidad*b.costo_unitario,0),g=(r=(await(await fetch(f+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:l==="sin-proveedor"?null:l,sucursal_id:t,status:"borrador",total:p,notas:a,fecha_entrega_estimada:o||null})})).json())[0])==null?void 0:r.id;if(g)for(const y of c.items)await fetch(f+"/finanzas/ordenes/"+g+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...y,subtotal:y.cantidad*y.costo_unitario})})}(d=document.getElementById("modal-orden"))==null||d.remove(),alert("Orden de compra guardada"),re()}catch(l){alert("Error guardando orden: "+l.message)}};function Ye(){return`
  ...
  `}async function se(){var t,o,a,n,i,s;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando finanzas...</p>';try{const d=await(await fetch(f+"/sucursales/")).json(),l=(t=d[0])==null?void 0:t.id,[c,p,m,u,g,y,b]=await Promise.all([fetch(f+"/finanzas/caja/hoy/"+l),fetch(f+"/finanzas/reporte/"+l),fetch(f+"/finanzas/gastos/"+l),fetch(f+"/finanzas/estado-resultados/"+l),fetch(f+"/finanzas/flujo/"+l),fetch(f+"/finanzas/cuentas-por-cobrar"),fetch(f+"/finanzas/gastos-categorias/"+l)]),h=await c.json(),v=await p.json(),w=await m.json(),_=await u.json(),x=await g.json(),P=await y.json(),L=await b.json(),$=h.find(B=>B.status==="abierta"),z=new Date().toISOString().split("T")[0],N=w.filter(B=>{var E;return(E=B.created_at)==null?void 0:E.startsWith(z)}),k=N.reduce((B,E)=>B+parseFloat(E.monto||0),0),T=P.reduce((B,E)=>B+parseFloat(E.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
    ...
    `,window._finanzasData={sucursalId:l,gastosHoy:N,totalGastosHoy:k,estadoResultados:_,flujo:x,cxc:P,categorias:L,historial:[],reporte:v},window._finanzasSucursalId=l;const S=await(await fetch(f+"/finanzas/caja/historial/"+l)).json();window._finanzasData.historial=S,mostrarTabFinanzas("gastos")}catch(r){e.innerHTML='<p style="padding:2rem;color:red">Error cargando finanzas: '+r.message+"</p>"}}window.mostrarTabFinanzas=e=>{var c,p,m,u,g,y,b,h,v,w,_,x,P,L;const{gastosHoy:t,totalGastosHoy:o,estadoResultados:a,flujo:n,cxc:i,categorias:s,historial:r,sucursalId:d}=window._finanzasData,l=document.getElementById("fin-tab-contenido");if(l)if(e==="cmv"){const $=((c=window._finanzasData.reporte)==null?void 0:c.desglose_cmv)||[],z=window._finanzasData.reporte||{},N=$.reduce((B,E)=>B+E.subtotal_costo,0),k=$.reduce((B,E)=>B+E.subtotal_venta,0),T=k>0?(k-N)/k*100:0,I=z.num_pedidos_sin_desglose||0,S=z.total_sin_desglose||0;l.innerHTML=`
      <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
        <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
          ...
          <div style="display:flex;gap:16px;font-size:0.82rem">
            <span>Total vendido: <strong style="color:#E91E8C">$${k.toLocaleString("es-MX",{maximumFractionDigits:0})}</strong></span>
            <span>Costo total: <strong style="color:#b5651d">$${N.toLocaleString("es-MX",{maximumFractionDigits:0})}</strong></span>
        ...
        ${$.length===0?'<p style="padding:2rem;text-align:center;color:#888">Sin ventas con costo registrado en los últimos 30 días</p>':`<div style="overflow-x:auto">
            <table style="width:100%;border-collapse:collapse;font-size:0.83rem">
              ...
              <tbody>
                ${$.map(B=>{const E=B.subtotal_venta>0?(B.subtotal_venta-B.subtotal_costo)/B.subtotal_venta*100:0,M=E>=30?"#2e7d32":E>=15?"#f57f17":"#c62828";return`<tr style="border-bottom:1px solid #f5f5f5">
                    ...
                    <td style="padding:10px 8px;text-align:right;font-weight:700;color:${M}">${E.toFixed(1)}%</td>
                  </tr>`}).join("")}
              </tbody>
              <tfoot>
                <tr style="background:#f9f9f9;border-top:2px solid #eee;font-weight:700">
                  <td colspan="4" style="padding:10px 14px">TOTAL</td>
                  <td style="padding:10px 8px;text-align:right;color:#b5651d">$${N.toLocaleString("es-MX",{maximumFractionDigits:0})}</td>
                  <td></td>
                  <td style="padding:10px 8px;text-align:right;color:#E91E8C">$${k.toLocaleString("es-MX",{maximumFractionDigits:0})}</td>
    ...
    `}else if(e==="gastos"){const $=s.reduce((z,N)=>z+N.total,0);l.innerHTML=`
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
          ...
          <div style="padding:1rem">
            ${s.length===0?'<p style="color:#888;text-align:center;padding:1rem">Sin gastos registrados</p>':s.map(z=>`
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;margin-bottom:1rem">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            ...
            <span style="font-weight:700;color:${(((v=n.semana)==null?void 0:v.neto)||0)>=0?"#2e7d32":"#c62828"};font-size:1.1rem">$${(((w=n.semana)==null?void 0:w.neto)||0).toFixed(0)}</span>
          </div>
        </div>
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
...
Diferencia: $${(n=s.diferencia)==null?void 0:n.toFixed(2)}`),se()):alert("Error: "+JSON.stringify(s))}catch{alert("Error cerrando caja")}};window.agregarGasto=e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",t.innerHTML=`
  ...
  `,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()})};window.guardarProveedor=async e=>{const t={nombre:document.getElementById("prov-nombre").value,contacto:document.getElementById("prov-contacto").value,telefono:document.getElementById("prov-telefono").value,email:document.getElementById("prov-email").value,ciudad:document.getElementById("prov-ciudad").value,direccion:document.getElementById("prov-direccion").value,notas:document.getElementById("prov-notas").value};if(!t.nombre){alert("El nombre es requerido");return}try{e?await fetch(f+"/finanzas/proveedores/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):await fetch(f+"/finanzas/proveedores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),document.querySelector('div[style*="position:fixed"]').remove(),je()}catch{alert("Error guardando proveedor")}};window.editarProveedor=async e=>{const a=(await(await fetch(f+"/finanzas/proveedores")).json()).find(n=>n.id===e);a&&mostrarFormProveedor(a)};async function Qe(){const e=document.getElementById("content");e.innerHTML=`
    ...
    <style>@keyframes pulse{0%,100%{opacity:1}50%{opacity:0.5}}</style>`;try{let B=function(C,O,D){return`<div style="display:flex;align-items:center;gap:6px">
        <div style="flex:1;height:6px;background:#f1f5f9;border-radius:3px;overflow:hidden">
          <div style="width:${O>0?Math.round(C/O*100):0}%;height:100%;background:${D};border-radius:3px;transition:width 0.4s ease"></div>
        </div>
        <span style="font-size:0.7rem;font-weight:700;color:#334155;min-width:22px;text-align:right">${C}</span>
        ...
        <div id="rotacion-lista" style="display:flex;flex-direction:column;gap:8px">
          ${z.map(C=>{const O=S[C.semaforo],D=Math.max(...z.map(j=>j.ventas.d30),1);return`
            <div class="rotacion-item" data-semaforo="${C.semaforo}"
              ...
              ${C.imagen_principal?`<img src="${C.imagen_principal}" style="width:48px;height:48px;object-fit:contain;border-radius:8px;background:#f8fafc;flex-shrink:0">`:'<div style="width:48px;height:48px;background:#f8fafc;border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;flex-shrink:0;color:#cbd5e1">👠</div>'}
              <div style="flex:1;min-width:130px">
                <p style="font-weight:700;font-size:0.88rem;color:#0f172a;margin-bottom:2px">${C.nombre}</p>
                <p style="font-size:0.72rem;color:#94a3b8;margin-bottom:6px">${C.sku_interno||""} · ${C.stockTotal} pares en stock</p>
              ...
              <div style="min-width:160px;flex:1">
                ...
                ${B(C.ventas.d30,D,"#E91E8C")}
                <div style="display:flex;gap:12px;margin-top:6px">
                  <span style="font-size:0.7rem;color:#64748b">60d: <strong>${C.ventas.d60}</strong></span>
                  <span style="font-size:0.7rem;color:#64748b">90d: <strong>${C.ventas.d90}</strong></span>
                  <span style="font-size:0.7rem;color:#64748b">${C.ventasSemana.toFixed(1)} /sem</span>
                </div>
              </div>
              <div style="text-align:right;min-width:100px">
                ${C.diasInventario?`<p style="font-size:1rem;font-weight:800;color:${C.diasInventario<14?"#dc2626":C.diasInventario<30?"#ca8a04":"#16a34a"}">${C.diasInventario}d</p>
                     <p style="font-size:0.67rem;color:#94a3b8">stock restante</p>`:'<p style="font-size:0.72rem;color:#94a3b8">Sin ventas</p>'}
                <p style="font-size:0.67rem;color:#64748b;margin-top:3px">${C.recomendacion}</p>
              </div>
            </div>`}).join("")}
        </div>`},M=function(C){C=(C||"").toLowerCase();const O=z.filter(A=>(A.tallasDesglosadas.length>0||A.tallasData.some(H=>H.total>0))&&(!C||A.nombre.toLowerCase().includes(C)||(A.sku_interno||"").toLowerCase().includes(C))),D=z.filter(A=>A.tallasData.some(H=>H.total>0)).length,j=`
        ...
        </div>`;function q(A){const H=Math.max(...A.map(R=>R.total),1);return A.map(R=>{const F=Math.round(R.total/H*100),X=F===0?"#f8fafc":F<20?"#fce7f3":F<50?"#fbcfe8":F<80?"#f472b6":"#E91E8C",G=F>=50?"white":F===0?"#cbd5e1":"#be185d",Y=F>=50?"rgba(255,255,255,0.75)":"#db2777";return`
          <div style="background:${X};border-radius:7px;padding:8px 5px;text-align:center;transition:transform 0.15s;min-width:58px;${F===0?"border:1px solid #e2e8f0":""}"
            ...
            <p style="font-size:0.9rem;font-weight:800;color:${G};line-height:1;margin-bottom:2px">${R.total}</p>
            <p style="font-size:0.65rem;font-weight:700;color:${G}">T${R.talla}</p>
            <p style="font-size:0.58rem;color:${R.d30>0?Y:"transparent"};margin-top:1px">${R.d30>0?"+"+R.d30:"·"}</p>
          </div>`}).join("")}return`
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px;flex-wrap:wrap">
          <input id="tallas-buscar" class="form-input" placeholder="Filtrar por modelo o SKU..."
            style="max-width:260px;font-size:0.82rem" value="${C}"
            oninput="document.getElementById('analisis-tab-content').innerHTML=window._renderTabTallas(this.value)">
          <span style="font-size:0.75rem;color:#94a3b8">${O.length} de ${D} modelos</span>
        </div>
        ${j}
        ${O.length===0?'<div style="padding:3rem;text-align:center;color:#94a3b8;font-size:0.9rem">No se encontraron modelos</div>':O.map(A=>{const H=A.tallasData.find(F=>F.total>0),R=A.tallasDesglosadas.length>0;return`
            <div style="background:white;border:1px solid #e2e8f0;border-radius:12px;padding:16px;margin-bottom:10px">
              ...
              <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px;flex-wrap:wrap">
                ...
                <div style="flex:1">
                  ...
                  <p style="font-size:0.7rem;color:#94a3b8">${A.ventas.d90} pares en 90d · ${R?A.tallasDesglosadas.length+" colores con ventas":A.tallasData.filter(F=>F.total>0).length+" tallas con movimiento"}</p>
                </div>
                ${H?`
              ...
              ${R?A.tallasDesglosadas.map(F=>`
                  <div style="margin-bottom:12px">
                    <div style="display:flex;align-items:center;gap:6px;margin-bottom:7px">
                      <span style="font-size:0.72rem;font-weight:700;color:#334155;min-width:0">${F.color}</span>
                      <span style="font-size:0.65rem;color:#94a3b8;background:#f1f5f9;padding:1px 7px;border-radius:100px">${F.total} pares totales</span>
                      ${F.tallas.find(X=>X.total===Math.max(...F.tallas.map(G=>G.total)))?`<span style="font-size:0.65rem;color:#be185d;background:#fdf2f8;padding:1px 7px;border-radius:100px">
                            top: T${F.tallas.find(X=>X.total===Math.max(...F.tallas.map(G=>G.total))).talla}
                          </span>`:""}
                    </div>
                    <div style="display:flex;gap:6px;flex-wrap:wrap">
                      ${q(F.tallas)}
                    </div>
                  </div>`).join('<hr style="border:none;border-top:1px solid #f1f5f9;margin:4px 0 12px">'):`<div style="display:flex;gap:6px;flex-wrap:wrap">${q(A.tallasData)}</div>`}
            </div>`}).join("")}
      `},V=function(){const C=z.filter(O=>O.variantesData.some(D=>D.total>0));return C.length===0?'<div style="padding:3rem;text-align:center;color:#94a3b8;font-size:0.9rem">No hay datos de ventas por variante aún</div>':C.map(O=>{const D=O.variantesData.slice(0,8),j=Math.max(...D.map(A=>A.total),1),q=D[0];return`
        <div style="background:white;border:1px solid #e2e8f0;border-radius:12px;padding:16px;margin-bottom:10px">
          ...
          <div style="display:flex;flex-direction:column;gap:6px">
            ${D.map((A,H)=>{const R=["#E91E8C","#7c3aed","#0ea5e9","#10b981","#f59e0b","#ef4444","#6366f1","#14b8a6"],F=R[H%R.length];return`
              <div style="display:flex;align-items:center;gap:8px">
                ...
                <div style="flex:1;height:20px;background:#f1f5f9;border-radius:4px;overflow:hidden;position:relative">
                  <div style="width:${Math.round(A.total/j*100)}%;height:100%;background:${F};border-radius:4px;transition:width 0.5s ease;display:flex;align-items:center;padding-left:6px;box-sizing:border-box">
        ...
        </div>`}).join("")};var t=B,o=E,a=M,n=V;const[i,s,r,d]=await Promise.all([fetch(f+"/productos/"),fetch(f+"/variantes/?activa=eq.true"),fetch(f+"/movimientos/"),fetch(f+"/inventario/slim")]),l=await i.json(),c=await s.json(),p=await r.json(),m=await d.json(),u={},g={};c.forEach(C=>{u[C.id]=C,g[C.producto_id]||(g[C.producto_id]=[]),g[C.producto_id].push(C.id)});const y={};m.forEach(C=>{y[C.variante_id]=(y[C.variante_id]||0)+C.cantidad});const b=new Date,h=new Date(b-30*24*60*60*1e3),v=new Date(b-60*24*60*60*1e3),w=new Date(b-90*24*60*60*1e3),_={},x={},P={},L={};p.filter(C=>C.tipo==="venta").forEach(C=>{const O=u[C.variante_id];if(!O)return;const D=O.producto_id,j=Math.abs(C.cantidad),q=new Date(C.created_at);_[D]||(_[D]={d30:0,d60:0,d90:0,total:0}),_[D].total+=j,q>=h&&(_[D].d30+=j),q>=v&&(_[D].d60+=j),q>=w&&(_[D].d90+=j),x[C.variante_id]||(x[C.variante_id]={d30:0,d90:0,total:0}),x[C.variante_id].total+=j,q>=h&&(x[C.variante_id].d30+=j),q>=w&&(x[C.variante_id].d90+=j);const A=O.talla||"S/T",H=`${D}|${A}`;P[H]||(P[H]={talla:A,d30:0,d90:0,total:0}),P[H].total+=j,q>=h&&(P[H].d30+=j),q>=w&&(P[H].d90+=j);const R=O.color||"Sin color",F=`${D}|${R}|${A}`;L[F]||(L[F]={talla:A,color:R,d30:0,d90:0,total:0}),L[F].total+=j,q>=h&&(L[F].d30+=j),q>=w&&(L[F].d90+=j)});const z=l.map(C=>{const O=_[C.id]||{d30:0,d60:0,d90:0,total:0},D=g[C.id]||[],j=D.reduce((U,J)=>U+(y[J]||0),0),q=O.d30/4,A=q>0?Math.round(j/q*7):null;let H="gris",R="Sin ventas recientes";O.d30>=6?(H="verde",R="Rota bien — considerar resurtido"):O.d30>=2?(H="amarillo",R="Rotación moderada"):O.d90===0&&j>0?(H="rojo",R="Sin movimiento en 90 días — revisar"):O.d30>0&&(H="amarillo",R="Rotación lenta");const F=D.map(U=>{var J;return(J=u[U])==null?void 0:J.talla}).filter(Boolean).filter((U,J,Q)=>Q.indexOf(U)===J).map(U=>({talla:U,...P[`${C.id}|${U}`]||{d30:0,d90:0,total:0}})).sort((U,J)=>J.total-U.total),G=[...new Set(D.map(U=>{var J;return(J=u[U])==null?void 0:J.color}).filter(Boolean))].map(U=>{const J=D.filter(W=>{var Z;return((Z=u[W])==null?void 0:Z.color)===U}).map(W=>{var Z;return(Z=u[W])==null?void 0:Z.talla}).filter(Boolean).filter((W,Z,Je)=>Je.indexOf(W)===Z).map(W=>({talla:W,...L[`${C.id}|${U}|${W}`]||{d30:0,d90:0,total:0}})).sort((W,Z)=>parseFloat(W.talla)-parseFloat(Z.talla)),Q=J.reduce((W,Z)=>W+Z.total,0);return{color:U,tallas:J,total:Q}}).filter(U=>U.total>0).sort((U,J)=>J.total-U.total),Y=D.map(U=>{const J=u[U];if(!J)return null;const Q=x[U]||{d30:0,d90:0,total:0},W=y[U]||0;return{id:U,label:[J.talla,J.color].filter(Boolean).join(" / ")||U,stock:W,...Q}}).filter(Boolean).sort((U,J)=>J.total-U.total);return{...C,ventas:O,stockTotal:j,ventasSemana:q,diasInventario:A,semaforo:H,recomendacion:R,tallasData:F,tallasDesglosadas:G,variantesData:Y}}).sort((C,O)=>O.ventas.d30-C.ventas.d30);window._analisisData={productosConRotacion:z,ventasPorTalla:P};const N=z.reduce((C,O)=>C+O.ventas.d30,0),k=z.reduce((C,O)=>C+O.ventas.d90,0),T=z.filter(C=>C.semaforo==="verde").length,I=z.filter(C=>C.semaforo==="rojo").length,S={verde:{bg:"#dcfce7",color:"#166534",dot:"#16a34a",txt:"Rota bien"},amarillo:{bg:"#fef9c3",color:"#854d0e",dot:"#ca8a04",txt:"Rotación lenta"},rojo:{bg:"#fee2e2",color:"#991b1b",dot:"#dc2626",txt:"Sin movimiento"},gris:{bg:"#f1f5f9",color:"#64748b",dot:"#94a3b8",txt:"Sin datos"}};window._renderTabRotacion=E,window._renderTabTallas=M,window._renderTabVariantes=V,e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(130px,1fr));gap:10px;margin-bottom:1.5rem">
        <div style="background:linear-gradient(135deg,#fff0f8,#ffe4f2);border:1px solid #f9a8d4;border-radius:14px;padding:1rem 1.1rem">
          <p style="font-size:1.5rem;font-weight:800;color:#be185d;line-height:1;margin-bottom:3px">${N}</p>
        ...
        <div style="background:linear-gradient(135deg,#f5f3ff,#ede9fe);border:1px solid #ddd6fe;border-radius:14px;padding:1rem 1.1rem">
          <p style="font-size:1.5rem;font-weight:800;color:#6d28d9;line-height:1;margin-bottom:3px">${k}</p>
    ...
    `,window._analisisTabActivo="rotacion"}catch(i){e.innerHTML='<p style="padding:2rem;color:red">Error cargando análisis</p>',console.error(i)}}window.switchTabAnalisis=e=>{["rotacion","tallas","variantes"].forEach(a=>{const n=document.getElementById("tab-"+a);n&&(a===e?(n.style.background="white",n.style.color="#E91E8C",n.style.boxShadow="0 1px 4px rgba(0,0,0,0.1)"):(n.style.background="transparent",n.style.color="#64748b",n.style.boxShadow="none"))});const o=document.getElementById("analisis-tab-content");o&&(window._analisisTabActivo=e,e==="rotacion"?o.innerHTML=window._renderTabRotacion():e==="tallas"?o.innerHTML=window._renderTabTallas():e==="variantes"&&(o.innerHTML=window._renderTabVariantes()))};window.filtrarRotacion=e=>{document.querySelectorAll(".rotacion-item").forEach(o=>{o.style.display=e==="todos"||o.dataset.semaforo===e?"":"none"}),document.querySelectorAll("#analisis-tab-content .pill-filter").forEach(o=>{o.classList.remove("pill-active")});const t=[...document.querySelectorAll("#analisis-tab-content .pill-filter")].find(o=>o.textContent.trim().toLowerCase().includes(e==="todos"?"todos":e==="verde"?"bien":e==="amarillo"?"lento":"movimiento"));t&&t.classList.add("pill-active")};async function Pe(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando CRM...</p>';try{const[t,o,a]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/"),fetch(f+"/crm/seguimientos/pendientes/todos")]),n=await t.json(),i=await o.json(),s=await a.json(),r=new Date,d=new Date(r-30*24*60*60*1e3),l=new Date(r-60*24*60*60*1e3),c=new Date(r-90*24*60*60*1e3),p=n.map(v=>{const w=i.filter(z=>z.cliente_id===v.id&&(z.status==="confirmado"||z.status==="pagado")),_=w.reduce((z,N)=>z+parseFloat(N.total||0),0),x=w.length>0?new Date(w[0].created_at):null,P=x?Math.floor((r-x)/(1e3*60*60*24)):null,L=w.filter(z=>new Date(z.created_at)>=d).length;let $="nuevo";return w.length===0?$="nuevo":_>=5e3&&L>=1?$="vip":P>90?$="inactivo":P>30?$="riesgo":L>=2?$="frecuente":$="activo",{...v,totalGastado:_,ultimoPedido:x,diasSinComprar:P,pedidos30:L,segmento:$,totalPedidos:w.length}}),m=p.filter(v=>v.segmento==="vip"),u=p.filter(v=>v.segmento==="riesgo").sort((v,w)=>w.totalGastado-v.totalGastado),g=p.filter(v=>v.segmento==="inactivo").sort((v,w)=>w.totalGastado-v.totalGastado),y=[...p].sort((v,w)=>w.totalGastado-v.totalGastado).slice(0,10),b=i.filter(v=>new Date(v.created_at).toDateString()===r.toDateString()&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,w)=>v+parseFloat(w.total||0),0),h=i.filter(v=>new Date(v.created_at)>=d&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,w)=>v+parseFloat(w.total||0),0);e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
          ...
          ${s.length===0?'<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">Sin recordatorios pendientes 🎉</div>':s.slice(0,5).map(v=>{var w;return`
              <div style="padding:0.75rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:12px">
                <div style="flex:1">
...
⚠️ Requiere que los productos estén en el catálogo de Meta Commerce.`;else if(d.style.background="#e8f5e9",d.style.borderColor="#a5d6a7",d.style.color="#333",o){let y;t==="personalizado"?y=(((g=document.getElementById("texto-personalizado"))==null?void 0:g.value)||"").replace("{nombre}","María"):y=o.mensaje("María"),d.textContent=y}}const l=document.getElementById("campana-count");l&&(l.textContent=i.length+" clientes");const c=document.getElementById("campana-lista");if(c){if(!i.length){c.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No hay clientes en este segmento con teléfono registrado</div>';return}window._campanaFiltrados=i,window._campanaPlantillaId=t,c.innerHTML=i.map((y,b)=>{var _;let h;t==="personalizado"?h=(((_=document.getElementById("texto-personalizado"))==null?void 0:_.value)||"").replace("{nombre}",y.nombre.split(" ")[0]):h=o.mensaje(y.nombre.split(" ")[0]);const v=encodeURIComponent(h),w=(y.lada||"52")+y.telefono.replace(/\D/g,"");return`
    ...
    <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);text-align:center">
      ...
      <p style="font-size:0.82rem;color:#888">Conectando con WhatsApp Business</p>
        ...
        <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
          ...
          ${w>0&&((L=v.resultados)!=null&&L.length)?`
        ...
        </div>`};window._campanaJobId=g;const h=setInterval(async()=>{try{const w=await(await fetch(f+"/campanas/estado/"+g)).json();b(w),w.terminado&&(clearInterval(h),window._campanaUltimosResultados=w.resultados||[],setTimeout(()=>{const _=w.enviados||0,x=w.fallidos||0;l.innerHTML=`
              <div style="background:white;border-radius:16px;padding:2.5rem;max-width:400px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
                ...
                ${x>0?`
                  ...
                  <div style="background:#fff5f5;border-radius:8px;padding:0.75rem;margin-bottom:1rem;text-align:left;max-height:140px;overflow-y:auto">
                    ${w.resultados.filter(P=>!P.ok).map(P=>`
    ...
    `};window._campanaAvanzar=()=>{if(s++,s>=i.length){r.innerHTML=`
      ...
      `;return}d()},d(),document.body.appendChild(r)};async function et(){const e=document.getElementById("content");try{const[t,o]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/")]),a=await t.json(),n=await o.json(),i=new Date,s=new Date(i-30*24*60*60*1e3),r=new Date(i-90*24*60*60*1e3),d=a.map(u=>{const g=n.filter(L=>L.cliente_id===u.id&&(L.status==="confirmado"||L.status==="pagado")),y=g.reduce((L,$)=>L+parseFloat($.total||0),0),b=g.length>0?new Date(g[0].created_at):null,h=g.filter(L=>new Date(L.created_at)>=s).length,v=b?Math.floor((i-b)/(1e3*60*60*24)):null;let w="nuevo",_="⚪ Nuevo",x="#f5f5f5",P="#888";return g.length===0?(w="nuevo",_="⚪ Sin compras",x="#f5f5f5",P="#888"):y>=5e3&&h>=1?(w="vip",_="⭐ VIP",x="#fff8e1",P="#f57f17"):v>90?(w="inactivo",_="🔴 Inactivo",x="#ffebee",P="#c62828"):v>30?(w="riesgo",_="🟡 En riesgo",x="#fff8e1",P="#f57f17"):h>=2?(w="frecuente",_="🟢 Frecuente",x="#e8f5e9",P="#2e7d32"):(w="activo",_="🔵 Activo",x="#e3f2fd",P="#1565c0"),{...u,totalGastado:y,ultimoPedido:b,pedidos30:h,diasSinComprar:v,segmento:w,segmentoLabel:_,segmentoBg:x,segmentoColor:P,totalPedidos:g.length}}).sort((u,g)=>g.totalGastado-u.totalGastado),l=d.filter(u=>u.segmento==="vip").length,c=d.filter(u=>u.segmento==="inactivo").length,p=d.filter(u=>u.segmento==="riesgo").length,m=d.filter(u=>u.segmento==="frecuente"||u.segmento==="activo").length;window._clientesData=d,e.innerHTML=`
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
...
`,renderInventario()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.renderInventario=()=>{const{sucursales:e,productos:t,variantes:o,inventario:a}=window._invData,n=(document.getElementById("inv-buscar")?document.getElementById("inv-buscar").value:"").toLowerCase(),i=document.getElementById("inv-categoria")?document.getElementById("inv-categoria").value:"",s=document.getElementById("inv-talla")?document.getElementById("inv-talla").value:"",r=document.getElementById("inv-estado")?document.getElementById("inv-estado").value:"",d=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],l=t.filter(m=>!(!m.activo||n&&!m.nombre.toLowerCase().includes(n)&&!(m.sku_interno||"").toLowerCase().includes(n)||i&&m.categoria!==i)),c=e.map(m=>{const u=a.filter(y=>y.sucursal_id===m.id),g=l.map(y=>{const b=o.filter(_=>_.producto_id===y.id&&_.activa!==!1);if(b.length===0)return"";const v=[...new Set(b.map(_=>_.color).filter(Boolean))].map(_=>{const x=b.filter(z=>z.color===_).sort((z,N)=>d.indexOf(z.talla)-d.indexOf(N.talla));if(s&&!x.find(z=>z.talla===s))return"";const P=x[0]?x[0].color_hex:"#888",L=x[0]?x[0].foto_url:null,$=x.map(z=>{const N=u.find(B=>B.variante_id===z.id),k=N?N.cantidad:null,T=N?N.stock_minimo:3;if(s&&z.talla!==s||r&&(r==="agotado"&&k!==0||r==="bajo"&&(k===null||k===0||k>T)||r==="disponible"&&(k===null||k===0||k<=T)))return"";let I,S;return k===null?(I="#f0f0f0",S="#aaa"):k===0?(I="#ffebee",S="#c62828"):k<=T?(I="#fff8e1",S="#f57f17"):(I="#e8f5e9",S="#2e7d32"),`
            <div style="display:flex;align-items:center;justify-content:space-between;background:${I};border-radius:10px;padding:8px 12px;border:1px solid ${S}30">
              ...
              <div style="display:flex;align-items:center;gap:8px">
                <button onclick="cambiarStockInventario('${z.id}', '${m.id}', ${k!==null?k:0}, ${T}, -1)"
                ...
                <span id="stock-${z.id}-${m.id}" style="font-size:1.1rem;font-weight:700;color:${S};min-width:32px;text-align:center">${k!==null?k:"—"}</span>
                <button onclick="cambiarStockInventario('${z.id}', '${m.id}', ${k!==null?k:0}, ${T}, 1)"
                        style="background:#fff;border:1px solid #ddd;border-radius:6px;width:34px;height:34px;cursor:pointer;font-size:1.2rem;font-weight:700;touch-action:manipulation">+</button>
              </div>
            </div>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div>
          ...
          <select class="form-input" id="f-categoria" required onchange="actualizarSKU()">
            ...
            ${We.map(a=>`<option value="${a.value}" ${t.categoria===a.value?"selected":""}>${a.label}</option>`).join("")}
          </select>
        </div>
        <div>
...
${o.telefono?'<a href="https://wa.me/'+(o.lada||"52")+o.telefono.replace(/\D/g,"")+'" target="_blank" class="btn btn-secondary" style="background:#25D366;color:white;border-color:#25D366;margin-left:auto">WhatsApp</a>':""}      </div>
  ...
  `};window.guardarCliente=async e=>{const t=document.getElementById("cli-nombre").value;if(!t){alert("El nombre del cliente es obligatorio");return}const o=document.getElementById("btn-cli-guardar");o&&(o.textContent="Guardando...",o.disabled=!0);const a={nombre:t,telefono:document.getElementById("cli-telefono").value||null,email:document.getElementById("cli-email").value||null,tipo:document.getElementById("cli-tipo").value,direccion:document.getElementById("cli-direccion").value||null,lada:document.getElementById("cli-lada").value||"52",ciudad:document.getElementById("cli-ciudad").value||null,estado:document.getElementById("cli-estado").value||null,codigo_postal:document.getElementById("cli-cp").value||null,limite_credito:parseFloat(document.getElementById("cli-credito").value)||0,dias_credito:parseInt(document.getElementById("cli-dias").value)||0,comentarios_internos:document.getElementById("cli-comentarios").value||null,activo:!0};try{const n=e?"PATCH":"POST",i=e?f+"/clientes/"+e:f+"/clientes/",s=await fetch(i,{method:n,headers:{"Content-Type":"application/json"},body:JSON.stringify(a)});if(s.ok)alert("Cliente guardado correctamente"),navegarA("clientes");else{const r=await s.text();alert("Error al guardar: "+r),o&&(o.textContent="Guardar cliente",o.disabled=!1)}}catch{alert("Error conectando con el servidor"),o&&(o.textContent="Guardar cliente",o.disabled=!1)}};window.verCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[o,a]=await Promise.all([fetch(f+"/clientes/"+e),fetch(f+"/pedidos/")]),n=await o.json(),i=await a.json();if(!n||n.length===0){alert("Cliente no encontrado");return}const s=n[0],r=i.filter(g=>g.cliente_id===e),d=r.filter(g=>g.status==="confirmado"||g.status==="pagado"),l=d.reduce((g,y)=>g+parseFloat(y.total||0),0),c=d.length>0?l/d.length:0,p=r.length>0?new Date(r[0].created_at):null,m=p?Math.floor((new Date-p)/(1e3*60*60*24)):null,u={};d.forEach(g=>{const y=new Date(g.created_at).toLocaleDateString("es-MX",{month:"short",year:"2-digit"});u[y]=(u[y]||0)+parseFloat(g.total||0)}),t.innerHTML=`
      <div style="max-width:900px;margin:0 auto">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden;margin-bottom:1rem">
          ...
          ${r.length===0?'<div style="text-align:center;padding:2rem;color:#888">Sin pedidos registrados</div>':r.map(g=>{const y={confirmado:"#2e7d32",pagado:"#2e7d32",pendiente_pago:"#f57f17",cancelado:"#c62828",borrador:"#f57f17"}[g.status]||"#888",b={confirmado:"#e8f5e9",pagado:"#e8f5e9",pendiente_pago:"#fff8e1",cancelado:"#ffebee",borrador:"#fff8e1"}[g.status]||"#f5f5f5";return`
    ...
    `}catch{t.innerHTML='<p style="padding:2rem;color:red">Error cargando cliente</p>'}};window.guardarNotasCliente=async e=>{var o;const t=((o=document.getElementById("cli-notas-"+e))==null?void 0:o.value)||"";try{await fetch(f+"/clientes/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({comentarios_internos:t})});const a=document.querySelector(`button[onclick="guardarNotasCliente('${e}')"]`);a&&(a.textContent="✅ Guardado",setTimeout(()=>a.textContent="💾 Guardar notas",2e3))}catch{alert("Error guardando notas")}};window.editarCliente=e=>{mostrarFormCliente(e)};window.nuevoPedidoCliente=async(e,t)=>{await Oe(),setTimeout(()=>{const o=document.getElementById("pos-cliente-buscar"),a=document.getElementById("pos-cliente"),n=document.getElementById("pos-cliente-seleccionado");o&&(o.value=""),a&&(a.value=e),n&&(n.textContent="✔ "+t+" — toca para cambiar",n.style.display="block");const i=document.getElementById("topbar-title");i&&(i.textContent="Punto de venta")},300)};window.verHistorialCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando historial...</p>';try{const n=(await(await fetch(f+"/pedidos/")).json()).filter(r=>r.cliente_id===e),i=n.length>0&&n[0].clientes?n[0].clientes:{},s=n.filter(r=>r.status==="confirmado"||r.status==="pagado").reduce((r,d)=>r+parseFloat(d.total||0),0);t.innerHTML=`
      <div class="table-card" style="padding:2rem">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;flex-wrap:wrap">
          <button class="btn btn-secondary" onclick="navegarA('clientes')">← Volver</button>
  ...
  `};window.guardarSalida=async()=>{const e=document.getElementById("sal").value,t=document.getElementById("sal-sucursal").value,o=document.getElementById("sal-cantidad").value,a=document.getElementById("sal-motivo").value;if(!e||!t||!o){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(f+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:-parseInt(o),motivo:a})})).json();i.ok?(alert("Salida registrada. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const o=await(await fetch(f+"/sucursales/")).json(),n=await(await fetch(f+"/productos/")).json(),s=await(await fetch(f+"/variantes/")).json(),d=await(await fetch(f+"/inventario/")).json(),l=[...new Set(n.map(p=>p.categoria).filter(Boolean))],c=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:o,productos:n,variantes:s,inventario:d},e.innerHTML=`
    ...
    `,renderTablasMasivo()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:e,variantes:t,inventario:o}=window._invMasivo,a=document.getElementById("im-sucursal").value,n=document.getElementById("im-categoria").value,i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],s=e.filter(c=>!(n&&c.categoria!==n)),r=o.filter(c=>c.sucursal_id===a),d=s.map(c=>{const p=t.filter(g=>g.producto_id===c.id);if(p.length===0)return"";const u=[...new Set(p.map(g=>g.color).filter(Boolean))].map(g=>{const y=p.filter(h=>h.color===g).sort((h,v)=>i.indexOf(h.talla)-i.indexOf(v.talla));return`
        <div style="margin-bottom:1rem">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap">
            ${y.map(h=>{const v=r.find(P=>P.variante_id===h.id),w=v?v.cantidad:0,_=v?v.stock_minimo:3;let x="#ddd";return w===0?x="#ffcdd2":w<=_?x="#ffe082":x="#a5d6a7",`
                <div style="text-align:center">
  ...
  `,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()})};window.confirmarEnvio=async function(e){const t=document.getElementById("env-paqueteria").value,o=document.getElementById("env-guia").value.trim(),a=document.getElementById("env-error"),n=document.getElementById("btn-confirmar-envio");if(!t||!o){a.textContent="Selecciona paquetería e ingresa el número de guía.",a.style.display="block";return}n.disabled=!0,n.textContent="Guardando...",a.style.display="none";try{const i=await fetch(f+`/pedidos/${e}/marcar-enviado`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({paqueteria:t,numero_guia:o})}),s=await i.json();if(!i.ok)throw new Error(s.error||"Error al guardar");try{const r=await fetch(f+"/pedidos/"+e).then(c=>c.json()),d=r.telefono_cliente,l=(r.nombre_cliente||"Cliente").split(" ")[0];d&&await fetch(f+"/chatbot/templates/enviar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({telefono:d,template:"aviso_envio",params:[l,String(e).slice(-6),o,t]})})}catch{}document.getElementById("modal-envio").remove(),mostrarToast("✅ Pedido enviado — WhatsApp de tracking enviado al cliente"),await Le()}catch(i){a.textContent=i.message,a.style.display="block",n.disabled=!1,n.textContent="Confirmar envío ✓"}};async function Le(){const e=document.getElementById("content");try{const o=await(await fetch(f+"/pedidos/")).json(),a=new Date,n=new Date(a.getFullYear(),a.getMonth(),a.getDate()),i=new Date(a-7*24*60*60*1e3),s=o.filter(g=>g.status!=="cancelado"&&g.status!=="borrador"),r=s.filter(g=>new Date(g.created_at)>=n),d=r.reduce((g,y)=>g+parseFloat(y.total||0),0),l=s.filter(g=>new Date(g.created_at)>=i).reduce((g,y)=>g+parseFloat(y.total||0),0),c=o.filter(g=>g.status==="pendiente_pago").length,p=o.filter(g=>g.status==="pagado"&&g.mp_preference_id).length,m=o.filter(g=>g.forma_pago==="credito"&&g.status!=="cancelado").length,u=(g,y,b,h,v,w,_)=>`
      <div style="background:${v};border-radius:14px;padding:1.1rem 1.25rem;border:1px solid ${w};cursor:${_?"pointer":"default"};transition:transform 0.15s,box-shadow 0.15s"
           ${_?`onclick="${_}" onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 6px 20px rgba(0,0,0,0.08)'" onmouseout="this.style.transform='';this.style.boxShadow=''"`:""}>
        <p style="font-size:1.55rem;font-weight:800;color:${h};line-height:1;margin-bottom:3px;letter-spacing:-0.5px">${g}</p>
        <p style="font-size:0.7rem;font-weight:600;color:${h};opacity:0.85;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:1px">${y}</p>
        ${b?`<p style="font-size:0.68rem;color:#94a3b8;margin-top:2px">${b}</p>`:""}
      </div>`;e.innerHTML=`
      <div style="margin-bottom:1.25rem">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:10px;margin-bottom:16px">
          ${u(r.length,"Pedidos hoy",`$${d.toLocaleString("es-MX",{maximumFractionDigits:0})} vendidos`,"#E91E8C","linear-gradient(135deg,#fff0f8,#ffe4f2)","#f9a8d4","")}
          ${u("$"+Math.round(l/1e3)+"k","7 días",`${s.filter(g=>new Date(g.created_at)>=i).length} pedidos`,"#7c3aed","#f5f3ff","#ddd6fe","")}
          ${c>0?u(c,"SPEI pendiente","Esperando confirmación","#b45309","#fffbeb","#fcd34d","cargarPedidosFiltro('pendiente_pago')"):u("0","SPEI pendiente","Todo al corriente","#16a34a","#f0fdf4","#86efac","")}
          ${p>0?u(p,"Por enviar","Pagados online","#1d4ed8","#eff6ff","#93c5fd","cargarPedidosFiltro('por_enviar')"):u("0","Por enviar","Sin pendientes","#16a34a","#f0fdf4","#86efac","")}
          ${u(m,"En crédito","Pedidos activos","#0f766e","#f0fdfa","#99f6e4","cargarPedidosFiltro('credito')")}
        </div>
  ...
  `).join(""),o.style.display="block"};window.seleccionarClientePOS=(e,t)=>{document.getElementById("pos-cliente").value=e,document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-resultados").style.display="none";const o=document.getElementById("pos-cliente-seleccionado");o.textContent="✔ "+t+" — toca para cambiar",o.style.display="block"};window.limpiarClientePOS=()=>{document.getElementById("pos-cliente").value="",document.getElementById("pos-cliente-seleccionado").style.display="none",document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-buscar").focus()};window.renderProductosPOS=e=>{const{variantes:t,inventario:o}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=o.filter(s=>s.sucursal_id===a),i=document.getElementById("pos-productos-grid");i&&(i.innerHTML=e.filter(s=>s.activo).map(s=>{const r=t.filter(c=>c.producto_id===s.id),d=[...new Set(r.map(c=>c.color).filter(Boolean))],l=r.reduce((c,p)=>{const m=n.find(u=>u.variante_id===p.id);return c+(m?m.cantidad:0)},0);return`
    ...
    <div style="background:white;border-radius:16px;max-width:640px;width:100%;height:90vh;display:flex;flex-direction:column;overflow:hidden">
      ...
      <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
          ${l.map(p=>{const m=d.find(g=>g.color===p),u=d.filter(g=>g.color===p).reduce((g,y)=>{const b=r.find(h=>h.variante_id===y.id);return g+(b?b.cantidad:0)},0);return`
  ...
  `,document.body.appendChild(c),c.addEventListener("click",p=>{p.target===c&&c.remove()}),window._posSeleccion={productoId:e,color:null},window._posBuffer={}};window.mostrarCorridaModalPOS=e=>{const{variantes:t,inventario:o}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=o.filter(p=>p.sucursal_id===a),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],s=[...new Set(t.filter(p=>p.producto_id===e).map(p=>p.color).filter(Boolean))],r=document.querySelector(`button[onclick="mostrarCorridaModalPOS('${e}')"]`);r&&(r.style.display="none"),document.querySelectorAll("#pos-modal").forEach(p=>{p!==document.getElementById("pos-modal")&&p.remove()}),window._posSeleccion.color=null,window._corridaCantidades={};const d=document.getElementById("pos-tallas-panel");if(!d)return;const l=p=>{const m=t.filter(u=>u.producto_id===e&&u.color===p).sort((u,g)=>i.indexOf(u.talla)-i.indexOf(g.talla));m.filter(u=>{const g=n.find(y=>y.variante_id===u.id);return g&&g.cantidad>0}),d.innerHTML=`
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:16px">
        ${s.map(u=>{const g=t.find(v=>v.producto_id===e&&v.color===u),y=g?g.color_hex:"#888",b=g?g.foto_url:null,h=Object.entries(window._corridaCantidades).filter(([v])=>t.find(w=>w.id===v&&w.color===u)).reduce((v,[,w])=>v+w,0);return`
  ...
  `};window.seleccionarTallaPOS=(e,t)=>{window._posSeleccion.talla=t,window._posSeleccion.varianteId=e,document.querySelectorAll('[id^="pos-talla-"]').forEach(n=>{n.style.borderColor="#ddd",n.style.background="white",n.style.color="#333"});const o=document.getElementById("pos-talla-"+t.replace(".","_"));o&&(o.style.borderColor="#E91E8C",o.style.background="#fce4f3",o.style.color="#E91E8C");const a=document.getElementById("pos-btn-agregar");a&&(a.textContent="+ Agregar al carrito",a.disabled=!1)};window.agregarAlCarritoPOS=e=>{const{productos:t,variantes:o}=window._posData,{varianteId:a,color:n,talla:i}=window._posSeleccion;if(!a||!n||!i)return;const s=t.find(d=>d.id===e);if(!s)return;const r=window._posCarrito.find(d=>d.variante_id===a);r?r.cantidad++:window._posCarrito.push({variante_id:a,producto_id:e,nombre:s.nombre,color:n,talla:i,cantidad:1,precio_menudeo:parseFloat(s.precio_menudeo)||0,precio_mayoreo3:parseFloat(s.precio_mayoreo3)||parseFloat(s.precio_menudeo)-30,precio_mayoreo6:parseFloat(s.precio_mayoreo6)||parseFloat(s.precio_menudeo)-70,precio_corrida:parseFloat(s.precio_corrida)||parseFloat(s.precio_menudeo)-100,imagen:s.imagen_principal||null,es_oferta:s.es_oferta||!1,precio_unitario:parseFloat(s.precio_menudeo)||0}),document.getElementById("pos-modal").remove(),renderCarritoPOS()};window.agregarCorridaPOS=e=>{const{productos:t,variantes:o,inventario:a}=window._posData,{color:n}=window._posSeleccion;if(!n){alert("Selecciona un color primero");return}t.find(m=>m.id===e);const i=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",s=a.filter(m=>m.sucursal_id===i),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=o.filter(m=>m.producto_id===e&&m.color===n).sort((m,u)=>r.indexOf(m.talla)-r.indexOf(u.talla)),c=document.getElementById("pos-modal").querySelector("div > div:last-child"),p=`
    <div style="background:#f3e5f5;border-radius:8px;padding:1rem;margin-top:1rem;border:1px solid #ce93d8">
      ...
      <div style="display:flex;flex-direction:column;gap:6px">
        ${d.map(m=>{const u=s.find(y=>y.variante_id===m.id),g=u?u.cantidad:0;return`
            <div style="display:flex;align-items:center;gap:8px">
...
`).join("")}
    ...
    <div style="background:white;border-radius:16px;max-width:400px;width:100%;padding:1.5rem;max-height:90vh;overflow-y:auto">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${d.map(c=>{const p=s.find(y=>y.variante_id===c.id),m=p?p.cantidad:0,u=window._posCarrito.find(y=>y.variante_id===c.id&&y.es_corrida),g=u?u.cantidad:0;return`
            <div style="display:flex;align-items:center;gap:10px">
...
`+((l==null?void 0:l.message)||l)),[e,t].forEach(c=>{c&&(c.disabled=!1,c.textContent="Cobrar")})}};window.imprimirTicketPOS=async(e,t,o,a)=>{const i=await(await fetch(f+"/pedidos/"+e)).json();if(!i||i.length===0)return;const s=i[0],r=s.pedido_items||[],d=s.clientes||{},l=new Date().toLocaleString("es-MX"),c=window.open("","_blank","width=400,height=600");c.document.write(`
    ...
    <body>
      ...
      <div class="divider"></div>
      ${(()=>{const p={};return r.forEach(m=>{const u=m.variantes||{},g=u.productos||{},y=(g.nombre||"—")+"|"+(u.color||"");p[y]||(p[y]={nombre:g.nombre||"—",color:u.color||"",cantidad:0,subtotal:0}),p[y].cantidad+=m.cantidad,p[y].subtotal+=parseFloat(m.subtotal)||m.cantidad*m.precio_unitario}),`
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
        ...
        </tr>`}).join(""))};async function it(){try{const t=await(await fetch(f+"/pedidos/")).json(),a=await(await fetch(f+"/clientes/")).json(),i=await(await fetch(f+"/inventario/alertas")).json(),s=new Date;s.setHours(0,0,0,0);const r=new Date(s);r.setDate(r.getDate()-7);const d=new Date(s);d.setDate(d.getDate()-30);const l=t.filter(E=>["confirmado","pagado","enviado"].includes(E.status)),c=l.filter(E=>new Date(E.created_at)>=s),p=l.filter(E=>new Date(E.created_at)>=r),m=c.reduce((E,M)=>E+parseFloat(M.total||0),0),u=p.reduce((E,M)=>E+parseFloat(M.total||0),0),g=a.filter(E=>E.created_at&&new Date(E.created_at)>=d).length,y=["Dom","Lun","Mar","Mie","Jue","Vie","Sab"],b={};y.forEach(E=>b[E]=0),l.filter(E=>new Date(E.created_at)>=d).forEach(E=>{const M=y[new Date(E.created_at).getDay()];b[M]+=parseFloat(E.total||0)});const h={};l.forEach(E=>{h[E.canal||"sucursal"]=(h[E.canal||"sucursal"]||0)+parseFloat(E.total||0)});const v={};l.forEach(E=>{v[E.forma_pago||"efectivo"]=(v[E.forma_pago||"efectivo"]||0)+1});const w={};l.forEach(E=>{w[E.empleado||"Admin"]=(w[E.empleado||"Admin"]||0)+parseFloat(E.total||0)});const _={};l.forEach(E=>{const M=new Date(E.created_at).toLocaleDateString("es-MX",{month:"short",year:"numeric"});_[M]=(_[M]||0)+parseFloat(E.total||0)});const x={};l.forEach(E=>{E.clientes&&(x[E.clientes.nombre]=(x[E.clientes.nombre]||0)+parseFloat(E.total||0))});const P=Object.entries(x).sort((E,M)=>M[1]-E[1]).slice(0,5),L=Object.entries(b).sort((E,M)=>M[1]-E[1])[0],$=Object.entries(w).sort((E,M)=>M[1]-E[1])[0];if(!document.getElementById("dashboard-contenido"))return;const N=l.filter(E=>new Date(E.created_at)>=d),k=N.reduce((E,M)=>E+parseFloat(M.total||0),0),T=[];for(let E=6;E>=0;E--){const M=new Date(s);M.setDate(M.getDate()-E);const V=M.toISOString().split("T")[0],C=M.toLocaleDateString("es-MX",{weekday:"short",day:"numeric"}),O=l.filter(D=>{var j;return(j=D.created_at)==null?void 0:j.startsWith(V)}).reduce((D,j)=>D+parseFloat(j.total||0),0);T.push({label:C,total:O,ds:V})}const I=(E,M,V,C)=>{const O=document.getElementById(E),D=document.getElementById(E+"-sub");O&&(O.textContent=M,C&&(O.style.color=C)),D&&V&&(D.textContent=V)};I("kpi-ventas-hoy","$"+m.toLocaleString("es-MX",{maximumFractionDigits:0}),c.length+" pedidos","#C8967A"),I("kpi-pedidos-hoy",c.length,"confirmados"),I("kpi-ventas-7d","$"+u.toLocaleString("es-MX",{maximumFractionDigits:0}),p.length+" pedidos"),I("kpi-ventas-30d","$"+k.toLocaleString("es-MX",{maximumFractionDigits:0}),N.length+" pedidos"),I("kpi-clientes-nuevos",g,"últimos 30 días"),I("kpi-stock-bajo",i.length,i.length>0?"⚠ reabastecer":"✓ ok",i.length>0?"#f59e0b":"#10b981"),I("kpi-mejor-dia",L?L[0]:"—",L?"$"+L[1].toLocaleString("es-MX",{maximumFractionDigits:0}):""),I("kpi-total-clientes",a.length,"registrados");const S=document.getElementById("dash-top-clientes");S&&(S.innerHTML=P.length===0?'<p style="color:var(--text-muted);font-size:0.85rem">Sin datos aun</p>':P.map(([E,M],V)=>`
          <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px">
            <span style="width:22px;height:22px;background:linear-gradient(135deg,#C8967A,#b5687a);color:white;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:0.68rem;font-weight:700;flex-shrink:0">${V+1}</span>
          ...
          </div>`).join(""));const B=document.getElementById("dash-ultimos-pedidos");B&&(B.innerHTML=t.slice(0,6).map(E=>{var M;return`
        <div onclick="verPedido('${E.id}')" style="display:flex;align-items:center;justify-content:space-between;padding:9px 0;border-bottom:1px solid rgba(200,150,122,0.08);cursor:pointer;transition:background 0.12s">
          <div>
            <p style="font-size:0.84rem;font-weight:600;color:var(--text-1)">${((M=E.clientes)==null?void 0:M.nombre)||E.nombre_cliente||"General"}</p>
            <p style="font-size:0.7rem;color:var(--text-3);margin-top:1px">${E.mp_preference_id?"🌐 online":E.canal||"sucursal"} · ${new Date(E.created_at).toLocaleDateString("es-MX",{day:"numeric",month:"short"})}</p>
          </div>
          <div style="text-align:right">
        ...
        </div>`}).join("")),setTimeout(()=>{const E="#E91E8C",M="#7c3aed",V="#0891b2",C="#059669",O=["rgba(233,30,140,0.8)","rgba(124,58,237,0.8)","rgba(8,145,178,0.8)","rgba(5,150,105,0.8)","rgba(217,119,6,0.8)","rgba(220,38,38,0.8)"],D=["#E91E8C","#7c3aed","#0891b2","#059669","#d97706","#dc2626"],j={ticks:{color:"#94a3b8",font:{size:9}},grid:{color:"rgba(148,163,184,0.08)"}},q={responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:j,y:j}},A=document.getElementById("chart-tendencia");A&&window.Chart&&new Chart(A,{type:"line",data:{labels:T.map(G=>G.label),datasets:[{data:T.map(G=>G.total),borderColor:E,backgroundColor:"rgba(233,30,140,0.08)",borderWidth:2.5,pointBackgroundColor:E,pointBorderColor:"white",pointBorderWidth:2,pointRadius:5,pointHoverRadius:7,fill:!0,tension:.4}]},options:{...q,plugins:{legend:{display:!1},tooltip:{callbacks:{label:G=>" $"+G.parsed.y.toLocaleString("es-MX",{maximumFractionDigits:0})}}}}});const H=document.getElementById("chart-dias");H&&window.Chart&&new Chart(H,{type:"bar",data:{labels:y,datasets:[{data:y.map(G=>b[G]||0),backgroundColor:O,borderColor:D,borderWidth:1.5,borderRadius:6}]},options:{...q,plugins:{legend:{display:!1}}}});const R=document.getElementById("chart-canales");R&&window.Chart&&Object.keys(h).length>0&&new Chart(R,{type:"doughnut",data:{labels:Object.keys(h),datasets:[{data:Object.values(h),backgroundColor:O,borderColor:D,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"70%",plugins:{legend:{display:!1},tooltip:{callbacks:{label:G=>` ${G.label}: ${G.parsed}`}}}}});const F=document.getElementById("chart-meses");if(F&&window.Chart){const G=Object.entries(_).slice(-6);new Chart(F,{type:"line",data:{labels:G.map(([Y])=>Y),datasets:[{data:G.map(([,Y])=>Y),borderColor:M,backgroundColor:"rgba(124,58,237,0.07)",borderWidth:2,pointBackgroundColor:M,pointBorderColor:"white",pointBorderWidth:2,pointRadius:4,fill:!0,tension:.4}]},options:{...q,plugins:{legend:{display:!1}}}})}const X=document.getElementById("chart-pagos");X&&window.Chart&&Object.keys(v).length>0&&new Chart(X,{type:"doughnut",data:{labels:Object.keys(v),datasets:[{data:Object.values(v),backgroundColor:O,borderColor:D,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"70%",plugins:{legend:{display:!1},tooltip:{callbacks:{label:G=>` ${G.label}: ${G.parsed}`}}}}})},300);try{const M=await(await fetch(f+"/chatbot/tareas-hoy")).json(),V=document.createElement("div");V.style.cssText="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem;margin-top:1.5rem",V.innerHTML=`
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem">
        <h3 style="font-size:1rem;font-weight:700;margin:0">✅ Tareas pendientes hoy</h3>
        <span style="background:#e91e8c;color:white;border-radius:100px;padding:2px 10px;font-size:0.75rem">${M.filter(C=>!C.completada).length} pendientes</span>
      </div>
      ${M.length===0?'<p style="color:#aaa;font-size:0.85rem;text-align:center;padding:1rem">Sin tareas pendientes</p>':M.map(C=>`
          <div style="display:flex;align-items:center;gap:10px;padding:10px 0;border-bottom:1px solid #f5f5f5">
            <input type="checkbox" ${C.completada?"checked":""}
                   onchange="completarTareaDashboard('${C.id}', this.checked)"
                   style="width:16px;height:16px;cursor:pointer;accent-color:#25D366">
            <div style="flex:1">
              <p style="font-size:0.85rem;font-weight:600;margin:0;${C.completada?"text-decoration:line-through;color:#aaa":""}">${C.titulo}</p>
              <p style="font-size:0.72rem;color:#888;margin:0">${C.nombre_contacto||C.telefono} · ${C.agente||"Sin asignar"}</p>
            </div>
            <button onclick="navegarA('conversaciones');setTimeout(()=>abrirChat('${C.telefono}'),800)"
        ...
        `).join("")}
    `,document.getElementById("dashboard-contenido").appendChild(V)}catch(E){console.error("tareas:",E)}}catch(e){console.error("Error dashboard:",e)}}window.eliminarItemPedido=e=>{window._pedidoItems.splice(e,1),window.recalcularTotal(),window.renderItemsPedido()};window.cerrarSesionPanel=()=>{confirm("Cerrar sesion?")&&(sessionStorage.removeItem("erp_empleado"),sessionStorage.removeItem("erp_token"),window._empleadoActual=null,location.reload())};async function Fe(){const e=document.getElementById("content");try{const o=await(await fetch(f+"/empleados/",{headers:window.authHeaders()})).json();e.innerHTML=`
      <div class="table-card">
        <div class="table-header">
...
`).trim();if(n.match(/^https?:\/\/.+\.(jpg|jpeg|png|webp|gif)/i))return'<img src="'+n+'" style="max-width:200px;border-radius:8px;display:block">'+(i?'<p style="font-size:0.82rem;color:#333;white-space:pre-wrap;margin-top:6px">'+i+"</p>":"")}return'<p style="font-size:0.85rem;color:#333;white-space:pre-wrap">'+e.mensaje.replace(/\[.+?\]:\s*/,"")+"</p>"};window._recargarChats=async()=>{try{const e=await fetch(f+"/chatbot/chats").then(o=>o.json()),t=Array.isArray(e)?e:[];return window._chatsData={},t.forEach(o=>window._chatsData[o.telefono]=o),t}catch{return[]}};window._renderBurbujas=e=>{const t=[...e.mensajes].reverse(),o=t.reduce((a,n,i)=>n.tipo==="manual"||n.tipo==="imagen_saliente"||n.tipo==="documento_saliente"||n.tipo==="video_saliente"||n.tipo==="ubicacion_saliente"||n.tipo==="contacto_saliente"||n.tipo==="botones_saliente"||n.tipo==="lista_saliente"||n.tipo==="carrusel_saliente"||n.tipo==="template_saliente"?i:a,-1);return t.map((a,n)=>{var g,y;const i=a.tipo==="manual"||a.tipo==="imagen_saliente"||a.tipo==="documento_saliente"||a.tipo==="video_saliente"||a.tipo==="ubicacion_saliente"||a.tipo==="contacto_saliente"||a.tipo==="botones_saliente"||a.tipo==="lista_saliente"||a.tipo==="carrusel_saliente"||a.tipo==="template_saliente",s=i?((g=a.mensaje.match(/\[(.+?)\]:/))==null?void 0:g[1])||"Admin":e.nombre||e.telefono,r=new Date(a.created_at).toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"}),d=a.mensaje?a.mensaje.replace(/\[.+?\]:\s*/,""):"";let l="";if(a.tipo==="imagen_saliente"){const b=a.mensaje.replace(/\[.+?\]:\s*\[Imagen\]\s*/,"").split(`
`)[0].trim();l=b.match(/^https?:\/\/.+\.(jpg|jpeg|png|webp|gif)/i)?`<img src="${b}" style="max-width:200px;border-radius:8px;display:block;cursor:pointer" onclick="window.open('${b}')">`:`<p>${d}</p>`}else if(a.tipo==="documento_saliente"){const b=d.replace("[Documento] ","").split(" "),h=b[0]||"documento";l=`<a href="${b[1]||""}" target="_blank" class="wa-doc-link">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
        ${h}</a>`}else if(a.tipo==="video_saliente")l=`<video src="${d.replace("[Video] ","")}" controls style="max-width:220px;border-radius:8px;display:block"></video>`;else if(a.tipo==="botones_saliente"){const b=d.replace("[Botones] ","").split(" -> "),h=b[0]||d,v=(b[1]||"").split(" | ");l=`<p style="margin:0 0 8px">${h}</p>
        <div style="display:flex;flex-direction:column;gap:4px">${v.map(w=>`<span style="border:1px solid rgba(8,145,178,0.3);border-radius:6px;padding:4px 10px;font-size:0.78rem;color:#0891b2;text-align:center">${w}</span>`).join("")}</div>`}else if(a.tipo==="lista_saliente"){const b=d.replace("[Lista] ","").split(" -> "),h=b[0]||d,v=(b[1]||"").split(", ").slice(0,5);l=`<p style="margin:0 0 6px">${h}</p>
        <div style="border:1px solid rgba(8,145,178,0.25);border-radius:6px;padding:6px 8px;font-size:0.75rem;color:#0891b2">
          ${v.map(w=>`<div>• ${w}</div>`).join("")}
          ${v.length<(b[1]||"").split(", ").length?'<div style="color:#94a3b8">…</div>':""}
        ...
        ${d.replace("[Contacto] ","")}</span>`:a.tipo==="imagen"?l='<p style="color:#64748b;font-size:0.8rem">[Imagen recibida]</p>':l=`<p>${d}</p>`;let c="";if(i){const b=e.cliente_leyo_at?new Date(e.cliente_leyo_at):null,h=e.cliente_entrego_at?new Date(e.cliente_entrego_at):null,v=new Date(a.created_at);n===o?b&&b>=v?c=`<span class="wa-read-receipt read" title="Visto ${b.toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"})}">✓✓</span>`:h&&h>=v?c='<span class="wa-read-receipt delivered" title="Entregado">✓✓</span>':b?c='<span class="wa-read-receipt read" title="Visto">✓✓</span>':h?c='<span class="wa-read-receipt delivered" title="Entregado">✓✓</span>':c='<span class="wa-read-receipt sent" title="Enviado">✓</span>':c='<span class="wa-read-receipt sent">✓</span>'}const p=`<button class="wa-reply-btn" onclick="iniciarReply('${e.telefono}','${(a.wa_message_id||"").replace(/'/g,"")}')" title="Responder">
      ...
      <div class="wa-msg-row saliente">
        ...
        <div class="wa-msg-row-inner">
          ...
          <div class="wa-bubble bot">
            ...
            ${(a.respuesta.match(/(https?:\/\/[^\s]+\.(?:jpg|jpeg|png|webp))/gi)||[]).map(b=>`<img src="${b}" style="max-width:200px;border-radius:8px;margin-top:4px;display:block" onclick="window.open('${b}')">`).join("")}
            <div class="wa-bubble-time">${r}</div>
          </div>
        </div>
      </div>`:"";return m+u}).join("")};window.abrirChat=async e=>{const t=window._chatsData[e];if(!t)return;document.querySelectorAll(".wa-chat-item").forEach(i=>i.classList.remove("activo"));const o=document.querySelector(`[data-tel="${e}"]`);o&&o.classList.add("activo");const a=window.innerWidth<=900;if(a){const i=document.getElementById("wa-sidebar"),s=document.getElementById("wa-container");i&&(i.style.display="none"),s&&(s.style.gridTemplateColumns="1fr")}const n=document.getElementById("chat-area");n.style.display="flex",n.style.flexDirection="column",n.style.flex="1",n.style.minHeight="0",n.innerHTML=`
    <!-- Header compacto -->
  ...
  `,document.body.appendChild(a),a.addEventListener("click",n=>{n.target===a&&a.remove()})};window.cargarNotasTareas=async e=>{var s;(s=window._empleadoActual)!=null&&s.nombre;const t=new Date().toISOString().split("T")[0],[o,a]=await Promise.all([fetch(f+"/chatbot/notas/"+e).then(r=>r.json()),fetch(f+"/chatbot/tareas/"+e).then(r=>r.json())]),n=document.getElementById("notas-lista-"+e);n&&(n.innerHTML=o.length===0?'<p style="font-size:0.73rem;color:var(--text-3);text-align:center;padding:8px">Sin notas</p>':o.map(r=>`
    ...
    </div>`);document.body.appendChild(t),setTimeout(()=>{var o;return(o=document.getElementById("mbt-cuerpo"))==null?void 0:o.focus()},50)};window._enviarBotonesWA=async e=>{var r,d,l,c,p,m;const t=(r=document.getElementById("mbt-cuerpo"))==null?void 0:r.value.trim();if(!t){alert("Escribe el mensaje principal");return}const o=((d=document.getElementById("mbt-encabezado"))==null?void 0:d.value.trim())||"",a=((l=document.getElementById("mbt-btn1"))==null?void 0:l.value.trim())||"",n=((c=document.getElementById("mbt-btn2"))==null?void 0:c.value.trim())||"",i=[a,n].filter(Boolean),s=((p=window._empleadoActual)==null?void 0:p.nombre)||"Admin";(m=document.getElementById("modal-botones-wa"))==null||m.remove();try{await fetch(f+"/chatbot/chats/"+e+"/botones",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cuerpo:t,encabezado:o,botones:i,agente:s})}),await window._recargarChats(),abrirChat(e)}catch(u){alert("Error: "+u.message)}};window.mostrarModalLista=e=>{const t=fe("modal-lista-wa",`
...
`)||"(sin contenido)",n.style.display="block";const m=document.getElementById("envio-seccion-foto");if(m){m.style.display="block";const h=m.querySelector("p");h&&(h.innerHTML=p?'<span style="font-weight:700;font-size:0.9rem">2️⃣ Foto de portada del catálogo</span> <span style="font-weight:400;color:#aaa;font-size:0.78rem">(imagen principal que verá el cliente)</span>':'<span style="font-weight:700;font-size:0.9rem">2️⃣ Foto del modelo</span> <span style="font-weight:400;color:#aaa;font-size:0.78rem">(opcional — para plantillas con imagen)</span>')}const u=document.getElementById("envio-mpm-aviso");u&&(u.style.display=p?"block":"none"),window._envioEsMPM=p,window._envioHeaderTipo=(r==null?void 0:r.format)||(r!=null&&r.text?"TEXT":"NONE");const g=(d==null?void 0:d.text)||"",y=g.match(/\{\{[\d]*\}\}/g)||[];window._envioBodyVarsCount=y.length||(g.includes("{{")?1:0);const b=document.getElementById("envio-seccion-foto");b&&(b.style.display=window._envioHeaderTipo==="IMAGE"?"block":"none"),document.querySelectorAll('input[name="envio-plantilla-radio"]').forEach(h=>{const v=h.closest("label");v&&(v.style.borderColor=h.value===e?"#E91E8C":"#eee",v.style.background=h.value===e?"#fff0f8":"")})};const He=e=>{const t=document.getElementById("envio-lista");t&&(t.innerHTML=e.map(o=>{var i;const a=(i=window._envioSeleccionados)==null?void 0:i.has(o.telefono),n=o.telefono.replace(/\D/g,"");return`<label style="display:flex;align-items:center;gap:10px;padding:8px 10px;border-radius:8px;cursor:pointer;border:1.5px solid ${a?"#E91E8C":"#f0f0f0"};background:${a?"#fff0f8":"white"}" id="envio-row-${n}">
...
<div>
  ...
  <div style="display:flex;gap:1rem;flex-wrap:wrap">
    ...
    <div class="table-card">
    ...
    </div>`,a==="seleccionar"&&Re(e),a==="generar"&&qe(e)}window.switchTabCat=function(e){const{catalogoId:t}=window._catalogoPaginasData;window._catalogoPaginasData.tabActiva=e,document.querySelectorAll("#tab-subir,#tab-seleccionar,#tab-generar").forEach(o=>o.style.display="none"),document.getElementById("tab-"+e).style.display="block",document.querySelectorAll('[onclick^="switchTabCat"]').forEach(o=>{var n;const a=(n=o.getAttribute("onclick").match(/'(\w+)'/))==null?void 0:n[1];o.style.borderBottomColor=a===e?"#C8967A":"transparent",o.style.color=a===e?"#C8967A":"#6b7280"}),e==="seleccionar"&&Re(t),e==="generar"&&qe(t)};window.descargarCatalogoPDF=async function(){const e=window._catalogoPaginasData;if(!e)return;const{portada_url:t,paginas:o,nombre:a}=e,n=[];if(t&&n.push(t),[...o].sort((r,d)=>r.pagina_numero-d.pagina_numero).forEach(r=>{r.imagen_url&&n.push(r.imagen_url)}),n.length===0){alert("No hay páginas para descargar.");return}const s=document.querySelector('[onclick="descargarCatalogoPDF()"]');s&&(s.disabled=!0,s.textContent="⏳ Generando PDF...");try{window.jspdf||await new Promise((b,h)=>{const v=document.createElement("script");v.src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js",v.onload=b,v.onerror=h,document.head.appendChild(v)});const{jsPDF:r}=window.jspdf,d=b=>new Promise(h=>{const v=new Image;v.crossOrigin="anonymous",v.onload=()=>{const w=document.createElement("canvas");w.width=v.naturalWidth||v.width,w.height=v.naturalHeight||v.height,w.getContext("2d").drawImage(v,0,0),h({dataUrl:w.toDataURL("image/jpeg",.92),w:w.width,h:w.height})},v.onerror=()=>h(null),v.src=b}),c=(await Promise.all(n.map(d))).filter(Boolean);if(c.length===0){alert("No se pudieron cargar las imágenes. Revisa tu conexión.");return}const p=210,m=280,u=new r({unit:"mm",format:[p,m]}),g=(b,h)=>{h||u.addPage([p,m]);const v=b.w/b.h,w=p/m;let _,x,P,L;v>w?(_=p,x=p/v,P=0,L=(m-x)/2):(x=m,_=m*v,L=0,P=(p-_)/2),u.addImage(b.dataUrl,"JPEG",P,L,_,x)};c.forEach((b,h)=>g(b,h===0));const y=(a||"catalogo").replace(/[^a-zA-Z0-9_\-áéíóúñÁÉÍÓÚÑ ]/g,"").trim()||"catalogo";u.save(`${y}.pdf`)}catch(r){console.error("Error generando PDF:",r),alert("Error al generar el PDF: "+r.message)}finally{s&&(s.disabled=!1,s.innerHTML="📥 Descargar PDF")}};async function Re(e){const t=document.getElementById("selector-tienda-content");if(t)try{const[o,a]=await Promise.all([fetch(f+"/variantes/"),fetch(f+"/productos/")]),n=await o.json(),i=await a.json(),s=[];n.forEach(d=>{const l=i.find(p=>p.id===d.producto_id),c=(l==null?void 0:l.nombre)||d.sku||"";d.foto_url&&s.push({url:d.foto_url,nombre:c,color:d.color||""}),d.imagenes&&Array.isArray(d.imagenes)&&d.imagenes.forEach(p=>{p&&p!==d.foto_url&&s.push({url:p,nombre:c,color:d.color||""})})});const r=s.filter((d,l,c)=>c.findIndex(p=>p.url===d.url)===l);window._selectorFotos={fotos:r,seleccionadas:new Set},t.innerHTML=`
      ...
      </div>`}catch(o){t.innerHTML='<p style="color:red">Error: '+o.message+"</p>"}}window._toggleGenProd=function(e){const{seleccionados:t}=window._generadorData,o=document.getElementById("gen-item-"+e),a=document.getElementById("gen-colores-"+e);t.has(e)?(t.delete(e),o.style.borderColor="transparent",a&&(a.style.opacity="0.35",a.style.pointerEvents="none")):(t.add(e),o.style.borderColor="#C8967A",a&&(a.style.opacity="1",a.style.pointerEvents="auto")),document.getElementById("gen-count").textContent=t.size+" seleccionados"};window._toggleColorGen=function(e,t){var n,i;const o=document.getElementById(`gen-col-${e}-${t}`);if(!o)return;const a=o.dataset.sel==="1";o.dataset.sel=a?"0":"1",o.style.borderColor=a?"#ccc":"#C8967A",o.style.opacity=a?"0.3":"1",o.title=(((i=(n=window._generadorData.coloresPorProd[e])==null?void 0:n[t])==null?void 0:i.color)||"")+(a?" (excluido)":"")};window._selTodosGenerador=function(){const{productos:e,seleccionados:t}=window._generadorData,o=t.size===e.length;t.clear(),e.forEach((a,n)=>{const i=document.getElementById("gen-item-"+n);o?i&&(i.style.borderColor="transparent"):(t.add(n),i&&(i.style.borderColor="#C8967A"))}),document.getElementById("gen-count").textContent=t.size+" seleccionados"};function le(e){return new Promise(t=>{const o=new Image;o.crossOrigin="anonymous",o.onload=()=>t(o),o.onerror=()=>t(null),o.src=e+(e.includes("?")?"&":"?")+"_t="+Date.now()})}function _e(e,t,o,a,n,i){const s=t.split(" ");let r="",d=a;for(let l of s){const c=r+(r?" ":"")+l;e.measureText(c).width>n&&r?(e.fillText(r,o,d),r=l,d+=i):r=c}return r&&e.fillText(r,o,d),d+i}window.generarPaginasCanvas=async function(e){const{productos:t,variantes:o,seleccionados:a,coloresPorProd:n}=window._generadorData;if(!a.size){alert("Selecciona al menos un producto");return}const i=document.getElementById("gen-layout").value,s=i==="1e"?1:parseInt(i),r=[];Array.from(a).sort((b,h)=>b-h).forEach(b=>{const h=t[b],v=n?n[b]:[];if(!v||v.length<=1)r.push({prod:h,origIdx:b,colorFiltro:null,todosColSel:v||[]});else{const w=v.filter((x,P)=>{const L=document.getElementById(`gen-col-${b}-${P}`);return!L||L.dataset.sel!=="0"}),_=w.length>0?w:v;for(const x of _)r.push({prod:h,origIdx:b,colorFiltro:x.color,todosColSel:_})}});const d=b=>{const h=o.filter(v=>v.producto_id===b.prod.id&&v.activa!==!1);return b.colorFiltro?h.filter(v=>(v.color||"").trim()===b.colorFiltro):h},l=[];for(let b=0;b<r.length;b+=s)l.push(r.slice(b,b+s));const c=document.getElementById("btn-generar"),p=document.getElementById("gen-progress"),m=document.getElementById("gen-msg"),u=document.getElementById("gen-bar");c.disabled=!0,p.style.display="block";const{paginas:g}=window._catalogoPaginasData;let y=g.length>0?Math.max(...g.map(b=>b.pagina_numero))+1:1;for(let b=0;b<l.length;b++){const h=l[b],v=$=>($==null?void 0:$.prod)??$,w=$=>($==null?void 0:$.origIdx)??t.indexOf(($==null?void 0:$.prod)??$);m.textContent=`Generando página ${b+1} de ${l.length}...`,u.style.width=b/l.length*100+"%";const _=document.createElement("canvas");_.width=1080,_.height=1440;const x=_.getContext("2d");if(x.fillStyle="#FAFAF8",x.fillRect(0,0,1080,1440),x.fillStyle="#C8967A",x.fillRect(60,48,960,1),x.fillStyle="#2A1A0E",x.font="300 22px DM Sans, sans-serif",x.textAlign="center",x.letterSpacing="8px",x.fillText("ZAPATILLAS MAY",540,42),x.letterSpacing="0px",x.fillStyle="#C8967A",x.fillRect(60,58,960,1),i==="1e"){const $=h[0],z=v($),N=d($),k=[],T=new Set,I=j=>{j&&!T.has(j)&&(T.add(j),k.push(j))};N.length>0&&N[0].foto_url?I(N[0].foto_url):I(z.imagen_principal);for(const j of N)if(I(j.foto_url),Array.isArray(j.imagenes)&&j.imagenes.forEach(I),k.length>=3)break;const S=k.length,B=($.todosColSel||[]).map(j=>({color:j.color,hex:j.hex})),E={negro:"#1C1C1C",blanco:"#F8F8F8",hueso:"#F0EBE1",beige:"#D9C9A8",camel:"#C19A6B","cafe claro":"#A0725A","cafe medio":"#7A4A30","cafe oscuro":"#4A2010",cafe:"#6B3A2A",chocolate:"#3D1C02",cognac:"#9B4421",taupe:"#8B7355",nude:"#D4A97A","nude claro":"#E8C9A8","nude oscuro":"#C0886A","nude rosa":"#DDA090","palo de rosa":"#D4A0A0",salmon:"#FA8072",coral:"#FF6B4A",rojo:"#CC2200",vino:"#722F37",bordo:"#800020","rosa claro":"#F9C0CB",rosa:"#F4607A",fusha:"#E91E8C",naranja:"#FF8C00",amarillo:"#F5C518",dorado:"#D4AF37",oro:"#CFB53B","oro rosa":"#E8B4B8",plateado:"#C0C0C0","azul claro":"#5B8DB8",azul:"#1E4080","azul marino":"#001F5B",turquesa:"#40C4AA",verde:"#2D6A4F","verde menta":"#98D8C8","gris claro":"#C8C8C8",gris:"#909090","gris oscuro":"#505050",morado:"#7B2D8B",lila:"#C8A0D8",multicolor:"#CCAA88"},M=({color:j,hex:q})=>{if(q&&q.startsWith("#"))return q;const A=(j||"").toLowerCase();if(E[A])return E[A];for(const[H,R]of Object.entries(E))if(A.includes(H))return R;return"#BBAA99"},V=(j,q,A,H,R)=>{if(x.save(),x.fillStyle="#FFFFFF",x.fillRect(q,A,H,R),j){x.beginPath(),x.rect(q,A,H,R),x.clip();const F=j.naturalWidth/j.naturalHeight,X=H/R;let G,Y,U,J;F>X?(U=H,J=H/F,G=q,Y=A+(R-J)/2):(J=R,U=R*F,Y=A,G=q+(H-U)/2),x.drawImage(j,G,Y,U,J)}x.restore()},C=62,O=1080,D=C+O+12;if(S>=3){const[j,q,A]=await Promise.all(k.slice(0,3).map(le)),H=10,R=10,F=648,X=1080-F-H,G=Math.floor((O-R)/2);V(j,0,C,F,O),V(q,F+H,C,X,G),V(A,F+H,C+G+R,X,G)}else if(S===2){const[j,q]=await Promise.all(k.map(le)),A=10,H=Math.floor((1080-A)/2);V(j,0,C,H,O),V(q,H+A,C,H,O)}else{const[j]=await Promise.all([le(k[0])]);V(j,40,C,1e3,O)}if(x.fillStyle="#E8DDD5",x.fillRect(0,D,1080,1),x.fillStyle="#2A1A0E",x.textAlign="center",x.font="300 28px DM Sans, sans-serif",x.letterSpacing="3px",_e(x,z.nombre.toUpperCase(),540,D+42,960,38),x.letterSpacing="0px",z.sku&&(x.fillStyle="#A07860",x.font="400 14px DM Mono, monospace",x.fillText(z.sku,540,D+66)),B.length>0){const A=Math.min(B.length,14),H=A*(11*2)+(A-1)*8;let R=Math.round(540-H/2+11);const F=D+100;for(let X=0;X<A;X++){const G=R+X*30;x.beginPath(),x.arc(G,F,11,0,Math.PI*2),x.fillStyle=M(B[X]),x.fill(),x.strokeStyle="rgba(0,0,0,0.18)",x.lineWidth=1.5,x.stroke()}}}else{const $=s<=2?s:2,z=s===4?2:1,N=80,k=100,T=s===1?0:20,I=s===4?20:0,S=s===1?40:28,B=(1080-S*2-T*($-1))/$,E=(1440-N-k-I*(z-1))/z;for(let M=0;M<h.length;M++){const V=v(h[M]);w(h[M]);const C=M%$,O=Math.floor(M/$),D=S+C*(B+T),j=N+O*(E+I),q=s===1?120:s===2?90:70,A=E-q,H=d(h[M]),R=H.length>0&&H[0].foto_url?H[0].foto_url:V.imagen_principal,F=await le(R);if(x.save(),x.fillStyle="#FFFFFF",x.fillRect(D,j,B,A),F){x.beginPath(),x.rect(D,j,B,A),x.clip();const Y=F.naturalWidth/F.naturalHeight,U=B/A;let J,Q,W,Z;Y>U?(W=B,Z=B/Y,J=D,Q=j+(A-Z)/2):(Z=A,W=A*Y,Q=j,J=D+(B-W)/2),x.drawImage(F,J,Q,W,Z)}x.restore(),x.fillStyle="#E8DDD5",x.fillRect(D,j+A,B,1);const X=j+A+q/2;x.fillStyle="#2A1A0E",x.textAlign="center";const G=s===1?34:s===2?24:19;x.font=`300 ${G}px DM Sans, sans-serif`,x.letterSpacing="2px",_e(x,V.nombre.toUpperCase(),D+B/2,X-8,B-32,G+10),x.letterSpacing="0px",V.sku&&(x.fillStyle="#A07860",x.font=`400 ${s===1?18:13}px DM Mono, monospace`,x.fillText(V.sku,D+B/2,X+(s===1?36:26)))}}x.fillStyle="#C8967A",x.fillRect(60,1340,960,1),x.fillStyle="#A07860",x.font="300 18px DM Sans, sans-serif",x.textAlign="center",x.letterSpacing="3px",x.fillText("@ZAPATILLASMAY",540,1368),x.letterSpacing="0px",x.fillStyle="#C0A898",x.font="300 15px DM Sans, sans-serif",x.fillText("zapatillasmay.mx  ·  León, Guanajuato",540,1394);const P=await new Promise($=>_.toBlob($,"image/jpeg",.92)),L=new FormData;L.append("archivo",P,`catalogo-pag-${y}.jpg`);try{const z=await(await fetch(f+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:L})).json();z.url&&await fetch(f+"/catalogos/"+e+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:z.url,pagina_numero:y++})})}catch($){console.error("Error subiendo página generada",$)}}u.style.width="100%",m.textContent=`✅ ${l.length} páginas generadas`,setTimeout(()=>{p.style.display="none"},2e3),c.disabled=!1,await gestionarPaginas(e,window._catalogoPaginasData.nombre)};window.descargarCatalogoPorCategoria=async function(e,t){const o=document.getElementById("cat-pdf-msg"),a=document.querySelectorAll("#cat-pdf-btns button");a.forEach(n=>n.disabled=!0),o&&(o.style.display="block",o.textContent=`⏳ Cargando productos de ${t}...`);try{const[n,i]=await Promise.all([fetch(f+`/productos/?categoria=eq.${e}&activo=eq.true&order=nombre.asc`),fetch(f+"/variantes/")]),s=await n.json(),r=await i.json();if(!s.length){o&&(o.textContent=`Sin productos activos en ${t}`),a.forEach(k=>k.disabled=!1);return}o&&(o.textContent=`✏️ Generando PDF (${s.length} productos)...`),window.jspdf||await new Promise((k,T)=>{const I=document.createElement("script");I.src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js",I.onload=k,I.onerror=T,document.head.appendChild(I)});const{jsPDF:d}=window.jspdf,l=2,c=2,p=l*c,m=1080,u=1440,g=40,y=16,b=70,h=80,v=(m-g*2-y*(l-1))/l,w=(u-b-h-y*(c-1))/c,_=60,x=k=>new Promise(T=>{if(!k)return T(null);const I=new Image;I.crossOrigin="anonymous",I.onload=()=>T(I),I.onerror=()=>T(null),I.src=k}),P=(k,T,I,S,B,E)=>{if(k.save(),k.fillStyle="#FFFFFF",k.fillRect(I,S,B,E),T){k.beginPath(),k.rect(I,S,B,E),k.clip();const M=T.naturalWidth/T.naturalHeight,V=B/E;let C,O,D,j;M>V?(D=B,j=B/M,C=I,O=S+(E-j)/2):(j=E,D=E*M,O=S,C=I+(B-D)/2),k.drawImage(T,C,O,D,j)}k.restore()},L=[];for(let k=0;k<s.length;k+=p)L.push(s.slice(k,k+p));const $=new d({orientation:"portrait",unit:"px",format:[m,u]});let z=!0;for(let k=0;k<L.length;k++){o&&(o.textContent=`✏️ Página ${k+1} de ${L.length}...`);const T=L[k],I=document.createElement("canvas");I.width=m,I.height=u;const S=I.getContext("2d");S.fillStyle="#FAFAF8",S.fillRect(0,0,m,u),S.fillStyle="#C8967A",S.fillRect(g,36,m-g*2,1),S.fillStyle="#2A1A0E",S.font="300 20px sans-serif",S.textAlign="center",S.letterSpacing="8px",S.fillText("ZAPATILLAS MAY",m/2,32),S.letterSpacing="3px",S.font="400 13px sans-serif",S.fillStyle="#A07860",S.fillText(t.replace(/^[^\s]+\s/,"").toUpperCase(),m/2,54),S.letterSpacing="0px",S.fillStyle="#C8967A",S.fillRect(g,62,m-g*2,1);for(let E=0;E<T.length;E++){const M=T[E],V=E%l,C=Math.floor(E/l),O=g+V*(v+y),D=b+C*(w+y),j=w-_,q=r.filter(F=>F.producto_id===M.id&&F.activa!==!1),A=q.length>0&&q[0].foto_url?q[0].foto_url:M.imagen_principal,H=await x(A);P(S,H,O,D,v,j),S.fillStyle="#E8DDD5",S.fillRect(O,D+j,v,1),S.fillStyle="#2A1A0E",S.textAlign="center",S.font="600 18px sans-serif";const R=M.nombre.length>28?M.nombre.substring(0,26)+"…":M.nombre;S.fillText(R.toUpperCase(),O+v/2,D+j+26),M.precio_menudeo&&(S.fillStyle="#C8967A",S.font="400 15px sans-serif",S.fillText(`$${Number(M.precio_menudeo).toFixed(0)} MXN`,O+v/2,D+j+48))}S.fillStyle="#C8967A",S.fillRect(g,u-h,m-g*2,1),S.fillStyle="#A07860",S.textAlign="center",S.font="300 16px sans-serif",S.letterSpacing="3px",S.fillText("@ZAPATILLASMAY",m/2,u-50),S.letterSpacing="0px",S.fillStyle="#C0A898",S.font="300 13px sans-serif",S.fillText("zapatillasmay.mx  ·  León, Guanajuato",m/2,u-28);const B=I.toDataURL("image/jpeg",.88);z||$.addPage(),$.addImage(B,"JPEG",0,0,m,u),z=!1}const N=`catalogo-${e}-zapatillasmay.pdf`;$.save(N),o&&(o.textContent=`✅ Descargado: ${N}`,setTimeout(()=>{o.style.display="none"},4e3))}catch(n){console.error(n),o&&(o.textContent="Error generando el PDF: "+n.message)}finally{a.forEach(n=>n.disabled=!1)}};window.subirPaginasCatalogo=async function(e,t){const o=Array.from(e.files||e);if(!o.length)return;const a=document.getElementById("upload-progress"),n=document.getElementById("upload-msg"),i=document.getElementById("upload-bar");a&&(a.style.display="block");const{paginas:s}=window._catalogoPaginasData;let r=s.length>0?Math.max(...s.map(d=>d.pagina_numero))+1:1;for(let d=0;d<o.length;d++){n&&(n.textContent=`Subiendo ${d+1} de ${o.length}...`),i&&(i.style.width=d/o.length*100+"%");try{const l=new FormData;l.append("archivo",o[d]);const p=await(await fetch(f+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:l})).json();p.url&&await fetch(f+"/catalogos/"+t+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:p.url,pagina_numero:r++})})}catch(l){console.error("Error subiendo página "+(d+1),l)}}i&&(i.style.width="100%"),n&&(n.textContent="✅ Listo"),setTimeout(()=>{a&&(a.style.display="none")},1500),e.value!==void 0&&(e.value=""),await gestionarPaginas(t,window._catalogoPaginasData.nombre)};window.moverPagina=async function(e,t){const{paginas:o,catalogoId:a,nombre:n}=window._catalogoPaginasData,i=o.findIndex(l=>l.id===e);if(i===-1)return;const s=t==="up"?i-1:i+1;if(s<0||s>=o.length)return;const r=o[i].pagina_numero,d=o[s].pagina_numero;await Promise.all([fetch(f+"/catalogos/paginas/"+o[i].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:d})}),fetch(f+"/catalogos/paginas/"+o[s].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:r})})]),await gestionarPaginas(a,n)};window.eliminarPagina=async function(e,t){confirm("¿Eliminar esta página?")&&(await fetch(f+"/catalogos/paginas/"+e,{method:"DELETE"}),await gestionarPaginas(t,window._catalogoPaginasData.nombre))};window.usarComoPortada=async function(e,t){await fetch(f+"/catalogos/"+t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({portada_url:e})}),alert("✅ Portada actualizada")};window.mlVerStock=async function(e){const t=e.innerHTML;e.innerHTML="⏳ Consultando...",e.disabled=!0;const o=document.getElementById("ml-resultado");try{const n=await(await fetch(f+"/ml/stock")).json();if(o.style.display="block",n.diferencias&&n.diferencias.length>0){const i=n.diferencias.map(s=>`${s.item_id} | SKU: ${s.seller_sku} | ML: ${s.qty_ml} | ERP: ${s.qty_erp}`).join(`
...
`):"")}}catch(s){o.style.display="block",o.textContent="Error: "+s.message}e.innerHTML=t,e.disabled=!1};async function Ve(e,t){var s,r,d,l,c,p;const o=document.getElementById("ml-pub-sku").value.trim(),a=document.getElementById("ml-pub-listing").value,n=document.getElementById("ml-pub-resultado"),i=t.innerHTML;if(!o){alert("Ingresa el SKU del producto (ej: M-SAN-0148)");return}t.innerHTML=e?"⏳ Generando preview...":"⏳ Publicando en ML...",t.disabled=!0,n.style.display="none";try{const m=await fetch(f+"/ml/publicar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sku_interno:o.toUpperCase().trim(),listing_type:a,solo_preview:e})}),u=await m.json();if(n.style.display="block",!m.ok){n.textContent="❌ Error: "+(u.detail||JSON.stringify(u));return}if(e){const g=(s=u.resultados)==null?void 0:s[0];if(!g){n.textContent="Sin resultados";return}const y=g.preview;let b=`=== PREVIEW — ${u.producto} (${u.total} variantes) ===
...
`,b+=`Imágenes:    ${((r=y.pictures)==null?void 0:r.length)||0}
...
`})})),n.textContent=b}}catch(m){n.style.display="block",n.textContent="Error inesperado: "+m.message}finally{t.innerHTML=i,t.disabled=!1}}window.mlPublicarPreview=function(e){Ve(!0,e)};window.mlPublicarReal=function(e){confirm("¿Publicar TODAS las variantes activas de este producto en MercadoLibre? Esto creará nuevos items en tu cuenta.")&&Ve(!1,e)};window.descargarExcelTikTok=async function(e,t,o){const a=e.innerHTML;try{e.innerHTML="⏳ Generando...",e.disabled=!0;const n=await fetch(`${f}/tiktok/${t}`);if(!n.ok){const d=await n.text();throw new Error(`Error ${n.status}: ${d}`)}const i=await n.blob(),s=URL.createObjectURL(i),r=document.createElement("a");r.href=s,r.download=o,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(s)}catch(n){alert("Error al descargar el archivo: "+n.message)}finally{e.innerHTML=a,e.disabled=!1}};async function ct(){const e=document.getElementById("content");e.innerHTML=`
  ...
  `,document.getElementById("ml-titulo").addEventListener("input",function(){document.getElementById("ml-titulo-count").textContent=this.value.length}),window.mlGenerarPreview=async()=>{var d,l,c,p;const o=document.getElementById("ml-sku").value.trim().toUpperCase(),a=document.getElementById("ml-listing").value,n=document.getElementById("ml-titulo").value.trim(),i=document.getElementById("ml-precio").value.trim(),s=i?parseFloat(i):null;if(!o){alert("Ingresa el SKU del producto");return}if(!n){alert("Ingresa el título para ML");return}if(n.length>60){alert("El título no puede superar 60 caracteres");return}if(s!==null&&(isNaN(s)||s<=0)){alert("El precio debe ser mayor a 0");return}const r=document.getElementById("ml-btn-preview");r.textContent="⏳ Generando...",r.disabled=!0;try{const m=await fetch(`${f}/ml/publicar`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sku_interno:o,listing_type:a,solo_preview:!0})}),u=await m.json();if(!m.ok){alert("Error: "+(u.detail||JSON.stringify(u)));return}const g=u.resultados||[];if(!g.length){alert("No se encontraron variantes activas");return}const y=document.getElementById("ml-descripcion"),b=((c=(l=(d=g[0])==null?void 0:d.preview)==null?void 0:l.description)==null?void 0:c.plain_text)||"";y.value.trim()||(y.value=b);const h={},v=[],w=new Set;for(const z of g){const N=z.color||"Sin color";h[N]||(h[N]=[]);for(const k of((p=z.preview)==null?void 0:p.pictures)||[])k.source&&(h[N].find(T=>T.source===k.source)||h[N].push(k),w.has(k.source)||(w.add(k.source),v.push(k)))}const _={},x=new Set;for(const z of Object.keys(h))_[z]=0,x.add(z);const P=Object.keys(h);if(P.length>0){const z=document.getElementById("ml-fotos-wrap"),N=document.getElementById("ml-fotos-grid"),k=()=>{T();const I=g.filter(S=>x.has(S.color||"Sin color"));t(I,n,s,_,y.value.trim(),h)},T=()=>{N.innerHTML=P.map(I=>{const S=h[I];if(!S.length)return"";const B=x.has(I),E=I.replace(/'/g,"\\'"),M=I.replace(/[^a-zA-Z0-9]/g,"_");return`
              <div style="margin-bottom:1rem;width:100%;opacity:${B?1:.4}">
                <label style="display:flex;align-items:center;gap:8px;cursor:pointer;margin-bottom:6px">
                  ...
                  <span style="font-size:0.72rem;color:#888">(${g.filter(V=>(V.color||"Sin color")===I).length} tallas)</span>
                </label>
                <div style="display:flex;gap:8px;flex-wrap:wrap;padding-left:24px">
                  ${S.map((V,C)=>`
                    <div onclick="${B?`mlSeleccionarPortadaColor('${E}',${C})`:""}"
                         id="ml-foto-${M}-${C}"
                         style="cursor:${B?"pointer":"default"};border:3px solid ${C===_[I]&&B?"#3483fa":"#ddd"};border-radius:8px;overflow:hidden;width:80px;height:80px;position:relative;flex-shrink:0">
                      <img src="${V.source}" style="width:100%;height:100%;object-fit:cover">
                      ${C===_[I]&&B?'<div style="position:absolute;bottom:0;left:0;right:0;background:#3483fa;color:#fff;font-size:0.55rem;text-align:center;padding:2px;font-weight:700">PORTADA</div>':""}
                    </div>
                  `).join("")}
                </div>
              </div>`}).join("")};T(),z.style.display="block",window.mlToggleColor=I=>{x.has(I)?x.delete(I):x.add(I),k()},window.mlSeleccionarPortadaColor=(I,S)=>{_[I]=S,k()}}const L=g.filter(z=>x.has(z.color||"Sin color"));t(L,n,s,_,y.value.trim(),h);const $=document.getElementById("ml-variantes-wrap");$.style.display="block",$.scrollIntoView({behavior:"smooth",block:"start"})}catch(m){alert("Error de conexión: "+m.message)}finally{r.textContent="🔍 Generar preview",r.disabled=!1}};function t(o,a,n,i,s,r){const d=document.getElementById("ml-variantes-titulo"),l=document.getElementById("ml-variantes-list");d.textContent=`Paso 2 — Revisa y edita (${o.length} variantes, título aplicado a todas)`,l.innerHTML=o.map((c,p)=>{const m={...c.preview,family_name:a};if(delete m.title,n!==null&&(m.price=n),s&&(m.description={plain_text:s}),r){const u=c.color||"Sin color",g=r[u]||[],y=i&&i[u]||0;let b=[...g];if(y>0&&y<b.length){const[h]=b.splice(y,1);b.unshift(h)}if(b.length<3&&r){for(const[h,v]of Object.entries(r))if(h!==u){for(const w of v)if(b.find(_=>_.source===w.source)||b.push(w),b.length>=12)break;if(b.length>=12)break}}m.pictures=b.slice(0,12)}return`
  ...
  `,await ut(),oe=setInterval(async()=>{document.getElementById("ga-activos")?await Ge():(clearInterval(oe),oe=null)},3e4)}async function we(e,t=8e3){const o=new AbortController,a=setTimeout(()=>o.abort(),t);try{const n=await fetch(e,{signal:o.signal});return clearTimeout(a),n}catch(n){throw clearTimeout(a),n.name==="AbortError"?new Error("timeout"):n}}async function ut(){const e=[Ge().catch(()=>ue("ga-activos","—")),gt().catch(()=>ue("ga-sesiones","—")),ft().catch(()=>ue("ga-chart",null))];await Promise.allSettled(e);const t=document.getElementById("ga-ultima-act");t&&(t.textContent="Actualizado: "+new Date().toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit",second:"2-digit"}))}function ue(e,t){const o=document.getElementById(e);o&&t!==null&&(o.textContent=t)}async function Ge(){var e;try{const o=await(await we(`${f}/analytics/tiempo-real`)).json();if(!o.configurado){bt(o);return}const a=document.getElementById("ga-activos");if(!a)return;a.textContent=o.activos_ahora??0;const n=document.getElementById("ga-dispositivos");n&&o.por_dispositivo&&(n.textContent=Object.entries(o.por_dispositivo).map(([s,r])=>`${s}: ${r}`).join(" · "));const i=document.getElementById("ga-paginas-rt");i&&((e=o.por_pais)!=null&&e.length)?i.innerHTML='<div style="font-size:0.65rem;color:#aaa;margin-bottom:4px;text-transform:uppercase;letter-spacing:.05em">Por país</div>'+o.por_pais.map(s=>`
...
Nuevo monto:`,o);if(a===null)return;const n=parseFloat(a);if(isNaN(n)||n<0)return alert("Monto inválido");try{(await fetch(f+"/clientes/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({credito_disponible:n})})).ok?await $e():alert("Error actualizando crédito")}catch(i){alert("Error: "+i.message)}};async function Ee(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando carritos...</p>';try{const[t,o,a]=await Promise.all([fetch(f+"/pedidos/?status=borrador").then(i=>i.json()).catch(()=>[]),fetch(f+"/clientes/").then(i=>i.json()),fetch(f+"/sucursales/").then(i=>i.json())]),n=Array.isArray(t)?t.filter(i=>i.status==="borrador"&&(!i.canal||i.canal==="sucursal"||i.canal==="mayoreo")):[];e.innerHTML=`
    ...
    <div style="max-width:860px">
      ...
      <div class="table-card" style="padding:1.2rem">
        ...
        <div id="carrito-items-lista">
          ...
          ${(()=>{const m={};return a.forEach((u,g)=>{const y=u.variantes||{},b=y.productos||{},h=b.nombre||u.nombre||"—",v=y.color||u.color||"",w=!!u.es_corrida,_=w?"c|"+h+"|"+v:"s|"+u.id;m[_]||(m[_]={nombre:h,color:v,esCorrida:w,items:[],imagen:y.foto_url||b.imagen_principal||null}),m[_].items.push({...u,_idx:g})}),Object.values(m).map(u=>{const g=u.esCorrida,y=u.imagen;if(g){const b=u.items.reduce((_,x)=>_+x.cantidad,0),h=u.items.reduce((_,x)=>_+x.cantidad*x.precio_unitario,0),v=(h/b).toFixed(2),w=u.items.map(_=>_.id).join(",");return`
                  <div style="background:#fdf4ff;border-radius:8px;padding:12px;margin-bottom:8px;border:1px solid #e8d5f5">
                    <div style="display:flex;align-items:start;gap:10px;margin-bottom:8px">
                      ...
                      <div style="flex:1">
                        ...
                        <div style="display:flex;flex-wrap:wrap;gap:4px">
                          ${u.items.map(_=>`<span style="background:#f3e5f5;border-radius:100px;padding:2px 8px;font-size:0.72rem;color:#6a1b9a">T${(_.variantes||{}).talla||_.talla||"?"}</span>`).join("")}
                        </div>
                      </div>
                    ...
                    <div id="corrida-detalle-${w.replace(/,/g,"_").substring(0,20)}" style="display:none;margin-top:10px;border-top:1px solid #e8d5f5;padding-top:10px">
                      ${u.items.map(_=>{const P=(_.variantes||{}).talla||_.talla||"?",L=s.find(z=>z.variante_id===_.variante_id&&(r?z.sucursal_id===r:!0)),$=L?L.cantidad:999;return`
                          <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px"
                  ...
                  </div>`}else{const b=u.items[0],h=b.variantes||{};h.productos;const v=h.talla||b.talla||"",w=s.find(x=>x.variante_id===b.variante_id&&(r?x.sucursal_id===r:!0)),_=w?w.cantidad:null;return`
  ...
  `).join("")};window.seleccionarModeloCorrida=(e,t)=>{const{variantes:o,productos:a,inventario:n,sucursalId:i}=window._carritoActivo,s=a.find(m=>m.id===e);document.getElementById("c-buscar-corrida").value=`${(s==null?void 0:s.nombre)||""} · ${t}`,document.getElementById("c-corrida-resultados").style.display="none";const r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=o.filter(m=>m.producto_id===e&&m.color===t).sort((m,u)=>r.indexOf(m.talla)-r.indexOf(u.talla)),l=parseFloat(s==null?void 0:s.precio_menudeo)||0,c=parseFloat(s==null?void 0:s.precio_corrida)||(l>0?Math.round(l-100):0);document.getElementById("c-precio-corrida").value=c||"",window._corridaSeleccionada={productoId:e,color:t,variantes:d,prod:s,precioCorrida:c};const p=document.getElementById("c-corrida-tallas-grid");p.innerHTML=d.map(m=>{const u=n.find(b=>b.variante_id===m.id&&(i?b.sucursal_id===i:!0)),g=u?u.cantidad:null,y=g!==null&&g===0;return`
  ...
  `,window.hacerLogin=async()=>{const t=document.getElementById("login-email").value,o=document.getElementById("login-password").value,a=document.getElementById("btn-login");if(document.getElementById("login-error"),!t||!o){e("Por favor completa todos los campos");return}a.textContent="Verificando...",a.disabled=!0;try{const n=await fetch("/api/empleados/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:o})}),i=await n.json();n.ok?(sessionStorage.setItem(Ue,JSON.stringify(i)),i.token&&sessionStorage.setItem("erp_token",i.token),window._empleadoActual=i,Ie()):(e(i.error||"Email o contrasena incorrectos"),a.textContent="Iniciar sesion",a.disabled=!1)}catch{e("Error conectando con el servidor"),a.textContent="Iniciar sesion",a.disabled=!1}};function e(t){const o=document.getElementById("login-error");o&&(o.textContent=t,o.style.display="block")}}window.authHeaders=()=>{const e=sessionStorage.getItem("erp_token");return e?{"Content-Type":"application/json",Authorization:`Bearer ${e}`}:{"Content-Type":"application/json"}};const ke=sessionStorage.getItem(Ue);if(ke)try{window._empleadoActual=JSON.parse(ke),Ie()}catch{Ce()}else Ce();
