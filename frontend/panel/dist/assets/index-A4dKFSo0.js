          ...
          ${i.length===0?'<div class="table-card" style="padding:2rem;text-align:center;color:var(--text-muted)">No hay pedidos pendientes de pago 🎉</div>':`<div class="table-card" style="padding:0;overflow:hidden">
            <div style="overflow-x:auto">
              <table style="width:100%;border-collapse:collapse;font-size:0.85rem">
                ...
                <tbody>
                  ${i.map(l=>{const c=l.nombre_cliente||"—",p=l.email_cliente||"",u=l.telefono_cliente||"",g=l.horas_pendiente!=null?l.horas_pendiente<1?"hace &lt;1h":`hace ${l.horas_pendiente}h`:"—",m=!!l.recordatorio_pago_enviado_at;return`<tr data-pedido-id="${l.id}" style="border-bottom:1px solid var(--border)">
                      <td style="padding:10px 14px">
                      ...
                      <td style="padding:10px 14px">
                        <div style="display:flex;gap:6px;flex-wrap:wrap">
                          ...
                          ${u?`<button onclick="enviarRecordatorioWA('${l.id}', this, '${(l.nombre_cliente||"").split(" ")[0]}', '${parseFloat(l.total||0).toFixed(0)}', '${(l.forma_pago||"OXXO/SPEI").toUpperCase()}')" style="padding:5px 12px;border-radius:20px;border:1.5px solid #25D366;background:none;color:#15803d;font-size:0.75rem;font-weight:600;cursor:pointer">💬 WhatsApp</button>`:""}
                        </div>
