(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function o(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=o(n);fetch(n.href,i)}})();const f="/api",Ie=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],Ye=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],Qe=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],ie=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"resenas",icon:"⭐",label:"Reseñas",section:"Catalogo",soloAdmin:!0},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"carritos",icon:"🛒",label:"Carritos",section:"Ventas"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"envio",icon:"🚚",label:"Envíos",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"},{id:"catalogos",icon:"📖",label:"Catálogos",section:"Catalogo",soloAdmin:!0},{id:"orden-home",icon:"🏠",label:"Orden en Home",section:"Catalogo",soloAdmin:!0},{id:"generar-nombres",icon:"✏️",label:"Generar nombres",section:"Catalogo",soloAdmin:!0},{id:"mercadolibre",icon:"🛒",label:"MercadoLibre",section:"Integraciones",soloAdmin:!0},{id:"analytics",icon:"📊",label:"Google Analytics",section:"Integraciones",soloAdmin:!0},{id:"referidos",icon:"🎁",label:"Referidos",section:"Ventas",soloAdmin:!0},{id:"carritos-abandonados",icon:"🛒",label:"Carritos abandonados",section:"Ventas",soloAdmin:!0}];var Se;let te=((Se=window._empleadoActual)==null?void 0:Se.rol)==="admin"?"dashboard":"pos",ge=1;function Te(){var r,s;const e=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),t=((r=window._empleadoActual)==null?void 0:r.rol)==="admin"?"dashboard":"pos";te=e||t,document.querySelector("#app").innerHTML=`
    ...
    <div class="main">
      <div class="topbar">
        <div style="display:flex;align-items:center;gap:1rem">
          ...
          <h1 id="topbar-title">${((s=ie.find(d=>d.id===te))==null?void 0:s.label)||"Dashboard"}</h1>
        </div>
  ...
  `,window.toggleSidebar=()=>{const d=document.getElementById("sidebar"),l=document.getElementById("sidebar-overlay"),c=d.classList.toggle("open");l.classList.toggle("active",c),document.body.style.overflow=c?"hidden":""},window._conversacionesInterval&&clearInterval(window._conversacionesInterval),window._conversacionesInterval=setInterval(async()=>{try{const d=await window._recargarChats(),l=window._totalNoLeidos||0,c=d.reduce((p,m)=>p+(m.no_leidos||0),0);if(window._totalNoLeidos=c,c>l){document.title=`(${c}) Zapatillas May`;const p=document.querySelector('[data-modulo="conversaciones"]');if(p){let m=p.querySelector(".nav-badge");m||(m=document.createElement("span"),m.className="nav-badge",m.style.cssText="background:#e91e8c;color:white;border-radius:100px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:auto",p.appendChild(m)),m.textContent=c}try{const m=new(window.AudioContext||window.webkitAudioContext),g=m.createOscillator(),u=m.createGain();g.connect(u),u.connect(m.destination),g.frequency.value=523,u.gain.setValueAtTime(.5,m.currentTime),u.gain.exponentialRampToValueAtTime(.001,m.currentTime+.2),g.start(m.currentTime),g.stop(m.currentTime+.2);const v=m.createOscillator(),b=m.createGain();v.connect(b),b.connect(m.destination),v.frequency.value=783,b.gain.setValueAtTime(.5,m.currentTime+.2),b.gain.exponentialRampToValueAtTime(.001,m.currentTime+.5),v.start(m.currentTime+.2),v.stop(m.currentTime+.5)}catch{}}try{window._refrescarListaChats(d)}catch{}if(window._chatActivo&&window._chatsData[window._chatActivo]){const p=window._chatsData[window._chatActivo],m=document.getElementById("mensajes-area");if(m){const g=m.scrollHeight-m.scrollTop<=m.clientHeight+60;m.innerHTML=window._renderBurbujas(p),g&&(m.scrollTop=m.scrollHeight)}}}catch{}},8e3);let o=new Set;async function a(){try{const d=await fetch(f+"/pedidos/?status=pagado");if(!d.ok)return;const c=(await d.json()).filter(v=>v.mp_preference_id||v.mp_payment_id),p=c.length,m=document.getElementById("badge-pedidos-enviar");m&&(m.textContent=p,m.style.display=p>0?"inline":"none");const g=new Set(c.map(v=>v.id)),u=c.filter(v=>!o.has(v.id));u.length>0&&o.size>0&&u.forEach(v=>{const b=v.nombre_cliente||"Cliente",y=parseFloat(v.total||0).toLocaleString("es-MX",{maximumFractionDigits:0});n(`🛍️ Nuevo pedido de ${b} — $${y} MXN`)}),o=g}catch{}}function n(d){const l=document.createElement("div");l.style.cssText="position:fixed;bottom:24px;right:24px;background:#1a1a2e;color:white;padding:14px 20px;border-radius:12px;font-size:0.85rem;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3);z-index:9999;cursor:pointer;max-width:320px;line-height:1.4;border-left:4px solid #e53935",l.textContent=d,l.onclick=()=>{navegarA("pedidos"),l.remove()},document.body.appendChild(l),setTimeout(()=>l.remove(),8e3),Notification.permission==="granted"?new Notification("Zapatillas May — Panel",{body:d,icon:"/favicon.ico"}):Notification.permission==="default"&&Notification.requestPermission();try{const c=new AudioContext,p=c.createOscillator(),m=c.createGain();p.connect(m),m.connect(c.destination),p.frequency.setValueAtTime(880,c.currentTime),p.frequency.setValueAtTime(1100,c.currentTime+.1),m.gain.setValueAtTime(.15,c.currentTime),m.gain.exponentialRampToValueAtTime(.001,c.currentTime+.4),p.start(),p.stop(c.currentTime+.4)}catch{}}window._limpiarBadgePedidos=function(){const d=document.getElementById("badge-pedidos-enviar");d&&(d.style.display="none"),o=new Set([...o])};function i(){document.getElementById("badge-pedidos-enviar")?a():setTimeout(i,400)}i(),setInterval(a,3e4),window.navegarA=d=>{var g;const l=((g=window._empleadoActual)==null?void 0:g.rol)==="admin",c=ie.find(u=>u.id===d);if(c!=null&&c.soloAdmin&&!l){alert("No tienes permisos para acceder a este módulo");return}te=d;try{localStorage.setItem("zm_panel_modulo",d)}catch{}const p=document.getElementById("sidebar"),m=document.getElementById("sidebar-overlay");p.classList.contains("open")&&(p.classList.remove("open"),m.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(u=>u.classList.remove("active")),document.querySelector('[data-modulo="'+d+'"]').classList.add("active"),document.getElementById("topbar-title").textContent=ie.find(u=>u.id===d).label,je(d)}}function et(){var o;const e=((o=window._empleadoActual)==null?void 0:o.rol)==="admin";return[...new Set(ie.filter(a=>e||!a.soloAdmin).map(a=>a.section))].map(a=>`
