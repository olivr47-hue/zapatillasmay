(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function o(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=o(n);fetch(n.href,i)}})();const b="/api",Se=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],ot=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],at=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],re=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"resenas",icon:"⭐",label:"Reseñas",section:"Catalogo",soloAdmin:!0},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"carritos",icon:"🛒",label:"Carritos",section:"Ventas"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"envio",icon:"🚚",label:"Envíos",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"},{id:"catalogos",icon:"📖",label:"Catálogos",section:"Catalogo",soloAdmin:!0},{id:"orden-home",icon:"🏠",label:"Orden en Home",section:"Catalogo",soloAdmin:!0},{id:"generar-nombres",icon:"✏️",label:"Generar nombres",section:"Catalogo",soloAdmin:!0},{id:"mercadolibre",icon:"🛒",label:"MercadoLibre",section:"Integraciones",soloAdmin:!0},{id:"analytics",icon:"📊",label:"Google Analytics",section:"Integraciones",soloAdmin:!0},{id:"referidos",icon:"🎁",label:"Referidos",section:"Ventas",soloAdmin:!0},{id:"carritos-abandonados",icon:"🛒",label:"Carritos abandonados",section:"Ventas",soloAdmin:!0}];var ze;let te=((ze=window._empleadoActual)==null?void 0:ze.rol)==="admin"?"dashboard":"pos",Ie=1;function Te(){var d,l;const e=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),t=((d=window._empleadoActual)==null?void 0:d.rol)==="admin"?"dashboard":"pos";te=e||t,document.querySelector("#app").innerHTML=`
    ...
    <div class="main">
      <div class="topbar">
        <div style="display:flex;align-items:center;gap:1rem">
          ...
          <h1 id="topbar-title">${((l=re.find(c=>c.id===te))==null?void 0:l.label)||"Dashboard"}</h1>
        </div>
  ...
  `,window.toggleSidebar=()=>{const c=document.getElementById("sidebar"),p=document.getElementById("sidebar-overlay"),m=c.classList.toggle("open");p.classList.toggle("active",m),document.body.style.overflow=m?"hidden":""},window._conversacionesInterval&&clearInterval(window._conversacionesInterval),window._conversacionesInterval=setInterval(async()=>{try{const c=await window._recargarChats(),p=window._totalNoLeidos||0,m=c.reduce((g,u)=>g+(u.no_leidos||0),0);if(window._totalNoLeidos=m,m>p){document.title=`(${m}) Zapatillas May`;const g=document.querySelector('[data-modulo="conversaciones"]');if(g){let u=g.querySelector(".nav-badge");u||(u=document.createElement("span"),u.className="nav-badge",u.style.cssText="background:#e91e8c;color:white;border-radius:100px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:auto",g.appendChild(u)),u.textContent=m}try{const u=new(window.AudioContext||window.webkitAudioContext),y=u.createOscillator(),f=u.createGain();y.connect(f),f.connect(u.destination),y.frequency.value=523,f.gain.setValueAtTime(.5,u.currentTime),f.gain.exponentialRampToValueAtTime(.001,u.currentTime+.2),y.start(u.currentTime),y.stop(u.currentTime+.2);const v=u.createOscillator(),h=u.createGain();v.connect(h),h.connect(u.destination),v.frequency.value=783,h.gain.setValueAtTime(.5,u.currentTime+.2),h.gain.exponentialRampToValueAtTime(.001,u.currentTime+.5),v.start(u.currentTime+.2),v.stop(u.currentTime+.5)}catch{}}try{window._refrescarListaChats(c)}catch{}if(window._chatActivo&&window._chatsData[window._chatActivo]){const g=window._chatsData[window._chatActivo],u=document.getElementById("mensajes-area");if(u){const y=u.scrollHeight-u.scrollTop<=u.clientHeight+60;u.innerHTML=window._renderBurbujas(g),y&&(u.scrollTop=u.scrollHeight)}}}catch{}},8e3);const o="zm_badge_pedidos";let a=new Set;function n(c){const p=document.getElementById("badge-pedidos-enviar");p&&(p.textContent=c,p.style.display=c>0?"inline":"none")}async function i(){try{const c=await fetch(b+"/pedidos/?status=pagado");if(!c.ok)return;const m=(await c.json()).filter(f=>f.mp_preference_id||f.mp_payment_id),g=m.length;localStorage.setItem(o,g),n(g);const u=new Set(m.map(f=>f.id)),y=m.filter(f=>!a.has(f.id));y.length>0&&a.size>0&&y.forEach(f=>{const v=f.nombre_cliente||"Cliente",h=parseFloat(f.total||0).toLocaleString("es-MX",{maximumFractionDigits:0});r(`🛍️ Nuevo pedido de ${v} — $${h} MXN`)}),a=u}catch{}}function r(c){const p=document.createElement("div");p.style.cssText="position:fixed;bottom:24px;right:24px;background:#1a1a2e;color:white;padding:14px 20px;border-radius:12px;font-size:0.85rem;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3);z-index:9999;cursor:pointer;max-width:320px;line-height:1.4;border-left:4px solid #e53935",p.textContent=c,p.onclick=()=>{navegarA("pedidos"),p.remove()},document.body.appendChild(p),setTimeout(()=>p.remove(),8e3),Notification.permission==="granted"?new Notification("Zapatillas May — Panel",{body:c,icon:"/favicon.ico"}):Notification.permission==="default"&&Notification.requestPermission();try{const m=new AudioContext,g=m.createOscillator(),u=m.createGain();g.connect(u),u.connect(m.destination),g.frequency.setValueAtTime(880,m.currentTime),g.frequency.setValueAtTime(1100,m.currentTime+.1),u.gain.setValueAtTime(.15,m.currentTime),u.gain.exponentialRampToValueAtTime(.001,m.currentTime+.4),g.start(),g.stop(m.currentTime+.4)}catch{}}window._limpiarBadgePedidos=function(){const c=document.getElementById("badge-pedidos-enviar");c&&(c.style.display="none"),a=new Set([...a])};function s(){if(document.getElementById("badge-pedidos-enviar")){const c=parseInt(localStorage.getItem(o)||"0",10);c>0&&n(c),i()}else setTimeout(s,400)}s(),window._pedidosInterval&&clearInterval(window._pedidosInterval),window._pedidosInterval=setInterval(i,3e4),window.navegarA=c=>{var y;const p=((y=window._empleadoActual)==null?void 0:y.rol)==="admin",m=re.find(f=>f.id===c);if(m!=null&&m.soloAdmin&&!p){alert("No tienes permisos para acceder a este módulo");return}te=c;try{localStorage.setItem("zm_panel_modulo",c)}catch{}const g=document.getElementById("sidebar"),u=document.getElementById("sidebar-overlay");g.classList.contains("open")&&(g.classList.remove("open"),u.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(f=>f.classList.remove("active")),document.querySelector('[data-modulo="'+c+'"]').classList.add("active"),document.getElementById("topbar-title").textContent=re.find(f=>f.id===c).label,je(c)}}function nt(){var o;const e=((o=window._empleadoActual)==null?void 0:o.rol)==="admin";return[...new Set(re.filter(a=>e||!a.soloAdmin).map(a=>a.section))].map(a=>`
    ...
    `).join("")}
  `).join("")}async function je(e){var o;const t=document.getElementById("content");switch(t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>',e){case"catalogos":await we();break;case"dashboard":t.innerHTML=rt(),setTimeout(()=>ut(),100);break;case"productos":await me();break;case"resenas":await cargarResenasModeracion();break;case"clientes":await Ae();break;case"carritos":await Ee();break;case"pedidos":await De(),(o=window._limpiarBadgePedidos)==null||o.call(window);break;case"sucursales":await dt();break;case"inventario":await lt();break;case"pos":await Fe();break;case"historial":await Ne();break;case"empleados":await Re();break;case"seo":await bt();break;case"envio":await ft();break;case"analisis":await st();break;case"crm":await Be();break;case"finanzas":await de();break;case"proveedores":await Pe();break;case"ordenes":await se();break;case"conversaciones":await cargarConversaciones();break;case"envios":await cargarEnviosMasivos();break;case"mercadolibre":await vt();break;case"analytics":await xt();break;case"orden-home":await ht();break;case"generar-nombres":await It();break;case"referidos":await $e();break;case"carritos-abandonados":await gt();break}}function it(){return setTimeout(()=>{document.querySelectorAll(".nav-item").forEach(a=>a.classList.remove("active"));const e=document.querySelector('[data-modulo="'+te+'"]');e&&e.classList.add("active");const t=document.getElementById("topbar-title"),o=re.find(a=>a.id===te);t&&o&&(t.textContent=o.label),je(te)},100),'<div style="padding:2rem;color:#888;text-align:center">Cargando...</div>'}async function se(){var t;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando sugerencias...</p>';try{const a=await(await fetch(b+"/sucursales/")).json(),n=(t=a[0])==null?void 0:t.id,[i,r]=await Promise.all([fetch(b+"/finanzas/sugerencias-recompra/"+n),fetch(b+"/finanzas/proveedores")]),s=await i.json(),d=await r.json(),l=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),c=new Date().toISOString().split("T")[0],p=s.filter(f=>{const v=l[f.producto_id];return v?v.hasta===null||v.hasta===void 0?!1:v.hasta<=c:!0}),m=s.length-p.length;window._ordenesData={sugerencias:p,proveedores:d,sucursalId:n},window._ordenSeleccion={};const g=p.filter(f=>f.urgente),u=p.filter(f=>!f.urgente),y=p.reduce((f,v)=>f+v.cantidad_sugerida*v.costo_unitario,0);e.innerHTML=`
              ...
              <div class="orden-item" data-urgente="${f.urgente}" style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
                ...
                <div style="flex:1;min-width:140px">
                  ...
                  <div style="margin-top:6px;display:flex;flex-wrap:wrap;gap:4px">
                    ${f.variantes.map(v=>{const h=[v.talla,v.color].filter(Boolean).join(" / "),x=v.sin_stock;return`<span style="
                      ...
                      " title="${x?"Sin stock":"Stock: "+v.stock}">${h}${x?" ✗":""}</span>`}).join("")}
                  </div>`:""}
                </div>
...
<style>
  ...
  <script>window.onload = () => window.print()<\/script>
    ...
    </div>`,a.addEventListener("click",n=>{n.target===a&&a.remove()}),document.body.appendChild(a)};window.aplicarPosponer=(e,t)=>{var n;const o=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}");let a=null;if(t!==null){const i=new Date;i.setDate(i.getDate()+t),a=i.toISOString().split("T")[0]}o[e]={hasta:a},localStorage.setItem("ordenes_pospuestos",JSON.stringify(o)),(n=document.getElementById("modal-posponer"))==null||n.remove(),se()};window.verPospuestos=()=>{const e=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),{sugerencias:t}=window._ordenesData;new Date().toISOString().split("T")[0];const o=Object.entries(e).map(([n,i])=>{const r=i.nombre||n,s=i.hasta?"hasta "+i.hasta:"indefinido";return`• ${r} — ${s}`}).join(`
`);if(!o){alert("No hay productos pospuestos.");return}confirm(`Productos pospuestos:

`+o+`

¿Quieres reactivar todos?`)&&(localStorage.removeItem("ordenes_pospuestos"),se())};window.guardarOrdenCompra2=async()=>{var i,r,s,d;const{seleccionados:e,sucursalId:t}=window._ordenModal||{};if(!e)return;const o=(i=document.getElementById("orden-fecha"))==null?void 0:i.value,a=((r=document.getElementById("orden-notas"))==null?void 0:r.value)||"",n={};e.forEach(l=>{var g,u;const c=l.proveedor_id||"sin-proveedor",p=((g=l.proveedor)==null?void 0:g.nombre)||"Sin proveedor";n[c]||(n[c]={nombre:p,items:[]});const m=l.variantes||[];if(m.length===0){const y=parseInt(((u=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:u.value)||l.cantidad_sugerida);n[c].items.push({variante_id:null,cantidad:y,costo_unitario:l.costo_unitario})}else m.forEach(y=>{var h;const f=document.getElementById("chk-var-"+y.id);if(!(f!=null&&f.checked))return;const v=parseInt(((h=document.getElementById("qty-var-"+y.id))==null?void 0:h.value)||0);v<=0||n[c].items.push({variante_id:y.id,cantidad:v,costo_unitario:l.costo_unitario})})});try{for(const[l,c]of Object.entries(n)){if(c.items.length===0)continue;const p=c.items.reduce((y,f)=>y+f.cantidad*f.costo_unitario,0),u=(s=(await(await fetch(b+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:l==="sin-proveedor"?null:l,sucursal_id:t,status:"borrador",total:p,notas:a,fecha_entrega_estimada:o||null})})).json())[0])==null?void 0:s.id;if(u)for(const y of c.items)await fetch(b+"/finanzas/ordenes/"+u+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...y,subtotal:y.cantidad*y.costo_unitario})})}(d=document.getElementById("modal-orden"))==null||d.remove(),alert("Orden de compra guardada"),se()}catch(l){alert("Error guardando orden: "+l.message)}};function rt(){var o;const e=new Date().toLocaleDateString("es-MX",{weekday:"long",day:"numeric",month:"long"});return`
  ...
  `}async function de(){var t,o,a,n,i,r;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando finanzas...</p>';try{const d=await(await fetch(b+"/sucursales/")).json(),l=(t=d[0])==null?void 0:t.id,[c,p,m,g,u,y,f]=await Promise.all([fetch(b+"/finanzas/caja/hoy/"+l),fetch(b+"/finanzas/reporte/"+l),fetch(b+"/finanzas/gastos/"+l),fetch(b+"/finanzas/estado-resultados/"+l),fetch(b+"/finanzas/flujo/"+l),fetch(b+"/finanzas/cuentas-por-cobrar"),fetch(b+"/finanzas/gastos-categorias/"+l)]),v=await c.json(),h=await p.json(),x=await m.json(),$=await g.json(),w=await u.json(),C=await y.json(),j=await f.json(),E=v.find(A=>A.status==="abierta"),z=new Date().toISOString().split("T")[0],G=x.filter(A=>{var k;return(k=A.created_at)==null?void 0:k.startsWith(z)}),S=G.reduce((A,k)=>A+parseFloat(k.monto||0),0),M=C.reduce((A,k)=>A+parseFloat(k.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
    ...
    `,window._finanzasData={sucursalId:l,gastosHoy:G,totalGastosHoy:S,estadoResultados:$,flujo:w,cxc:C,categorias:j,historial:[],reporte:h},window._finanzasSucursalId=l;const P=await(await fetch(b+"/finanzas/caja/historial/"+l)).json();window._finanzasData.historial=P,mostrarTabFinanzas("gastos")}catch(s){e.innerHTML='<p style="padding:2rem;color:red">Error cargando finanzas: '+s.message+"</p>"}}window.mostrarTabFinanzas=e=>{var c,p,m,g,u,y,f,v,h,x,$,w,C,j;const{gastosHoy:t,totalGastosHoy:o,estadoResultados:a,flujo:n,cxc:i,categorias:r,historial:s,sucursalId:d}=window._finanzasData,l=document.getElementById("fin-tab-contenido");if(l)if(e==="cmv"){const E=((c=window._finanzasData.reporte)==null?void 0:c.desglose_cmv)||[],z=window._finanzasData.reporte||{},G=E.reduce((A,k)=>A+k.subtotal_costo,0),S=E.reduce((A,k)=>A+k.subtotal_venta,0),M=S>0?(S-G)/S*100:0,F=z.num_pedidos_sin_desglose||0,P=z.total_sin_desglose||0;l.innerHTML=`
      <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
        <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        ...
        ${E.length===0?'<p style="padding:2rem;text-align:center;color:#888">Sin ventas con costo registrado en los últimos 30 días</p>':`<div style="overflow-x:auto">
            <table style="width:100%;border-collapse:collapse;font-size:0.83rem">
              ...
              <tbody>
                ${E.map(A=>{const k=A.subtotal_venta>0?(A.subtotal_venta-A.subtotal_costo)/A.subtotal_venta*100:0,B=k>=30?"#2e7d32":k>=15?"#f57f17":"#c62828";return`<tr style="border-bottom:1px solid #f5f5f5">
    ...
    `}else if(e==="gastos"){const E=r.reduce((z,G)=>z+G.total,0);l.innerHTML=`
            ...
            ${r.length===0?'<p style="color:#888;text-align:center;padding:1rem">Sin gastos registrados</p>':r.map(z=>`
                <div style="margin-bottom:12px">
                  ...
                  <div style="background:#f5f5f5;border-radius:100px;height:8px;overflow:hidden">
                    <div style="background:#E91E8C;height:100%;width:${E>0?(z.total/E*100).toFixed(0):0}%;border-radius:100px;transition:width 0.5s"></div>
                  </div>
                </div>
              `).join("")}
          </div>
      ...
      <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
            ...
            <tbody>
              ${a.map(E=>`
                <tr>
                  ...
                  <td style="color:#E91E8C;font-weight:600">$${E.ventas.toFixed(0)}</td>
                  <td style="color:#c62828">$${E.gastos.toFixed(0)}</td>
                  <td style="color:${E.utilidad>=0?"#2e7d32":"#c62828"};font-weight:700">$${E.utilidad.toFixed(0)}</td>
                  <td>${E.num_pedidos}</td>
                  <td>
                    <span style="padding:2px 8px;border-radius:100px;font-size:0.72rem;font-weight:600;background:${E.ventas>0&&E.utilidad/E.ventas>=.2?"#e8f5e9":E.utilidad>=0?"#fff8e1":"#ffebee"};color:${E.ventas>0&&E.utilidad/E.ventas>=.2?"#2e7d32":E.utilidad>=0?"#f57f17":"#c62828"}">
                      ${E.ventas>0?(E.utilidad/E.ventas*100).toFixed(1):0}%
                    </span>
                  </td>
                </tr>
              `).join("")}
        ...
        <div style="padding:1rem 1.5rem;background:#f9f9f9;display:flex;gap:2rem;flex-wrap:wrap">
          <div>
            ...
            <p style="font-weight:700;color:#E91E8C">$${a.reduce((E,z)=>E+z.ventas,0).toFixed(0)}</p>
          </div>
          <div>
            <p style="font-size:0.72rem;color:#888">Total gastos 6 meses</p>
            <p style="font-weight:700;color:#c62828">$${a.reduce((E,z)=>E+z.gastos,0).toFixed(0)}</p>
          </div>
          <div>
            <p style="font-size:0.72rem;color:#888">Utilidad total</p>
            <p style="font-weight:700;color:#2e7d32">$${a.reduce((E,z)=>E+z.utilidad,0).toFixed(0)}</p>
          </div>
        </div>
      </div>
    `:e==="flujo"?l.innerHTML=`
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          ${[{label:"Efectivo",val:((p=n.hoy)==null?void 0:p.efectivo)||0,color:"#2e7d32"},{label:"Tarjeta",val:((m=n.hoy)==null?void 0:m.tarjeta)||0,color:"#1565c0"},{label:"SPEI",val:((g=n.hoy)==null?void 0:g.spei)||0,color:"#6a1b9a"},{label:"Crédito",val:((u=n.hoy)==null?void 0:u.credito)||0,color:"#f57f17"}].map(E=>`
            <div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f5f5f5">
              <span style="font-size:0.82rem;color:#888">${E.label}</span>
              <span style="font-weight:700;color:${E.color}">$${E.val.toFixed(0)}</span>
            </div>
          `).join("")}
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            <span style="font-size:0.85rem;font-weight:700">Neto</span>
            <span style="font-weight:700;color:${(((C=n.mes)==null?void 0:C.neto)||0)>=0?"#2e7d32":"#c62828"};font-size:1.1rem">$${(((j=n.mes)==null?void 0:j.neto)||0).toFixed(0)}</span>
          </div>
        </div>
      </div>
    `:e==="caja"?l.innerHTML=`
      <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
        ...
        ${s.length===0?'<div style="padding:2rem;text-align:center;color:#888">Sin historial</div>':s.map(E=>`
            <div style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
              <div style="flex:1">
                <p style="font-size:0.85rem;font-weight:600">${new Date(E.fecha).toLocaleDateString("es-MX",{weekday:"short",day:"numeric",month:"short"})}</p>
                <p style="font-size:0.72rem;color:#888">Apertura: $${parseFloat(E.monto_apertura||0).toFixed(0)} · Cierre: $${parseFloat(E.monto_cierre||0).toFixed(0)}</p>
              </div>
              <div style="text-align:center">
                <p style="font-size:0.9rem;font-weight:700;color:#E91E8C">$${parseFloat(E.total_ventas||0).toFixed(0)}</p>
                <p style="font-size:0.65rem;color:#888">Ventas</p>
              </div>
              <div style="text-align:center">
                <p style="font-size:0.9rem;font-weight:700;color:${parseFloat(E.diferencia||0)>=0?"#2e7d32":"#c62828"}">${parseFloat(E.diferencia||0)>=0?"+":""}$${parseFloat(E.diferencia||0).toFixed(0)}</p>
                <p style="font-size:0.65rem;color:#888">Diferencia</p>
              </div>
              <span style="padding:3px 10px;border-radius:100px;font-size:0.68rem;font-weight:600;background:${E.status==="cerrada"?"#e8f5e9":"#fff8e1"};color:${E.status==="cerrada"?"#2e7d32":"#f57f17"}">${E.status}</span>
            </div>
          `).join("")}
      </div>
...
Diferencia: $${(n=r.diferencia)==null?void 0:n.toFixed(2)}`),de()):alert("Error: "+JSON.stringify(r))}catch{alert("Error cerrando caja")}};window.agregarGasto=e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",t.innerHTML=`
  ...
  `,document.body.appendChild(t),t.addEventListener("click",o=>{o.target===t&&t.remove()})};window.guardarGasto=async(e,t)=>{var i;const o=document.getElementById("gasto-concepto").value,a=document.getElementById("gasto-monto").value,n=document.getElementById("gasto-categoria").value;if(!o||!a){alert("Completa concepto y monto");return}try{await fetch(b+"/finanzas/gastos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sucursal_id:e,concepto:o,monto:parseFloat(a),categoria:n,empleado:((i=window._empleadoActual)==null?void 0:i.nombre)||"Admin"})}),t.closest('div[style*="position:fixed"]').remove(),de()}catch{alert("Error guardando gasto")}};window.eliminarGasto=async e=>{if(confirm("¿Eliminar este gasto?"))try{await fetch(b+"/finanzas/gastos/"+e,{method:"DELETE"}),de()}catch{alert("Error eliminando gasto")}};async function Pe(){const e=document.getElementById("content");try{const o=await(await fetch(b+"/finanzas/proveedores")).json();e.innerHTML=`
  ...
  `,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()})};window.guardarProveedor=async e=>{const t={nombre:document.getElementById("prov-nombre").value,contacto:document.getElementById("prov-contacto").value,telefono:document.getElementById("prov-telefono").value,email:document.getElementById("prov-email").value,ciudad:document.getElementById("prov-ciudad").value,direccion:document.getElementById("prov-direccion").value,notas:document.getElementById("prov-notas").value};if(!t.nombre){alert("El nombre es requerido");return}try{e?await fetch(b+"/finanzas/proveedores/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):await fetch(b+"/finanzas/proveedores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),document.querySelector('div[style*="position:fixed"]').remove(),Pe()}catch{alert("Error guardando proveedor")}};window.editarProveedor=async e=>{const a=(await(await fetch(b+"/finanzas/proveedores")).json()).find(n=>n.id===e);a&&mostrarFormProveedor(a)};async function st(){const e=document.getElementById("content");e.innerHTML=`
    ...
    <style>@keyframes pulse{0%,100%{opacity:1}50%{opacity:0.5}}</style>`;try{let A=function(_,L,O){return`<div style="display:flex;align-items:center;gap:6px">
        ...
        </div>`},B=function(_){_=(_||"").toLowerCase();const L=z.filter(T=>(T.tallasDesglosadas.length>0||T.tallasData.some(H=>H.total>0))&&(!_||T.nombre.toLowerCase().includes(_)||(T.sku_interno||"").toLowerCase().includes(_))),O=z.filter(T=>T.tallasData.some(H=>H.total>0)).length,I=`
      ...
      `},D=function(){const _=z.filter(L=>L.variantesData.some(O=>O.total>0));return _.length===0?'<div style="padding:3rem;text-align:center;color:#94a3b8;font-size:0.9rem">No hay datos de ventas por variante aún</div>':_.map(L=>{const O=L.variantesData.slice(0,8),I=Math.max(...O.map(T=>T.total),1),q=O[0];return`
        <div style="background:white;border:1px solid #e2e8f0;border-radius:12px;padding:16px;margin-bottom:10px">
  ...
  `).join("")};window.seleccionarClienteOportunidad=(e,t)=>{document.getElementById("op-cliente-id").value=e,document.getElementById("op-cliente-buscar").value=t,document.getElementById("op-cliente-resultados").style.display="none"};window.guardarOportunidad=async()=>{const e=document.getElementById("op-titulo").value,t=document.getElementById("op-cliente-id").value,o=document.getElementById("op-monto").value,a=document.getElementById("op-etapa").value,n=document.getElementById("op-fecha").value,i=document.getElementById("op-notas").value;if(!e){alert("El título es requerido");return}try{await fetch(b+"/crm/oportunidades",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({titulo:e,cliente_id:t||null,monto_estimado:parseFloat(o)||0,etapa:a,fecha_cierre_estimada:n||null,notas:i})}),document.getElementById("modal-oportunidad").remove(),mostrarPipeline()}catch{alert("Error guardando oportunidad")}};async function me(e,t=!1){const o=document.getElementById("content");try{const n=await(await fetch(b+"/productos/")).json(),i=n.filter(c=>c.activo),r=n.filter(c=>!c.activo),s=t?r:i;console.log("mostrarInactivos:",t,"base:",s.length,"inactivos:",r.length);const d=[...new Set(i.map(c=>c.categoria).filter(Boolean))],l=e?s.filter(c=>c.categoria===e):s;o.innerHTML=`
    ...
    `}catch{o.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.cargarProductos=me;window.mostrarCampanas=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando campañas...</p>';try{const[t,o]=await Promise.all([fetch(b+"/clientes/"),fetch(b+"/pedidos/")]),a=await t.json(),n=await o.json(),i=new Date,r=new Date(i-30*24*60*60*1e3),s=new Date(i-90*24*60*60*1e3),d=a.map(p=>{const m=n.filter(h=>h.cliente_id===p.id&&(h.status==="confirmado"||h.status==="pagado")),g=m.reduce((h,x)=>h+parseFloat(x.total||0),0),u=m.length>0?new Date(m[0].created_at):null,y=u?Math.floor((i-u)/(1e3*60*60*24)):null,f=m.filter(h=>new Date(h.created_at)>=r).length;let v="nuevo";return m.length===0?v="nuevo":g>=5e3&&f>=1?v="vip":y>90?v="inactivo":y>30?v="riesgo":f>=2?v="frecuente":v="activo",{...p,totalGastado:g,diasSinComprar:y,segmento:v}}).filter(p=>p.telefono);window._campanaClientes=d;const l=[{id:"catalogo",nombre:"👠 Catálogo completo",descripcion:"Envía el catálogo completo de productos",mensaje:p=>`Hola ${p}! 👋
...
⚠️ Requiere que los productos estén en el catálogo de Meta Commerce.`;else if(d.style.background="#e8f5e9",d.style.borderColor="#a5d6a7",d.style.color="#333",o){let y;t==="personalizado"?y=(((u=document.getElementById("texto-personalizado"))==null?void 0:u.value)||"").replace("{nombre}","María"):y=o.mensaje("María"),d.textContent=y}}const l=document.getElementById("campana-count");l&&(l.textContent=i.length+" clientes");const c=document.getElementById("campana-lista");if(c){if(!i.length){c.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No hay clientes en este segmento con teléfono registrado</div>';return}window._campanaFiltrados=i,window._campanaPlantillaId=t,c.innerHTML=i.map((y,f)=>{var $;let v;t==="personalizado"?v=((($=document.getElementById("texto-personalizado"))==null?void 0:$.value)||"").replace("{nombre}",y.nombre.split(" ")[0]):v=o.mensaje(y.nombre.split(" ")[0]);const h=encodeURIComponent(v),x=(y.lada||"52")+y.telefono.replace(/\D/g,"");return`
    ...
    <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);text-align:center">
      ...
      <p style="font-size:0.82rem;color:#888">Conectando con WhatsApp Business</p>
        ...
        <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
          ...
          <p style="font-size:0.78rem;color:#888;text-align:center;margin-bottom:1.5rem">${x} de ${y} mensajes enviados</p>
        ...
        </div>`};window._campanaJobId=u;const v=setInterval(async()=>{try{const x=await(await fetch(b+"/campanas/estado/"+u)).json();f(x),x.terminado&&(clearInterval(v),window._campanaUltimosResultados=x.resultados||[],setTimeout(()=>{const $=x.enviados||0,w=x.fallidos||0;l.innerHTML=`
    ...
    `};window._campanaAvanzar=()=>{if(r++,r>=i.length){s.innerHTML=`
      ...
      `;return}d()},d(),document.body.appendChild(s)};async function Ae(){const e=document.getElementById("content");try{const[t,o]=await Promise.all([fetch(b+"/clientes/"),fetch(b+"/pedidos/")]),a=await t.json(),n=await o.json(),i=new Date,r=new Date(i-30*24*60*60*1e3),s=new Date(i-90*24*60*60*1e3),d=a.map(u=>{const y=n.filter(E=>E.cliente_id===u.id&&(E.status==="confirmado"||E.status==="pagado")),f=y.reduce((E,z)=>E+parseFloat(z.total||0),0),v=y.length>0?new Date(y[0].created_at):null,h=y.filter(E=>new Date(E.created_at)>=r).length,x=v?Math.floor((i-v)/(1e3*60*60*24)):null;let $="nuevo",w="⚪ Nuevo",C="#f5f5f5",j="#888";return y.length===0?($="nuevo",w="⚪ Sin compras",C="#f5f5f5",j="#888"):f>=5e3&&h>=1?($="vip",w="⭐ VIP",C="#fff8e1",j="#f57f17"):x>90?($="inactivo",w="🔴 Inactivo",C="#ffebee",j="#c62828"):x>30?($="riesgo",w="🟡 En riesgo",C="#fff8e1",j="#f57f17"):h>=2?($="frecuente",w="🟢 Frecuente",C="#e8f5e9",j="#2e7d32"):($="activo",w="🔵 Activo",C="#e3f2fd",j="#1565c0"),{...u,totalGastado:f,ultimoPedido:v,pedidos30:h,diasSinComprar:x,segmento:$,segmentoLabel:w,segmentoBg:C,segmentoColor:j,totalPedidos:y.length}}).sort((u,y)=>y.totalGastado-u.totalGastado),l=d.filter(u=>u.segmento==="vip").length,c=d.filter(u=>u.segmento==="inactivo").length,p=d.filter(u=>u.segmento==="riesgo").length,m=d.filter(u=>u.segmento==="frecuente"||u.segmento==="activo").length,g=d.filter(u=>u.origen==="tienda").length;window._clientesData=d,e.innerHTML=`
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
...
`,renderInventario()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.renderInventario=()=>{const{sucursales:e,productos:t,variantes:o,inventario:a}=window._invData,n=(document.getElementById("inv-buscar")?document.getElementById("inv-buscar").value:"").toLowerCase(),i=document.getElementById("inv-categoria")?document.getElementById("inv-categoria").value:"",r=document.getElementById("inv-talla")?document.getElementById("inv-talla").value:"",s=document.getElementById("inv-estado")?document.getElementById("inv-estado").value:"",d=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],l=t.filter(m=>!(!m.activo||n&&!m.nombre.toLowerCase().includes(n)&&!(m.sku_interno||"").toLowerCase().includes(n)||i&&m.categoria!==i)),c=e.map(m=>{const g=a.filter(y=>y.sucursal_id===m.id),u=l.map(y=>{const f=o.filter($=>$.producto_id===y.id&&$.activa!==!1);if(f.length===0)return"";const h=[...new Set(f.map($=>$.color).filter(Boolean))].map($=>{const w=f.filter(z=>z.color===$).sort((z,G)=>d.indexOf(z.talla)-d.indexOf(G.talla));if(r&&!w.find(z=>z.talla===r))return"";const C=w[0]?w[0].color_hex:"#888",j=w[0]?w[0].foto_url:null,E=w.map(z=>{const G=g.find(A=>A.variante_id===z.id),S=G?G.cantidad:null,M=G?G.stock_minimo:3;if(r&&z.talla!==r||s&&(s==="agotado"&&S!==0||s==="bajo"&&(S===null||S===0||S>M)||s==="disponible"&&(S===null||S===0||S<=M)))return"";let F,P;return S===null?(F="#f0f0f0",P="#aaa"):S===0?(F="#ffebee",P="#c62828"):S<=M?(F="#fff8e1",P="#f57f17"):(F="#e8f5e9",P="#2e7d32"),`
          ...
          <div style="background:#fafafa;border-radius:12px;padding:1rem;margin-bottom:10px;border:1px solid #eee">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
              ${j?`<img src="${j}" style="width:52px;height:52px;object-fit:cover;border-radius:8px;border:1px solid #eee;flex-shrink:0">`:`<div style="width:52px;height:52px;background:${C};border-radius:8px;border:1px solid #eee;flex-shrink:0;opacity:0.7"></div>`}
              <div style="display:flex;align-items:center;gap:8px">
        ...
        `:""}).join("");if(!h.trim())return"";const x=y.imagen_principal;return`
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div>
          ...
          <select class="form-input" id="f-categoria" required onchange="actualizarSKU()">
            ...
            ${at.map(a=>`<option value="${a.value}" ${t.categoria===a.value?"selected":""}>${a.label}</option>`).join("")}
          </select>
        </div>
        <div>
...
<div id="variantes-container">
  ${window._coloresExistentes&&window._coloresExistentes.length>0?window._coloresExistentes.map((a,n)=>pe(n,a)).join(""):pe(0,null)}
</div>
...
${o.telefono?'<a href="https://wa.me/'+(o.lada||"52")+o.telefono.replace(/\D/g,"")+'" target="_blank" class="btn btn-secondary" style="background:#25D366;color:white;border-color:#25D366;margin-left:auto">WhatsApp</a>':""}      </div>
  ...
  `};window.guardarSalida=async()=>{const e=document.getElementById("sal").value,t=document.getElementById("sal-sucursal").value,o=document.getElementById("sal-cantidad").value,a=document.getElementById("sal-motivo").value;if(!e||!t||!o){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(b+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:-parseInt(o),motivo:a})})).json();i.ok?(alert("Salida registrada. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const o=await(await fetch(b+"/sucursales/")).json(),n=await(await fetch(b+"/productos/")).json(),r=await(await fetch(b+"/variantes/")).json(),d=await(await fetch(b+"/inventario/")).json(),l=[...new Set(n.map(p=>p.categoria).filter(Boolean))],c=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:o,productos:n,variantes:r,inventario:d},e.innerHTML=`
    ...
    `,renderTablasMasivo()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:e,variantes:t,inventario:o}=window._invMasivo,a=document.getElementById("im-sucursal").value,n=document.getElementById("im-categoria").value,i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],r=e.filter(c=>!(n&&c.categoria!==n)),s=o.filter(c=>c.sucursal_id===a),d=r.map(c=>{const p=t.filter(u=>u.producto_id===c.id);if(p.length===0)return"";const g=[...new Set(p.map(u=>u.color).filter(Boolean))].map(u=>{const y=p.filter(v=>v.color===u).sort((v,h)=>i.indexOf(v.talla)-i.indexOf(h.talla));return`
        <div style="margin-bottom:1rem">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap">
            ${y.map(v=>{const h=s.find(C=>C.variante_id===v.id),x=h?h.cantidad:0,$=h?h.stock_minimo:3;let w="#ddd";return x===0?w="#ffcdd2":x<=$?w="#ffe082":w="#a5d6a7",`
                <div style="text-align:center">
  ...
  `,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()})};window.confirmarEnvio=async function(e){const t=document.getElementById("env-paqueteria").value,o=document.getElementById("env-guia").value.trim(),a=document.getElementById("env-error"),n=document.getElementById("btn-confirmar-envio");if(!t||!o){a.textContent="Selecciona paquetería e ingresa el número de guía.",a.style.display="block";return}n.disabled=!0,n.textContent="Guardando...",a.style.display="none";try{const i=await fetch(b+`/pedidos/${e}/marcar-enviado`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({paqueteria:t,numero_guia:o})}),r=await i.json();if(!i.ok)throw new Error(r.error||"Error al guardar");try{const s=await fetch(b+"/pedidos/"+e).then(c=>c.json()),d=s.telefono_cliente,l=(s.nombre_cliente||"Cliente").split(" ")[0];d&&await fetch(b+"/chatbot/templates/enviar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({telefono:d,template:"aviso_envio",params:[l,String(e).slice(-6),o,t]})})}catch{}document.getElementById("modal-envio").remove(),mostrarToast("✅ Pedido enviado — WhatsApp de tracking enviado al cliente"),await De()}catch(i){a.textContent=i.message,a.style.display="block",n.disabled=!1,n.textContent="Confirmar envío ✓"}};async function De(){const e=document.getElementById("content");try{const o=await(await fetch(b+"/pedidos/")).json(),a=new Date,n=new Date(a.getFullYear(),a.getMonth(),a.getDate()),i=new Date(a-7*24*60*60*1e3),r=["cancelado","borrador","checkout_iniciado"],s=o.filter(v=>!r.includes(v.status)),d=o.filter(v=>v.status!=="checkout_iniciado"&&v.status!=="borrador"),l=s.filter(v=>new Date(v.created_at)>=n),c=l.reduce((v,h)=>v+parseFloat(h.total||0),0),p=s.filter(v=>new Date(v.created_at)>=i).reduce((v,h)=>v+parseFloat(h.total||0),0),m=o.filter(v=>v.status==="pendiente_pago").length,g=o.filter(v=>v.status==="checkout_iniciado").length,u=o.filter(v=>v.status==="pagado"&&(v.mp_preference_id||v.mp_payment_id)).length,y=o.filter(v=>v.forma_pago==="credito"&&v.status!=="cancelado").length,f=(v,h,x,$,w,C,j)=>`
      ...
      <div class="table-card">
        <table>
          ...
          <tbody>
            ${d.length===0?'<tr><td colspan="8" style="text-align:center;color:#888;padding:2rem">No hay pedidos</td></tr>':d.map(v=>Oe(v)).join("")}
          </tbody>
        </table>
      </div>
  ...
  `).join(""),window.recalcularTotal()}};window.cambiarCantidadItem=async(e,t)=>{if(t>0){const o=window._pedidoItems[e],a=document.getElementById("ped-sucursal")?document.getElementById("ped-sucursal").value:"";if(a)try{const r=(await(await fetch(b+"/inventario/sucursal/"+a)).json()).find(d=>d.variante_id===o.variante_id),s=r?r.cantidad:0;if(o.cantidad>=s){alert("No hay mas existencia disponible. Maximo: "+s+" pares");return}}catch{}}window._pedidoItems[e].cantidad=Math.max(1,window._pedidoItems[e].cantidad+t),window.recalcularTotal(),renderItemsPedido()};window.guardarPedido=async()=>{var d;if(window._creandoPedido)return;const e=document.getElementById("ped-cliente").value,t=document.getElementById("ped-canal").value,o=document.getElementById("ped-sucursal").value,a=document.getElementById("ped-pago").value,n=document.getElementById("ped-comentarios").value;if(!e){alert("Selecciona un cliente");return}if(window._pedidoItems.length===0){alert("Agrega al menos un producto");return}window._creandoPedido=!0;const i=document.getElementById("btn-ped-guardar");i&&(i.textContent="Guardando...",i.disabled=!0);const r=window._pedidoItems.reduce((l,c)=>l+c.cantidad*c.precio_unitario,0),s=a==="spei"?"pendiente_pago":"confirmado";try{const l=await fetch(b+"/pedidos/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cliente_id:e,canal:t,sucursal_id:o,forma_pago:a,comentarios:n||null,total:r,subtotal:r,status:s})});if(!l.ok){alert("Error creando pedido"),i&&(i.textContent="Crear pedido",i.disabled=!1),window._creandoPedido=!1;return}const c=await l.json(),p=c.id||((d=c[0])==null?void 0:d.id);if(!p){alert("Error: no se obtuvo ID del pedido"),i&&(i.textContent="Crear pedido",i.disabled=!1),window._creandoPedido=!1;return}await Promise.all(window._pedidoItems.map(m=>fetch(b+"/pedidos/"+p+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:m.variante_id,cantidad:m.cantidad,precio_unitario:m.precio_unitario,subtotal:m.cantidad*m.precio_unitario})}))),a!=="spei"&&a!=="mercadopago"&&await fetch(b+"/pedidos/"+p+"/confirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({forma_pago:a})}),alert("Pedido creado correctamente"),window._pedidoItems=[],window._creandoPedido=!1,verPedido(p)}catch{alert("Error conectando con el servidor"),i&&(i.textContent="Crear pedido",i.disabled=!1),window._creandoPedido=!1}};window.abrirPreviewPedido=async e=>{const t=document.getElementById("pedido-preview-panel");if(!t){verPedido(e);return}if(t.dataset.pedidoId===e&&t.style.display!=="none"){t.style.display="none",t.dataset.pedidoId="";return}t.dataset.pedidoId=e,t.style.display="block",t.innerHTML='<p style="padding:1.5rem;color:#888;text-align:center">Cargando...</p>',t.scrollIntoView({behavior:"smooth",block:"nearest"});try{const[o,a]=await Promise.all([fetch(b+"/pedidos/"+e).then(d=>d.json()),fetch(b+"/pedidos/"+e+"/items").then(d=>d.json())]),n=Array.isArray(o)?o[0]:o,i=Array.isArray(a)?a:[],r=n.clientes||{},s={confirmado:"#2e7d32",pagado:"#2e7d32",cancelado:"#c62828",pendiente_pago:"#f57f17",borrador:"#f57f17"}[n.status]||"#888";t.innerHTML=`
      ...
      <div class="table-card" style="padding:2rem">
        ...
        ${(()=>{const p=(n.direccion_envio||n.direccion_entrega||"").trim();let m="";if(!p&&n.notas){const h=n.notas.match(/Env[ií]o a:\s*(.+)$/i);h&&(m=h[1].trim())}const g=p||m,u=r.nombre||n.nombre_cliente||"",y=r.telefono||n.telefono_cliente||"",f=n.email_cliente&&n.email_cliente!=="cliente@zapatillasmay.mx"?n.email_cliente:"";return!g&&!u&&!y?"":`
...
`).replace(/"/g,"&quot;")}" style="padding:4px 12px;border-radius:20px;border:1.5px solid #1d4ed8;background:none;color:#1d4ed8;font-size:0.75rem;font-weight:600;cursor:pointer">📋 Copiar</button>
        ...
        <div style="margin-bottom:1.5rem">
          ...
          ${i.map(p=>{const m=p.variantes||{},g=m.productos||{},u=g.nombre||p.nombre||"—",y=m.color||p.color||"",f=m.talla||p.talla||"";let v=g.imagen_principal||null;if(!v&&p.variante_id&&window._productosCache&&window._variantesCache){const h=window._variantesCache.find(x=>x.id===p.variante_id);if(h){const x=window._productosCache.find($=>$.id===h.producto_id);x&&(v=x.imagen_principal||null)}}return`
              <div style="display:flex;align-items:center;gap:12px;padding:12px;background:#f9f9f9;border-radius:8px;margin-bottom:8px;border:1px solid #eee">
        ...
        ${d.map((p,m)=>{const g=p.variantes||{},u=g.productos||{},y=u.nombre||p.nombre||"—",f=g.color||p.color||"",v=g.talla||p.talla||"",h=p.es_corrida?'<span style="background:#f3e5f5;color:#6a1b9a;font-size:0.65rem;font-weight:700;padding:2px 6px;border-radius:100px;margin-left:6px">📦 Corrida</span>':"";let x=u.imagen_principal||null;if(!x&&p.variante_id&&window._editVariantes&&window._editProductos){const $=window._editVariantes.find(w=>w.id===p.variante_id);if($){const w=window._editProductos.find(C=>C.id===$.producto_id);w&&(x=w.imagen_principal||null)}}return`
            <div style="display:flex;align-items:center;gap:10px;padding:10px;background:white;border-radius:8px;margin-bottom:8px;border:1px solid #eee;flex-wrap:wrap">
              ...
              <div style="flex:1;min-width:120px">
                <p style="font-weight:600;font-size:0.85rem;margin:0">${y}${f?" · "+f:""}${v?" T"+v:""}${h}</p>
              </div>
              <div style="display:flex;align-items:center;gap:6px">
  ...
  `).join(""))};window.seleccionarModeloEdicion=(e,t)=>{const o=window._editVariantes||[],a=window._editProductos||[],n=window._editInventario||[],i=a.find(f=>f.id===e),r=document.getElementById("ep-buscar-corrida"),s=document.getElementById("ep-corrida-resultados");r&&(r.value=`${(i==null?void 0:i.nombre)||""} · ${t}`),s&&(s.style.display="none");const d=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],l=o.filter(f=>f.producto_id===e&&f.color===t).sort((f,v)=>d.indexOf(f.talla)-d.indexOf(v.talla)),c=parseFloat(i==null?void 0:i.precio_menudeo)||0,p=parseFloat(i==null?void 0:i.precio_corrida)||(c>0?Math.round(c-100):0),m=document.getElementById("ep-precio-corrida");m&&(m.value=p||""),window._editCorridaSeleccionada={productoId:e,color:t,variantes:l,prod:i,precioCorrida:p};const g=document.getElementById("ep-corrida-titulo");g&&(g.textContent=`Tallas para ${(i==null?void 0:i.nombre)||""} · ${t}:`);const u=document.getElementById("ep-corrida-tallas-grid");u&&(u.innerHTML=l.map(f=>{const v=n.find(j=>j.variante_id===f.id),h=v?v.cantidad:null,x=h!==null&&h===0,$=x?0:1,w=`ep-card-${f.id}`,C=`ep-qty-${f.id}`;return`
      <div id="${w}" class="size-card" style="display:flex;flex-direction:column;align-items:center;gap:6px;padding:10px 12px;border:2px solid ${x?"#fecaca":$>0?"#E91E8C":"#e2e8f0"};border-radius:12px;background:${x?"#fef2f2":$>0?"#fdf2f8":"#fff"};min-width:70px;transition:all 0.2s;position:relative;opacity:${x?.6:1}">
        ...
        <div style="display:flex;align-items:center;gap:4px">
          <button type="button" onclick="const inp=document.getElementById('${C}');inp.value=Math.max(0,parseInt(inp.value||0)-1);inp.dispatchEvent(new Event('input'))"
            style="background:#f1f5f9;color:#475569;border:none;border-radius:6px;width:24px;height:24px;cursor:pointer;font-size:1rem;font-weight:700;display:flex;align-items:center;justify-content:center" ${x?"disabled":""}>−</button>
          <input type="number" value="${$}" min="0" max="${h!==null?h:999}" id="${C}" data-variante="${f.id}"
  ...
  `).join(""),o.style.display="block"};window.seleccionarClientePOS=(e,t)=>{document.getElementById("pos-cliente").value=e,document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-resultados").style.display="none";const o=document.getElementById("pos-cliente-seleccionado");o.textContent="✔ "+t+" — toca para cambiar",o.style.display="block"};window.limpiarClientePOS=()=>{document.getElementById("pos-cliente").value="",document.getElementById("pos-cliente-seleccionado").style.display="none",document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-buscar").focus()};window.renderProductosPOS=e=>{const{variantes:t,inventario:o}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=o.filter(r=>r.sucursal_id===a),i=document.getElementById("pos-productos-grid");i&&(i.innerHTML=e.filter(r=>r.activo).map(r=>{const s=t.filter(c=>c.producto_id===r.id),d=[...new Set(s.map(c=>c.color).filter(Boolean))],l=s.reduce((c,p)=>{const m=n.find(g=>g.variante_id===p.id);return c+(m?m.cantidad:0)},0);return`
    ...
    <div style="background:white;border-radius:16px;max-width:640px;width:100%;height:90vh;display:flex;flex-direction:column;overflow:hidden">
      ...
      <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
          ${l.map(f=>{const v=d.filter(C=>C.color===f),h=v[0],x=v.map(C=>C.foto_url).find(Boolean),$=v.reduce((C,j)=>{const E=s.find(z=>z.variante_id===j.id);return C+(E?E.cantidad:0)},0),w=x?`<img src="${x}" style="width:46px;height:46px;object-fit:cover;border-radius:8px;border:1px solid #ddd">`:`<div style="width:46px;height:46px;border-radius:8px;background:${h?h.color_hex:"#888"};border:1px solid #ddd"></div>`;return`
...
`).join("")}
    `;const d=document.getElementById("pos-total"),l=document.getElementById("pos-total-pares"),c=document.getElementById("pos-tipo-precio");d&&(d.textContent="$"+a.toFixed(2)),l&&(l.textContent=o),c&&(c.textContent=n);const p=document.getElementById("pos-flotante-pares"),m=document.getElementById("pos-flotante-total");p&&(p.textContent=o+" pares"),m&&(m.textContent="$"+a.toFixed(2)),(g=document.getElementById("pos-drawer"))!=null&&g.classList.contains("open")&&renderDrawerPOS(),fe()};window.editarPrecioPOS=(e,t)=>{if(!window._posCarrito[e])return;const o=parseFloat(t);if(!o||o<=0){alert("El precio debe ser mayor a $0");return}window._posCarrito[e].precio_unitario=o,window._posCarrito[e].precio_manual=!0;const a=window._posCarrito[e].cantidad,n=document.getElementById("subtotal-item-"+e);n&&(n.textContent="$"+(a*o).toFixed(2));const i=window._posCarrito.reduce((s,d)=>s+d.cantidad*d.precio_unitario,0),r=document.getElementById("pos-total");r&&(r.textContent="$"+i.toFixed(2)),fe()};window.editarPrecioCorridaPOS=(e,t)=>{const[o,a]=e.split("|"),n=parseFloat(t);if(!n||n<=0){alert("El precio debe ser mayor a $0");return}window._posCarrito.forEach(c=>{c.producto_id===o&&c.color===a&&c.es_corrida&&(c.precio_unitario=n,c.precio_manual=!0)});const r=window._posCarrito.filter(c=>c.producto_id===o&&c.color===a&&c.es_corrida).reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),s=document.getElementById("subtotal-corrida-"+e.replace("|","-"));s&&(s.textContent="$"+r.toFixed(2));const d=window._posCarrito.reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),l=document.getElementById("pos-total");l&&(l.textContent="$"+d.toFixed(2)),fe()};window.editarCorridaEnCarrito=e=>{const[t,o]=e.split("|"),{inventario:a,variantes:n}=window._posData,i=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=a.filter(c=>c.sucursal_id===i),s=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=n.filter(c=>c.producto_id===t&&c.color===o).sort((c,p)=>s.indexOf(c.talla)-s.indexOf(p.talla)),l=document.createElement("div");l.id="pos-modal-editar-corrida",l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",l.innerHTML=`
...
`+((l==null?void 0:l.message)||l)),[e,t].forEach(c=>{c&&(c.disabled=!1,c.textContent="Cobrar")})}};window.guardarCarritoPOS=async e=>{var s,d,l,c;if(!window._posCarrito||window._posCarrito.length===0){alert("El carrito está vacío");return}const t=((s=document.getElementById("pos-cliente"))==null?void 0:s.value)||null;if(!t){alert("Selecciona un cliente para guardar el carrito");return}if(window._guardandoCarrito)return;window._guardandoCarrito=!0;const o=(d=document.getElementById("pos-sucursal"))==null?void 0:d.value,a=((l=document.getElementById("pos-pago"))==null?void 0:l.value)||"efectivo",n=[...document.querySelectorAll('button[onclick^="guardarCarritoPOS"]')];n.forEach(p=>{p.disabled=!0,p._txt=p.textContent,p.textContent="Guardando..."});let i=null,r=!1;try{const p=await fetch(b+"/pedidos/?status=borrador").then(f=>f.json()).catch(()=>[]),m=Array.isArray(p)?p.find(f=>f.cliente_id===t&&(!f.canal||f.canal==="sucursal"||f.canal==="mayoreo")):null;if(m)i=m.id;else{const f=await fetch(b+"/pedidos/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cliente_id:t,canal:"sucursal",sucursal_id:o,forma_pago:a,total:0,subtotal:0,status:"borrador"})}),v=await f.json();if(!f.ok)throw new Error("No se pudo crear el carrito: "+JSON.stringify(v));if(i=Array.isArray(v)?(c=v[0])==null?void 0:c.id:v==null?void 0:v.id,!i)throw new Error("No se obtuvo ID del carrito");r=!0}let g=await fetch(b+"/pedidos/"+i+"/items").then(f=>f.json()).catch(()=>[]);Array.isArray(g)||(g=[]);for(const f of window._posCarrito){const v=!!f.es_corrida,h=g.find(x=>x.variante_id===f.variante_id&&!!x.es_corrida===v);if(h){const x=h.cantidad+f.cantidad,$=await fetch(b+"/pedidos/"+i+"/items/"+h.id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({cantidad:x,precio_unitario:f.precio_unitario,subtotal:x*f.precio_unitario})});if(!$.ok)throw new Error("Error actualizando "+(f.nombre||"")+": "+JSON.stringify(await $.json().catch(()=>({}))));h.cantidad=x}else{const x=await fetch(b+"/pedidos/"+i+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:f.variante_id,cantidad:f.cantidad,precio_unitario:f.precio_unitario,subtotal:f.cantidad*f.precio_unitario,nombre:f.nombre||"",color:f.color||"",talla:f.talla||"",es_corrida:v})});if(!x.ok)throw new Error("Error en item "+(f.nombre||"")+": "+JSON.stringify(await x.json().catch(()=>({}))));const $=await x.json().catch(()=>null);Array.isArray($)&&$[0]&&g.push($[0])}}const u=await fetch(b+"/pedidos/"+i+"/items").then(f=>f.json()).catch(()=>g),y=(Array.isArray(u)?u:[]).reduce((f,v)=>f+v.cantidad*v.precio_unitario,0);await fetch(b+"/pedidos/"+i,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({total:y,subtotal:y})}),window._posCarrito=[],window._guardandoCarrito=!1,e&&typeof cerrarDrawerPOS=="function"&&cerrarDrawerPOS(),typeof limpiarClientePOS=="function"&&limpiarClientePOS(),renderCarritoPOS(),alert(m?"Se agregó al carrito que ya tenía este cliente. Lo ves en la sección Carritos.":"Carrito guardado. Lo encuentras en la sección Carritos.")}catch(p){if(window._guardandoCarrito=!1,i&&r)try{await fetch(b+"/pedidos/"+i+"/cancelar",{method:"POST",headers:{"Content-Type":"application/json"},body:"{}"})}catch{}alert(`No se pudo guardar el carrito:
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
        ...
        </tr>`}).join(""))};async function ut(){try{const t=await(await fetch(b+"/pedidos/")).json(),a=await(await fetch(b+"/clientes/")).json(),i=await(await fetch(b+"/inventario/alertas")).json(),r=new Date;r.setHours(0,0,0,0);const s=new Date(r);s.setDate(s.getDate()-7);const d=new Date(r);d.setDate(d.getDate()-30);const l=t.filter(k=>["confirmado","pagado","enviado"].includes(k.status)),c=l.filter(k=>new Date(k.created_at)>=r),p=l.filter(k=>new Date(k.created_at)>=s),m=c.reduce((k,B)=>k+parseFloat(B.total||0),0),g=p.reduce((k,B)=>k+parseFloat(B.total||0),0),u=a.filter(k=>k.created_at&&new Date(k.created_at)>=d).length,y=["Dom","Lun","Mar","Mie","Jue","Vie","Sab"],f={};y.forEach(k=>f[k]=0),l.filter(k=>new Date(k.created_at)>=d).forEach(k=>{const B=y[new Date(k.created_at).getDay()];f[B]+=parseFloat(k.total||0)});const v={};l.forEach(k=>{v[k.canal||"sucursal"]=(v[k.canal||"sucursal"]||0)+parseFloat(k.total||0)});const h={};l.forEach(k=>{h[k.forma_pago||"efectivo"]=(h[k.forma_pago||"efectivo"]||0)+1});const x={};l.forEach(k=>{x[k.empleado||"Admin"]=(x[k.empleado||"Admin"]||0)+parseFloat(k.total||0)});const $={};l.forEach(k=>{const B=new Date(k.created_at).toLocaleDateString("es-MX",{month:"short",year:"numeric"});$[B]=($[B]||0)+parseFloat(k.total||0)});const w={};l.forEach(k=>{k.clientes&&(w[k.clientes.nombre]=(w[k.clientes.nombre]||0)+parseFloat(k.total||0))});const C=Object.entries(w).sort((k,B)=>B[1]-k[1]).slice(0,5),j=Object.entries(f).sort((k,B)=>B[1]-k[1])[0],E=Object.entries(x).sort((k,B)=>B[1]-k[1])[0];if(!document.getElementById("dashboard-contenido"))return;const G=l.filter(k=>new Date(k.created_at)>=d),S=G.reduce((k,B)=>k+parseFloat(B.total||0),0),M=[];for(let k=6;k>=0;k--){const B=new Date(r);B.setDate(B.getDate()-k);const D=B.toISOString().split("T")[0],_=B.toLocaleDateString("es-MX",{weekday:"short",day:"numeric"}),L=l.filter(O=>{var I;return(I=O.created_at)==null?void 0:I.startsWith(D)}).reduce((O,I)=>O+parseFloat(I.total||0),0);M.push({label:_,total:L,ds:D})}const F=(k,B,D,_)=>{const L=document.getElementById(k),O=document.getElementById(k+"-sub");L&&(L.textContent=B,_&&(L.style.color=_)),O&&D&&(O.textContent=D)};F("kpi-ventas-hoy","$"+m.toLocaleString("es-MX",{maximumFractionDigits:0}),c.length+" pedidos","#C8967A"),F("kpi-pedidos-hoy",c.length,"confirmados"),F("kpi-ventas-7d","$"+g.toLocaleString("es-MX",{maximumFractionDigits:0}),p.length+" pedidos"),F("kpi-ventas-30d","$"+S.toLocaleString("es-MX",{maximumFractionDigits:0}),G.length+" pedidos"),F("kpi-clientes-nuevos",u,"últimos 30 días"),F("kpi-stock-bajo",i.length,i.length>0?"⚠ reabastecer":"✓ ok",i.length>0?"#f59e0b":"#10b981"),F("kpi-mejor-dia",j?j[0]:"—",j?"$"+j[1].toLocaleString("es-MX",{maximumFractionDigits:0}):""),F("kpi-total-clientes",a.length,"registrados");const P=document.getElementById("dash-top-clientes");P&&(P.innerHTML=C.length===0?'<p style="color:var(--text-muted);font-size:0.85rem">Sin datos aun</p>':C.map(([k,B],D)=>`
...
`)[0].trim();p=x.match(/^https?:\/\/.+\.(jpg|jpeg|png|webp|gif)/i)?`<img src="${x}" style="max-width:200px;border-radius:8px;display:block;cursor:pointer" onclick="window.open('${x}')">`:`<p>${c}</p>`}else if(n.tipo==="documento_saliente"){const x=c.replace("[Documento] ","").split(" "),$=x[0]||"documento";p=`<a href="${x[1]||""}" target="_blank" class="wa-doc-link">
        ...
        ${c.replace("[Contacto] ","")}</span>`;else if(n.tipo==="imagen"){const x=(n.mensaje||"").match(/https?:\/\/\S+/),$=n.media_url||(x?x[0]:null),w=(n.mensaje||"").replace("[Imagen]","").replace(/https?:\/\/\S+/,"").replace(/^[:\s]+/,"").trim();$?p=`<div>
        ...
        </div>`:p='<p style="color:#64748b;font-size:0.8rem">📷 Imagen recibida</p>'}else if(n.tipo==="audio"){const x=n.media_url||((h=(n.mensaje||"").match(/https?:\/\/\S+/))==null?void 0:h[0])||"",$=c.replace("[Audio de voz recibido]","").replace("[Audio sin contenido]","").replace("[Audio no procesable]","").trim();p=x?`<div>
            <audio src="${x}" controls style="max-width:220px;width:100%;margin-bottom:${$?"4px":"0"}"></audio>
            ${$?`<p style="font-size:0.8rem;color:#475569;margin:0;font-style:italic">${$}</p>`:""}
           </div>`:`<p style="color:#64748b;font-size:0.8rem">🎵 ${$||"Audio de voz"}</p>`}else if(n.tipo==="documento"){const x=(n.mensaje||"").match(/https?:\/\/\S+/),$=n.media_url||(x?x[0]:null),w=(n.mensaje||"").replace("[Documento]","").replace(/https?:\/\/\S+/g,"").trim()||"documento";p=$?`<a href="${$}" target="_blank" class="wa-doc-link">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
            ${w}</a>`:`<p style="color:#64748b;font-size:0.8rem">📄 ${w}</p>`}else if(n.tipo==="video"){const x=(n.mensaje||"").match(/https?:\/\/\S+/),$=n.media_url||(x?x[0]:null);p=$?`<video src="${$}" controls style="max-width:220px;border-radius:8px;display:block"></video>`:'<p style="color:#64748b;font-size:0.8rem">🎬 Video recibido</p>'}else p=`<p>${c}</p>`;let m="";if(r){const x=t(e.cliente_leyo_at),$=t(e.cliente_entrego_at),w=t(n.created_at);x&&w<=x?m='<span class="wa-read-receipt read" title="Visto">✓✓</span>':$&&w<=$?m='<span class="wa-read-receipt delivered" title="Entregado">✓✓</span>':i===a&&(m='<span class="wa-read-receipt sent" title="Enviado">✓</span>')}const g=`<button class="wa-reply-btn" onclick="iniciarReply('${e.telefono}','${(n.wa_message_id||"").replace(/'/g,"")}')" title="Responder">
      ...
      <div class="wa-msg-row saliente">
        ...
        <div class="wa-msg-row-inner">
          ...
          <div class="wa-bubble bot">
            ...
            ${(n.respuesta.match(/(https?:\/\/[^\s]+\.(?:jpg|jpeg|png|webp))/gi)||[]).map(x=>`<img src="${x}" style="max-width:200px;border-radius:8px;margin-top:4px;display:block" onclick="window.open('${x}')">`).join("")}
  ...
  `,document.body.appendChild(a),a.addEventListener("click",n=>{n.target===a&&a.remove()})};window.cargarNotasTareas=async e=>{var r;(r=window._empleadoActual)!=null&&r.nombre;const t=new Date().toISOString().split("T")[0],[o,a]=await Promise.all([fetch(b+"/chatbot/notas/"+e).then(s=>s.json()),fetch(b+"/chatbot/tareas/"+e).then(s=>s.json())]),n=document.getElementById("notas-lista-"+e);n&&(n.innerHTML=o.length===0?'<p style="font-size:0.73rem;color:var(--text-3);text-align:center;padding:8px">Sin notas</p>':o.map(s=>`
    ...
    <div style="display:flex;gap:8px;margin-top:16px">
      <button onclick="document.getElementById('modal-lista-wa').remove()" style="${ye()}">Cancelar</button>
      <button onclick="_enviarListaWA('${e}')" style="${ve()}">Enviar</button>
...
`).map(p=>p.trim()).filter(Boolean).slice(0,10);if(!a.length){alert("Agrega al menos una opción");return}const n=((l=window._empleadoActual)==null?void 0:l.nombre)||"Admin";(c=document.getElementById("modal-lista-wa"))==null||c.remove();const i=[{titulo:"Opciones",opciones:a.map((p,m)=>({id:`op_${m}`,titulo:p}))}];try{await fetch(b+"/chatbot/chats/"+e+"/lista",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cuerpo:t,titulo_boton:o,secciones:i,agente:n})}),await window._recargarChats(),abrirChat(e)}catch(p){alert("Error: "+p.message)}};window.mostrarModalCarrusel=async e=>{const t=be("modal-carrusel-wa",`
    ...
    <div style="display:flex;gap:8px;margin-top:8px">
      <button onclick="document.getElementById('modal-carrusel-wa').remove()" style="${ye()}">Cancelar</button>
      <button onclick="_enviarCarruselWA('${e}')" style="${ve()}">Enviar fotos</button>
  ...
  <div style="display:flex;gap:1rem;flex-wrap:wrap">
    ...
    <div class="table-card">
      ...
      <div style="display:flex;border-bottom:2px solid #e5e7eb;margin-bottom:20px;gap:4px">
        <button style="${ue(a,"subir")}" onclick="switchTabCat('subir')">📁 Subir imágenes</button>
        <button style="${ue(a,"seleccionar")}" onclick="switchTabCat('seleccionar')">🖼 De la tienda</button>
        <button style="${ue(a,"generar")}" onclick="switchTabCat('generar')">✨ Generar automático</button>
      </div>
    ...
    </div>`,a==="seleccionar"&&Xe(e),a==="generar"&&Je(e)}window.switchTabCat=function(e){const{catalogoId:t}=window._catalogoPaginasData;window._catalogoPaginasData.tabActiva=e,document.querySelectorAll("#tab-subir,#tab-seleccionar,#tab-generar").forEach(o=>o.style.display="none"),document.getElementById("tab-"+e).style.display="block",document.querySelectorAll('[onclick^="switchTabCat"]').forEach(o=>{var n;const a=(n=o.getAttribute("onclick").match(/'(\w+)'/))==null?void 0:n[1];o.style.borderBottomColor=a===e?"#C8967A":"transparent",o.style.color=a===e?"#C8967A":"#6b7280"}),e==="seleccionar"&&Xe(t),e==="generar"&&Je(t)};window.descargarCatalogoPDF=async function(){const e=window._catalogoPaginasData;if(!e)return;const{portada_url:t,paginas:o,nombre:a}=e,n=[];if(t&&n.push(t),[...o].sort((s,d)=>s.pagina_numero-d.pagina_numero).forEach(s=>{s.imagen_url&&n.push(s.imagen_url)}),n.length===0){alert("No hay páginas para descargar.");return}const r=document.querySelector('[onclick="descargarCatalogoPDF()"]');r&&(r.disabled=!0,r.textContent="⏳ Generando PDF...");try{window.jspdf||await new Promise((f,v)=>{const h=document.createElement("script");h.src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js",h.onload=f,h.onerror=v,document.head.appendChild(h)});const{jsPDF:s}=window.jspdf,d=f=>new Promise(v=>{const h=new Image;h.crossOrigin="anonymous",h.onload=()=>{const x=document.createElement("canvas");x.width=h.naturalWidth||h.width,x.height=h.naturalHeight||h.height,x.getContext("2d").drawImage(h,0,0),v({dataUrl:x.toDataURL("image/jpeg",.92),w:x.width,h:x.height})},h.onerror=()=>v(null),h.src=f}),c=(await Promise.all(n.map(d))).filter(Boolean);if(c.length===0){alert("No se pudieron cargar las imágenes. Revisa tu conexión.");return}const p=210,m=280,g=new s({unit:"mm",format:[p,m]}),u=(f,v)=>{v||g.addPage([p,m]);const h=f.w/f.h,x=p/m;let $,w,C,j;h>x?($=p,w=p/h,C=0,j=(m-w)/2):(w=m,$=m*h,j=0,C=(p-$)/2),g.addImage(f.dataUrl,"JPEG",C,j,$,w)};c.forEach((f,v)=>u(f,v===0));const y=(a||"catalogo").replace(/[^a-zA-Z0-9_\-áéíóúñÁÉÍÓÚÑ ]/g,"").trim()||"catalogo";g.save(`${y}.pdf`)}catch(s){console.error("Error generando PDF:",s),alert("Error al generar el PDF: "+s.message)}finally{r&&(r.disabled=!1,r.innerHTML="📥 Descargar PDF")}};async function Xe(e){const t=document.getElementById("selector-tienda-content");if(t)try{const[o,a]=await Promise.all([fetch(b+"/variantes/"),fetch(b+"/productos/")]),n=await o.json(),i=await a.json(),r=[];n.forEach(d=>{const l=i.find(p=>p.id===d.producto_id),c=(l==null?void 0:l.nombre)||d.sku||"";d.foto_url&&r.push({url:d.foto_url,nombre:c,color:d.color||""}),d.imagenes&&Array.isArray(d.imagenes)&&d.imagenes.forEach(p=>{p&&p!==d.foto_url&&r.push({url:p,nombre:c,color:d.color||""})})});const s=r.filter((d,l,c)=>c.findIndex(p=>p.url===d.url)===l);window._selectorFotos={fotos:s,seleccionadas:new Set},t.innerHTML=`
...
`})),y.length&&(f+=`
ERRORES:
`,y.forEach(v=>{var h;f+=`  ${v.sku}  [${v.codigo}] ${v.error}
`,(h=v.causas)!=null&&h.length&&v.causas.forEach(x=>{f+=`    ↳ ${x.code}: ${x.message}
`})})),n.textContent=f}}catch(m){n.style.display="block",n.textContent="Error inesperado: "+m.message}finally{t.innerHTML=i,t.disabled=!1}}window.mlPublicarPreview=function(e){We(!0,e)};window.mlPublicarReal=function(e){confirm("¿Publicar TODAS las variantes activas de este producto en MercadoLibre? Esto creará nuevos items en tu cuenta.")&&We(!1,e)};window.descargarExcelTikTok=async function(e,t,o){const a=e.innerHTML;try{e.innerHTML="⏳ Generando...",e.disabled=!0;const n=await fetch(`${b}/tiktok/${t}`);if(!n.ok){const d=await n.text();throw new Error(`Error ${n.status}: ${d}`)}const i=await n.blob(),r=URL.createObjectURL(i),s=document.createElement("a");s.href=r,s.download=o,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(r)}catch(n){alert("Error al descargar el archivo: "+n.message)}finally{e.innerHTML=a,e.disabled=!1}};async function vt(){const e=document.getElementById("content");e.innerHTML=`
  ...
  `,document.getElementById("ml-titulo").addEventListener("input",function(){document.getElementById("ml-titulo-count").textContent=this.value.length});let t=[];fetch(`${b}/productos/?select=id,sku_interno,nombre,activo`).then(r=>r.json()).then(r=>{t=(Array.isArray(r)?r:[]).filter(s=>s.activo!==!1)}).catch(()=>{});const o=document.getElementById("ml-sku"),a=document.getElementById("ml-sku-sug"),n=r=>{if(r=(r||"").toLowerCase().trim(),!r||!t.length){a.style.display="none";return}const s=t.filter(d=>(d.nombre||"").toLowerCase().includes(r)||(d.sku_interno||"").toLowerCase().includes(r)).slice(0,12);if(!s.length){a.style.display="none";return}a.innerHTML=s.map(d=>`
        ...
        <span style="color:#888;font-size:0.75rem;margin-left:6px">${d.sku_interno||""}</span>
              ...
              <div style="margin-bottom:1rem;width:100%;opacity:${O?1:.4}">
                <label style="display:flex;align-items:center;gap:8px;cursor:pointer;margin-bottom:6px">
                  ...
                  <span style="font-size:0.72rem;color:#888">(${x.filter(T=>(T.color||"Sin color")===_).length} tallas)</span>
                </label>
                <div style="display:flex;gap:8px;flex-wrap:wrap;padding-left:24px">
                  ${L.map((T,H)=>{const R=S.has(T.source),N=H===z[_]&&O&&!R;return`
              ...
              </div>`}).join("")};D(),A.style.display="block",window.mlToggleColor=_=>{G.has(_)?G.delete(_):G.add(_),B()},window.mlSeleccionarPortadaColor=(_,L)=>{z[_]=L,B()},window.mlToggleFoto=(_,L,O)=>{if(S.has(O))S.delete(O);else{S.add(O);const I=C[_]||[];if(I[z[_]]&&I[z[_]].source===O){const q=I.findIndex(T=>!S.has(T.source));z[_]=q>=0?q:0}}B()}}const F=x.filter(A=>G.has(A.color||"Sin color"));i(F,d,c,z,$.value.trim(),C);const P=document.getElementById("ml-variantes-wrap");P.style.display="block",P.scrollIntoView({behavior:"smooth",block:"start"})}catch(v){alert("Error de conexión: "+v.message)}finally{m.textContent="🔍 Generar preview",m.disabled=!1}};function i(r,s,d,l,c,p,m){m=m||new Set;const g=document.getElementById("ml-variantes-titulo"),u=document.getElementById("ml-variantes-list");g.textContent=`Paso 2 — Revisa y edita (${r.length} variantes, título aplicado a todas)`,u.innerHTML=r.map((y,f)=>{const v={...y.preview};if(delete v.title,v.family_name=s,d!==null&&(v.price=d),c&&(v.description={plain_text:c}),p){const h=y.color||"Sin color",x=p[h]||[],$=l&&l[h]||0,w=x[$]?x[$].source:null;let C=x.filter(j=>!m.has(j.source));if(w){const j=C.findIndex(E=>E.source===w);if(j>0){const[E]=C.splice(j,1);C.unshift(E)}}if(C.length<3){for(const[j,E]of Object.entries(p))if(j!==h){for(const z of E)if(!m.has(z.source)&&(C.find(G=>G.source===z.source)||C.push(z),C.length>=12))break;if(C.length>=12)break}}v.pictures=C.slice(0,12)}return`
      ...
      `).join("")||'<p style="color:#888">Sin detalles</p>'}catch(g){p.textContent="❌ Error de conexión",m.innerHTML=`<p style="color:red">${g.message}</p>`}finally{l.textContent="🚀 Publicar todas en ML",l.disabled=!1}}}let K=[],ne="";async function ht(){const e=document.getElementById("content");e.innerHTML=`
    <style>
  ...
  `;try{K=(await(await fetch(`${b}/productos/`)).json()).filter(a=>a.activo).sort((a,n)=>{const i=a.orden_home??99999,r=n.orden_home??99999;return i!==r?i-r:new Date(n.created_at)-new Date(a.created_at)}),ne="",le()}catch(t){document.getElementById("oh-lista").innerHTML=`<p style="color:red">Error: ${t.message}</p>`}}window._ohFiltrar=function(e){ne=e.toLowerCase().trim(),le()};function le(){const e=document.getElementById("oh-lista"),t=document.getElementById("oh-count");if(!e)return;const o=K.length,a=ne?K.filter(n=>(n.nombre||"").toLowerCase().includes(ne)||(n.sku_interno||"").toLowerCase().includes(ne)):K;if(t&&(t.textContent=ne?`${a.length} de ${o} modelos`:`${o} modelos activos`),!o){e.innerHTML='<p style="color:#888;text-align:center;padding:2rem">No hay productos activos</p>';return}if(!a.length){e.innerHTML='<p style="color:#aaa;text-align:center;padding:1.5rem">Sin resultados para esa búsqueda</p>';return}e.innerHTML=a.map(n=>{const i=K.indexOf(n),r=i+1,s=n.foto_principal||n.imagenes&&n.imagenes[0]||"",d=s?`<img class="oh-img" src="${s}" alt="" loading="lazy" onerror="this.style.display='none'">`:'<div class="oh-img" style="display:flex;align-items:center;justify-content:center;font-size:1.1rem">👠</div>';return`
  ...
  `,await wt(),ae=setInterval(async()=>{document.getElementById("ga-activos")?await Ke():(clearInterval(ae),ae=null)},3e4)}async function oe(e,t=8e3){const o=new AbortController,a=setTimeout(()=>o.abort(),t);try{const n=await fetch(e,{signal:o.signal});return clearTimeout(a),n}catch(n){throw clearTimeout(a),n.name==="AbortError"?new Error("timeout"):n}}async function wt(){const e=[Ke().catch(()=>ge("ga-activos","—")),$t().catch(()=>ge("ga-sesiones","—")),Ze().catch(()=>ge("ga-chart",null)),_t().catch(()=>{}),kt().catch(()=>{}),Ct().catch(()=>{})];await Promise.allSettled(e);const t=document.getElementById("ga-ultima-act");t&&(t.textContent="Actualizado: "+new Date().toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit",second:"2-digit"}))}function ge(e,t){const o=document.getElementById(e);o&&t!==null&&(o.textContent=t)}async function Ke(){var e;try{const o=await(await oe(`${b}/analytics/tiempo-real`)).json();if(!o.configurado){zt(o);return}const a=document.getElementById("ga-activos");if(!a)return;a.textContent=o.activos_ahora??0;const n=document.getElementById("ga-dispositivos");n&&o.por_dispositivo&&(n.textContent=Object.entries(o.por_dispositivo).map(([r,s])=>`${r}: ${s}`).join(" · "));const i=document.getElementById("ga-paginas-rt");i&&((e=o.por_pais)!=null&&e.length)?i.innerHTML='<div style="font-size:0.65rem;color:#aaa;margin-bottom:4px;text-transform:uppercase;letter-spacing:.05em">Por país</div>'+o.por_pais.map(r=>`
          ...
          </div>`).join(""):r.innerHTML='<p style="color:#bbb;font-size:0.82rem;margin:0">Sin datos de páginas aún</p>')}catch(t){console.warn("GA hoy:",t.message)}}async function Ze(){var e;try{const o=await(await oe(`${b}/analytics/semana`)).json();if(!o.configurado||!((e=o.dias)!=null&&e.length))return;Ye(o.dias)}catch(t){console.warn("GA semana:",t.message)}}window._gaPeriodoActivo="7d";window._gaSetPeriodo=async function(e){window._gaPeriodoActivo=e;const t=document.getElementById("ga-tab-7d"),o=document.getElementById("ga-tab-30d"),a=document.getElementById("ga-chart-label");t&&(t.style.background=e==="7d"?"#3483fa":"white",t.style.color=e==="7d"?"white":"#888",t.style.borderColor=e==="7d"?"#3483fa":"#ddd"),o&&(o.style.background=e==="30d"?"#3483fa":"white",o.style.color=e==="30d"?"white":"#888",o.style.borderColor=e==="30d"?"#3483fa":"#ddd"),a&&(a.textContent=e==="7d"?"Últimos 7 días":"Últimos 30 días"),e==="7d"?await Ze():await Et()};async function Et(){var e;try{const o=await(await oe(`${b}/analytics/mes`)).json();if(!o.configurado||!((e=o.dias)!=null&&e.length))return;Ye(o.dias)}catch(t){console.warn("GA mes:",t.message)}}function Ye(e){const t=document.getElementById("ga-chart");!t||!window.Chart||(t._chartInstance&&t._chartInstance.destroy(),t._chartInstance=new Chart(t,{type:"bar",data:{labels:e.map(o=>o.fecha),datasets:[{label:"Sesiones",data:e.map(o=>o.sesiones),backgroundColor:"rgba(52,131,250,0.7)",borderRadius:4},{label:"Usuarios",data:e.map(o=>o.usuarios),backgroundColor:"rgba(34,197,94,0.5)",borderRadius:4}]},options:{responsive:!0,plugins:{legend:{position:"top"}},scales:{y:{beginAtZero:!0,ticks:{precision:0}}}}}))}async function _t(){var e;try{const o=await(await oe(`${b}/analytics/fuentes`)).json(),a=document.getElementById("ga-fuentes");if(!a)return;if(!o.configurado||o.error||!((e=o.fuentes)!=null&&e.length)){a.innerHTML='<p style="color:#bbb;font-size:0.82rem;margin:0">Sin datos</p>';return}const n=o.total_sesiones||1,i={google:"🔍",instagram:"📸",facebook:"👥",direct:"🔗","(direct)":"🔗",tiktok:"🎵",youtube:"▶️",bing:"🔍",email:"📧",whatsapp:"💬"};a.innerHTML=o.fuentes.map(r=>{var l;const s=Math.round(r.sesiones/n*100);return`<div style="margin-bottom:0.55rem">
      ...
      </div>`}).join("")}catch(t){console.warn("GA fuentes:",t.message)}}async function kt(){var e;try{const o=await(await oe(`${b}/analytics/ciudades`)).json(),a=document.getElementById("ga-ciudades");if(!a)return;if(!o.configurado||o.error||!((e=o.ciudades)!=null&&e.length)){a.innerHTML='<p style="color:#bbb;font-size:0.82rem;margin:0">Sin datos</p>';return}const n=o.ciudades[0].sesiones||1;a.innerHTML=o.ciudades.map((i,r)=>{const s=Math.round(i.sesiones/n*100);return`<div style="margin-bottom:0.55rem">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:3px">
      ...
      </div>`}).join("")}catch(t){console.warn("GA ciudades:",t.message)}}async function Ct(){var e;try{const o=await(await oe(`${b}/analytics/horario`)).json();if(!o.configurado||!((e=o.horas)!=null&&e.length))return;const a=document.getElementById("ga-chart-horario");if(!a||!window.Chart)return;a._chartInstance&&a._chartInstance.destroy();const n=Math.max(...o.horas.map(r=>r.sesiones)),i=o.horas.map(r=>r.sesiones===n?"rgba(233,30,140,0.8)":"rgba(52,131,250,0.55)");a._chartInstance=new Chart(a,{type:"bar",data:{labels:o.horas.map(r=>r.hora.replace(":00","")),datasets:[{label:"Sesiones",data:o.horas.map(r=>r.sesiones),backgroundColor:i,borderRadius:3}]},options:{responsive:!0,plugins:{legend:{display:!1},tooltip:{callbacks:{title:r=>`${r[0].label}:00 hs`}}},scales:{y:{beginAtZero:!0,ticks:{precision:0}},x:{ticks:{font:{size:10}}}}}})}catch(t){console.warn("GA horario:",t.message)}}function zt(e){const t=document.getElementById("ga-setup"),o=document.getElementById("ga-setup-body");!t||!o||(t.style.display="block",o.innerHTML=`
    ...
    `}catch(t){e.innerHTML=`<p style="padding:2rem;color:red">Error cargando referidos: ${t.message}</p>`}}function St(e,t){const o=parseFloat(e.credito_disponible||0),a=e.referido_por?t[e.referido_por]||e.referido_por:"—",n=o>0?"#2e7d32":"#aaa";return`<tr id="ref-row-${e.id}" style="border-bottom:1px solid #f5f5f5">
    ...
    <div style="max-width:860px">
      ...
      <div class="table-card" style="padding:1.2rem">
        ...
        <div id="carrito-items-lista">
          ...
          ${(()=>{const m={};return a.forEach((g,u)=>{const y=g.variantes||{},f=y.productos||{},v=f.nombre||g.nombre||"—",h=y.color||g.color||"",x=!!g.es_corrida,$=x?"c|"+v+"|"+h:"s|"+g.id;m[$]||(m[$]={nombre:v,color:h,esCorrida:x,items:[],imagen:y.foto_url||f.imagen_principal||null}),m[$].items.push({...g,_idx:u})}),Object.values(m).map(g=>{const u=g.esCorrida,y=g.imagen;if(u){const f=g.items.reduce(($,w)=>$+w.cantidad,0),v=g.items.reduce(($,w)=>$+w.cantidad*w.precio_unitario,0),h=(v/f).toFixed(2),x=g.items.map($=>$.id).join(",");return`
                  <div style="background:#fdf4ff;border-radius:8px;padding:12px;margin-bottom:8px;border:1px solid #e8d5f5">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
                      <span id="corrida-header-${x.replace(/,/g,"_").substring(0,20)}" style="font-size:0.85rem;color:#888">${f} pares · <strong style="color:#6a1b9a">$${v.toFixed(2)}</strong></span>
                      <div style="display:flex;align-items:center;gap:4px">
                        <span style="font-size:0.72rem;color:#888">$</span>
                    ...
                    <div id="corrida-detalle-${x.replace(/,/g,"_").substring(0,20)}" style="display:none;margin-top:10px;border-top:1px solid #e8d5f5;padding-top:10px">
                      ${g.items.map($=>{const C=($.variantes||{}).talla||$.talla||"?",j=r.find(z=>z.variante_id===$.variante_id&&(s?z.sucursal_id===s:!0)),E=j?j.cantidad:999;return`
                          <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px"
                               data-item-id="${$.id}" data-item-idx="${$._idx}" data-stock="${E}" data-precio="${$.precio_unitario}">
                  ...
                  </div>`}else{const f=g.items[0],v=f.variantes||{};v.productos;const h=v.talla||f.talla||"",x=r.find(w=>w.variante_id===f.variante_id&&(s?w.sucursal_id===s:!0)),$=x?x.cantidad:null;return`
