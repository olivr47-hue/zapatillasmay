(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(a){if(a.ep)return;a.ep=!0;const i=n(a);fetch(a.href,i)}})();const g="https://zapatillasmay-production.up.railway.app",J=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],re=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],se=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],O=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"}];var U;let A=((U=window._empleadoActual)==null?void 0:U.rol)==="admin"?"dashboard":"pos",R=1;function W(){var n,o;const t=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),e=((n=window._empleadoActual)==null?void 0:n.rol)==="admin"?"dashboard":"pos";A=t||e,document.querySelector("#app").innerHTML=`
    ...
    <div class="main">
      <div class="topbar">
        <div style="display:flex;align-items:center;gap:1rem">
          ...
          <h1 id="topbar-title">${((o=O.find(a=>a.id===A))==null?void 0:o.label)||"Dashboard"}</h1>
        </div>
  ...
  `,window.toggleSidebar=()=>{const a=document.getElementById("sidebar"),i=document.getElementById("sidebar-overlay"),r=a.classList.toggle("open");i.classList.toggle("active",r),document.body.style.overflow=r?"hidden":""},window._conversacionesInterval&&clearInterval(window._conversacionesInterval),window._conversacionesInterval=setInterval(async()=>{try{const i=await(await fetch(g+"/chatbot/chats")).json();window._chatsData||(window._chatsData={});const r=window._totalNoLeidos||0,s=i.reduce((d,l)=>d+(l.no_leidos||0),0);if(window._totalNoLeidos=s,i.forEach(d=>{window._chatsData&&(window._chatsData[d.telefono]=d)}),fetch(g+"/health").catch(()=>{}),s>r){document.title=`(${s}) Zapatillas May`;const d=document.querySelector('[data-modulo="conversaciones"]');if(d){let l=d.querySelector(".nav-badge");l||(l=document.createElement("span"),l.className="nav-badge",l.style.cssText="background:#e91e8c;color:white;border-radius:100px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:auto",d.appendChild(l)),l.textContent=s}try{const l=new(window.AudioContext||window.webkitAudioContext),c=l.createOscillator(),p=l.createGain();c.connect(p),p.connect(l.destination),c.frequency.value=523,p.gain.setValueAtTime(.5,l.currentTime),p.gain.exponentialRampToValueAtTime(.001,l.currentTime+.2),c.start(l.currentTime),c.stop(l.currentTime+.2);const m=l.createOscillator(),f=l.createGain();m.connect(f),f.connect(l.destination),m.frequency.value=783,f.gain.setValueAtTime(.5,l.currentTime+.2),f.gain.exponentialRampToValueAtTime(.001,l.currentTime+.5),m.start(l.currentTime+.2),m.stop(l.currentTime+.5)}catch{}}if(window._chatActivo&&window._chatsData[window._chatActivo]){const d=window._chatsData[window._chatActivo],l=document.getElementById("mensajes-area");if(l){const c=l.scrollHeight-l.scrollTop<=l.clientHeight+50;l.innerHTML=[...d.mensajes].reverse().map(p=>{const m=p.tipo==="manual"||p.tipo==="imagen_saliente";return`
    ...
    `).join("")}
  `).join("")}async function K(t){const e=document.getElementById("content");switch(e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>',t){case"dashboard":e.innerHTML=ce(),setTimeout(()=>ye(),100);break;case"productos":await H();break;case"clientes":await me();break;case"pedidos":await te();break;case"sucursales":await ue();break;case"inventario":await fe();break;case"pos":await oe();break;case"historial":await ae();break;case"empleados":await ne();break;case"seo":await ve();break;case"analisis":await pe();break;case"crm":await Y();break;case"finanzas":await D();break;case"proveedores":await Z();break;case"ordenes":await L();break;case"conversaciones":await cargarConversaciones();break;case"envios":await cargarEnviosMasivos();break}}function le(){return setTimeout(()=>{document.querySelectorAll(".nav-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector('[data-modulo="'+A+'"]');t&&t.classList.add("active");const e=document.getElementById("topbar-title"),n=O.find(o=>o.id===A);e&&n&&(e.textContent=n.label),K(A)},100),'<div style="padding:2rem;color:#888;text-align:center">Cargando...</div>'}async function L(){var e;const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando sugerencias...</p>';try{const o=await(await fetch(g+"/sucursales/")).json(),a=(e=o[0])==null?void 0:e.id,[i,r]=await Promise.all([fetch(g+"/finanzas/sugerencias-recompra/"+a),fetch(g+"/finanzas/proveedores")]),s=await i.json(),d=await r.json(),l=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),c=new Date().toISOString().split("T")[0],p=s.filter(y=>{const h=l[y.producto_id];return h?h.hasta===null||h.hasta===void 0?!1:h.hasta<=c:!0}),m=s.length-p.length;window._ordenesData={sugerencias:p,proveedores:d,sucursalId:a},window._ordenSeleccion={};const f=p.filter(y=>y.urgente),u=p.filter(y=>!y.urgente),b=p.reduce((y,h)=>y+h.cantidad_sugerida*h.costo_unitario,0);t.innerHTML=`
  ...
  `,document.body.appendChild(a),a.addEventListener("click",i=>{i.target===a&&a.remove()}),setTimeout(ordenRecalcTotal,50)};window.guardarOrdenCompra=async t=>{var a,i,r;const e=(a=document.getElementById("orden-fecha"))==null?void 0:a.value,n=((i=document.getElementById("orden-notas"))==null?void 0:i.value)||"",o=window._ordenesData.sucursalId;try{const s=typeof t=="string"?JSON.parse(t):t;for(const[d,l]of s){const c=l.productos.reduce((u,b)=>u+b.cantidad_final*b.costo_unitario,0),f=(r=(await(await fetch(g+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:d==="sin-proveedor"?null:d,sucursal_id:o,status:"borrador",total:c,notas:n,fecha_entrega_estimada:e||null})})).json())[0])==null?void 0:r.id;if(f)for(const u of l.productos)await fetch(g+"/finanzas/ordenes/"+f+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:null,cantidad:u.cantidad_final,costo_unitario:u.costo_unitario,subtotal:u.cantidad_final*u.costo_unitario})})}document.querySelector('div[style*="position:fixed"]').remove(),alert("Orden de compra guardada exitosamente"),L()}catch(s){alert("Error guardando orden: "+s.message)}};window.ordenToggleVar=(t,e)=>{const n=document.getElementById("qty-var-"+t);n&&(n.disabled=!e,n.style.opacity=e?"1":"0.35",n.style.borderColor=e?"#E91E8C":"#ddd",e&&(!n.value||n.value==="0")?n.value=1:e||(n.value=0),ordenRecalcTotal())};window.ordenRecalcTotal=()=>{const{seleccionados:t}=window._ordenModal||{};if(!t)return;let e=0;t.forEach(o=>{var a;if((o.variantes||[]).forEach(i=>{var d;const r=document.getElementById("chk-var-"+i.id),s=parseInt(((d=document.getElementById("qty-var-"+i.id))==null?void 0:d.value)||0);r!=null&&r.checked&&s>0&&(e+=s*o.costo_unitario)}),!o.variantes||o.variantes.length===0){const i=parseInt(((a=document.getElementById("qty-orden-"+o.producto_id))==null?void 0:a.value)||o.cantidad_sugerida);e+=i*o.costo_unitario}});const n=document.getElementById("orden-total-general");n&&(n.textContent="$"+e.toFixed(0))};window.imprimirOrden=()=>{var s,d;const{seleccionados:t}=window._ordenModal||{};if(!t)return;const e=((s=document.getElementById("orden-fecha"))==null?void 0:s.value)||"",n=((d=document.getElementById("orden-notas"))==null?void 0:d.value)||"",o=new Date().toLocaleDateString("es-MX");let a="",i=0;t.forEach(l=>{var p;const c=l.variantes||[];if(c.length===0){const m=parseInt(((p=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:p.value)||l.cantidad_sugerida),f=m*l.costo_unitario;i+=f,a+=`<tr><td>${l.nombre}</td><td>${l.sku||""}</td><td>—</td><td>—</td><td style="text-align:center">${m}</td><td style="text-align:right">$${f.toFixed(0)}</td></tr>`}else c.forEach(m=>{var y;const f=document.getElementById("chk-var-"+m.id);if(!(f!=null&&f.checked))return;const u=parseInt(((y=document.getElementById("qty-var-"+m.id))==null?void 0:y.value)||0);if(u<=0)return;const b=u*l.costo_unitario;i+=b,a+=`<tr style="${m.sin_stock?"background:#fff5f5":""}">
...
¿Quieres reactivar todos?`)&&(localStorage.removeItem("ordenes_pospuestos"),L())};window.guardarOrdenCompra2=async()=>{var i,r,s,d;const{seleccionados:t,sucursalId:e}=window._ordenModal||{};if(!t)return;const n=(i=document.getElementById("orden-fecha"))==null?void 0:i.value,o=((r=document.getElementById("orden-notas"))==null?void 0:r.value)||"",a={};t.forEach(l=>{var f,u;const c=l.proveedor_id||"sin-proveedor",p=((f=l.proveedor)==null?void 0:f.nombre)||"Sin proveedor";a[c]||(a[c]={nombre:p,items:[]});const m=l.variantes||[];if(m.length===0){const b=parseInt(((u=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:u.value)||l.cantidad_sugerida);a[c].items.push({variante_id:null,cantidad:b,costo_unitario:l.costo_unitario})}else m.forEach(b=>{var v;const y=document.getElementById("chk-var-"+b.id);if(!(y!=null&&y.checked))return;const h=parseInt(((v=document.getElementById("qty-var-"+b.id))==null?void 0:v.value)||0);h<=0||a[c].items.push({variante_id:b.id,cantidad:h,costo_unitario:l.costo_unitario})})});try{for(const[l,c]of Object.entries(a)){if(c.items.length===0)continue;const p=c.items.reduce((b,y)=>b+y.cantidad*y.costo_unitario,0),u=(s=(await(await fetch(g+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:l==="sin-proveedor"?null:l,sucursal_id:e,status:"borrador",total:p,notas:o,fecha_entrega_estimada:n||null})})).json())[0])==null?void 0:s.id;if(u)for(const b of c.items)await fetch(g+"/finanzas/ordenes/"+u+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...b,subtotal:b.cantidad*b.costo_unitario})})}(d=document.getElementById("modal-orden"))==null||d.remove(),alert("Orden de compra guardada"),L()}catch(l){alert("Error guardando orden: "+l.message)}};function ce(){return`
  ...
  `}async function D(){var e,n,o,a,i,r;const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando finanzas...</p>';try{const d=await(await fetch(g+"/sucursales/")).json(),l=(e=d[0])==null?void 0:e.id,[c,p,m,f,u,b,y]=await Promise.all([fetch(g+"/finanzas/caja/hoy/"+l),fetch(g+"/finanzas/reporte/"+l),fetch(g+"/finanzas/gastos/"+l),fetch(g+"/finanzas/estado-resultados/"+l),fetch(g+"/finanzas/flujo/"+l),fetch(g+"/finanzas/cuentas-por-cobrar"),fetch(g+"/finanzas/gastos-categorias/"+l)]),h=await c.json(),v=await p.json(),x=await m.json(),C=await f.json(),E=await u.json(),k=await b.json(),w=await y.json(),_=h.find(z=>z.status==="abierta"),I=new Date().toISOString().split("T")[0],T=x.filter(z=>{var j;return(j=z.created_at)==null?void 0:j.startsWith(I)}),S=T.reduce((z,j)=>z+parseFloat(j.monto||0),0),P=k.reduce((z,j)=>z+parseFloat(j.total||0),0);t.innerHTML=`
      ...
      <div style="background:${_?"#e8f5e9":"#ffebee"};border-radius:12px;padding:1.25rem;border:1px solid ${_?"#a5d6a7":"#ffcdd2"};margin-bottom:1.5rem;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
        ...
        ${_?`
          <div style="display:flex;gap:16px;flex-wrap:wrap">
            ...
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#1565c0">$${(((o=E.hoy)==null?void 0:o.tarjeta)||0).toFixed(0)}</p>
    ...
    `,window._finanzasData={sucursalId:l,gastosHoy:T,totalGastosHoy:S,estadoResultados:C,flujo:E,cxc:k,categorias:w,historial:[]},window._finanzasSucursalId=l;const $=await(await fetch(g+"/finanzas/caja/historial/"+l)).json();window._finanzasData.historial=$,mostrarTabFinanzas("gastos")}catch(s){t.innerHTML='<p style="padding:2rem;color:red">Error cargando finanzas: '+s.message+"</p>"}}window.mostrarTabFinanzas=t=>{var c,p,m,f,u,b,y,h,v,x,C,E,k;const{gastosHoy:e,totalGastosHoy:n,estadoResultados:o,flujo:a,cxc:i,categorias:r,historial:s,sucursalId:d}=window._finanzasData,l=document.getElementById("fin-tab-contenido");if(l)if(t==="gastos"){const w=r.reduce((_,I)=>_+I.total,0);l.innerHTML=`
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
        <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
          ...
          ${e.length===0?'<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">Sin gastos hoy</div>':e.map(_=>`
      ...
      <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
        ...
        <div style="padding:1rem 1.5rem;background:#f9f9f9;display:flex;gap:2rem;flex-wrap:wrap">
          <div>
            ...
            <p style="font-weight:700;color:#E91E8C">$${o.reduce((w,_)=>w+_.ventas,0).toFixed(0)}</p>
          </div>
          <div>
            <p style="font-size:0.72rem;color:#888">Total gastos 6 meses</p>
            <p style="font-weight:700;color:#c62828">$${o.reduce((w,_)=>w+_.gastos,0).toFixed(0)}</p>
          </div>
          <div>
            <p style="font-size:0.72rem;color:#888">Utilidad total</p>
            <p style="font-weight:700;color:#2e7d32">$${o.reduce((w,_)=>w+_.utilidad,0).toFixed(0)}</p>
          </div>
        </div>
      </div>
    `:t==="flujo"?l.innerHTML=`
    ...
    <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
      ...
      ${t.length===0?'<div style="padding:2rem;text-align:center;color:#888">Sin cuentas por cobrar</div>':t.map(o=>{var i,r;const a=Math.floor((n-new Date(o.created_at))/864e5);return`
            <div style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
              <div style="flex:1">
  ...
  `};window.abrirCaja=async t=>{var n;const e=prompt("¿Cuánto efectivo hay en caja para empezar? (fondo de caja)");if(e!==null)try{const a=await(await fetch(g+"/finanzas/caja/abrir",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sucursal_id:t,monto_apertura:parseFloat(e)||0,empleado:((n=window._empleadoActual)==null?void 0:n.nombre)||"Admin"})})).json();if(a.error){alert("Error: "+a.error);return}D()}catch{alert("Error abriendo caja")}};window.cerrarCaja=async t=>{var o,a;const e=prompt("¿Cuánto efectivo hay físicamente en caja al cerrar?");if(e===null)return;const n=prompt("Notas del cierre (opcional):")||"";try{const r=await(await fetch(g+"/finanzas/caja/"+t+"/cerrar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({monto_cierre:parseFloat(e)||0,notas:n})})).json();r.ok?(alert(`Caja cerrada.
Total ventas: $${(o=r.total_ventas)==null?void 0:o.toFixed(2)}
Diferencia: $${(a=r.diferencia)==null?void 0:a.toFixed(2)}`),D()):alert("Error: "+JSON.stringify(r))}catch{alert("Error cerrando caja")}};window.agregarGasto=t=>{const e=document.createElement("div");e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",e.innerHTML=`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",n=>{n.target===e&&e.remove()})};window.guardarGasto=async(t,e)=>{var i;const n=document.getElementById("gasto-concepto").value,o=document.getElementById("gasto-monto").value,a=document.getElementById("gasto-categoria").value;if(!n||!o){alert("Completa concepto y monto");return}try{await fetch(g+"/finanzas/gastos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sucursal_id:t,concepto:n,monto:parseFloat(o),categoria:a,empleado:((i=window._empleadoActual)==null?void 0:i.nombre)||"Admin"})}),e.closest('div[style*="position:fixed"]').remove(),D()}catch{alert("Error guardando gasto")}};window.eliminarGasto=async t=>{if(confirm("¿Eliminar este gasto?"))try{await fetch(g+"/finanzas/gastos/"+t,{method:"DELETE"}),D()}catch{alert("Error eliminando gasto")}};async function Z(){const t=document.getElementById("content");try{const n=await(await fetch(g+"/finanzas/proveedores")).json();t.innerHTML=`
  ...
  <button class="btn btn-secondary" style="padding:4px 10px;font-size:0.75rem;background:#ffebee;border-color:#c62828;color:#c62828" onclick="filtrarRotacion('rojo')">🔴 Sin movimiento</button>
    ...
    `,window._crmData={clientes:p,pedidos:i,recordatorios:r}}catch(e){t.innerHTML='<p style="padding:2rem;color:red">Error cargando CRM: '+e.message+"</p>"}}window.mostrarSegmento=t=>{const{clientes:e}=window._crmData||{};if(!e)return;const n=e.filter(i=>i.segmento===t).sort((i,r)=>r.totalGastado-i.totalGastado),o={vip:"⭐ Clientes VIP",riesgo:"🟡 En riesgo",inactivo:"🔴 Inactivos",frecuente:"🟢 Frecuentes"},a=document.getElementById("crm-segmento-detalle");a.style.display="block",a.innerHTML=`
    <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
      <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee;display:flex;justify-content:space-between;align-items:center">
  ...
  `,a.scrollIntoView({behavior:"smooth"})};window.completarRecordatorio=async t=>{try{await fetch(g+"/crm/seguimientos/"+t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({completado:!0})}),Y()}catch{alert("Error al completar recordatorio")}};window.mostrarPipeline=async()=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando pipeline...</p>';try{const n=await(await fetch(g+"/crm/oportunidades")).json(),o=[{id:"contacto",label:"📞 Contacto",color:"#e3f2fd",colorText:"#1565c0"},{id:"interes",label:"👀 Interés",color:"#f3e5f5",colorText:"#6a1b9a"},{id:"cotizacion",label:"📋 Cotización",color:"#fff8e1",colorText:"#f57f17"},{id:"negociacion",label:"🤝 Negociación",color:"#fce4f3",colorText:"#E91E8C"},{id:"ganado",label:"✅ Ganado",color:"#e8f5e9",colorText:"#2e7d32"},{id:"perdido",label:"❌ Perdido",color:"#ffebee",colorText:"#c62828"}];t.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:12px">
        ${o.map(a=>{const i=n.filter(s=>s.etapa===a.id),r=i.reduce((s,d)=>s+parseFloat(d.monto_estimado||0),0);return`
  ...
  `).join("")};window.seleccionarClienteOportunidad=(t,e)=>{document.getElementById("op-cliente-id").value=t,document.getElementById("op-cliente-buscar").value=e,document.getElementById("op-cliente-resultados").style.display="none"};window.guardarOportunidad=async()=>{const t=document.getElementById("op-titulo").value,e=document.getElementById("op-cliente-id").value,n=document.getElementById("op-monto").value,o=document.getElementById("op-etapa").value,a=document.getElementById("op-fecha").value,i=document.getElementById("op-notas").value;if(!t){alert("El título es requerido");return}try{await fetch(g+"/crm/oportunidades",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({titulo:t,cliente_id:e||null,monto_estimado:parseFloat(n)||0,etapa:o,fecha_cierre_estimada:a||null,notas:i})}),document.getElementById("modal-oportunidad").remove(),mostrarPipeline()}catch{alert("Error guardando oportunidad")}};async function H(t,e=!1){const n=document.getElementById("content");try{const a=await(await fetch(g+"/productos/")).json(),i=a.filter(c=>c.activo),r=a.filter(c=>!c.activo),s=e?r:i;console.log("mostrarInactivos:",e,"base:",s.length,"inactivos:",r.length);const d=[...new Set(i.map(c=>c.categoria).filter(Boolean))],l=t?s.filter(c=>c.categoria===t):s;n.innerHTML=`
    ...
    `}catch{n.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.cargarProductos=H;window.mostrarCampanas=async()=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando campañas...</p>';try{const[e,n]=await Promise.all([fetch(g+"/clientes/"),fetch(g+"/pedidos/")]),o=await e.json(),a=await n.json(),i=new Date,r=new Date(i-30*24*60*60*1e3),s=new Date(i-90*24*60*60*1e3),d=o.map(p=>{const m=a.filter(v=>v.cliente_id===p.id&&(v.status==="confirmado"||v.status==="pagado")),f=m.reduce((v,x)=>v+parseFloat(x.total||0),0),u=m.length>0?new Date(m[0].created_at):null,b=u?Math.floor((i-u)/(1e3*60*60*24)):null,y=m.filter(v=>new Date(v.created_at)>=r).length;let h="nuevo";return m.length===0?h="nuevo":f>=5e3&&y>=1?h="vip":b>90?h="inactivo":b>30?h="riesgo":y>=2?h="frecuente":h="activo",{...p,totalGastado:f,diasSinComprar:b,segmento:h}}).filter(p=>p.telefono);window._campanaClientes=d;const l=[{id:"catalogo",nombre:"👠 Catálogo completo",descripcion:"Envía el catálogo completo de productos",mensaje:p=>`Hola ${p}! 👋
...
⚠️ Requiere que los productos estén en el catálogo de Meta Commerce.`;else if(d.style.background="#e8f5e9",d.style.borderColor="#a5d6a7",d.style.color="#333",n){let b;e==="personalizado"?b=(((u=document.getElementById("texto-personalizado"))==null?void 0:u.value)||"").replace("{nombre}","María"):b=n.mensaje("María"),d.textContent=b}}const l=document.getElementById("campana-count");l&&(l.textContent=i.length+" clientes");const c=document.getElementById("campana-lista");if(c){if(!i.length){c.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No hay clientes en este segmento con teléfono registrado</div>';return}window._campanaFiltrados=i,window._campanaPlantillaId=e,c.innerHTML=i.map((b,y)=>{var C;let h;e==="personalizado"?h=(((C=document.getElementById("texto-personalizado"))==null?void 0:C.value)||"").replace("{nombre}",b.nombre.split(" ")[0]):h=n.mensaje(b.nombre.split(" ")[0]);const v=encodeURIComponent(h),x=(b.lada||"52")+b.telefono.replace(/\D/g,"");return`
    ...
    </div>`}).join("")};window.filtrarModelosCampana=t=>{const e=window._campanaModelosList||[],n=t.trim()?e.filter(o=>(o.nombre||"").toLowerCase().includes(t.toLowerCase())||(o.sku_interno||"").toLowerCase().includes(t.toLowerCase())):e;_renderModelosCampana(n)};window.seleccionarModeloCampana=async(t,e)=>{var i,r,s;const n=String(t);window._campanaModelosSeleccionados||(window._campanaModelosSeleccionados=new Set),window._campanaModelosData||(window._campanaModelosData=new Map),window._campanaColoresSeleccionados||(window._campanaColoresSeleccionados=new Set);const o=document.getElementById("campana-fotos-nuevos-grid");if(window._campanaModelosSeleccionados.has(n)){window._campanaModelosSeleccionados.delete(n);for(const d of[...window._campanaColoresSeleccionados])d.startsWith(n+"::")&&window._campanaColoresSeleccionados.delete(d);if(e){e.style.background="";const d=e.querySelector("span");d&&(d.style.fontWeight="500"),e.querySelector("span:last-child")}_renderColoresNuevos(),actualizarCountFotos(),window._campanaModelosList&&_renderModelosCampana((i=document.getElementById("campana-nuevo-buscar"))!=null&&i.value?(window._campanaModelosList||[]).filter(d=>(d.nombre||"").toLowerCase().includes(document.getElementById("campana-nuevo-buscar").value.toLowerCase())):window._campanaModelosList||[]);return}if(window._campanaModelosSeleccionados.add(n),e){e.style.background="#fce4ec";const d=e.querySelector("span");d&&(d.style.fontWeight="700")}if(o){const d=document.createElement("p");d.id="campana-load-"+n,d.style.cssText="font-size:0.8rem;color:#aaa;padding:4px 0",d.textContent="Cargando colores...",o.appendChild(d)}if(!window._campanaModelosData.has(n))try{const d=((r=e==null?void 0:e.querySelector("span"))==null?void 0:r.textContent)||n,c=await(await fetch(g+"/variantes/producto/"+n)).json(),p={};for(const m of c)m.color&&(p[m.color]||(p[m.color]={color:m.color,color_hex:m.color_hex||null,foto_url:null}),!p[m.color].foto_url&&m.foto_url&&(p[m.color].foto_url=m.foto_url));window._campanaModelosData.set(n,{nombre:d,colores:Object.values(p)})}catch{window._campanaModelosSeleccionados.delete(n);const l=document.getElementById("campana-load-"+n);if(l&&l.remove(),o){const c=document.createElement("p");c.style.cssText="color:red;font-size:0.8rem",c.textContent="Error cargando variantes",o.appendChild(c)}return}const a=document.getElementById("campana-load-"+n);a&&a.remove(),_renderColoresNuevos(),actualizarCountFotos(),window._campanaModelosList&&_renderModelosCampana((s=document.getElementById("campana-nuevo-buscar"))!=null&&s.value?(window._campanaModelosList||[]).filter(d=>(d.nombre||"").toLowerCase().includes(document.getElementById("campana-nuevo-buscar").value.toLowerCase())):window._campanaModelosList||[])};window._renderColoresNuevos=()=>{var i;const t=document.getElementById("campana-fotos-nuevos-grid");if(!t)return;const e=window._campanaModelosSeleccionados||new Set;if(!e.size){t.innerHTML='<p style="font-size:0.8rem;color:#aaa;padding:4px 0">Selecciona uno o más modelos arriba</p>';return}const n=window._campanaColoresSeleccionados||new Set,o=e.size>1;let a="";for(const r of e){const s=(i=window._campanaModelosData)==null?void 0:i.get(r);if(s){if(o&&(a+=`<p style="font-size:0.72rem;font-weight:700;color:#888;text-transform:uppercase;letter-spacing:.04em;margin:10px 0 4px;padding:0 2px">${s.nombre}</p>`),!s.colores.length){a+='<p style="font-size:0.78rem;color:#aaa;margin:0 0 6px">Sin colores registrados</p>';continue}a+=s.colores.map(d=>{const l=`${r}::${d.color}`,c=n.has(l),p=!d.foto_url;return`
    ...
    </div>`}catch(r){a.remove(),alert("Error: "+r.message)}};window.enviarCampanaAutomatica=async()=>{var c,p;const t=document.querySelectorAll(".campana-cli-check:checked"),e=Array.from(t).map(m=>parseInt(m.dataset.idx)),n=window._campanaFiltrados||[],o=window._campanaPlantillaId||"catalogo",a=(c=window._plantillasCampana)==null?void 0:c.find(m=>m.id===o),i=window._campanaImagenUrl||"";let r=[],s=[];if(o==="nuevos"){const m=window._campanaColoresSeleccionados||new Set;if(!m.size){alert("Selecciona al menos un color");return}for(const f of window._campanaModelosSeleccionados||new Set){const u=(p=window._campanaModelosData)==null?void 0:p.get(f);if(u)for(const b of u.colores){const y=`${f}::${b.color}`;m.has(y)&&b.foto_url&&(s.push({url:b.foto_url,caption:b.color}),r.push(b.foto_url))}}if(!s.length){alert("Los colores seleccionados no tienen foto. Selecciona colores con imagen.");return}}else i&&(r=[i]);const d=e.map(m=>n[m]).filter(Boolean).map(m=>{var u;let f;return o==="personalizado"?f=(((u=document.getElementById("texto-personalizado"))==null?void 0:u.value)||"").replace("{nombre}",m.nombre.split(" ")[0]):f=a.mensaje(m.nombre.split(" ")[0]),{nombre:m.nombre,telefono:m.telefono,lada:m.lada||"52",mensaje:f}});if(!d.length)return;const l=document.createElement("div");l.id="campana-auto-overlay",l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9999;display:flex;align-items:center;justify-content:center;padding:1rem",l.innerHTML=`
    ...
    `}catch{t.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.filtrarClientes=()=>{var n,o;const t=(((n=document.getElementById("cli-buscar"))==null?void 0:n.value)||"").toLowerCase(),e=((o=document.getElementById("cli-tipo"))==null?void 0:o.value)||"";document.querySelectorAll(".cli-item").forEach(a=>{const i=a.dataset.nombre||"",r=a.dataset.tel||"",s=a.dataset.tipo||"",d=!t||i.includes(t)||r.includes(t),l=!e||s===e;a.style.display=d&&l?"":"none"})};window.filtrarClientesSeg=t=>{document.querySelectorAll(".cli-item").forEach(e=>{if(t==="todos"){e.style.display="";return}if(t==="activos"){e.style.display=e.dataset.segmento==="activo"||e.dataset.segmento==="frecuente"?"":"none";return}e.style.display=e.dataset.segmento===t?"":"none"})};async function ue(){const t=document.getElementById("content");try{const n=await(await fetch(g+"/sucursales/")).json();t.innerHTML=`
      <div class="table-card">
        <div class="table-header">
    ...
    `}catch{t.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}async function fe(){const t=document.getElementById("content");try{const n=await(await fetch(g+"/sucursales/")).json(),a=await(await fetch(g+"/productos/")).json(),r=await(await fetch(g+"/variantes/")).json(),d=await(await fetch(g+"/inventario/")).json();window._invData={sucursales:n,productos:a,variantes:r,inventario:d},t.innerHTML=`
  <div style="margin-bottom:1.5rem">
...
`,renderInventario()}catch{t.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.renderInventario=()=>{const{sucursales:t,productos:e,variantes:n,inventario:o}=window._invData,a=(document.getElementById("inv-buscar")?document.getElementById("inv-buscar").value:"").toLowerCase(),i=document.getElementById("inv-categoria")?document.getElementById("inv-categoria").value:"",r=document.getElementById("inv-talla")?document.getElementById("inv-talla").value:"",s=document.getElementById("inv-estado")?document.getElementById("inv-estado").value:"",d=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],l=e.filter(m=>!(!m.activo||a&&!m.nombre.toLowerCase().includes(a)&&!(m.sku_interno||"").toLowerCase().includes(a)||i&&m.categoria!==i)),c=t.map(m=>{const f=o.filter(b=>b.sucursal_id===m.id),u=l.map(b=>{const y=n.filter(C=>C.producto_id===b.id);if(y.length===0)return"";const v=[...new Set(y.map(C=>C.color).filter(Boolean))].map(C=>{const E=y.filter(I=>I.color===C).sort((I,T)=>d.indexOf(I.talla)-d.indexOf(T.talla));if(r&&!E.find(I=>I.talla===r))return"";const k=E[0]?E[0].color_hex:"#888",w=E[0]?E[0].foto_url:null,_=E.map(I=>{const T=f.find(z=>z.variante_id===I.id),S=T?T.cantidad:null,P=T?T.stock_minimo:3;if(r&&I.talla!==r||s&&(s==="agotado"&&S!==0||s==="bajo"&&(S===null||S===0||S>P)||s==="disponible"&&(S===null||S===0||S<=P)))return"";let M,$;return S===null?(M="#f0f0f0",$="#aaa"):S===0?(M="#ffebee",$="#c62828"):S<=P?(M="#fff8e1",$="#f57f17"):(M="#e8f5e9",$="#2e7d32"),`
    ...
    `:""}).join(""),p=document.getElementById("inv-contenido");p&&(p.innerHTML=c||'<div style="text-align:center;padding:3rem;color:#888"><p>No hay inventario registrado</p></div>')};window.cambiarStockInventario=async(t,e,n,o,a)=>{const i=Math.max(0,n+a);try{if((await fetch(g+"/inventario/actualizar",{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:t,sucursal_id:e,cantidad:i,stock_minimo:o})})).ok){const s=document.getElementById("stock-"+t+"-"+e);if(s){s.textContent=i;let c;i===0?c="#c62828":i<=o?c="#f57f17":c="#2e7d32",s.style.color=c}const d=window._invData.inventario.find(c=>c.variante_id===t&&c.sucursal_id===e);d&&(d.cantidad=i),document.querySelectorAll(`button[onclick*="${t}"][onclick*="${e}"]`).forEach(c=>{c.setAttribute("onclick",c.getAttribute("onclick").replace(/cambiarStockInventario\('[^']+', '[^']+', \d+,/,`cambiarStockInventario('${t}', '${e}', ${i},`))})}}catch{alert("Error actualizando stock")}};window.editarStock=async(t,e,n,o)=>{const a=prompt("Nueva cantidad:",n);if(a===null)return;const i=prompt("Stock minimo de alerta:",o);if(i!==null)try{if((await fetch(g+"/inventario/actualizar",{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:t,sucursal_id:e,cantidad:parseInt(a),stock_minimo:parseInt(i)})})).ok){const s=await fetch(g+"/inventario/");window._invData.inventario=await s.json(),renderInventario()}}catch{alert("Error conectando con el servidor")}};window.mostrarFormInventario=async()=>{const e=await(await fetch(g+"/sucursales/")).json(),o=await(await fetch(g+"/variantes/")).json();window._variantesCache=o;const a=document.getElementById("content");a.innerHTML=`
      ...
      <div style="display:grid;gap:1rem">
        <div>
          ...
          <select class="form-input" id="inv-sucursal" required>
            ...
            ${e.map(i=>`<option value="${i.id}">${i.nombre}</option>`).join("")}
          </select>
        </div>
        <div>
  ...
  `};window.guardarInventario=async()=>{const t=document.getElementById("inv-sucursal").value,e=document.getElementById("inv-v").value,n=document.getElementById("inv-cantidad").value,o=document.getElementById("inv-minimo").value||3;if(!t||!e||n===""){alert("Por favor completa todos los campos");return}try{(await fetch(g+"/inventario/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sucursal_id:t,variante_id:e,cantidad:parseInt(n),stock_minimo:parseInt(o)})})).ok?(alert("Stock guardado correctamente"),navegarA("inventario")):alert("Error al guardar stock")}catch{alert("Error conectando con el servidor")}};window.mostrarAlertas=async()=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando alertas...</p>';try{const n=await(await fetch(g+"/inventario/alertas")).json();t.innerHTML=`
      ...
      ${n.length===0?'<div class="table-card" style="padding:3rem;text-align:center;color:#888"><p>Todo el inventario esta en buen nivel</p></div>':`<div class="table-card"><table>
          ...
          <tbody>
            ${n.map(o=>{const a=o.cantidad||0,i=o.stock_minimo||3,r=a===0;return`
                <tr style="background:${r?"#fff5f5":"#fffdf0"}">
                  ...
                  <td><button class="btn btn-primary" style="padding:4px 10px;font-size:0.75rem" onclick="editarStock('${o.variante_id}', '${o.sucursal_id}', ${a}, ${i})">Reabastecer</button></td>
                </tr>
              `}).join("")}
          </tbody></table></div>`}
  ...
  `};window.guardarAjuste=async()=>{const t=document.getElementById("aj").value,e=document.getElementById("aj-sucursal").value,n=document.getElementById("aj-cantidad").value,o=document.getElementById("aj-motivo").value;if(!t||!e||n===""){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(g+"/movimientos/ajuste",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:t,sucursal_id:e,cantidad:parseInt(n),motivo:o})})).json();i.ok?(alert("Ajuste guardado. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarCambio=async()=>{const e=await(await fetch(g+"/sucursales/")).json(),o=await(await fetch(g+"/variantes/")).json();window._variantesCache=o;const a=document.getElementById("content");a.innerHTML=`
  ...
  `};window.guardarCambio=async()=>{const t=document.getElementById("cam-origen").value,e=document.getElementById("cam-destino").value,n=document.getElementById("cam-sucursal").value,o=document.getElementById("cam-motivo").value;if(!t||!e||!n){alert("Por favor selecciona ambos productos y la sucursal");return}if(t===e){alert("El producto que regresa y el que se lleva deben ser diferentes");return}try{const i=await(await fetch(g+"/movimientos/cambio",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_origen_id:t,variante_destino_id:e,sucursal_id:n,motivo:o})})).json();i.ok?(alert("Cambio registrado. El inventario se actualizo automaticamente."),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.buscarVariante=(t,e)=>{const n=window._variantesCache||[],o=document.getElementById(e+"-resultados");if(!o)return;if(!t||t.length<2){o.style.display="none";return}const a=t.toLowerCase().split(" ").filter(s=>s),i=n.filter(s=>{const d=(s.productos&&s.productos.nombre||"").toLowerCase(),l=(s.color||"").toLowerCase(),c=(s.talla||"").toLowerCase(),p=(s.sku||"").toLowerCase(),m=d+" "+l+" "+c+" "+p;return a.every(f=>m.includes(f))}).slice(0,15);if(i.length===0){o.innerHTML='<div style="padding:10px 14px;color:#888;font-size:0.85rem">No se encontraron resultados</div>',o.style.display="block";return}const r=e==="ped-prod";o.innerHTML=i.map(s=>{const d=(s.productos&&s.productos.nombre||"")+" - "+s.color+" - T"+s.talla;return`
      <div onclick="${r?`agregarItemPedido('${s.id}', '${d.replace(/'/g,"")}')`:`seleccionarVariante('${s.id}', '${d.replace(/'/g,"")}', '${e}')`}; document.getElementById('${e}-resultados').style.display='none'; document.getElementById('${r?"ped-buscar-prod":e+"-buscar"}') && (document.getElementById('${r?"ped-buscar-prod":e+"-buscar"}').value='')"
  ...
  <img src="${s}" style="width:72px;height:72px;object-fit:cover;border-radius:10px;border:3px solid ${l?"#E91E8C":"#eee"}" onclick="seleccionarPortadaExistente(${t}, ${d})">
    ...
    <div class="variante-item" id="variante-${t}" style="margin-bottom:0.625rem;border-radius:12px;border:1px solid #eee;box-shadow:0 1px 4px rgba(0,0,0,0.05);overflow:hidden">
      ...
      <div onclick="toggleVariante(${t})"
        ...
        <div id="v${t}-header-thumb" style="flex-shrink:0">${r}</div>
  ...
  `}window.eliminarColorVariante=async(t,e)=>{const n=document.getElementById("v"+t+"-nombre"),o=n?n.value:null;if(o&&window._productoEditandoId&&window._coloresExistentes){if(!confirm("Eliminar el color "+o+" y todas sus variantes?"))return;try{const r=(await(await fetch(g+"/variantes/producto/"+window._productoEditandoId)).json()).filter(s=>s.color===o);for(const s of r)await fetch(g+"/variantes/"+s.id+"/eliminar",{method:"POST",headers:{"Content-Type":"application/json"}});window._coloresExistentes=window._coloresExistentes.filter(s=>s.color!==o),window._coloresEliminados||(window._coloresEliminados=[]),window._coloresEliminados.push(o),alert("Color eliminado correctamente")}catch{alert("Error eliminando el color");return}}e.closest(".variante-item").remove(),actualizarTablaStock()};window.eliminarFotoExistente=(t,e)=>{const n=e.parentElement,o=n.dataset.url,a=document.getElementById("v"+t+"-preview");n.remove();const i=document.getElementById("v"+t+"-nombre");if(i&&window._coloresExistentes){const r=i.value,s=window._coloresExistentes.find(d=>d.color===r);s&&(s.imagenes&&(s.imagenes=s.imagenes.filter(d=>d!==o)),s.foto_url===o&&(s.foto_url=s.imagenes&&s.imagenes.length>0?s.imagenes[0]:null))}if(n.dataset.esPortada==="true"&&a){const r=a.querySelector("div[data-url]");if(r){r.dataset.esPortada="true",r.querySelector("img").style.border="2px solid #E91E8C";const s=document.createElement("span");s.className="portada-badge",s.style.cssText="position:absolute;top:-6px;left:-6px;background:#E91E8C;color:white;font-size:0.55rem;padding:1px 4px;border-radius:100px;pointer-events:none",s.textContent="PORTADA",r.appendChild(s)}}};window.seleccionarPortadaExistente=(t,e)=>{const n=document.getElementById("v"+t+"-preview");if(!n)return;n.querySelectorAll(".portada-badge").forEach(a=>a.remove()),n.querySelectorAll("img").forEach(a=>a.style.border="2px solid #ddd"),n.querySelectorAll("[data-es-portada]").forEach(a=>a.dataset.esPortada="false");const o=n.querySelectorAll("div[data-file-idx]");if(o[e]){o[e].dataset.esPortada="true",o[e].querySelector("img").style.border="2px solid #E91E8C";const a=document.createElement("span");a.className="portada-badge",a.style.cssText="position:absolute;top:-6px;left:-6px;background:#E91E8C;color:white;font-size:0.55rem;padding:1px 4px;border-radius:100px;pointer-events:none",a.textContent="PORTADA",o[e].appendChild(a)}};window.mostrarFormProducto=t=>{t||(window._coloresExistentes=null),R=window._coloresExistentes&&window._coloresExistentes.length>0?window._coloresExistentes.length:1;const e=t||{},n=document.getElementById("content");R=window._coloresExistentes&&window._coloresExistentes.length>0?window._coloresExistentes.length:1,t||(window._coloresExistentes=null),n.innerHTML=`
...
<div id="variantes-container">
  ...
  `,fetch(g+"/sucursales/").then(o=>o.json()).then(o=>{const a=document.getElementById("f-sucursal-stock");a&&(a.innerHTML=o.map(i=>`<option value="${i.id}">${i.nombre}</option>`).join("")),setTimeout(()=>actualizarTablaStock(),100)})};window.seleccionarColorPortada=t=>{if(!window._coloresExistentes)return;const e=window._coloresExistentes.splice(t,1)[0];window._coloresExistentes.unshift(e),document.querySelectorAll('[id^="portada-color-"]').forEach((o,a)=>{const i=a===0;o.style.borderColor=i?"#2e7d32":"#ddd",o.style.background=i?"#e8f5e9":"white",o.innerHTML=`
...
${n.telefono?'<a href="https://wa.me/'+(n.lada||"52")+n.telefono.replace(/\D/g,"")+'" target="_blank" class="btn btn-secondary" style="background:#25D366;color:white;border-color:#25D366;margin-left:auto">WhatsApp</a>':""}      </div>
  ...
  `};window.guardarEntrada=async()=>{const t=document.getElementById("ent").value,e=document.getElementById("ent-sucursal").value,n=document.getElementById("ent-cantidad").value,o=document.getElementById("ent-motivo").value;if(!t||!e||!n){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(g+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:t,sucursal_id:e,cantidad:parseInt(n),motivo:o})})).json();i.ok?(alert("Entrada guardada. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarSalida=async()=>{const e=await(await fetch(g+"/sucursales/")).json(),o=await(await fetch(g+"/variantes/")).json();window._variantesCache=o;const a=document.getElementById("content");a.innerHTML=`
    <div class="table-card" style="padding:2rem;max-width:600px">
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem">
        <button class="btn btn-secondary" onclick="navegarA('inventario')">← Volver</button>
  ...
  `};window.guardarSalida=async()=>{const t=document.getElementById("sal").value,e=document.getElementById("sal-sucursal").value,n=document.getElementById("sal-cantidad").value,o=document.getElementById("sal-motivo").value;if(!t||!e||!n){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(g+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:t,sucursal_id:e,cantidad:-parseInt(n),motivo:o})})).json();i.ok?(alert("Salida registrada. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const n=await(await fetch(g+"/sucursales/")).json(),a=await(await fetch(g+"/productos/")).json(),r=await(await fetch(g+"/variantes/")).json(),d=await(await fetch(g+"/inventario/")).json(),l=[...new Set(a.map(p=>p.categoria).filter(Boolean))],c=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:n,productos:a,variantes:r,inventario:d},t.innerHTML=`
    ...
    `,renderTablasMasivo()}catch{t.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:t,variantes:e,inventario:n}=window._invMasivo,o=document.getElementById("im-sucursal").value,a=document.getElementById("im-categoria").value,i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],r=t.filter(c=>!(a&&c.categoria!==a)),s=n.filter(c=>c.sucursal_id===o),d=r.map(c=>{const p=e.filter(u=>u.producto_id===c.id);if(p.length===0)return"";const f=[...new Set(p.map(u=>u.color).filter(Boolean))].map(u=>{const b=p.filter(h=>h.color===u).sort((h,v)=>i.indexOf(h.talla)-i.indexOf(v.talla));return`
        <div style="margin-bottom:1rem">
    ...
    `}).join(""),l=document.getElementById("im-tablas");l&&(l.innerHTML=d||'<div style="padding:2rem;text-align:center;color:#888">No hay productos en esta categoria</div>')};window.guardarInventarioMasivo=async()=>{const t=document.getElementById("im-sucursal").value,e=document.querySelectorAll("[data-variante]");let n=0,o=0,a=0;const i=document.querySelector('[onclick="guardarInventarioMasivo()"]');i&&(i.textContent="Guardando...",i.disabled=!0);for(const r of e){const s=r.dataset.variante,d=parseInt(r.dataset.anterior)||0,l=parseInt(r.value)||0;if(l===d){a++;continue}try{(await(await fetch(g+"/movimientos/ajuste",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:s,sucursal_id:t,cantidad:l,motivo:"Inventario masivo"})})).json()).ok?(n++,r.dataset.anterior=l,r.style.borderColor="#a5d6a7"):(o++,r.style.borderColor="#ffcdd2")}catch{o++}}i&&(i.textContent="Guardar todo",i.disabled=!1),o>0?alert(`Guardados: ${n}, Errores: ${o}, Sin cambios: ${a}`):alert(`Inventario actualizado. ${n} cambios guardados, ${a} sin cambios.`)};window.mostrarFormSucursal=async t=>{const e=document.getElementById("content");let n={};if(t)try{n=(await(await fetch(g+"/sucursales/")).json()).find(i=>i.id===t)||{}}catch{}e.innerHTML=`
    <div class="table-card" style="padding:2rem;max-width:600px">
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem">
  ...
  `};window.guardarTraspaso=async()=>{const t=document.getElementById("tra").value,e=document.getElementById("tra-origen").value,n=document.getElementById("tra-destino").value,o=document.getElementById("tra-cantidad").value;if(!t||!e||!n||!o){alert("Por favor completa todos los campos");return}if(e===n){alert("La sucursal origen y destino no pueden ser la misma");return}try{const i=await(await fetch(g+"/movimientos/traspaso",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:t,sucursal_origen_id:e,sucursal_destino_id:n,cantidad:parseInt(o)})})).json();i.ok?(alert("Traspaso realizado correctamente. Se movieron "+i.cantidad_movida+" pares."),navegarA("inventario")):alert("Error: "+(i.error||JSON.stringify(i)))}catch{alert("Error conectando con el servidor")}};async function te(){const t=document.getElementById("content");try{const n=await(await fetch(g+"/pedidos/")).json();t.innerHTML=`
      <div style="margin-bottom:1rem;display:flex;gap:8px;flex-wrap:wrap;align-items:center">
  ...
  `).join(""),window.recalcularTotal()}};window.cambiarCantidadItem=async(t,e)=>{if(e>0){const n=window._pedidoItems[t],o=document.getElementById("ped-sucursal")?document.getElementById("ped-sucursal").value:"";if(o)try{const r=(await(await fetch(g+"/inventario/sucursal/"+o)).json()).find(d=>d.variante_id===n.variante_id),s=r?r.cantidad:0;if(n.cantidad>=s){alert("No hay mas existencia disponible. Maximo: "+s+" pares");return}}catch{}}window._pedidoItems[t].cantidad=Math.max(1,window._pedidoItems[t].cantidad+e),window.recalcularTotal(),renderItemsPedido()};window.guardarPedido=async()=>{const t=document.getElementById("ped-cliente").value,e=document.getElementById("ped-canal").value,n=document.getElementById("ped-sucursal").value,o=document.getElementById("ped-pago").value,a=document.getElementById("ped-comentarios").value;if(!t){alert("Selecciona un cliente");return}if(window._pedidoItems.length===0){alert("Agrega al menos un producto");return}const i=document.getElementById("btn-ped-guardar");i&&(i.textContent="Guardando...",i.disabled=!0);const r=window._pedidoItems.reduce((d,l)=>d+l.cantidad*l.precio_unitario,0),s=o==="spei"?"pendiente_pago":"confirmado";try{const d=await fetch(g+"/pedidos/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cliente_id:t,canal:e,sucursal_id:n,forma_pago:o,comentarios:a||null,total:r,subtotal:r,status:s})});if(!d.ok){alert("Error creando pedido"),i&&(i.textContent="Crear pedido",i.disabled=!1);return}const c=(await d.json())[0].id;for(const p of window._pedidoItems)await fetch(g+"/pedidos/"+c+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:p.variante_id,cantidad:p.cantidad,precio_unitario:p.precio_unitario,subtotal:p.cantidad*p.precio_unitario})});o!=="spei"&&o!=="mercadopago"&&await fetch(g+"/pedidos/"+c+"/confirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({forma_pago:o})}),alert("Pedido creado correctamente"),window._pedidoItems=[],verPedido(c)}catch{alert("Error conectando con el servidor"),i&&(i.textContent="Crear pedido",i.disabled=!1)}};window.verPedido=async t=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando pedido...</p>';try{const o=await(await fetch(g+"/pedidos/"+t)).json();if(!o||o.length===0){alert("Pedido no encontrado");return}const a=o[0],i=a.pedido_items||[],r=a.clientes||{},s={borrador:"#f57f17",pendiente_pago:"#f57f17",confirmado:"#2e7d32",pagado:"#2e7d32",cancelado:"#c62828"}[a.status]||"#888";e.innerHTML=`
      <div class="table-card" style="padding:2rem">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;flex-wrap:wrap">
          <button class="btn btn-secondary" onclick="navegarA('pedidos')">← Volver</button>
  ...
  `).join(""),n.style.display="block"};window.seleccionarClientePOS=(t,e)=>{document.getElementById("pos-cliente").value=t,document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-resultados").style.display="none";const n=document.getElementById("pos-cliente-seleccionado");n.textContent="✔ "+e+" — toca para cambiar",n.style.display="block"};window.limpiarClientePOS=()=>{document.getElementById("pos-cliente").value="",document.getElementById("pos-cliente-seleccionado").style.display="none",document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-buscar").focus()};window.renderProductosPOS=t=>{const{variantes:e,inventario:n}=window._posData,o=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",a=n.filter(r=>r.sucursal_id===o),i=document.getElementById("pos-productos-grid");i&&(i.innerHTML=t.filter(r=>r.activo).map(r=>{const s=e.filter(c=>c.producto_id===r.id),d=[...new Set(s.map(c=>c.color).filter(Boolean))],l=s.reduce((c,p)=>{const m=a.find(f=>f.variante_id===p.id);return c+(m?m.cantidad:0)},0);return`
  ...
  `,document.body.appendChild(c),c.addEventListener("click",p=>{p.target===c&&c.remove()}),window._posSeleccion={productoId:t,color:null},window._posBuffer={}};window.mostrarCorridaModalPOS=t=>{const{variantes:e,inventario:n}=window._posData,o=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",a=n.filter(p=>p.sucursal_id===o),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],r=[...new Set(e.filter(p=>p.producto_id===t).map(p=>p.color).filter(Boolean))],s=document.querySelector(`button[onclick="mostrarCorridaModalPOS('${t}')"]`);s&&(s.style.display="none"),document.querySelectorAll("#pos-modal").forEach(p=>{p!==document.getElementById("pos-modal")&&p.remove()}),window._posSeleccion.color=null,window._corridaCantidades={};const d=document.getElementById("pos-tallas-panel");if(!d)return;const l=p=>{const m=e.filter(f=>f.producto_id===t&&f.color===p).sort((f,u)=>i.indexOf(f.talla)-i.indexOf(u.talla));m.filter(f=>{const u=a.find(b=>b.variante_id===f.id);return u&&u.cantidad>0}),d.innerHTML=`
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:16px">
        ${r.map(f=>{const u=e.find(v=>v.producto_id===t&&v.color===f),b=u?u.color_hex:"#888",y=u?u.foto_url:null,h=Object.entries(window._corridaCantidades).filter(([v])=>e.find(x=>x.id===v&&x.color===f)).reduce((v,[,x])=>v+x,0);return`
    ...
    `)};window.sugerirCorrida=(t,e)=>{const{variantes:n,inventario:o}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",i=o.filter(c=>c.sucursal_id===a),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],s=n.filter(c=>c.producto_id===t&&c.color===e).sort((c,p)=>r.indexOf(c.talla)-r.indexOf(p.talla)),d=s.filter(c=>{const p=i.find(m=>m.variante_id===c.id);return p&&p.cantidad>0}),l=d.some(c=>c.talla.includes("."));if(s.forEach(c=>{window._corridaCantidades[c.id]=0}),l)d.slice(0,6).forEach(c=>{window._corridaCantidades[c.id]=1});else{const c=d.slice(0,5);c.length>=4?c.forEach((p,m)=>{window._corridaCantidades[p.id]=m===1||m===2?2:1}):d.slice(0,6).forEach(p=>{window._corridaCantidades[p.id]=Math.ceil(6/d.length)})}window.renderCorridaColor(e)};window.confirmarCorridaNueva=t=>{const{variantes:e}=window._posData,n=window._posData.productos.find(i=>i.id===t);if(!n)return;let o=0;if(Object.entries(window._corridaCantidades).forEach(([i,r])=>{var l;if(r<=0)return;const s=e.find(c=>c.id===i);if(!s)return;const d=window._posCarrito.find(c=>c.variante_id===i&&c.es_corrida);d?(d.cantidad+=r,d.es_corrida=!0):window._posCarrito.push({variante_id:i,producto_id:t,nombre:n.nombre,color:s.color,talla:s.talla,cantidad:r,precio_menudeo:parseFloat(n.precio_menudeo)||0,precio_mayoreo3:parseFloat(n.precio_mayoreo3)||parseFloat(n.precio_menudeo)-30,precio_mayoreo6:parseFloat(n.precio_mayoreo6)||parseFloat(n.precio_menudeo)-70,precio_corrida:parseFloat(n.precio_corrida)||parseFloat(n.precio_menudeo)-110,es_corrida:!0,imagen:((l=window._posData.variantes.find(c=>c.id===i))==null?void 0:l.foto_url)||n.imagen_principal||null,precio_unitario:parseFloat(n.precio_corrida)||parseFloat(n.precio_menudeo)-110}),o++}),o===0){alert("Agrega al menos una talla");return}const a=document.getElementById("pos-modal");a&&a.remove(),window._corridaCantidades={},renderCarritoPOS()};window.seleccionarColorModalPOS=(t,e)=>{const{variantes:n,inventario:o}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",i=o.filter(f=>f.sucursal_id===a),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._posSeleccion&&window._posSeleccion.color&&guardarBufferColor(t,window._posSeleccion.color),document.querySelectorAll('[id^="pos-color-btn-"]').forEach(f=>{f.style.borderColor="#ddd",f.style.background="transparent"});const s=document.getElementById("pos-color-btn-"+e.replace(/\s/g,"_"));s&&(s.style.borderColor="#E91E8C",s.style.background="#fce4f3"),window._posSeleccion.color=e;const d=n.filter(f=>f.producto_id===t&&f.color===e).sort((f,u)=>r.indexOf(f.talla)-r.indexOf(u.talla)),l=d[0]?d[0].foto_url:null,c=document.getElementById("pos-modal-img");c&&l&&(c.src=l);const p=window._posBuffer[e]||{},m=document.getElementById("pos-tallas-panel");m&&(m.innerHTML=`
    ...
    `)};window.guardarBufferColor=(t,e)=>{const{variantes:n}=window._posData,o=n.filter(a=>a.producto_id===t&&a.color===e);window._posBuffer[e]||(window._posBuffer[e]={}),o.forEach(a=>{const i=document.getElementById("qty-modal-"+a.id);window._posBuffer[e][a.id]=i&&parseInt(i.value)||0}),actualizarBadgeColor(t,e)};window.actualizarBadgeColor=(t,e)=>{const{variantes:n}=window._posData,o=n.filter(r=>r.producto_id===t&&r.color===e);let a=0;o.forEach(r=>{const s=document.getElementById("qty-modal-"+r.id);a+=s&&parseInt(s.value)||0});const i=document.getElementById("pos-color-badge-"+e.replace(/\s/g,"_"));i&&(a>0?(i.textContent=a+" par"+(a>1?"es":""),i.style.display="block"):i.style.display="none"),actualizarResumenModalPOS(t)};window.actualizarResumenModalPOS=t=>{const{variantes:e}=window._posData;let n=0;const o=[];Object.entries(window._posBuffer).forEach(([s,d])=>{Object.entries(d).forEach(([l,c])=>{if(c>0){const p=e.find(m=>m.id===l);p&&(o.push({color:s,talla:p.talla,cantidad:c}),n+=c)}})});const a=window._posSeleccion?window._posSeleccion.color:null;a&&!window._posBuffer[a]&&e.filter(d=>d.producto_id===t&&d.color===a).forEach(d=>{const l=document.getElementById("qty-modal-"+d.id),c=l&&parseInt(l.value)||0;c>0&&(o.push({color:a,talla:d.talla,cantidad:c}),n+=c)});const i=document.getElementById("pos-modal-resumen"),r=document.getElementById("pos-btn-confirmar");n>0?(i&&(i.style.display="block",i.innerHTML=`
      ...
      `),r&&(r.textContent=`✅ Agregar ${n} pares al carrito`,r.disabled=!1)):(i&&(i.style.display="none"),r&&(r.textContent="Selecciona al menos una talla",r.disabled=!0))};window.confirmarModalPOS=t=>{window._posSeleccion&&window._posSeleccion.color;const{productos:e,variantes:n}=window._posData,o=e.find(i=>i.id===t);if(!o)return;window._posSeleccion&&window._posSeleccion.color?guardarBufferColor(t,window._posSeleccion.color):document.querySelectorAll('[id^="qty-modal-"]').forEach(r=>{const s=r.id.replace("qty-modal-",""),d=n.find(c=>c.id===s);if(!d)return;const l=parseInt(r.value)||0;window._posBuffer[d.color]||(window._posBuffer[d.color]={}),window._posBuffer[d.color][s]=l});let a=0;if(Object.entries(window._posBuffer).forEach(([i,r])=>{Object.entries(r).forEach(([s,d])=>{var p;if(d<=0)return;const l=n.find(m=>m.id===s),c=window._posCarrito.find(m=>m.variante_id===s&&!m.es_corrida);c?c.cantidad+=d:window._posCarrito.push({variante_id:s,producto_id:t,nombre:o.nombre,color:l?l.color:i,talla:l?l.talla:"",cantidad:d,precio_menudeo:parseFloat(o.precio_menudeo)||0,precio_mayoreo3:parseFloat(o.precio_mayoreo3)||parseFloat(o.precio_menudeo)-30,precio_mayoreo6:parseFloat(o.precio_mayoreo6)||parseFloat(o.precio_menudeo)-70,precio_corrida:parseFloat(o.precio_corrida)||parseFloat(o.precio_menudeo)-110,es_oferta:o.es_oferta||!1,es_corrida:!1,imagen:window._posBuffer[l?l.color:i]&&((p=window._posData.variantes.find(m=>m.id===s))==null?void 0:p.foto_url)||o.imagen_principal||null,precio_unitario:parseFloat(o.precio_menudeo)||0}),a++})}),a===0){alert("Pon al menos 1 par en alguna talla");return}document.getElementById("pos-modal").remove(),window._posBuffer={},renderCarritoPOS()};window.seleccionarColorPOS=(t,e)=>{const{variantes:n,inventario:o}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",i=o.filter(m=>m.sucursal_id===a),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];document.querySelectorAll('[id^="pos-color-"]').forEach(m=>{m.style.borderColor="transparent",m.style.background="transparent"});const s=document.getElementById("pos-color-"+e.replace(/\s/g,"_"));s&&(s.style.borderColor="#E91E8C",s.style.background="#fce4f3"),window._posSeleccion.color=e,window._posSeleccion.talla=null;const d=n.filter(m=>m.producto_id===t&&m.color===e).sort((m,f)=>r.indexOf(m.talla)-r.indexOf(f.talla)),l=d[0]?d[0].foto_url:null,c=document.getElementById("pos-modal-img");c&&l&&(c.src=l);const p=document.getElementById("pos-tallas-container");p&&(p.innerHTML=`
  ...
  `)};window.cambiarCantidadTallaPOS=(t,e,n)=>{const o=document.getElementById("qty-"+t);if(!o)return;const a=Math.min(n,Math.max(0,(parseInt(o.value)||0)+e));o.value=a,window._posSeleccion&&actualizarBadgeColor(window._posSeleccion.productoId,window._posSeleccion.color)};window.agregarTallasPOS=(t,e)=>{const{productos:n,variantes:o}=window._posData,a=n.find(d=>d.id===t);if(!a)return;const i=o.filter(d=>d.producto_id===t&&d.color===e);let r=0;if(i.forEach(d=>{const l=document.getElementById("qty-"+d.id),c=l&&parseInt(l.value)||0;if(c<=0)return;const p=window._posCarrito.find(m=>m.variante_id===d.id);p?p.cantidad+=c:window._posCarrito.push({variante_id:d.id,producto_id:t,nombre:a.nombre,color:e,talla:d.talla,cantidad:c,precio_menudeo:parseFloat(a.precio_menudeo)||0,precio_mayoreo3:parseFloat(a.precio_mayoreo3)||parseFloat(a.precio_menudeo)-30,precio_mayoreo6:parseFloat(a.precio_mayoreo6)||parseFloat(a.precio_menudeo)-70,precio_corrida:parseFloat(a.precio_corrida)||parseFloat(a.precio_menudeo)-110,imagen:a.imagen_principal||null,es_oferta:a.es_oferta||!1,precio_unitario:parseFloat(a.precio_menudeo)||0}),r++}),r===0){alert("Pon al menos 1 par en alguna talla");return}const s=document.querySelector(`button[onclick="agregarTallasPOS('${t}', '${e}')"]`);s&&(s.textContent="✅ Agregado — selecciona otro color o cierra",s.style.background="#2e7d32",s.style.borderColor="#2e7d32",s.disabled=!0),i.forEach(d=>{const l=document.getElementById("qty-"+d.id);l&&(l.value=0)}),actualizarResumenModal(t)};window.actualizarResumenModal=t=>{const e=window._posCarrito.filter(a=>a.producto_id===t),n=e.reduce((a,i)=>a+i.cantidad,0);let o=document.getElementById("pos-modal-resumen");if(!o){o=document.createElement("div"),o.id="pos-modal-resumen",o.style.cssText="background:#e8f5e9;border-radius:8px;padding:0.75rem;margin-top:10px;border:1px solid #a5d6a7";const a=document.querySelector("#pos-modal > div > div:last-child");a&&a.insertBefore(o,a.firstChild)}o.innerHTML=`
...
`).join("")}
    `;const d=document.getElementById("pos-total"),l=document.getElementById("pos-total-pares"),c=document.getElementById("pos-tipo-precio");d&&(d.textContent="$"+o.toFixed(2)),l&&(l.textContent=n),c&&(c.textContent=a);const p=document.getElementById("pos-flotante-pares"),m=document.getElementById("pos-flotante-total");p&&(p.textContent=n+" pares"),m&&(m.textContent="$"+o.toFixed(2)),(f=document.getElementById("pos-drawer"))!=null&&f.classList.contains("open")&&renderDrawerPOS()};window.editarPrecioPOS=(t,e)=>{if(!window._posCarrito[t])return;const n=parseFloat(e)||0;window._posCarrito[t].precio_unitario=n,window._posCarrito[t].precio_manual=!0;const o=window._posCarrito[t].cantidad,a=document.getElementById("subtotal-item-"+t);a&&(a.textContent="$"+(o*n).toFixed(2));const i=window._posCarrito.reduce((s,d)=>s+d.cantidad*d.precio_unitario,0),r=document.getElementById("pos-total");r&&(r.textContent="$"+i.toFixed(2))};window.editarPrecioCorridaPOS=(t,e)=>{const[n,o]=t.split("|"),a=parseFloat(e)||0;window._posCarrito.forEach(c=>{c.producto_id===n&&c.color===o&&c.es_corrida&&(c.precio_unitario=a,c.precio_manual=!0)});const r=window._posCarrito.filter(c=>c.producto_id===n&&c.color===o&&c.es_corrida).reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),s=document.getElementById("subtotal-corrida-"+t.replace("|","-"));s&&(s.textContent="$"+r.toFixed(2));const d=window._posCarrito.reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),l=document.getElementById("pos-total");l&&(l.textContent="$"+d.toFixed(2))};window.editarCorridaEnCarrito=t=>{const[e,n]=t.split("|"),{inventario:o,variantes:a}=window._posData,i=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=o.filter(c=>c.sucursal_id===i),s=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=a.filter(c=>c.producto_id===e&&c.color===n).sort((c,p)=>s.indexOf(c.talla)-s.indexOf(p.talla)),l=document.createElement("div");l.id="pos-modal-editar-corrida",l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",l.innerHTML=`
  ...
  `),c.document.close()};window.generarPDFPedido=async t=>{const n=await(await fetch(g+"/pedidos/"+t)).json();if(!n||n.length===0)return;const o=n[0],a=o.pedido_items||[],i=o.clientes||{},r=new Date(o.created_at).toLocaleDateString("es-MX",{year:"numeric",month:"long",day:"numeric"}),s=o.total||0,d=a.reduce((c,p)=>c+p.cantidad,0),l=window.open("","_blank");l.document.write(`
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="UTF-8">
  ...
  `),l.document.close()};async function ae(){const t=document.getElementById("content");try{const n=await(await fetch(g+"/movimientos/")).json(),o={venta:{label:"Venta",badge:"badge-success"},entrada:{label:"Entrada",badge:"badge-info"},ajuste:{label:"Ajuste",badge:"badge-warning"},traspaso_salida:{label:"Traspaso salida",badge:"badge-danger"},traspaso_entrada:{label:"Traspaso entrada",badge:"badge-info"},cambio_salida:{label:"Cambio salida",badge:"badge-info"},cambio_entrada:{label:"Cambio entrada",badge:"badge-info"}};t.innerHTML=`
      <div class="table-card">
        ...
        <table>
          ...
          <tbody id="hist-tbody">
            ${n.length===0?'<tr><td colspan="9" style="text-align:center;color:var(--text-muted);padding:2rem">No hay movimientos registrados</td></tr>':n.map(a=>{const i=o[a.tipo]||{label:a.tipo,badge:"badge-warning"},r=a.cantidad||0;return`<tr>
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
      ...
      </div>`,window._historialData=n}catch{t.innerHTML='<p style="padding:2rem;color:var(--red)">Error conectando con el servidor</p>'}}window.cancelarMovimiento=async(t,e,n,o,a)=>{if(confirm("¿Cancelar este movimiento? Se revertirá el cambio en el inventario."))try{const r=await(await fetch(g+"/inventario/?variante_id=eq."+n+"&sucursal_id=eq."+o)).json(),s=r&&r.length>0?r[0].cantidad:0,d=a==="venta"?s+e:Math.max(0,s-e);(await fetch(g+"/inventario/actualizar",{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:n,sucursal_id:o,cantidad:d,stock_minimo:r&&r.length>0?r[0].stock_minimo:3})})).ok?(alert("Movimiento cancelado. Inventario actualizado."),ae()):alert("Error al actualizar inventario")}catch{alert("Error conectando con el servidor")}};window.filtrarHistorial=()=>{const t=document.getElementById("hist-tipo").value,e=document.getElementById("hist-buscar").value.toLowerCase(),n=window._historialData||[],o={venta:{label:"Venta",badge:"badge-success"},entrada:{label:"Entrada",badge:"badge-info"},ajuste:{label:"Ajuste",badge:"badge-warning"},traspaso_salida:{label:"Traspaso salida",badge:"badge-danger"},traspaso_entrada:{label:"Traspaso entrada",badge:"badge-info"},cambio_salida:{label:"Cambio salida",badge:"badge-info"},cambio_entrada:{label:"Cambio entrada",badge:"badge-info"}},a=n.filter(r=>{if(t&&r.tipo!==t)return!1;if(e){const s=(r.variantes&&r.variantes.productos?r.variantes.productos.nombre:"").toLowerCase(),d=(r.motivo||"").toLowerCase();if(!s.includes(e)&&!d.includes(e))return!1}return!0}),i=document.getElementById("hist-tbody");i&&(i.innerHTML=a.length===0?'<tr><td colspan="9" style="text-align:center;color:var(--text-muted);padding:2rem">No se encontraron movimientos</td></tr>':a.map(r=>{const s=o[r.tipo]||{label:r.tipo,badge:"badge-warning"},d=r.cantidad||0;return`<tr>
          ...
          </div>`).join(""));const M=document.getElementById("dash-ultimos-pedidos");M&&(M.innerHTML=e.slice(0,5).map($=>`
      ...
      ${z.length===0?'<p style="color:#aaa;font-size:0.85rem;text-align:center;padding:1rem">Sin tareas pendientes</p>':z.map(B=>`
        ...
        `).join("")}
    `,document.getElementById("dashboard-contenido").appendChild(j)}catch($){console.error("tareas:",$)}}catch(t){console.error("Error dashboard:",t)}}window.eliminarItemPedido=t=>{window._pedidoItems.splice(t,1),window.recalcularTotal(),window.renderItemsPedido()};window.cerrarSesionPanel=()=>{confirm("Cerrar sesion?")&&(sessionStorage.removeItem("erp_empleado"),window._empleadoActual=null,location.reload())};async function ne(){const t=document.getElementById("content");try{const n=await(await fetch(g+"/empleados/")).json();t.innerHTML=`
      <div class="table-card">
        <div class="table-header">
      ...
      </div>`}catch{t.innerHTML='<p style="padding:2rem;color:var(--red)">Error conectando con el servidor</p>'}}window.mostrarFormEmpleado=async t=>{const e=document.getElementById("content");let n={};if(t)try{n=(await(await fetch(g+"/empleados/")).json()).find(i=>i.id===t)||{}}catch{}e.innerHTML=`
    ...
    </div>`};window.guardarEmpleado=async t=>{const e=document.getElementById("emp-nombre").value,n=document.getElementById("emp-email").value,o=document.getElementById("emp-password").value,a=document.getElementById("emp-rol").value;if(!e||!n){alert("Nombre y email son obligatorios");return}if(!t&&!o){alert("La contrasena es obligatoria para nuevos empleados");return}try{const i=t?"PATCH":"POST",r=t?g+"/empleados/"+t:g+"/empleados/",s={nombre:e,email:n,rol:a};o&&(s.password=o);const d=await fetch(r,{method:i,headers:{"Content-Type":"application/json"},body:JSON.stringify(s)});if(d.ok)alert("Empleado guardado correctamente"),navegarA("empleados");else{const l=await d.json();alert("Error: "+(l.error||"No se pudo guardar"))}}catch{alert("Error conectando con el servidor")}};window.toggleEmpleado=async(t,e)=>{if(confirm(e?"Desactivar este empleado?":"Activar este empleado?"))try{(await fetch(g+"/empleados/"+t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({activo:!e})})).ok?ne():alert("Error al cambiar estado")}catch{alert("Error conectando con el servidor")}};window.resetearPassword=async(t,e)=>{const n=prompt("Nueva contrasena para "+e+":");if(n){if(n.length<4){alert("La contrasena debe tener al menos 4 caracteres");return}try{const o=await fetch(g+"/empleados/"+t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:n})});if(o.ok)alert("Contrasena actualizada correctamente");else{const a=await o.json();alert("Error: "+(a.error||"No se pudo actualizar"))}}catch{alert("Error conectando con el servidor")}}};window.cargarConversaciones=async function(){var n;document.title="Zapatillas May";const t=document.querySelector('[data-modulo="conversaciones"]');t&&((n=t.querySelector(".nav-badge"))==null||n.remove());const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const a=await(await fetch(g+"/chatbot/chats")).json(),r=await(await fetch(g+"/productos/?select=id,nombre,imagen_principal,precio_menudeo,precio_mayoreo3,precio_mayoreo6,precio_corrida,corrida_activa,activo")).json();window._chatsData={},a.forEach(d=>window._chatsData[d.telefono]=d),window._productosWA=r.filter(d=>d.activo);const s=a.reduce((d,l)=>d+(l.no_leidos||0),0);e.innerHTML=`
  <div style="display:flex;gap:8px;margin-bottom:1rem">
...
`).trim();if(a.match(/^https?:\/\/.+\.(jpg|jpeg|png|webp|gif)/i))return'<img src="'+a+'" style="max-width:200px;border-radius:8px;display:block">'+(i?'<p style="font-size:0.82rem;color:#333;white-space:pre-wrap;margin-top:6px">'+i+"</p>":"")}return'<p style="font-size:0.85rem;color:#333;white-space:pre-wrap">'+t.mensaje.replace(/\[.+?\]:\s*/,"")+"</p>"};window.abrirChat=async t=>{const e=window._chatsData[t];if(!e)return;document.querySelectorAll(".wa-chat-item").forEach(i=>i.classList.remove("activo"));const n=document.querySelector(`[data-tel="${t}"]`);n&&n.classList.add("activo");const o=window.innerWidth<=900;if(o){const i=document.getElementById("wa-sidebar"),r=document.getElementById("wa-container");i&&(i.style.display="none"),r&&(r.style.gridTemplateColumns="1fr")}const a=document.getElementById("chat-area");a.style.display="flex",a.style.flexDirection="column",a.style.flex="1",a.style.minHeight="0",a.innerHTML=`
    ...
    <div id="mensajes-area">
      ${[...e.mensajes].reverse().map(i=>{var p;const r=i.tipo==="manual"||i.tipo==="imagen_saliente",s=r?((p=i.mensaje.match(/\[(.+?)\]:/))==null?void 0:p[1])||"Admin":e.nombre||e.telefono,d=i.tipo==="imagen_saliente"?i.mensaje.replace(/\[.+?\]:\s*\[Imagen\]\s*/,"").split(`
`)[0].trim():"",l=i.tipo==="imagen_saliente"&&d.match(/^https?:\/\/.+\.(jpg|jpeg|png|webp|gif)/i)?'<img src="'+d+'" style="max-width:200px;border-radius:8px;display:block">':"<p>"+i.mensaje.replace(/\[.+?\]:\s*/,"")+"</p>",c=new Date(i.created_at).toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"});return`
  ...
  `,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()})};window.cargarNotasTareas=async t=>{var r;(r=window._empleadoActual)!=null&&r.nombre;const e=new Date().toISOString().split("T")[0],[n,o]=await Promise.all([fetch(g+"/chatbot/notas/"+t).then(s=>s.json()),fetch(g+"/chatbot/tareas/"+t).then(s=>s.json())]),a=document.getElementById("notas-lista-"+t);a&&(a.innerHTML=n.length===0?'<p style="font-size:0.73rem;color:var(--text-3);text-align:center;padding:8px">Sin notas</p>':n.map(s=>`
      ...
      `).join(""));const i=document.getElementById("tareas-lista-"+t);i&&(i.innerHTML=o.length===0?'<p style="font-size:0.73rem;color:var(--text-3);text-align:center;padding:8px">Sin tareas</p>':o.map(s=>{const d=s.fecha_vence===e,l=s.fecha_vence&&s.fecha_vence<e&&!s.completada;return`
...
• Corrida completa: $`+(e.precio_corrida||e.precio_menudeo-110)+`

🛍️ Ver y comprar: https://zapatillasmay.mx`:""};window.enviarProductoWA=async(t,e,n)=>{var i;console.log("imagenUrl:",e,"caption:",n);const o=document.querySelector('div[style*="position:fixed"][style*="z-index:1000"]');o&&o.remove(),console.log("enviando a:",t,e);const a=((i=window._empleadoActual)==null?void 0:i.nombre)||"Admin";try{if(e){const d=n.replace(/\\n/g,`
`);await fetch(g+"/chatbot/chats/"+t+"/imagen",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:e,caption:d,agente:a})})}else await fetch(g+"/chatbot/chats/"+t+"/mensaje",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mensaje:n,agente:a})});await new Promise(d=>setTimeout(d,1500));const s=await(await fetch(g+"/chatbot/chats")).json();window._chatsData={},s.forEach(d=>window._chatsData[d.telefono]=d),abrirChat(t)}catch{alert("Error enviando producto")}};window.cargarEnviosMasivos=async function(){const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[e,n,o]=await Promise.all([fetch(g+"/chatbot/plantillas").then(r=>r.json()),fetch(g+"/clientes/").then(r=>r.json()),fetch(g+"/chatbot/chats").then(r=>r.json())]),a={};n.forEach(r=>{r.telefono&&(a[r.telefono]={telefono:r.telefono,nombre:r.nombre,fuente:"cliente"})}),o.forEach(r=>{a[r.telefono]||(a[r.telefono]={telefono:r.telefono,nombre:r.nombre||r.telefono,fuente:"whatsapp",etiqueta:r.etiqueta})});const i=Object.values(a);window._envioContactos=i,window._envioChats=o,window._envioClientes=n,t.innerHTML=`
          ...
          <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
            ...
            <div style="margin-bottom:1rem">
              ...
              <select id="envio-plantilla" class="form-input">
                ${e.map(r=>`<option value="${r.name}">${r.name}</option>`).join("")}
              </select>
            </div>
            <div style="margin-bottom:1rem">
    ...
    `,cargarProductosEnvio(),cargarProductosEnvioInteractivo()}catch(e){t.innerHTML='<p style="padding:2rem;color:red">Error: '+e.message+"</p>"}};window.filtrarAudienciaEnvio=()=>{const t=document.getElementById("envio-filtro").value,e=window._envioClientes||[],n=window._envioChats||[];let o=[];if(t==="todos"){const a={};e.forEach(i=>{i.telefono&&(a[i.telefono]={telefono:i.telefono,nombre:i.nombre,fuente:"cliente"})}),n.forEach(i=>{a[i.telefono]||(a[i.telefono]={telefono:i.telefono,nombre:i.nombre||i.telefono,fuente:"whatsapp"})}),o=Object.values(a)}else t==="clientes"?o=e.filter(a=>a.telefono).map(a=>({telefono:a.telefono,nombre:a.nombre,fuente:"cliente"})):t==="whatsapp"?o=n.map(a=>({telefono:a.telefono,nombre:a.nombre||a.telefono,fuente:"whatsapp"})):o=n.filter(a=>a.etiqueta===t).map(a=>({telefono:a.telefono,nombre:a.nombre||a.telefono,fuente:"whatsapp"}));window._envioContactos=o,document.getElementById("envio-count").textContent=o.length,document.getElementById("envio-lista").innerHTML=o.map(a=>`
    <div style="display:flex;align-items:center;gap:10px;padding:8px;background:#f9f9f9;border-radius:8px">
  ...
  </div>`,document.body.appendChild(n);try{const i=await(await fetch(g+"/chatbot/envio-productos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contactos:t.map(r=>({telefono:r.telefono,nombre:r.nombre})),skus:e,titulo:"Nuestros modelos 👠",cuerpo:"Mira los modelos disponibles. ¡Elige el tuyo!",pie:"Zapatillas May · León, Gto."})})).json();if(i.error){n.innerHTML=`<div style="background:white;border-radius:16px;padding:2.5rem;max-width:400px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
    ...
    `,document.body.appendChild(s),s.addEventListener("click",d=>{d.target===s&&s.remove()})}catch(o){console.error("Error verOportunidad",o)}};window.actualizarEtapaOportunidad=async(t,e)=>{var n;try{await fetch(g+"/crm/oportunidades/"+t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({etapa:e})}),(n=document.querySelector('div[style*="position:fixed"][style*="z-index:1000"]'))==null||n.remove(),mostrarPipeline()}catch{alert("Error actualizando etapa")}};window.completarTareaDashboard=async(t,e)=>{try{await fetch(g+"/chatbot/tareas/"+t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({completada:e})})}catch(n){console.error(n)}};async function ve(){const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:var(--text-muted)">Cargando...</p>';try{const n=await(await fetch(g+"/seo/config")).json(),o={};n.forEach(a=>o[a.clave]=a.valor||""),t.innerHTML=`
      <div style="max-width:800px">
        ...
        <div class="table-card" style="padding:2rem;margin-bottom:1rem">
          ...
          <div style="display:flex;gap:1rem;flex-wrap:wrap">
            <a href="${g}/tiktok/import-excel" target="_blank" download
            ...
            <a href="${g}/tiktok/stock-excel" target="_blank" download
