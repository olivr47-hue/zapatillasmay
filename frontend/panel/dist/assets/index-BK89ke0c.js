(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function o(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=o(n);fetch(n.href,i)}})();const f="/api",Ee=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],Ne=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],Re=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],te=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"carritos",icon:"🛒",label:"Carritos",section:"Ventas"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"envio",icon:"🚚",label:"Envíos",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"},{id:"catalogos",icon:"📖",label:"Catálogos",section:"Catalogo",soloAdmin:!0},{id:"orden-home",icon:"🏠",label:"Orden en Home",section:"Catalogo",soloAdmin:!0},{id:"mercadolibre",icon:"🛒",label:"MercadoLibre",section:"Integraciones",soloAdmin:!0},{id:"analytics",icon:"📊",label:"Google Analytics",section:"Integraciones",soloAdmin:!0},{id:"referidos",icon:"🎁",label:"Referidos",section:"Ventas",soloAdmin:!0},{id:"carritos-abandonados",icon:"🛒",label:"Carritos abandonados",section:"Ventas",soloAdmin:!0}];var $e;let K=(($e=window._empleadoActual)==null?void 0:$e.rol)==="admin"?"dashboard":"pos",ue=1;function _e(){var i,s;const e=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),t=((i=window._empleadoActual)==null?void 0:i.rol)==="admin"?"dashboard":"pos";K=e||t,document.querySelector("#app").innerHTML=`
  ...
  `,window.toggleSidebar=()=>{const r=document.getElementById("sidebar"),d=document.getElementById("sidebar-overlay"),l=r.classList.toggle("open");d.classList.toggle("active",l),document.body.style.overflow=l?"hidden":""},window._conversacionesInterval&&clearInterval(window._conversacionesInterval),window._conversacionesInterval=setInterval(async()=>{try{const d=await(await fetch(f+"/chatbot/chats")).json();window._chatsData||(window._chatsData={});const l=window._totalNoLeidos||0,c=d.reduce((p,m)=>p+(m.no_leidos||0),0);if(window._totalNoLeidos=c,d.forEach(p=>{window._chatsData&&(window._chatsData[p.telefono]=p)}),c>l){document.title=`(${c}) Zapatillas May`;const p=document.querySelector('[data-modulo="conversaciones"]');if(p){let m=p.querySelector(".nav-badge");m||(m=document.createElement("span"),m.className="nav-badge",m.style.cssText="background:#e91e8c;color:white;border-radius:100px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:auto",p.appendChild(m)),m.textContent=c}try{const m=new(window.AudioContext||window.webkitAudioContext),u=m.createOscillator(),g=m.createGain();u.connect(g),g.connect(m.destination),u.frequency.value=523,g.gain.setValueAtTime(.5,m.currentTime),g.gain.exponentialRampToValueAtTime(.001,m.currentTime+.2),u.start(m.currentTime),u.stop(m.currentTime+.2);const y=m.createOscillator(),b=m.createGain();y.connect(b),b.connect(m.destination),y.frequency.value=783,b.gain.setValueAtTime(.5,m.currentTime+.2),b.gain.exponentialRampToValueAtTime(.001,m.currentTime+.5),y.start(m.currentTime+.2),y.stop(m.currentTime+.5)}catch{}}if(window._chatActivo&&window._chatsData[window._chatActivo]){const p=window._chatsData[window._chatActivo],m=document.getElementById("mensajes-area");if(m){const u=m.scrollHeight-m.scrollTop<=m.clientHeight+50;m.innerHTML=[...p.mensajes].reverse().map(g=>{const y=g.tipo==="manual"||g.tipo==="imagen_saliente";return`
    ...
    `).join("")}
  `).join("")}async function Ce(e){var o;const t=document.getElementById("content");switch(t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>',e){case"catalogos":await fe();break;case"dashboard":t.innerHTML=Ge(),setTimeout(()=>Ye(),100);break;case"productos":await le();break;case"clientes":await Je();break;case"carritos":await ve();break;case"pedidos":await je(),(o=window._limpiarBadgePedidos)==null||o.call(window);break;case"sucursales":await Ue();break;case"inventario":await We();break;case"pos":await Pe();break;case"historial":await Be();break;case"empleados":await Ae();break;case"seo":await ot();break;case"envio":await tt();break;case"analisis":await Xe();break;case"crm":await ze();break;case"finanzas":await ae();break;case"proveedores":await ke();break;case"ordenes":await oe();break;case"conversaciones":await cargarConversaciones();break;case"envios":await cargarEnviosMasivos();break;case"mercadolibre":await nt();break;case"analytics":await rt();break;case"orden-home":await it();break;case"referidos":await ye();break;case"carritos-abandonados":await et();break}}function Ve(){return setTimeout(()=>{document.querySelectorAll(".nav-item").forEach(a=>a.classList.remove("active"));const e=document.querySelector('[data-modulo="'+K+'"]');e&&e.classList.add("active");const t=document.getElementById("topbar-title"),o=te.find(a=>a.id===K);t&&o&&(t.textContent=o.label),Ce(K)},100),'<div style="padding:2rem;color:#888;text-align:center">Cargando...</div>'}async function oe(){var t;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando sugerencias...</p>';try{const a=await(await fetch(f+"/sucursales/")).json(),n=(t=a[0])==null?void 0:t.id,[i,s]=await Promise.all([fetch(f+"/finanzas/sugerencias-recompra/"+n),fetch(f+"/finanzas/proveedores")]),r=await i.json(),d=await s.json(),l=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),c=new Date().toISOString().split("T")[0],p=r.filter(b=>{const h=l[b.producto_id];return h?h.hasta===null||h.hasta===void 0?!1:h.hasta<=c:!0}),m=r.length-p.length;window._ordenesData={sugerencias:p,proveedores:d,sucursalId:n},window._ordenSeleccion={};const u=p.filter(b=>b.urgente),g=p.filter(b=>!b.urgente),y=p.reduce((b,h)=>b+h.cantidad_sugerida*h.costo_unitario,0);e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;margin-bottom:1rem">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            ...
            <span style="font-weight:700;color:${(((v=n.semana)==null?void 0:v.neto)||0)>=0?"#2e7d32":"#c62828"};font-size:1.1rem">$${(((x=n.semana)==null?void 0:x.neto)||0).toFixed(0)}</span>
          </div>
        </div>
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
...
Diferencia: $${(n=s.diferencia)==null?void 0:n.toFixed(2)}`),ae()):alert("Error: "+JSON.stringify(s))}catch{alert("Error cerrando caja")}};window.agregarGasto=e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",t.innerHTML=`
  ...
  `,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()})};window.guardarProveedor=async e=>{const t={nombre:document.getElementById("prov-nombre").value,contacto:document.getElementById("prov-contacto").value,telefono:document.getElementById("prov-telefono").value,email:document.getElementById("prov-email").value,ciudad:document.getElementById("prov-ciudad").value,direccion:document.getElementById("prov-direccion").value,notas:document.getElementById("prov-notas").value};if(!t.nombre){alert("El nombre es requerido");return}try{e?await fetch(f+"/finanzas/proveedores/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):await fetch(f+"/finanzas/proveedores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),document.querySelector('div[style*="position:fixed"]').remove(),ke()}catch{alert("Error guardando proveedor")}};window.editarProveedor=async e=>{const a=(await(await fetch(f+"/finanzas/proveedores")).json()).find(n=>n.id===e);a&&mostrarFormProveedor(a)};async function Xe(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando análisis...</p>';try{const[t,o,a,n]=await Promise.all([fetch(f+"/productos/"),fetch(f+"/variantes/?activa=eq.true"),fetch(f+"/movimientos/"),fetch(f+"/inventario/slim")]),i=await t.json(),s=await o.json(),r=await a.json(),d=await n.json(),l={},c={};s.forEach(x=>{l[x.id]=x,c[x.producto_id]||(c[x.producto_id]=[]),c[x.producto_id].push(x.id)});const p={};d.forEach(x=>{p[x.variante_id]=(p[x.variante_id]||0)+x.cantidad});const m=new Date,u=new Date(m-30*24*60*60*1e3),g=new Date(m-60*24*60*60*1e3),y=new Date(m-90*24*60*60*1e3),b={};r.filter(x=>x.tipo==="venta").forEach(x=>{const E=l[x.variante_id];if(!E)return;const w=E.producto_id;b[w]||(b[w]={d30:0,d60:0,d90:0});const T=new Date(x.created_at),P=Math.abs(x.cantidad);T>=u&&(b[w].d30+=P),T>=g&&(b[w].d60+=P),T>=y&&(b[w].d90+=P)});const h=i.map(x=>{const E=b[x.id]||{d30:0,d60:0,d90:0},T=(c[x.id]||[]).reduce((C,S)=>C+(p[S]||0),0),P=E.d30/4,$=P>0?Math.round(T/P*7):null;let k="gris",A="Sin ventas recientes";return E.d30>=6?(k="verde",A="Rota bien — considerar resurtido"):E.d30>=2?(k="amarillo",A="Rotacion moderada"):E.d90===0&&T>0?(k="rojo",A="Sin movimiento en 90 dias — revisar"):E.d30>0&&(k="amarillo",A="Rotacion lenta"),{...x,ventas:E,stockTotal:T,ventasSemana:P,diasInventario:$,semaforo:k,recomendacion:A}}).sort((x,E)=>E.ventas.d30-x.ventas.d30),v={verde:{bg:"#e8f5e9",color:"#2e7d32",texto:"🟢 Rota bien"},amarillo:{bg:"#fff8e1",color:"#f57f17",texto:"🟡 Rotacion lenta"},rojo:{bg:"#ffebee",color:"#c62828",texto:"🔴 Sin movimiento"},gris:{bg:"#f5f5f5",color:"#888",texto:"⚪ Sin datos"}};e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:12px;margin-bottom:2rem">
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#E91E8C">${h.reduce((x,E)=>x+E.ventas.d30,0)}</p>
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#E91E8C">${h.reduce((x,E)=>x+E.ventas.d90,0)}</p>
          <p style="font-size:0.75rem;color:#aaa">pares</p>
        </div>
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
  ...
  <button class="btn btn-secondary" style="padding:4px 10px;font-size:0.75rem;background:#ffebee;border-color:#c62828;color:#c62828" onclick="filtrarRotacion('rojo')">🔴 Sin movimiento</button>
        ...
        <div id="rotacion-lista">
          ${h.map(x=>{const E=v[x.semaforo];return`
    ...
    `,window._rotacionData=h}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando análisis</p>'}}window.filtrarRotacion=e=>{document.querySelectorAll(".rotacion-item").forEach(t=>{t.style.display=e==="todos"||t.dataset.semaforo===e?"":"none"})};async function ze(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando CRM...</p>';try{const[t,o,a]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/"),fetch(f+"/crm/seguimientos/pendientes/todos")]),n=await t.json(),i=await o.json(),s=await a.json(),r=new Date,d=new Date(r-30*24*60*60*1e3),l=new Date(r-60*24*60*60*1e3),c=new Date(r-90*24*60*60*1e3),p=n.map(v=>{const x=i.filter(k=>k.cliente_id===v.id&&(k.status==="confirmado"||k.status==="pagado")),E=x.reduce((k,A)=>k+parseFloat(A.total||0),0),w=x.length>0?new Date(x[0].created_at):null,T=w?Math.floor((r-w)/(1e3*60*60*24)):null,P=x.filter(k=>new Date(k.created_at)>=d).length;let $="nuevo";return x.length===0?$="nuevo":E>=5e3&&P>=1?$="vip":T>90?$="inactivo":T>30?$="riesgo":P>=2?$="frecuente":$="activo",{...v,totalGastado:E,ultimoPedido:w,diasSinComprar:T,pedidos30:P,segmento:$,totalPedidos:x.length}}),m=p.filter(v=>v.segmento==="vip"),u=p.filter(v=>v.segmento==="riesgo").sort((v,x)=>x.totalGastado-v.totalGastado),g=p.filter(v=>v.segmento==="inactivo").sort((v,x)=>x.totalGastado-v.totalGastado),y=[...p].sort((v,x)=>x.totalGastado-v.totalGastado).slice(0,10),b=i.filter(v=>new Date(v.created_at).toDateString()===r.toDateString()&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,x)=>v+parseFloat(x.total||0),0),h=i.filter(v=>new Date(v.created_at)>=d&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,x)=>v+parseFloat(x.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
          ...
          ${s.length===0?'<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">Sin recordatorios pendientes 🎉</div>':s.slice(0,5).map(v=>{var x;return`
              <div style="padding:0.75rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:12px">
                <div style="flex:1">
...
⚠️ Requiere que los productos estén en el catálogo de Meta Commerce.`;else if(d.style.background="#e8f5e9",d.style.borderColor="#a5d6a7",d.style.color="#333",o){let y;t==="personalizado"?y=(((g=document.getElementById("texto-personalizado"))==null?void 0:g.value)||"").replace("{nombre}","María"):y=o.mensaje("María"),d.textContent=y}}const l=document.getElementById("campana-count");l&&(l.textContent=i.length+" clientes");const c=document.getElementById("campana-lista");if(c){if(!i.length){c.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No hay clientes en este segmento con teléfono registrado</div>';return}window._campanaFiltrados=i,window._campanaPlantillaId=t,c.innerHTML=i.map((y,b)=>{var E;let h;t==="personalizado"?h=(((E=document.getElementById("texto-personalizado"))==null?void 0:E.value)||"").replace("{nombre}",y.nombre.split(" ")[0]):h=o.mensaje(y.nombre.split(" ")[0]);const v=encodeURIComponent(h),x=(y.lada||"52")+y.telefono.replace(/\D/g,"");return`
    ...
    <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);text-align:center">
      ...
      <p style="font-size:0.82rem;color:#888">Conectando con WhatsApp Business</p>
        ...
        <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
          ...
          ${x>0&&((P=v.resultados)!=null&&P.length)?`
        ...
        </div>`};window._campanaJobId=g;const h=setInterval(async()=>{try{const x=await(await fetch(f+"/campanas/estado/"+g)).json();b(x),x.terminado&&(clearInterval(h),window._campanaUltimosResultados=x.resultados||[],setTimeout(()=>{const E=x.enviados||0,w=x.fallidos||0;l.innerHTML=`
              <div style="background:white;border-radius:16px;padding:2.5rem;max-width:400px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
                ...
                ${w>0?`
                  ...
                  <div style="background:#fff5f5;border-radius:8px;padding:0.75rem;margin-bottom:1rem;text-align:left;max-height:140px;overflow-y:auto">
                    ${x.resultados.filter(T=>!T.ok).map(T=>`
    ...
    `};window._campanaAvanzar=()=>{if(s++,s>=i.length){r.innerHTML=`
      ...
      `;return}d()},d(),document.body.appendChild(r)};async function Je(){const e=document.getElementById("content");try{const[t,o]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/")]),a=await t.json(),n=await o.json(),i=new Date,s=new Date(i-30*24*60*60*1e3),r=new Date(i-90*24*60*60*1e3),d=a.map(u=>{const g=n.filter(P=>P.cliente_id===u.id&&(P.status==="confirmado"||P.status==="pagado")),y=g.reduce((P,$)=>P+parseFloat($.total||0),0),b=g.length>0?new Date(g[0].created_at):null,h=g.filter(P=>new Date(P.created_at)>=s).length,v=b?Math.floor((i-b)/(1e3*60*60*24)):null;let x="nuevo",E="⚪ Nuevo",w="#f5f5f5",T="#888";return g.length===0?(x="nuevo",E="⚪ Sin compras",w="#f5f5f5",T="#888"):y>=5e3&&h>=1?(x="vip",E="⭐ VIP",w="#fff8e1",T="#f57f17"):v>90?(x="inactivo",E="🔴 Inactivo",w="#ffebee",T="#c62828"):v>30?(x="riesgo",E="🟡 En riesgo",w="#fff8e1",T="#f57f17"):h>=2?(x="frecuente",E="🟢 Frecuente",w="#e8f5e9",T="#2e7d32"):(x="activo",E="🔵 Activo",w="#e3f2fd",T="#1565c0"),{...u,totalGastado:y,ultimoPedido:b,pedidos30:h,diasSinComprar:v,segmento:x,segmentoLabel:E,segmentoBg:w,segmentoColor:T,totalPedidos:g.length}}).sort((u,g)=>g.totalGastado-u.totalGastado),l=d.filter(u=>u.segmento==="vip").length,c=d.filter(u=>u.segmento==="inactivo").length,p=d.filter(u=>u.segmento==="riesgo").length,m=d.filter(u=>u.segmento==="frecuente"||u.segmento==="activo").length;window._clientesData=d,e.innerHTML=`
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
  ...
  <div style="margin-bottom:1.5rem">
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">
      ...
      <select class="form-input" id="inv-talla" style="min-width:100px" onchange="renderInventario()">
        ...
        ${Ee.map(c=>`<option value="${c}">${c}</option>`).join("")}
      </select>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div>
          ...
          <select class="form-input" id="f-categoria" required onchange="actualizarSKU()">
            ...
            ${Re.map(a=>`<option value="${a.value}" ${t.categoria===a.value?"selected":""}>${a.label}</option>`).join("")}
          </select>
        </div>
        <div>
...
${o.telefono?'<a href="https://wa.me/'+(o.lada||"52")+o.telefono.replace(/\D/g,"")+'" target="_blank" class="btn btn-secondary" style="background:#25D366;color:white;border-color:#25D366;margin-left:auto">WhatsApp</a>':""}      </div>
  ...
  `};window.guardarCliente=async e=>{const t=document.getElementById("cli-nombre").value;if(!t){alert("El nombre del cliente es obligatorio");return}const o=document.getElementById("btn-cli-guardar");o&&(o.textContent="Guardando...",o.disabled=!0);const a={nombre:t,telefono:document.getElementById("cli-telefono").value||null,email:document.getElementById("cli-email").value||null,tipo:document.getElementById("cli-tipo").value,direccion:document.getElementById("cli-direccion").value||null,lada:document.getElementById("cli-lada").value||"52",ciudad:document.getElementById("cli-ciudad").value||null,estado:document.getElementById("cli-estado").value||null,codigo_postal:document.getElementById("cli-cp").value||null,limite_credito:parseFloat(document.getElementById("cli-credito").value)||0,dias_credito:parseInt(document.getElementById("cli-dias").value)||0,comentarios_internos:document.getElementById("cli-comentarios").value||null,activo:!0};try{const n=e?"PATCH":"POST",i=e?f+"/clientes/"+e:f+"/clientes/",s=await fetch(i,{method:n,headers:{"Content-Type":"application/json"},body:JSON.stringify(a)});if(s.ok)alert("Cliente guardado correctamente"),navegarA("clientes");else{const r=await s.text();alert("Error al guardar: "+r),o&&(o.textContent="Guardar cliente",o.disabled=!1)}}catch{alert("Error conectando con el servidor"),o&&(o.textContent="Guardar cliente",o.disabled=!1)}};window.verCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[o,a]=await Promise.all([fetch(f+"/clientes/"+e),fetch(f+"/pedidos/")]),n=await o.json(),i=await a.json();if(!n||n.length===0){alert("Cliente no encontrado");return}const s=n[0],r=i.filter(g=>g.cliente_id===e),d=r.filter(g=>g.status==="confirmado"||g.status==="pagado"),l=d.reduce((g,y)=>g+parseFloat(y.total||0),0),c=d.length>0?l/d.length:0,p=r.length>0?new Date(r[0].created_at):null,m=p?Math.floor((new Date-p)/(1e3*60*60*24)):null,u={};d.forEach(g=>{const y=new Date(g.created_at).toLocaleDateString("es-MX",{month:"short",year:"2-digit"});u[y]=(u[y]||0)+parseFloat(g.total||0)}),t.innerHTML=`
    ...
    `}catch{t.innerHTML='<p style="padding:2rem;color:red">Error cargando cliente</p>'}};window.guardarNotasCliente=async e=>{var o;const t=((o=document.getElementById("cli-notas-"+e))==null?void 0:o.value)||"";try{await fetch(f+"/clientes/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({comentarios_internos:t})});const a=document.querySelector(`button[onclick="guardarNotasCliente('${e}')"]`);a&&(a.textContent="✅ Guardado",setTimeout(()=>a.textContent="💾 Guardar notas",2e3))}catch{alert("Error guardando notas")}};window.editarCliente=e=>{mostrarFormCliente(e)};window.nuevoPedidoCliente=async(e,t)=>{await Pe(),setTimeout(()=>{const o=document.getElementById("pos-cliente-buscar"),a=document.getElementById("pos-cliente"),n=document.getElementById("pos-cliente-seleccionado");o&&(o.value=""),a&&(a.value=e),n&&(n.textContent="✔ "+t+" — toca para cambiar",n.style.display="block");const i=document.getElementById("topbar-title");i&&(i.textContent="Punto de venta")},300)};window.verHistorialCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando historial...</p>';try{const n=(await(await fetch(f+"/pedidos/")).json()).filter(r=>r.cliente_id===e),i=n.length>0&&n[0].clientes?n[0].clientes:{},s=n.filter(r=>r.status==="confirmado"||r.status==="pagado").reduce((r,d)=>r+parseFloat(d.total||0),0);t.innerHTML=`
      <div class="table-card" style="padding:2rem">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;flex-wrap:wrap">
          <button class="btn btn-secondary" onclick="navegarA('clientes')">← Volver</button>
  ...
  `};window.guardarSalida=async()=>{const e=document.getElementById("sal").value,t=document.getElementById("sal-sucursal").value,o=document.getElementById("sal-cantidad").value,a=document.getElementById("sal-motivo").value;if(!e||!t||!o){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(f+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:-parseInt(o),motivo:a})})).json();i.ok?(alert("Salida registrada. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const o=await(await fetch(f+"/sucursales/")).json(),n=await(await fetch(f+"/productos/")).json(),s=await(await fetch(f+"/variantes/")).json(),d=await(await fetch(f+"/inventario/")).json(),l=[...new Set(n.map(p=>p.categoria).filter(Boolean))],c=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:o,productos:n,variantes:s,inventario:d},e.innerHTML=`
    ...
    `,renderTablasMasivo()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:e,variantes:t,inventario:o}=window._invMasivo,a=document.getElementById("im-sucursal").value,n=document.getElementById("im-categoria").value,i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],s=e.filter(c=>!(n&&c.categoria!==n)),r=o.filter(c=>c.sucursal_id===a),d=s.map(c=>{const p=t.filter(g=>g.producto_id===c.id);if(p.length===0)return"";const u=[...new Set(p.map(g=>g.color).filter(Boolean))].map(g=>{const y=p.filter(h=>h.color===g).sort((h,v)=>i.indexOf(h.talla)-i.indexOf(v.talla));return`
        <div style="margin-bottom:1rem">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap">
            ${y.map(h=>{const v=r.find(T=>T.variante_id===h.id),x=v?v.cantidad:0,E=v?v.stock_minimo:3;let w="#ddd";return x===0?w="#ffcdd2":x<=E?w="#ffe082":w="#a5d6a7",`
                <div style="text-align:center">
  ...
  `,document.body.appendChild(c),c.addEventListener("click",p=>{p.target===c&&c.remove()}),window._posSeleccion={productoId:e,color:null},window._posBuffer={}};window.mostrarCorridaModalPOS=e=>{const{variantes:t,inventario:o}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=o.filter(p=>p.sucursal_id===a),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],s=[...new Set(t.filter(p=>p.producto_id===e).map(p=>p.color).filter(Boolean))],r=document.querySelector(`button[onclick="mostrarCorridaModalPOS('${e}')"]`);r&&(r.style.display="none"),document.querySelectorAll("#pos-modal").forEach(p=>{p!==document.getElementById("pos-modal")&&p.remove()}),window._posSeleccion.color=null,window._corridaCantidades={};const d=document.getElementById("pos-tallas-panel");if(!d)return;const l=p=>{const m=t.filter(u=>u.producto_id===e&&u.color===p).sort((u,g)=>i.indexOf(u.talla)-i.indexOf(g.talla));m.filter(u=>{const g=n.find(y=>y.variante_id===u.id);return g&&g.cantidad>0}),d.innerHTML=`
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:16px">
        ${s.map(u=>{const g=t.find(v=>v.producto_id===e&&v.color===u),y=g?g.color_hex:"#888",b=g?g.foto_url:null,h=Object.entries(window._corridaCantidades).filter(([v])=>t.find(x=>x.id===v&&x.color===u)).reduce((v,[,x])=>v+x,0);return`
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
        ...
        </tr>`}).join(""))};async function Ye(){try{const t=await(await fetch(f+"/pedidos/")).json(),a=await(await fetch(f+"/clientes/")).json(),i=await(await fetch(f+"/inventario/alertas")).json(),s=new Date;s.setHours(0,0,0,0);const r=new Date(s);r.setDate(r.getDate()-7);const d=new Date(s);d.setDate(d.getDate()-30);const l=t.filter(_=>["confirmado","pagado","enviado"].includes(_.status)),c=l.filter(_=>new Date(_.created_at)>=s),p=l.filter(_=>new Date(_.created_at)>=r),m=c.reduce((_,B)=>_+parseFloat(B.total||0),0),u=p.reduce((_,B)=>_+parseFloat(B.total||0),0),g=a.filter(_=>_.created_at&&new Date(_.created_at)>=d).length,y=["Dom","Lun","Mar","Mie","Jue","Vie","Sab"],b={};y.forEach(_=>b[_]=0),l.filter(_=>new Date(_.created_at)>=d).forEach(_=>{const B=y[new Date(_.created_at).getDay()];b[B]+=parseFloat(_.total||0)});const h={};l.forEach(_=>{h[_.canal||"sucursal"]=(h[_.canal||"sucursal"]||0)+parseFloat(_.total||0)});const v={};l.forEach(_=>{v[_.forma_pago||"efectivo"]=(v[_.forma_pago||"efectivo"]||0)+1});const x={};l.forEach(_=>{x[_.empleado||"Admin"]=(x[_.empleado||"Admin"]||0)+parseFloat(_.total||0)});const E={};l.forEach(_=>{const B=new Date(_.created_at).toLocaleDateString("es-MX",{month:"short",year:"numeric"});E[B]=(E[B]||0)+parseFloat(_.total||0)});const w={};l.forEach(_=>{_.clientes&&(w[_.clientes.nombre]=(w[_.clientes.nombre]||0)+parseFloat(_.total||0))});const T=Object.entries(w).sort((_,B)=>B[1]-_[1]).slice(0,5),P=Object.entries(b).sort((_,B)=>B[1]-_[1])[0],$=Object.entries(x).sort((_,B)=>B[1]-_[1])[0];if(!document.getElementById("dashboard-contenido"))return;const A=l.filter(_=>new Date(_.created_at)>=d),C=A.reduce((_,B)=>_+parseFloat(B.total||0),0),S=[];for(let _=6;_>=0;_--){const B=new Date(s);B.setDate(B.getDate()-_);const O=B.toISOString().split("T")[0],L=B.toLocaleDateString("es-MX",{weekday:"short",day:"numeric"}),H=l.filter(D=>{var M;return(M=D.created_at)==null?void 0:M.startsWith(O)}).reduce((D,M)=>D+parseFloat(M.total||0),0);S.push({label:L,total:H,ds:O})}const I=(_,B,O,L)=>{const H=document.getElementById(_),D=document.getElementById(_+"-sub");H&&(H.textContent=B,L&&(H.style.color=L)),D&&O&&(D.textContent=O)};I("kpi-ventas-hoy","$"+m.toLocaleString("es-MX",{maximumFractionDigits:0}),c.length+" pedidos","#C8967A"),I("kpi-pedidos-hoy",c.length,"confirmados"),I("kpi-ventas-7d","$"+u.toLocaleString("es-MX",{maximumFractionDigits:0}),p.length+" pedidos"),I("kpi-ventas-30d","$"+C.toLocaleString("es-MX",{maximumFractionDigits:0}),A.length+" pedidos"),I("kpi-clientes-nuevos",g,"últimos 30 días"),I("kpi-stock-bajo",i.length,i.length>0?"⚠ reabastecer":"✓ ok",i.length>0?"#f59e0b":"#10b981"),I("kpi-mejor-dia",P?P[0]:"—",P?"$"+P[1].toLocaleString("es-MX",{maximumFractionDigits:0}):""),I("kpi-total-clientes",a.length,"registrados");const z=document.getElementById("dash-top-clientes");z&&(z.innerHTML=T.length===0?'<p style="color:var(--text-muted);font-size:0.85rem">Sin datos aun</p>':T.map(([_,B],O)=>`
        ...
        </div>`}).join("")),setTimeout(()=>{const _="#C8967A",B="#b5687a",O="#d4b8a8",L="#8B6A54",H=["rgba(200,150,122,0.75)","rgba(181,104,122,0.75)","rgba(139,106,84,0.75)","rgba(212,184,168,0.75)","rgba(160,120,96,0.75)","rgba(90,60,40,0.75)"],D=["#C8967A","#b5687a","#8B6A54","#d4b8a8","#a07060","#5a3c28"],M={ticks:{color:"#C4A38A",font:{size:10}},grid:{color:"rgba(200,150,122,0.08)"}},R={responsive:!0,plugins:{legend:{labels:{color:"#8B6A54",font:{size:11}}}},scales:{x:M,y:M}},F=document.getElementById("chart-tendencia");F&&window.Chart&&new Chart(F,{type:"line",data:{labels:S.map(q=>q.label),datasets:[{data:S.map(q=>q.total),borderColor:_,backgroundColor:"rgba(200,150,122,0.10)",borderWidth:2.5,pointBackgroundColor:_,pointBorderColor:"white",pointBorderWidth:2,pointRadius:5,pointHoverRadius:7,fill:!0,tension:.4}]},options:{...R,plugins:{legend:{display:!1},tooltip:{callbacks:{label:q=>" $"+q.parsed.y.toLocaleString("es-MX",{maximumFractionDigits:0})}}}}});const N=document.getElementById("chart-dias");N&&window.Chart&&new Chart(N,{type:"bar",data:{labels:y,datasets:[{data:y.map(q=>b[q]||0),backgroundColor:H,borderColor:D,borderWidth:1.5,borderRadius:6}]},options:{...R,plugins:{legend:{display:!1}}}});const G=document.getElementById("chart-canales");G&&window.Chart&&Object.keys(h).length>0&&new Chart(G,{type:"doughnut",data:{labels:Object.keys(h),datasets:[{data:Object.values(h),backgroundColor:H,borderColor:D,borderWidth:2}]},options:{responsive:!0,cutout:"68%",plugins:{legend:{position:"bottom",labels:{color:"#8B6A54",font:{size:11},padding:10}}}}});const V=document.getElementById("chart-meses");if(V&&window.Chart){const q=Object.entries(E).slice(-6);new Chart(V,{type:"line",data:{labels:q.map(([U])=>U),datasets:[{data:q.map(([,U])=>U),borderColor:B,backgroundColor:"rgba(181,104,122,0.08)",borderWidth:2,pointBackgroundColor:B,pointBorderColor:"white",pointBorderWidth:2,pointRadius:4,fill:!0,tension:.4}]},options:{...R,plugins:{legend:{display:!1}}}})}const J=document.getElementById("chart-pagos");J&&window.Chart&&Object.keys(v).length>0&&new Chart(J,{type:"doughnut",data:{labels:Object.keys(v),datasets:[{data:Object.values(v),backgroundColor:H,borderColor:D,borderWidth:2}]},options:{responsive:!0,cutout:"68%",plugins:{legend:{position:"bottom",labels:{color:"#8B6A54",font:{size:11},padding:10}}}}})},300);try{const B=await(await fetch(f+"/chatbot/tareas-hoy")).json(),O=document.createElement("div");O.style.cssText="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem;margin-top:1.5rem",O.innerHTML=`
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem">
      ...
      ${B.length===0?'<p style="color:#aaa;font-size:0.85rem;text-align:center;padding:1rem">Sin tareas pendientes</p>':B.map(L=>`
        ...
        `).join("")}
    `,document.getElementById("dashboard-contenido").appendChild(O)}catch(_){console.error("tareas:",_)}}catch(e){console.error("Error dashboard:",e)}}window.eliminarItemPedido=e=>{window._pedidoItems.splice(e,1),window.recalcularTotal(),window.renderItemsPedido()};window.cerrarSesionPanel=()=>{confirm("Cerrar sesion?")&&(sessionStorage.removeItem("erp_empleado"),sessionStorage.removeItem("erp_token"),window._empleadoActual=null,location.reload())};async function Ae(){const e=document.getElementById("content");try{const o=await(await fetch(f+"/empleados/",{headers:window.authHeaders()})).json();e.innerHTML=`
      <div class="table-card">
        <div class="table-header">
      ...
      <div id="wa-sidebar">
        <div class="wa-sidebar-header">
          <div class="wa-sidebar-title">
            <span>💬 WhatsApp</span>
            <span class="wa-new-badge">${r} nuevo${r!==1?"s":""}</span>
          </div>
...
`).trim();if(n.match(/^https?:\/\/.+\.(jpg|jpeg|png|webp|gif)/i))return'<img src="'+n+'" style="max-width:200px;border-radius:8px;display:block">'+(i?'<p style="font-size:0.82rem;color:#333;white-space:pre-wrap;margin-top:6px">'+i+"</p>":"")}return'<p style="font-size:0.85rem;color:#333;white-space:pre-wrap">'+e.mensaje.replace(/\[.+?\]:\s*/,"")+"</p>"};window.abrirChat=async e=>{const t=window._chatsData[e];if(!t)return;document.querySelectorAll(".wa-chat-item").forEach(i=>i.classList.remove("activo"));const o=document.querySelector(`[data-tel="${e}"]`);o&&o.classList.add("activo");const a=window.innerWidth<=900;if(a){const i=document.getElementById("wa-sidebar"),s=document.getElementById("wa-container");i&&(i.style.display="none"),s&&(s.style.gridTemplateColumns="1fr")}const n=document.getElementById("chat-area");n.style.display="flex",n.style.flexDirection="column",n.style.flex="1",n.style.minHeight="0",n.innerHTML=`
    ...
    <div id="mensajes-area">
      ${[...t.mensajes].reverse().map(i=>{var p;const s=i.tipo==="manual"||i.tipo==="imagen_saliente",r=s?((p=i.mensaje.match(/\[(.+?)\]:/))==null?void 0:p[1])||"Admin":t.nombre||t.telefono,d=i.tipo==="imagen_saliente"?i.mensaje.replace(/\[.+?\]:\s*\[Imagen\]\s*/,"").split(`
`)[0].trim():"",l=i.tipo==="imagen_saliente"&&d.match(/^https?:\/\/.+\.(jpg|jpeg|png|webp|gif)/i)?'<img src="'+d+'" style="max-width:200px;border-radius:8px;display:block">':"<p>"+i.mensaje.replace(/\[.+?\]:\s*/,"")+"</p>",c=new Date(i.created_at).toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"});return`
    ${i.mensaje?`
      <div class="wa-msg-row ${s?"saliente":"entrante"}">
        <span class="wa-msg-sender">${s?"👤 "+r:r}</span>
        <div class="wa-bubble ${s?"saliente":"entrante"}">${l}<div class="wa-bubble-time">${c}</div></div>
      </div>`:""}
    ${i.respuesta?`
...
`);await fetch(f+"/chatbot/chats/"+e+"/imagen",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:t,caption:d,agente:n})})}else await fetch(f+"/chatbot/chats/"+e+"/mensaje",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mensaje:o,agente:n})});await new Promise(d=>setTimeout(d,1500));const r=await(await fetch(f+"/chatbot/chats")).json();window._chatsData={},r.forEach(d=>window._chatsData[d.telefono]=d),abrirChat(e)}catch{alert("Error enviando producto")}};window.cargarEnviosMasivos=async function(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[t,o]=await Promise.all([fetch(f+"/chatbot/plantillas").then(r=>r.json()),fetch(f+"/clientes/").then(r=>r.json())]);if(t.error){e.innerHTML=`<div style="padding:2rem;color:#c62828;background:#ffebee;border-radius:12px;margin:1rem">
      ...
      <div style="max-width:960px">
        <div style="margin-bottom:1.5rem;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px">
          <div>
            ...
            <p style="color:#888;font-size:0.85rem">Plantillas aprobadas por Meta · ${n.length} clientes con teléfono</p>
          </div>
    ...
    `,cargarProductosEnvio(),cargarProductosEnvioInteractivo();const s=document.querySelector('input[name="envio-plantilla-radio"]');s&&(s.checked=!0,onCambiarPlantillaEnvio(s.value,s.dataset.idioma))}catch(t){e.innerHTML='<p style="padding:2rem;color:red">Error: '+t.message+"</p>"}};window.ejecutarDebugPlantillas=async()=>{const e=document.getElementById("diag-resultado");if(e){e.style.display="block",e.textContent="Consultando estructura...";try{const o=await(await fetch(f+"/chatbot/plantillas-debug")).json();e.textContent=JSON.stringify(o,null,2)}catch(t){e.textContent="Error: "+t.message}}};window.ejecutarDiagnostico=async()=>{var i,s;const e=(((i=document.getElementById("diag-tel"))==null?void 0:i.value)||"").trim(),t=document.querySelector('input[name="envio-plantilla-radio"]:checked'),o=(t==null?void 0:t.value)||"",a=((s=t==null?void 0:t.dataset)==null?void 0:s.idioma)||"es_MX",n=document.getElementById("diag-resultado");if(n){n.style.display="block",n.textContent="Consultando...";try{const d=await(await fetch(f+"/chatbot/wa-diagnostico",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({telefono:e,plantilla:o,idioma:a})})).json();n.textContent=JSON.stringify(d,null,2)}catch(r){n.textContent="Error: "+r.message}}};window.onCambiarPlantillaEnvio=(e,t)=>{window._envioPlantillaActual={nombre:e,idioma:t};const a=(window._envioPlantillas||[]).find(b=>b.name===e),n=document.getElementById("plantilla-preview-box"),i=document.getElementById("plantilla-preview-burbuja");if(!n||!i||!a)return;const s=[],r=(a.components||[]).find(b=>b.type==="HEADER"),d=(a.components||[]).find(b=>b.type==="BODY"),l=(a.components||[]).find(b=>b.type==="FOOTER"),c=(a.components||[]).find(b=>b.type==="BUTTONS"),p=((c==null?void 0:c.buttons)||[]).some(b=>b.sub_type==="MPM"||b.type==="MPM"||a.sub_category==="MULTI_PRODUCT_MESSAGE");(r==null?void 0:r.format)==="IMAGE"&&s.push("🖼️ [Imagen del producto]"),r!=null&&r.text&&s.push(`*${r.text}*`),d!=null&&d.text&&s.push(d.text),l!=null&&l.text&&s.push(`_${l.text}_`),p&&s.push("🛍️ [Catálogo de productos — selecciona abajo]"),i.textContent=s.join(`

`)||"(sin contenido)",n.style.display="block";const m=document.getElementById("envio-seccion-foto");if(m){m.style.display="block";const b=m.querySelector("p");b&&(b.innerHTML=p?'<span style="font-weight:700;font-size:0.9rem">2️⃣ Foto de portada del catálogo</span> <span style="font-weight:400;color:#aaa;font-size:0.78rem">(imagen principal que verá el cliente)</span>':'<span style="font-weight:700;font-size:0.9rem">2️⃣ Foto del modelo</span> <span style="font-weight:400;color:#aaa;font-size:0.78rem">(opcional — para plantillas con imagen)</span>')}const u=document.getElementById("envio-mpm-aviso");u&&(u.style.display=p?"block":"none"),window._envioEsMPM=p,window._envioHeaderTipo=(r==null?void 0:r.format)||(r!=null&&r.text?"TEXT":"NONE");const g=((d==null?void 0:d.text)||"").match(/\{\{\d+\}\}/g)||[];window._envioBodyVarsCount=g.length;const y=document.getElementById("envio-seccion-foto");y&&(y.style.display=window._envioHeaderTipo==="IMAGE"?"block":"none"),document.querySelectorAll('input[name="envio-plantilla-radio"]').forEach(b=>{const h=b.closest("label");h&&(h.style.borderColor=b.value===e?"#E91E8C":"#eee",h.style.background=b.value===e?"#fff0f8":"")})};const Me=e=>{const t=document.getElementById("envio-lista");t&&(t.innerHTML=e.map(o=>{var i;const a=(i=window._envioSeleccionados)==null?void 0:i.has(o.telefono),n=o.telefono.replace(/\D/g,"");return`<label style="display:flex;align-items:center;gap:10px;padding:8px 10px;border-radius:8px;cursor:pointer;border:1.5px solid ${a?"#E91E8C":"#f0f0f0"};background:${a?"#fff0f8":"white"}" id="envio-row-${n}">
...
<div>
  ...
  <div style="display:flex;gap:1rem;flex-wrap:wrap">
    ...
    </div>`,a==="seleccionar"&&Le(e),a==="generar"&&Oe(e)}window.switchTabCat=function(e){const{catalogoId:t}=window._catalogoPaginasData;window._catalogoPaginasData.tabActiva=e,document.querySelectorAll("#tab-subir,#tab-seleccionar,#tab-generar").forEach(o=>o.style.display="none"),document.getElementById("tab-"+e).style.display="block",document.querySelectorAll('[onclick^="switchTabCat"]').forEach(o=>{var n;const a=(n=o.getAttribute("onclick").match(/'(\w+)'/))==null?void 0:n[1];o.style.borderBottomColor=a===e?"#C8967A":"transparent",o.style.color=a===e?"#C8967A":"#6b7280"}),e==="seleccionar"&&Le(t),e==="generar"&&Oe(t)};window.descargarCatalogoPDF=async function(){const e=window._catalogoPaginasData;if(!e)return;const{portada_url:t,paginas:o,nombre:a}=e,n=[];if(t&&n.push(t),[...o].sort((r,d)=>r.pagina_numero-d.pagina_numero).forEach(r=>{r.imagen_url&&n.push(r.imagen_url)}),n.length===0){alert("No hay páginas para descargar.");return}const s=document.querySelector('[onclick="descargarCatalogoPDF()"]');s&&(s.disabled=!0,s.textContent="⏳ Generando PDF...");try{window.jspdf||await new Promise((b,h)=>{const v=document.createElement("script");v.src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js",v.onload=b,v.onerror=h,document.head.appendChild(v)});const{jsPDF:r}=window.jspdf,d=b=>new Promise(h=>{const v=new Image;v.crossOrigin="anonymous",v.onload=()=>{const x=document.createElement("canvas");x.width=v.naturalWidth||v.width,x.height=v.naturalHeight||v.height,x.getContext("2d").drawImage(v,0,0),h({dataUrl:x.toDataURL("image/jpeg",.92),w:x.width,h:x.height})},v.onerror=()=>h(null),v.src=b}),c=(await Promise.all(n.map(d))).filter(Boolean);if(c.length===0){alert("No se pudieron cargar las imágenes. Revisa tu conexión.");return}const p=210,m=280,u=new r({unit:"mm",format:[p,m]}),g=(b,h)=>{h||u.addPage([p,m]);const v=b.w/b.h,x=p/m;let E,w,T,P;v>x?(E=p,w=p/v,T=0,P=(m-w)/2):(w=m,E=m*v,P=0,T=(p-E)/2),u.addImage(b.dataUrl,"JPEG",T,P,E,w)};c.forEach((b,h)=>g(b,h===0));const y=(a||"catalogo").replace(/[^a-zA-Z0-9_\-áéíóúñÁÉÍÓÚÑ ]/g,"").trim()||"catalogo";u.save(`${y}.pdf`)}catch(r){console.error("Error generando PDF:",r),alert("Error al generar el PDF: "+r.message)}finally{s&&(s.disabled=!1,s.innerHTML="📥 Descargar PDF")}};async function Le(e){const t=document.getElementById("selector-tienda-content");if(t)try{const[o,a]=await Promise.all([fetch(f+"/variantes/"),fetch(f+"/productos/")]),n=await o.json(),i=await a.json(),s=[];n.forEach(d=>{const l=i.find(p=>p.id===d.producto_id),c=(l==null?void 0:l.nombre)||d.sku||"";d.foto_url&&s.push({url:d.foto_url,nombre:c,color:d.color||""}),d.imagenes&&Array.isArray(d.imagenes)&&d.imagenes.forEach(p=>{p&&p!==d.foto_url&&s.push({url:p,nombre:c,color:d.color||""})})});const r=s.filter((d,l,c)=>c.findIndex(p=>p.url===d.url)===l);window._selectorFotos={fotos:r,seleccionadas:new Set},t.innerHTML=`
...
`,(v=h.causas)!=null&&v.length&&h.causas.forEach(x=>{b+=`    ↳ ${x.code}: ${x.message}
`})})),n.textContent=b}}catch(m){n.style.display="block",n.textContent="Error inesperado: "+m.message}finally{t.innerHTML=i,t.disabled=!1}}window.mlPublicarPreview=function(e){De(!0,e)};window.mlPublicarReal=function(e){confirm("¿Publicar TODAS las variantes activas de este producto en MercadoLibre? Esto creará nuevos items en tu cuenta.")&&De(!1,e)};window.descargarExcelTikTok=async function(e,t,o){const a=e.innerHTML;try{e.innerHTML="⏳ Generando...",e.disabled=!0;const n=await fetch(`${f}/tiktok/${t}`);if(!n.ok){const d=await n.text();throw new Error(`Error ${n.status}: ${d}`)}const i=await n.blob(),s=URL.createObjectURL(i),r=document.createElement("a");r.href=s,r.download=o,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(s)}catch(n){alert("Error al descargar el archivo: "+n.message)}finally{e.innerHTML=a,e.disabled=!1}};async function nt(){const e=document.getElementById("content");e.innerHTML=`
  ...
  `,document.getElementById("ml-titulo").addEventListener("input",function(){document.getElementById("ml-titulo-count").textContent=this.value.length}),window.mlGenerarPreview=async()=>{var d,l,c,p;const o=document.getElementById("ml-sku").value.trim().toUpperCase(),a=document.getElementById("ml-listing").value,n=document.getElementById("ml-titulo").value.trim(),i=document.getElementById("ml-precio").value.trim(),s=i?parseFloat(i):null;if(!o){alert("Ingresa el SKU del producto");return}if(!n){alert("Ingresa el título para ML");return}if(n.length>60){alert("El título no puede superar 60 caracteres");return}if(s!==null&&(isNaN(s)||s<=0)){alert("El precio debe ser mayor a 0");return}const r=document.getElementById("ml-btn-preview");r.textContent="⏳ Generando...",r.disabled=!0;try{const m=await fetch(`${f}/ml/publicar`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sku_interno:o,listing_type:a,solo_preview:!0})}),u=await m.json();if(!m.ok){alert("Error: "+(u.detail||JSON.stringify(u)));return}const g=u.resultados||[];if(!g.length){alert("No se encontraron variantes activas");return}const y=document.getElementById("ml-descripcion"),b=((c=(l=(d=g[0])==null?void 0:d.preview)==null?void 0:l.description)==null?void 0:c.plain_text)||"";y.value.trim()||(y.value=b);const h={},v=[],x=new Set;for(const k of g){const A=k.color||"Sin color";h[A]||(h[A]=[]);for(const C of((p=k.preview)==null?void 0:p.pictures)||[])C.source&&(h[A].find(S=>S.source===C.source)||h[A].push(C),x.has(C.source)||(x.add(C.source),v.push(C)))}const E={},w=new Set;for(const k of Object.keys(h))E[k]=0,w.add(k);const T=Object.keys(h);if(T.length>0){const k=document.getElementById("ml-fotos-wrap"),A=document.getElementById("ml-fotos-grid"),C=()=>{S();const I=g.filter(z=>w.has(z.color||"Sin color"));t(I,n,s,E,y.value.trim(),h)},S=()=>{A.innerHTML=T.map(I=>{const z=h[I];if(!z.length)return"";const j=w.has(I),_=I.replace(/'/g,"\\'"),B=I.replace(/[^a-zA-Z0-9]/g,"_");return`
      ...
      `).join("")||'<p style="color:#888">Sin detalles</p>'}catch(l){r.textContent="❌ Error de conexión",d.innerHTML=`<p style="color:red">${l.message}</p>`}finally{i.textContent="🚀 Publicar todas en ML",i.disabled=!1}}}let X=[],Q="";async function it(){const e=document.getElementById("content");e.innerHTML=`
    <style>
  ...
  `,await st(),Y=setInterval(async()=>{document.getElementById("ga-activos")?await Fe():(clearInterval(Y),Y=null)},3e4)}async function be(e,t=8e3){const o=new AbortController,a=setTimeout(()=>o.abort(),t);try{const n=await fetch(e,{signal:o.signal});return clearTimeout(a),n}catch(n){throw clearTimeout(a),n.name==="AbortError"?new Error("timeout"):n}}async function st(){const e=[Fe().catch(()=>me("ga-activos","—")),dt().catch(()=>me("ga-sesiones","—")),lt().catch(()=>me("ga-chart",null))];await Promise.allSettled(e);const t=document.getElementById("ga-ultima-act");t&&(t.textContent="Actualizado: "+new Date().toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit",second:"2-digit"}))}function me(e,t){const o=document.getElementById(e);o&&t!==null&&(o.textContent=t)}async function Fe(){var e;try{const o=await(await be(`${f}/analytics/tiempo-real`)).json();if(!o.configurado){ct(o);return}const a=document.getElementById("ga-activos");if(!a)return;a.textContent=o.activos_ahora??0;const n=document.getElementById("ga-dispositivos");n&&o.por_dispositivo&&(n.textContent=Object.entries(o.por_dispositivo).map(([s,r])=>`${s}: ${r}`).join(" · "));const i=document.getElementById("ga-paginas-rt");i&&((e=o.por_pais)!=null&&e.length)?i.innerHTML='<div style="font-size:0.65rem;color:#aaa;margin-bottom:4px;text-transform:uppercase;letter-spacing:.05em">Por país</div>'+o.por_pais.map(s=>`
          ...
          </div>`).join(""):s.innerHTML='<p style="color:#bbb;font-size:0.82rem;margin:0">Sin datos de páginas aún</p>')}catch(t){console.warn("GA hoy:",t.message)}}async function lt(){var e;try{const o=await(await be(`${f}/analytics/semana`)).json();if(!o.configurado||!((e=o.dias)!=null&&e.length))return;const a=document.getElementById("ga-chart");if(!a||!window.Chart)return;a._chartInstance&&a._chartInstance.destroy(),a._chartInstance=new Chart(a,{type:"bar",data:{labels:o.dias.map(n=>n.fecha),datasets:[{label:"Sesiones",data:o.dias.map(n=>n.sesiones),backgroundColor:"rgba(52,131,250,0.7)",borderRadius:4},{label:"Usuarios",data:o.dias.map(n=>n.usuarios),backgroundColor:"rgba(34,197,94,0.5)",borderRadius:4}]},options:{responsive:!0,plugins:{legend:{position:"top"}},scales:{y:{beginAtZero:!0,ticks:{precision:0}}}}})}catch(t){console.warn("GA semana:",t.message)}}function ct(e){const t=document.getElementById("ga-setup"),o=document.getElementById("ga-setup-body");!t||!o||(t.style.display="block",o.innerHTML=`
    ...
    `}catch(t){e.innerHTML=`<p style="padding:2rem;color:red">Error cargando referidos: ${t.message}</p>`}}function pt(e,t){const o=parseFloat(e.credito_disponible||0),a=e.referido_por?t[e.referido_por]||e.referido_por:"—",n=o>0?"#2e7d32":"#aaa";return`<tr id="ref-row-${e.id}" style="border-bottom:1px solid #f5f5f5">
  ...
  </tr>`}window.filtrarReferidos=function(e){const t=document.querySelectorAll("#ref-tbody tr"),o=e.toLowerCase();t.forEach(a=>{a.style.display=a.textContent.toLowerCase().includes(o)?"":"none"})};window.generarCodigoReferido=async function(e){try{(await(await fetch(f+"/referidos/mi-codigo/"+e)).json()).codigo_referido?await ye():alert("Error generando código")}catch(t){alert("Error: "+t.message)}};window.ajustarCredito=async function(e,t,o){const a=prompt(`Ajustar crédito de ${t}
Crédito actual: $${o} MXN

Nuevo monto:`,o);if(a===null)return;const n=parseFloat(a);if(isNaN(n)||n<0)return alert("Monto inválido");try{(await fetch(f+"/clientes/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({credito_disponible:n})})).ok?await ye():alert("Error actualizando crédito")}catch(i){alert("Error: "+i.message)}};async function ve(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando carritos...</p>';try{const[t,o,a]=await Promise.all([fetch(f+"/pedidos/?status=borrador").then(i=>i.json()).catch(()=>[]),fetch(f+"/clientes/").then(i=>i.json()),fetch(f+"/sucursales/").then(i=>i.json())]),n=Array.isArray(t)?t.filter(i=>i.status==="borrador"&&(!i.canal||i.canal==="sucursal"||i.canal==="mayoreo")):[];e.innerHTML=`
        ...
        `:`
          <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:1rem">
            ${n.map(i=>{const s=i.clientes||{},r=i.created_at?Math.floor((Date.now()-new Date(i.created_at).getTime())/864e5):0;return`
                <div class="table-card" style="padding:1.2rem;cursor:pointer;transition:box-shadow 0.2s" onclick="abrirCarrito('${i.id}')"
                     onmouseenter="this.style.boxShadow='0 4px 20px rgba(0,0,0,0.1)'" onmouseleave="this.style.boxShadow=''">
                  <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px">
                    <div>
                      <p style="font-weight:700;font-size:1rem;margin:0">${s.nombre||"Sin cliente"}</p>
                      <p style="font-size:0.78rem;color:#888;margin:2px 0 0">${s.telefono||""}</p>
                    </div>
                  ...
                  <div style="background:#f9f9f9;border-radius:8px;padding:10px;text-align:center;margin-bottom:12px">
                    ...
                    <p style="font-weight:700;font-size:1.3rem;margin:2px 0 0;color:#E91E8C">$${parseFloat(i.total||0).toLocaleString("es-MX",{minimumFractionDigits:2})}</p>
                  </div>
                  <div style="display:flex;gap:6px">
                    <button class="btn btn-primary" style="flex:1;font-size:0.8rem" onclick="event.stopPropagation();abrirCarrito('${i.id}')">Abrir</button>
                    <button class="btn btn-secondary" style="font-size:0.8rem;color:#c62828;border-color:#c62828" onclick="event.stopPropagation();liberarCarrito('${i.id}')">Liberar</button>
                  </div>
                </div>
              `}).join("")}
          </div>
    ...
    <div style="max-width:860px">
      ...
      <div class="table-card" style="padding:1.2rem">
        ...
        <div id="carrito-items-lista">
          ...
          ${(()=>{const m={};return a.forEach((u,g)=>{const y=u.variantes||{},b=y.productos||{},h=b.nombre||u.nombre||"—",v=y.color||u.color||"",x=!!u.es_corrida,E=x?"c|"+h+"|"+v:"s|"+u.id;m[E]||(m[E]={nombre:h,color:v,esCorrida:x,items:[],imagen:y.foto_url||b.imagen_principal||null}),m[E].items.push({...u,_idx:g})}),Object.values(m).map(u=>{const g=u.esCorrida,y=u.imagen;if(g){const b=u.items.reduce((E,w)=>E+w.cantidad,0),h=u.items.reduce((E,w)=>E+w.cantidad*w.precio_unitario,0),v=(h/b).toFixed(2),x=u.items.map(E=>E.id).join(",");return`
                  <div style="background:#fdf4ff;border-radius:8px;padding:12px;margin-bottom:8px;border:1px solid #e8d5f5">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
                      <span id="corrida-header-${x.replace(/,/g,"_").substring(0,20)}" style="font-size:0.85rem;color:#888">${b} pares · <strong style="color:#6a1b9a">$${h.toFixed(2)}</strong></span>
                      <div style="display:flex;align-items:center;gap:4px">
                        <span style="font-size:0.72rem;color:#888">$</span>
                  ...
                  </div>`}else{const b=u.items[0],h=b.variantes||{};h.productos;const v=h.talla||b.talla||"",x=s.find(w=>w.variante_id===b.variante_id&&(r?w.sucursal_id===r:!0)),E=x?x.cantidad:null;return`
  ...
  `,window.hacerLogin=async()=>{const t=document.getElementById("login-email").value,o=document.getElementById("login-password").value,a=document.getElementById("btn-login");if(document.getElementById("login-error"),!t||!o){e("Por favor completa todos los campos");return}a.textContent="Verificando...",a.disabled=!0;try{const n=await fetch("/api/empleados/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:o})}),i=await n.json();n.ok?(sessionStorage.setItem(He,JSON.stringify(i)),i.token&&sessionStorage.setItem("erp_token",i.token),window._empleadoActual=i,_e()):(e(i.error||"Email o contrasena incorrectos"),a.textContent="Iniciar sesion",a.disabled=!1)}catch{e("Error conectando con el servidor"),a.textContent="Iniciar sesion",a.disabled=!1}};function e(t){const o=document.getElementById("login-error");o&&(o.textContent=t,o.style.display="block")}}window.authHeaders=()=>{const e=sessionStorage.getItem("erp_token");return e?{"Content-Type":"application/json",Authorization:`Bearer ${e}`}:{"Content-Type":"application/json"}};const we=sessionStorage.getItem(He);if(we)try{window._empleadoActual=JSON.parse(we),_e()}catch{xe()}else xe();
