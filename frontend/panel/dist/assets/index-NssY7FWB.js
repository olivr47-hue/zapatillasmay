(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(n){if(n.ep)return;n.ep=!0;const r=a(n);fetch(n.href,r)}})();const b="/api",ge=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],Te=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],je=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],Y=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"},{id:"catalogos",icon:"📖",label:"Catálogos",section:"Catalogo",soloAdmin:!0},{id:"mercadolibre",icon:"🛒",label:"MercadoLibre",section:"Integraciones",soloAdmin:!0},{id:"analytics",icon:"📊",label:"Google Analytics",section:"Integraciones",soloAdmin:!0}];var ue;let W=((ue=window._empleadoActual)==null?void 0:ue.rol)==="admin"?"dashboard":"pos",de=1;function fe(){var a,o;const e=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),t=((a=window._empleadoActual)==null?void 0:a.rol)==="admin"?"dashboard":"pos";W=e||t,document.querySelector("#app").innerHTML=`
    ...
    <div class="main">
      <div class="topbar">
        <div style="display:flex;align-items:center;gap:1rem">
          ...
          <h1 id="topbar-title">${((o=Y.find(n=>n.id===W))==null?void 0:o.label)||"Dashboard"}</h1>
        </div>
  ...
  `,window.toggleSidebar=()=>{const n=document.getElementById("sidebar"),r=document.getElementById("sidebar-overlay"),i=n.classList.toggle("open");r.classList.toggle("active",i),document.body.style.overflow=i?"hidden":""},window._conversacionesInterval&&clearInterval(window._conversacionesInterval),window._conversacionesInterval=setInterval(async()=>{try{const r=await(await fetch(b+"/chatbot/chats")).json();window._chatsData||(window._chatsData={});const i=window._totalNoLeidos||0,s=r.reduce((d,l)=>d+(l.no_leidos||0),0);if(window._totalNoLeidos=s,r.forEach(d=>{window._chatsData&&(window._chatsData[d.telefono]=d)}),fetch(b+"/health").catch(()=>{}),s>i){document.title=`(${s}) Zapatillas May`;const d=document.querySelector('[data-modulo="conversaciones"]');if(d){let l=d.querySelector(".nav-badge");l||(l=document.createElement("span"),l.className="nav-badge",l.style.cssText="background:#e91e8c;color:white;border-radius:100px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:auto",d.appendChild(l)),l.textContent=s}try{const l=new(window.AudioContext||window.webkitAudioContext),c=l.createOscillator(),p=l.createGain();c.connect(p),p.connect(l.destination),c.frequency.value=523,p.gain.setValueAtTime(.5,l.currentTime),p.gain.exponentialRampToValueAtTime(.001,l.currentTime+.2),c.start(l.currentTime),c.stop(l.currentTime+.2);const m=l.createOscillator(),u=l.createGain();m.connect(u),u.connect(l.destination),m.frequency.value=783,u.gain.setValueAtTime(.5,l.currentTime+.2),u.gain.exponentialRampToValueAtTime(.001,l.currentTime+.5),m.start(l.currentTime+.2),m.stop(l.currentTime+.5)}catch{}}if(window._chatActivo&&window._chatsData[window._chatActivo]){const d=window._chatsData[window._chatActivo],l=document.getElementById("mensajes-area");if(l){const c=l.scrollHeight-l.scrollTop<=l.clientHeight+50;l.innerHTML=[...d.mensajes].reverse().map(p=>{const m=p.tipo==="manual"||p.tipo==="imagen_saliente";return`
              ...
              </div>`}).join(""),c&&(l.scrollTop=l.scrollHeight)}}}catch{}},5e3),window.navegarA=n=>{var l;const r=((l=window._empleadoActual)==null?void 0:l.rol)==="admin",i=Y.find(c=>c.id===n);if(i!=null&&i.soloAdmin&&!r){alert("No tienes permisos para acceder a este módulo");return}W=n;try{localStorage.setItem("zm_panel_modulo",n)}catch{}const s=document.getElementById("sidebar"),d=document.getElementById("sidebar-overlay");s.classList.contains("open")&&(s.classList.remove("open"),d.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(c=>c.classList.remove("active")),document.querySelector('[data-modulo="'+n+'"]').classList.add("active"),document.getElementById("topbar-title").textContent=Y.find(c=>c.id===n).label,be(n)}}function Pe(){var a;const e=((a=window._empleadoActual)==null?void 0:a.rol)==="admin";return[...new Set(Y.filter(o=>e||!o.soloAdmin).map(o=>o.section))].map(o=>`
    <div class="nav-section">${o}</div>
    ${Y.filter(n=>n.section===o&&(e||!n.soloAdmin)).map(n=>`
    ...
    `).join("")}
  `).join("")}async function be(e){const t=document.getElementById("content");switch(t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>',e){case"catalogos":await le();break;case"dashboard":t.innerHTML=Ae(),setTimeout(()=>Ne(),100);break;case"productos":await re();break;case"clientes":await Le();break;case"pedidos":await we();break;case"sucursales":await Oe();break;case"inventario":await De();break;case"pos":await $e();break;case"historial":await Ee();break;case"empleados":await _e();break;case"seo":await Re();break;case"analisis":await Me();break;case"crm":await ve();break;case"finanzas":await ee();break;case"proveedores":await ye();break;case"ordenes":await Q();break;case"conversaciones":await cargarConversaciones();break;case"envios":await cargarEnviosMasivos();break;case"mercadolibre":await Ve();break;case"analytics":await Ge();break}}function Be(){return setTimeout(()=>{document.querySelectorAll(".nav-item").forEach(o=>o.classList.remove("active"));const e=document.querySelector('[data-modulo="'+W+'"]');e&&e.classList.add("active");const t=document.getElementById("topbar-title"),a=Y.find(o=>o.id===W);t&&a&&(t.textContent=a.label),be(W)},100),'<div style="padding:2rem;color:#888;text-align:center">Cargando...</div>'}async function Q(){var t;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando sugerencias...</p>';try{const o=await(await fetch(b+"/sucursales/")).json(),n=(t=o[0])==null?void 0:t.id,[r,i]=await Promise.all([fetch(b+"/finanzas/sugerencias-recompra/"+n),fetch(b+"/finanzas/proveedores")]),s=await r.json(),d=await i.json(),l=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),c=new Date().toISOString().split("T")[0],p=s.filter(f=>{const h=l[f.producto_id];return h?h.hasta===null||h.hasta===void 0?!1:h.hasta<=c:!0}),m=s.length-p.length;window._ordenesData={sugerencias:p,proveedores:d,sucursalId:n},window._ordenSeleccion={};const u=p.filter(f=>f.urgente),g=p.filter(f=>!f.urgente),y=p.reduce((f,h)=>f+h.cantidad_sugerida*h.costo_unitario,0);e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          <p style="font-size:1.6rem;font-weight:700;color:#333">${p.reduce((f,h)=>f+h.cantidad_sugerida,0)}</p>
              ...
              <div class="orden-item" data-urgente="${f.urgente}" style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
                ...
                <div style="flex:1;min-width:140px">
                  ...
                  <div style="margin-top:6px;display:flex;flex-wrap:wrap;gap:4px">
                    ${f.variantes.map(h=>{const v=[h.talla,h.color].filter(Boolean).join(" / "),w=h.sin_stock;return`<span style="
  ...
  `,document.body.appendChild(n),n.addEventListener("click",r=>{r.target===n&&n.remove()}),setTimeout(ordenRecalcTotal,50)};window.guardarOrdenCompra=async e=>{var n,r,i;const t=(n=document.getElementById("orden-fecha"))==null?void 0:n.value,a=((r=document.getElementById("orden-notas"))==null?void 0:r.value)||"",o=window._ordenesData.sucursalId;try{const s=typeof e=="string"?JSON.parse(e):e;for(const[d,l]of s){const c=l.productos.reduce((g,y)=>g+y.cantidad_final*y.costo_unitario,0),u=(i=(await(await fetch(b+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:d==="sin-proveedor"?null:d,sucursal_id:o,status:"borrador",total:c,notas:a,fecha_entrega_estimada:t||null})})).json())[0])==null?void 0:i.id;if(u)for(const g of l.productos)await fetch(b+"/finanzas/ordenes/"+u+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:null,cantidad:g.cantidad_final,costo_unitario:g.costo_unitario,subtotal:g.cantidad_final*g.costo_unitario})})}document.querySelector('div[style*="position:fixed"]').remove(),alert("Orden de compra guardada exitosamente"),Q()}catch(s){alert("Error guardando orden: "+s.message)}};window.ordenToggleVar=(e,t)=>{const a=document.getElementById("qty-var-"+e);a&&(a.disabled=!t,a.style.opacity=t?"1":"0.35",a.style.borderColor=t?"#E91E8C":"#ddd",t&&(!a.value||a.value==="0")?a.value=1:t||(a.value=0),ordenRecalcTotal())};window.ordenRecalcTotal=()=>{const{seleccionados:e}=window._ordenModal||{};if(!e)return;let t=0;e.forEach(o=>{var n;if((o.variantes||[]).forEach(r=>{var d;const i=document.getElementById("chk-var-"+r.id),s=parseInt(((d=document.getElementById("qty-var-"+r.id))==null?void 0:d.value)||0);i!=null&&i.checked&&s>0&&(t+=s*o.costo_unitario)}),!o.variantes||o.variantes.length===0){const r=parseInt(((n=document.getElementById("qty-orden-"+o.producto_id))==null?void 0:n.value)||o.cantidad_sugerida);t+=r*o.costo_unitario}});const a=document.getElementById("orden-total-general");a&&(a.textContent="$"+t.toFixed(0))};window.imprimirOrden=()=>{var s,d;const{seleccionados:e}=window._ordenModal||{};if(!e)return;const t=((s=document.getElementById("orden-fecha"))==null?void 0:s.value)||"",a=((d=document.getElementById("orden-notas"))==null?void 0:d.value)||"",o=new Date().toLocaleDateString("es-MX");let n="",r=0;e.forEach(l=>{var p;const c=l.variantes||[];if(c.length===0){const m=parseInt(((p=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:p.value)||l.cantidad_sugerida),u=m*l.costo_unitario;r+=u,n+=`<tr><td>${l.nombre}</td><td>${l.sku||""}</td><td>—</td><td>—</td><td style="text-align:center">${m}</td><td style="text-align:right">$${u.toFixed(0)}</td></tr>`}else c.forEach(m=>{var f;const u=document.getElementById("chk-var-"+m.id);if(!(u!=null&&u.checked))return;const g=parseInt(((f=document.getElementById("qty-var-"+m.id))==null?void 0:f.value)||0);if(g<=0)return;const y=g*l.costo_unitario;r+=y,n+=`<tr style="${m.sin_stock?"background:#fff5f5":""}">
...
<style>
  ...
  <script>window.onload = () => window.print()<\/script>
    ...
    </div>`,o.addEventListener("click",n=>{n.target===o&&o.remove()}),document.body.appendChild(o)};window.aplicarPosponer=(e,t)=>{var n;const a=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}");let o=null;if(t!==null){const r=new Date;r.setDate(r.getDate()+t),o=r.toISOString().split("T")[0]}a[e]={hasta:o},localStorage.setItem("ordenes_pospuestos",JSON.stringify(a)),(n=document.getElementById("modal-posponer"))==null||n.remove(),Q()};window.verPospuestos=()=>{const e=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),{sugerencias:t}=window._ordenesData;new Date().toISOString().split("T")[0];const a=Object.entries(e).map(([n,r])=>{const i=r.nombre||n,s=r.hasta?"hasta "+r.hasta:"indefinido";return`• ${i} — ${s}`}).join(`
`);if(!a){alert("No hay productos pospuestos.");return}confirm(`Productos pospuestos:

`+a+`

¿Quieres reactivar todos?`)&&(localStorage.removeItem("ordenes_pospuestos"),Q())};window.guardarOrdenCompra2=async()=>{var r,i,s,d;const{seleccionados:e,sucursalId:t}=window._ordenModal||{};if(!e)return;const a=(r=document.getElementById("orden-fecha"))==null?void 0:r.value,o=((i=document.getElementById("orden-notas"))==null?void 0:i.value)||"",n={};e.forEach(l=>{var u,g;const c=l.proveedor_id||"sin-proveedor",p=((u=l.proveedor)==null?void 0:u.nombre)||"Sin proveedor";n[c]||(n[c]={nombre:p,items:[]});const m=l.variantes||[];if(m.length===0){const y=parseInt(((g=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:g.value)||l.cantidad_sugerida);n[c].items.push({variante_id:null,cantidad:y,costo_unitario:l.costo_unitario})}else m.forEach(y=>{var v;const f=document.getElementById("chk-var-"+y.id);if(!(f!=null&&f.checked))return;const h=parseInt(((v=document.getElementById("qty-var-"+y.id))==null?void 0:v.value)||0);h<=0||n[c].items.push({variante_id:y.id,cantidad:h,costo_unitario:l.costo_unitario})})});try{for(const[l,c]of Object.entries(n)){if(c.items.length===0)continue;const p=c.items.reduce((y,f)=>y+f.cantidad*f.costo_unitario,0),g=(s=(await(await fetch(b+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:l==="sin-proveedor"?null:l,sucursal_id:t,status:"borrador",total:p,notas:o,fecha_entrega_estimada:a||null})})).json())[0])==null?void 0:s.id;if(g)for(const y of c.items)await fetch(b+"/finanzas/ordenes/"+g+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...y,subtotal:y.cantidad*y.costo_unitario})})}(d=document.getElementById("modal-orden"))==null||d.remove(),alert("Orden de compra guardada"),Q()}catch(l){alert("Error guardando orden: "+l.message)}};function Ae(){return`
  ...
  `}async function ee(){var t,a,o,n,r,i;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando finanzas...</p>';try{const d=await(await fetch(b+"/sucursales/")).json(),l=(t=d[0])==null?void 0:t.id,[c,p,m,u,g,y,f]=await Promise.all([fetch(b+"/finanzas/caja/hoy/"+l),fetch(b+"/finanzas/reporte/"+l),fetch(b+"/finanzas/gastos/"+l),fetch(b+"/finanzas/estado-resultados/"+l),fetch(b+"/finanzas/flujo/"+l),fetch(b+"/finanzas/cuentas-por-cobrar"),fetch(b+"/finanzas/gastos-categorias/"+l)]),h=await c.json(),v=await p.json(),w=await m.json(),k=await u.json(),x=await g.json(),C=await y.json(),_=await f.json(),$=h.find(z=>z.status==="abierta"),T=new Date().toISOString().split("T")[0],j=w.filter(z=>{var P;return(P=z.created_at)==null?void 0:P.startsWith(T)}),S=j.reduce((z,P)=>z+parseFloat(P.monto||0),0),I=C.reduce((z,P)=>z+parseFloat(P.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
    ...
    `,window._finanzasData={sucursalId:l,gastosHoy:j,totalGastosHoy:S,estadoResultados:k,flujo:x,cxc:C,categorias:_,historial:[]},window._finanzasSucursalId=l;const E=await(await fetch(b+"/finanzas/caja/historial/"+l)).json();window._finanzasData.historial=E,mostrarTabFinanzas("gastos")}catch(s){e.innerHTML='<p style="padding:2rem;color:red">Error cargando finanzas: '+s.message+"</p>"}}window.mostrarTabFinanzas=e=>{var c,p,m,u,g,y,f,h,v,w,k,x,C;const{gastosHoy:t,totalGastosHoy:a,estadoResultados:o,flujo:n,cxc:r,categorias:i,historial:s,sucursalId:d}=window._finanzasData,l=document.getElementById("fin-tab-contenido");if(l)if(e==="gastos"){const _=i.reduce(($,T)=>$+T.total,0);l.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;margin-bottom:1rem">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f5f5f5">
            ...
            <span style="font-weight:700;color:#c62828">-$${(((f=n.semana)==null?void 0:f.gastos)||0).toFixed(0)}</span>
          </div>
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
  ...
  `};window.abrirCaja=async e=>{var a;const t=prompt("¿Cuánto efectivo hay en caja para empezar? (fondo de caja)");if(t!==null)try{const n=await(await fetch(b+"/finanzas/caja/abrir",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sucursal_id:e,monto_apertura:parseFloat(t)||0,empleado:((a=window._empleadoActual)==null?void 0:a.nombre)||"Admin"})})).json();if(n.error){alert("Error: "+n.error);return}ee()}catch{alert("Error abriendo caja")}};window.cerrarCaja=async e=>{var o,n;const t=prompt("¿Cuánto efectivo hay físicamente en caja al cerrar?");if(t===null)return;const a=prompt("Notas del cierre (opcional):")||"";try{const i=await(await fetch(b+"/finanzas/caja/"+e+"/cerrar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({monto_cierre:parseFloat(t)||0,notas:a})})).json();i.ok?(alert(`Caja cerrada.
Total ventas: $${(o=i.total_ventas)==null?void 0:o.toFixed(2)}
Diferencia: $${(n=i.diferencia)==null?void 0:n.toFixed(2)}`),ee()):alert("Error: "+JSON.stringify(i))}catch{alert("Error cerrando caja")}};window.agregarGasto=e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",t.innerHTML=`
  ...
  `,document.body.appendChild(t),t.addEventListener("click",a=>{a.target===t&&t.remove()})};window.guardarGasto=async(e,t)=>{var r;const a=document.getElementById("gasto-concepto").value,o=document.getElementById("gasto-monto").value,n=document.getElementById("gasto-categoria").value;if(!a||!o){alert("Completa concepto y monto");return}try{await fetch(b+"/finanzas/gastos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sucursal_id:e,concepto:a,monto:parseFloat(o),categoria:n,empleado:((r=window._empleadoActual)==null?void 0:r.nombre)||"Admin"})}),t.closest('div[style*="position:fixed"]').remove(),ee()}catch{alert("Error guardando gasto")}};window.eliminarGasto=async e=>{if(confirm("¿Eliminar este gasto?"))try{await fetch(b+"/finanzas/gastos/"+e,{method:"DELETE"}),ee()}catch{alert("Error eliminando gasto")}};async function ye(){const e=document.getElementById("content");try{const a=await(await fetch(b+"/finanzas/proveedores")).json();e.innerHTML=`
  ...
  `,document.body.appendChild(a),a.addEventListener("click",o=>{o.target===a&&a.remove()})};window.guardarProveedor=async e=>{const t={nombre:document.getElementById("prov-nombre").value,contacto:document.getElementById("prov-contacto").value,telefono:document.getElementById("prov-telefono").value,email:document.getElementById("prov-email").value,ciudad:document.getElementById("prov-ciudad").value,direccion:document.getElementById("prov-direccion").value,notas:document.getElementById("prov-notas").value};if(!t.nombre){alert("El nombre es requerido");return}try{e?await fetch(b+"/finanzas/proveedores/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):await fetch(b+"/finanzas/proveedores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),document.querySelector('div[style*="position:fixed"]').remove(),ye()}catch{alert("Error guardando proveedor")}};window.editarProveedor=async e=>{const o=(await(await fetch(b+"/finanzas/proveedores")).json()).find(n=>n.id===e);o&&mostrarFormProveedor(o)};async function Me(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando análisis...</p>';try{const[t,a,o,n]=await Promise.all([fetch(b+"/productos/"),fetch(b+"/variantes/"),fetch(b+"/movimientos/"),fetch(b+"/inventario/")]),r=await t.json(),i=await a.json(),s=await o.json(),d=await n.json(),l=new Date,c=new Date(l-30*24*60*60*1e3),p=new Date(l-60*24*60*60*1e3),m=new Date(l-90*24*60*60*1e3),u={};s.filter(f=>f.tipo==="venta").forEach(f=>{const h=i.find(x=>x.id===f.variante_id);if(!h)return;const v=h.producto_id;u[v]||(u[v]={d30:0,d60:0,d90:0});const w=new Date(f.created_at),k=Math.abs(f.cantidad);w>=c&&(u[v].d30+=k),w>=p&&(u[v].d60+=k),w>=m&&(u[v].d90+=k)});const g=r.map(f=>{const h=u[f.id]||{d30:0,d60:0,d90:0},v=d.filter(_=>i.find($=>$.id===_.variante_id&&$.producto_id===f.id)).reduce((_,$)=>_+$.cantidad,0),w=h.d30/4,k=w>0?Math.round(v/w*7):null;let x="gris",C="Sin ventas recientes";return h.d30>=6?(x="verde",C="Rota bien — considerar resurtido"):h.d30>=2?(x="amarillo",C="Rotacion moderada"):h.d90===0&&v>0?(x="rojo",C="Sin movimiento en 90 dias — revisar"):h.d30>0&&(x="amarillo",C="Rotacion lenta"),{...f,ventas:h,stockTotal:v,ventasSemana:w,diasInventario:k,semaforo:x,recomendacion:C}}).sort((f,h)=>h.ventas.d30-f.ventas.d30),y={verde:{bg:"#e8f5e9",color:"#2e7d32",texto:"🟢 Rota bien"},amarillo:{bg:"#fff8e1",color:"#f57f17",texto:"🟡 Rotacion lenta"},rojo:{bg:"#ffebee",color:"#c62828",texto:"🔴 Sin movimiento"},gris:{bg:"#f5f5f5",color:"#888",texto:"⚪ Sin datos"}};e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:12px;margin-bottom:2rem">
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#E91E8C">${g.reduce((f,h)=>f+h.ventas.d30,0)}</p>
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#E91E8C">${g.reduce((f,h)=>f+h.ventas.d90,0)}</p>
          <p style="font-size:0.75rem;color:#aaa">pares</p>
        </div>
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          <p style="font-size:0.72rem;color:#888;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:6px">Rotan bien</p>
          <p style="font-size:1.8rem;font-weight:700;color:#2e7d32">${g.filter(f=>f.semaforo==="verde").length}</p>
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#c62828">${g.filter(f=>f.semaforo==="rojo").length}</p>
          <p style="font-size:0.75rem;color:#aaa">modelos</p>
        </div>
      </div>
  ...
  <button class="btn btn-secondary" style="padding:4px 10px;font-size:0.75rem;background:#ffebee;border-color:#c62828;color:#c62828" onclick="filtrarRotacion('rojo')">🔴 Sin movimiento</button>
        ...
        <div id="rotacion-lista">
          ${g.map(f=>{const h=y[f.semaforo];return`
              <div class="rotacion-item" data-semaforo="${f.semaforo}" style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
                ${f.imagen_principal?`<img src="${f.imagen_principal}" style="width:52px;height:52px;object-fit:contain;border-radius:8px;background:#f5f5f5;flex-shrink:0">`:'<div style="width:52px;height:52px;background:#f5f5f5;border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:1.5rem;flex-shrink:0">👠</div>'}
                <div style="flex:1;min-width:140px">
                  <p style="font-weight:600;font-size:0.9rem;margin-bottom:2px">${f.nombre}</p>
                  <p style="font-size:0.75rem;color:#888">${f.sku_interno||""} · Stock: ${f.stockTotal} pares</p>
                ...
                <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;text-align:center;min-width:200px">
                  <div>
                    <p style="font-size:1.1rem;font-weight:700;color:#333">${f.ventas.d30}</p>
                    <p style="font-size:0.65rem;color:#aaa">30 días</p>
                  </div>
                  <div>
                    <p style="font-size:1.1rem;font-weight:700;color:#333">${f.ventas.d60}</p>
                    <p style="font-size:0.65rem;color:#aaa">60 días</p>
                  </div>
                  <div>
                    <p style="font-size:1.1rem;font-weight:700;color:#333">${f.ventas.d90}</p>
                    <p style="font-size:0.65rem;color:#aaa">90 días</p>
                  </div>
                </div>
                <div style="text-align:right;min-width:120px">
                  <p style="font-size:0.82rem;font-weight:600;color:#333">${f.ventasSemana.toFixed(1)} pares/sem</p>
                  <p style="font-size:0.75rem;color:${f.diasInventario?f.diasInventario<14?"#c62828":f.diasInventario<30?"#f57f17":"#2e7d32":"#aaa"}">${f.diasInventario?`~${f.diasInventario} días stock`:"Sin ventas"}</p>
                  <p style="font-size:0.72rem;color:#888;margin-top:2px">${f.recomendacion}</p>
                </div>
              </div>
            `}).join("")}
        </div>
      </div>
    `,window._rotacionData=g}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando análisis</p>'}}window.filtrarRotacion=e=>{document.querySelectorAll(".rotacion-item").forEach(t=>{t.style.display=e==="todos"||t.dataset.semaforo===e?"":"none"})};async function ve(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando CRM...</p>';try{const[t,a,o]=await Promise.all([fetch(b+"/clientes/"),fetch(b+"/pedidos/"),fetch(b+"/crm/seguimientos/pendientes/todos")]),n=await t.json(),r=await a.json(),i=await o.json(),s=new Date,d=new Date(s-30*24*60*60*1e3),l=new Date(s-60*24*60*60*1e3),c=new Date(s-90*24*60*60*1e3),p=n.map(v=>{const w=r.filter(T=>T.cliente_id===v.id&&(T.status==="confirmado"||T.status==="pagado")),k=w.reduce((T,j)=>T+parseFloat(j.total||0),0),x=w.length>0?new Date(w[0].created_at):null,C=x?Math.floor((s-x)/(1e3*60*60*24)):null,_=w.filter(T=>new Date(T.created_at)>=d).length;let $="nuevo";return w.length===0?$="nuevo":k>=5e3&&_>=1?$="vip":C>90?$="inactivo":C>30?$="riesgo":_>=2?$="frecuente":$="activo",{...v,totalGastado:k,ultimoPedido:x,diasSinComprar:C,pedidos30:_,segmento:$,totalPedidos:w.length}}),m=p.filter(v=>v.segmento==="vip"),u=p.filter(v=>v.segmento==="riesgo").sort((v,w)=>w.totalGastado-v.totalGastado),g=p.filter(v=>v.segmento==="inactivo").sort((v,w)=>w.totalGastado-v.totalGastado),y=[...p].sort((v,w)=>w.totalGastado-v.totalGastado).slice(0,10),f=r.filter(v=>new Date(v.created_at).toDateString()===s.toDateString()&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,w)=>v+parseFloat(w.total||0),0),h=r.filter(v=>new Date(v.created_at)>=d&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,w)=>v+parseFloat(w.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
    ...
    `,window._crmData={clientes:p,pedidos:r,recordatorios:i}}catch(t){e.innerHTML='<p style="padding:2rem;color:red">Error cargando CRM: '+t.message+"</p>"}}window.mostrarSegmento=e=>{const{clientes:t}=window._crmData||{};if(!t)return;const a=t.filter(r=>r.segmento===e).sort((r,i)=>i.totalGastado-r.totalGastado),o={vip:"⭐ Clientes VIP",riesgo:"🟡 En riesgo",inactivo:"🔴 Inactivos",frecuente:"🟢 Frecuentes"},n=document.getElementById("crm-segmento-detalle");n.style.display="block",n.innerHTML=`
    <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
      <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee;display:flex;justify-content:space-between;align-items:center">
  ...
  `).join("")};window.seleccionarClienteOportunidad=(e,t)=>{document.getElementById("op-cliente-id").value=e,document.getElementById("op-cliente-buscar").value=t,document.getElementById("op-cliente-resultados").style.display="none"};window.guardarOportunidad=async()=>{const e=document.getElementById("op-titulo").value,t=document.getElementById("op-cliente-id").value,a=document.getElementById("op-monto").value,o=document.getElementById("op-etapa").value,n=document.getElementById("op-fecha").value,r=document.getElementById("op-notas").value;if(!e){alert("El título es requerido");return}try{await fetch(b+"/crm/oportunidades",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({titulo:e,cliente_id:t||null,monto_estimado:parseFloat(a)||0,etapa:o,fecha_cierre_estimada:n||null,notas:r})}),document.getElementById("modal-oportunidad").remove(),mostrarPipeline()}catch{alert("Error guardando oportunidad")}};async function re(e,t=!1){const a=document.getElementById("content");try{const n=await(await fetch(b+"/productos/")).json(),r=n.filter(c=>c.activo),i=n.filter(c=>!c.activo),s=t?i:r;console.log("mostrarInactivos:",t,"base:",s.length,"inactivos:",i.length);const d=[...new Set(r.map(c=>c.categoria).filter(Boolean))],l=e?s.filter(c=>c.categoria===e):s;a.innerHTML=`
    ...
    `}catch{a.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.cargarProductos=re;window.mostrarCampanas=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando campañas...</p>';try{const[t,a]=await Promise.all([fetch(b+"/clientes/"),fetch(b+"/pedidos/")]),o=await t.json(),n=await a.json(),r=new Date,i=new Date(r-30*24*60*60*1e3),s=new Date(r-90*24*60*60*1e3),d=o.map(p=>{const m=n.filter(v=>v.cliente_id===p.id&&(v.status==="confirmado"||v.status==="pagado")),u=m.reduce((v,w)=>v+parseFloat(w.total||0),0),g=m.length>0?new Date(m[0].created_at):null,y=g?Math.floor((r-g)/(1e3*60*60*24)):null,f=m.filter(v=>new Date(v.created_at)>=i).length;let h="nuevo";return m.length===0?h="nuevo":u>=5e3&&f>=1?h="vip":y>90?h="inactivo":y>30?h="riesgo":f>=2?h="frecuente":h="activo",{...p,totalGastado:u,diasSinComprar:y,segmento:h}}).filter(p=>p.telefono);window._campanaClientes=d;const l=[{id:"catalogo",nombre:"👠 Catálogo completo",descripcion:"Envía el catálogo completo de productos",mensaje:p=>`Hola ${p}! 👋
...
⚠️ Requiere que los productos estén en el catálogo de Meta Commerce.`;else if(d.style.background="#e8f5e9",d.style.borderColor="#a5d6a7",d.style.color="#333",a){let y;t==="personalizado"?y=(((g=document.getElementById("texto-personalizado"))==null?void 0:g.value)||"").replace("{nombre}","María"):y=a.mensaje("María"),d.textContent=y}}const l=document.getElementById("campana-count");l&&(l.textContent=r.length+" clientes");const c=document.getElementById("campana-lista");if(c){if(!r.length){c.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No hay clientes en este segmento con teléfono registrado</div>';return}window._campanaFiltrados=r,window._campanaPlantillaId=t,c.innerHTML=r.map((y,f)=>{var k;let h;t==="personalizado"?h=(((k=document.getElementById("texto-personalizado"))==null?void 0:k.value)||"").replace("{nombre}",y.nombre.split(" ")[0]):h=a.mensaje(y.nombre.split(" ")[0]);const v=encodeURIComponent(h),w=(y.lada||"52")+y.telefono.replace(/\D/g,"");return`
    ...
    <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);text-align:center">
      ...
      <p style="font-size:0.82rem;color:#888">Conectando con WhatsApp Business</p>
    </div>`,document.body.appendChild(l);try{const u=await(await fetch(b+"/campanas/enviar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({destinatarios:d.map(v=>({nombre:v.nombre,telefono:v.telefono,mensaje:v.mensaje})),fotos_urls:i,fotos_con_caption:s.length?s:null,imagen_url:i.length===1?i[0]:"",delay_segundos:4})})).json();if(u.error){l.remove(),alert("Error: "+u.error);return}const g=u.job_id,y=u.total,f=v=>{var _;const w=v.progreso||0,k=Math.round(w/y*100),x=v.enviados||0,C=v.fallidos||0;l.innerHTML=`
        ...
        </div>`};window._campanaJobId=g;const h=setInterval(async()=>{try{const w=await(await fetch(b+"/campanas/estado/"+g)).json();f(w),w.terminado&&(clearInterval(h),window._campanaUltimosResultados=w.resultados||[],setTimeout(()=>{const k=w.enviados||0,x=w.fallidos||0;l.innerHTML=`
    ...
    `}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}async function De(){const e=document.getElementById("content");try{const a=await(await fetch(b+"/sucursales/")).json(),n=await(await fetch(b+"/productos/")).json();let i=await(await fetch(b+"/variantes/")).json();const d=await(await fetch(b+"/inventario/")).json();d.forEach(c=>{c.variantes&&c.variantes.id&&!i.find(p=>p.id===c.variantes.id)&&i.push(c.variantes)}),window._invData={sucursales:a,productos:n,variantes:i,inventario:d};const l=n.find(c=>c.sku_interno==="AR1011");if(l){const c=i.filter(m=>m.producto_id===l.id),p=d.filter(m=>c.some(u=>u.id===m.variante_id));console.log(`[Diag AR1011] Variantes en listado: ${c.length}`,c.map(m=>m.color+" T"+m.talla)),console.log(`[Diag AR1011] Con inventario: ${p.length}`)}e.innerHTML=`
  <div style="margin-bottom:1.5rem">
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">
      ...
      <select class="form-input" id="inv-talla" style="min-width:100px" onchange="renderInventario()">
        ...
        ${ge.map(c=>`<option value="${c}">${c}</option>`).join("")}
      </select>
...
`,renderInventario()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.renderInventario=()=>{const{sucursales:e,productos:t,variantes:a,inventario:o}=window._invData,n=(document.getElementById("inv-buscar")?document.getElementById("inv-buscar").value:"").toLowerCase(),r=document.getElementById("inv-categoria")?document.getElementById("inv-categoria").value:"",i=document.getElementById("inv-talla")?document.getElementById("inv-talla").value:"",s=document.getElementById("inv-estado")?document.getElementById("inv-estado").value:"",d=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],l=t.filter(m=>!(!m.activo||n&&!m.nombre.toLowerCase().includes(n)&&!(m.sku_interno||"").toLowerCase().includes(n)||r&&m.categoria!==r)),c=e.map(m=>{const u=o.filter(y=>y.sucursal_id===m.id),g=l.map(y=>{const f=a.filter(k=>k.producto_id===y.id);if(f.length===0)return"";const v=[...new Set(f.map(k=>k.color).filter(Boolean))].map(k=>{const x=f.filter(T=>T.color===k).sort((T,j)=>d.indexOf(T.talla)-d.indexOf(j.talla));if(i&&!x.find(T=>T.talla===i))return"";const C=x[0]?x[0].color_hex:"#888",_=x[0]?x[0].foto_url:null,$=x.map(T=>{const j=u.find(z=>z.variante_id===T.id),S=j?j.cantidad:null,I=j?j.stock_minimo:3;if(i&&T.talla!==i||s&&(s==="agotado"&&S!==0||s==="bajo"&&(S===null||S===0||S>I)||s==="disponible"&&(S===null||S===0||S<=I)))return"";let M,E;return S===null?(M="#f0f0f0",E="#aaa"):S===0?(M="#ffebee",E="#c62828"):S<=I?(M="#fff8e1",E="#f57f17"):(M="#e8f5e9",E="#2e7d32"),`
    ...
    `:""}).join(""),p=document.getElementById("inv-contenido");p&&(p.innerHTML=c||'<div style="text-align:center;padding:3rem;color:#888"><p>No hay inventario registrado</p></div>')};window.cambiarStockInventario=async(e,t,a,o,n)=>{const r=Math.max(0,a+n);try{if((await fetch(b+"/movimientos/ajuste",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:r,stock_minimo:o,motivo:"Ajuste desde inventario"})})).ok){const s=document.getElementById("stock-"+e+"-"+t);if(s){s.textContent=r;let c;r===0?c="#c62828":r<=o?c="#f57f17":c="#2e7d32",s.style.color=c}const d=window._invData.inventario.find(c=>c.variante_id===e&&c.sucursal_id===t);d&&(d.cantidad=r),document.querySelectorAll(`button[onclick*="${e}"][onclick*="${t}"]`).forEach(c=>{c.setAttribute("onclick",c.getAttribute("onclick").replace(/cambiarStockInventario\('[^']+', '[^']+', \d+,/,`cambiarStockInventario('${e}', '${t}', ${r},`))})}}catch{alert("Error actualizando stock")}};window.editarStock=async(e,t,a,o)=>{const n=prompt("Nueva cantidad:",a);if(n===null)return;const r=prompt("Stock minimo de alerta:",o);if(r!==null)try{const i=await fetch(b+"/movimientos/ajuste",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:parseInt(n),stock_minimo:parseInt(r),motivo:"Ajuste manual desde inventario"})});if(i.ok){const s=await fetch(b+"/inventario/");window._invData.inventario=await s.json(),renderInventario()}else{const s=await i.json().catch(()=>({}));alert("Error al guardar: "+(s.error||i.status))}}catch{alert("Error conectando con el servidor")}};window.mostrarFormInventario=async()=>{const t=await(await fetch(b+"/sucursales/")).json(),o=await(await fetch(b+"/variantes/")).json();window._variantesCache=o;const n=document.getElementById("content");n.innerHTML=`
  ...
  `};window.guardarAjuste=async()=>{const e=document.getElementById("aj").value,t=document.getElementById("aj-sucursal").value,a=document.getElementById("aj-cantidad").value,o=document.getElementById("aj-motivo").value;if(!e||!t||a===""){alert("Por favor completa todos los campos");return}try{const r=await(await fetch(b+"/movimientos/ajuste",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:parseInt(a),motivo:o})})).json();r.ok?(alert("Ajuste guardado. Anterior: "+r.cantidad_anterior+" pares ÔåÆ Nuevo: "+r.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(r))}catch{alert("Error conectando con el servidor")}};window.mostrarCambio=async()=>{const t=await(await fetch(b+"/sucursales/")).json(),o=await(await fetch(b+"/variantes/")).json();window._variantesCache=o;const n=document.getElementById("content");n.innerHTML=`
  ...
  `};window.guardarCambio=async()=>{const e=document.getElementById("cam-origen").value,t=document.getElementById("cam-destino").value,a=document.getElementById("cam-sucursal").value,o=document.getElementById("cam-motivo").value;if(!e||!t||!a){alert("Por favor selecciona ambos productos y la sucursal");return}if(e===t){alert("El producto que regresa y el que se lleva deben ser diferentes");return}try{const r=await(await fetch(b+"/movimientos/cambio",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_origen_id:e,variante_destino_id:t,sucursal_id:a,motivo:o})})).json();r.ok?(alert("Cambio registrado. El inventario se actualizo automaticamente."),navegarA("inventario")):alert("Error: "+JSON.stringify(r))}catch{alert("Error conectando con el servidor")}};window.buscarVariante=(e,t)=>{const a=window._variantesCache||[],o=document.getElementById(t+"-resultados");if(!o)return;if(!e||e.length<2){o.style.display="none";return}const n=e.toLowerCase().split(" ").filter(s=>s),r=a.filter(s=>{const d=(s.productos&&s.productos.nombre||"").toLowerCase(),l=(s.color||"").toLowerCase(),c=(s.talla||"").toLowerCase(),p=(s.sku||"").toLowerCase(),m=d+" "+l+" "+c+" "+p;return n.every(u=>m.includes(u))}).slice(0,15);if(r.length===0){o.innerHTML='<div style="padding:10px 14px;color:#888;font-size:0.85rem">No se encontraron resultados</div>',o.style.display="block";return}const i=t==="ped-prod";o.innerHTML=r.map(s=>{const d=(s.productos&&s.productos.nombre||"")+" - "+s.color+" - T"+s.talla;return`
    ...
    `}).join(""),o.style.display="block"};window.seleccionarVariante=(e,t,a)=>{const o=document.getElementById(a);o&&(o.value=e);const n=document.getElementById(a+"-seleccionado");n&&(n.textContent="Ô£ô "+t,n.style.display="block");const r=document.getElementById(a+"-resultados");r&&(r.style.display="none")};function ne(e,t){const a=t||{},o=!t;let n="";a.imagenes&&a.imagenes.length>0?n=a.imagenes.map((s,d)=>{const l=d===0;return`<div style="position:relative;cursor:pointer" data-url="${s}" data-es-portada="${l}" data-file-idx="${d}">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div>
          ...
          <select class="form-input" id="f-categoria" required onchange="actualizarSKU()">
            ...
            ${je.map(o=>`<option value="${o.value}" ${t.categoria===o.value?"selected":""}>${o.label}</option>`).join("")}
          </select>
        </div>
        <div>
...
<div id="variantes-container">
  ${window._coloresExistentes&&window._coloresExistentes.length>0?window._coloresExistentes.map((o,n)=>ne(n,o)).join(""):ne(0,null)}
</div>
  ...
  `,fetch(b+"/sucursales/").then(o=>o.json()).then(o=>{const n=document.getElementById("f-sucursal-stock");n&&(n.innerHTML=o.map(r=>`<option value="${r.id}">${r.nombre}</option>`).join("")),setTimeout(()=>actualizarTablaStock(),100)})};window.seleccionarColorPortada=e=>{if(!window._coloresExistentes)return;const t=window._coloresExistentes.splice(e,1)[0];window._coloresExistentes.unshift(t),document.querySelectorAll('[id^="portada-color-"]').forEach((o,n)=>{const r=n===0;o.style.borderColor=r?"#2e7d32":"#ddd",o.style.background=r?"#e8f5e9":"white",o.innerHTML=`
...
${a.telefono?'<a href="https://wa.me/'+(a.lada||"52")+a.telefono.replace(/\D/g,"")+'" target="_blank" class="btn btn-secondary" style="background:#25D366;color:white;border-color:#25D366;margin-left:auto">WhatsApp</a>':""}      </div>
  ...
  `};window.guardarCliente=async e=>{const t=document.getElementById("cli-nombre").value;if(!t){alert("El nombre del cliente es obligatorio");return}const a=document.getElementById("btn-cli-guardar");a&&(a.textContent="Guardando...",a.disabled=!0);const o={nombre:t,telefono:document.getElementById("cli-telefono").value||null,email:document.getElementById("cli-email").value||null,tipo:document.getElementById("cli-tipo").value,direccion:document.getElementById("cli-direccion").value||null,lada:document.getElementById("cli-lada").value||"52",ciudad:document.getElementById("cli-ciudad").value||null,estado:document.getElementById("cli-estado").value||null,codigo_postal:document.getElementById("cli-cp").value||null,limite_credito:parseFloat(document.getElementById("cli-credito").value)||0,dias_credito:parseInt(document.getElementById("cli-dias").value)||0,comentarios_internos:document.getElementById("cli-comentarios").value||null,activo:!0};try{const n=e?"PATCH":"POST",r=e?b+"/clientes/"+e:b+"/clientes/",i=await fetch(r,{method:n,headers:{"Content-Type":"application/json"},body:JSON.stringify(o)});if(i.ok)alert("Cliente guardado correctamente"),navegarA("clientes");else{const s=await i.text();alert("Error al guardar: "+s),a&&(a.textContent="Guardar cliente",a.disabled=!1)}}catch{alert("Error conectando con el servidor"),a&&(a.textContent="Guardar cliente",a.disabled=!1)}};window.verCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[a,o]=await Promise.all([fetch(b+"/clientes/"+e),fetch(b+"/pedidos/")]),n=await a.json(),r=await o.json();if(!n||n.length===0){alert("Cliente no encontrado");return}const i=n[0],s=r.filter(g=>g.cliente_id===e),d=s.filter(g=>g.status==="confirmado"||g.status==="pagado"),l=d.reduce((g,y)=>g+parseFloat(y.total||0),0),c=d.length>0?l/d.length:0,p=s.length>0?new Date(s[0].created_at):null,m=p?Math.floor((new Date-p)/(1e3*60*60*24)):null,u={};d.forEach(g=>{const y=new Date(g.created_at).toLocaleDateString("es-MX",{month:"short",year:"2-digit"});u[y]=(u[y]||0)+parseFloat(g.total||0)}),t.innerHTML=`
                ...
                <div style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap;cursor:pointer" onclick="verPedido('${g.id}')"
                  ...
                  <div style="flex:1">
                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px">
                      ...
                      <span style="padding:2px 8px;border-radius:100px;font-size:0.65rem;font-weight:600;background:${f};color:${y}">${g.status}</span>
                    </div>
    ...
    `}catch{t.innerHTML='<p style="padding:2rem;color:red">Error cargando cliente</p>'}};window.guardarNotasCliente=async e=>{var a;const t=((a=document.getElementById("cli-notas-"+e))==null?void 0:a.value)||"";try{await fetch(b+"/clientes/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({comentarios_internos:t})});const o=document.querySelector(`button[onclick="guardarNotasCliente('${e}')"]`);o&&(o.textContent="✅ Guardado",setTimeout(()=>o.textContent="💾 Guardar notas",2e3))}catch{alert("Error guardando notas")}};window.editarCliente=e=>{mostrarFormCliente(e)};window.nuevoPedidoCliente=async(e,t)=>{await $e(),setTimeout(()=>{const a=document.getElementById("pos-cliente-buscar"),o=document.getElementById("pos-cliente"),n=document.getElementById("pos-cliente-seleccionado");a&&(a.value=""),o&&(o.value=e),n&&(n.textContent="✔ "+t+" — toca para cambiar",n.style.display="block");const r=document.getElementById("topbar-title");r&&(r.textContent="Punto de venta")},300)};window.verHistorialCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando historial...</p>';try{const n=(await(await fetch(b+"/pedidos/")).json()).filter(s=>s.cliente_id===e),r=n.length>0&&n[0].clientes?n[0].clientes:{},i=n.filter(s=>s.status==="confirmado"||s.status==="pagado").reduce((s,d)=>s+parseFloat(d.total||0),0);t.innerHTML=`
      <div class="table-card" style="padding:2rem">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;flex-wrap:wrap">
          <button class="btn btn-secondary" onclick="navegarA('clientes')">← Volver</button>
  ...
  `};window.guardarEntrada=async()=>{const e=document.getElementById("ent").value,t=document.getElementById("ent-sucursal").value,a=document.getElementById("ent-cantidad").value,o=document.getElementById("ent-motivo").value;if(!e||!t||!a){alert("Por favor completa todos los campos");return}try{const r=await(await fetch(b+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:parseInt(a),motivo:o})})).json();r.ok?(alert("Entrada guardada. Anterior: "+r.cantidad_anterior+" pares ÔåÆ Nuevo: "+r.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(r))}catch{alert("Error conectando con el servidor")}};window.mostrarSalida=async()=>{const t=await(await fetch(b+"/sucursales/")).json(),o=await(await fetch(b+"/variantes/")).json();window._variantesCache=o;const n=document.getElementById("content");n.innerHTML=`
    <div class="table-card" style="padding:2rem;max-width:600px">
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem">
        <button class="btn btn-secondary" onclick="navegarA('inventario')">← Volver</button>
  ...
  `};window.guardarSalida=async()=>{const e=document.getElementById("sal").value,t=document.getElementById("sal-sucursal").value,a=document.getElementById("sal-cantidad").value,o=document.getElementById("sal-motivo").value;if(!e||!t||!a){alert("Por favor completa todos los campos");return}try{const r=await(await fetch(b+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:-parseInt(a),motivo:o})})).json();r.ok?(alert("Salida registrada. Anterior: "+r.cantidad_anterior+" pares ÔåÆ Nuevo: "+r.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(r))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const a=await(await fetch(b+"/sucursales/")).json(),n=await(await fetch(b+"/productos/")).json(),i=await(await fetch(b+"/variantes/")).json(),d=await(await fetch(b+"/inventario/")).json(),l=[...new Set(n.map(p=>p.categoria).filter(Boolean))],c=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:a,productos:n,variantes:i,inventario:d},e.innerHTML=`
    ...
    `,renderTablasMasivo()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:e,variantes:t,inventario:a}=window._invMasivo,o=document.getElementById("im-sucursal").value,n=document.getElementById("im-categoria").value,r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],i=e.filter(c=>!(n&&c.categoria!==n)),s=a.filter(c=>c.sucursal_id===o),d=i.map(c=>{const p=t.filter(g=>g.producto_id===c.id);if(p.length===0)return"";const u=[...new Set(p.map(g=>g.color).filter(Boolean))].map(g=>{const y=p.filter(h=>h.color===g).sort((h,v)=>r.indexOf(h.talla)-r.indexOf(v.talla));return`
        <div style="margin-bottom:1rem">
  ...
  `};window.guardarTraspaso=async()=>{const e=document.getElementById("tra").value,t=document.getElementById("tra-origen").value,a=document.getElementById("tra-destino").value,o=document.getElementById("tra-cantidad").value;if(!e||!t||!a||!o){alert("Por favor completa todos los campos");return}if(t===a){alert("La sucursal origen y destino no pueden ser la misma");return}try{const r=await(await fetch(b+"/movimientos/traspaso",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_origen_id:t,sucursal_destino_id:a,cantidad:parseInt(o)})})).json();r.ok?(alert("Traspaso realizado correctamente. Se movieron "+r.cantidad_movida+" pares."),navegarA("inventario")):alert("Error: "+(r.error||JSON.stringify(r)))}catch{alert("Error conectando con el servidor")}};async function we(){const e=document.getElementById("content");try{const a=await(await fetch(b+"/pedidos/")).json();e.innerHTML=`
      <div style="margin-bottom:1rem;display:flex;gap:8px;flex-wrap:wrap;align-items:center">
    ...
    `,window._pedidosData=a}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.filtrarPedidos=()=>{const e=document.getElementById("ped-buscar").value.toLowerCase();document.querySelectorAll("#content tbody tr").forEach(a=>{const o=a.textContent.toLowerCase();a.style.display=o.includes(e)?"":"none"})};window.cargarPedidosFiltro=async e=>{document.getElementById("content");try{const a=await(await fetch(b+"/pedidos/")).json();let o=a;e==="pendiente_pago"?o=a.filter(n=>n.status==="pendiente_pago"):e==="credito"?o=a.filter(n=>n.forma_pago==="credito"):e&&(o=a.filter(n=>n.canal===e)),await we()}catch{}};window.mostrarFormPedido=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const a=await(await fetch(b+"/clientes/")).json(),n=await(await fetch(b+"/sucursales/")).json(),i=await(await fetch(b+"/productos/")).json(),d=await(await fetch(b+"/variantes/")).json();window._variantesCache=d,window._productosCache=i,window._pedidoItems=[],e.innerHTML=`
      <div class="table-card" style="padding:2rem">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem">
  ...
  <select class="form-input" id="pos-sucursal" style="width:100%" onchange="actualizarInventarioPOS()">
    ${i.map(p=>`<option value="${p.id}">${p.nombre}</option>`).join("")}
            ...
            <div style="display:flex;gap:6px;flex-wrap:wrap" id="pos-categorias">
              ...
              ${[...new Set(a.map(p=>p.categoria).filter(Boolean))].map(p=>`
    ...
    `,renderProductosPOS(a.filter(p=>p.activo))}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando punto de venta</p>'}}window.abrirDrawerPOS=()=>{renderDrawerPOS();const e=document.getElementById("pos-drawer"),t=document.getElementById("pos-drawer-overlay");e&&e.classList.add("open"),t&&t.classList.add("active"),document.body.style.overflow="hidden"};window.cerrarDrawerPOS=()=>{const e=document.getElementById("pos-drawer"),t=document.getElementById("pos-drawer-overlay");e&&e.classList.remove("open"),t&&t.classList.remove("active"),document.body.style.overflow=""};window.renderDrawerPOS=()=>{const e=window._posCarrito,t=document.getElementById("pos-drawer-items");if(!t)return;const a=e.reduce((p,m)=>p+m.cantidad,0),o=e.reduce((p,m)=>p+m.cantidad*m.precio_unitario,0),n=e.some(p=>p.es_corrida)?"Corrida":a>=6?"Mayoreo 6+":a>=3?"Mayoreo 3+":"Menudeo",r=document.getElementById("pos-drawer-pares"),i=document.getElementById("pos-drawer-total"),s=document.getElementById("pos-drawer-tipo");if(r&&(r.textContent=a),i&&(i.textContent="$"+o.toFixed(2)),s&&(s.textContent=n),!e.length){t.innerHTML='<p style="color:#888;text-align:center;padding:2rem">El carrito esta vacio</p>';return}const d=e.filter(p=>!p.es_corrida),l=e.filter(p=>p.es_corrida),c={};l.forEach(p=>{const m=p.producto_id+"|"+p.color;c[m]||(c[m]={nombre:p.nombre,color:p.color,producto_id:p.producto_id,tallas:[],subtotal:0,imagen:p.imagen||null}),c[m].tallas.push({talla:p.talla,cantidad:p.cantidad}),c[m].subtotal+=p.cantidad*p.precio_unitario}),t.innerHTML=`
  ...
  `).join(""),a.style.display="block"};window.seleccionarClientePOS=(e,t)=>{document.getElementById("pos-cliente").value=e,document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-resultados").style.display="none";const a=document.getElementById("pos-cliente-seleccionado");a.textContent="✔ "+t+" — toca para cambiar",a.style.display="block"};window.limpiarClientePOS=()=>{document.getElementById("pos-cliente").value="",document.getElementById("pos-cliente-seleccionado").style.display="none",document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-buscar").focus()};window.renderProductosPOS=e=>{const{variantes:t,inventario:a}=window._posData,o=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=a.filter(i=>i.sucursal_id===o),r=document.getElementById("pos-productos-grid");r&&(r.innerHTML=e.filter(i=>i.activo).map(i=>{const s=t.filter(c=>c.producto_id===i.id),d=[...new Set(s.map(c=>c.color).filter(Boolean))],l=s.reduce((c,p)=>{const m=n.find(u=>u.variante_id===p.id);return c+(m?m.cantidad:0)},0);return`
    ...
    <div style="background:white;border-radius:16px;max-width:640px;width:100%;height:90vh;display:flex;flex-direction:column;overflow:hidden">
      ...
      <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
          ${l.map(p=>{const m=d.find(g=>g.color===p),u=d.filter(g=>g.color===p).reduce((g,y)=>{const f=s.find(h=>h.variante_id===y.id);return g+(f?f.cantidad:0)},0);return`
  ...
  `,document.body.appendChild(c),c.addEventListener("click",p=>{p.target===c&&c.remove()}),window._posSeleccion={productoId:e,color:null},window._posBuffer={}};window.mostrarCorridaModalPOS=e=>{const{variantes:t,inventario:a}=window._posData,o=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=a.filter(p=>p.sucursal_id===o),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],i=[...new Set(t.filter(p=>p.producto_id===e).map(p=>p.color).filter(Boolean))],s=document.querySelector(`button[onclick="mostrarCorridaModalPOS('${e}')"]`);s&&(s.style.display="none"),document.querySelectorAll("#pos-modal").forEach(p=>{p!==document.getElementById("pos-modal")&&p.remove()}),window._posSeleccion.color=null,window._corridaCantidades={};const d=document.getElementById("pos-tallas-panel");if(!d)return;const l=p=>{const m=t.filter(u=>u.producto_id===e&&u.color===p).sort((u,g)=>r.indexOf(u.talla)-r.indexOf(g.talla));m.filter(u=>{const g=n.find(y=>y.variante_id===u.id);return g&&g.cantidad>0}),d.innerHTML=`
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:16px">
        ${i.map(u=>{const g=t.find(v=>v.producto_id===e&&v.color===u),y=g?g.color_hex:"#888",f=g?g.foto_url:null,h=Object.entries(window._corridaCantidades).filter(([v])=>t.find(w=>w.id===v&&w.color===u)).reduce((v,[,w])=>v+w,0);return`
            <div onclick="window._corridaColorActivo='${u}';renderCorridaColor('${u}')"
              ...
              ${f?`<img src="${f}" style="width:44px;height:44px;object-fit:cover;border-radius:6px">`:`<div style="width:44px;height:44px;border-radius:6px;background:${y}"></div>`}
          ...
          `}).join("")}
           ...
           <div style="display:flex;flex-direction:column;gap:8px">
        ${m.map(u=>{const g=n.find(h=>h.variante_id===u.id),y=g?g.cantidad:0,f=window._corridaCantidades[u.id]||0;return`
            <div style="display:flex;align-items:center;gap:10px;opacity:${y===0?"0.4":"1"}">
              ...
              <div style="display:flex;align-items:center;gap:6px">
                ...
                <input type="number" min="0" max="${y}"
                       ...
                       id="qty-corrida-${u.id}"
                       ${y===0?"disabled":""}
                       style="width:56px;height:40px;text-align:center;padding:4px;border:2px solid ${f>0?"#6a1b9a":"#ddd"};border-radius:8px;font-size:1rem;font-weight:700"
    ...
    `)};window.sugerirCorrida=(e,t)=>{const{variantes:a,inventario:o}=window._posData,n=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=o.filter(c=>c.sucursal_id===n),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],s=a.filter(c=>c.producto_id===e&&c.color===t).sort((c,p)=>i.indexOf(c.talla)-i.indexOf(p.talla)),d=s.filter(c=>{const p=r.find(m=>m.variante_id===c.id);return p&&p.cantidad>0}),l=d.some(c=>c.talla.includes("."));if(s.forEach(c=>{window._corridaCantidades[c.id]=0}),l)d.slice(0,6).forEach(c=>{window._corridaCantidades[c.id]=1});else{const c=d.slice(0,5);c.length>=4?c.forEach((p,m)=>{window._corridaCantidades[p.id]=m===1||m===2?2:1}):d.slice(0,6).forEach(p=>{window._corridaCantidades[p.id]=Math.ceil(6/d.length)})}window.renderCorridaColor(t)};window.confirmarCorridaNueva=e=>{const{variantes:t}=window._posData,a=window._posData.productos.find(r=>r.id===e);if(!a)return;let o=0;if(Object.entries(window._corridaCantidades).forEach(([r,i])=>{var l;if(i<=0)return;const s=t.find(c=>c.id===r);if(!s)return;const d=window._posCarrito.find(c=>c.variante_id===r&&c.es_corrida);d?(d.cantidad+=i,d.es_corrida=!0):window._posCarrito.push({variante_id:r,producto_id:e,nombre:a.nombre,color:s.color,talla:s.talla,cantidad:i,precio_menudeo:parseFloat(a.precio_menudeo)||0,precio_mayoreo3:parseFloat(a.precio_mayoreo3)||parseFloat(a.precio_menudeo)-30,precio_mayoreo6:parseFloat(a.precio_mayoreo6)||parseFloat(a.precio_menudeo)-70,precio_corrida:parseFloat(a.precio_corrida)||parseFloat(a.precio_menudeo)-100,es_corrida:!0,imagen:((l=window._posData.variantes.find(c=>c.id===r))==null?void 0:l.foto_url)||a.imagen_principal||null,precio_unitario:parseFloat(a.precio_corrida)||parseFloat(a.precio_menudeo)-100}),o++}),o===0){alert("Agrega al menos una talla");return}const n=document.getElementById("pos-modal");n&&n.remove(),window._corridaCantidades={},renderCarritoPOS()};window.seleccionarColorModalPOS=(e,t)=>{const{variantes:a,inventario:o}=window._posData,n=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=o.filter(u=>u.sucursal_id===n),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._posSeleccion&&window._posSeleccion.color&&guardarBufferColor(e,window._posSeleccion.color),document.querySelectorAll('[id^="pos-color-btn-"]').forEach(u=>{u.style.borderColor="#ddd",u.style.background="transparent"});const s=document.getElementById("pos-color-btn-"+t.replace(/\s/g,"_"));s&&(s.style.borderColor="#E91E8C",s.style.background="#fce4f3"),window._posSeleccion.color=t;const d=a.filter(u=>u.producto_id===e&&u.color===t).sort((u,g)=>i.indexOf(u.talla)-i.indexOf(g.talla)),l=d[0]?d[0].foto_url:null,c=document.getElementById("pos-modal-img");c&&l&&(c.src=l);const p=window._posBuffer[t]||{},m=document.getElementById("pos-tallas-panel");m&&(m.innerHTML=`
      <p style="font-size:0.75rem;color:#888;font-weight:600;margin-bottom:10px">TALLAS — ${t}</p>
      <div style="display:flex;flex-direction:column;gap:8px">
        ${d.map(u=>{const g=r.find(h=>h.variante_id===u.id),y=g?g.cantidad:0,f=p[u.id]||0;return`
            <div style="display:flex;align-items:center;gap:10px;opacity:${y===0?"0.4":"1"}">
              ...
              <div style="display:flex;align-items:center;gap:6px">
                ...
                <input type="number" min="0" max="${y}"
                       ...
                       id="qty-modal-${u.id}"
                       ${y===0?"disabled":""}
                       style="width:50px;text-align:center;padding:5px;border:2px solid ${f>0?"#E91E8C":"#ddd"};border-radius:8px;font-size:1rem;font-weight:700"
  ...
  <div style="padding:10px;border-bottom:1px solid #f5f5f5;background:#fdf4ff" data-corrida-key="${g}">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-top:6px;flex-wrap:wrap;gap:8px">
      ...
      <div style="display:flex;align-items:center;gap:6px">
        ...
        <input type="number" value="${(y.subtotal/y.tallas.reduce((f,h)=>f+h.cantidad,0)).toFixed(2)}"
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-top:6px">
      <span style="font-size:0.78rem;color:#888">${y.tallas.reduce((f,h)=>f+h.cantidad,0)} pares</span>
      <p id="subtotal-corrida-${g.replace("|","-")}" style="font-size:0.95rem;font-weight:700;color:#6a1b9a">$${y.subtotal.toFixed(2)}</p>
    </div>
  </div>
`).join("")}
    `;const d=document.getElementById("pos-total"),l=document.getElementById("pos-total-pares"),c=document.getElementById("pos-tipo-precio");d&&(d.textContent="$"+o.toFixed(2)),l&&(l.textContent=a),c&&(c.textContent=n);const p=document.getElementById("pos-flotante-pares"),m=document.getElementById("pos-flotante-total");p&&(p.textContent=a+" pares"),m&&(m.textContent="$"+o.toFixed(2)),(u=document.getElementById("pos-drawer"))!=null&&u.classList.contains("open")&&renderDrawerPOS()};window.editarPrecioPOS=(e,t)=>{if(!window._posCarrito[e])return;const a=parseFloat(t)||0;window._posCarrito[e].precio_unitario=a,window._posCarrito[e].precio_manual=!0;const o=window._posCarrito[e].cantidad,n=document.getElementById("subtotal-item-"+e);n&&(n.textContent="$"+(o*a).toFixed(2));const r=window._posCarrito.reduce((s,d)=>s+d.cantidad*d.precio_unitario,0),i=document.getElementById("pos-total");i&&(i.textContent="$"+r.toFixed(2))};window.editarPrecioCorridaPOS=(e,t)=>{const[a,o]=e.split("|"),n=parseFloat(t)||0;window._posCarrito.forEach(c=>{c.producto_id===a&&c.color===o&&c.es_corrida&&(c.precio_unitario=n,c.precio_manual=!0)});const i=window._posCarrito.filter(c=>c.producto_id===a&&c.color===o&&c.es_corrida).reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),s=document.getElementById("subtotal-corrida-"+e.replace("|","-"));s&&(s.textContent="$"+i.toFixed(2));const d=window._posCarrito.reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),l=document.getElementById("pos-total");l&&(l.textContent="$"+d.toFixed(2))};window.editarCorridaEnCarrito=e=>{const[t,a]=e.split("|"),{inventario:o,variantes:n}=window._posData,r=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",i=o.filter(c=>c.sucursal_id===r),s=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=n.filter(c=>c.producto_id===t&&c.color===a).sort((c,p)=>s.indexOf(c.talla)-s.indexOf(p.talla)),l=document.createElement("div");l.id="pos-modal-editar-corrida",l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",l.innerHTML=`
  ...
  `),c.document.close()};window.generarPDFPedido=async e=>{const a=await(await fetch(b+"/pedidos/"+e)).json();if(!a||a.length===0)return;const o=a[0],n=o.pedido_items||[],r=o.clientes||{},i=new Date(o.created_at).toLocaleDateString("es-MX",{year:"numeric",month:"long",day:"numeric"}),s=o.total||0,d=n.reduce((c,p)=>c+p.cantidad,0),l=window.open("","_blank");l.document.write(`
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="UTF-8">
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
      ...
      </div>`,window._historialData=a}catch{e.innerHTML='<p style="padding:2rem;color:var(--red)">Error conectando con el servidor</p>'}}window.cancelarMovimiento=async(e,t,a,o,n)=>{if(confirm("¿Cancelar este movimiento? Se revertirá el cambio en el inventario."))try{const i=await(await fetch(b+"/inventario/?variante_id=eq."+a+"&sucursal_id=eq."+o)).json(),s=i&&i.length>0?i[0].cantidad:0,d=n==="venta"?s+t:Math.max(0,s-t);(await fetch(b+"/inventario/actualizar",{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:a,sucursal_id:o,cantidad:d,stock_minimo:i&&i.length>0?i[0].stock_minimo:3})})).ok?(alert("Movimiento cancelado. Inventario actualizado."),Ee()):alert("Error al actualizar inventario")}catch{alert("Error conectando con el servidor")}};window.filtrarHistorial=()=>{const e=document.getElementById("hist-tipo").value,t=document.getElementById("hist-buscar").value.toLowerCase(),a=window._historialData||[],o={venta:{label:"Venta",badge:"badge-success"},entrada:{label:"Entrada",badge:"badge-info"},ajuste:{label:"Ajuste",badge:"badge-warning"},traspaso_salida:{label:"Traspaso salida",badge:"badge-danger"},traspaso_entrada:{label:"Traspaso entrada",badge:"badge-info"},cambio_salida:{label:"Cambio salida",badge:"badge-info"},cambio_entrada:{label:"Cambio entrada",badge:"badge-info"}},n=a.filter(i=>{if(e&&i.tipo!==e)return!1;if(t){const s=(i.variantes&&i.variantes.productos?i.variantes.productos.nombre:"").toLowerCase(),d=(i.motivo||"").toLowerCase();if(!s.includes(t)&&!d.includes(t))return!1}return!0}),r=document.getElementById("hist-tbody");r&&(r.innerHTML=n.length===0?'<tr><td colspan="9" style="text-align:center;color:var(--text-muted);padding:2rem">No se encontraron movimientos</td></tr>':n.map(i=>{const s=o[i.tipo]||{label:i.tipo,badge:"badge-warning"},d=i.cantidad||0;return`<tr>
      ...
      ${z.length===0?'<p style="color:#aaa;font-size:0.85rem;text-align:center;padding:1rem">Sin tareas pendientes</p>':z.map(B=>`
        ...
        `).join("")}
    `,document.getElementById("dashboard-contenido").appendChild(P)}catch(E){console.error("tareas:",E)}}catch(e){console.error("Error dashboard:",e)}}window.eliminarItemPedido=e=>{window._pedidoItems.splice(e,1),window.recalcularTotal(),window.renderItemsPedido()};window.cerrarSesionPanel=()=>{confirm("Cerrar sesion?")&&(sessionStorage.removeItem("erp_empleado"),sessionStorage.removeItem("erp_token"),window._empleadoActual=null,location.reload())};async function _e(){const e=document.getElementById("content");try{const a=await(await fetch(b+"/empleados/",{headers:window.authHeaders()})).json();e.innerHTML=`
      <div class="table-card">
        <div class="table-header">
      ...
      </div>`}catch{e.innerHTML='<p style="padding:2rem;color:var(--red)">Error conectando con el servidor</p>'}}window.mostrarFormEmpleado=async e=>{const t=document.getElementById("content");let a={};if(e)try{a=(await(await fetch(b+"/empleados/",{headers:window.authHeaders()})).json()).find(r=>r.id===e)||{}}catch{}t.innerHTML=`
...
`);await fetch(b+"/chatbot/chats/"+e+"/imagen",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:t,caption:d,agente:n})})}else await fetch(b+"/chatbot/chats/"+e+"/mensaje",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mensaje:a,agente:n})});await new Promise(d=>setTimeout(d,1500));const s=await(await fetch(b+"/chatbot/chats")).json();window._chatsData={},s.forEach(d=>window._chatsData[d.telefono]=d),abrirChat(e)}catch{alert("Error enviando producto")}};window.cargarEnviosMasivos=async function(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[t,a,o]=await Promise.all([fetch(b+"/chatbot/plantillas").then(i=>i.json()),fetch(b+"/clientes/").then(i=>i.json()),fetch(b+"/chatbot/chats").then(i=>i.json())]),n={};a.forEach(i=>{i.telefono&&(n[i.telefono]={telefono:i.telefono,nombre:i.nombre,fuente:"cliente"})}),o.forEach(i=>{n[i.telefono]||(n[i.telefono]={telefono:i.telefono,nombre:i.nombre||i.telefono,fuente:"whatsapp",etiqueta:i.etiqueta})});const r=Object.values(n);window._envioContactos=r,window._envioChats=o,window._envioClientes=a,e.innerHTML=`
...
<div>
  ...
  <div style="display:flex;gap:1rem;flex-wrap:wrap">
    ...
    </div>`,e&&fetch(b+"/catalogos/"+e).then(a=>a.json()).then(a=>{const o=Array.isArray(a)?a[0]:a;o&&(document.getElementById("cat-nombre").value=o.nombre||"",document.getElementById("cat-temporada").value=o.temporada||"",o.portada_url&&(document.getElementById("cat-portada-url").value=o.portada_url,document.getElementById("cat-portada-nombre").textContent="Portada actual",document.getElementById("cat-portada-preview").innerHTML=`<img src="${o.portada_url}" style="height:80px;border-radius:6px;object-fit:cover">`))}))};window.previewPortadaCat=function(e){const t=e.files[0];if(!t)return;document.getElementById("cat-portada-nombre").textContent=t.name;const a=new FileReader;a.onload=o=>{document.getElementById("cat-portada-preview").innerHTML=`<img src="${o.target.result}" style="height:80px;border-radius:6px;object-fit:cover">`},a.readAsDataURL(t)};window.guardarCatalogo=async function(e){const t=document.getElementById("cat-nombre").value.trim();if(!t){alert("El nombre es obligatorio");return}const a=document.getElementById("cat-temporada").value.trim();let o=document.getElementById("cat-portada-url").value;const n=document.getElementById("cat-portada-file");if(n.files.length>0){const i=new FormData;i.append("archivo",n.files[0]),i.append("carpeta","catalogos");try{o=(await(await fetch(b+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:i})).json()).url||o}catch(s){alert("Error subiendo portada: "+s.message);return}}const r={nombre:t,temporada:a,portada_url:o||null};try{e?await fetch(b+"/catalogos/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}):await fetch(b+"/catalogos/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),await le()}catch(i){alert("Error guardando: "+i.message)}};window.toggleCatalogo=async function(e,t){confirm(t?"¿Ocultar este catálogo de la tienda?":"¿Publicar este catálogo en la tienda?")&&(await fetch(b+"/catalogos/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({activo:!t})}),await le())};window.gestionarPaginas=async function(e,t){const a=document.getElementById("content");a.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[o,n]=await Promise.all([fetch(b+"/catalogos/"+e),fetch(b+"/catalogos/"+e+"/paginas")]),r=await o.json(),i=Array.isArray(r)?r[0]:r,s=await n.json();window._catalogoPaginasData={catalogoId:e,nombre:t,paginas:s,tabActiva:"subir",portada_url:(i==null?void 0:i.portada_url)||null},qe()}catch(o){a.innerHTML='<p style="padding:2rem;color:red">Error: '+o.message+"</p>"}};function se(e,t){return`padding:9px 18px;font-size:0.83rem;font-weight:600;border:none;cursor:pointer;border-bottom:3px solid ${e===t?"#C8967A":"transparent"};background:none;color:${e===t?"#C8967A":"#6b7280"};transition:all 0.2s;font-family:inherit`}function qe(){const{catalogoId:e,nombre:t,paginas:a,tabActiva:o,portada_url:n}=window._catalogoPaginasData,r=document.getElementById("content");a.length>0&&Math.max(...a.map(i=>i.pagina_numero))+1,r.innerHTML=`
    <div class="table-card">
      <div class="table-header">
      ...
      <div style="display:flex;border-bottom:2px solid #e5e7eb;margin-bottom:20px;gap:4px">
        <button style="${se(o,"subir")}" onclick="switchTabCat('subir')">📁 Subir imágenes</button>
        <button style="${se(o,"seleccionar")}" onclick="switchTabCat('seleccionar')">🖼 De la tienda</button>
        <button style="${se(o,"generar")}" onclick="switchTabCat('generar')">✨ Generar automático</button>
      </div>
    ...
    </div>`,o==="seleccionar"&&Ce(e),o==="generar"&&ke(e)}window.switchTabCat=function(e){const{catalogoId:t}=window._catalogoPaginasData;window._catalogoPaginasData.tabActiva=e,document.querySelectorAll("#tab-subir,#tab-seleccionar,#tab-generar").forEach(a=>a.style.display="none"),document.getElementById("tab-"+e).style.display="block",document.querySelectorAll('[onclick^="switchTabCat"]').forEach(a=>{var n;const o=(n=a.getAttribute("onclick").match(/'(\w+)'/))==null?void 0:n[1];a.style.borderBottomColor=o===e?"#C8967A":"transparent",a.style.color=o===e?"#C8967A":"#6b7280"}),e==="seleccionar"&&Ce(t),e==="generar"&&ke(t)};window.descargarCatalogoPDF=async function(){const e=window._catalogoPaginasData;if(!e)return;const{portada_url:t,paginas:a,nombre:o}=e,n=[];if(t&&n.push(t),[...a].sort((s,d)=>s.pagina_numero-d.pagina_numero).forEach(s=>{s.imagen_url&&n.push(s.imagen_url)}),n.length===0){alert("No hay páginas para descargar.");return}const i=document.querySelector('[onclick="descargarCatalogoPDF()"]');i&&(i.disabled=!0,i.textContent="⏳ Generando PDF...");try{window.jspdf||await new Promise((f,h)=>{const v=document.createElement("script");v.src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js",v.onload=f,v.onerror=h,document.head.appendChild(v)});const{jsPDF:s}=window.jspdf,d=f=>new Promise(h=>{const v=new Image;v.crossOrigin="anonymous",v.onload=()=>{const w=document.createElement("canvas");w.width=v.naturalWidth||v.width,w.height=v.naturalHeight||v.height,w.getContext("2d").drawImage(v,0,0),h({dataUrl:w.toDataURL("image/jpeg",.92),w:w.width,h:w.height})},v.onerror=()=>h(null),v.src=f}),c=(await Promise.all(n.map(d))).filter(Boolean);if(c.length===0){alert("No se pudieron cargar las imágenes. Revisa tu conexión.");return}const p=210,m=280,u=new s({unit:"mm",format:[p,m]}),g=(f,h)=>{h||u.addPage([p,m]);const v=f.w/f.h,w=p/m;let k,x,C,_;v>w?(k=p,x=p/v,C=0,_=(m-x)/2):(x=m,k=m*v,_=0,C=(p-k)/2),u.addImage(f.dataUrl,"JPEG",C,_,k,x)};c.forEach((f,h)=>g(f,h===0));const y=(o||"catalogo").replace(/[^a-zA-Z0-9_\-áéíóúñÁÉÍÓÚÑ ]/g,"").trim()||"catalogo";u.save(`${y}.pdf`)}catch(s){console.error("Error generando PDF:",s),alert("Error al generar el PDF: "+s.message)}finally{i&&(i.disabled=!1,i.innerHTML="📥 Descargar PDF")}};async function Ce(e){const t=document.getElementById("selector-tienda-content");if(t)try{const[a,o]=await Promise.all([fetch(b+"/variantes/"),fetch(b+"/productos/")]),n=await a.json(),r=await o.json(),i=[];n.forEach(d=>{const l=r.find(p=>p.id===d.producto_id),c=(l==null?void 0:l.nombre)||d.sku||"";d.foto_url&&i.push({url:d.foto_url,nombre:c,color:d.color||""}),d.imagenes&&Array.isArray(d.imagenes)&&d.imagenes.forEach(p=>{p&&p!==d.foto_url&&i.push({url:p,nombre:c,color:d.color||""})})});const s=i.filter((d,l,c)=>c.findIndex(p=>p.url===d.url)===l);window._selectorFotos={fotos:s,seleccionadas:new Set},t.innerHTML=`
      ...
      </div>`}catch(a){t.innerHTML='<p style="color:red">Error: '+a.message+"</p>"}}window._toggleGenProd=function(e){const{seleccionados:t}=window._generadorData,a=document.getElementById("gen-item-"+e),o=document.getElementById("gen-colores-"+e);t.has(e)?(t.delete(e),a.style.borderColor="transparent",o&&(o.style.opacity="0.35",o.style.pointerEvents="none")):(t.add(e),a.style.borderColor="#C8967A",o&&(o.style.opacity="1",o.style.pointerEvents="auto")),document.getElementById("gen-count").textContent=t.size+" seleccionados"};window._toggleColorGen=function(e,t){var n,r;const a=document.getElementById(`gen-col-${e}-${t}`);if(!a)return;const o=a.dataset.sel==="1";a.dataset.sel=o?"0":"1",a.style.borderColor=o?"#ccc":"#C8967A",a.style.opacity=o?"0.3":"1",a.title=(((r=(n=window._generadorData.coloresPorProd[e])==null?void 0:n[t])==null?void 0:r.color)||"")+(o?" (excluido)":"")};window._selTodosGenerador=function(){const{productos:e,seleccionados:t}=window._generadorData,a=t.size===e.length;t.clear(),e.forEach((o,n)=>{const r=document.getElementById("gen-item-"+n);a?r&&(r.style.borderColor="transparent"):(t.add(n),r&&(r.style.borderColor="#C8967A"))}),document.getElementById("gen-count").textContent=t.size+" seleccionados"};function ae(e){return new Promise(t=>{const a=new Image;a.crossOrigin="anonymous",a.onload=()=>t(a),a.onerror=()=>t(null),a.src=e+(e.includes("?")?"&":"?")+"_t="+Date.now()})}function ce(e,t,a,o,n,r){const i=t.split(" ");let s="",d=o;for(let l of i){const c=s+(s?" ":"")+l;e.measureText(c).width>n&&s?(e.fillText(s,a,d),s=l,d+=r):s=c}return s&&e.fillText(s,a,d),d+r}window.generarPaginasCanvas=async function(e){const{productos:t,variantes:a,seleccionados:o,coloresPorProd:n}=window._generadorData;if(!o.size){alert("Selecciona al menos un producto");return}const r=document.getElementById("gen-layout").value,i=r==="1e"?1:parseInt(r),s=[];Array.from(o).sort((f,h)=>f-h).forEach(f=>{const h=t[f],v=n?n[f]:[];if(!v||v.length<=1)s.push({prod:h,origIdx:f,colorFiltro:null,todosColSel:v||[]});else{const w=v.filter((x,C)=>{const _=document.getElementById(`gen-col-${f}-${C}`);return!_||_.dataset.sel!=="0"}),k=w.length>0?w:v;for(const x of k)s.push({prod:h,origIdx:f,colorFiltro:x.color,todosColSel:k})}});const d=f=>{const h=a.filter(v=>v.producto_id===f.prod.id&&v.activa!==!1);return f.colorFiltro?h.filter(v=>(v.color||"").trim()===f.colorFiltro):h},l=[];for(let f=0;f<s.length;f+=i)l.push(s.slice(f,f+i));const c=document.getElementById("btn-generar"),p=document.getElementById("gen-progress"),m=document.getElementById("gen-msg"),u=document.getElementById("gen-bar");c.disabled=!0,p.style.display="block";const{paginas:g}=window._catalogoPaginasData;let y=g.length>0?Math.max(...g.map(f=>f.pagina_numero))+1:1;for(let f=0;f<l.length;f++){const h=l[f],v=$=>($==null?void 0:$.prod)??$,w=$=>($==null?void 0:$.origIdx)??t.indexOf(($==null?void 0:$.prod)??$);m.textContent=`Generando página ${f+1} de ${l.length}...`,u.style.width=f/l.length*100+"%";const k=document.createElement("canvas");k.width=1080,k.height=1440;const x=k.getContext("2d");if(x.fillStyle="#FAFAF8",x.fillRect(0,0,1080,1440),x.fillStyle="#C8967A",x.fillRect(60,48,960,1),x.fillStyle="#2A1A0E",x.font="300 22px DM Sans, sans-serif",x.textAlign="center",x.letterSpacing="8px",x.fillText("ZAPATILLAS MAY",540,42),x.letterSpacing="0px",x.fillStyle="#C8967A",x.fillRect(60,58,960,1),r==="1e"){const $=h[0],T=v($),j=d($),S=[],I=new Set,M=A=>{A&&!I.has(A)&&(I.add(A),S.push(A))};j.length>0&&j[0].foto_url?M(j[0].foto_url):M(T.imagen_principal);for(const A of j)if(M(A.foto_url),Array.isArray(A.imagenes)&&A.imagenes.forEach(M),S.length>=3)break;const E=S.length,z=($.todosColSel||[]).map(A=>({color:A.color,hex:A.hex})),P={negro:"#1C1C1C",blanco:"#F8F8F8",hueso:"#F0EBE1",beige:"#D9C9A8",camel:"#C19A6B","cafe claro":"#A0725A","cafe medio":"#7A4A30","cafe oscuro":"#4A2010",cafe:"#6B3A2A",chocolate:"#3D1C02",cognac:"#9B4421",taupe:"#8B7355",nude:"#D4A97A","nude claro":"#E8C9A8","nude oscuro":"#C0886A","nude rosa":"#DDA090","palo de rosa":"#D4A0A0",salmon:"#FA8072",coral:"#FF6B4A",rojo:"#CC2200",vino:"#722F37",bordo:"#800020","rosa claro":"#F9C0CB",rosa:"#F4607A",fusha:"#E91E8C",naranja:"#FF8C00",amarillo:"#F5C518",dorado:"#D4AF37",oro:"#CFB53B","oro rosa":"#E8B4B8",plateado:"#C0C0C0","azul claro":"#5B8DB8",azul:"#1E4080","azul marino":"#001F5B",turquesa:"#40C4AA",verde:"#2D6A4F","verde menta":"#98D8C8","gris claro":"#C8C8C8",gris:"#909090","gris oscuro":"#505050",morado:"#7B2D8B",lila:"#C8A0D8",multicolor:"#CCAA88"},B=({color:A,hex:H})=>{if(H&&H.startsWith("#"))return H;const L=(A||"").toLowerCase();if(P[L])return P[L];for(const[O,N]of Object.entries(P))if(L.includes(O))return N;return"#BBAA99"},D=(A,H,L,O,N)=>{if(x.save(),x.fillStyle="#FFFFFF",x.fillRect(H,L,O,N),A){x.beginPath(),x.rect(H,L,O,N),x.clip();const R=A.naturalWidth/A.naturalHeight,G=O/N;let U,J,K,X;R>G?(K=O,X=O/R,U=H,J=L+(N-X)/2):(X=N,K=N*R,J=L,U=H+(O-K)/2),x.drawImage(A,U,J,K,X)}x.restore()},F=62,q=1080,V=F+q+12;if(E>=3){const[A,H,L]=await Promise.all(S.slice(0,3).map(ae)),O=10,N=10,R=648,G=1080-R-O,U=Math.floor((q-N)/2);D(A,0,F,R,q),D(H,R+O,F,G,U),D(L,R+O,F+U+N,G,U)}else if(E===2){const[A,H]=await Promise.all(S.map(ae)),L=10,O=Math.floor((1080-L)/2);D(A,0,F,O,q),D(H,O+L,F,O,q)}else{const[A]=await Promise.all([ae(S[0])]);D(A,40,F,1e3,q)}if(x.fillStyle="#E8DDD5",x.fillRect(0,V,1080,1),x.fillStyle="#2A1A0E",x.textAlign="center",x.font="300 28px DM Sans, sans-serif",x.letterSpacing="3px",ce(x,T.nombre.toUpperCase(),540,V+42,960,38),x.letterSpacing="0px",T.sku&&(x.fillStyle="#A07860",x.font="400 14px DM Mono, monospace",x.fillText(T.sku,540,V+66)),z.length>0){const L=Math.min(z.length,14),O=L*(11*2)+(L-1)*8;let N=Math.round(540-O/2+11);const R=V+100;for(let G=0;G<L;G++){const U=N+G*30;x.beginPath(),x.arc(U,R,11,0,Math.PI*2),x.fillStyle=B(z[G]),x.fill(),x.strokeStyle="rgba(0,0,0,0.18)",x.lineWidth=1.5,x.stroke()}}}else{const $=i<=2?i:2,T=i===4?2:1,j=80,S=100,I=i===1?0:20,M=i===4?20:0,E=i===1?40:28,z=(1080-E*2-I*($-1))/$,P=(1440-j-S-M*(T-1))/T;for(let B=0;B<h.length;B++){const D=v(h[B]);w(h[B]);const F=B%$,q=Math.floor(B/$),V=E+F*(z+I),A=j+q*(P+M),H=i===1?120:i===2?90:70,L=P-H,O=d(h[B]),N=O.length>0&&O[0].foto_url?O[0].foto_url:D.imagen_principal,R=await ae(N);if(x.save(),x.fillStyle="#FFFFFF",x.fillRect(V,A,z,L),R){x.beginPath(),x.rect(V,A,z,L),x.clip();const J=R.naturalWidth/R.naturalHeight,K=z/L;let X,ie,te,oe;J>K?(te=z,oe=z/J,X=V,ie=A+(L-oe)/2):(oe=L,te=L*J,ie=A,X=V+(z-te)/2),x.drawImage(R,X,ie,te,oe)}x.restore(),x.fillStyle="#E8DDD5",x.fillRect(V,A+L,z,1);const G=A+L+H/2;x.fillStyle="#2A1A0E",x.textAlign="center";const U=i===1?34:i===2?24:19;x.font=`300 ${U}px DM Sans, sans-serif`,x.letterSpacing="2px",ce(x,D.nombre.toUpperCase(),V+z/2,G-8,z-32,U+10),x.letterSpacing="0px",D.sku&&(x.fillStyle="#A07860",x.font=`400 ${i===1?18:13}px DM Mono, monospace`,x.fillText(D.sku,V+z/2,G+(i===1?36:26)))}}x.fillStyle="#C8967A",x.fillRect(60,1340,960,1),x.fillStyle="#A07860",x.font="300 18px DM Sans, sans-serif",x.textAlign="center",x.letterSpacing="3px",x.fillText("@ZAPATILLASMAY",540,1368),x.letterSpacing="0px",x.fillStyle="#C0A898",x.font="300 15px DM Sans, sans-serif",x.fillText("zapatillasmay.mx  ·  León, Guanajuato",540,1394);const C=await new Promise($=>k.toBlob($,"image/jpeg",.92)),_=new FormData;_.append("archivo",C,`catalogo-pag-${y}.jpg`);try{const T=await(await fetch(b+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:_})).json();T.url&&await fetch(b+"/catalogos/"+e+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:T.url,pagina_numero:y++})})}catch($){console.error("Error subiendo página generada",$)}}u.style.width="100%",m.textContent=`✅ ${l.length} páginas generadas`,setTimeout(()=>{p.style.display="none"},2e3),c.disabled=!1,await gestionarPaginas(e,window._catalogoPaginasData.nombre)};window.subirPaginasCatalogo=async function(e,t){const a=Array.from(e.files||e);if(!a.length)return;const o=document.getElementById("upload-progress"),n=document.getElementById("upload-msg"),r=document.getElementById("upload-bar");o&&(o.style.display="block");const{paginas:i}=window._catalogoPaginasData;let s=i.length>0?Math.max(...i.map(d=>d.pagina_numero))+1:1;for(let d=0;d<a.length;d++){n&&(n.textContent=`Subiendo ${d+1} de ${a.length}...`),r&&(r.style.width=d/a.length*100+"%");try{const l=new FormData;l.append("archivo",a[d]);const p=await(await fetch(b+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:l})).json();p.url&&await fetch(b+"/catalogos/"+t+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:p.url,pagina_numero:s++})})}catch(l){console.error("Error subiendo página "+(d+1),l)}}r&&(r.style.width="100%"),n&&(n.textContent="✅ Listo"),setTimeout(()=>{o&&(o.style.display="none")},1500),e.value!==void 0&&(e.value=""),await gestionarPaginas(t,window._catalogoPaginasData.nombre)};window.moverPagina=async function(e,t){const{paginas:a,catalogoId:o,nombre:n}=window._catalogoPaginasData,r=a.findIndex(l=>l.id===e);if(r===-1)return;const i=t==="up"?r-1:r+1;if(i<0||i>=a.length)return;const s=a[r].pagina_numero,d=a[i].pagina_numero;await Promise.all([fetch(b+"/catalogos/paginas/"+a[r].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:d})}),fetch(b+"/catalogos/paginas/"+a[i].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:s})})]),await gestionarPaginas(o,n)};window.eliminarPagina=async function(e,t){confirm("¿Eliminar esta página?")&&(await fetch(b+"/catalogos/paginas/"+e,{method:"DELETE"}),await gestionarPaginas(t,window._catalogoPaginasData.nombre))};window.usarComoPortada=async function(e,t){await fetch(b+"/catalogos/"+t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({portada_url:e})}),alert("✅ Portada actualizada")};window.mlVerStock=async function(e){const t=e.innerHTML;e.innerHTML="⏳ Consultando...",e.disabled=!0;const a=document.getElementById("ml-resultado");try{const n=await(await fetch(b+"/ml/stock")).json();if(a.style.display="block",n.diferencias&&n.diferencias.length>0){const r=n.diferencias.map(i=>`${i.item_id} | SKU: ${i.seller_sku} | ML: ${i.qty_ml} | ERP: ${i.qty_erp}`).join(`
...
`):"")}}catch(i){a.style.display="block",a.textContent="Error: "+i.message}e.innerHTML=t,e.disabled=!1};async function ze(e,t){var i,s,d,l,c,p;const a=document.getElementById("ml-pub-sku").value.trim(),o=document.getElementById("ml-pub-listing").value,n=document.getElementById("ml-pub-resultado"),r=t.innerHTML;if(!a){alert("Ingresa el SKU del producto (ej: M-SAN-0148)");return}t.innerHTML=e?"⏳ Generando preview...":"⏳ Publicando en ML...",t.disabled=!0,n.style.display="none";try{const m=await fetch(b+"/ml/publicar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sku_interno:a.toUpperCase().trim(),listing_type:o,solo_preview:e})}),u=await m.json();if(n.style.display="block",!m.ok){n.textContent="❌ Error: "+(u.detail||JSON.stringify(u));return}if(e){const g=(i=u.resultados)==null?void 0:i[0];if(!g){n.textContent="Sin resultados";return}const y=g.preview;let f=`=== PREVIEW — ${u.producto} (${u.total} variantes) ===

`;f+=`Producto:    ${u.producto} (${u.categoria})
`,f+=`Category ID: ${u.category_id}
`,f+=`Listing:     ${o}

`,f+=`--- Primera variante: ${g.sku} ---
`,f+=`Título:      ${y.title}
...
... y ${u.total-1} variantes más con la misma estructura.`,n.textContent=f}else{const g=((c=u.resultados)==null?void 0:c.filter(h=>h.status==="publicado"))||[],y=((p=u.resultados)==null?void 0:p.filter(h=>h.status==="error"))||[];let f=`=== RESULTADO — ${u.producto} ===
`;f+=`✅ Publicados: ${g.length}   ❌ Errores: ${y.length}

`,g.length&&(f+=`PUBLICADOS:
`,g.forEach(h=>{f+=`  ${h.sku} → ${h.item_id}
  ${h.permalink||""}
`})),y.length&&(f+=`
ERRORES:
`,y.forEach(h=>{var v;f+=`  ${h.sku}  [${h.codigo}] ${h.error}
`,(v=h.causas)!=null&&v.length&&h.causas.forEach(w=>{f+=`    ↳ ${w.code}: ${w.message}
`})})),n.textContent=f}}catch(m){n.style.display="block",n.textContent="Error inesperado: "+m.message}finally{t.innerHTML=r,t.disabled=!1}}window.mlPublicarPreview=function(e){ze(!0,e)};window.mlPublicarReal=function(e){confirm("¿Publicar TODAS las variantes activas de este producto en MercadoLibre? Esto creará nuevos items en tu cuenta.")&&ze(!1,e)};window.descargarExcelTikTok=async function(e,t,a){const o=e.innerHTML;try{e.innerHTML="⏳ Generando...",e.disabled=!0;const n=await fetch(`${b}/tiktok/${t}`);if(!n.ok){const d=await n.text();throw new Error(`Error ${n.status}: ${d}`)}const r=await n.blob(),i=URL.createObjectURL(r),s=document.createElement("a");s.href=i,s.download=a,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(i)}catch(n){alert("Error al descargar el archivo: "+n.message)}finally{e.innerHTML=o,e.disabled=!1}};async function Ve(){const e=document.getElementById("content");e.innerHTML=`
  ...
  `,document.getElementById("ml-titulo").addEventListener("input",function(){document.getElementById("ml-titulo-count").textContent=this.value.length}),window.mlGenerarPreview=async()=>{var l,c,p,m;const a=document.getElementById("ml-sku").value.trim().toUpperCase(),o=document.getElementById("ml-listing").value,n=document.getElementById("ml-titulo").value.trim(),r=document.getElementById("ml-precio").value.trim(),i=r?parseFloat(r):null;if(!a){alert("Ingresa el SKU del producto");return}if(!n){alert("Ingresa el título para ML");return}if(n.length>60){alert("El título no puede superar 60 caracteres");return}if(i!==null&&(isNaN(i)||i<=0)){alert("El precio debe ser mayor a 0");return}const s=document.getElementById("ml-btn-preview");s.textContent="⏳ Generando...",s.disabled=!0;let d=0;try{const u=await fetch(`${b}/ml/publicar`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sku_interno:a,listing_type:o,solo_preview:!0})}),g=await u.json();if(!u.ok){alert("Error: "+(g.detail||JSON.stringify(g)));return}const y=g.resultados||[];if(!y.length){alert("No se encontraron variantes activas");return}const f=document.getElementById("ml-descripcion"),h=((p=(c=(l=y[0])==null?void 0:l.preview)==null?void 0:c.description)==null?void 0:p.plain_text)||"";f.value.trim()||(f.value=h);const v=new Set,w=[];for(const x of y)for(const C of((m=x.preview)==null?void 0:m.pictures)||[])C.source&&!v.has(C.source)&&(v.add(C.source),w.push(C));if(w.length>=1){const x=document.getElementById("ml-fotos-wrap"),C=document.getElementById("ml-fotos-grid");C.innerHTML=w.map((_,$)=>`
        ...
        `).join(""),x.style.display="block",window.mlSeleccionarPortada=_=>{d=_,w.forEach(($,T)=>{var S;const j=document.getElementById(`ml-foto-thumb-${T}`);if(j&&(j.style.border=T===_?"3px solid #3483fa":"3px solid #ddd",(S=j.querySelector("div"))==null||S.remove(),T===_)){const I=document.createElement("div");I.style.cssText="position:absolute;bottom:0;left:0;right:0;background:#3483fa;color:#fff;font-size:0.6rem;text-align:center;padding:2px",I.textContent="PORTADA",j.appendChild(I)}}),t(y,n,i,d,f.value.trim(),w)}}t(y,n,i,d,f.value.trim());const k=document.getElementById("ml-variantes-wrap");k.style.display="block",k.scrollIntoView({behavior:"smooth",block:"start"})}catch(u){alert("Error de conexión: "+u.message)}finally{s.textContent="🔍 Generar preview",s.disabled=!1}};function t(a,o,n,r,i,s){const d=document.getElementById("ml-variantes-titulo"),l=document.getElementById("ml-variantes-list");d.textContent=`Paso 2 — Revisa y edita (${a.length} variantes, título aplicado a todas)`,l.innerHTML=a.map((c,p)=>{const m={...c.preview,family_name:o};if(delete m.title,n!==null&&(m.price=n),i&&(m.description={plain_text:i}),s&&s.length>0){let u=[...s];if(r>0&&r<u.length){const[g]=u.splice(r,1);u.unshift(g)}m.pictures=u.slice(0,12)}return`
        ...
        </details>`}).join("")}window.mlPublicarTodas=async()=>{if(!confirm("¿Publicar TODAS las variantes en MercadoLibre con los JSONs editados?"))return;const o=document.getElementById("ml-variantes-list").querySelectorAll("textarea"),n=[];for(let l=0;l<o.length;l++)try{n.push(JSON.parse(o[l].value))}catch(c){alert(`JSON inválido en variante ${l+1}: ${c.message}`);return}const r=document.getElementById("ml-btn-publicar");r.textContent="⏳ Publicando...",r.disabled=!0;const i=document.getElementById("ml-resultado"),s=document.getElementById("ml-resultado-titulo"),d=document.getElementById("ml-resultado-body");i.style.display="block",s.textContent="⏳ Publicando...",d.innerHTML='<p style="color:#888">Enviando a MercadoLibre...</p>';try{const c=await(await fetch(`${b}/ml/publicar-payloads`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({payloads:n})})).json(),p=c.publicados||0,m=c.errores||0;s.textContent=`✅ ${p} publicado(s)${m?` · ❌ ${m} con error`:""} de ${c.total||0}`,d.innerHTML=(c.resultados||[]).map(u=>`
      ...
      `).join("")||'<p style="color:#888">Sin detalles</p>'}catch(l){s.textContent="❌ Error de conexión",d.innerHTML=`<p style="color:red">${l.message}</p>`}finally{r.textContent="🚀 Publicar todas en ML",r.disabled=!1}}}let Z=null;async function Ge(){Z&&(clearInterval(Z),Z=null);const e=document.getElementById("content");e.innerHTML=`
  ...
  `,await Ue(),Z=setInterval(async()=>{document.getElementById("ga-activos")?await Se():(clearInterval(Z),Z=null)},3e4)}async function Ue(){await Promise.all([Se(),Xe(),Je()]),document.getElementById("ga-ultima-act").textContent="Actualizado: "+new Date().toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}async function Se(){try{const t=await(await fetch(`${b}/analytics/tiempo-real`)).json();if(!t.configurado){We(t);return}const a=document.getElementById("ga-activos");if(!a)return;a.textContent=t.activos_ahora??0;const o=document.getElementById("ga-dispositivos");o&&t.por_dispositivo&&(o.textContent=Object.entries(t.por_dispositivo).map(([n,r])=>`${n}: ${r}`).join(" · "))}catch(e){console.warn("GA realtime:",e.message)}}async function Xe(){var e;try{const a=await(await fetch(`${b}/analytics/hoy`)).json();if(!a.configurado)return;const o=(i,s)=>{const d=document.getElementById(i);d&&(d.textContent=s)};o("ga-sesiones",a.sesiones??"—"),o("ga-usuarios",a.usuarios_activos??"—"),o("ga-pageviews",a.paginas_vistas??"—"),o("ga-nuevos",a.usuarios_nuevos??"—");const n=a.duracion_promedio_s;o("ga-duracion",n?`${Math.floor(n/60)}m ${n%60}s`:"—"),o("ga-rebote",a.tasa_rebote!=null?`${a.tasa_rebote}%`:"—");const r=document.getElementById("ga-top-paginas");r&&((e=a.top_paginas)!=null&&e.length)&&(r.innerHTML=a.top_paginas.map(i=>`
        ...
        </div>`).join(""))}catch(t){console.warn("GA hoy:",t.message)}}async function Je(){var e;try{const a=await(await fetch(`${b}/analytics/semana`)).json();if(!a.configurado||!((e=a.dias)!=null&&e.length))return;const o=document.getElementById("ga-chart");if(!o||!window.Chart)return;o._chartInstance&&o._chartInstance.destroy(),o._chartInstance=new Chart(o,{type:"bar",data:{labels:a.dias.map(n=>n.fecha),datasets:[{label:"Sesiones",data:a.dias.map(n=>n.sesiones),backgroundColor:"rgba(52,131,250,0.7)",borderRadius:4},{label:"Usuarios",data:a.dias.map(n=>n.usuarios),backgroundColor:"rgba(34,197,94,0.5)",borderRadius:4}]},options:{responsive:!0,plugins:{legend:{position:"top"}},scales:{y:{beginAtZero:!0,ticks:{precision:0}}}}})}catch(t){console.warn("GA semana:",t.message)}}function We(e){const t=document.getElementById("ga-setup"),a=document.getElementById("ga-setup-body");!t||!a||(t.style.display="block",a.innerHTML=`
    ...
    </p>`,["ga-activos","ga-sesiones","ga-usuarios","ga-pageviews","ga-nuevos","ga-duracion","ga-rebote"].forEach(o=>{const n=document.getElementById(o);n&&(n.textContent="—")}))}document.querySelector("#app").style.cssText="display:flex;min-height:100vh;width:100%";const Ie="erp_empleado";function pe(){document.querySelector("#app").innerHTML=`
  ...
  `,window.hacerLogin=async()=>{const t=document.getElementById("login-email").value,a=document.getElementById("login-password").value,o=document.getElementById("btn-login");if(document.getElementById("login-error"),!t||!a){e("Por favor completa todos los campos");return}o.textContent="Verificando...",o.disabled=!0;try{const n=await fetch("/api/empleados/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),r=await n.json();n.ok?(sessionStorage.setItem(Ie,JSON.stringify(r)),r.token&&sessionStorage.setItem("erp_token",r.token),window._empleadoActual=r,fe()):(e(r.error||"Email o contrasena incorrectos"),o.textContent="Iniciar sesion",o.disabled=!1)}catch{e("Error conectando con el servidor"),o.textContent="Iniciar sesion",o.disabled=!1}};function e(t){const a=document.getElementById("login-error");a&&(a.textContent=t,a.style.display="block")}}window.authHeaders=()=>{const e=sessionStorage.getItem("erp_token");return e?{"Content-Type":"application/json",Authorization:`Bearer ${e}`}:{"Content-Type":"application/json"}};const me=sessionStorage.getItem(Ie);if(me)try{window._empleadoActual=JSON.parse(me),fe()}catch{pe()}else pe();
