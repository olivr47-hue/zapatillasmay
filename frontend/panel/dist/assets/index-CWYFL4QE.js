(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(n){if(n.ep)return;n.ep=!0;const i=a(n);fetch(n.href,i)}})();const f="/api",se=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],we=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],$e=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],X=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"},{id:"catalogos",icon:"📖",label:"Catálogos",section:"Catalogo",soloAdmin:!0}];var re;let U=((re=window._empleadoActual)==null?void 0:re.rol)==="admin"?"dashboard":"pos",te=1;function de(){var a,o;const e=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),t=((a=window._empleadoActual)==null?void 0:a.rol)==="admin"?"dashboard":"pos";U=e||t,document.querySelector("#app").innerHTML=`
    ...
    <div class="main">
      <div class="topbar">
        <div style="display:flex;align-items:center;gap:1rem">
          ...
          <h1 id="topbar-title">${((o=X.find(n=>n.id===U))==null?void 0:o.label)||"Dashboard"}</h1>
        </div>
  ...
  `,window.toggleSidebar=()=>{const n=document.getElementById("sidebar"),i=document.getElementById("sidebar-overlay"),r=n.classList.toggle("open");i.classList.toggle("active",r),document.body.style.overflow=r?"hidden":""},window._conversacionesInterval&&clearInterval(window._conversacionesInterval),window._conversacionesInterval=setInterval(async()=>{try{const i=await(await fetch(f+"/chatbot/chats")).json();window._chatsData||(window._chatsData={});const r=window._totalNoLeidos||0,s=i.reduce((d,l)=>d+(l.no_leidos||0),0);if(window._totalNoLeidos=s,i.forEach(d=>{window._chatsData&&(window._chatsData[d.telefono]=d)}),fetch(f+"/health").catch(()=>{}),s>r){document.title=`(${s}) Zapatillas May`;const d=document.querySelector('[data-modulo="conversaciones"]');if(d){let l=d.querySelector(".nav-badge");l||(l=document.createElement("span"),l.className="nav-badge",l.style.cssText="background:#e91e8c;color:white;border-radius:100px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:auto",d.appendChild(l)),l.textContent=s}try{const l=new(window.AudioContext||window.webkitAudioContext),c=l.createOscillator(),p=l.createGain();c.connect(p),p.connect(l.destination),c.frequency.value=523,p.gain.setValueAtTime(.5,l.currentTime),p.gain.exponentialRampToValueAtTime(.001,l.currentTime+.2),c.start(l.currentTime),c.stop(l.currentTime+.2);const m=l.createOscillator(),g=l.createGain();m.connect(g),g.connect(l.destination),m.frequency.value=783,g.gain.setValueAtTime(.5,l.currentTime+.2),g.gain.exponentialRampToValueAtTime(.001,l.currentTime+.5),m.start(l.currentTime+.2),m.stop(l.currentTime+.5)}catch{}}if(window._chatActivo&&window._chatsData[window._chatActivo]){const d=window._chatsData[window._chatActivo],l=document.getElementById("mensajes-area");if(l){const c=l.scrollHeight-l.scrollTop<=l.clientHeight+50;l.innerHTML=[...d.mensajes].reverse().map(p=>{const m=p.tipo==="manual"||p.tipo==="imagen_saliente";return`
              <div style="display:flex;flex-direction:column;gap:4px">
                ...
                ${p.respuesta?`<div style="display:flex;flex-direction:column;align-items:flex-end"><div style="max-width:70%;background:#dcf8c6;border-radius:12px 12px 0 12px;padding:8px 12px;box-shadow:0 1px 2px rgba(0,0,0,0.08)"><p style="font-size:0.62rem;color:#2e7d32;margin-bottom:2px">🤖 Bot</p><p style="font-size:0.85rem;color:#333;white-space:pre-wrap">${p.respuesta.replace(/(https?:\/\/[^\s]+\.(?:jpg|jpeg|png|webp))/gi,"")}</p>${p.respuesta.match(/(https?:\/\/[^\s]+\.(?:jpg|jpeg|png|webp))/gi)?p.respuesta.match(/(https?:\/\/[^\s]+\.(?:jpg|jpeg|png|webp))/gi).map(g=>`<img src="${g}" style="max-width:200px;border-radius:8px;margin-top:4px;display:block" onclick="window.open('${g}')">`).join(""):""}<p style="font-size:0.62rem;color:#aaa;text-align:right;margin-top:2px">${new Date(p.created_at).toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"})}</p></div></div>`:""}
              </div>`}).join(""),c&&(l.scrollTop=l.scrollHeight)}}}catch{}},5e3),window.navegarA=n=>{var l;const i=((l=window._empleadoActual)==null?void 0:l.rol)==="admin",r=X.find(c=>c.id===n);if(r!=null&&r.soloAdmin&&!i){alert("No tienes permisos para acceder a este módulo");return}U=n;try{localStorage.setItem("zm_panel_modulo",n)}catch{}const s=document.getElementById("sidebar"),d=document.getElementById("sidebar-overlay");s.classList.contains("open")&&(s.classList.remove("open"),d.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(c=>c.classList.remove("active")),document.querySelector('[data-modulo="'+n+'"]').classList.add("active"),document.getElementById("topbar-title").textContent=X.find(c=>c.id===n).label,le(n)}}function Ee(){var a;const e=((a=window._empleadoActual)==null?void 0:a.rol)==="admin";return[...new Set(X.filter(o=>e||!o.soloAdmin).map(o=>o.section))].map(o=>`
    <div class="nav-section">${o}</div>
    ${X.filter(n=>n.section===o&&(e||!n.soloAdmin)).map(n=>`
      <div class="nav-item ${n.id===U?"active":""}"
           data-modulo="${n.id}"
    ...
    `).join("")}
  `).join("")}async function le(e){const t=document.getElementById("content");switch(t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>',e){case"catalogos":await oe();break;case"dashboard":t.innerHTML=Ce(),setTimeout(()=>Be(),100);break;case"productos":await Q();break;case"clientes":await ze();break;case"pedidos":await ge();break;case"sucursales":await Se();break;case"inventario":await Ie();break;case"pos":await fe();break;case"historial":await be();break;case"empleados":await ye();break;case"seo":await Pe();break;case"analisis":await ke();break;case"crm":await pe();break;case"finanzas":await W();break;case"proveedores":await ce();break;case"ordenes":await J();break;case"conversaciones":await cargarConversaciones();break;case"envios":await cargarEnviosMasivos();break}}function _e(){return setTimeout(()=>{document.querySelectorAll(".nav-item").forEach(o=>o.classList.remove("active"));const e=document.querySelector('[data-modulo="'+U+'"]');e&&e.classList.add("active");const t=document.getElementById("topbar-title"),a=X.find(o=>o.id===U);t&&a&&(t.textContent=a.label),le(U)},100),'<div style="padding:2rem;color:#888;text-align:center">Cargando...</div>'}async function J(){var t;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando sugerencias...</p>';try{const o=await(await fetch(f+"/sucursales/")).json(),n=(t=o[0])==null?void 0:t.id,[i,r]=await Promise.all([fetch(f+"/finanzas/sugerencias-recompra/"+n),fetch(f+"/finanzas/proveedores")]),s=await i.json(),d=await r.json(),l=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),c=new Date().toISOString().split("T")[0],p=s.filter(v=>{const y=l[v.producto_id];return y?y.hasta===null||y.hasta===void 0?!1:y.hasta<=c:!0}),m=s.length-p.length;window._ordenesData={sugerencias:p,proveedores:d,sucursalId:n},window._ordenSeleccion={};const g=p.filter(v=>v.urgente),u=p.filter(v=>!v.urgente),b=p.reduce((v,y)=>v+y.cantidad_sugerida*y.costo_unitario,0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
          <select class="form-input" id="ord-sucursal" style="max-width:200px" onchange="recargarOrdenes(this.value)">
            ${o.map(v=>`<option value="${v.id}">${v.nombre}</option>`).join("")}
          </select>
...
¿Quieres reactivar todos?`)&&(localStorage.removeItem("ordenes_pospuestos"),J())};window.guardarOrdenCompra2=async()=>{var i,r,s,d;const{seleccionados:e,sucursalId:t}=window._ordenModal||{};if(!e)return;const a=(i=document.getElementById("orden-fecha"))==null?void 0:i.value,o=((r=document.getElementById("orden-notas"))==null?void 0:r.value)||"",n={};e.forEach(l=>{var g,u;const c=l.proveedor_id||"sin-proveedor",p=((g=l.proveedor)==null?void 0:g.nombre)||"Sin proveedor";n[c]||(n[c]={nombre:p,items:[]});const m=l.variantes||[];if(m.length===0){const b=parseInt(((u=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:u.value)||l.cantidad_sugerida);n[c].items.push({variante_id:null,cantidad:b,costo_unitario:l.costo_unitario})}else m.forEach(b=>{var h;const v=document.getElementById("chk-var-"+b.id);if(!(v!=null&&v.checked))return;const y=parseInt(((h=document.getElementById("qty-var-"+b.id))==null?void 0:h.value)||0);y<=0||n[c].items.push({variante_id:b.id,cantidad:y,costo_unitario:l.costo_unitario})})});try{for(const[l,c]of Object.entries(n)){if(c.items.length===0)continue;const p=c.items.reduce((b,v)=>b+v.cantidad*v.costo_unitario,0),u=(s=(await(await fetch(f+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:l==="sin-proveedor"?null:l,sucursal_id:t,status:"borrador",total:p,notas:o,fecha_entrega_estimada:a||null})})).json())[0])==null?void 0:s.id;if(u)for(const b of c.items)await fetch(f+"/finanzas/ordenes/"+u+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...b,subtotal:b.cantidad*b.costo_unitario})})}(d=document.getElementById("modal-orden"))==null||d.remove(),alert("Orden de compra guardada"),J()}catch(l){alert("Error guardando orden: "+l.message)}};function Ce(){return`
  ...
  `}async function W(){var t,a,o,n,i,r;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando finanzas...</p>';try{const d=await(await fetch(f+"/sucursales/")).json(),l=(t=d[0])==null?void 0:t.id,[c,p,m,g,u,b,v]=await Promise.all([fetch(f+"/finanzas/caja/hoy/"+l),fetch(f+"/finanzas/reporte/"+l),fetch(f+"/finanzas/gastos/"+l),fetch(f+"/finanzas/estado-resultados/"+l),fetch(f+"/finanzas/flujo/"+l),fetch(f+"/finanzas/cuentas-por-cobrar"),fetch(f+"/finanzas/gastos-categorias/"+l)]),y=await c.json(),h=await p.json(),w=await m.json(),_=await g.json(),C=await u.json(),k=await b.json(),$=await v.json(),E=y.find(S=>S.status==="abierta"),T=new Date().toISOString().split("T")[0],M=w.filter(S=>{var P;return(P=S.created_at)==null?void 0:P.startsWith(T)}),z=M.reduce((S,P)=>S+parseFloat(P.monto||0),0),I=k.reduce((S,P)=>S+parseFloat(P.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
      ...
      <div style="background:${E?"#e8f5e9":"#ffebee"};border-radius:12px;padding:1.25rem;border:1px solid ${E?"#a5d6a7":"#ffcdd2"};margin-bottom:1.5rem;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
        ...
        ${E?`
          <div style="display:flex;gap:16px;flex-wrap:wrap">
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#2e7d32">$${(((a=C.hoy)==null?void 0:a.efectivo)||0).toFixed(0)}</p>
              <p style="font-size:0.65rem;color:#888">Efectivo</p>
            </div>
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#1565c0">$${(((o=C.hoy)==null?void 0:o.tarjeta)||0).toFixed(0)}</p>
              <p style="font-size:0.65rem;color:#888">Tarjeta</p>
            </div>
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#6a1b9a">$${(((n=C.hoy)==null?void 0:n.spei)||0).toFixed(0)}</p>
              <p style="font-size:0.65rem;color:#888">SPEI</p>
            </div>
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#E91E8C">$${(((i=C.hoy)==null?void 0:i.total)||0).toFixed(0)}</p>
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          <p style="font-size:1.5rem;font-weight:700;color:#E91E8C">$${(h.total_ventas||0).toFixed(0)}</p>
          <p style="font-size:0.68rem;color:#888;text-transform:uppercase;letter-spacing:0.5px">Ventas 30 días</p>
        </div>
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          <p style="font-size:1.5rem;font-weight:700;color:#c62828">$${(h.total_gastos||0).toFixed(0)}</p>
        ...
        <div style="background:${(h.utilidad||0)>=0?"#e8f5e9":"#ffebee"};border-radius:12px;padding:1.25rem;border:1px solid ${(h.utilidad||0)>=0?"#a5d6a7":"#ffcdd2"};text-align:center">
          <p style="font-size:1.5rem;font-weight:700;color:${(h.utilidad||0)>=0?"#2e7d32":"#c62828"}">$${(h.utilidad||0).toFixed(0)}</p>
          <p style="font-size:0.68rem;color:#888;text-transform:uppercase;letter-spacing:0.5px">Utilidad 30 días</p>
        </div>
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          <p style="font-size:1.5rem;font-weight:700;color:#333">$${(((r=C.semana)==null?void 0:r.ingresos)||0).toFixed(0)}</p>
    ...
    `,window._finanzasData={sucursalId:l,gastosHoy:M,totalGastosHoy:z,estadoResultados:_,flujo:C,cxc:k,categorias:$,historial:[]},window._finanzasSucursalId=l;const x=await(await fetch(f+"/finanzas/caja/historial/"+l)).json();window._finanzasData.historial=x,mostrarTabFinanzas("gastos")}catch(s){e.innerHTML='<p style="padding:2rem;color:red">Error cargando finanzas: '+s.message+"</p>"}}window.mostrarTabFinanzas=e=>{var c,p,m,g,u,b,v,y,h,w,_,C,k;const{gastosHoy:t,totalGastosHoy:a,estadoResultados:o,flujo:n,cxc:i,categorias:r,historial:s,sucursalId:d}=window._finanzasData,l=document.getElementById("fin-tab-contenido");if(l)if(e==="gastos"){const $=r.reduce((E,T)=>E+T.total,0);l.innerHTML=`
    ...
    `:e==="flujo"?l.innerHTML=`
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          ${[{label:"Efectivo",val:((c=n.hoy)==null?void 0:c.efectivo)||0,color:"#2e7d32"},{label:"Tarjeta",val:((p=n.hoy)==null?void 0:p.tarjeta)||0,color:"#1565c0"},{label:"SPEI",val:((m=n.hoy)==null?void 0:m.spei)||0,color:"#6a1b9a"},{label:"Crédito",val:((g=n.hoy)==null?void 0:g.credito)||0,color:"#f57f17"}].map($=>`
          ...
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            ...
            <span style="font-weight:700;color:#E91E8C;font-size:1.1rem">$${(((u=n.hoy)==null?void 0:u.total)||0).toFixed(0)}</span>
          </div>
        </div>
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            ...
            <span style="font-weight:700;color:${(((y=n.semana)==null?void 0:y.neto)||0)>=0?"#2e7d32":"#c62828"};font-size:1.1rem">$${(((h=n.semana)==null?void 0:h.neto)||0).toFixed(0)}</span>
          </div>
        </div>
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f5f5f5">
            <span style="font-size:0.82rem;color:#888">Gastos</span>
            <span style="font-weight:700;color:#c62828">-$${(((_=n.mes)==null?void 0:_.gastos)||0).toFixed(0)}</span>
          </div>
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            <span style="font-size:0.85rem;font-weight:700">Neto</span>
            <span style="font-weight:700;color:${(((C=n.mes)==null?void 0:C.neto)||0)>=0?"#2e7d32":"#c62828"};font-size:1.1rem">$${(((k=n.mes)==null?void 0:k.neto)||0).toFixed(0)}</span>
          </div>
        </div>
      </div>
    `:e==="caja"?l.innerHTML=`
  ...
  `};window.abrirCaja=async e=>{var a;const t=prompt("¿Cuánto efectivo hay en caja para empezar? (fondo de caja)");if(t!==null)try{const n=await(await fetch(f+"/finanzas/caja/abrir",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sucursal_id:e,monto_apertura:parseFloat(t)||0,empleado:((a=window._empleadoActual)==null?void 0:a.nombre)||"Admin"})})).json();if(n.error){alert("Error: "+n.error);return}W()}catch{alert("Error abriendo caja")}};window.cerrarCaja=async e=>{var o,n;const t=prompt("¿Cuánto efectivo hay físicamente en caja al cerrar?");if(t===null)return;const a=prompt("Notas del cierre (opcional):")||"";try{const r=await(await fetch(f+"/finanzas/caja/"+e+"/cerrar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({monto_cierre:parseFloat(t)||0,notas:a})})).json();r.ok?(alert(`Caja cerrada.
Total ventas: $${(o=r.total_ventas)==null?void 0:o.toFixed(2)}
Diferencia: $${(n=r.diferencia)==null?void 0:n.toFixed(2)}`),W()):alert("Error: "+JSON.stringify(r))}catch{alert("Error cerrando caja")}};window.agregarGasto=e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",t.innerHTML=`
  ...
  `,document.body.appendChild(t),t.addEventListener("click",a=>{a.target===t&&t.remove()})};window.guardarGasto=async(e,t)=>{var i;const a=document.getElementById("gasto-concepto").value,o=document.getElementById("gasto-monto").value,n=document.getElementById("gasto-categoria").value;if(!a||!o){alert("Completa concepto y monto");return}try{await fetch(f+"/finanzas/gastos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sucursal_id:e,concepto:a,monto:parseFloat(o),categoria:n,empleado:((i=window._empleadoActual)==null?void 0:i.nombre)||"Admin"})}),t.closest('div[style*="position:fixed"]').remove(),W()}catch{alert("Error guardando gasto")}};window.eliminarGasto=async e=>{if(confirm("¿Eliminar este gasto?"))try{await fetch(f+"/finanzas/gastos/"+e,{method:"DELETE"}),W()}catch{alert("Error eliminando gasto")}};async function ce(){const e=document.getElementById("content");try{const a=await(await fetch(f+"/finanzas/proveedores")).json();e.innerHTML=`
  ...
  `,document.body.appendChild(a),a.addEventListener("click",o=>{o.target===a&&a.remove()})};window.guardarProveedor=async e=>{const t={nombre:document.getElementById("prov-nombre").value,contacto:document.getElementById("prov-contacto").value,telefono:document.getElementById("prov-telefono").value,email:document.getElementById("prov-email").value,ciudad:document.getElementById("prov-ciudad").value,direccion:document.getElementById("prov-direccion").value,notas:document.getElementById("prov-notas").value};if(!t.nombre){alert("El nombre es requerido");return}try{e?await fetch(f+"/finanzas/proveedores/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):await fetch(f+"/finanzas/proveedores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),document.querySelector('div[style*="position:fixed"]').remove(),ce()}catch{alert("Error guardando proveedor")}};window.editarProveedor=async e=>{const o=(await(await fetch(f+"/finanzas/proveedores")).json()).find(n=>n.id===e);o&&mostrarFormProveedor(o)};async function ke(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando análisis...</p>';try{const[t,a,o,n]=await Promise.all([fetch(f+"/productos/"),fetch(f+"/variantes/"),fetch(f+"/movimientos/"),fetch(f+"/inventario/")]),i=await t.json(),r=await a.json(),s=await o.json(),d=await n.json(),l=new Date,c=new Date(l-30*24*60*60*1e3),p=new Date(l-60*24*60*60*1e3),m=new Date(l-90*24*60*60*1e3),g={};s.filter(v=>v.tipo==="venta").forEach(v=>{const y=r.find(C=>C.id===v.variante_id);if(!y)return;const h=y.producto_id;g[h]||(g[h]={d30:0,d60:0,d90:0});const w=new Date(v.created_at),_=Math.abs(v.cantidad);w>=c&&(g[h].d30+=_),w>=p&&(g[h].d60+=_),w>=m&&(g[h].d90+=_)});const u=i.map(v=>{const y=g[v.id]||{d30:0,d60:0,d90:0},h=d.filter($=>r.find(E=>E.id===$.variante_id&&E.producto_id===v.id)).reduce(($,E)=>$+E.cantidad,0),w=y.d30/4,_=w>0?Math.round(h/w*7):null;let C="gris",k="Sin ventas recientes";return y.d30>=6?(C="verde",k="Rota bien — considerar resurtido"):y.d30>=2?(C="amarillo",k="Rotacion moderada"):y.d90===0&&h>0?(C="rojo",k="Sin movimiento en 90 dias — revisar"):y.d30>0&&(C="amarillo",k="Rotacion lenta"),{...v,ventas:y,stockTotal:h,ventasSemana:w,diasInventario:_,semaforo:C,recomendacion:k}}).sort((v,y)=>y.ventas.d30-v.ventas.d30),b={verde:{bg:"#e8f5e9",color:"#2e7d32",texto:"🟢 Rota bien"},amarillo:{bg:"#fff8e1",color:"#f57f17",texto:"🟡 Rotacion lenta"},rojo:{bg:"#ffebee",color:"#c62828",texto:"🔴 Sin movimiento"},gris:{bg:"#f5f5f5",color:"#888",texto:"⚪ Sin datos"}};e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:12px;margin-bottom:2rem">
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#E91E8C">${u.reduce((v,y)=>v+y.ventas.d30,0)}</p>
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#E91E8C">${u.reduce((v,y)=>v+y.ventas.d90,0)}</p>
          <p style="font-size:0.75rem;color:#aaa">pares</p>
        </div>
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          <p style="font-size:0.72rem;color:#888;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:6px">Rotan bien</p>
          <p style="font-size:1.8rem;font-weight:700;color:#2e7d32">${u.filter(v=>v.semaforo==="verde").length}</p>
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#c62828">${u.filter(v=>v.semaforo==="rojo").length}</p>
          <p style="font-size:0.75rem;color:#aaa">modelos</p>
        </div>
      </div>
  ...
  <button class="btn btn-secondary" style="padding:4px 10px;font-size:0.75rem;background:#ffebee;border-color:#c62828;color:#c62828" onclick="filtrarRotacion('rojo')">🔴 Sin movimiento</button>
        ...
        <div id="rotacion-lista">
          ${u.map(v=>{const y=b[v.semaforo];return`
              <div class="rotacion-item" data-semaforo="${v.semaforo}" style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
                ${v.imagen_principal?`<img src="${v.imagen_principal}" style="width:52px;height:52px;object-fit:contain;border-radius:8px;background:#f5f5f5;flex-shrink:0">`:'<div style="width:52px;height:52px;background:#f5f5f5;border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:1.5rem;flex-shrink:0">👠</div>'}
                <div style="flex:1;min-width:140px">
                  <p style="font-weight:600;font-size:0.9rem;margin-bottom:2px">${v.nombre}</p>
                  <p style="font-size:0.75rem;color:#888">${v.sku_interno||""} · Stock: ${v.stockTotal} pares</p>
                  <span style="display:inline-block;margin-top:4px;padding:2px 8px;border-radius:100px;font-size:0.68rem;font-weight:600;background:${y.bg};color:${y.color}">${y.texto}</span>
                </div>
                <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;text-align:center;min-width:200px">
                  <div>
                    <p style="font-size:1.1rem;font-weight:700;color:#333">${v.ventas.d30}</p>
                    <p style="font-size:0.65rem;color:#aaa">30 días</p>
                  </div>
                  <div>
                    <p style="font-size:1.1rem;font-weight:700;color:#333">${v.ventas.d60}</p>
                    <p style="font-size:0.65rem;color:#aaa">60 días</p>
                  </div>
                  <div>
                    <p style="font-size:1.1rem;font-weight:700;color:#333">${v.ventas.d90}</p>
                    <p style="font-size:0.65rem;color:#aaa">90 días</p>
                  </div>
                </div>
                <div style="text-align:right;min-width:120px">
                  <p style="font-size:0.82rem;font-weight:600;color:#333">${v.ventasSemana.toFixed(1)} pares/sem</p>
                  <p style="font-size:0.75rem;color:${v.diasInventario?v.diasInventario<14?"#c62828":v.diasInventario<30?"#f57f17":"#2e7d32":"#aaa"}">${v.diasInventario?`~${v.diasInventario} días stock`:"Sin ventas"}</p>
                  <p style="font-size:0.72rem;color:#888;margin-top:2px">${v.recomendacion}</p>
                </div>
              </div>
            `}).join("")}
        </div>
      </div>
    `,window._rotacionData=u}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando análisis</p>'}}window.filtrarRotacion=e=>{document.querySelectorAll(".rotacion-item").forEach(t=>{t.style.display=e==="todos"||t.dataset.semaforo===e?"":"none"})};async function pe(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando CRM...</p>';try{const[t,a,o]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/"),fetch(f+"/crm/seguimientos/pendientes/todos")]),n=await t.json(),i=await a.json(),r=await o.json(),s=new Date,d=new Date(s-30*24*60*60*1e3),l=new Date(s-60*24*60*60*1e3),c=new Date(s-90*24*60*60*1e3),p=n.map(h=>{const w=i.filter(T=>T.cliente_id===h.id&&(T.status==="confirmado"||T.status==="pagado")),_=w.reduce((T,M)=>T+parseFloat(M.total||0),0),C=w.length>0?new Date(w[0].created_at):null,k=C?Math.floor((s-C)/(1e3*60*60*24)):null,$=w.filter(T=>new Date(T.created_at)>=d).length;let E="nuevo";return w.length===0?E="nuevo":_>=5e3&&$>=1?E="vip":k>90?E="inactivo":k>30?E="riesgo":$>=2?E="frecuente":E="activo",{...h,totalGastado:_,ultimoPedido:C,diasSinComprar:k,pedidos30:$,segmento:E,totalPedidos:w.length}}),m=p.filter(h=>h.segmento==="vip"),g=p.filter(h=>h.segmento==="riesgo").sort((h,w)=>w.totalGastado-h.totalGastado),u=p.filter(h=>h.segmento==="inactivo").sort((h,w)=>w.totalGastado-h.totalGastado),b=[...p].sort((h,w)=>w.totalGastado-h.totalGastado).slice(0,10),v=i.filter(h=>new Date(h.created_at).toDateString()===s.toDateString()&&(h.status==="confirmado"||h.status==="pagado")).reduce((h,w)=>h+parseFloat(w.total||0),0),y=i.filter(h=>new Date(h.created_at)>=d&&(h.status==="confirmado"||h.status==="pagado")).reduce((h,w)=>h+parseFloat(w.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
  ...
  `).join("")};window.seleccionarClienteOportunidad=(e,t)=>{document.getElementById("op-cliente-id").value=e,document.getElementById("op-cliente-buscar").value=t,document.getElementById("op-cliente-resultados").style.display="none"};window.guardarOportunidad=async()=>{const e=document.getElementById("op-titulo").value,t=document.getElementById("op-cliente-id").value,a=document.getElementById("op-monto").value,o=document.getElementById("op-etapa").value,n=document.getElementById("op-fecha").value,i=document.getElementById("op-notas").value;if(!e){alert("El título es requerido");return}try{await fetch(f+"/crm/oportunidades",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({titulo:e,cliente_id:t||null,monto_estimado:parseFloat(a)||0,etapa:o,fecha_cierre_estimada:n||null,notas:i})}),document.getElementById("modal-oportunidad").remove(),mostrarPipeline()}catch{alert("Error guardando oportunidad")}};async function Q(e,t=!1){const a=document.getElementById("content");try{const n=await(await fetch(f+"/productos/")).json(),i=n.filter(c=>c.activo),r=n.filter(c=>!c.activo),s=t?r:i;console.log("mostrarInactivos:",t,"base:",s.length,"inactivos:",r.length);const d=[...new Set(i.map(c=>c.categoria).filter(Boolean))],l=e?s.filter(c=>c.categoria===e):s;a.innerHTML=`
    ...
    `}catch{a.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.cargarProductos=Q;window.mostrarCampanas=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando campañas...</p>';try{const[t,a]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/")]),o=await t.json(),n=await a.json(),i=new Date,r=new Date(i-30*24*60*60*1e3),s=new Date(i-90*24*60*60*1e3),d=o.map(p=>{const m=n.filter(h=>h.cliente_id===p.id&&(h.status==="confirmado"||h.status==="pagado")),g=m.reduce((h,w)=>h+parseFloat(w.total||0),0),u=m.length>0?new Date(m[0].created_at):null,b=u?Math.floor((i-u)/(1e3*60*60*24)):null,v=m.filter(h=>new Date(h.created_at)>=r).length;let y="nuevo";return m.length===0?y="nuevo":g>=5e3&&v>=1?y="vip":b>90?y="inactivo":b>30?y="riesgo":v>=2?y="frecuente":y="activo",{...p,totalGastado:g,diasSinComprar:b,segmento:y}}).filter(p=>p.telefono);window._campanaClientes=d;const l=[{id:"catalogo",nombre:"👠 Catálogo completo",descripcion:"Envía el catálogo completo de productos",mensaje:p=>`Hola ${p}! 👋
...
⚠️ Requiere que los productos estén en el catálogo de Meta Commerce.`;else if(d.style.background="#e8f5e9",d.style.borderColor="#a5d6a7",d.style.color="#333",a){let b;t==="personalizado"?b=(((u=document.getElementById("texto-personalizado"))==null?void 0:u.value)||"").replace("{nombre}","María"):b=a.mensaje("María"),d.textContent=b}}const l=document.getElementById("campana-count");l&&(l.textContent=i.length+" clientes");const c=document.getElementById("campana-lista");if(c){if(!i.length){c.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No hay clientes en este segmento con teléfono registrado</div>';return}window._campanaFiltrados=i,window._campanaPlantillaId=t,c.innerHTML=i.map((b,v)=>{var _;let y;t==="personalizado"?y=(((_=document.getElementById("texto-personalizado"))==null?void 0:_.value)||"").replace("{nombre}",b.nombre.split(" ")[0]):y=a.mensaje(b.nombre.split(" ")[0]);const h=encodeURIComponent(y),w=(b.lada||"52")+b.telefono.replace(/\D/g,"");return`
    ...
    <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);text-align:center">
      ...
      <p style="font-size:0.82rem;color:#888">Conectando con WhatsApp Business</p>
          ...
          ${w>0&&(($=h.resultados)!=null&&$.length)?`
            <div style="margin-top:1rem;max-height:120px;overflow-y:auto;border-top:1px solid #f5f5f5;padding-top:0.75rem">
        ...
        </div>`};window._campanaJobId=u;const y=setInterval(async()=>{try{const w=await(await fetch(f+"/campanas/estado/"+u)).json();v(w),w.terminado&&(clearInterval(y),window._campanaUltimosResultados=w.resultados||[],setTimeout(()=>{const _=w.enviados||0,C=w.fallidos||0;l.innerHTML=`
              <div style="background:white;border-radius:16px;padding:2.5rem;max-width:400px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
                ...
                ${C>0?`
                  <p style="color:#e53e3e;font-size:0.8rem;margin-bottom:0.5rem">${C} no se pudieron enviar</p>
                  <div style="background:#fff5f5;border-radius:8px;padding:0.75rem;margin-bottom:1rem;text-align:left;max-height:140px;overflow-y:auto">
                    ${w.resultados.filter(k=>!k.ok).map(k=>`
                      <div style="font-size:0.75rem;padding:3px 0;border-bottom:1px solid #ffe0e0">
                        <span style="font-weight:600">📵 ${k.nombre}</span>
                        <span style="color:#aaa;margin-left:4px">${k.telefono}</span><br>
                        <span style="color:#e53e3e;font-size:0.68rem">${k.error?k.error.substring(0,120):"Error desconocido"}</span>
                      </div>`).join("")}
                  </div>
    ...
    `};window._campanaAvanzar=()=>{if(r++,r>=i.length){s.innerHTML=`
      ...
      `;return}d()},d(),document.body.appendChild(s)};async function ze(){const e=document.getElementById("content");try{const[t,a]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/")]),o=await t.json(),n=await a.json(),i=new Date,r=new Date(i-30*24*60*60*1e3),s=new Date(i-90*24*60*60*1e3),d=o.map(g=>{const u=n.filter($=>$.cliente_id===g.id&&($.status==="confirmado"||$.status==="pagado")),b=u.reduce(($,E)=>$+parseFloat(E.total||0),0),v=u.length>0?new Date(u[0].created_at):null,y=u.filter($=>new Date($.created_at)>=r).length,h=v?Math.floor((i-v)/(1e3*60*60*24)):null;let w="nuevo",_="⚪ Nuevo",C="#f5f5f5",k="#888";return u.length===0?(w="nuevo",_="⚪ Sin compras",C="#f5f5f5",k="#888"):b>=5e3&&y>=1?(w="vip",_="⭐ VIP",C="#fff8e1",k="#f57f17"):h>90?(w="inactivo",_="🔴 Inactivo",C="#ffebee",k="#c62828"):h>30?(w="riesgo",_="🟡 En riesgo",C="#fff8e1",k="#f57f17"):y>=2?(w="frecuente",_="🟢 Frecuente",C="#e8f5e9",k="#2e7d32"):(w="activo",_="🔵 Activo",C="#e3f2fd",k="#1565c0"),{...g,totalGastado:b,ultimoPedido:v,pedidos30:y,diasSinComprar:h,segmento:w,segmentoLabel:_,segmentoBg:C,segmentoColor:k,totalPedidos:u.length}}).sort((g,u)=>u.totalGastado-g.totalGastado),l=d.filter(g=>g.segmento==="vip").length,c=d.filter(g=>g.segmento==="inactivo").length,p=d.filter(g=>g.segmento==="riesgo").length,m=d.filter(g=>g.segmento==="frecuente"||g.segmento==="activo").length;window._clientesData=d,e.innerHTML=`
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
      ...
      <div class="table-card">
        ...
        <div id="cli-lista">
          ${d.map(g=>`
            <div class="cli-item" data-segmento="${g.segmento}" data-tipo="${g.tipo||""}" data-nombre="${g.nombre.toLowerCase()}" data-tel="${g.telefono||""}"
              ...
              <div style="flex:1;min-width:140px">
                <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-bottom:4px">
                  <p style="font-weight:700;font-size:0.95rem">${g.nombre}</p>
                  <span style="padding:2px 8px;border-radius:100px;font-size:0.65rem;font-weight:600;background:${g.segmentoBg};color:${g.segmentoColor}">${g.segmentoLabel}</span>
                  <span style="padding:2px 8px;border-radius:100px;font-size:0.65rem;font-weight:600;background:#f5f5f5;color:#888">${g.tipo==="mayoreo"?"Mayoreo":g.tipo==="zapateria"?"Corridas":"Menudeo"}</span>
                </div>
                <p style="font-size:0.78rem;color:#888">${g.telefono||"Sin teléfono"}${g.ciudad?" · "+g.ciudad:""}</p>
                ${g.comentarios_internos?`<p style="font-size:0.72rem;color:#E91E8C;margin-top:2px">📝 ${g.comentarios_internos.substring(0,50)}${g.comentarios_internos.length>50?"...":""}</p>`:""}
              </div>
              <div style="text-align:right;min-width:100px">
                <p style="font-weight:700;color:#E91E8C;font-size:0.95rem">$${g.totalGastado.toFixed(0)}</p>
                <p style="font-size:0.72rem;color:#888">${g.totalPedidos} pedidos</p>
                ${g.diasSinComprar!==null?`<p style="font-size:0.68rem;color:${g.diasSinComprar>60?"#c62828":"#aaa"}">${g.diasSinComprar===0?"Hoy":"Hace "+g.diasSinComprar+" días"}</p>`:""}
              </div>
              <div style="display:flex;gap:6px;flex-shrink:0" onclick="event.stopPropagation()">
                ${g.telefono?`<a href="https://wa.me/${g.lada||"52"}${g.telefono.replace(/\D/g,"")}" target="_blank" class="btn btn-secondary" style="padding:4px 10px;font-size:0.72rem;background:#25D366;color:white;border-color:#25D366">WhatsApp</a>`:""}
                <button class="btn btn-secondary" style="padding:4px 10px;font-size:0.72rem" onclick="mostrarFormCliente('${g.id}')">Editar</button>
              </div>
            </div>
          `).join("")}
        </div>
      </div>
    `}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.filtrarClientes=()=>{var a,o;const e=(((a=document.getElementById("cli-buscar"))==null?void 0:a.value)||"").toLowerCase(),t=((o=document.getElementById("cli-tipo"))==null?void 0:o.value)||"";document.querySelectorAll(".cli-item").forEach(n=>{const i=n.dataset.nombre||"",r=n.dataset.tel||"",s=n.dataset.tipo||"",d=!e||i.includes(e)||r.includes(e),l=!t||s===t;n.style.display=d&&l?"":"none"})};window.filtrarClientesSeg=e=>{document.querySelectorAll(".cli-item").forEach(t=>{if(e==="todos"){t.style.display="";return}if(e==="activos"){t.style.display=t.dataset.segmento==="activo"||t.dataset.segmento==="frecuente"?"":"none";return}t.style.display=t.dataset.segmento===e?"":"none"})};async function Se(){const e=document.getElementById("content");try{const a=await(await fetch(f+"/sucursales/")).json();e.innerHTML=`
      <div class="table-card">
        <div class="table-header">
...
`,renderInventario()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.renderInventario=()=>{const{sucursales:e,productos:t,variantes:a,inventario:o}=window._invData,n=(document.getElementById("inv-buscar")?document.getElementById("inv-buscar").value:"").toLowerCase(),i=document.getElementById("inv-categoria")?document.getElementById("inv-categoria").value:"",r=document.getElementById("inv-talla")?document.getElementById("inv-talla").value:"",s=document.getElementById("inv-estado")?document.getElementById("inv-estado").value:"",d=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],l=t.filter(m=>!(!m.activo||n&&!m.nombre.toLowerCase().includes(n)&&!(m.sku_interno||"").toLowerCase().includes(n)||i&&m.categoria!==i)),c=e.map(m=>{const g=o.filter(b=>b.sucursal_id===m.id),u=l.map(b=>{const v=a.filter(_=>_.producto_id===b.id);if(v.length===0)return"";const h=[...new Set(v.map(_=>_.color).filter(Boolean))].map(_=>{const C=v.filter(T=>T.color===_).sort((T,M)=>d.indexOf(T.talla)-d.indexOf(M.talla));if(r&&!C.find(T=>T.talla===r))return"";const k=C[0]?C[0].color_hex:"#888",$=C[0]?C[0].foto_url:null,E=C.map(T=>{const M=g.find(S=>S.variante_id===T.id),z=M?M.cantidad:null,I=M?M.stock_minimo:3;if(r&&T.talla!==r||s&&(s==="agotado"&&z!==0||s==="bajo"&&(z===null||z===0||z>I)||s==="disponible"&&(z===null||z===0||z<=I)))return"";let O,x;return z===null?(O="#f0f0f0",x="#aaa"):z===0?(O="#ffebee",x="#c62828"):z<=I?(O="#fff8e1",x="#f57f17"):(O="#e8f5e9",x="#2e7d32"),`
            <div style="display:flex;align-items:center;justify-content:space-between;background:${O};border-radius:10px;padding:8px 12px;border:1px solid ${x}30">
              <span style="font-size:0.85rem;font-weight:600;color:#555;min-width:44px">T${T.talla}</span>
              <div style="display:flex;align-items:center;gap:8px">
                <button onclick="cambiarStockInventario('${T.id}', '${m.id}', ${z!==null?z:0}, ${I}, -1)"
                ...
                <span id="stock-${T.id}-${m.id}" style="font-size:1.1rem;font-weight:700;color:${x};min-width:32px;text-align:center">${z!==null?z:"—"}</span>
                <button onclick="cambiarStockInventario('${T.id}', '${m.id}', ${z!==null?z:0}, ${I}, 1)"
                        style="background:#fff;border:1px solid #ddd;border-radius:6px;width:34px;height:34px;cursor:pointer;font-size:1.2rem;font-weight:700;touch-action:manipulation">+</button>
              </div>
            </div>
          ...
          <div style="background:#fafafa;border-radius:12px;padding:1rem;margin-bottom:10px;border:1px solid #eee">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
              ${$?`<img src="${$}" style="width:52px;height:52px;object-fit:cover;border-radius:8px;border:1px solid #eee;flex-shrink:0">`:`<div style="width:52px;height:52px;background:${k};border-radius:8px;border:1px solid #eee;flex-shrink:0;opacity:0.7"></div>`}
              <div style="display:flex;align-items:center;gap:8px">
  ...
  `};window.guardarAjuste=async()=>{const e=document.getElementById("aj").value,t=document.getElementById("aj-sucursal").value,a=document.getElementById("aj-cantidad").value,o=document.getElementById("aj-motivo").value;if(!e||!t||a===""){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(f+"/movimientos/ajuste",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:parseInt(a),motivo:o})})).json();i.ok?(alert("Ajuste guardado. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarCambio=async()=>{const t=await(await fetch(f+"/sucursales/")).json(),o=await(await fetch(f+"/variantes/")).json();window._variantesCache=o;const n=document.getElementById("content");n.innerHTML=`
  ...
  `};window.guardarCambio=async()=>{const e=document.getElementById("cam-origen").value,t=document.getElementById("cam-destino").value,a=document.getElementById("cam-sucursal").value,o=document.getElementById("cam-motivo").value;if(!e||!t||!a){alert("Por favor selecciona ambos productos y la sucursal");return}if(e===t){alert("El producto que regresa y el que se lleva deben ser diferentes");return}try{const i=await(await fetch(f+"/movimientos/cambio",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_origen_id:e,variante_destino_id:t,sucursal_id:a,motivo:o})})).json();i.ok?(alert("Cambio registrado. El inventario se actualizo automaticamente."),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.buscarVariante=(e,t)=>{const a=window._variantesCache||[],o=document.getElementById(t+"-resultados");if(!o)return;if(!e||e.length<2){o.style.display="none";return}const n=e.toLowerCase().split(" ").filter(s=>s),i=a.filter(s=>{const d=(s.productos&&s.productos.nombre||"").toLowerCase(),l=(s.color||"").toLowerCase(),c=(s.talla||"").toLowerCase(),p=(s.sku||"").toLowerCase(),m=d+" "+l+" "+c+" "+p;return n.every(g=>m.includes(g))}).slice(0,15);if(i.length===0){o.innerHTML='<div style="padding:10px 14px;color:#888;font-size:0.85rem">No se encontraron resultados</div>',o.style.display="block";return}const r=t==="ped-prod";o.innerHTML=i.map(s=>{const d=(s.productos&&s.productos.nombre||"")+" - "+s.color+" - T"+s.talla;return`
    ...
    `}).join(""),o.style.display="block"};window.seleccionarVariante=(e,t,a)=>{const o=document.getElementById(a);o&&(o.value=e);const n=document.getElementById(a+"-seleccionado");n&&(n.textContent="Ô£ô "+t,n.style.display="block");const i=document.getElementById(a+"-resultados");i&&(i.style.display="none")};function Y(e,t){const a=t||{},o=!t;let n="";a.imagenes&&a.imagenes.length>0?n=a.imagenes.map((s,d)=>{const l=d===0;return`<div style="position:relative;cursor:pointer" data-url="${s}" data-es-portada="${l}" data-file-idx="${d}">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div>
          ...
          <select class="form-input" id="f-categoria" required onchange="actualizarSKU()">
            ...
            ${$e.map(o=>`<option value="${o.value}" ${t.categoria===o.value?"selected":""}>${o.label}</option>`).join("")}
          </select>
        </div>
        <div>
...
<div id="variantes-container">
  ${window._coloresExistentes&&window._coloresExistentes.length>0?window._coloresExistentes.map((o,n)=>Y(n,o)).join(""):Y(0,null)}
</div>
  ...
  `,fetch(f+"/sucursales/").then(o=>o.json()).then(o=>{const n=document.getElementById("f-sucursal-stock");n&&(n.innerHTML=o.map(i=>`<option value="${i.id}">${i.nombre}</option>`).join("")),setTimeout(()=>actualizarTablaStock(),100)})};window.seleccionarColorPortada=e=>{if(!window._coloresExistentes)return;const t=window._coloresExistentes.splice(e,1)[0];window._coloresExistentes.unshift(t),document.querySelectorAll('[id^="portada-color-"]').forEach((o,n)=>{const i=n===0;o.style.borderColor=i?"#2e7d32":"#ddd",o.style.background=i?"#e8f5e9":"white",o.innerHTML=`
...
${a.telefono?'<a href="https://wa.me/'+(a.lada||"52")+a.telefono.replace(/\D/g,"")+'" target="_blank" class="btn btn-secondary" style="background:#25D366;color:white;border-color:#25D366;margin-left:auto">WhatsApp</a>':""}      </div>
  ...
  `};window.guardarCliente=async e=>{const t=document.getElementById("cli-nombre").value;if(!t){alert("El nombre del cliente es obligatorio");return}const a=document.getElementById("btn-cli-guardar");a&&(a.textContent="Guardando...",a.disabled=!0);const o={nombre:t,telefono:document.getElementById("cli-telefono").value||null,email:document.getElementById("cli-email").value||null,tipo:document.getElementById("cli-tipo").value,direccion:document.getElementById("cli-direccion").value||null,lada:document.getElementById("cli-lada").value||"52",ciudad:document.getElementById("cli-ciudad").value||null,estado:document.getElementById("cli-estado").value||null,codigo_postal:document.getElementById("cli-cp").value||null,limite_credito:parseFloat(document.getElementById("cli-credito").value)||0,dias_credito:parseInt(document.getElementById("cli-dias").value)||0,comentarios_internos:document.getElementById("cli-comentarios").value||null,activo:!0};try{const n=e?"PATCH":"POST",i=e?f+"/clientes/"+e:f+"/clientes/",r=await fetch(i,{method:n,headers:{"Content-Type":"application/json"},body:JSON.stringify(o)});if(r.ok)alert("Cliente guardado correctamente"),navegarA("clientes");else{const s=await r.text();alert("Error al guardar: "+s),a&&(a.textContent="Guardar cliente",a.disabled=!1)}}catch{alert("Error conectando con el servidor"),a&&(a.textContent="Guardar cliente",a.disabled=!1)}};window.verCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[a,o]=await Promise.all([fetch(f+"/clientes/"+e),fetch(f+"/pedidos/")]),n=await a.json(),i=await o.json();if(!n||n.length===0){alert("Cliente no encontrado");return}const r=n[0],s=i.filter(u=>u.cliente_id===e),d=s.filter(u=>u.status==="confirmado"||u.status==="pagado"),l=d.reduce((u,b)=>u+parseFloat(b.total||0),0),c=d.length>0?l/d.length:0,p=s.length>0?new Date(s[0].created_at):null,m=p?Math.floor((new Date-p)/(1e3*60*60*24)):null,g={};d.forEach(u=>{const b=new Date(u.created_at).toLocaleDateString("es-MX",{month:"short",year:"2-digit"});g[b]=(g[b]||0)+parseFloat(u.total||0)}),t.innerHTML=`
    ...
    `}catch{t.innerHTML='<p style="padding:2rem;color:red">Error cargando cliente</p>'}};window.guardarNotasCliente=async e=>{var a;const t=((a=document.getElementById("cli-notas-"+e))==null?void 0:a.value)||"";try{await fetch(f+"/clientes/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({comentarios_internos:t})});const o=document.querySelector(`button[onclick="guardarNotasCliente('${e}')"]`);o&&(o.textContent="✅ Guardado",setTimeout(()=>o.textContent="💾 Guardar notas",2e3))}catch{alert("Error guardando notas")}};window.editarCliente=e=>{mostrarFormCliente(e)};window.nuevoPedidoCliente=async(e,t)=>{await fe(),setTimeout(()=>{const a=document.getElementById("pos-cliente-buscar"),o=document.getElementById("pos-cliente"),n=document.getElementById("pos-cliente-seleccionado");a&&(a.value=""),o&&(o.value=e),n&&(n.textContent="✔ "+t+" — toca para cambiar",n.style.display="block");const i=document.getElementById("topbar-title");i&&(i.textContent="Punto de venta")},300)};window.verHistorialCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando historial...</p>';try{const n=(await(await fetch(f+"/pedidos/")).json()).filter(s=>s.cliente_id===e),i=n.length>0&&n[0].clientes?n[0].clientes:{},r=n.filter(s=>s.status==="confirmado"||s.status==="pagado").reduce((s,d)=>s+parseFloat(d.total||0),0);t.innerHTML=`
      <div class="table-card" style="padding:2rem">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;flex-wrap:wrap">
          <button class="btn btn-secondary" onclick="navegarA('clientes')">← Volver</button>
  ...
  `};window.guardarEntrada=async()=>{const e=document.getElementById("ent").value,t=document.getElementById("ent-sucursal").value,a=document.getElementById("ent-cantidad").value,o=document.getElementById("ent-motivo").value;if(!e||!t||!a){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(f+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:parseInt(a),motivo:o})})).json();i.ok?(alert("Entrada guardada. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarSalida=async()=>{const t=await(await fetch(f+"/sucursales/")).json(),o=await(await fetch(f+"/variantes/")).json();window._variantesCache=o;const n=document.getElementById("content");n.innerHTML=`
    <div class="table-card" style="padding:2rem;max-width:600px">
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem">
        <button class="btn btn-secondary" onclick="navegarA('inventario')">← Volver</button>
  ...
  `};window.guardarSalida=async()=>{const e=document.getElementById("sal").value,t=document.getElementById("sal-sucursal").value,a=document.getElementById("sal-cantidad").value,o=document.getElementById("sal-motivo").value;if(!e||!t||!a){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(f+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:-parseInt(a),motivo:o})})).json();i.ok?(alert("Salida registrada. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const a=await(await fetch(f+"/sucursales/")).json(),n=await(await fetch(f+"/productos/")).json(),r=await(await fetch(f+"/variantes/")).json(),d=await(await fetch(f+"/inventario/")).json(),l=[...new Set(n.map(p=>p.categoria).filter(Boolean))],c=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:a,productos:n,variantes:r,inventario:d},e.innerHTML=`
    ...
    `,renderTablasMasivo()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:e,variantes:t,inventario:a}=window._invMasivo,o=document.getElementById("im-sucursal").value,n=document.getElementById("im-categoria").value,i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],r=e.filter(c=>!(n&&c.categoria!==n)),s=a.filter(c=>c.sucursal_id===o),d=r.map(c=>{const p=t.filter(u=>u.producto_id===c.id);if(p.length===0)return"";const g=[...new Set(p.map(u=>u.color).filter(Boolean))].map(u=>{const b=p.filter(y=>y.color===u).sort((y,h)=>i.indexOf(y.talla)-i.indexOf(h.talla));return`
        <div style="margin-bottom:1rem">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap">
            ${b.map(y=>{const h=s.find(k=>k.variante_id===y.id),w=h?h.cantidad:0,_=h?h.stock_minimo:3;let C="#ddd";return w===0?C="#ffcdd2":w<=_?C="#ffe082":C="#a5d6a7",`
                <div style="text-align:center">
                  ...
                  <input type="number" min="0"
                         ...
                         data-variante="${y.id}"
                         data-anterior="${w}"
                         style="width:58px;text-align:center;padding:6px 4px;border:2px solid ${C};border-radius:8px;font-size:0.9rem;font-weight:600"
  ...
  `};window.guardarTraspaso=async()=>{const e=document.getElementById("tra").value,t=document.getElementById("tra-origen").value,a=document.getElementById("tra-destino").value,o=document.getElementById("tra-cantidad").value;if(!e||!t||!a||!o){alert("Por favor completa todos los campos");return}if(t===a){alert("La sucursal origen y destino no pueden ser la misma");return}try{const i=await(await fetch(f+"/movimientos/traspaso",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_origen_id:t,sucursal_destino_id:a,cantidad:parseInt(o)})})).json();i.ok?(alert("Traspaso realizado correctamente. Se movieron "+i.cantidad_movida+" pares."),navegarA("inventario")):alert("Error: "+(i.error||JSON.stringify(i)))}catch{alert("Error conectando con el servidor")}};async function ge(){const e=document.getElementById("content");try{const a=await(await fetch(f+"/pedidos/")).json();e.innerHTML=`
      <div style="margin-bottom:1rem;display:flex;gap:8px;flex-wrap:wrap;align-items:center">
  ...
  `).join(""),window.recalcularTotal()}};window.cambiarCantidadItem=async(e,t)=>{if(t>0){const a=window._pedidoItems[e],o=document.getElementById("ped-sucursal")?document.getElementById("ped-sucursal").value:"";if(o)try{const r=(await(await fetch(f+"/inventario/sucursal/"+o)).json()).find(d=>d.variante_id===a.variante_id),s=r?r.cantidad:0;if(a.cantidad>=s){alert("No hay mas existencia disponible. Maximo: "+s+" pares");return}}catch{}}window._pedidoItems[e].cantidad=Math.max(1,window._pedidoItems[e].cantidad+t),window.recalcularTotal(),renderItemsPedido()};window.guardarPedido=async()=>{const e=document.getElementById("ped-cliente").value,t=document.getElementById("ped-canal").value,a=document.getElementById("ped-sucursal").value,o=document.getElementById("ped-pago").value,n=document.getElementById("ped-comentarios").value;if(!e){alert("Selecciona un cliente");return}if(window._pedidoItems.length===0){alert("Agrega al menos un producto");return}const i=document.getElementById("btn-ped-guardar");i&&(i.textContent="Guardando...",i.disabled=!0);const r=window._pedidoItems.reduce((d,l)=>d+l.cantidad*l.precio_unitario,0),s=o==="spei"?"pendiente_pago":"confirmado";try{const d=await fetch(f+"/pedidos/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cliente_id:e,canal:t,sucursal_id:a,forma_pago:o,comentarios:n||null,total:r,subtotal:r,status:s})});if(!d.ok){alert("Error creando pedido"),i&&(i.textContent="Crear pedido",i.disabled=!1);return}const c=(await d.json())[0].id;for(const p of window._pedidoItems)await fetch(f+"/pedidos/"+c+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:p.variante_id,cantidad:p.cantidad,precio_unitario:p.precio_unitario,subtotal:p.cantidad*p.precio_unitario})});o!=="spei"&&o!=="mercadopago"&&await fetch(f+"/pedidos/"+c+"/confirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({forma_pago:o})}),alert("Pedido creado correctamente"),window._pedidoItems=[],verPedido(c)}catch{alert("Error conectando con el servidor"),i&&(i.textContent="Crear pedido",i.disabled=!1)}};window.verPedido=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando pedido...</p>';try{const o=await(await fetch(f+"/pedidos/"+e)).json();if(!o||o.length===0){alert("Pedido no encontrado");return}const n=o[0],i=n.pedido_items||[],r=n.clientes||{},s={borrador:"#f57f17",pendiente_pago:"#f57f17",confirmado:"#2e7d32",pagado:"#2e7d32",cancelado:"#c62828"}[n.status]||"#888";t.innerHTML=`
      <div class="table-card" style="padding:2rem">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;flex-wrap:wrap">
          <button class="btn btn-secondary" onclick="navegarA('pedidos')">← Volver</button>
  ...
  `,document.body.appendChild(c),c.addEventListener("click",p=>{p.target===c&&c.remove()}),window._posSeleccion={productoId:e,color:null},window._posBuffer={}};window.mostrarCorridaModalPOS=e=>{const{variantes:t,inventario:a}=window._posData,o=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=a.filter(p=>p.sucursal_id===o),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],r=[...new Set(t.filter(p=>p.producto_id===e).map(p=>p.color).filter(Boolean))],s=document.querySelector(`button[onclick="mostrarCorridaModalPOS('${e}')"]`);s&&(s.style.display="none"),document.querySelectorAll("#pos-modal").forEach(p=>{p!==document.getElementById("pos-modal")&&p.remove()}),window._posSeleccion.color=null,window._corridaCantidades={};const d=document.getElementById("pos-tallas-panel");if(!d)return;const l=p=>{const m=t.filter(g=>g.producto_id===e&&g.color===p).sort((g,u)=>i.indexOf(g.talla)-i.indexOf(u.talla));m.filter(g=>{const u=n.find(b=>b.variante_id===g.id);return u&&u.cantidad>0}),d.innerHTML=`
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:16px">
        ${r.map(g=>{const u=t.find(h=>h.producto_id===e&&h.color===g),b=u?u.color_hex:"#888",v=u?u.foto_url:null,y=Object.entries(window._corridaCantidades).filter(([h])=>t.find(w=>w.id===h&&w.color===g)).reduce((h,[,w])=>h+w,0);return`
            <div onclick="window._corridaColorActivo='${g}';renderCorridaColor('${g}')"
              ...
              ${v?`<img src="${v}" style="width:44px;height:44px;object-fit:cover;border-radius:6px">`:`<div style="width:44px;height:44px;border-radius:6px;background:${b}"></div>`}
              <span style="font-size:0.65rem;font-weight:600;color:#333;text-align:center">${g}</span>
              ${y>0?`<span style="position:absolute;top:-6px;right:-6px;background:#6a1b9a;color:white;font-size:0.6rem;font-weight:700;width:18px;height:18px;border-radius:50%;display:flex;align-items:center;justify-content:center">${y}</span>`:""}
            </div>
          `}).join("")}
      </div>

           <div style="display:flex;flex-direction:column;gap:8px">
        ${m.map(g=>{const u=n.find(y=>y.variante_id===g.id),b=u?u.cantidad:0,v=window._corridaCantidades[g.id]||0;return`
            <div style="display:flex;align-items:center;gap:10px;opacity:${b===0?"0.4":"1"}">
              ...
              <div style="display:flex;align-items:center;gap:6px">
                ...
                <input type="number" min="0" max="${b}"
                       ...
                       id="qty-corrida-${g.id}"
                       ${b===0?"disabled":""}
                       style="width:56px;height:40px;text-align:center;padding:4px;border:2px solid ${v>0?"#6a1b9a":"#ddd"};border-radius:8px;font-size:1rem;font-weight:700"
            ...
            <div style="display:flex;align-items:center;gap:10px;opacity:${b===0?"0.4":"1"}">
              ...
              <div style="display:flex;align-items:center;gap:6px">
                ...
                <input type="number" min="0" max="${b}"
                       ...
                       id="qty-modal-${g.id}"
                       ${b===0?"disabled":""}
                       style="width:50px;text-align:center;padding:5px;border:2px solid ${v>0?"#E91E8C":"#ddd"};border-radius:8px;font-size:1rem;font-weight:700"
...
`).join("")}
    `;const d=document.getElementById("pos-total"),l=document.getElementById("pos-total-pares"),c=document.getElementById("pos-tipo-precio");d&&(d.textContent="$"+o.toFixed(2)),l&&(l.textContent=a),c&&(c.textContent=n);const p=document.getElementById("pos-flotante-pares"),m=document.getElementById("pos-flotante-total");p&&(p.textContent=a+" pares"),m&&(m.textContent="$"+o.toFixed(2)),(g=document.getElementById("pos-drawer"))!=null&&g.classList.contains("open")&&renderDrawerPOS()};window.editarPrecioPOS=(e,t)=>{if(!window._posCarrito[e])return;const a=parseFloat(t)||0;window._posCarrito[e].precio_unitario=a,window._posCarrito[e].precio_manual=!0;const o=window._posCarrito[e].cantidad,n=document.getElementById("subtotal-item-"+e);n&&(n.textContent="$"+(o*a).toFixed(2));const i=window._posCarrito.reduce((s,d)=>s+d.cantidad*d.precio_unitario,0),r=document.getElementById("pos-total");r&&(r.textContent="$"+i.toFixed(2))};window.editarPrecioCorridaPOS=(e,t)=>{const[a,o]=e.split("|"),n=parseFloat(t)||0;window._posCarrito.forEach(c=>{c.producto_id===a&&c.color===o&&c.es_corrida&&(c.precio_unitario=n,c.precio_manual=!0)});const r=window._posCarrito.filter(c=>c.producto_id===a&&c.color===o&&c.es_corrida).reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),s=document.getElementById("subtotal-corrida-"+e.replace("|","-"));s&&(s.textContent="$"+r.toFixed(2));const d=window._posCarrito.reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),l=document.getElementById("pos-total");l&&(l.textContent="$"+d.toFixed(2))};window.editarCorridaEnCarrito=e=>{const[t,a]=e.split("|"),{inventario:o,variantes:n}=window._posData,i=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=o.filter(c=>c.sucursal_id===i),s=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=n.filter(c=>c.producto_id===t&&c.color===a).sort((c,p)=>s.indexOf(c.talla)-s.indexOf(p.talla)),l=document.createElement("div");l.id="pos-modal-editar-corrida",l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",l.innerHTML=`
  ...
  `),c.document.close()};window.generarPDFPedido=async e=>{const a=await(await fetch(f+"/pedidos/"+e)).json();if(!a||a.length===0)return;const o=a[0],n=o.pedido_items||[],i=o.clientes||{},r=new Date(o.created_at).toLocaleDateString("es-MX",{year:"numeric",month:"long",day:"numeric"}),s=o.total||0,d=n.reduce((c,p)=>c+p.cantidad,0),l=window.open("","_blank");l.document.write(`
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="UTF-8">
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
      ...
      </div>`,window._historialData=a}catch{e.innerHTML='<p style="padding:2rem;color:var(--red)">Error conectando con el servidor</p>'}}window.cancelarMovimiento=async(e,t,a,o,n)=>{if(confirm("¿Cancelar este movimiento? Se revertirá el cambio en el inventario."))try{const r=await(await fetch(f+"/inventario/?variante_id=eq."+a+"&sucursal_id=eq."+o)).json(),s=r&&r.length>0?r[0].cantidad:0,d=n==="venta"?s+t:Math.max(0,s-t);(await fetch(f+"/inventario/actualizar",{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:a,sucursal_id:o,cantidad:d,stock_minimo:r&&r.length>0?r[0].stock_minimo:3})})).ok?(alert("Movimiento cancelado. Inventario actualizado."),be()):alert("Error al actualizar inventario")}catch{alert("Error conectando con el servidor")}};window.filtrarHistorial=()=>{const e=document.getElementById("hist-tipo").value,t=document.getElementById("hist-buscar").value.toLowerCase(),a=window._historialData||[],o={venta:{label:"Venta",badge:"badge-success"},entrada:{label:"Entrada",badge:"badge-info"},ajuste:{label:"Ajuste",badge:"badge-warning"},traspaso_salida:{label:"Traspaso salida",badge:"badge-danger"},traspaso_entrada:{label:"Traspaso entrada",badge:"badge-info"},cambio_salida:{label:"Cambio salida",badge:"badge-info"},cambio_entrada:{label:"Cambio entrada",badge:"badge-info"}},n=a.filter(r=>{if(e&&r.tipo!==e)return!1;if(t){const s=(r.variantes&&r.variantes.productos?r.variantes.productos.nombre:"").toLowerCase(),d=(r.motivo||"").toLowerCase();if(!s.includes(t)&&!d.includes(t))return!1}return!0}),i=document.getElementById("hist-tbody");i&&(i.innerHTML=n.length===0?'<tr><td colspan="9" style="text-align:center;color:var(--text-muted);padding:2rem">No se encontraron movimientos</td></tr>':n.map(r=>{const s=o[r.tipo]||{label:r.tipo,badge:"badge-warning"},d=r.cantidad||0;return`<tr>
        ...
        </tr>`}).join(""))};async function Be(){try{const t=await(await fetch(f+"/pedidos/")).json(),o=await(await fetch(f+"/clientes/")).json(),i=await(await fetch(f+"/inventario/alertas")).json(),r=new Date;r.setHours(0,0,0,0);const s=new Date(r);s.setDate(s.getDate()-7);const d=new Date(r);d.setDate(d.getDate()-30);const l=t.filter(x=>x.status==="confirmado"||x.status==="pagado"),c=l.filter(x=>new Date(x.created_at)>=r),p=l.filter(x=>new Date(x.created_at)>=s),m=c.reduce((x,S)=>x+parseFloat(S.total||0),0),g=p.reduce((x,S)=>x+parseFloat(S.total||0),0),u=o.filter(x=>x.created_at&&new Date(x.created_at)>=d).length,b=["Dom","Lun","Mar","Mie","Jue","Vie","Sab"],v={};b.forEach(x=>v[x]=0),l.filter(x=>new Date(x.created_at)>=d).forEach(x=>{const S=b[new Date(x.created_at).getDay()];v[S]+=parseFloat(x.total||0)});const y={};l.forEach(x=>{y[x.canal||"sucursal"]=(y[x.canal||"sucursal"]||0)+parseFloat(x.total||0)});const h={};l.forEach(x=>{h[x.forma_pago||"efectivo"]=(h[x.forma_pago||"efectivo"]||0)+1});const w={};l.forEach(x=>{w[x.empleado||"Admin"]=(w[x.empleado||"Admin"]||0)+parseFloat(x.total||0)});const _={};l.forEach(x=>{const S=new Date(x.created_at).toLocaleDateString("es-MX",{month:"short",year:"numeric"});_[S]=(_[S]||0)+parseFloat(x.total||0)});const C={};l.forEach(x=>{x.clientes&&(C[x.clientes.nombre]=(C[x.clientes.nombre]||0)+parseFloat(x.total||0))});const k=Object.entries(C).sort((x,S)=>S[1]-x[1]).slice(0,5),$=Object.entries(v).sort((x,S)=>S[1]-x[1])[0],E=Object.entries(w).sort((x,S)=>S[1]-x[1])[0],T=document.getElementById("dashboard-contenido");if(!T)return;const M=T.querySelectorAll(".stat-card"),z=[{val:"$"+m.toFixed(0),sub:c.length+" pedidos hoy",color:"var(--pink)"},{val:c.length,sub:"confirmados hoy"},{val:"$"+g.toFixed(0),sub:p.length+" pedidos"},{val:u,sub:"ultimos 30 dias"},{val:i.length,sub:"por reabastecer",color:i.length>0?"var(--amber)":"var(--green)"},{val:$?$[0]:"—",sub:$?"$"+$[1].toFixed(0)+" prom.":""},{val:E?E[0]:"—",sub:E?"$"+E[1].toFixed(0):"",small:!0},{val:o.length,sub:"registrados"}];M.forEach((x,S)=>{if(!z[S])return;const P=x.querySelector(".stat-value"),B=x.querySelector(".stat-sub");P&&(P.textContent=z[S].val,P.style.color=z[S].color||"var(--text-primary)",z[S].small&&(P.style.fontSize="1rem")),B&&(B.textContent=z[S].sub||"")});const I=document.getElementById("dash-top-clientes");I&&(I.innerHTML=k.length===0?'<p style="color:var(--text-muted);font-size:0.85rem">Sin datos aun</p>':k.map(([x,S],P)=>`
          <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px">
            ...
            <span style="flex:1;font-size:0.875rem">${x}</span>
            <strong style="color:var(--pink)">$${S.toFixed(0)}</strong>
          </div>`).join(""));const O=document.getElementById("dash-ultimos-pedidos");O&&(O.innerHTML=t.slice(0,5).map(x=>`
        <div onclick="verPedido('${x.id}')" style="display:flex;align-items:center;justify-content:space-between;padding:8px 0;border-bottom:1px solid var(--border);cursor:pointer">
          <div>
            <p style="font-size:0.85rem;font-weight:500">${x.clientes?x.clientes.nombre:"General"}</p>
            <p style="font-size:0.72rem;color:var(--text-muted)">${x.canal} · ${new Date(x.created_at).toLocaleDateString("es-MX")}</p>
          </div>
          <div style="text-align:right">
            <p style="font-weight:700;color:var(--pink)">$${x.total||0}</p>
            <span class="badge ${x.status==="confirmado"||x.status==="pagado"?"badge-success":"badge-warning"}">${x.status}</span>
          </div>
        </div>`).join("")),setTimeout(()=>{const x={responsive:!0,plugins:{legend:{labels:{color:"#666",font:{size:11}}}},scales:{x:{ticks:{color:"#666",font:{size:11}},grid:{color:"rgba(0,0,0,0.05)"}},y:{ticks:{color:"#666",font:{size:11}},grid:{color:"rgba(0,0,0,0.05)"}}}},S=document.getElementById("chart-dias");S&&window.Chart&&new Chart(S,{type:"bar",data:{labels:b,datasets:[{data:b.map(L=>v[L]||0),backgroundColor:"rgba(233,30,140,0.2)",borderColor:"#E91E8C",borderWidth:2,borderRadius:6}]},options:{...x,plugins:{legend:{display:!1}}}});const P=document.getElementById("chart-canales");P&&window.Chart&&Object.keys(y).length>0&&new Chart(P,{type:"doughnut",data:{labels:Object.keys(y),datasets:[{data:Object.values(y),backgroundColor:["rgba(233,30,140,0.7)","rgba(0,151,178,0.7)","rgba(124,58,237,0.7)","rgba(46,125,50,0.7)"],borderColor:["#E91E8C","#0097b2","#7c3aed","#2e7d32"],borderWidth:2}]},options:{responsive:!0,cutout:"65%",plugins:{legend:{position:"bottom",labels:{color:"#666",font:{size:11},padding:12}}}}});const B=document.getElementById("chart-meses");if(B&&window.Chart){const L=Object.entries(_).slice(-6);new Chart(B,{type:"line",data:{labels:L.map(([A])=>A),datasets:[{data:L.map(([,A])=>A),borderColor:"#0097b2",backgroundColor:"rgba(0,151,178,0.08)",borderWidth:2,pointBackgroundColor:"#0097b2",pointRadius:4,fill:!0,tension:.4}]},options:{...x,plugins:{legend:{display:!1}}}})}const j=document.getElementById("chart-pagos");j&&window.Chart&&Object.keys(h).length>0&&new Chart(j,{type:"doughnut",data:{labels:Object.keys(h),datasets:[{data:Object.values(h),backgroundColor:["rgba(46,125,50,0.7)","rgba(245,127,23,0.7)","rgba(233,30,140,0.7)","rgba(124,58,237,0.7)"],borderColor:["#2e7d32","#f57f17","#E91E8C","#7c3aed"],borderWidth:2}]},options:{responsive:!0,cutout:"65%",plugins:{legend:{position:"bottom",labels:{color:"#666",font:{size:11},padding:12}}}}})},300);try{const S=await(await fetch(f+"/chatbot/tareas-hoy")).json(),P=document.createElement("div");P.style.cssText="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem;margin-top:1.5rem",P.innerHTML=`
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem">
        <h3 style="font-size:1rem;font-weight:700;margin:0">✅ Tareas pendientes hoy</h3>
        <span style="background:#e91e8c;color:white;border-radius:100px;padding:2px 10px;font-size:0.75rem">${S.filter(B=>!B.completada).length} pendientes</span>
      </div>
      ${S.length===0?'<p style="color:#aaa;font-size:0.85rem;text-align:center;padding:1rem">Sin tareas pendientes</p>':S.map(B=>`
        ...
        `).join("")}
    `,document.getElementById("dashboard-contenido").appendChild(P)}catch(x){console.error("tareas:",x)}}catch(e){console.error("Error dashboard:",e)}}window.eliminarItemPedido=e=>{window._pedidoItems.splice(e,1),window.recalcularTotal(),window.renderItemsPedido()};window.cerrarSesionPanel=()=>{confirm("Cerrar sesion?")&&(sessionStorage.removeItem("erp_empleado"),sessionStorage.removeItem("erp_token"),window._empleadoActual=null,location.reload())};async function ye(){const e=document.getElementById("content");try{const a=await(await fetch(f+"/empleados/",{headers:window.authHeaders()})).json();e.innerHTML=`
      <div class="table-card">
        <div class="table-header">
      ...
      </div>`}catch{e.innerHTML='<p style="padding:2rem;color:var(--red)">Error conectando con el servidor</p>'}}window.mostrarFormEmpleado=async e=>{const t=document.getElementById("content");let a={};if(e)try{a=(await(await fetch(f+"/empleados/",{headers:window.authHeaders()})).json()).find(i=>i.id===e)||{}}catch{}t.innerHTML=`
...
🛍️ Ver y comprar: https://zapatillasmay.mx`:""};window.enviarProductoWA=async(e,t,a)=>{var i;console.log("imagenUrl:",t,"caption:",a);const o=document.querySelector('div[style*="position:fixed"][style*="z-index:1000"]');o&&o.remove(),console.log("enviando a:",e,t);const n=((i=window._empleadoActual)==null?void 0:i.nombre)||"Admin";try{if(t){const d=a.replace(/\\n/g,`
`);await fetch(f+"/chatbot/chats/"+e+"/imagen",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:t,caption:d,agente:n})})}else await fetch(f+"/chatbot/chats/"+e+"/mensaje",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mensaje:a,agente:n})});await new Promise(d=>setTimeout(d,1500));const s=await(await fetch(f+"/chatbot/chats")).json();window._chatsData={},s.forEach(d=>window._chatsData[d.telefono]=d),abrirChat(e)}catch{alert("Error enviando producto")}};window.cargarEnviosMasivos=async function(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[t,a,o]=await Promise.all([fetch(f+"/chatbot/plantillas").then(r=>r.json()),fetch(f+"/clientes/").then(r=>r.json()),fetch(f+"/chatbot/chats").then(r=>r.json())]),n={};a.forEach(r=>{r.telefono&&(n[r.telefono]={telefono:r.telefono,nombre:r.nombre,fuente:"cliente"})}),o.forEach(r=>{n[r.telefono]||(n[r.telefono]={telefono:r.telefono,nombre:r.nombre||r.telefono,fuente:"whatsapp",etiqueta:r.etiqueta})});const i=Object.values(n);window._envioContactos=i,window._envioChats=o,window._envioClientes=a,e.innerHTML=`
  ...
  </div>`,document.body.appendChild(a);try{const i=await(await fetch(f+"/chatbot/envio-productos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contactos:e.map(r=>({telefono:r.telefono,nombre:r.nombre})),skus:t,titulo:"Nuestros modelos 👠",cuerpo:"Mira los modelos disponibles. ¡Elige el tuyo!",pie:"Zapatillas May · León, Gto."})})).json();if(i.error){a.innerHTML=`<div style="background:white;border-radius:16px;padding:2.5rem;max-width:400px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
...
<div>
  ...
  <div style="display:flex;gap:1rem;flex-wrap:wrap">
    ...
    <div class="table-card">
      ...
      <div style="display:flex;border-bottom:2px solid #e5e7eb;margin-bottom:20px;gap:4px">
        <button style="${ee(o,"subir")}" onclick="switchTabCat('subir')">📁 Subir imágenes</button>
        <button style="${ee(o,"seleccionar")}" onclick="switchTabCat('seleccionar')">🖼 De la tienda</button>
        <button style="${ee(o,"generar")}" onclick="switchTabCat('generar')">✨ Generar automático</button>
      </div>
    ...
    </div>`,o==="seleccionar"&&ve(e),o==="generar"&&he(e)}window.switchTabCat=function(e){const{catalogoId:t}=window._catalogoPaginasData;window._catalogoPaginasData.tabActiva=e,document.querySelectorAll("#tab-subir,#tab-seleccionar,#tab-generar").forEach(a=>a.style.display="none"),document.getElementById("tab-"+e).style.display="block",document.querySelectorAll('[onclick^="switchTabCat"]').forEach(a=>{var n;const o=(n=a.getAttribute("onclick").match(/'(\w+)'/))==null?void 0:n[1];a.style.borderBottomColor=o===e?"#C8967A":"transparent",a.style.color=o===e?"#C8967A":"#6b7280"}),e==="seleccionar"&&ve(t),e==="generar"&&he(t)};async function ve(e){const t=document.getElementById("selector-tienda-content");if(t)try{const[a,o]=await Promise.all([fetch(f+"/variantes/"),fetch(f+"/productos/")]),n=await a.json(),i=await o.json(),r=[];n.forEach(d=>{const l=i.find(p=>p.id===d.producto_id),c=(l==null?void 0:l.nombre)||d.sku||"";d.foto_url&&r.push({url:d.foto_url,nombre:c,color:d.color||""}),d.imagenes&&Array.isArray(d.imagenes)&&d.imagenes.forEach(p=>{p&&p!==d.foto_url&&r.push({url:p,nombre:c,color:d.color||""})})});const s=r.filter((d,l,c)=>c.findIndex(p=>p.url===d.url)===l);window._selectorFotos={fotos:s,seleccionadas:new Set},t.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(120px,1fr));gap:8px;max-height:420px;overflow-y:auto;padding:4px">
        ${n.map((r,s)=>{const d=i.filter(p=>p.producto_id===r.id),l=d.length?d.map(p=>p.precio_menudeo).filter(Boolean):[],c=r.precio_menudeo||(l.length?Math.min(...l):0);return`
          <div id="gen-item-${s}" onclick="_toggleGenProd(${s})"
      ...
      </div>`}catch(a){t.innerHTML='<p style="color:red">Error: '+a.message+"</p>"}}window._toggleGenProd=function(e){const{seleccionados:t}=window._generadorData,a=document.getElementById("gen-item-"+e);t.has(e)?(t.delete(e),a.style.borderColor="transparent"):(t.add(e),a.style.borderColor="#C8967A"),document.getElementById("gen-count").textContent=t.size+" seleccionados"};window._selTodosGenerador=function(){const{productos:e,seleccionados:t}=window._generadorData,a=t.size===e.length;t.clear(),e.forEach((o,n)=>{const i=document.getElementById("gen-item-"+n);a?i&&(i.style.borderColor="transparent"):(t.add(n),i&&(i.style.borderColor="#C8967A"))}),document.getElementById("gen-count").textContent=t.size+" seleccionados"};function Z(e){return new Promise(t=>{const a=new Image;a.crossOrigin="anonymous",a.onload=()=>t(a),a.onerror=()=>t(null),a.src=e+(e.includes("?")?"&":"?")+"_t="+Date.now()})}function ae(e,t,a,o,n,i){const r=t.split(" ");let s="",d=o;for(let l of r){const c=s+(s?" ":"")+l;e.measureText(c).width>n&&s?(e.fillText(s,a,d),s=l,d+=i):s=c}return s&&e.fillText(s,a,d),d+i}window.generarPaginasCanvas=async function(e){const{productos:t,variantes:a,seleccionados:o}=window._generadorData;if(!o.size){alert("Selecciona al menos un producto");return}const n=document.getElementById("gen-layout").value,i=n==="1e"?1:parseInt(n),r=Array.from(o).map(u=>t[u]),s=[];for(let u=0;u<r.length;u+=i)s.push(r.slice(u,u+i));const d=document.getElementById("btn-generar"),l=document.getElementById("gen-progress"),c=document.getElementById("gen-msg"),p=document.getElementById("gen-bar");d.disabled=!0,l.style.display="block";const{paginas:m}=window._catalogoPaginasData;let g=m.length>0?Math.max(...m.map(u=>u.pagina_numero))+1:1;for(let u=0;u<s.length;u++){const b=s[u];c.textContent=`Generando página ${u+1} de ${s.length}...`,p.style.width=u/s.length*100+"%";const v=document.createElement("canvas");v.width=1080,v.height=1440;const y=v.getContext("2d");if(y.fillStyle="#FAFAF8",y.fillRect(0,0,1080,1440),y.fillStyle="#C8967A",y.fillRect(60,48,960,1),y.fillStyle="#2A1A0E",y.font="300 22px DM Sans, sans-serif",y.textAlign="center",y.letterSpacing="8px",y.fillText("ZAPATILLAS MAY",540,42),y.letterSpacing="0px",y.fillStyle="#C8967A",y.fillRect(60,58,960,1),n==="1e"){const _=b[0],C=a.filter(j=>j.producto_id===_.id&&j.activa!==!1),k=[],$=new Set,E=j=>{j&&!$.has(j)&&($.add(j),k.push(j))};E(_.imagen_principal);for(const j of C)if(E(j.foto_url),Array.isArray(j.imagenes)&&j.imagenes.forEach(E),k.length>=3)break;const T=k.length,M=[],z=new Set;for(const j of C){const L=(j.color||"").trim();L&&!z.has(L)&&(z.add(L),M.push({color:L,hex:j.color_hex}))}const I={negro:"#1C1C1C",blanco:"#F8F8F8",hueso:"#F0EBE1",beige:"#D9C9A8",camel:"#C19A6B","cafe claro":"#A0725A","cafe medio":"#7A4A30","cafe oscuro":"#4A2010",cafe:"#6B3A2A",chocolate:"#3D1C02",cognac:"#9B4421",taupe:"#8B7355",nude:"#D4A97A","nude claro":"#E8C9A8","nude oscuro":"#C0886A","nude rosa":"#DDA090","palo de rosa":"#D4A0A0",salmon:"#FA8072",coral:"#FF6B4A",rojo:"#CC2200",vino:"#722F37",bordo:"#800020","rosa claro":"#F9C0CB",rosa:"#F4607A",fusha:"#E91E8C",naranja:"#FF8C00",amarillo:"#F5C518",dorado:"#D4AF37",oro:"#CFB53B","oro rosa":"#E8B4B8",plateado:"#C0C0C0","azul claro":"#5B8DB8",azul:"#1E4080","azul marino":"#001F5B",turquesa:"#40C4AA",verde:"#2D6A4F","verde menta":"#98D8C8","gris claro":"#C8C8C8",gris:"#909090","gris oscuro":"#505050",morado:"#7B2D8B",lila:"#C8A0D8",multicolor:"#CCAA88"},O=({color:j,hex:L})=>{if(L&&L.startsWith("#"))return L;const A=(j||"").toLowerCase();if(I[A])return I[A];for(const[D,F]of Object.entries(I))if(A.includes(D))return F;return"#BBAA99"},x=(j,L,A,D,F)=>{if(y.save(),y.fillStyle="#FFFFFF",y.fillRect(L,A,D,F),j){y.beginPath(),y.rect(L,A,D,F),y.clip();const H=j.naturalWidth/j.naturalHeight,N=D/F;let q,G,V,R;H>N?(V=D,R=D/H,q=L,G=A+(F-R)/2):(R=F,V=F*H,G=A,q=L+(D-V)/2),y.drawImage(j,q,G,V,R)}y.restore()},S=62,P=1080,B=S+P+12;if(T>=3){const[j,L,A]=await Promise.all(k.slice(0,3).map(Z)),D=10,F=10,H=648,N=1080-H-D,q=Math.floor((P-F)/2);x(j,0,S,H,P),x(L,H+D,S,N,q),x(A,H+D,S+q+F,N,q)}else if(T===2){const[j,L]=await Promise.all(k.map(Z)),A=10,D=Math.floor((1080-A)/2);x(j,0,S,D,P),x(L,D+A,S,D,P)}else{const[j]=await Promise.all([Z(k[0])]);x(j,40,S,1e3,P)}if(y.fillStyle="#E8DDD5",y.fillRect(0,B,1080,1),y.fillStyle="#2A1A0E",y.textAlign="center",y.font="300 28px DM Sans, sans-serif",y.letterSpacing="3px",ae(y,_.nombre.toUpperCase(),540,B+42,960,38),y.letterSpacing="0px",_.sku&&(y.fillStyle="#A07860",y.font="400 14px DM Mono, monospace",y.fillText(_.sku,540,B+66)),M.length>0){const A=Math.min(M.length,14),D=A*(11*2)+(A-1)*8;let F=Math.round(540-D/2+11);const H=B+100;for(let N=0;N<A;N++){const q=F+N*30;y.beginPath(),y.arc(q,H,11,0,Math.PI*2),y.fillStyle=O(M[N]),y.fill(),y.strokeStyle="rgba(0,0,0,0.18)",y.lineWidth=1.5,y.stroke()}}}else{const _=i<=2?i:2,C=i===4?2:1,k=80,$=100,E=i===1?0:20,T=i===4?20:0,M=i===1?40:28,z=(1080-M*2-E*(_-1))/_,I=(1440-k-$-T*(C-1))/C;for(let O=0;O<b.length;O++){const x=b[O],S=O%_,P=Math.floor(O/_),B=M+S*(z+E),j=k+P*(I+T),L=i===1?120:i===2?90:70,A=I-L,D=await Z(x.imagen_principal);if(y.save(),y.fillStyle="#FFFFFF",y.fillRect(B,j,z,A),D){y.beginPath(),y.rect(B,j,z,A),y.clip();const N=D.naturalWidth/D.naturalHeight,q=z/A;let G,V,R,K;N>q?(R=z,K=z/N,G=B,V=j+(A-K)/2):(K=A,R=A*N,V=j,G=B+(z-R)/2),y.drawImage(D,G,V,R,K)}y.restore(),y.fillStyle="#E8DDD5",y.fillRect(B,j+A,z,1);const F=j+A+L/2;y.fillStyle="#2A1A0E",y.textAlign="center";const H=i===1?34:i===2?24:19;y.font=`300 ${H}px DM Sans, sans-serif`,y.letterSpacing="2px",ae(y,x.nombre.toUpperCase(),B+z/2,F-8,z-32,H+10),y.letterSpacing="0px",x.sku&&(y.fillStyle="#A07860",y.font=`400 ${i===1?18:13}px DM Mono, monospace`,y.fillText(x.sku,B+z/2,F+(i===1?36:26)))}}y.fillStyle="#C8967A",y.fillRect(60,1340,960,1),y.fillStyle="#A07860",y.font="300 18px DM Sans, sans-serif",y.textAlign="center",y.letterSpacing="3px",y.fillText("@ZAPATILLASMAY",540,1368),y.letterSpacing="0px",y.fillStyle="#C0A898",y.font="300 15px DM Sans, sans-serif",y.fillText("zapatillasmay.mx  ·  León, Guanajuato",540,1394);const h=await new Promise(_=>v.toBlob(_,"image/jpeg",.92)),w=new FormData;w.append("archivo",h,`catalogo-pag-${g}.jpg`);try{const C=await(await fetch(f+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:w})).json();C.url&&await fetch(f+"/catalogos/"+e+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:C.url,pagina_numero:g++})})}catch(_){console.error("Error subiendo página generada",_)}}p.style.width="100%",c.textContent=`✅ ${s.length} páginas generadas`,setTimeout(()=>{l.style.display="none"},2e3),d.disabled=!1,await gestionarPaginas(e,window._catalogoPaginasData.nombre)};window.subirPaginasCatalogo=async function(e,t){const a=Array.from(e.files||e);if(!a.length)return;const o=document.getElementById("upload-progress"),n=document.getElementById("upload-msg"),i=document.getElementById("upload-bar");o&&(o.style.display="block");const{paginas:r}=window._catalogoPaginasData;let s=r.length>0?Math.max(...r.map(d=>d.pagina_numero))+1:1;for(let d=0;d<a.length;d++){n&&(n.textContent=`Subiendo ${d+1} de ${a.length}...`),i&&(i.style.width=d/a.length*100+"%");try{const l=new FormData;l.append("archivo",a[d]);const p=await(await fetch(f+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:l})).json();p.url&&await fetch(f+"/catalogos/"+t+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:p.url,pagina_numero:s++})})}catch(l){console.error("Error subiendo página "+(d+1),l)}}i&&(i.style.width="100%"),n&&(n.textContent="✅ Listo"),setTimeout(()=>{o&&(o.style.display="none")},1500),e.value!==void 0&&(e.value=""),await gestionarPaginas(t,window._catalogoPaginasData.nombre)};window.moverPagina=async function(e,t){const{paginas:a,catalogoId:o,nombre:n}=window._catalogoPaginasData,i=a.findIndex(l=>l.id===e);if(i===-1)return;const r=t==="up"?i-1:i+1;if(r<0||r>=a.length)return;const s=a[i].pagina_numero,d=a[r].pagina_numero;await Promise.all([fetch(f+"/catalogos/paginas/"+a[i].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:d})}),fetch(f+"/catalogos/paginas/"+a[r].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:s})})]),await gestionarPaginas(o,n)};window.eliminarPagina=async function(e,t){confirm("¿Eliminar esta página?")&&(await fetch(f+"/catalogos/paginas/"+e,{method:"DELETE"}),await gestionarPaginas(t,window._catalogoPaginasData.nombre))};window.usarComoPortada=async function(e,t){await fetch(f+"/catalogos/"+t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({portada_url:e})}),alert("✅ Portada actualizada")};window.descargarExcelTikTok=async function(e,t,a){const o=e.innerHTML;try{e.innerHTML="⏳ Generando...",e.disabled=!0;const n=await fetch(`${f}/tiktok/${t}`);if(!n.ok){const d=await n.text();throw new Error(`Error ${n.status}: ${d}`)}const i=await n.blob(),r=URL.createObjectURL(i),s=document.createElement("a");s.href=r,s.download=a,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(r)}catch(n){alert("Error al descargar el archivo: "+n.message)}finally{e.innerHTML=o,e.disabled=!1}};document.querySelector("#app").style.cssText="display:flex;min-height:100vh;width:100%";const xe="erp_empleado";function ne(){document.querySelector("#app").innerHTML=`
  ...
  `,window.hacerLogin=async()=>{const t=document.getElementById("login-email").value,a=document.getElementById("login-password").value,o=document.getElementById("btn-login");if(document.getElementById("login-error"),!t||!a){e("Por favor completa todos los campos");return}o.textContent="Verificando...",o.disabled=!0;try{const n=await fetch("/api/empleados/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),i=await n.json();n.ok?(sessionStorage.setItem(xe,JSON.stringify(i)),i.token&&sessionStorage.setItem("erp_token",i.token),window._empleadoActual=i,de()):(e(i.error||"Email o contrasena incorrectos"),o.textContent="Iniciar sesion",o.disabled=!1)}catch{e("Error conectando con el servidor"),o.textContent="Iniciar sesion",o.disabled=!1}};function e(t){const a=document.getElementById("login-error");a&&(a.textContent=t,a.style.display="block")}}window.authHeaders=()=>{const e=sessionStorage.getItem("erp_token");return e?{"Content-Type":"application/json",Authorization:`Bearer ${e}`}:{"Content-Type":"application/json"}};const ie=sessionStorage.getItem(xe);if(ie)try{window._empleadoActual=JSON.parse(ie),de()}catch{ne()}else ne();
