(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function o(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=o(n);fetch(n.href,i)}})();const b="/api",Se=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],Ze=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],Qe=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],ie=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"resenas",icon:"⭐",label:"Reseñas",section:"Catalogo",soloAdmin:!0},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"carritos",icon:"🛒",label:"Carritos",section:"Ventas"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"envio",icon:"🚚",label:"Envíos",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"},{id:"catalogos",icon:"📖",label:"Catálogos",section:"Catalogo",soloAdmin:!0},{id:"orden-home",icon:"🏠",label:"Orden en Home",section:"Catalogo",soloAdmin:!0},{id:"generar-nombres",icon:"✏️",label:"Generar nombres",section:"Catalogo",soloAdmin:!0},{id:"mercadolibre",icon:"🛒",label:"MercadoLibre",section:"Integraciones",soloAdmin:!0},{id:"analytics",icon:"📊",label:"Google Analytics",section:"Integraciones",soloAdmin:!0},{id:"referidos",icon:"🎁",label:"Referidos",section:"Ventas",soloAdmin:!0},{id:"carritos-abandonados",icon:"🛒",label:"Carritos abandonados",section:"Ventas",soloAdmin:!0}];var ze;let te=((ze=window._empleadoActual)==null?void 0:ze.rol)==="admin"?"dashboard":"pos",Ie=1;function Te(){var d,l;const e=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),t=((d=window._empleadoActual)==null?void 0:d.rol)==="admin"?"dashboard":"pos";te=e||t,document.querySelector("#app").innerHTML=`
    ...
    <div class="main">
      <div class="topbar">
        <div style="display:flex;align-items:center;gap:1rem">
          ...
          <h1 id="topbar-title">${((l=ie.find(c=>c.id===te))==null?void 0:l.label)||"Dashboard"}</h1>
        </div>
  ...
  `,window.toggleSidebar=()=>{const c=document.getElementById("sidebar"),p=document.getElementById("sidebar-overlay"),m=c.classList.toggle("open");p.classList.toggle("active",m),document.body.style.overflow=m?"hidden":""},window._conversacionesInterval&&clearInterval(window._conversacionesInterval),window._conversacionesInterval=setInterval(async()=>{try{const c=await window._recargarChats(),p=window._totalNoLeidos||0,m=c.reduce((g,u)=>g+(u.no_leidos||0),0);if(window._totalNoLeidos=m,m>p){document.title=`(${m}) Zapatillas May`;const g=document.querySelector('[data-modulo="conversaciones"]');if(g){let u=g.querySelector(".nav-badge");u||(u=document.createElement("span"),u.className="nav-badge",u.style.cssText="background:#e91e8c;color:white;border-radius:100px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:auto",g.appendChild(u)),u.textContent=m}try{const u=new(window.AudioContext||window.webkitAudioContext),v=u.createOscillator(),f=u.createGain();v.connect(f),f.connect(u.destination),v.frequency.value=523,f.gain.setValueAtTime(.5,u.currentTime),f.gain.exponentialRampToValueAtTime(.001,u.currentTime+.2),v.start(u.currentTime),v.stop(u.currentTime+.2);const y=u.createOscillator(),h=u.createGain();y.connect(h),h.connect(u.destination),y.frequency.value=783,h.gain.setValueAtTime(.5,u.currentTime+.2),h.gain.exponentialRampToValueAtTime(.001,u.currentTime+.5),y.start(u.currentTime+.2),y.stop(u.currentTime+.5)}catch{}}try{window._refrescarListaChats(c)}catch{}if(window._chatActivo&&window._chatsData[window._chatActivo]){const g=window._chatsData[window._chatActivo],u=document.getElementById("mensajes-area");if(u){const v=u.scrollHeight-u.scrollTop<=u.clientHeight+60;u.innerHTML=window._renderBurbujas(g),v&&(u.scrollTop=u.scrollHeight)}}}catch{}},8e3);const o="zm_badge_pedidos";let a=new Set;function n(c){const p=document.getElementById("badge-pedidos-enviar");p&&(p.textContent=c,p.style.display=c>0?"inline":"none")}async function i(){try{const c=await fetch(b+"/pedidos/?status=pagado");if(!c.ok)return;const m=(await c.json()).filter(f=>f.mp_preference_id||f.mp_payment_id),g=m.length;localStorage.setItem(o,g),n(g);const u=new Set(m.map(f=>f.id)),v=m.filter(f=>!a.has(f.id));v.length>0&&a.size>0&&v.forEach(f=>{const y=f.nombre_cliente||"Cliente",h=parseFloat(f.total||0).toLocaleString("es-MX",{maximumFractionDigits:0});r(`🛍️ Nuevo pedido de ${y} — $${h} MXN`)}),a=u}catch{}}function r(c){const p=document.createElement("div");p.style.cssText="position:fixed;bottom:24px;right:24px;background:#1a1a2e;color:white;padding:14px 20px;border-radius:12px;font-size:0.85rem;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3);z-index:9999;cursor:pointer;max-width:320px;line-height:1.4;border-left:4px solid #e53935",p.textContent=c,p.onclick=()=>{navegarA("pedidos"),p.remove()},document.body.appendChild(p),setTimeout(()=>p.remove(),8e3),Notification.permission==="granted"?new Notification("Zapatillas May — Panel",{body:c,icon:"/favicon.ico"}):Notification.permission==="default"&&Notification.requestPermission();try{const m=new AudioContext,g=m.createOscillator(),u=m.createGain();g.connect(u),u.connect(m.destination),g.frequency.setValueAtTime(880,m.currentTime),g.frequency.setValueAtTime(1100,m.currentTime+.1),u.gain.setValueAtTime(.15,m.currentTime),u.gain.exponentialRampToValueAtTime(.001,m.currentTime+.4),g.start(),g.stop(m.currentTime+.4)}catch{}}window._limpiarBadgePedidos=function(){const c=document.getElementById("badge-pedidos-enviar");c&&(c.style.display="none"),a=new Set([...a])};function s(){if(document.getElementById("badge-pedidos-enviar")){const c=parseInt(localStorage.getItem(o)||"0",10);c>0&&n(c),i()}else setTimeout(s,400)}s(),window._pedidosInterval&&clearInterval(window._pedidosInterval),window._pedidosInterval=setInterval(i,3e4),window.navegarA=c=>{var v;const p=((v=window._empleadoActual)==null?void 0:v.rol)==="admin",m=ie.find(f=>f.id===c);if(m!=null&&m.soloAdmin&&!p){alert("No tienes permisos para acceder a este módulo");return}te=c;try{localStorage.setItem("zm_panel_modulo",c)}catch{}const g=document.getElementById("sidebar"),u=document.getElementById("sidebar-overlay");g.classList.contains("open")&&(g.classList.remove("open"),u.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(f=>f.classList.remove("active")),document.querySelector('[data-modulo="'+c+'"]').classList.add("active"),document.getElementById("topbar-title").textContent=ie.find(f=>f.id===c).label,je(c)}}function et(){var o;const e=((o=window._empleadoActual)==null?void 0:o.rol)==="admin";return[...new Set(ie.filter(a=>e||!a.soloAdmin).map(a=>a.section))].map(a=>`
    ...
    `).join("")}
  `).join("")}async function je(e){var o;const t=document.getElementById("content");switch(t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>',e){case"catalogos":await xe();break;case"dashboard":t.innerHTML=ot(),setTimeout(()=>lt(),100);break;case"productos":await pe();break;case"resenas":await cargarResenasModeracion();break;case"clientes":await Ae();break;case"carritos":await Ee();break;case"pedidos":await De(),(o=window._limpiarBadgePedidos)==null||o.call(window);break;case"sucursales":await nt();break;case"inventario":await it();break;case"pos":await Fe();break;case"historial":await Ne();break;case"empleados":await Re();break;case"seo":await mt();break;case"envio":await pt();break;case"analisis":await at();break;case"crm":await Be();break;case"finanzas":await se();break;case"proveedores":await Pe();break;case"ordenes":await re();break;case"conversaciones":await cargarConversaciones();break;case"envios":await cargarEnviosMasivos();break;case"mercadolibre":await gt();break;case"analytics":await bt();break;case"orden-home":await ft();break;case"generar-nombres":await $t();break;case"referidos":await $e();break;case"carritos-abandonados":await ct();break}}function tt(){return setTimeout(()=>{document.querySelectorAll(".nav-item").forEach(a=>a.classList.remove("active"));const e=document.querySelector('[data-modulo="'+te+'"]');e&&e.classList.add("active");const t=document.getElementById("topbar-title"),o=ie.find(a=>a.id===te);t&&o&&(t.textContent=o.label),je(te)},100),'<div style="padding:2rem;color:#888;text-align:center">Cargando...</div>'}async function re(){var t;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando sugerencias...</p>';try{const a=await(await fetch(b+"/sucursales/")).json(),n=(t=a[0])==null?void 0:t.id,[i,r]=await Promise.all([fetch(b+"/finanzas/sugerencias-recompra/"+n),fetch(b+"/finanzas/proveedores")]),s=await i.json(),d=await r.json(),l=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),c=new Date().toISOString().split("T")[0],p=s.filter(f=>{const y=l[f.producto_id];return y?y.hasta===null||y.hasta===void 0?!1:y.hasta<=c:!0}),m=s.length-p.length;window._ordenesData={sugerencias:p,proveedores:d,sucursalId:n},window._ordenSeleccion={};const g=p.filter(f=>f.urgente),u=p.filter(f=>!f.urgente),v=p.reduce((f,y)=>f+y.cantidad_sugerida*y.costo_unitario,0);e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          <p style="font-size:1.6rem;font-weight:700;color:#333">${p.reduce((f,y)=>f+y.cantidad_sugerida,0)}</p>
              ...
              <div class="orden-item" data-urgente="${f.urgente}" style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
                ...
                <div style="flex:1;min-width:140px">
                  ...
                  <div style="margin-top:6px;display:flex;flex-wrap:wrap;gap:4px">
                    ${f.variantes.map(y=>{const h=[y.talla,y.color].filter(Boolean).join(" / "),x=y.sin_stock;return`<span style="
                      ...
                      " title="${x?"Sin stock":"Stock: "+y.stock}">${h}${x?" ✗":""}</span>`}).join("")}
                  </div>`:""}
                </div>
  ...
  `,document.body.appendChild(n),n.addEventListener("click",i=>{i.target===n&&n.remove()}),setTimeout(ordenRecalcTotal,50)};window.guardarOrdenCompra=async e=>{var n,i,r;const t=(n=document.getElementById("orden-fecha"))==null?void 0:n.value,o=((i=document.getElementById("orden-notas"))==null?void 0:i.value)||"",a=window._ordenesData.sucursalId;try{const s=typeof e=="string"?JSON.parse(e):e;for(const[d,l]of s){const c=l.productos.reduce((u,v)=>u+v.cantidad_final*v.costo_unitario,0),g=(r=(await(await fetch(b+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:d==="sin-proveedor"?null:d,sucursal_id:a,status:"borrador",total:c,notas:o,fecha_entrega_estimada:t||null})})).json())[0])==null?void 0:r.id;if(g)for(const u of l.productos)await fetch(b+"/finanzas/ordenes/"+g+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:null,cantidad:u.cantidad_final,costo_unitario:u.costo_unitario,subtotal:u.cantidad_final*u.costo_unitario})})}document.querySelector('div[style*="position:fixed"]').remove(),alert("Orden de compra guardada exitosamente"),re()}catch(s){alert("Error guardando orden: "+s.message)}};window.ordenToggleVar=(e,t)=>{const o=document.getElementById("qty-var-"+e);o&&(o.disabled=!t,o.style.opacity=t?"1":"0.35",o.style.borderColor=t?"#E91E8C":"#ddd",t&&(!o.value||o.value==="0")?o.value=1:t||(o.value=0),ordenRecalcTotal())};window.ordenRecalcTotal=()=>{const{seleccionados:e}=window._ordenModal||{};if(!e)return;let t=0;e.forEach(a=>{var n;if((a.variantes||[]).forEach(i=>{var d;const r=document.getElementById("chk-var-"+i.id),s=parseInt(((d=document.getElementById("qty-var-"+i.id))==null?void 0:d.value)||0);r!=null&&r.checked&&s>0&&(t+=s*a.costo_unitario)}),!a.variantes||a.variantes.length===0){const i=parseInt(((n=document.getElementById("qty-orden-"+a.producto_id))==null?void 0:n.value)||a.cantidad_sugerida);t+=i*a.costo_unitario}});const o=document.getElementById("orden-total-general");o&&(o.textContent="$"+t.toFixed(0))};window.imprimirOrden=()=>{var s,d;const{seleccionados:e}=window._ordenModal||{};if(!e)return;const t=((s=document.getElementById("orden-fecha"))==null?void 0:s.value)||"",o=((d=document.getElementById("orden-notas"))==null?void 0:d.value)||"",a=new Date().toLocaleDateString("es-MX");let n="",i=0;e.forEach(l=>{var p;const c=l.variantes||[];if(c.length===0){const m=parseInt(((p=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:p.value)||l.cantidad_sugerida),g=m*l.costo_unitario;i+=g,n+=`<tr><td>${l.nombre}</td><td>${l.sku||""}</td><td>—</td><td>—</td><td style="text-align:center">${m}</td><td style="text-align:right">$${g.toFixed(0)}</td></tr>`}else c.forEach(m=>{var f;const g=document.getElementById("chk-var-"+m.id);if(!(g!=null&&g.checked))return;const u=parseInt(((f=document.getElementById("qty-var-"+m.id))==null?void 0:f.value)||0);if(u<=0)return;const v=u*l.costo_unitario;i+=v,n+=`<tr style="${m.sin_stock?"background:#fff5f5":""}">
          ...
          <td style="text-align:right">$${v.toFixed(0)}</td>
...
¿Quieres reactivar todos?`)&&(localStorage.removeItem("ordenes_pospuestos"),re())};window.guardarOrdenCompra2=async()=>{var i,r,s,d;const{seleccionados:e,sucursalId:t}=window._ordenModal||{};if(!e)return;const o=(i=document.getElementById("orden-fecha"))==null?void 0:i.value,a=((r=document.getElementById("orden-notas"))==null?void 0:r.value)||"",n={};e.forEach(l=>{var g,u;const c=l.proveedor_id||"sin-proveedor",p=((g=l.proveedor)==null?void 0:g.nombre)||"Sin proveedor";n[c]||(n[c]={nombre:p,items:[]});const m=l.variantes||[];if(m.length===0){const v=parseInt(((u=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:u.value)||l.cantidad_sugerida);n[c].items.push({variante_id:null,cantidad:v,costo_unitario:l.costo_unitario})}else m.forEach(v=>{var h;const f=document.getElementById("chk-var-"+v.id);if(!(f!=null&&f.checked))return;const y=parseInt(((h=document.getElementById("qty-var-"+v.id))==null?void 0:h.value)||0);y<=0||n[c].items.push({variante_id:v.id,cantidad:y,costo_unitario:l.costo_unitario})})});try{for(const[l,c]of Object.entries(n)){if(c.items.length===0)continue;const p=c.items.reduce((v,f)=>v+f.cantidad*f.costo_unitario,0),u=(s=(await(await fetch(b+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:l==="sin-proveedor"?null:l,sucursal_id:t,status:"borrador",total:p,notas:a,fecha_entrega_estimada:o||null})})).json())[0])==null?void 0:s.id;if(u)for(const v of c.items)await fetch(b+"/finanzas/ordenes/"+u+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...v,subtotal:v.cantidad*v.costo_unitario})})}(d=document.getElementById("modal-orden"))==null||d.remove(),alert("Orden de compra guardada"),re()}catch(l){alert("Error guardando orden: "+l.message)}};function ot(){var o;const e=new Date().toLocaleDateString("es-MX",{weekday:"long",day:"numeric",month:"long"});return`
  ...
  `}async function se(){var t,o,a,n,i,r;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando finanzas...</p>';try{const d=await(await fetch(b+"/sucursales/")).json(),l=(t=d[0])==null?void 0:t.id,[c,p,m,g,u,v,f]=await Promise.all([fetch(b+"/finanzas/caja/hoy/"+l),fetch(b+"/finanzas/reporte/"+l),fetch(b+"/finanzas/gastos/"+l),fetch(b+"/finanzas/estado-resultados/"+l),fetch(b+"/finanzas/flujo/"+l),fetch(b+"/finanzas/cuentas-por-cobrar"),fetch(b+"/finanzas/gastos-categorias/"+l)]),y=await c.json(),h=await p.json(),x=await m.json(),E=await g.json(),w=await u.json(),C=await v.json(),T=await f.json(),$=y.find(A=>A.status==="abierta"),z=new Date().toISOString().split("T")[0],G=x.filter(A=>{var k;return(k=A.created_at)==null?void 0:k.startsWith(z)}),S=G.reduce((A,k)=>A+parseFloat(k.monto||0),0),M=C.reduce((A,k)=>A+parseFloat(k.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
    ...
    `,window._finanzasData={sucursalId:l,gastosHoy:G,totalGastosHoy:S,estadoResultados:E,flujo:w,cxc:C,categorias:T,historial:[],reporte:h},window._finanzasSucursalId=l;const P=await(await fetch(b+"/finanzas/caja/historial/"+l)).json();window._finanzasData.historial=P,mostrarTabFinanzas("gastos")}catch(s){e.innerHTML='<p style="padding:2rem;color:red">Error cargando finanzas: '+s.message+"</p>"}}window.mostrarTabFinanzas=e=>{var c,p,m,g,u,v,f,y,h,x,E,w,C,T;const{gastosHoy:t,totalGastosHoy:o,estadoResultados:a,flujo:n,cxc:i,categorias:r,historial:s,sucursalId:d}=window._finanzasData,l=document.getElementById("fin-tab-contenido");if(l)if(e==="cmv"){const $=((c=window._finanzasData.reporte)==null?void 0:c.desglose_cmv)||[],z=window._finanzasData.reporte||{},G=$.reduce((A,k)=>A+k.subtotal_costo,0),S=$.reduce((A,k)=>A+k.subtotal_venta,0),M=S>0?(S-G)/S*100:0,F=z.num_pedidos_sin_desglose||0,P=z.total_sin_desglose||0;l.innerHTML=`
      <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
        <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        ...
        <div style="background:#fff8e1;border-bottom:1px solid #ffe082;padding:12px 20px;font-size:0.83rem;color:#6d4c00;display:flex;align-items:center;gap:10px">
          ...
          <span><strong>${F} pedido${F>1?"s":""} ($${P.toLocaleString("es-MX",{maximumFractionDigits:0})} MXN)</strong> no tienen productos desglosados — por eso "Ventas 30 días" es mayor que "Venta total" aquí. Son ventas registradas sin items individuales (POS antiguo o pedidos manuales sin productos).</span>
        </div>`:""}
        ${$.length===0?'<p style="padding:2rem;text-align:center;color:#888">Sin ventas con costo registrado en los últimos 30 días</p>':`<div style="overflow-x:auto">
            <table style="width:100%;border-collapse:collapse;font-size:0.83rem">
              ...
              <tbody>
                ${$.map(A=>{const k=A.subtotal_venta>0?(A.subtotal_venta-A.subtotal_costo)/A.subtotal_venta*100:0,B=k>=30?"#2e7d32":k>=15?"#f57f17":"#c62828";return`<tr style="border-bottom:1px solid #f5f5f5">
                    ...
                    <td style="padding:10px 8px;text-align:right;font-weight:700;color:${B}">${k.toFixed(1)}%</td>
                  </tr>`}).join("")}
              </tbody>
              <tfoot>
    ...
    `}else if(e==="gastos"){const $=r.reduce((z,G)=>z+G.total,0);l.innerHTML=`
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
        <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
          ...
          ${t.length===0?'<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">Sin gastos hoy</div>':t.map(z=>`
              <div style="padding:0.75rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:12px">
                <div style="flex:1">
                  <p style="font-size:0.85rem;font-weight:600">${z.concepto}</p>
                  <p style="font-size:0.72rem;color:#888">${z.categoria} · ${new Date(z.created_at).toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"})}</p>
                </div>
                <p style="font-weight:700;color:#c62828">-$${parseFloat(z.monto).toFixed(2)}</p>
                <button onclick="eliminarGasto('${z.id}')" style="background:none;border:none;color:#ccc;cursor:pointer;font-size:1.1rem">✕</button>
              </div>
            `).join("")}
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
          ...
          <div style="padding:1rem">
            ${r.length===0?'<p style="color:#888;text-align:center;padding:1rem">Sin gastos registrados</p>':r.map(z=>`
                <div style="margin-bottom:12px">
                  <div style="display:flex;justify-content:space-between;margin-bottom:4px">
                    <span style="font-size:0.82rem;font-weight:600;text-transform:capitalize">${z.categoria}</span>
                    <span style="font-size:0.82rem;color:#c62828;font-weight:700">$${z.total.toFixed(0)}</span>
                  </div>
                  <div style="background:#f5f5f5;border-radius:100px;height:8px;overflow:hidden">
                    <div style="background:#E91E8C;height:100%;width:${$>0?(z.total/$*100).toFixed(0):0}%;border-radius:100px;transition:width 0.5s"></div>
                  </div>
                </div>
              `).join("")}
          </div>
      ...
      <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
        ...
        <div style="padding:1rem 1.5rem;background:#f9f9f9;display:flex;gap:2rem;flex-wrap:wrap">
          <div>
            ...
            <p style="font-weight:700;color:#E91E8C">$${a.reduce(($,z)=>$+z.ventas,0).toFixed(0)}</p>
          </div>
          <div>
            <p style="font-size:0.72rem;color:#888">Total gastos 6 meses</p>
            <p style="font-weight:700;color:#c62828">$${a.reduce(($,z)=>$+z.gastos,0).toFixed(0)}</p>
          </div>
          <div>
            <p style="font-size:0.72rem;color:#888">Utilidad total</p>
            <p style="font-weight:700;color:#2e7d32">$${a.reduce(($,z)=>$+z.utilidad,0).toFixed(0)}</p>
          </div>
        </div>
      </div>
    `:e==="flujo"?l.innerHTML=`
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            ...
            <span style="font-weight:700;color:#E91E8C;font-size:1.1rem">$${(((v=n.hoy)==null?void 0:v.total)||0).toFixed(0)}</span>
          </div>
        </div>
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            ...
            <span style="font-weight:700;color:${(((h=n.semana)==null?void 0:h.neto)||0)>=0?"#2e7d32":"#c62828"};font-size:1.1rem">$${(((x=n.semana)==null?void 0:x.neto)||0).toFixed(0)}</span>
          </div>
        </div>
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            <span style="font-size:0.85rem;font-weight:700">Neto</span>
            <span style="font-weight:700;color:${(((C=n.mes)==null?void 0:C.neto)||0)>=0?"#2e7d32":"#c62828"};font-size:1.1rem">$${(((T=n.mes)==null?void 0:T.neto)||0).toFixed(0)}</span>
          </div>
        </div>
      </div>
    `:e==="caja"?l.innerHTML=`
...
Diferencia: $${(n=r.diferencia)==null?void 0:n.toFixed(2)}`),se()):alert("Error: "+JSON.stringify(r))}catch{alert("Error cerrando caja")}};window.agregarGasto=e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",t.innerHTML=`
  ...
  `,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()})};window.guardarProveedor=async e=>{const t={nombre:document.getElementById("prov-nombre").value,contacto:document.getElementById("prov-contacto").value,telefono:document.getElementById("prov-telefono").value,email:document.getElementById("prov-email").value,ciudad:document.getElementById("prov-ciudad").value,direccion:document.getElementById("prov-direccion").value,notas:document.getElementById("prov-notas").value};if(!t.nombre){alert("El nombre es requerido");return}try{e?await fetch(b+"/finanzas/proveedores/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):await fetch(b+"/finanzas/proveedores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),document.querySelector('div[style*="position:fixed"]').remove(),Pe()}catch{alert("Error guardando proveedor")}};window.editarProveedor=async e=>{const a=(await(await fetch(b+"/finanzas/proveedores")).json()).find(n=>n.id===e);a&&mostrarFormProveedor(a)};async function at(){const e=document.getElementById("content");e.innerHTML=`
    ...
    <style>@keyframes pulse{0%,100%{opacity:1}50%{opacity:0.5}}</style>`;try{let A=function(_,L,O){return`<div style="display:flex;align-items:center;gap:6px">
        <div style="flex:1;height:6px;background:#f1f5f9;border-radius:3px;overflow:hidden">
          <div style="width:${L>0?Math.round(_/L*100):0}%;height:100%;background:${O};border-radius:3px;transition:width 0.4s ease"></div>
        </div>
        ...
        <div id="rotacion-lista" style="display:flex;flex-direction:column;gap:8px">
          ${z.map(_=>{const L=P[_.semaforo],O=Math.max(...z.map(I=>I.ventas.d30),1);return`
        ...
        </div>`},B=function(_){_=(_||"").toLowerCase();const L=z.filter(j=>(j.tallasDesglosadas.length>0||j.tallasData.some(H=>H.total>0))&&(!_||j.nombre.toLowerCase().includes(_)||(j.sku_interno||"").toLowerCase().includes(_))),O=z.filter(j=>j.tallasData.some(H=>H.total>0)).length,I=`
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;padding:9px 14px;background:#f8fafc;border-radius:10px;border:1px solid #e2e8f0;flex-wrap:wrap">
          ...
          ${[{bg:"#f8fafc",txt:"Sin ventas"},{bg:"#fce7f3",txt:"1–2 pares"},{bg:"#fbcfe8",txt:"Moderado"},{bg:"#f472b6",txt:"Buenas"},{bg:"#E91E8C",txt:"Muy buenas"}].map(j=>`
            <div style="display:flex;align-items:center;gap:4px">
              <div style="width:16px;height:16px;border-radius:3px;background:${j.bg};border:1px solid rgba(0,0,0,0.08);flex-shrink:0"></div>
              <span style="font-size:0.68rem;color:#475569">${j.txt}</span>
            </div>`).join("")}
          <span style="font-size:0.68rem;color:#94a3b8;margin-left:2px">— Número = pares totales · (+X) = últimos 30 días</span>
        </div>`;function q(j){const H=Math.max(...j.map(R=>R.total),1);return j.map(R=>{const N=Math.round(R.total/H*100),W=N===0?"#f8fafc":N<20?"#fce7f3":N<50?"#fbcfe8":N<80?"#f472b6":"#E91E8C",X=N>=50?"white":N===0?"#cbd5e1":"#be185d",Q=N>=50?"rgba(255,255,255,0.75)":"#db2777";return`
        ...
        ${I}
        ${L.length===0?'<div style="padding:3rem;text-align:center;color:#94a3b8;font-size:0.9rem">No se encontraron modelos</div>':L.map(j=>{const H=j.tallasData.find(N=>N.total>0),R=j.tallasDesglosadas.length>0;return`
            <div style="background:white;border:1px solid #e2e8f0;border-radius:12px;padding:16px;margin-bottom:10px">
              <!-- cabecera del producto -->
              <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px;flex-wrap:wrap">
                ${j.imagen_principal?`<img src="${j.imagen_principal}" style="width:40px;height:40px;object-fit:contain;border-radius:8px;background:#f8fafc;flex-shrink:0">`:""}
                <div style="flex:1">
                  <p style="font-weight:700;font-size:0.88rem;color:#0f172a">${j.nombre}</p>
                  <p style="font-size:0.7rem;color:#94a3b8">${j.ventas.d90} pares en 90d · ${R?j.tallasDesglosadas.length+" colores con ventas":j.tallasData.filter(N=>N.total>0).length+" tallas con movimiento"}</p>
                </div>
                ${H?`
              ...
              ${R?j.tallasDesglosadas.map(N=>`
                  ...
                  </div>`).join('<hr style="border:none;border-top:1px solid #f1f5f9;margin:4px 0 12px">'):`<div style="display:flex;gap:6px;flex-wrap:wrap">${q(j.tallasData)}</div>`}
            </div>`}).join("")}
      `},D=function(){const _=z.filter(L=>L.variantesData.some(O=>O.total>0));return _.length===0?'<div style="padding:3rem;text-align:center;color:#94a3b8;font-size:0.9rem">No hay datos de ventas por variante aún</div>':_.map(L=>{const O=L.variantesData.slice(0,8),I=Math.max(...O.map(j=>j.total),1),q=O[0];return`
        <div style="background:white;border:1px solid #e2e8f0;border-radius:12px;padding:16px;margin-bottom:10px">
          <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;flex-wrap:wrap">
            ...
            <div style="flex:1">
              ...
              <p style="font-size:0.7rem;color:#94a3b8">${L.variantesData.filter(j=>j.total>0).length} de ${L.variantesData.length} variantes con ventas</p>
            </div>
          ...
          <div style="display:flex;flex-direction:column;gap:6px">
            ${O.map((j,H)=>{const R=["#E91E8C","#7c3aed","#0ea5e9","#10b981","#f59e0b","#ef4444","#6366f1","#14b8a6"],N=R[H%R.length];return`
              <div style="display:flex;align-items:center;gap:8px">
                <span style="font-size:0.72rem;font-weight:600;color:#64748b;min-width:100px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${j.label}</span>
                <div style="flex:1;height:20px;background:#f1f5f9;border-radius:4px;overflow:hidden;position:relative">
                  <div style="width:${Math.round(j.total/I*100)}%;height:100%;background:${N};border-radius:4px;transition:width 0.5s ease;display:flex;align-items:center;padding-left:6px;box-sizing:border-box">
                    ${j.total/I>.18?`<span style="font-size:0.65rem;font-weight:700;color:white">${j.total}</span>`:""}
                  </div>
                  ${j.total/I<=.18?`<span style="position:absolute;left:${Math.round(j.total/I*100)+1}%;top:50%;transform:translateY(-50%);font-size:0.65rem;font-weight:700;color:#334155">${j.total}</span>`:""}
                </div>
                <span style="font-size:0.67rem;color:#94a3b8;min-width:52px;text-align:right">Stock: ${j.stock}</span>
              </div>`}).join("")}
          </div>
        </div>`}).join("")};var t=A,o=k,a=B,n=D;const[i,r,s,d]=await Promise.all([fetch(b+"/productos/"),fetch(b+"/variantes/?activa=eq.true"),fetch(b+"/movimientos/"),fetch(b+"/inventario/slim")]),l=await i.json(),c=await r.json(),p=await s.json(),m=await d.json(),g={},u={};c.forEach(_=>{g[_.id]=_,u[_.producto_id]||(u[_.producto_id]=[]),u[_.producto_id].push(_.id)});const v={};m.forEach(_=>{v[_.variante_id]=(v[_.variante_id]||0)+_.cantidad});const f=new Date,y=new Date(f-30*24*60*60*1e3),h=new Date(f-60*24*60*60*1e3),x=new Date(f-90*24*60*60*1e3),E={},w={},C={},T={};p.filter(_=>_.tipo==="venta").forEach(_=>{const L=g[_.variante_id];if(!L)return;const O=L.producto_id,I=Math.abs(_.cantidad),q=new Date(_.created_at);E[O]||(E[O]={d30:0,d60:0,d90:0,total:0}),E[O].total+=I,q>=y&&(E[O].d30+=I),q>=h&&(E[O].d60+=I),q>=x&&(E[O].d90+=I),w[_.variante_id]||(w[_.variante_id]={d30:0,d90:0,total:0}),w[_.variante_id].total+=I,q>=y&&(w[_.variante_id].d30+=I),q>=x&&(w[_.variante_id].d90+=I);const j=L.talla||"S/T",H=`${O}|${j}`;C[H]||(C[H]={talla:j,d30:0,d90:0,total:0}),C[H].total+=I,q>=y&&(C[H].d30+=I),q>=x&&(C[H].d90+=I);const R=L.color||"Sin color",N=`${O}|${R}|${j}`;T[N]||(T[N]={talla:j,color:R,d30:0,d90:0,total:0}),T[N].total+=I,q>=y&&(T[N].d30+=I),q>=x&&(T[N].d90+=I)});const z=l.map(_=>{const L=E[_.id]||{d30:0,d60:0,d90:0,total:0},O=u[_.id]||[],I=O.reduce((V,U)=>V+(v[U]||0),0),q=L.d30/4,j=q>0?Math.round(I/q*7):null;let H="gris",R="Sin ventas recientes";L.d30>=6?(H="verde",R="Rota bien — considerar resurtido"):L.d30>=2?(H="amarillo",R="Rotación moderada"):L.d90===0&&I>0?(H="rojo",R="Sin movimiento en 90 días — revisar"):L.d30>0&&(H="amarillo",R="Rotación lenta");const N=O.map(V=>{var U;return(U=g[V])==null?void 0:U.talla}).filter(Boolean).filter((V,U,Y)=>Y.indexOf(V)===U).map(V=>({talla:V,...C[`${_.id}|${V}`]||{d30:0,d90:0,total:0}})).sort((V,U)=>U.total-V.total),X=[...new Set(O.map(V=>{var U;return(U=g[V])==null?void 0:U.color}).filter(Boolean))].map(V=>{const U=O.filter(J=>{var Z;return((Z=g[J])==null?void 0:Z.color)===V}).map(J=>{var Z;return(Z=g[J])==null?void 0:Z.talla}).filter(Boolean).filter((J,Z,Ye)=>Ye.indexOf(J)===Z).map(J=>({talla:J,...T[`${_.id}|${V}|${J}`]||{d30:0,d90:0,total:0}})).sort((J,Z)=>parseFloat(J.talla)-parseFloat(Z.talla)),Y=U.reduce((J,Z)=>J+Z.total,0);return{color:V,tallas:U,total:Y}}).filter(V=>V.total>0).sort((V,U)=>U.total-V.total),Q=O.map(V=>{const U=g[V];if(!U)return null;const Y=w[V]||{d30:0,d90:0,total:0},J=v[V]||0;return{id:V,label:[U.talla,U.color].filter(Boolean).join(" / ")||V,stock:J,...Y}}).filter(Boolean).sort((V,U)=>U.total-V.total);return{..._,ventas:L,stockTotal:I,ventasSemana:q,diasInventario:j,semaforo:H,recomendacion:R,tallasData:N,tallasDesglosadas:X,variantesData:Q}}).sort((_,L)=>L.ventas.d30-_.ventas.d30);window._analisisData={productosConRotacion:z,ventasPorTalla:C};const G=z.reduce((_,L)=>_+L.ventas.d30,0),S=z.reduce((_,L)=>_+L.ventas.d90,0),M=z.filter(_=>_.semaforo==="verde").length,F=z.filter(_=>_.semaforo==="rojo").length,P={verde:{bg:"#dcfce7",color:"#166534",dot:"#16a34a",txt:"Rota bien"},amarillo:{bg:"#fef9c3",color:"#854d0e",dot:"#ca8a04",txt:"Rotación lenta"},rojo:{bg:"#fee2e2",color:"#991b1b",dot:"#dc2626",txt:"Sin movimiento"},gris:{bg:"#f1f5f9",color:"#64748b",dot:"#94a3b8",txt:"Sin datos"}};window._renderTabRotacion=k,window._renderTabTallas=B,window._renderTabVariantes=D,e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(130px,1fr));gap:10px;margin-bottom:1.5rem">
        ...
        <div style="background:linear-gradient(135deg,#fff1f2,#fee2e2);border:1px solid #fca5a5;border-radius:14px;padding:1rem 1.1rem">
          <p style="font-size:1.5rem;font-weight:800;color:#b91c1c;line-height:1;margin-bottom:3px">${F}</p>
    ...
    `,window._analisisTabActivo="rotacion"}catch(i){e.innerHTML='<p style="padding:2rem;color:red">Error cargando análisis</p>',console.error(i)}}window.switchTabAnalisis=e=>{["rotacion","tallas","variantes"].forEach(a=>{const n=document.getElementById("tab-"+a);n&&(a===e?(n.style.background="white",n.style.color="#E91E8C",n.style.boxShadow="0 1px 4px rgba(0,0,0,0.1)"):(n.style.background="transparent",n.style.color="#64748b",n.style.boxShadow="none"))});const o=document.getElementById("analisis-tab-content");o&&(window._analisisTabActivo=e,e==="rotacion"?o.innerHTML=window._renderTabRotacion():e==="tallas"?o.innerHTML=window._renderTabTallas():e==="variantes"&&(o.innerHTML=window._renderTabVariantes()))};window.filtrarRotacion=e=>{document.querySelectorAll(".rotacion-item").forEach(o=>{o.style.display=e==="todos"||o.dataset.semaforo===e?"":"none"}),document.querySelectorAll("#analisis-tab-content .pill-filter").forEach(o=>{o.classList.remove("pill-active")});const t=[...document.querySelectorAll("#analisis-tab-content .pill-filter")].find(o=>o.textContent.trim().toLowerCase().includes(e==="todos"?"todos":e==="verde"?"bien":e==="amarillo"?"lento":"movimiento"));t&&t.classList.add("pill-active")};async function Be(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando CRM...</p>';try{const[t,o,a]=await Promise.all([fetch(b+"/clientes/"),fetch(b+"/pedidos/"),fetch(b+"/crm/seguimientos/pendientes/todos")]),n=await t.json(),i=await o.json(),r=await a.json(),s=new Date,d=new Date(s-30*24*60*60*1e3),l=new Date(s-60*24*60*60*1e3),c=new Date(s-90*24*60*60*1e3),p=n.map(h=>{const x=i.filter(z=>z.cliente_id===h.id&&(z.status==="confirmado"||z.status==="pagado")),E=x.reduce((z,G)=>z+parseFloat(G.total||0),0),w=x.length>0?new Date(x[0].created_at):null,C=w?Math.floor((s-w)/(1e3*60*60*24)):null,T=x.filter(z=>new Date(z.created_at)>=d).length;let $="nuevo";return x.length===0?$="nuevo":E>=5e3&&T>=1?$="vip":C>90?$="inactivo":C>30?$="riesgo":T>=2?$="frecuente":$="activo",{...h,totalGastado:E,ultimoPedido:w,diasSinComprar:C,pedidos30:T,segmento:$,totalPedidos:x.length}}),m=p.filter(h=>h.segmento==="vip"),g=p.filter(h=>h.segmento==="riesgo").sort((h,x)=>x.totalGastado-h.totalGastado),u=p.filter(h=>h.segmento==="inactivo").sort((h,x)=>x.totalGastado-h.totalGastado),v=[...p].sort((h,x)=>x.totalGastado-h.totalGastado).slice(0,10),f=i.filter(h=>new Date(h.created_at).toDateString()===s.toDateString()&&(h.status==="confirmado"||h.status==="pagado")).reduce((h,x)=>h+parseFloat(x.total||0),0),y=i.filter(h=>new Date(h.created_at)>=d&&(h.status==="confirmado"||h.status==="pagado")).reduce((h,x)=>h+parseFloat(x.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
          ...
          ${r.length===0?'<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">Sin recordatorios pendientes 🎉</div>':r.slice(0,5).map(h=>{var x;return`
              <div style="padding:0.75rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:12px">
                <div style="flex:1">
                  <p style="font-size:0.85rem;font-weight:600">${((x=h.clientes)==null?void 0:x.nombre)||"Cliente"}</p>
  ...
  `).join("")};window.seleccionarClienteOportunidad=(e,t)=>{document.getElementById("op-cliente-id").value=e,document.getElementById("op-cliente-buscar").value=t,document.getElementById("op-cliente-resultados").style.display="none"};window.guardarOportunidad=async()=>{const e=document.getElementById("op-titulo").value,t=document.getElementById("op-cliente-id").value,o=document.getElementById("op-monto").value,a=document.getElementById("op-etapa").value,n=document.getElementById("op-fecha").value,i=document.getElementById("op-notas").value;if(!e){alert("El título es requerido");return}try{await fetch(b+"/crm/oportunidades",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({titulo:e,cliente_id:t||null,monto_estimado:parseFloat(o)||0,etapa:a,fecha_cierre_estimada:n||null,notas:i})}),document.getElementById("modal-oportunidad").remove(),mostrarPipeline()}catch{alert("Error guardando oportunidad")}};async function pe(e,t=!1){const o=document.getElementById("content");try{const n=await(await fetch(b+"/productos/")).json(),i=n.filter(c=>c.activo),r=n.filter(c=>!c.activo),s=t?r:i;console.log("mostrarInactivos:",t,"base:",s.length,"inactivos:",r.length);const d=[...new Set(i.map(c=>c.categoria).filter(Boolean))],l=e?s.filter(c=>c.categoria===e):s;o.innerHTML=`
    ...
    `}catch{o.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.cargarProductos=pe;window.mostrarCampanas=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando campañas...</p>';try{const[t,o]=await Promise.all([fetch(b+"/clientes/"),fetch(b+"/pedidos/")]),a=await t.json(),n=await o.json(),i=new Date,r=new Date(i-30*24*60*60*1e3),s=new Date(i-90*24*60*60*1e3),d=a.map(p=>{const m=n.filter(h=>h.cliente_id===p.id&&(h.status==="confirmado"||h.status==="pagado")),g=m.reduce((h,x)=>h+parseFloat(x.total||0),0),u=m.length>0?new Date(m[0].created_at):null,v=u?Math.floor((i-u)/(1e3*60*60*24)):null,f=m.filter(h=>new Date(h.created_at)>=r).length;let y="nuevo";return m.length===0?y="nuevo":g>=5e3&&f>=1?y="vip":v>90?y="inactivo":v>30?y="riesgo":f>=2?y="frecuente":y="activo",{...p,totalGastado:g,diasSinComprar:v,segmento:y}}).filter(p=>p.telefono);window._campanaClientes=d;const l=[{id:"catalogo",nombre:"👠 Catálogo completo",descripcion:"Envía el catálogo completo de productos",mensaje:p=>`Hola ${p}! 👋
...
⚠️ Requiere que los productos estén en el catálogo de Meta Commerce.`;else if(d.style.background="#e8f5e9",d.style.borderColor="#a5d6a7",d.style.color="#333",o){let v;t==="personalizado"?v=(((u=document.getElementById("texto-personalizado"))==null?void 0:u.value)||"").replace("{nombre}","María"):v=o.mensaje("María"),d.textContent=v}}const l=document.getElementById("campana-count");l&&(l.textContent=i.length+" clientes");const c=document.getElementById("campana-lista");if(c){if(!i.length){c.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No hay clientes en este segmento con teléfono registrado</div>';return}window._campanaFiltrados=i,window._campanaPlantillaId=t,c.innerHTML=i.map((v,f)=>{var E;let y;t==="personalizado"?y=(((E=document.getElementById("texto-personalizado"))==null?void 0:E.value)||"").replace("{nombre}",v.nombre.split(" ")[0]):y=o.mensaje(v.nombre.split(" ")[0]);const h=encodeURIComponent(y),x=(v.lada||"52")+v.telefono.replace(/\D/g,"");return`
      <div class="campana-cli-row" data-idx="${f}" style="padding:0.75rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:12px;transition:background 0.15s">
        ...
        <div style="flex:1;min-width:0">
          <p style="font-size:0.85rem;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${v.nombre}</p>
          <p style="font-size:0.72rem;color:#888">${v.tipo==="mayoreo"?"Mayoreo":v.tipo==="zapateria"?"Corridas":"Menudeo"} · ${v.telefono}</p>
        </div>
        <a href="https://wa.me/${x}?text=${h}" target="_blank"
    ...
    <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);text-align:center">
      ...
      <p style="font-size:0.82rem;color:#888">Conectando con WhatsApp Business</p>
        ...
        <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
          ...
          <p style="font-size:0.78rem;color:#888;text-align:center;margin-bottom:1.5rem">${x} de ${v} mensajes enviados</p>
          <div style="display:flex;gap:1rem;justify-content:center">
            ...
            <div style="text-align:center">
              <p style="font-size:1.5rem;font-weight:700;color:#888">${v-x}</p>
              <p style="font-size:0.72rem;color:#888">Pendientes</p>
            </div>
          </div>
          ${x>0&&((T=h.resultados)!=null&&T.length)?`
        ...
        </div>`};window._campanaJobId=u;const y=setInterval(async()=>{try{const x=await(await fetch(b+"/campanas/estado/"+u)).json();f(x),x.terminado&&(clearInterval(y),window._campanaUltimosResultados=x.resultados||[],setTimeout(()=>{const E=x.enviados||0,w=x.fallidos||0;l.innerHTML=`
    ...
    `};window._campanaAvanzar=()=>{if(r++,r>=i.length){s.innerHTML=`
      ...
      `;return}d()},d(),document.body.appendChild(s)};async function Ae(){const e=document.getElementById("content");try{const[t,o]=await Promise.all([fetch(b+"/clientes/"),fetch(b+"/pedidos/")]),a=await t.json(),n=await o.json(),i=new Date,r=new Date(i-30*24*60*60*1e3),s=new Date(i-90*24*60*60*1e3),d=a.map(u=>{const v=n.filter($=>$.cliente_id===u.id&&($.status==="confirmado"||$.status==="pagado")),f=v.reduce(($,z)=>$+parseFloat(z.total||0),0),y=v.length>0?new Date(v[0].created_at):null,h=v.filter($=>new Date($.created_at)>=r).length,x=y?Math.floor((i-y)/(1e3*60*60*24)):null;let E="nuevo",w="⚪ Nuevo",C="#f5f5f5",T="#888";return v.length===0?(E="nuevo",w="⚪ Sin compras",C="#f5f5f5",T="#888"):f>=5e3&&h>=1?(E="vip",w="⭐ VIP",C="#fff8e1",T="#f57f17"):x>90?(E="inactivo",w="🔴 Inactivo",C="#ffebee",T="#c62828"):x>30?(E="riesgo",w="🟡 En riesgo",C="#fff8e1",T="#f57f17"):h>=2?(E="frecuente",w="🟢 Frecuente",C="#e8f5e9",T="#2e7d32"):(E="activo",w="🔵 Activo",C="#e3f2fd",T="#1565c0"),{...u,totalGastado:f,ultimoPedido:y,pedidos30:h,diasSinComprar:x,segmento:E,segmentoLabel:w,segmentoBg:C,segmentoColor:T,totalPedidos:v.length}}).sort((u,v)=>v.totalGastado-u.totalGastado),l=d.filter(u=>u.segmento==="vip").length,c=d.filter(u=>u.segmento==="inactivo").length,p=d.filter(u=>u.segmento==="riesgo").length,m=d.filter(u=>u.segmento==="frecuente"||u.segmento==="activo").length,g=d.filter(u=>u.origen==="tienda").length;window._clientesData=d,e.innerHTML=`
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
  ...
  <div style="margin-bottom:1.5rem">
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">
      ...
      <select class="form-input" id="inv-talla" style="min-width:100px" onchange="renderInventario()">
        ...
        ${Se.map(r=>`<option value="${r}">${r}</option>`).join("")}
      </select>
...
`,renderInventario()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.renderInventario=()=>{const{sucursales:e,productos:t,variantes:o,inventario:a}=window._invData,n=(document.getElementById("inv-buscar")?document.getElementById("inv-buscar").value:"").toLowerCase(),i=document.getElementById("inv-categoria")?document.getElementById("inv-categoria").value:"",r=document.getElementById("inv-talla")?document.getElementById("inv-talla").value:"",s=document.getElementById("inv-estado")?document.getElementById("inv-estado").value:"",d=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],l=t.filter(m=>!(!m.activo||n&&!m.nombre.toLowerCase().includes(n)&&!(m.sku_interno||"").toLowerCase().includes(n)||i&&m.categoria!==i)),c=e.map(m=>{const g=a.filter(v=>v.sucursal_id===m.id),u=l.map(v=>{const f=o.filter(E=>E.producto_id===v.id&&E.activa!==!1);if(f.length===0)return"";const h=[...new Set(f.map(E=>E.color).filter(Boolean))].map(E=>{const w=f.filter(z=>z.color===E).sort((z,G)=>d.indexOf(z.talla)-d.indexOf(G.talla));if(r&&!w.find(z=>z.talla===r))return"";const C=w[0]?w[0].color_hex:"#888",T=w[0]?w[0].foto_url:null,$=w.map(z=>{const G=g.find(A=>A.variante_id===z.id),S=G?G.cantidad:null,M=G?G.stock_minimo:3;if(r&&z.talla!==r||s&&(s==="agotado"&&S!==0||s==="bajo"&&(S===null||S===0||S>M)||s==="disponible"&&(S===null||S===0||S<=M)))return"";let F,P;return S===null?(F="#f0f0f0",P="#aaa"):S===0?(F="#ffebee",P="#c62828"):S<=M?(F="#fff8e1",P="#f57f17"):(F="#e8f5e9",P="#2e7d32"),`
            <div style="display:flex;align-items:center;justify-content:space-between;background:${F};border-radius:10px;padding:8px 12px;border:1px solid ${P}30">
              <span style="font-size:0.85rem;font-weight:600;color:#555;min-width:44px">T${z.talla}</span>
              <div style="display:flex;align-items:center;gap:8px">
                <button onclick="cambiarStockInventario('${z.id}', '${m.id}', ${S!==null?S:0}, ${M}, -1)"
                ...
                <span id="stock-${z.id}-${m.id}" style="font-size:1.1rem;font-weight:700;color:${P};min-width:32px;text-align:center">${S!==null?S:"—"}</span>
                <button onclick="cambiarStockInventario('${z.id}', '${m.id}', ${S!==null?S:0}, ${M}, 1)"
                        style="background:#fff;border:1px solid #ddd;border-radius:6px;width:34px;height:34px;cursor:pointer;font-size:1.2rem;font-weight:700;touch-action:manipulation">+</button>
              </div>
            </div>
          ...
          <div style="background:#fafafa;border-radius:12px;padding:1rem;margin-bottom:10px;border:1px solid #eee">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
              ${T?`<img src="${T}" style="width:52px;height:52px;object-fit:cover;border-radius:8px;border:1px solid #eee;flex-shrink:0">`:`<div style="width:52px;height:52px;background:${C};border-radius:8px;border:1px solid #eee;flex-shrink:0;opacity:0.7"></div>`}
              <div style="display:flex;align-items:center;gap:8px">
        ...
        `:""}).join("");if(!h.trim())return"";const x=v.imagen_principal;return`
        <div style="background:white;border-radius:12px;padding:1.25rem;margin-bottom:1rem;border:1px solid #eee">
          <div style="display:flex;align-items:center;gap:12px;margin-bottom:1rem">
            ...
            <div>
              <p style="font-weight:700;font-size:1rem;color:#1a1a1a;margin-bottom:2px">${v.nombre}</p>
              <div>
                <span style="font-size:0.75rem;color:#888;background:#f5f5f5;padding:2px 8px;border-radius:100px;margin-right:4px">${v.sku_interno||"—"}</span>
                <span style="font-size:0.72rem;color:#E91E8C;background:#fce4f3;padding:2px 8px;border-radius:100px">${v.categoria||""}</span>
              </div>
            </div>
          </div>
          ${h}
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div>
          ...
          <select class="form-input" id="f-categoria" required onchange="actualizarSKU()">
            ...
            ${Qe.map(a=>`<option value="${a.value}" ${t.categoria===a.value?"selected":""}>${a.label}</option>`).join("")}
          </select>
        </div>
        <div>
...
${o.telefono?'<a href="https://wa.me/'+(o.lada||"52")+o.telefono.replace(/\D/g,"")+'" target="_blank" class="btn btn-secondary" style="background:#25D366;color:white;border-color:#25D366;margin-left:auto">WhatsApp</a>':""}      </div>
  ...
  `};window.guardarCliente=async e=>{const t=document.getElementById("cli-nombre").value;if(!t){alert("El nombre del cliente es obligatorio");return}const o=document.getElementById("btn-cli-guardar");o&&(o.textContent="Guardando...",o.disabled=!0);const a={nombre:t,telefono:document.getElementById("cli-telefono").value||null,email:document.getElementById("cli-email").value||null,tipo:document.getElementById("cli-tipo").value,direccion:document.getElementById("cli-direccion").value||null,lada:document.getElementById("cli-lada").value||"52",ciudad:document.getElementById("cli-ciudad").value||null,estado:document.getElementById("cli-estado").value||null,codigo_postal:document.getElementById("cli-cp").value||null,limite_credito:parseFloat(document.getElementById("cli-credito").value)||0,dias_credito:parseInt(document.getElementById("cli-dias").value)||0,comentarios_internos:document.getElementById("cli-comentarios").value||null,activo:!0};try{const n=e?"PATCH":"POST",i=e?b+"/clientes/"+e:b+"/clientes/",r=await fetch(i,{method:n,headers:{"Content-Type":"application/json"},body:JSON.stringify(a)});if(r.ok)alert("Cliente guardado correctamente"),navegarA("clientes");else{const s=await r.text();alert("Error al guardar: "+s),o&&(o.textContent="Guardar cliente",o.disabled=!1)}}catch{alert("Error conectando con el servidor"),o&&(o.textContent="Guardar cliente",o.disabled=!1)}};window.verCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[o,a]=await Promise.all([fetch(b+"/clientes/"+e),fetch(b+"/pedidos/")]),n=await o.json(),i=await a.json();if(!n||n.length===0){alert("Cliente no encontrado");return}const r=n[0],s=i.filter(u=>u.cliente_id===e),d=s.filter(u=>u.status==="confirmado"||u.status==="pagado"),l=d.reduce((u,v)=>u+parseFloat(v.total||0),0),c=d.length>0?l/d.length:0,p=s.length>0?new Date(s[0].created_at):null,m=p?Math.floor((new Date-p)/(1e3*60*60*24)):null,g={};d.forEach(u=>{const v=new Date(u.created_at).toLocaleDateString("es-MX",{month:"short",year:"2-digit"});g[v]=(g[v]||0)+parseFloat(u.total||0)}),t.innerHTML=`
      <div style="max-width:900px;margin:0 auto">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden;margin-bottom:1rem">
          ...
          ${s.length===0?'<div style="text-align:center;padding:2rem;color:#888">Sin pedidos registrados</div>':s.map(u=>{const v={confirmado:"#2e7d32",pagado:"#2e7d32",pendiente_pago:"#f57f17",cancelado:"#c62828",borrador:"#f57f17"}[u.status]||"#888",f={confirmado:"#e8f5e9",pagado:"#e8f5e9",pendiente_pago:"#fff8e1",cancelado:"#ffebee",borrador:"#fff8e1"}[u.status]||"#f5f5f5";return`
                <div style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap;cursor:pointer" onclick="verPedido('${u.id}')"
                  ...
                  <div style="flex:1">
                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px">
                      ...
                      <span style="padding:2px 8px;border-radius:100px;font-size:0.65rem;font-weight:600;background:${f};color:${v}">${u.status}</span>
                    </div>
    ...
    `}catch{t.innerHTML='<p style="padding:2rem;color:red">Error cargando cliente</p>'}};window.guardarNotasCliente=async e=>{var o;const t=((o=document.getElementById("cli-notas-"+e))==null?void 0:o.value)||"";try{await fetch(b+"/clientes/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({comentarios_internos:t})});const a=document.querySelector(`button[onclick="guardarNotasCliente('${e}')"]`);a&&(a.textContent="✅ Guardado",setTimeout(()=>a.textContent="💾 Guardar notas",2e3))}catch{alert("Error guardando notas")}};window.editarCliente=e=>{mostrarFormCliente(e)};window.nuevoPedidoCliente=async(e,t)=>{await Fe(),setTimeout(()=>{const o=document.getElementById("pos-cliente-buscar"),a=document.getElementById("pos-cliente"),n=document.getElementById("pos-cliente-seleccionado");o&&(o.value=""),a&&(a.value=e),n&&(n.textContent="✔ "+t+" — toca para cambiar",n.style.display="block");const i=document.getElementById("topbar-title");i&&(i.textContent="Punto de venta")},300)};window.verHistorialCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando historial...</p>';try{const n=(await(await fetch(b+"/pedidos/")).json()).filter(s=>s.cliente_id===e),i=n.length>0&&n[0].clientes?n[0].clientes:{},r=n.filter(s=>s.status==="confirmado"||s.status==="pagado").reduce((s,d)=>s+parseFloat(d.total||0),0);t.innerHTML=`
      <div class="table-card" style="padding:2rem">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;flex-wrap:wrap">
          <button class="btn btn-secondary" onclick="navegarA('clientes')">← Volver</button>
  ...
  `};window.guardarSalida=async()=>{const e=document.getElementById("sal").value,t=document.getElementById("sal-sucursal").value,o=document.getElementById("sal-cantidad").value,a=document.getElementById("sal-motivo").value;if(!e||!t||!o){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(b+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:-parseInt(o),motivo:a})})).json();i.ok?(alert("Salida registrada. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const o=await(await fetch(b+"/sucursales/")).json(),n=await(await fetch(b+"/productos/")).json(),r=await(await fetch(b+"/variantes/")).json(),d=await(await fetch(b+"/inventario/")).json(),l=[...new Set(n.map(p=>p.categoria).filter(Boolean))],c=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:o,productos:n,variantes:r,inventario:d},e.innerHTML=`
    ...
    `,renderTablasMasivo()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:e,variantes:t,inventario:o}=window._invMasivo,a=document.getElementById("im-sucursal").value,n=document.getElementById("im-categoria").value,i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],r=e.filter(c=>!(n&&c.categoria!==n)),s=o.filter(c=>c.sucursal_id===a),d=r.map(c=>{const p=t.filter(u=>u.producto_id===c.id);if(p.length===0)return"";const g=[...new Set(p.map(u=>u.color).filter(Boolean))].map(u=>{const v=p.filter(y=>y.color===u).sort((y,h)=>i.indexOf(y.talla)-i.indexOf(h.talla));return`
        <div style="margin-bottom:1rem">
          <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
            <div style="width:14px;height:14px;border-radius:50%;background:${v[0]?v[0].color_hex:"#888"};border:1px solid #ddd;flex-shrink:0"></div>
            <span style="font-size:0.85rem;font-weight:500;color:#444">${u}</span>
          </div>
          <div style="display:flex;gap:8px;flex-wrap:wrap">
            ${v.map(y=>{const h=s.find(C=>C.variante_id===y.id),x=h?h.cantidad:0,E=h?h.stock_minimo:3;let w="#ddd";return x===0?w="#ffcdd2":x<=E?w="#ffe082":w="#a5d6a7",`
                <div style="text-align:center">
  ...
  `,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()})};window.confirmarEnvio=async function(e){const t=document.getElementById("env-paqueteria").value,o=document.getElementById("env-guia").value.trim(),a=document.getElementById("env-error"),n=document.getElementById("btn-confirmar-envio");if(!t||!o){a.textContent="Selecciona paquetería e ingresa el número de guía.",a.style.display="block";return}n.disabled=!0,n.textContent="Guardando...",a.style.display="none";try{const i=await fetch(b+`/pedidos/${e}/marcar-enviado`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({paqueteria:t,numero_guia:o})}),r=await i.json();if(!i.ok)throw new Error(r.error||"Error al guardar");try{const s=await fetch(b+"/pedidos/"+e).then(c=>c.json()),d=s.telefono_cliente,l=(s.nombre_cliente||"Cliente").split(" ")[0];d&&await fetch(b+"/chatbot/templates/enviar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({telefono:d,template:"aviso_envio",params:[l,String(e).slice(-6),o,t]})})}catch{}document.getElementById("modal-envio").remove(),mostrarToast("✅ Pedido enviado — WhatsApp de tracking enviado al cliente"),await De()}catch(i){a.textContent=i.message,a.style.display="block",n.disabled=!1,n.textContent="Confirmar envío ✓"}};async function De(){const e=document.getElementById("content");try{const o=await(await fetch(b+"/pedidos/")).json(),a=new Date,n=new Date(a.getFullYear(),a.getMonth(),a.getDate()),i=new Date(a-7*24*60*60*1e3),r=["cancelado","borrador","checkout_iniciado"],s=o.filter(y=>!r.includes(y.status)),d=o.filter(y=>y.status!=="checkout_iniciado"),l=s.filter(y=>new Date(y.created_at)>=n),c=l.reduce((y,h)=>y+parseFloat(h.total||0),0),p=s.filter(y=>new Date(y.created_at)>=i).reduce((y,h)=>y+parseFloat(h.total||0),0),m=o.filter(y=>y.status==="pendiente_pago").length,g=o.filter(y=>y.status==="checkout_iniciado").length,u=o.filter(y=>y.status==="pagado"&&(y.mp_preference_id||y.mp_payment_id)).length,v=o.filter(y=>y.forma_pago==="credito"&&y.status!=="cancelado").length,f=(y,h,x,E,w,C,T)=>`
      ...
      <div style="margin-bottom:1.25rem">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:10px;margin-bottom:16px">
          ...
          ${f("$"+Math.round(p/1e3)+"k","7 días",`${s.filter(y=>new Date(y.created_at)>=i).length} pedidos`,"#7c3aed","#f5f3ff","#ddd6fe","")}
          ...
          ${f(v,"En crédito","Pedidos activos","#0f766e","#f0fdfa","#99f6e4","cargarPedidosFiltro('credito')")}
        </div>
  ...
  `).join(""),window.recalcularTotal()}};window.cambiarCantidadItem=async(e,t)=>{if(t>0){const o=window._pedidoItems[e],a=document.getElementById("ped-sucursal")?document.getElementById("ped-sucursal").value:"";if(a)try{const r=(await(await fetch(b+"/inventario/sucursal/"+a)).json()).find(d=>d.variante_id===o.variante_id),s=r?r.cantidad:0;if(o.cantidad>=s){alert("No hay mas existencia disponible. Maximo: "+s+" pares");return}}catch{}}window._pedidoItems[e].cantidad=Math.max(1,window._pedidoItems[e].cantidad+t),window.recalcularTotal(),renderItemsPedido()};window.guardarPedido=async()=>{var d;if(window._creandoPedido)return;const e=document.getElementById("ped-cliente").value,t=document.getElementById("ped-canal").value,o=document.getElementById("ped-sucursal").value,a=document.getElementById("ped-pago").value,n=document.getElementById("ped-comentarios").value;if(!e){alert("Selecciona un cliente");return}if(window._pedidoItems.length===0){alert("Agrega al menos un producto");return}window._creandoPedido=!0;const i=document.getElementById("btn-ped-guardar");i&&(i.textContent="Guardando...",i.disabled=!0);const r=window._pedidoItems.reduce((l,c)=>l+c.cantidad*c.precio_unitario,0),s=a==="spei"?"pendiente_pago":"confirmado";try{const l=await fetch(b+"/pedidos/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cliente_id:e,canal:t,sucursal_id:o,forma_pago:a,comentarios:n||null,total:r,subtotal:r,status:s})});if(!l.ok){alert("Error creando pedido"),i&&(i.textContent="Crear pedido",i.disabled=!1),window._creandoPedido=!1;return}const c=await l.json(),p=c.id||((d=c[0])==null?void 0:d.id);if(!p){alert("Error: no se obtuvo ID del pedido"),i&&(i.textContent="Crear pedido",i.disabled=!1),window._creandoPedido=!1;return}await Promise.all(window._pedidoItems.map(m=>fetch(b+"/pedidos/"+p+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:m.variante_id,cantidad:m.cantidad,precio_unitario:m.precio_unitario,subtotal:m.cantidad*m.precio_unitario})}))),a!=="spei"&&a!=="mercadopago"&&await fetch(b+"/pedidos/"+p+"/confirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({forma_pago:a})}),alert("Pedido creado correctamente"),window._pedidoItems=[],window._creandoPedido=!1,verPedido(p)}catch{alert("Error conectando con el servidor"),i&&(i.textContent="Crear pedido",i.disabled=!1),window._creandoPedido=!1}};window.abrirPreviewPedido=async e=>{const t=document.getElementById("pedido-preview-panel");if(!t){verPedido(e);return}if(t.dataset.pedidoId===e&&t.style.display!=="none"){t.style.display="none",t.dataset.pedidoId="";return}t.dataset.pedidoId=e,t.style.display="block",t.innerHTML='<p style="padding:1.5rem;color:#888;text-align:center">Cargando...</p>',t.scrollIntoView({behavior:"smooth",block:"nearest"});try{const[o,a]=await Promise.all([fetch(b+"/pedidos/"+e).then(d=>d.json()),fetch(b+"/pedidos/"+e+"/items").then(d=>d.json())]),n=Array.isArray(o)?o[0]:o,i=Array.isArray(a)?a:[],r=n.clientes||{},s={confirmado:"#2e7d32",pagado:"#2e7d32",cancelado:"#c62828",pendiente_pago:"#f57f17",borrador:"#f57f17"}[n.status]||"#888";t.innerHTML=`
      ...
      <div class="table-card" style="padding:2rem">
        ...
        ${(()=>{const p=(n.direccion_envio||n.direccion_entrega||"").trim();let m="";if(!p&&n.notas){const h=n.notas.match(/Env[ií]o a:\s*(.+)$/i);h&&(m=h[1].trim())}const g=p||m,u=r.nombre||n.nombre_cliente||"",v=r.telefono||n.telefono_cliente||"",f=n.email_cliente&&n.email_cliente!=="cliente@zapatillasmay.mx"?n.email_cliente:"";return!g&&!u&&!v?"":`
          <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:1rem;margin-bottom:1.5rem">
            <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:8px">
              ...
              <button onclick="navigator.clipboard.writeText(this.dataset.copy).then(()=>{this.textContent='✓ Copiado';setTimeout(()=>this.textContent='📋 Copiar',1500)})" data-copy="${[u,v,f,g].filter(Boolean).join(`
`).replace(/"/g,"&quot;")}" style="padding:4px 12px;border-radius:20px;border:1.5px solid #1d4ed8;background:none;color:#1d4ed8;font-size:0.75rem;font-weight:600;cursor:pointer">📋 Copiar</button>
            ...
            ${v?`<p style="margin:2px 0;font-size:0.85rem;color:#334155">📞 ${v}</p>`:""}
        ...
        <div style="margin-bottom:1.5rem">
          ...
          ${i.map(p=>{const m=p.variantes||{},g=m.productos||{},u=g.nombre||p.nombre||"—",v=m.color||p.color||"",f=m.talla||p.talla||"";let y=g.imagen_principal||null;if(!y&&p.variante_id&&window._productosCache&&window._variantesCache){const h=window._variantesCache.find(x=>x.id===p.variante_id);if(h){const x=window._productosCache.find(E=>E.id===h.producto_id);x&&(y=x.imagen_principal||null)}}return`
              <div style="display:flex;align-items:center;gap:12px;padding:12px;background:#f9f9f9;border-radius:8px;margin-bottom:8px;border:1px solid #eee">
                ${y?'<img src="'+y+'" style="width:56px;height:56px;object-fit:cover;border-radius:8px;flex-shrink:0;border:1px solid #eee">':'<div style="width:56px;height:56px;background:#f0f0f0;border-radius:8px;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:1.4rem">👟</div>'}
                <div style="flex:1">
                  <p style="font-weight:600;font-size:0.85rem;margin:0 0 2px">${u}${v?" · "+v:""}${f?" · T"+f:""}</p>
  ...
  <button class="btn btn-secondary" onclick="imprimirTicketPOS('${n.id}',${n.total},${n.pedido_items?n.pedido_items.reduce((p,m)=>p+m.cantidad,0):0},'${n.forma_pago||"efectivo"}')">Reimprimir ticket</button>
    ...
    `}catch{t.innerHTML='<p style="padding:2rem;color:red">Error cargando pedido</p>'}};window.activarEdicionPedido=async e=>{var s;const t=document.getElementById("panel-edicion"),o=document.getElementById("items-lista");if(!t)return;const[a,n,i]=await Promise.all([fetch(b+"/variantes/").then(d=>d.json()),fetch(b+"/productos/").then(d=>d.json()),fetch(b+"/inventario/").then(d=>d.json()).catch(()=>[])]);window._editPedidoId=e,window._editItems=(((s=window._currentPedido)==null?void 0:s.pedido_items)||[]).map(d=>({...d})),window._editVariantes=a,window._editProductos=n,window._editInventario=i,window.recalcularPreciosEdicion(),o.style.display="none",t.style.display="block";const r=()=>{const d=window._editItems,l=d.reduce((p,m)=>p+m.cantidad,0),c=l>=6?"Mayoreo 6+ pares":l>=3?"Mayoreo 3-5 pares":"Menudeo";t.innerHTML=`
      <div style="background:#fff8e1;border:1px solid #ffe082;border-radius:8px;padding:1rem;margin-bottom:1rem">
        ...
        ${d.map((p,m)=>{const g=p.variantes||{},u=g.productos||{},v=u.nombre||p.nombre||"—",f=g.color||p.color||"",y=g.talla||p.talla||"",h=p.es_corrida?'<span style="background:#f3e5f5;color:#6a1b9a;font-size:0.65rem;font-weight:700;padding:2px 6px;border-radius:100px;margin-left:6px">📦 Corrida</span>':"";let x=u.imagen_principal||null;if(!x&&p.variante_id&&window._editVariantes&&window._editProductos){const E=window._editVariantes.find(w=>w.id===p.variante_id);if(E){const w=window._editProductos.find(C=>C.id===E.producto_id);w&&(x=w.imagen_principal||null)}}return`
            <div style="display:flex;align-items:center;gap:10px;padding:10px;background:white;border-radius:8px;margin-bottom:8px;border:1px solid #eee;flex-wrap:wrap">
              ${x?'<img src="'+x+'" style="width:48px;height:48px;object-fit:cover;border-radius:6px;flex-shrink:0;border:1px solid #eee">':'<div style="width:48px;height:48px;background:#f0f0f0;border-radius:6px;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:1.2rem">👟</div>'}
              <div style="flex:1;min-width:120px">
                <p style="font-weight:600;font-size:0.85rem;margin:0">${v}${f?" · "+f:""}${y?" T"+y:""}${h}</p>
              </div>
              <div style="display:flex;align-items:center;gap:6px">
    ...
    `};r(),window._renderEdicion=r};window.buscarProductoEdicion=e=>{const t=window._editVariantes||[],o=window._editProductos||[],a=document.getElementById("edit-prod-resultados");if(!a)return;if(window.posicionarDropdownCarrito("edit-prod-resultados","edit-buscar-prod"),!e||e.length<2){a.style.display="none";return}const n={};t.forEach(r=>{const s=o.find(c=>c.id===r.producto_id);if(!s)return;const d=((s.nombre||"")+" "+(r.color||"")+" "+(s.sku_interno||"")).toLowerCase();if(!e.toLowerCase().split(" ").every(c=>d.includes(c)))return;const l=s.id+"|"+(r.color||"");n[l]||(n[l]={prod:s,color:r.color||"",variantes:[]}),n[l].variantes.push(r)});const i=Object.values(n).slice(0,6);if(!i.length){a.innerHTML='<div style="padding:10px;font-size:0.85rem;color:#888">Sin resultados</div>',a.style.display="block";return}a.style.display="block",a.innerHTML=i.map(r=>`
    <div onclick="window.seleccionarProductoEdicion('${r.prod.id}','${r.color.replace(/'/g,"\\'")}')"
      ...
      <div>
        <p style="font-size:0.85rem;font-weight:600;margin:0;color:#0f172a">${r.prod.nombre} · ${r.color}</p>
        <p style="font-size:0.72rem;color:#888;margin:0">${r.variantes.length} tallas disponibles</p>
      </div>
    </div>
  `).join("")};window.seleccionarProductoEdicion=(e,t)=>{var g;const o=window._editVariantes||[],a=window._editProductos||[],n=window._editInventario||[],i=((g=window._currentPedido)==null?void 0:g.sucursal_id)||"",r=a.find(u=>u.id===e);document.getElementById("edit-buscar-prod").value=`${r?r.nombre:""} · ${t}`,document.getElementById("edit-prod-resultados").style.display="none";const s=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=o.filter(u=>u.producto_id===e&&u.color===t).sort((u,v)=>s.indexOf(u.talla)-s.indexOf(v.talla));window._editSeleccionado={productoId:e,color:t,variantes:d,prod:r};const l=parseFloat(r?r.precio_menudeo:0)||0,c=parseFloat(r?r.precio_corrida:0)||(l>0?Math.round(l-100):0);document.getElementById("edit-nuevo-precio").value=l||"";const p=document.getElementById("edit-precios-info");p&&r&&(p.innerHTML=`
      <span style="background:#e2e8f0;color:#334155;padding:3px 8px;border-radius:6px">Menudeo: <strong>$${l}</strong></span>
      <span style="background:#e2e8f0;color:#334155;padding:3px 8px;border-radius:6px">Mayoreo 3+: <strong>$${r.precio_mayoreo3||l-30}</strong></span>
      <span style="background:#e2e8f0;color:#334155;padding:3px 8px;border-radius:6px">Mayoreo 6+: <strong>$${r.precio_mayoreo6||l-70}</strong></span>
      <span style="background:#f3e5f5;color:#6a1b9a;padding:3px 8px;border-radius:6px">Corrida: <strong>$${c}</strong></span>
    `);const m=document.getElementById("edit-corrida-tallas-grid");m.innerHTML=d.map(u=>{const v=n.find(T=>T.variante_id===u.id&&(i?T.sucursal_id===i:!0)),f=v?v.cantidad:null,y=f!==null&&f===0,h=0,x=`edit-card-${u.id}`,E=`edit-qty-${u.id}`;return`
      <div id="${x}" class="size-card" style="display:flex;flex-direction:column;align-items:center;gap:6px;padding:10px 12px;border:2px solid ${y?"#fecaca":"#e2e8f0"};border-radius:12px;background:${y?"#fef2f2":"#ffffff"};min-width:70px;transition:all 0.2s ease;position:relative;opacity:${y?.6:1}">
        <span style="font-weight:800;font-size:0.9rem;color:#0f172a">T${u.talla}</span>
        <div style="display:flex;align-items:center;gap:4px">
          <button type="button" onclick="const inp=document.getElementById('${E}');inp.value=Math.max(0,parseInt(inp.value||0)-1);inp.dispatchEvent(new Event('input'))"
          ...
          <input type="number" value="${h}" min="0" max="${f!==null?f:999}" id="${E}" data-variante="${u.id}"
          ...
          <button type="button" onclick="const inp=document.getElementById('${E}');const max=parseInt(inp.max||999);const cur=parseInt(inp.value||0);if(cur<max){inp.value=cur+1;inp.dispatchEvent(new Event('input'))}else{inp.style.borderColor='#ef4444';setTimeout(()=>inp.style.borderColor='#cbd5e1',800)}"
            style="background:#f1f5f9;color:#475569;border:none;border-radius:6px;width:24px;height:24px;cursor:pointer;font-size:1rem;font-weight:700;display:flex;align-items:center;justify-content:center;transition:background 0.2s"
            onmouseenter="this.style.background='#e2e8f0'" onmouseleave="this.style.background='#f1f5f9'" ${y?"disabled":""}>+</button>
        </div>
        <span style="font-size:0.65rem;font-weight:600;color:${f===null?"#94a3b8":f>0?"#10b981":"#ef4444"}">
          ${f===null?"Stock: ?":f>0?`${f} disp.`:"Agotado"}
        </span>
      </div>
    `}).join(""),document.getElementById("edit-tallas-titulo").textContent=`Tallas disponibles para ${r?r.nombre:""} (${t}):`,document.getElementById("edit-corrida-tallas").style.display="block"};window.agregarItemsEdicionBulk=async e=>{const t=window._editSeleccionado;if(!t){alert("Selecciona un modelo primero");return}const{productoId:o,color:a,prod:n}=t,i=window._editPedidoId,r=document.getElementById("edit-nuevo-precio");let s=parseFloat(r.value);(isNaN(s)||s<=0)&&(e?s=parseFloat(n.precio_corrida)||parseFloat(n.precio_menudeo)-100:s=parseFloat(n.precio_menudeo)||0);const d=document.querySelectorAll("#edit-corrida-tallas-grid input[type=number][data-variante]"),l=[];if(d.forEach(m=>{const g=parseInt(m.value)||0;if(g>0){const u=m.dataset.variante,v=window._editVariantes.find(f=>f.id===u);l.push({variante_id:u,cantidad:g,precio_unitario:s,subtotal:g*s,nombre:n.nombre,color:a,talla:v?v.talla:"",es_corrida:e})}}),l.length===0){alert("Ingresa al menos 1 par en alguna talla");return}const c=event.currentTarget,p=c.textContent;c.textContent="Agregando...",c.disabled=!0;try{await Promise.all(l.map(g=>fetch(b+"/pedidos/"+i+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(g)})));const m=await fetch(b+"/pedidos/"+i+"/items").then(g=>g.json());window._editItems=m.map(g=>({...g})),window.recalcularPreciosEdicion(),document.getElementById("edit-buscar-prod").value="",document.getElementById("edit-corrida-tallas").style.display="none",window._editSeleccionado=null,window._renderEdicion()}catch(m){alert("Error agregando productos: "+m.message)}finally{c.textContent=p,c.disabled=!1}};window.recalcularPreciosEdicion=()=>{const e=window._editItems||[],t=window._editProductos||[],o=window._editVariantes||[],a=e.reduce((i,r)=>i+r.cantidad,0),n=a>=6?"mayoreo6":a>=3?"mayoreo3":"menudeo";e.forEach(i=>{if(i.es_corrida)return;const r=o.find(m=>m.id===i.variante_id),s=r?t.find(m=>m.id===r.producto_id):null;if(!s)return;const d=parseFloat(s.precio_menudeo)||0,l=parseFloat(s.precio_mayoreo3)||d-30,c=parseFloat(s.precio_mayoreo6)||d-70;if(i._precio_manual===void 0&&i.precio_unitario!==d&&i.precio_unitario!==l&&i.precio_unitario!==c&&(i._precio_manual=!0),i._precio_manual)return;let p=d;n==="mayoreo6"?p=c:n==="mayoreo3"&&(p=l),i.precio_unitario=p,i.subtotal=i.cantidad*p})};window.eliminarItemEdicion=async(e,t)=>{if(!confirm("¿Eliminar este producto del pedido?"))return;const o=window._editPedidoId,n=await(await fetch(b+"/pedidos/"+o+"/items/"+e,{method:"DELETE"})).json();n.ok?(window._editItems.splice(t,1),window.recalcularPreciosEdicion(),window._renderEdicion()):alert("Error eliminando ítem: "+JSON.stringify(n))};window.guardarEdicionPedido=async()=>{const e=window._editPedidoId,t=window._editItems,o=parseFloat(document.getElementById("edit-descuento").value)||0;await Promise.all(t.map(n=>fetch(b+"/pedidos/"+e+"/items/"+n.id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({cantidad:n.cantidad,precio_unitario:n.precio_unitario})})));const a=Math.max(0,t.reduce((n,i)=>n+i.cantidad*i.precio_unitario,0)-o);await fetch(b+"/pedidos/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({total:a})}),alert("Pedido actualizado correctamente"),verPedido(e)};window.cancelarEdicionPedido=e=>{verPedido(e)};window.cancelarPedido=async e=>{if(confirm("¿Cancelar este pedido? Si ya estaba confirmado se devolverá el stock automáticamente."))try{const o=await(await fetch(b+"/pedidos/"+e+"/cancelar",{method:"POST"})).json();o.ok?(alert(o.stock_devuelto?"Pedido cancelado. Stock devuelto al inventario.":"Pedido cancelado."),verPedido(e)):alert("Error: "+JSON.stringify(o))}catch{alert("Error conectando con el servidor")}};window.reconfirmarPedido=async e=>{if(confirm("¿Reconfirmar este pedido? Se descontará el stock del inventario nuevamente."))try{const o=await(await fetch(b+"/pedidos/"+e+"/reconfirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({})})).json();o.ok?(alert("Pedido reconfirmado correctamente."),verPedido(e)):alert("Error: "+JSON.stringify(o))}catch{alert("Error conectando con el servidor")}};window.confirmarPagoSPEI=async e=>{if(confirm("Confirmar que recibiste el pago por SPEI?"))try{const o=await(await fetch(b+"/pedidos/"+e+"/confirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({forma_pago:"spei"})})).json();o.ok?(alert("Pago confirmado. Inventario actualizado."),verPedido(e)):alert("Error: "+JSON.stringify(o))}catch{alert("Error conectando con el servidor")}};window.confirmarPedidoAdmin=async e=>{if(confirm("Confirmar este pedido? El inventario se descontara."))try{const o=await(await fetch(b+"/pedidos/"+e+"/confirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({forma_pago:"efectivo"})})).json();if(o.ok){try{const a=await fetch(b+"/pedidos/"+e).then(s=>s.json()),n=a.telefono_cliente,i=(a.nombre_cliente||"Cliente").split(" ")[0],r=a.total?"$"+parseFloat(a.total).toFixed(0):"";n&&await fetch(b+"/chatbot/templates/enviar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({telefono:n,template:"confirmacion_pedido",params:[i,String(e).slice(-6),r]})})}catch{}alert("Pedido confirmado correctamente."),verPedido(e)}else alert("Error: "+JSON.stringify(o))}catch{alert("Error conectando con el servidor")}};window.recalcularTotal=()=>{const e=window._pedidoItems||[],t=e.reduce((n,i)=>n+i.cantidad,0);e.forEach(n=>{n.es_oferta?n.precio_unitario=n.precio_menudeo:t>=6?n.precio_unitario=n.precio_mayoreo6||n.precio_menudeo-70:t>=3?n.precio_unitario=n.precio_mayoreo3||n.precio_menudeo-30:n.precio_unitario=n.precio_menudeo});const o=e.reduce((n,i)=>n+i.cantidad*i.precio_unitario,0),a=document.getElementById("ped-total");a&&(a.textContent="$"+o.toFixed(2))};async function Fe(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando punto de venta...</p>';try{const[t,o,a,n,i]=await Promise.all([fetch(b+"/productos/").then(r=>r.json()),fetch(b+"/variantes/").then(r=>r.json()),fetch(b+"/sucursales/").then(r=>r.json()),fetch(b+"/clientes/").then(r=>r.json()),fetch(b+"/inventario/").then(r=>r.json())]);window._posData={productos:t,variantes:o,sucursales:a,clientes:n,inventario:i},window._posCarrito=dt(),window._posClienteId=null,e.innerHTML=`
    ...
    <div style="background:white;border-radius:16px;max-width:640px;width:100%;height:90vh;display:flex;flex-direction:column;overflow:hidden">
      ...
      <div style="padding:1.25rem 1.5rem 0.85rem;border-bottom:1px solid #eee;flex-shrink:0">
        <div style="display:flex;align-items:flex-start;gap:12px">
          ${i.imagen_principal?`<img id="pos-modal-img" src="${i.imagen_principal}" style="width:64px;height:64px;object-fit:cover;border-radius:10px;flex-shrink:0">`:""}
          <div style="flex:1;min-width:0">
      ...
      <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
          ${l.map(f=>{const y=d.filter(C=>C.color===f),h=y[0],x=y.map(C=>C.foto_url).find(Boolean),E=y.reduce((C,T)=>{const $=s.find(z=>z.variante_id===T.id);return C+($?$.cantidad:0)},0),w=x?`<img src="${x}" style="width:46px;height:46px;object-fit:cover;border-radius:8px;border:1px solid #ddd">`:`<div style="width:46px;height:46px;border-radius:8px;background:${h?h.color_hex:"#888"};border:1px solid #ddd"></div>`;return`
              <div onclick="posSeleccionarColor('${e}', '${f}')"
                   id="pos-color-btn-${f.replace(/\s/g,"_")}"
                   style="display:flex;flex-direction:column;align-items:center;gap:4px;cursor:pointer;padding:6px;border-radius:10px;border:2px solid ${E===0?"#f5f5f5":"#ddd"};opacity:${E===0?"0.4":"1"};width:74px">
                ${w}
  ...
  `,document.body.appendChild(v),v.addEventListener("click",f=>{f.target===v&&v.remove()}),window._posSeleccion={productoId:e,color:null},window._posBuffer={},window._posModo="variado",window._posColores=l,window._corridaCantidades={},l.length&&posSeleccionarColor(e,l[0])};window._posHighlightColor=(e,t,o)=>{document.querySelectorAll('[id^="pos-color-btn-"]').forEach(n=>{n.style.borderColor="#ddd",n.style.background="transparent"});const a=document.getElementById("pos-color-btn-"+e.replace(/\s/g,"_"));a&&(a.style.borderColor=t,a.style.background=o)};window.posSeleccionarColor=(e,t)=>{window._posModo==="corrida"?(window._corridaColorActivo=t,window._posSeleccion.color=t,window._posHighlightColor(t,"#6a1b9a","#f3e5f5"),renderCorridaTallas(e,t)):seleccionarColorModalPOS(e,t)};window.posCambiarModo=(e,t)=>{var s;window._posModo=t;const o=document.getElementById("pos-modo-variado"),a=document.getElementById("pos-modo-corrida");o&&o.classList.toggle("active",t==="variado"),a&&a.classList.toggle("active",t==="corrida");const n=document.getElementById("pos-modo-hint");n&&(n.textContent=t==="corrida"?'Una corrida completa: varias tallas de un mismo color a precio de corrida. Usa "Sugerir" para llenarla rápido.':"Elige tallas sueltas; el precio se ajusta solo según el total de pares (menudeo · mayoreo 3+ · 6+)."),document.querySelectorAll('[id^="pos-color-badge-"]').forEach(d=>{d.style.display="none"});const i=document.getElementById("pos-modal-footer"),r=((s=window._posSeleccion)==null?void 0:s.color)||window._corridaColorActivo||window._posColores&&window._posColores[0];if(t==="corrida")if(window._corridaCantidades||(window._corridaCantidades={}),i&&(i.innerHTML=`
    ...
    <div style="display:flex;flex-direction:column;gap:8px">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(84px,1fr));gap:12px">
        ${d.map(g=>{const u=i.find(y=>y.variante_id===g.id),v=u?u.cantidad:0,f=p[g.id]||0;return`
            <div style="position:relative">
              <button id="chip-talla-${g.id}"
                      onclick="posTallaTap('${g.id}','${e}','${t}',${v})"
                      ${v===0?"disabled":""}
                      style="width:100%;min-height:62px;border:2px solid ${f>0?"#E91E8C":"#ddd"};background:${f>0?"#fce4f3":"#fff"};border-radius:12px;cursor:${v===0?"not-allowed":"pointer"};display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;font-family:inherit;padding:8px 4px;${v===0?"opacity:0.45":""};touch-action:manipulation">
                <span style="font-size:1.05rem;font-weight:800;color:#333">${g.talla}</span>
                <span style="font-size:0.63rem;color:${v===0?"#c62828":"#aaa"}">${v===0?"Agotado":"Stock "+v}</span>
              </button>
              ...
              <button id="chipmenos-${g.id}"
                      onclick="posTallaMenos('${g.id}','${e}','${t}',${v})"
    ...
    <div style="display:flex;flex-direction:column;gap:6px">
      ${d.map(m=>{const g=i.find(f=>f.variante_id===m.id),u=g?g.cantidad:0,v=u>0;return`
          <div style="display:flex;align-items:center;gap:8px;opacity:${v?"1":"0.4"}">
            ...
            <div style="display:flex;align-items:center;gap:4px">
              <button onclick="cambiarCantidadTallaPOS('${m.id}', -1, ${u})" 
                      ${v?"":"disabled"}
                      style="background:#f0f0f0;border:none;border-radius:4px;width:26px;height:26px;cursor:pointer;font-size:1rem;${v?"":"cursor:not-allowed"}">−</button>
            ...
            ${v?"":'<span style="font-size:0.7rem;color:#c62828;background:#ffebee;padding:2px 6px;border-radius:100px">Agotado</span>'}
          </div>
        `}).join("")}
    </div>
  ...
  `};window.seleccionarTallaPOS=(e,t)=>{window._posSeleccion.talla=t,window._posSeleccion.varianteId=e,document.querySelectorAll('[id^="pos-talla-"]').forEach(n=>{n.style.borderColor="#ddd",n.style.background="white",n.style.color="#333"});const o=document.getElementById("pos-talla-"+t.replace(".","_"));o&&(o.style.borderColor="#E91E8C",o.style.background="#fce4f3",o.style.color="#E91E8C");const a=document.getElementById("pos-btn-agregar");a&&(a.textContent="+ Agregar al carrito",a.disabled=!1)};window.agregarAlCarritoPOS=e=>{const{productos:t,variantes:o}=window._posData,{varianteId:a,color:n,talla:i}=window._posSeleccion;if(!a||!n||!i)return;const r=t.find(d=>d.id===e);if(!r)return;const s=window._posCarrito.find(d=>d.variante_id===a);s?s.cantidad++:window._posCarrito.push({variante_id:a,producto_id:e,nombre:r.nombre,color:n,talla:i,cantidad:1,precio_menudeo:parseFloat(r.precio_menudeo)||0,precio_mayoreo3:parseFloat(r.precio_mayoreo3)||parseFloat(r.precio_menudeo)-30,precio_mayoreo6:parseFloat(r.precio_mayoreo6)||parseFloat(r.precio_menudeo)-70,precio_corrida:parseFloat(r.precio_corrida)||parseFloat(r.precio_menudeo)-100,imagen:r.imagen_principal||null,es_oferta:r.es_oferta||!1,precio_unitario:parseFloat(r.precio_menudeo)||0}),document.getElementById("pos-modal").remove(),renderCarritoPOS()};window.agregarCorridaPOS=e=>{const{productos:t,variantes:o,inventario:a}=window._posData,{color:n}=window._posSeleccion;if(!n){alert("Selecciona un color primero");return}t.find(m=>m.id===e);const i=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=a.filter(m=>m.sucursal_id===i),s=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=o.filter(m=>m.producto_id===e&&m.color===n).sort((m,g)=>s.indexOf(m.talla)-s.indexOf(g.talla)),c=document.getElementById("pos-modal").querySelector("div > div:last-child"),p=`
    <div style="background:#f3e5f5;border-radius:8px;padding:1rem;margin-top:1rem;border:1px solid #ce93d8">
      ...
      <div style="display:flex;flex-direction:column;gap:6px">
        ${d.map(m=>{const g=r.find(v=>v.variante_id===m.id),u=g?g.cantidad:0;return`
            <div style="display:flex;align-items:center;gap:8px">
  ...
  `;c&&c.insertAdjacentHTML("beforeend",p)};window.confirmarCorridaPOS=(e,t)=>{const{productos:o,variantes:a}=window._posData,n=o.find(r=>r.id===e);a.filter(r=>r.producto_id===e&&r.color===t).forEach(r=>{const s=document.getElementById("qty-corrida-"+r.id),d=s&&parseInt(s.value)||0;if(d<=0)return;const l=window._posCarrito.find(c=>c.variante_id===r.id);l?(l.cantidad+=d,l.es_corrida=!0):window._posCarrito.push({variante_id:r.id,producto_id:e,nombre:n.nombre,color:t,talla:r.talla,cantidad:d,precio_menudeo:parseFloat(n.precio_menudeo)||0,precio_mayoreo3:parseFloat(n.precio_mayoreo3)||parseFloat(n.precio_menudeo)-30,precio_mayoreo6:parseFloat(n.precio_mayoreo6)||parseFloat(n.precio_menudeo)-70,precio_corrida:parseFloat(n.precio_corrida)||parseFloat(n.precio_menudeo)-100,imagen:n.imagen_principal||null,es_oferta:n.es_oferta||!1,es_corrida:!0,precio_unitario:parseFloat(n.precio_menudeo)||0})}),document.getElementById("pos-modal").remove(),renderCarritoPOS()};window.renderCarritoPOS=()=>{var g;const e=window._posCarrito,t=document.getElementById("pos-carrito-items");if(!t)return;const o=e.reduce((u,v)=>u+v.cantidad,0);e.forEach(u=>{u.precio_manual||(u.es_oferta?u.precio_unitario=u.precio_menudeo:u.es_corrida?u.precio_unitario=u.precio_corrida:o>=6?u.precio_unitario=u.precio_mayoreo6:o>=3?u.precio_unitario=u.precio_mayoreo3:u.precio_unitario=u.precio_menudeo)});const a=e.reduce((u,v)=>u+v.cantidad*v.precio_unitario,0),n=e.some(u=>u.es_corrida)?"Corrida":o>=6?"Mayoreo 6+":o>=3?"Mayoreo 3+":"Menudeo",i=e.filter(u=>!u.es_corrida),r=e.filter(u=>u.es_corrida),s={};r.forEach(u=>{const v=u.producto_id+"|"+u.color;s[v]||(s[v]={nombre:u.nombre,color:u.color,producto_id:u.producto_id,tallas:[],subtotal:0,imagen:u.imagen||null}),s[v].tallas.push({talla:u.talla,cantidad:u.cantidad,variante_id:u.variante_id}),s[v].subtotal+=u.cantidad*u.precio_unitario}),e.length===0?t.innerHTML='<p style="color:#888;font-size:0.85rem;text-align:center;padding:2rem">El carrito esta vacio</p>':t.innerHTML=`
      ${i.map(u=>`
...
`).join("")}
  ...
  <div style="padding:10px;border-bottom:1px solid #f5f5f5;background:#fdf4ff" data-corrida-key="${u}">
    <div style="display:flex;gap:10px;align-items:start;margin-bottom:6px">
      ${v.imagen?`<img src="${v.imagen}" style="width:48px;height:48px;object-fit:contain;background:#f5f5f5;border-radius:8px;flex-shrink:0">`:'<div style="width:48px;height:48px;background:#f3e5f5;border-radius:8px;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:1.3rem">👠</div>'}
      <div style="flex:1">
        <div style="display:flex;justify-content:space-between;align-items:start">
          <div>
            <p style="font-size:0.9rem;font-weight:700">${v.nombre}</p>
            <p style="font-size:0.78rem;color:#6a1b9a;font-weight:600">📦 Corrida · ${v.color}</p>
            <div style="display:flex;flex-wrap:wrap;gap:4px;margin-top:4px">
              ${v.tallas.map(f=>`<span style="background:#f3e5f5;border-radius:100px;padding:2px 8px;font-size:0.72rem;color:#6a1b9a">T${f.talla} ×${f.cantidad}</span>`).join("")}
            </div>
          </div>
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-top:6px;flex-wrap:wrap;gap:8px">
      ...
      <div style="display:flex;align-items:center;gap:6px">
        ...
        <input type="number" value="${(v.subtotal/v.tallas.reduce((f,y)=>f+y.cantidad,0)).toFixed(2)}"
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-top:6px">
      <span style="font-size:0.78rem;color:#888">${v.tallas.reduce((f,y)=>f+y.cantidad,0)} pares</span>
      <p id="subtotal-corrida-${u.replace("|","-")}" style="font-size:0.95rem;font-weight:700;color:#6a1b9a">$${v.subtotal.toFixed(2)}</p>
    </div>
  </div>
`).join("")}
    `;const d=document.getElementById("pos-total"),l=document.getElementById("pos-total-pares"),c=document.getElementById("pos-tipo-precio");d&&(d.textContent="$"+a.toFixed(2)),l&&(l.textContent=o),c&&(c.textContent=n);const p=document.getElementById("pos-flotante-pares"),m=document.getElementById("pos-flotante-total");p&&(p.textContent=o+" pares"),m&&(m.textContent="$"+a.toFixed(2)),(g=document.getElementById("pos-drawer"))!=null&&g.classList.contains("open")&&renderDrawerPOS(),ge()};window.editarPrecioPOS=(e,t)=>{if(!window._posCarrito[e])return;const o=parseFloat(t);if(!o||o<=0){alert("El precio debe ser mayor a $0");return}window._posCarrito[e].precio_unitario=o,window._posCarrito[e].precio_manual=!0;const a=window._posCarrito[e].cantidad,n=document.getElementById("subtotal-item-"+e);n&&(n.textContent="$"+(a*o).toFixed(2));const i=window._posCarrito.reduce((s,d)=>s+d.cantidad*d.precio_unitario,0),r=document.getElementById("pos-total");r&&(r.textContent="$"+i.toFixed(2)),ge()};window.editarPrecioCorridaPOS=(e,t)=>{const[o,a]=e.split("|"),n=parseFloat(t);if(!n||n<=0){alert("El precio debe ser mayor a $0");return}window._posCarrito.forEach(c=>{c.producto_id===o&&c.color===a&&c.es_corrida&&(c.precio_unitario=n,c.precio_manual=!0)});const r=window._posCarrito.filter(c=>c.producto_id===o&&c.color===a&&c.es_corrida).reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),s=document.getElementById("subtotal-corrida-"+e.replace("|","-"));s&&(s.textContent="$"+r.toFixed(2));const d=window._posCarrito.reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),l=document.getElementById("pos-total");l&&(l.textContent="$"+d.toFixed(2)),ge()};window.editarCorridaEnCarrito=e=>{const[t,o]=e.split("|"),{inventario:a,variantes:n}=window._posData,i=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=a.filter(c=>c.sucursal_id===i),s=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=n.filter(c=>c.producto_id===t&&c.color===o).sort((c,p)=>s.indexOf(c.talla)-s.indexOf(p.talla)),l=document.createElement("div");l.id="pos-modal-editar-corrida",l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",l.innerHTML=`
    <div style="background:white;border-radius:16px;max-width:400px;width:100%;padding:1.5rem;max-height:90vh;overflow-y:auto">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${d.map(c=>{const p=r.find(v=>v.variante_id===c.id),m=p?p.cantidad:0,g=window._posCarrito.find(v=>v.variante_id===c.id&&v.es_corrida),u=g?g.cantidad:0;return`
            <div style="display:flex;align-items:center;gap:10px">
...
`+l.join(`
`)),e&&(e.disabled=!1,e.textContent="Cobrar");return}}let r=null;try{const l=await fetch(b+"/pedidos/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cliente_id:o,canal:"sucursal",sucursal_id:a,forma_pago:n,total:i,subtotal:i,status:"borrador"})}),c=await l.json();if(!l.ok)throw new Error("No se pudo crear el pedido: "+JSON.stringify(c));if(r=Array.isArray(c)?(d=c[0])==null?void 0:d.id:c==null?void 0:c.id,!r)throw new Error("No se obtuvo ID del pedido");for(const g of window._posCarrito){const u=await fetch(b+"/pedidos/"+r+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:g.variante_id,cantidad:g.cantidad,precio_unitario:g.precio_unitario,subtotal:g.cantidad*g.precio_unitario})});if(!u.ok){const v=await u.json().catch(()=>({}));throw new Error("Error en item "+g.nombre+": "+JSON.stringify(v))}}if(n!=="spei"){const g=await fetch(b+"/pedidos/"+r+"/confirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({forma_pago:n})});if(!g.ok){const u=await g.json().catch(()=>({}));throw new Error("Error confirmando: "+JSON.stringify(u))}}else await fetch(b+"/pedidos/"+r,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:"pendiente_pago"})});const p=window._posCarrito.reduce((g,u)=>g+u.cantidad,0);window._posCarrito=[],window._cobrando=!1,renderCarritoPOS(),imprimirTicketPOS(r,i,p,n);const m=await fetch(b+"/inventario/sucursal/"+a);window._posData.inventario=await m.json(),renderProductosPOS(window._posData.productos)}catch(l){if(console.error("Error procesando la venta:",l),window._cobrando=!1,r)try{await fetch(b+"/pedidos/"+r+"/cancelar",{method:"POST",headers:{"Content-Type":"application/json"},body:"{}"}),console.warn("Pedido "+r+" cancelado por error")}catch{}alert(`Error al procesar la venta:
`+((l==null?void 0:l.message)||l)),[e,t].forEach(c=>{c&&(c.disabled=!1,c.textContent="Cobrar")})}};window.guardarCarritoPOS=async e=>{var s,d,l,c;if(!window._posCarrito||window._posCarrito.length===0){alert("El carrito está vacío");return}const t=((s=document.getElementById("pos-cliente"))==null?void 0:s.value)||null;if(!t){alert("Selecciona un cliente para guardar el carrito");return}if(window._guardandoCarrito)return;window._guardandoCarrito=!0;const o=(d=document.getElementById("pos-sucursal"))==null?void 0:d.value,a=((l=document.getElementById("pos-pago"))==null?void 0:l.value)||"efectivo",n=[...document.querySelectorAll('button[onclick^="guardarCarritoPOS"]')];n.forEach(p=>{p.disabled=!0,p._txt=p.textContent,p.textContent="Guardando..."});let i=null,r=!1;try{const p=await fetch(b+"/pedidos/?status=borrador").then(f=>f.json()).catch(()=>[]),m=Array.isArray(p)?p.find(f=>f.cliente_id===t&&(!f.canal||f.canal==="sucursal"||f.canal==="mayoreo")):null;if(m)i=m.id;else{const f=await fetch(b+"/pedidos/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cliente_id:t,canal:"sucursal",sucursal_id:o,forma_pago:a,total:0,subtotal:0,status:"borrador"})}),y=await f.json();if(!f.ok)throw new Error("No se pudo crear el carrito: "+JSON.stringify(y));if(i=Array.isArray(y)?(c=y[0])==null?void 0:c.id:y==null?void 0:y.id,!i)throw new Error("No se obtuvo ID del carrito");r=!0}let g=await fetch(b+"/pedidos/"+i+"/items").then(f=>f.json()).catch(()=>[]);Array.isArray(g)||(g=[]);for(const f of window._posCarrito){const y=!!f.es_corrida,h=g.find(x=>x.variante_id===f.variante_id&&!!x.es_corrida===y);if(h){const x=h.cantidad+f.cantidad,E=await fetch(b+"/pedidos/"+i+"/items/"+h.id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({cantidad:x,precio_unitario:f.precio_unitario,subtotal:x*f.precio_unitario})});if(!E.ok)throw new Error("Error actualizando "+(f.nombre||"")+": "+JSON.stringify(await E.json().catch(()=>({}))));h.cantidad=x}else{const x=await fetch(b+"/pedidos/"+i+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:f.variante_id,cantidad:f.cantidad,precio_unitario:f.precio_unitario,subtotal:f.cantidad*f.precio_unitario,nombre:f.nombre||"",color:f.color||"",talla:f.talla||"",es_corrida:y})});if(!x.ok)throw new Error("Error en item "+(f.nombre||"")+": "+JSON.stringify(await x.json().catch(()=>({}))));const E=await x.json().catch(()=>null);Array.isArray(E)&&E[0]&&g.push(E[0])}}const u=await fetch(b+"/pedidos/"+i+"/items").then(f=>f.json()).catch(()=>g),v=(Array.isArray(u)?u:[]).reduce((f,y)=>f+y.cantidad*y.precio_unitario,0);await fetch(b+"/pedidos/"+i,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({total:v,subtotal:v})}),window._posCarrito=[],window._guardandoCarrito=!1,e&&typeof cerrarDrawerPOS=="function"&&cerrarDrawerPOS(),typeof limpiarClientePOS=="function"&&limpiarClientePOS(),renderCarritoPOS(),alert(m?"Se agregó al carrito que ya tenía este cliente. Lo ves en la sección Carritos.":"Carrito guardado. Lo encuentras en la sección Carritos.")}catch(p){if(window._guardandoCarrito=!1,i&&r)try{await fetch(b+"/pedidos/"+i+"/cancelar",{method:"POST",headers:{"Content-Type":"application/json"},body:"{}"})}catch{}alert(`No se pudo guardar el carrito:
`+((p==null?void 0:p.message)||p)),n.forEach(m=>{m.disabled=!1,m._txt&&(m.textContent=m._txt)})}};window.imprimirTicketPOS=async(e,t,o,a)=>{const i=await(await fetch(b+"/pedidos/"+e)).json();if(!i||i.length===0)return;const r=i[0],s=r.pedido_items||[],d=r.clientes||{},l=new Date().toLocaleString("es-MX"),c=window.open("","_blank","width=400,height=600");c.document.write(`
    ...
    <body>
      ...
      <div class="divider"></div>
      ${(()=>{const p={};return s.forEach(m=>{const g=m.variantes||{},v=((g.productos||{}).nombre||"—").split(" ")[0],f=v+"|"+(g.color||"");p[f]||(p[f]={nombre:v,color:g.color||"",precio:m.precio_unitario||0,cantidad:0,subtotal:0}),p[f].cantidad+=m.cantidad,p[f].subtotal+=parseFloat(m.subtotal)||m.cantidad*m.precio_unitario}),`
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
        ...
        </tr>`}).join(""))};async function lt(){try{const t=await(await fetch(b+"/pedidos/")).json(),a=await(await fetch(b+"/clientes/")).json(),i=await(await fetch(b+"/inventario/alertas")).json(),r=new Date;r.setHours(0,0,0,0);const s=new Date(r);s.setDate(s.getDate()-7);const d=new Date(r);d.setDate(d.getDate()-30);const l=t.filter(k=>["confirmado","pagado","enviado"].includes(k.status)),c=l.filter(k=>new Date(k.created_at)>=r),p=l.filter(k=>new Date(k.created_at)>=s),m=c.reduce((k,B)=>k+parseFloat(B.total||0),0),g=p.reduce((k,B)=>k+parseFloat(B.total||0),0),u=a.filter(k=>k.created_at&&new Date(k.created_at)>=d).length,v=["Dom","Lun","Mar","Mie","Jue","Vie","Sab"],f={};v.forEach(k=>f[k]=0),l.filter(k=>new Date(k.created_at)>=d).forEach(k=>{const B=v[new Date(k.created_at).getDay()];f[B]+=parseFloat(k.total||0)});const y={};l.forEach(k=>{y[k.canal||"sucursal"]=(y[k.canal||"sucursal"]||0)+parseFloat(k.total||0)});const h={};l.forEach(k=>{h[k.forma_pago||"efectivo"]=(h[k.forma_pago||"efectivo"]||0)+1});const x={};l.forEach(k=>{x[k.empleado||"Admin"]=(x[k.empleado||"Admin"]||0)+parseFloat(k.total||0)});const E={};l.forEach(k=>{const B=new Date(k.created_at).toLocaleDateString("es-MX",{month:"short",year:"numeric"});E[B]=(E[B]||0)+parseFloat(k.total||0)});const w={};l.forEach(k=>{k.clientes&&(w[k.clientes.nombre]=(w[k.clientes.nombre]||0)+parseFloat(k.total||0))});const C=Object.entries(w).sort((k,B)=>B[1]-k[1]).slice(0,5),T=Object.entries(f).sort((k,B)=>B[1]-k[1])[0],$=Object.entries(x).sort((k,B)=>B[1]-k[1])[0];if(!document.getElementById("dashboard-contenido"))return;const G=l.filter(k=>new Date(k.created_at)>=d),S=G.reduce((k,B)=>k+parseFloat(B.total||0),0),M=[];for(let k=6;k>=0;k--){const B=new Date(r);B.setDate(B.getDate()-k);const D=B.toISOString().split("T")[0],_=B.toLocaleDateString("es-MX",{weekday:"short",day:"numeric"}),L=l.filter(O=>{var I;return(I=O.created_at)==null?void 0:I.startsWith(D)}).reduce((O,I)=>O+parseFloat(I.total||0),0);M.push({label:_,total:L,ds:D})}const F=(k,B,D,_)=>{const L=document.getElementById(k),O=document.getElementById(k+"-sub");L&&(L.textContent=B,_&&(L.style.color=_)),O&&D&&(O.textContent=D)};F("kpi-ventas-hoy","$"+m.toLocaleString("es-MX",{maximumFractionDigits:0}),c.length+" pedidos","#C8967A"),F("kpi-pedidos-hoy",c.length,"confirmados"),F("kpi-ventas-7d","$"+g.toLocaleString("es-MX",{maximumFractionDigits:0}),p.length+" pedidos"),F("kpi-ventas-30d","$"+S.toLocaleString("es-MX",{maximumFractionDigits:0}),G.length+" pedidos"),F("kpi-clientes-nuevos",u,"últimos 30 días"),F("kpi-stock-bajo",i.length,i.length>0?"⚠ reabastecer":"✓ ok",i.length>0?"#f59e0b":"#10b981"),F("kpi-mejor-dia",T?T[0]:"—",T?"$"+T[1].toLocaleString("es-MX",{maximumFractionDigits:0}):""),F("kpi-total-clientes",a.length,"registrados");const P=document.getElementById("dash-top-clientes");P&&(P.innerHTML=C.length===0?'<p style="color:var(--text-muted);font-size:0.85rem">Sin datos aun</p>':C.map(([k,B],D)=>`
          ...
          </div>`).join(""));const A=document.getElementById("dash-ultimos-pedidos");if(A){const k=D=>D==="online"||D==="mp"?"🌐":D==="whatsapp"?"💬":"🏪",B=D=>D==="confirmado"||D==="pagado"?"#10b981":D==="enviado"?"#0891b2":"#f59e0b";A.innerHTML=t.slice(0,7).map(D=>{var _;return`
        <div onclick="verPedido('${D.id}')" style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid var(--border);cursor:pointer">
          <div style="width:36px;height:36px;background:var(--pink-soft);border-radius:9px;display:flex;align-items:center;justify-content:center;font-size:1.1rem;flex-shrink:0">${k(D.mp_preference_id?"online":D.canal||"")}</div>
          <div style="flex:1;min-width:0">
            <p style="font-size:0.83rem;font-weight:600;color:var(--text-1);white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${((_=D.clientes)==null?void 0:_.nombre)||D.nombre_cliente||"General"}</p>
          ...
          <div style="text-align:right;flex-shrink:0">
            ...
            <span style="font-size:0.6rem;font-weight:700;color:${B(D.status)}">${D.status}</span>
          </div>
        </div>`}).join("")}setTimeout(()=>{const k="#E91E8C",B="#7c3aed",D="#0891b2",_="#059669",L=["rgba(233,30,140,0.8)","rgba(124,58,237,0.8)","rgba(8,145,178,0.8)","rgba(5,150,105,0.8)","rgba(217,119,6,0.8)","rgba(220,38,38,0.8)"],O=["#E91E8C","#7c3aed","#0891b2","#059669","#d97706","#dc2626"],I={ticks:{color:"#94a3b8",font:{size:9}},grid:{color:"rgba(148,163,184,0.08)"}},q={responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:I,y:I}},j=document.getElementById("chart-tendencia");j&&window.Chart&&new Chart(j,{type:"line",data:{labels:M.map(V=>V.label),datasets:[{data:M.map(V=>V.total),borderColor:k,backgroundColor:"rgba(233,30,140,0.08)",borderWidth:2.5,pointBackgroundColor:k,pointBorderColor:"white",pointBorderWidth:2,pointRadius:5,pointHoverRadius:7,fill:!0,tension:.4}]},options:{...q,plugins:{legend:{display:!1},tooltip:{callbacks:{label:V=>" $"+V.parsed.y.toLocaleString("es-MX",{maximumFractionDigits:0})}}}}});const H=document.getElementById("chart-dias");H&&window.Chart&&new Chart(H,{type:"bar",data:{labels:v,datasets:[{data:v.map(V=>f[V]||0),backgroundColor:L,borderColor:O,borderWidth:1.5,borderRadius:6}]},options:{...q,plugins:{legend:{display:!1}}}});const R=document.getElementById("chart-canales"),N=Object.keys(y),W=Object.values(y);if(R&&window.Chart&&N.length>0){new Chart(R,{type:"doughnut",data:{labels:N,datasets:[{data:W,backgroundColor:L,borderColor:O,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"72%",plugins:{legend:{display:!1},tooltip:{callbacks:{label:Y=>` ${Y.label}: $${Y.parsed.toLocaleString("es-MX",{maximumFractionDigits:0})}`}}}}});const V=W.reduce((Y,J)=>Y+J,0),U=document.getElementById("dash-canales-lista");U&&(U.innerHTML=N.map((Y,J)=>`
          <div style="display:flex;align-items:center;gap:7px;margin-bottom:8px">
            <span style="width:9px;height:9px;border-radius:50%;background:${O[J%O.length]};flex-shrink:0"></span>
            <span style="flex:1;font-size:0.76rem;color:var(--text-2);text-transform:capitalize">${Y}</span>
      ...
      ${B.length===0?'<p style="color:#aaa;font-size:0.85rem;text-align:center;padding:1rem">Sin tareas pendientes</p>':B.map(_=>`
        ...
        `).join("")}
    `,document.getElementById("dashboard-contenido").appendChild(D)}catch(k){console.error("tareas:",k)}}catch(e){console.error("Error dashboard:",e)}}window.eliminarItemPedido=e=>{window._pedidoItems.splice(e,1),window.recalcularTotal(),window.renderItemsPedido()};window.cerrarSesionPanel=()=>{confirm("Cerrar sesion?")&&(sessionStorage.removeItem("erp_empleado"),sessionStorage.removeItem("erp_token"),window._empleadoActual=null,location.reload())};async function Re(){const e=document.getElementById("content");try{const t=await fetch(b+"/empleados/",{headers:window.authHeaders()}),o=await t.json();if(!t.ok||!Array.isArray(o)){e.innerHTML=`<div style="padding:2rem;background:#fff3cd;border-radius:12px;color:#856404">
...
`)[0].trim();c=y.match(/^https?:\/\/.+\.(jpg|jpeg|png|webp|gif)/i)?`<img src="${y}" style="max-width:200px;border-radius:8px;display:block;cursor:pointer" onclick="window.open('${y}')">`:`<p>${l}</p>`}else if(n.tipo==="documento_saliente"){const y=l.replace("[Documento] ","").split(" "),h=y[0]||"documento";c=`<a href="${y[1]||""}" target="_blank" class="wa-doc-link">
        ...
        ${h}</a>`}else if(n.tipo==="video_saliente")c=`<video src="${l.replace("[Video] ","")}" controls style="max-width:220px;border-radius:8px;display:block"></video>`;else if(n.tipo==="botones_saliente"){const y=l.replace("[Botones] ","").split(" -> "),h=y[0]||l,x=(y[1]||"").split(" | ");c=`<p style="margin:0 0 8px">${h}</p>
        <div style="display:flex;flex-direction:column;gap:4px">${x.map(E=>`<span style="border:1px solid rgba(8,145,178,0.3);border-radius:6px;padding:4px 10px;font-size:0.78rem;color:#0891b2;text-align:center">${E}</span>`).join("")}</div>`}else if(n.tipo==="lista_saliente"){const y=l.replace("[Lista] ","").split(" -> "),h=y[0]||l,x=(y[1]||"").split(", ").slice(0,5);c=`<p style="margin:0 0 6px">${h}</p>
        <div style="border:1px solid rgba(8,145,178,0.25);border-radius:6px;padding:6px 8px;font-size:0.75rem;color:#0891b2">
          ${x.map(E=>`<div>• ${E}</div>`).join("")}
          ${x.length<(y[1]||"").split(", ").length?'<div style="color:#94a3b8">…</div>':""}
        </div>`}else if(n.tipo==="carrusel_saliente"){const y=(n.mensaje||"").split("|IMGS|"),h=y[1]?y[1].split(",").filter(Boolean):[];c=`<p style="margin:0;font-size:0.85rem">${l.split("|IMGS|")[0].replace("[Carrusel] ","")}</p>
        ${h.length?`<div style="display:flex;gap:6px;overflow-x:auto;margin-top:6px;max-width:250px;padding-bottom:2px">${h.map(E=>`<img src="${E}" alt="producto" style="width:62px;height:78px;object-fit:cover;border-radius:8px;flex-shrink:0;cursor:pointer" onclick="window.open('${E}','_blank')">`).join("")}</div>`:'<p style="margin:4px 0 0;font-size:0.72rem;color:#94a3b8">🎠 Carrusel de productos</p>'}`}else if(n.tipo==="sticker"){const y=(n.mensaje||"").match(/https?:\/\/\S+/);c=y?`<img src="${y[0]}" alt="sticker" style="width:100px;height:100px;object-fit:contain">`:'<p style="color:#64748b;font-size:0.8rem">🏷️ Sticker</p>'}else if(n.tipo==="template_saliente")c=`<p style="margin:0;font-size:0.85rem">${l.replace("[Template] ","")}</p>
        <p style="margin:4px 0 0;font-size:0.72rem;color:#94a3b8">📋 Plantilla enviada</p>`;else if(n.tipo==="button_reply")c=`<p style="margin:0;color:#0891b2;font-size:0.85rem">👆 ${l.replace("[Botón] ","")}</p>`;else if(n.tipo==="list_reply")c=`<p style="margin:0;color:#0891b2;font-size:0.85rem">☰ ${l.replace("[Lista] ","")}</p>`;else if(n.tipo==="ubicacion_saliente"){const y=((f=l.match(/https:\/\/maps\.google\.com\/\?q=[\d.,]+/))==null?void 0:f[0])||"",h=l.replace("[Ubicación] ","").replace(/ https:.*/,"");c=`<a href="${y}" target="_blank" class="wa-doc-link" style="color:#0891b2;text-decoration:none">
        ...
        ${l.replace("[Contacto] ","")}</span>`;else if(n.tipo==="imagen"){const y=(n.mensaje||"").match(/https?:\/\/\S+/),h=n.media_url||(y?y[0]:null),x=(n.mensaje||"").replace("[Imagen]","").replace(/https?:\/\/\S+/,"").replace(/^[:\s]+/,"").trim();h?c=`<div>
          ...
          ${x?`<p style="margin:4px 0 0;font-size:0.82rem;color:#475569">${x}</p>`:""}
        </div>`:c='<p style="color:#64748b;font-size:0.8rem">📷 Imagen recibida</p>'}else c=`<p>${l}</p>`;let p="";if(r){const y=t(e.cliente_leyo_at),h=t(e.cliente_entrego_at),x=t(n.created_at);y&&x<=y?p='<span class="wa-read-receipt read" title="Visto">✓✓</span>':h&&x<=h?p='<span class="wa-read-receipt delivered" title="Entregado">✓✓</span>':i===a&&(p='<span class="wa-read-receipt sent" title="Enviado">✓</span>')}const m=`<button class="wa-reply-btn" onclick="iniciarReply('${e.telefono}','${(n.wa_message_id||"").replace(/'/g,"")}')" title="Responder">
...
`)||"(sin contenido)",n.style.display="block";const m=document.getElementById("envio-seccion-foto");if(m){m.style.display="block";const y=m.querySelector("p");y&&(y.innerHTML=p?'<span style="font-weight:700;font-size:0.9rem">2️⃣ Foto de portada del catálogo</span> <span style="font-weight:400;color:#aaa;font-size:0.78rem">(imagen principal que verá el cliente)</span>':'<span style="font-weight:700;font-size:0.9rem">2️⃣ Foto del modelo</span> <span style="font-weight:400;color:#aaa;font-size:0.78rem">(opcional — para plantillas con imagen)</span>')}const g=document.getElementById("envio-mpm-aviso");g&&(g.style.display=p?"block":"none"),window._envioEsMPM=p,window._envioHeaderTipo=(s==null?void 0:s.format)||(s!=null&&s.text?"TEXT":"NONE");const u=(d==null?void 0:d.text)||"",v=u.match(/\{\{[\d]*\}\}/g)||[];window._envioBodyVarsCount=v.length||(u.includes("{{")?1:0);const f=document.getElementById("envio-seccion-foto");f&&(f.style.display=window._envioHeaderTipo==="IMAGE"?"block":"none"),document.querySelectorAll('input[name="envio-plantilla-radio"]').forEach(y=>{const h=y.closest("label");h&&(h.style.borderColor=y.value===e?"#E91E8C":"#eee",h.style.background=y.value===e?"#fff0f8":"")})};const qe=e=>{const t=document.getElementById("envio-lista");t&&(t.innerHTML=e.map(o=>{var i;const a=(i=window._envioSeleccionados)==null?void 0:i.has(o.telefono),n=o.telefono.replace(/\D/g,"");return`<label style="display:flex;align-items:center;gap:10px;padding:8px 10px;border-radius:8px;cursor:pointer;border:1.5px solid ${a?"#E91E8C":"#f0f0f0"};background:${a?"#fff0f8":"white"}" id="envio-row-${n}">
...
<div>
  ...
  <div style="display:flex;gap:1rem;flex-wrap:wrap">
    ...
    <div class="table-card">
    ...
    </div>`,a==="seleccionar"&&Ge(e),a==="generar"&&Ue(e)}window.switchTabCat=function(e){const{catalogoId:t}=window._catalogoPaginasData;window._catalogoPaginasData.tabActiva=e,document.querySelectorAll("#tab-subir,#tab-seleccionar,#tab-generar").forEach(o=>o.style.display="none"),document.getElementById("tab-"+e).style.display="block",document.querySelectorAll('[onclick^="switchTabCat"]').forEach(o=>{var n;const a=(n=o.getAttribute("onclick").match(/'(\w+)'/))==null?void 0:n[1];o.style.borderBottomColor=a===e?"#C8967A":"transparent",o.style.color=a===e?"#C8967A":"#6b7280"}),e==="seleccionar"&&Ge(t),e==="generar"&&Ue(t)};window.descargarCatalogoPDF=async function(){const e=window._catalogoPaginasData;if(!e)return;const{portada_url:t,paginas:o,nombre:a}=e,n=[];if(t&&n.push(t),[...o].sort((s,d)=>s.pagina_numero-d.pagina_numero).forEach(s=>{s.imagen_url&&n.push(s.imagen_url)}),n.length===0){alert("No hay páginas para descargar.");return}const r=document.querySelector('[onclick="descargarCatalogoPDF()"]');r&&(r.disabled=!0,r.textContent="⏳ Generando PDF...");try{window.jspdf||await new Promise((f,y)=>{const h=document.createElement("script");h.src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js",h.onload=f,h.onerror=y,document.head.appendChild(h)});const{jsPDF:s}=window.jspdf,d=f=>new Promise(y=>{const h=new Image;h.crossOrigin="anonymous",h.onload=()=>{const x=document.createElement("canvas");x.width=h.naturalWidth||h.width,x.height=h.naturalHeight||h.height,x.getContext("2d").drawImage(h,0,0),y({dataUrl:x.toDataURL("image/jpeg",.92),w:x.width,h:x.height})},h.onerror=()=>y(null),h.src=f}),c=(await Promise.all(n.map(d))).filter(Boolean);if(c.length===0){alert("No se pudieron cargar las imágenes. Revisa tu conexión.");return}const p=210,m=280,g=new s({unit:"mm",format:[p,m]}),u=(f,y)=>{y||g.addPage([p,m]);const h=f.w/f.h,x=p/m;let E,w,C,T;h>x?(E=p,w=p/h,C=0,T=(m-w)/2):(w=m,E=m*h,T=0,C=(p-E)/2),g.addImage(f.dataUrl,"JPEG",C,T,E,w)};c.forEach((f,y)=>u(f,y===0));const v=(a||"catalogo").replace(/[^a-zA-Z0-9_\-áéíóúñÁÉÍÓÚÑ ]/g,"").trim()||"catalogo";g.save(`${v}.pdf`)}catch(s){console.error("Error generando PDF:",s),alert("Error al generar el PDF: "+s.message)}finally{r&&(r.disabled=!1,r.innerHTML="📥 Descargar PDF")}};async function Ge(e){const t=document.getElementById("selector-tienda-content");if(t)try{const[o,a]=await Promise.all([fetch(b+"/variantes/"),fetch(b+"/productos/")]),n=await o.json(),i=await a.json(),r=[];n.forEach(d=>{const l=i.find(p=>p.id===d.producto_id),c=(l==null?void 0:l.nombre)||d.sku||"";d.foto_url&&r.push({url:d.foto_url,nombre:c,color:d.color||""}),d.imagenes&&Array.isArray(d.imagenes)&&d.imagenes.forEach(p=>{p&&p!==d.foto_url&&r.push({url:p,nombre:c,color:d.color||""})})});const s=r.filter((d,l,c)=>c.findIndex(p=>p.url===d.url)===l);window._selectorFotos={fotos:s,seleccionadas:new Set},t.innerHTML=`
      ...
      </div>`}catch(o){t.innerHTML='<p style="color:red">Error: '+o.message+"</p>"}}window._toggleGenProd=function(e){const{seleccionados:t}=window._generadorData,o=document.getElementById("gen-item-"+e),a=document.getElementById("gen-colores-"+e);t.has(e)?(t.delete(e),o.style.borderColor="transparent",a&&(a.style.opacity="0.35",a.style.pointerEvents="none")):(t.add(e),o.style.borderColor="#C8967A",a&&(a.style.opacity="1",a.style.pointerEvents="auto")),document.getElementById("gen-count").textContent=t.size+" seleccionados"};window._toggleColorGen=function(e,t){var n,i;const o=document.getElementById(`gen-col-${e}-${t}`);if(!o)return;const a=o.dataset.sel==="1";o.dataset.sel=a?"0":"1",o.style.borderColor=a?"#ccc":"#C8967A",o.style.opacity=a?"0.3":"1",o.title=(((i=(n=window._generadorData.coloresPorProd[e])==null?void 0:n[t])==null?void 0:i.color)||"")+(a?" (excluido)":"")};window._selTodosGenerador=function(){const{productos:e,seleccionados:t}=window._generadorData,o=t.size===e.length;t.clear(),e.forEach((a,n)=>{const i=document.getElementById("gen-item-"+n);o?i&&(i.style.borderColor="transparent"):(t.add(n),i&&(i.style.borderColor="#C8967A"))}),document.getElementById("gen-count").textContent=t.size+" seleccionados"};function le(e){return new Promise(t=>{const o=new Image;o.crossOrigin="anonymous",o.onload=()=>t(o),o.onerror=()=>t(null),o.src=e+(e.includes("?")?"&":"?")+"_t="+Date.now()})}function _e(e,t,o,a,n,i){const r=t.split(" ");let s="",d=a;for(let l of r){const c=s+(s?" ":"")+l;e.measureText(c).width>n&&s?(e.fillText(s,o,d),s=l,d+=i):s=c}return s&&e.fillText(s,o,d),d+i}window.generarPaginasCanvas=async function(e){const{productos:t,variantes:o,seleccionados:a,coloresPorProd:n}=window._generadorData;if(!a.size){alert("Selecciona al menos un producto");return}const i=document.getElementById("gen-layout").value,r=i==="1e"?1:parseInt(i),s=[];Array.from(a).sort((f,y)=>f-y).forEach(f=>{const y=t[f],h=n?n[f]:[];if(!h||h.length<=1)s.push({prod:y,origIdx:f,colorFiltro:null,todosColSel:h||[]});else{const x=h.filter((w,C)=>{const T=document.getElementById(`gen-col-${f}-${C}`);return!T||T.dataset.sel!=="0"}),E=x.length>0?x:h;for(const w of E)s.push({prod:y,origIdx:f,colorFiltro:w.color,todosColSel:E})}});const d=f=>{const y=o.filter(h=>h.producto_id===f.prod.id&&h.activa!==!1);return f.colorFiltro?y.filter(h=>(h.color||"").trim()===f.colorFiltro):y},l=[];for(let f=0;f<s.length;f+=r)l.push(s.slice(f,f+r));const c=document.getElementById("btn-generar"),p=document.getElementById("gen-progress"),m=document.getElementById("gen-msg"),g=document.getElementById("gen-bar");c.disabled=!0,p.style.display="block";const{paginas:u}=window._catalogoPaginasData;let v=u.length>0?Math.max(...u.map(f=>f.pagina_numero))+1:1;for(let f=0;f<l.length;f++){const y=l[f],h=$=>($==null?void 0:$.prod)??$,x=$=>($==null?void 0:$.origIdx)??t.indexOf(($==null?void 0:$.prod)??$);m.textContent=`Generando página ${f+1} de ${l.length}...`,g.style.width=f/l.length*100+"%";const E=document.createElement("canvas");E.width=1080,E.height=1440;const w=E.getContext("2d");if(w.fillStyle="#FAFAF8",w.fillRect(0,0,1080,1440),w.fillStyle="#C8967A",w.fillRect(60,48,960,1),w.fillStyle="#2A1A0E",w.font="300 22px DM Sans, sans-serif",w.textAlign="center",w.letterSpacing="8px",w.fillText("ZAPATILLAS MAY",540,42),w.letterSpacing="0px",w.fillStyle="#C8967A",w.fillRect(60,58,960,1),i==="1e"){const $=y[0],z=h($),G=d($),S=[],M=new Set,F=I=>{I&&!M.has(I)&&(M.add(I),S.push(I))};G.length>0&&G[0].foto_url?F(G[0].foto_url):F(z.imagen_principal);for(const I of G)if(F(I.foto_url),Array.isArray(I.imagenes)&&I.imagenes.forEach(F),S.length>=3)break;const P=S.length,A=($.todosColSel||[]).map(I=>({color:I.color,hex:I.hex})),k={negro:"#1C1C1C",blanco:"#F8F8F8",hueso:"#F0EBE1",beige:"#D9C9A8",camel:"#C19A6B","cafe claro":"#A0725A","cafe medio":"#7A4A30","cafe oscuro":"#4A2010",cafe:"#6B3A2A",chocolate:"#3D1C02",cognac:"#9B4421",taupe:"#8B7355",nude:"#D4A97A","nude claro":"#E8C9A8","nude oscuro":"#C0886A","nude rosa":"#DDA090","palo de rosa":"#D4A0A0",salmon:"#FA8072",coral:"#FF6B4A",rojo:"#CC2200",vino:"#722F37",bordo:"#800020","rosa claro":"#F9C0CB",rosa:"#F4607A",fusha:"#E91E8C",naranja:"#FF8C00",amarillo:"#F5C518",dorado:"#D4AF37",oro:"#CFB53B","oro rosa":"#E8B4B8",plateado:"#C0C0C0","azul claro":"#5B8DB8",azul:"#1E4080","azul marino":"#001F5B",turquesa:"#40C4AA",verde:"#2D6A4F","verde menta":"#98D8C8","gris claro":"#C8C8C8",gris:"#909090","gris oscuro":"#505050",morado:"#7B2D8B",lila:"#C8A0D8",multicolor:"#CCAA88"},B=({color:I,hex:q})=>{if(q&&q.startsWith("#"))return q;const j=(I||"").toLowerCase();if(k[j])return k[j];for(const[H,R]of Object.entries(k))if(j.includes(H))return R;return"#BBAA99"},D=(I,q,j,H,R)=>{if(w.save(),w.fillStyle="#FFFFFF",w.fillRect(q,j,H,R),I){w.beginPath(),w.rect(q,j,H,R),w.clip();const N=I.naturalWidth/I.naturalHeight,W=H/R;let X,Q,V,U;N>W?(V=H,U=H/N,X=q,Q=j+(R-U)/2):(U=R,V=R*N,Q=j,X=q+(H-V)/2),w.drawImage(I,X,Q,V,U)}w.restore()},_=62,L=1080,O=_+L+12;if(P>=3){const[I,q,j]=await Promise.all(S.slice(0,3).map(le)),H=10,R=10,N=648,W=1080-N-H,X=Math.floor((L-R)/2);D(I,0,_,N,L),D(q,N+H,_,W,X),D(j,N+H,_+X+R,W,X)}else if(P===2){const[I,q]=await Promise.all(S.map(le)),j=10,H=Math.floor((1080-j)/2);D(I,0,_,H,L),D(q,H+j,_,H,L)}else{const[I]=await Promise.all([le(S[0])]);D(I,40,_,1e3,L)}if(w.fillStyle="#E8DDD5",w.fillRect(0,O,1080,1),w.fillStyle="#2A1A0E",w.textAlign="center",w.font="300 28px DM Sans, sans-serif",w.letterSpacing="3px",_e(w,z.nombre.toUpperCase(),540,O+42,960,38),w.letterSpacing="0px",z.sku&&(w.fillStyle="#A07860",w.font="400 14px DM Mono, monospace",w.fillText(z.sku,540,O+66)),A.length>0){const j=Math.min(A.length,14),H=j*(11*2)+(j-1)*8;let R=Math.round(540-H/2+11);const N=O+100;for(let W=0;W<j;W++){const X=R+W*30;w.beginPath(),w.arc(X,N,11,0,Math.PI*2),w.fillStyle=B(A[W]),w.fill(),w.strokeStyle="rgba(0,0,0,0.18)",w.lineWidth=1.5,w.stroke()}}}else{const $=r<=2?r:2,z=r===4?2:1,G=80,S=100,M=r===1?0:20,F=r===4?20:0,P=r===1?40:28,A=(1080-P*2-M*($-1))/$,k=(1440-G-S-F*(z-1))/z;for(let B=0;B<y.length;B++){const D=h(y[B]);x(y[B]);const _=B%$,L=Math.floor(B/$),O=P+_*(A+M),I=G+L*(k+F),q=r===1?120:r===2?90:70,j=k-q,H=d(y[B]),R=H.length>0&&H[0].foto_url?H[0].foto_url:D.imagen_principal,N=await le(R);if(w.save(),w.fillStyle="#FFFFFF",w.fillRect(O,I,A,j),N){w.beginPath(),w.rect(O,I,A,j),w.clip();const Q=N.naturalWidth/N.naturalHeight,V=A/j;let U,Y,J,Z;Q>V?(J=A,Z=A/Q,U=O,Y=I+(j-Z)/2):(Z=j,J=j*Q,Y=I,U=O+(A-J)/2),w.drawImage(N,U,Y,J,Z)}w.restore(),w.fillStyle="#E8DDD5",w.fillRect(O,I+j,A,1);const W=I+j+q/2;w.fillStyle="#2A1A0E",w.textAlign="center";const X=r===1?34:r===2?24:19;w.font=`300 ${X}px DM Sans, sans-serif`,w.letterSpacing="2px",_e(w,D.nombre.toUpperCase(),O+A/2,W-8,A-32,X+10),w.letterSpacing="0px",D.sku&&(w.fillStyle="#A07860",w.font=`400 ${r===1?18:13}px DM Mono, monospace`,w.fillText(D.sku,O+A/2,W+(r===1?36:26)))}}w.fillStyle="#C8967A",w.fillRect(60,1340,960,1),w.fillStyle="#A07860",w.font="300 18px DM Sans, sans-serif",w.textAlign="center",w.letterSpacing="3px",w.fillText("@ZAPATILLASMAY",540,1368),w.letterSpacing="0px",w.fillStyle="#C0A898",w.font="300 15px DM Sans, sans-serif",w.fillText("zapatillasmay.mx  ·  León, Guanajuato",540,1394);const C=await new Promise($=>E.toBlob($,"image/jpeg",.92)),T=new FormData;T.append("archivo",C,`catalogo-pag-${v}.jpg`);try{const z=await(await fetch(b+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:T})).json();z.url&&await fetch(b+"/catalogos/"+e+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:z.url,pagina_numero:v++})})}catch($){console.error("Error subiendo página generada",$)}}g.style.width="100%",m.textContent=`✅ ${l.length} páginas generadas`,setTimeout(()=>{p.style.display="none"},2e3),c.disabled=!1,await gestionarPaginas(e,window._catalogoPaginasData.nombre)};window.descargarCatalogoPorCategoria=async function(e,t){const o=document.getElementById("cat-pdf-msg"),a=document.querySelectorAll("#cat-pdf-btns button");a.forEach(n=>n.disabled=!0),o&&(o.style.display="block",o.textContent=`⏳ Cargando productos de ${t}...`);try{const[n,i]=await Promise.all([fetch(b+`/productos/?categoria=eq.${e}&activo=eq.true&order=nombre.asc`),fetch(b+"/variantes/")]),r=await n.json(),s=await i.json();if(!r.length){o&&(o.textContent=`Sin productos activos en ${t}`),a.forEach(S=>S.disabled=!1);return}o&&(o.textContent=`✏️ Generando PDF (${r.length} productos)...`),window.jspdf||await new Promise((S,M)=>{const F=document.createElement("script");F.src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js",F.onload=S,F.onerror=M,document.head.appendChild(F)});const{jsPDF:d}=window.jspdf,l=2,c=2,p=l*c,m=1080,g=1440,u=40,v=16,f=70,y=80,h=(m-u*2-v*(l-1))/l,x=(g-f-y-v*(c-1))/c,E=60,w=S=>new Promise(M=>{if(!S)return M(null);const F=new Image;F.crossOrigin="anonymous",F.onload=()=>M(F),F.onerror=()=>M(null),F.src=S}),C=(S,M,F,P,A,k)=>{if(S.save(),S.fillStyle="#FFFFFF",S.fillRect(F,P,A,k),M){S.beginPath(),S.rect(F,P,A,k),S.clip();const B=M.naturalWidth/M.naturalHeight,D=A/k;let _,L,O,I;B>D?(O=A,I=A/B,_=F,L=P+(k-I)/2):(I=k,O=k*B,L=P,_=F+(A-O)/2),S.drawImage(M,_,L,O,I)}S.restore()},T=[];for(let S=0;S<r.length;S+=p)T.push(r.slice(S,S+p));const $=new d({orientation:"portrait",unit:"px",format:[m,g]});let z=!0;for(let S=0;S<T.length;S++){o&&(o.textContent=`✏️ Página ${S+1} de ${T.length}...`);const M=T[S],F=document.createElement("canvas");F.width=m,F.height=g;const P=F.getContext("2d");P.fillStyle="#FAFAF8",P.fillRect(0,0,m,g),P.fillStyle="#C8967A",P.fillRect(u,36,m-u*2,1),P.fillStyle="#2A1A0E",P.font="300 20px sans-serif",P.textAlign="center",P.letterSpacing="8px",P.fillText("ZAPATILLAS MAY",m/2,32),P.letterSpacing="3px",P.font="400 13px sans-serif",P.fillStyle="#A07860",P.fillText(t.replace(/^[^\s]+\s/,"").toUpperCase(),m/2,54),P.letterSpacing="0px",P.fillStyle="#C8967A",P.fillRect(u,62,m-u*2,1);for(let k=0;k<M.length;k++){const B=M[k],D=k%l,_=Math.floor(k/l),L=u+D*(h+v),O=f+_*(x+v),I=x-E,q=s.filter(N=>N.producto_id===B.id&&N.activa!==!1),j=q.length>0&&q[0].foto_url?q[0].foto_url:B.imagen_principal,H=await w(j);C(P,H,L,O,h,I),P.fillStyle="#E8DDD5",P.fillRect(L,O+I,h,1),P.fillStyle="#2A1A0E",P.textAlign="center",P.font="600 18px sans-serif";const R=B.nombre.length>28?B.nombre.substring(0,26)+"…":B.nombre;P.fillText(R.toUpperCase(),L+h/2,O+I+26),B.precio_menudeo&&(P.fillStyle="#C8967A",P.font="400 15px sans-serif",P.fillText(`$${Number(B.precio_menudeo).toFixed(0)} MXN`,L+h/2,O+I+48))}P.fillStyle="#C8967A",P.fillRect(u,g-y,m-u*2,1),P.fillStyle="#A07860",P.textAlign="center",P.font="300 16px sans-serif",P.letterSpacing="3px",P.fillText("@ZAPATILLASMAY",m/2,g-50),P.letterSpacing="0px",P.fillStyle="#C0A898",P.font="300 13px sans-serif",P.fillText("zapatillasmay.mx  ·  León, Guanajuato",m/2,g-28);const A=F.toDataURL("image/jpeg",.88);z||$.addPage(),$.addImage(A,"JPEG",0,0,m,g),z=!1}const G=`catalogo-${e}-zapatillasmay.pdf`;$.save(G),o&&(o.textContent=`✅ Descargado: ${G}`,setTimeout(()=>{o.style.display="none"},4e3))}catch(n){console.error(n),o&&(o.textContent="Error generando el PDF: "+n.message)}finally{a.forEach(n=>n.disabled=!1)}};window.subirPaginasCatalogo=async function(e,t){const o=Array.from(e.files||e);if(!o.length)return;const a=document.getElementById("upload-progress"),n=document.getElementById("upload-msg"),i=document.getElementById("upload-bar");a&&(a.style.display="block");const{paginas:r}=window._catalogoPaginasData;let s=r.length>0?Math.max(...r.map(d=>d.pagina_numero))+1:1;for(let d=0;d<o.length;d++){n&&(n.textContent=`Subiendo ${d+1} de ${o.length}...`),i&&(i.style.width=d/o.length*100+"%");try{const l=new FormData;l.append("archivo",o[d]);const p=await(await fetch(b+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:l})).json();p.url&&await fetch(b+"/catalogos/"+t+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:p.url,pagina_numero:s++})})}catch(l){console.error("Error subiendo página "+(d+1),l)}}i&&(i.style.width="100%"),n&&(n.textContent="✅ Listo"),setTimeout(()=>{a&&(a.style.display="none")},1500),e.value!==void 0&&(e.value=""),await gestionarPaginas(t,window._catalogoPaginasData.nombre)};window.moverPagina=async function(e,t){const{paginas:o,catalogoId:a,nombre:n}=window._catalogoPaginasData,i=o.findIndex(l=>l.id===e);if(i===-1)return;const r=t==="up"?i-1:i+1;if(r<0||r>=o.length)return;const s=o[i].pagina_numero,d=o[r].pagina_numero;await Promise.all([fetch(b+"/catalogos/paginas/"+o[i].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:d})}),fetch(b+"/catalogos/paginas/"+o[r].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:s})})]),await gestionarPaginas(a,n)};window.eliminarPagina=async function(e,t){confirm("¿Eliminar esta página?")&&(await fetch(b+"/catalogos/paginas/"+e,{method:"DELETE"}),await gestionarPaginas(t,window._catalogoPaginasData.nombre))};window.usarComoPortada=async function(e,t){await fetch(b+"/catalogos/"+t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({portada_url:e})}),alert("✅ Portada actualizada")};window.mlVerStock=async function(e){const t=e.innerHTML;e.innerHTML="⏳ Consultando...",e.disabled=!0;const o=document.getElementById("ml-resultado");try{const n=await(await fetch(b+"/ml/stock")).json();if(o.style.display="block",n.diferencias&&n.diferencias.length>0){const i=n.diferencias.map(r=>`${r.item_id} | SKU: ${r.seller_sku} | ML: ${r.qty_ml} | ERP: ${r.qty_erp}`).join(`
...
`):"")}}catch(r){o.style.display="block",o.textContent="Error: "+r.message}e.innerHTML=t,e.disabled=!1};async function Xe(e,t){var r,s,d,l,c,p;const o=document.getElementById("ml-pub-sku").value.trim(),a=document.getElementById("ml-pub-listing").value,n=document.getElementById("ml-pub-resultado"),i=t.innerHTML;if(!o){alert("Ingresa el SKU del producto (ej: M-SAN-0148)");return}t.innerHTML=e?"⏳ Generando preview...":"⏳ Publicando en ML...",t.disabled=!0,n.style.display="none";try{const m=await fetch(b+"/ml/publicar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sku_interno:o.toUpperCase().trim(),listing_type:a,solo_preview:e})}),g=await m.json();if(n.style.display="block",!m.ok){n.textContent="❌ Error: "+(g.detail||JSON.stringify(g));return}if(e){const u=(r=g.resultados)==null?void 0:r[0];if(!u){n.textContent="Sin resultados";return}const v=u.preview;let f=`=== PREVIEW — ${g.producto} (${g.total} variantes) ===
...
`,f+=`Título:      ${v.title}
`,f+=`Precio:      $${v.price} MXN
`,f+=`Stock:       ${v.available_quantity}
`,f+=`Imágenes:    ${((s=v.pictures)==null?void 0:s.length)||0}
`,f+=`Descripción: ${(l=(d=v.description)==null?void 0:d.plain_text)==null?void 0:l.substring(0,120)}...

`,f+=`Atributos:
`+(v.attributes||[]).map(y=>`  ${y.id}: ${y.value_name}`).join(`
`),f+=`

... y ${g.total-1} variantes más con la misma estructura.`,n.textContent=f}else{const u=((c=g.resultados)==null?void 0:c.filter(y=>y.status==="publicado"))||[],v=((p=g.resultados)==null?void 0:p.filter(y=>y.status==="error"))||[];let f=`=== RESULTADO — ${g.producto} ===
`;f+=`✅ Publicados: ${u.length}   ❌ Errores: ${v.length}

`,u.length&&(f+=`PUBLICADOS:
`,u.forEach(y=>{f+=`  ${y.sku} → ${y.item_id}
  ${y.permalink||""}
`})),v.length&&(f+=`
ERRORES:
`,v.forEach(y=>{var h;f+=`  ${y.sku}  [${y.codigo}] ${y.error}
`,(h=y.causas)!=null&&h.length&&y.causas.forEach(x=>{f+=`    ↳ ${x.code}: ${x.message}
`})})),n.textContent=f}}catch(m){n.style.display="block",n.textContent="Error inesperado: "+m.message}finally{t.innerHTML=i,t.disabled=!1}}window.mlPublicarPreview=function(e){Xe(!0,e)};window.mlPublicarReal=function(e){confirm("¿Publicar TODAS las variantes activas de este producto en MercadoLibre? Esto creará nuevos items en tu cuenta.")&&Xe(!1,e)};window.descargarExcelTikTok=async function(e,t,o){const a=e.innerHTML;try{e.innerHTML="⏳ Generando...",e.disabled=!0;const n=await fetch(`${b}/tiktok/${t}`);if(!n.ok){const d=await n.text();throw new Error(`Error ${n.status}: ${d}`)}const i=await n.blob(),r=URL.createObjectURL(i),s=document.createElement("a");s.href=r,s.download=o,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(r)}catch(n){alert("Error al descargar el archivo: "+n.message)}finally{e.innerHTML=a,e.disabled=!1}};async function gt(){const e=document.getElementById("content");e.innerHTML=`
  ...
  `,document.getElementById("ml-titulo").addEventListener("input",function(){document.getElementById("ml-titulo-count").textContent=this.value.length});let t=[];fetch(`${b}/productos/?select=id,sku_interno,nombre,activo`).then(r=>r.json()).then(r=>{t=(Array.isArray(r)?r:[]).filter(s=>s.activo!==!1)}).catch(()=>{});const o=document.getElementById("ml-sku"),a=document.getElementById("ml-sku-sug"),n=r=>{if(r=(r||"").toLowerCase().trim(),!r||!t.length){a.style.display="none";return}const s=t.filter(d=>(d.nombre||"").toLowerCase().includes(r)||(d.sku_interno||"").toLowerCase().includes(r)).slice(0,12);if(!s.length){a.style.display="none";return}a.innerHTML=s.map(d=>`
      <div onclick="window._mlElegirSku('${(d.sku_interno||"").replace(/'/g,"\\'")}')"
        ...
        <span style="color:#888;font-size:0.75rem;margin-left:6px">${d.sku_interno||""}</span>
      </div>`).join(""),a.style.display="block"};window._mlElegirSku=r=>{o.value=r,a.style.display="none"},o.addEventListener("input",()=>n(o.value)),o.addEventListener("focus",()=>n(o.value)),document.addEventListener("click",r=>{a&&!a.contains(r.target)&&r.target!==o&&(a.style.display="none")}),window._mlResolverSku=r=>{const s=(r||"").trim();if(!s||!t.length)return s.toUpperCase();const d=t.find(c=>(c.sku_interno||"").toUpperCase()===s.toUpperCase());if(d)return d.sku_interno.toUpperCase();const l=t.filter(c=>(c.nombre||"").toLowerCase().includes(s.toLowerCase()));return l.length===1?l[0].sku_interno.toUpperCase():l.length>1?"__AMBIGUO__":s.toUpperCase()},window.mlGenerarPreview=async()=>{var g,u,v,f;const r=document.getElementById("ml-sku").value.trim(),s=document.getElementById("ml-listing").value,d=document.getElementById("ml-titulo").value.trim(),l=document.getElementById("ml-precio").value.trim(),c=l?parseFloat(l):null;if(!r){alert("Ingresa el SKU o modelo del producto");return}const p=window._mlResolverSku(r);if(p==="__AMBIGUO__"){alert('Hay varios productos que coinciden con "'+r+'". Elige uno de la lista que aparece al escribir.');return}if(!d){alert("Ingresa el título para ML");return}if(d.length>60){alert("El título no puede superar 60 caracteres");return}if(c!==null&&(isNaN(c)||c<=0)){alert("El precio debe ser mayor a 0");return}const m=document.getElementById("ml-btn-preview");m.textContent="⏳ Generando...",m.disabled=!0;try{const y=await fetch(`${b}/ml/publicar`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sku_interno:p,listing_type:s,solo_preview:!0})}),h=await y.json();if(!y.ok){alert("Error: "+(h.detail||JSON.stringify(h)));return}const x=h.resultados||[];if(!x.length){alert("No se encontraron variantes activas");return}const E=document.getElementById("ml-descripcion"),w=((v=(u=(g=x[0])==null?void 0:g.preview)==null?void 0:u.description)==null?void 0:v.plain_text)||"";E.value.trim()||(E.value=w);const C={},T=[],$=new Set;for(const A of x){const k=A.color||"Sin color";C[k]||(C[k]=[]);for(const B of((f=A.preview)==null?void 0:f.pictures)||[])B.source&&(C[k].find(D=>D.source===B.source)||C[k].push(B),$.has(B.source)||($.add(B.source),T.push(B)))}const z={},G=new Set,S=new Set;for(const A of Object.keys(C))z[A]=0,G.add(A);const M=Object.keys(C);if(M.length>0){const A=document.getElementById("ml-fotos-wrap"),k=document.getElementById("ml-fotos-grid"),B=()=>{D();const _=x.filter(L=>G.has(L.color||"Sin color"));i(_,d,c,z,E.value.trim(),C,S)},D=()=>{k.innerHTML=M.map(_=>{const L=C[_];if(!L.length)return"";const O=G.has(_),I=_.replace(/'/g,"\\'"),q=_.replace(/[^a-zA-Z0-9]/g,"_");return`
              <div style="margin-bottom:1rem;width:100%;opacity:${O?1:.4}">
                <label style="display:flex;align-items:center;gap:8px;cursor:pointer;margin-bottom:6px">
                  ...
                  <span style="font-size:0.72rem;color:#888">(${x.filter(j=>(j.color||"Sin color")===_).length} tallas)</span>
                </label>
                <div style="display:flex;gap:8px;flex-wrap:wrap;padding-left:24px">
                  ${L.map((j,H)=>{const R=S.has(j.source),N=H===z[_]&&O&&!R;return`
              ...
              </div>`}).join("")};D(),A.style.display="block",window.mlToggleColor=_=>{G.has(_)?G.delete(_):G.add(_),B()},window.mlSeleccionarPortadaColor=(_,L)=>{z[_]=L,B()},window.mlToggleFoto=(_,L,O)=>{if(S.has(O))S.delete(O);else{S.add(O);const I=C[_]||[];if(I[z[_]]&&I[z[_]].source===O){const q=I.findIndex(j=>!S.has(j.source));z[_]=q>=0?q:0}}B()}}const F=x.filter(A=>G.has(A.color||"Sin color"));i(F,d,c,z,E.value.trim(),C);const P=document.getElementById("ml-variantes-wrap");P.style.display="block",P.scrollIntoView({behavior:"smooth",block:"start"})}catch(y){alert("Error de conexión: "+y.message)}finally{m.textContent="🔍 Generar preview",m.disabled=!1}};function i(r,s,d,l,c,p,m){m=m||new Set;const g=document.getElementById("ml-variantes-titulo"),u=document.getElementById("ml-variantes-list");g.textContent=`Paso 2 — Revisa y edita (${r.length} variantes, título aplicado a todas)`,u.innerHTML=r.map((v,f)=>{const y={...v.preview};if(delete y.title,y.family_name=s,d!==null&&(y.price=d),c&&(y.description={plain_text:c}),p){const h=v.color||"Sin color",x=p[h]||[],E=l&&l[h]||0,w=x[E]?x[E].source:null;let C=x.filter(T=>!m.has(T.source));if(w){const T=C.findIndex($=>$.source===w);if(T>0){const[$]=C.splice(T,1);C.unshift($)}}if(C.length<3){for(const[T,$]of Object.entries(p))if(T!==h){for(const z of $)if(!m.has(z.source)&&(C.find(G=>G.source===z.source)||C.push(z),C.length>=12))break;if(C.length>=12)break}}y.pictures=C.slice(0,12)}return`
        <details style="margin-bottom:0.5rem;border:1px solid #e0e0e0;border-radius:8px;overflow:hidden">
          <summary style="padding:0.5rem 1rem;cursor:pointer;background:#f8f8f8;font-size:0.85rem;font-weight:600;list-style:none;display:flex;justify-content:space-between">
            <span>${v.sku||"Variante "+(f+1)} &nbsp;·&nbsp; ${v.color||""} ${v.talla||""}</span>
        ...
        </tr>`).join(""),u=p.filter(y=>y.status==="active").length,v=p.filter(y=>y.status==="paused").length,f=c.sin_sku||0;s.innerHTML=`
        <div style="display:flex;gap:1.5rem;margin-bottom:0.75rem;flex-wrap:wrap">
          ...
          <span style="font-size:0.82rem;color:#e67e22">Pausadas: <b>${v}</b></span>
      ...
      `).join("")||'<p style="color:#888">Sin detalles</p>'}catch(g){p.textContent="❌ Error de conexión",m.innerHTML=`<p style="color:red">${g.message}</p>`}finally{l.textContent="🚀 Publicar todas en ML",l.disabled=!1}}}let K=[],ae="";async function ft(){const e=document.getElementById("content");e.innerHTML=`
    <style>
  ...
  `,await yt(),oe=setInterval(async()=>{document.getElementById("ga-activos")?await Je():(clearInterval(oe),oe=null)},3e4)}async function we(e,t=8e3){const o=new AbortController,a=setTimeout(()=>o.abort(),t);try{const n=await fetch(e,{signal:o.signal});return clearTimeout(a),n}catch(n){throw clearTimeout(a),n.name==="AbortError"?new Error("timeout"):n}}async function yt(){const e=[Je().catch(()=>ue("ga-activos","—")),vt().catch(()=>ue("ga-sesiones","—")),ht().catch(()=>ue("ga-chart",null))];await Promise.allSettled(e);const t=document.getElementById("ga-ultima-act");t&&(t.textContent="Actualizado: "+new Date().toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit",second:"2-digit"}))}function ue(e,t){const o=document.getElementById(e);o&&t!==null&&(o.textContent=t)}async function Je(){var e;try{const o=await(await we(`${b}/analytics/tiempo-real`)).json();if(!o.configurado){xt(o);return}const a=document.getElementById("ga-activos");if(!a)return;a.textContent=o.activos_ahora??0;const n=document.getElementById("ga-dispositivos");n&&o.por_dispositivo&&(n.textContent=Object.entries(o.por_dispositivo).map(([r,s])=>`${r}: ${s}`).join(" · "));const i=document.getElementById("ga-paginas-rt");i&&((e=o.por_pais)!=null&&e.length)?i.innerHTML='<div style="font-size:0.65rem;color:#aaa;margin-bottom:4px;text-transform:uppercase;letter-spacing:.05em">Por país</div>'+o.por_pais.map(r=>`
          ...
          </div>`).join(""):r.innerHTML='<p style="color:#bbb;font-size:0.82rem;margin:0">Sin datos de páginas aún</p>')}catch(t){console.warn("GA hoy:",t.message)}}async function ht(){var e;try{const o=await(await we(`${b}/analytics/semana`)).json();if(!o.configurado||!((e=o.dias)!=null&&e.length))return;const a=document.getElementById("ga-chart");if(!a||!window.Chart)return;a._chartInstance&&a._chartInstance.destroy(),a._chartInstance=new Chart(a,{type:"bar",data:{labels:o.dias.map(n=>n.fecha),datasets:[{label:"Sesiones",data:o.dias.map(n=>n.sesiones),backgroundColor:"rgba(52,131,250,0.7)",borderRadius:4},{label:"Usuarios",data:o.dias.map(n=>n.usuarios),backgroundColor:"rgba(34,197,94,0.5)",borderRadius:4}]},options:{responsive:!0,plugins:{legend:{position:"top"}},scales:{y:{beginAtZero:!0,ticks:{precision:0}}}}})}catch(t){console.warn("GA semana:",t.message)}}function xt(e){const t=document.getElementById("ga-setup"),o=document.getElementById("ga-setup-body");!t||!o||(t.style.display="block",o.innerHTML=`
    ...
    `}catch(t){e.innerHTML=`<p style="padding:2rem;color:red">Error cargando referidos: ${t.message}</p>`}}function wt(e,t){const o=parseFloat(e.credito_disponible||0),a=e.referido_por?t[e.referido_por]||e.referido_por:"—",n=o>0?"#2e7d32":"#aaa";return`<tr id="ref-row-${e.id}" style="border-bottom:1px solid #f5f5f5">
...
Nuevo monto:`,o);if(a===null)return;const n=parseFloat(a);if(isNaN(n)||n<0)return alert("Monto inválido");try{(await fetch(b+"/clientes/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({credito_disponible:n})})).ok?await $e():alert("Error actualizando crédito")}catch(i){alert("Error: "+i.message)}};async function Ee(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando carritos...</p>';try{const[t,o,a]=await Promise.all([fetch(b+"/pedidos/?status=borrador").then(i=>i.json()).catch(()=>[]),fetch(b+"/clientes/").then(i=>i.json()),fetch(b+"/sucursales/").then(i=>i.json())]),n=Array.isArray(t)?t.filter(i=>i.status==="borrador"&&(!i.canal||i.canal==="sucursal"||i.canal==="mayoreo")):[];e.innerHTML=`
  ...
  `};window.crearNuevoCarrito=async()=>{var a;const e=document.getElementById("nc-cliente").value,t=document.getElementById("nc-sucursal").value,o=document.getElementById("nc-comentario").value;if(!e){alert("Selecciona un cliente");return}try{const i=await(await fetch(b+"/pedidos/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cliente_id:e,sucursal_id:t,canal:"sucursal",forma_pago:"efectivo",status:"borrador",total:0,subtotal:0,comentarios:o||null,items:[]})})).json(),r=i.id||((a=i[0])==null?void 0:a.id);if(!r){alert("Error creando carrito");return}abrirCarrito(r)}catch(n){alert("Error: "+n.message)}};window.abrirCarrito=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando carrito...</p>';try{const[o,a,n,i,r]=await Promise.all([fetch(b+"/pedidos/"+e).then(l=>l.json()),fetch(b+"/pedidos/"+e+"/items").then(l=>l.json()),fetch(b+"/variantes/?activa=eq.true").then(l=>l.json()),fetch(b+"/productos/").then(l=>l.json()),fetch(b+"/inventario/").then(l=>l.json()).catch(()=>[])]),s=Array.isArray(o)?o[0]:o,d=s.clientes||{};window._carritoActivo={pedidoId:e,items:Array.isArray(a)?a:[],variantes:n,productos:i,inventario:r,sucursalId:s.sucursal_id},We(s)}catch{t.innerHTML='<p style="padding:2rem;color:red">Error cargando carrito</p>'}};function We(e){const t=document.getElementById("content"),{pedidoId:o,items:a,variantes:n,productos:i,inventario:r,sucursalId:s}=window._carritoActivo,d=e.clientes||{},l=a.reduce((m,g)=>m+g.cantidad*g.precio_unitario,0),c=a.reduce((m,g)=>m+g.cantidad,0),p=e.created_at?Math.floor((Date.now()-new Date(e.created_at).getTime())/864e5):0;t.innerHTML=`
    <div style="max-width:860px">
      ...
      <div class="table-card" style="padding:1.2rem">
        ...
        <div id="carrito-items-lista">
          ...
          ${(()=>{const m={};return a.forEach((g,u)=>{const v=g.variantes||{},f=v.productos||{},y=f.nombre||g.nombre||"—",h=v.color||g.color||"",x=!!g.es_corrida,E=x?"c|"+y+"|"+h:"s|"+g.id;m[E]||(m[E]={nombre:y,color:h,esCorrida:x,items:[],imagen:v.foto_url||f.imagen_principal||null}),m[E].items.push({...g,_idx:u})}),Object.values(m).map(g=>{const u=g.esCorrida,v=g.imagen;if(u){const f=g.items.reduce((E,w)=>E+w.cantidad,0),y=g.items.reduce((E,w)=>E+w.cantidad*w.precio_unitario,0),h=(y/f).toFixed(2),x=g.items.map(E=>E.id).join(",");return`
                  <div style="background:#fdf4ff;border-radius:8px;padding:12px;margin-bottom:8px;border:1px solid #e8d5f5">
                    <div style="display:flex;align-items:start;gap:10px;margin-bottom:8px">
                      ${v?`<img src="${v}" style="width:52px;height:52px;object-fit:cover;border-radius:8px;flex-shrink:0">`:'<div style="width:52px;height:52px;background:#f3e5f5;border-radius:8px;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:1.3rem">👠</div>'}
                      <div style="flex:1">
                      ...
                      <button onclick="eliminarCorridaCarrito('${x}')" style="background:none;border:none;color:#c62828;cursor:pointer;font-size:1.1rem;padding:4px">🗑</button>
                    </div>
                    <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
                      <span id="corrida-header-${x.replace(/,/g,"_").substring(0,20)}" style="font-size:0.85rem;color:#888">${f} pares · <strong style="color:#6a1b9a">$${y.toFixed(2)}</strong></span>
                      <div style="display:flex;align-items:center;gap:4px">
                        <span style="font-size:0.72rem;color:#888">$</span>
                        <input type="number" value="${h}"
                          onchange="actualizarPrecioCorridaCarrito('${x}', this.value)"
                    ...
                    <div id="corrida-detalle-${x.replace(/,/g,"_").substring(0,20)}" style="display:none;margin-top:10px;border-top:1px solid #e8d5f5;padding-top:10px">
                      ${g.items.map(E=>{const C=(E.variantes||{}).talla||E.talla||"?",T=r.find(z=>z.variante_id===E.variante_id&&(s?z.sucursal_id===s:!0)),$=T?T.cantidad:999;return`
                          <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px"
                    ...
                    <button onclick="toggleCorridaDetalle('${x.replace(/,/g,"_").substring(0,20)}')"
                  ...
                  </div>`}else{const f=g.items[0],y=f.variantes||{};y.productos;const h=y.talla||f.talla||"",x=r.find(w=>w.variante_id===f.variante_id&&(s?w.sucursal_id===s:!0)),E=x?x.cantidad:null;return`
                  <div style="display:flex;align-items:center;gap:10px;padding:10px;background:#f9f9f9;border-radius:8px;margin-bottom:8px;border:1px solid #eee;flex-wrap:wrap">
                    ${v?`<img src="${v}" style="width:52px;height:52px;object-fit:cover;border-radius:8px;flex-shrink:0">`:'<div style="width:52px;height:52px;background:#eee;border-radius:8px;flex-shrink:0;display:flex;align-items:center;justify-content:center">👟</div>'}
                    <div style="flex:1;min-width:120px">
  ...
  `).join("")};window.seleccionarModeloCorrida=(e,t)=>{const{variantes:o,productos:a,inventario:n,sucursalId:i}=window._carritoActivo,r=a.find(m=>m.id===e);document.getElementById("c-buscar-corrida").value=`${(r==null?void 0:r.nombre)||""} · ${t}`,document.getElementById("c-corrida-resultados").style.display="none";const s=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=o.filter(m=>m.producto_id===e&&m.color===t).sort((m,g)=>s.indexOf(m.talla)-s.indexOf(g.talla)),l=parseFloat(r==null?void 0:r.precio_menudeo)||0,c=parseFloat(r==null?void 0:r.precio_corrida)||(l>0?Math.round(l-100):0);document.getElementById("c-precio-corrida").value=c||"",window._corridaSeleccionada={productoId:e,color:t,variantes:d,prod:r,precioCorrida:c};const p=document.getElementById("c-corrida-tallas-grid");p.innerHTML=d.map(m=>{const g=n.find(w=>w.variante_id===m.id&&(i?w.sucursal_id===i:!0)),u=g?g.cantidad:null,v=u!==null&&u===0,f=v?0:1,y=`c-card-${m.id}`,h=`c-qty-${m.id}`,x=f>0?"#fdf2f8":"#ffffff",E=f>0?"#E91E8C":"#e2e8f0";return`
      <div id="${y}" class="size-card" style="display:flex;flex-direction:column;align-items:center;gap:6px;padding:10px 12px;border:2px solid ${v?"#fecaca":E};border-radius:12px;background:${v?"#fef2f2":x};min-width:70px;transition:all 0.2s ease;position:relative;opacity:${v?.6:1}">
        <span style="font-weight:800;font-size:0.9rem;color:#0f172a">T${m.talla}</span>
        <div style="display:flex;align-items:center;gap:4px">
          <button type="button" onclick="const inp=document.getElementById('${h}');inp.value=Math.max(0,parseInt(inp.value||0)-1);inp.dispatchEvent(new Event('input'))"
            style="background:#f1f5f9;color:#475569;border:none;border-radius:6px;width:24px;height:24px;cursor:pointer;font-size:1rem;font-weight:700;display:flex;align-items:center;justify-content:center;transition:background 0.2s"
            onmouseenter="this.style.background='#e2e8f0'" onmouseleave="this.style.background='#f1f5f9'" ${v?"disabled":""}>−</button>
          
          <input type="number" value="${f}" min="0" max="${u!==null?u:999}" id="${h}" data-variante="${m.id}"
            style="width:36px;height:24px;text-align:center;border:1px solid #cbd5e1;border-radius:6px;font-size:0.85rem;font-weight:700;color:#0f172a;outline:none"
            oninput="const val=Math.min(parseInt(this.max)||999,Math.max(0,parseInt(this.value)||0));this.value=val;const card=document.getElementById('${y}');if(val>0){card.style.borderColor='#E91E8C';card.style.background='#fdf2f8'}else{card.style.borderColor='#e2e8f0';card.style.background='#ffffff'}"
            ${v?"disabled":""}>
          
          <button type="button" onclick="const inp=document.getElementById('${h}');const max=parseInt(inp.max||999);const cur=parseInt(inp.value||0);if(cur<max){inp.value=cur+1;inp.dispatchEvent(new Event('input'))}else{inp.style.borderColor='#ef4444';setTimeout(()=>inp.style.borderColor='#cbd5e1',800)}"
            style="background:#f1f5f9;color:#475569;border:none;border-radius:6px;width:24px;height:24px;cursor:pointer;font-size:1rem;font-weight:700;display:flex;align-items:center;justify-content:center;transition:background 0.2s"
            onmouseenter="this.style.background='#e2e8f0'" onmouseleave="this.style.background='#f1f5f9'" ${v?"disabled":""}>+</button>
        </div>
