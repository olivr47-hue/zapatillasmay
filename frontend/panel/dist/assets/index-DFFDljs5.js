(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(n){if(n.ep)return;n.ep=!0;const r=a(n);fetch(n.href,r)}})();const f="/api",ge=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],Se=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],Ie=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],Y=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"},{id:"catalogos",icon:"📖",label:"Catálogos",section:"Catalogo",soloAdmin:!0}];var ue;let Z=((ue=window._empleadoActual)==null?void 0:ue.rol)==="admin"?"dashboard":"pos",de=1;function fe(){var a,o;const e=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),t=((a=window._empleadoActual)==null?void 0:a.rol)==="admin"?"dashboard":"pos";Z=e||t,document.querySelector("#app").innerHTML=`
    ...
    <div class="main">
      <div class="topbar">
        <div style="display:flex;align-items:center;gap:1rem">
          ...
          <h1 id="topbar-title">${((o=Y.find(n=>n.id===Z))==null?void 0:o.label)||"Dashboard"}</h1>
        </div>
  ...
  `,window.toggleSidebar=()=>{const n=document.getElementById("sidebar"),r=document.getElementById("sidebar-overlay"),i=n.classList.toggle("open");r.classList.toggle("active",i),document.body.style.overflow=i?"hidden":""},window._conversacionesInterval&&clearInterval(window._conversacionesInterval),window._conversacionesInterval=setInterval(async()=>{try{const r=await(await fetch(f+"/chatbot/chats")).json();window._chatsData||(window._chatsData={});const i=window._totalNoLeidos||0,s=r.reduce((d,l)=>d+(l.no_leidos||0),0);if(window._totalNoLeidos=s,r.forEach(d=>{window._chatsData&&(window._chatsData[d.telefono]=d)}),fetch(f+"/health").catch(()=>{}),s>i){document.title=`(${s}) Zapatillas May`;const d=document.querySelector('[data-modulo="conversaciones"]');if(d){let l=d.querySelector(".nav-badge");l||(l=document.createElement("span"),l.className="nav-badge",l.style.cssText="background:#e91e8c;color:white;border-radius:100px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:auto",d.appendChild(l)),l.textContent=s}try{const l=new(window.AudioContext||window.webkitAudioContext),c=l.createOscillator(),p=l.createGain();c.connect(p),p.connect(l.destination),c.frequency.value=523,p.gain.setValueAtTime(.5,l.currentTime),p.gain.exponentialRampToValueAtTime(.001,l.currentTime+.2),c.start(l.currentTime),c.stop(l.currentTime+.2);const m=l.createOscillator(),u=l.createGain();m.connect(u),u.connect(l.destination),m.frequency.value=783,u.gain.setValueAtTime(.5,l.currentTime+.2),u.gain.exponentialRampToValueAtTime(.001,l.currentTime+.5),m.start(l.currentTime+.2),m.stop(l.currentTime+.5)}catch{}}if(window._chatActivo&&window._chatsData[window._chatActivo]){const d=window._chatsData[window._chatActivo],l=document.getElementById("mensajes-area");if(l){const c=l.scrollHeight-l.scrollTop<=l.clientHeight+50;l.innerHTML=[...d.mensajes].reverse().map(p=>{const m=p.tipo==="manual"||p.tipo==="imagen_saliente";return`
              ...
              </div>`}).join(""),c&&(l.scrollTop=l.scrollHeight)}}}catch{}},5e3),window.navegarA=n=>{var l;const r=((l=window._empleadoActual)==null?void 0:l.rol)==="admin",i=Y.find(c=>c.id===n);if(i!=null&&i.soloAdmin&&!r){alert("No tienes permisos para acceder a este módulo");return}Z=n;try{localStorage.setItem("zm_panel_modulo",n)}catch{}const s=document.getElementById("sidebar"),d=document.getElementById("sidebar-overlay");s.classList.contains("open")&&(s.classList.remove("open"),d.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(c=>c.classList.remove("active")),document.querySelector('[data-modulo="'+n+'"]').classList.add("active"),document.getElementById("topbar-title").textContent=Y.find(c=>c.id===n).label,be(n)}}function Te(){var a;const e=((a=window._empleadoActual)==null?void 0:a.rol)==="admin";return[...new Set(Y.filter(o=>e||!o.soloAdmin).map(o=>o.section))].map(o=>`
    <div class="nav-section">${o}</div>
    ${Y.filter(n=>n.section===o&&(e||!n.soloAdmin)).map(n=>`
      <div class="nav-item ${n.id===Z?"active":""}"
           data-modulo="${n.id}"
    ...
    `).join("")}
  `).join("")}async function be(e){const t=document.getElementById("content");switch(t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>',e){case"catalogos":await le();break;case"dashboard":t.innerHTML=Be(),setTimeout(()=>Fe(),100);break;case"productos":await ie();break;case"clientes":await Ae();break;case"pedidos":await we();break;case"sucursales":await Me();break;case"inventario":await Oe();break;case"pos":await $e();break;case"historial":await Ee();break;case"empleados":await _e();break;case"seo":await He();break;case"analisis":await Pe();break;case"crm":await ve();break;case"finanzas":await ee();break;case"proveedores":await ye();break;case"ordenes":await Q();break;case"conversaciones":await cargarConversaciones();break;case"envios":await cargarEnviosMasivos();break}}function je(){return setTimeout(()=>{document.querySelectorAll(".nav-item").forEach(o=>o.classList.remove("active"));const e=document.querySelector('[data-modulo="'+Z+'"]');e&&e.classList.add("active");const t=document.getElementById("topbar-title"),a=Y.find(o=>o.id===Z);t&&a&&(t.textContent=a.label),be(Z)},100),'<div style="padding:2rem;color:#888;text-align:center">Cargando...</div>'}async function Q(){var t;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando sugerencias...</p>';try{const o=await(await fetch(f+"/sucursales/")).json(),n=(t=o[0])==null?void 0:t.id,[r,i]=await Promise.all([fetch(f+"/finanzas/sugerencias-recompra/"+n),fetch(f+"/finanzas/proveedores")]),s=await r.json(),d=await i.json(),l=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),c=new Date().toISOString().split("T")[0],p=s.filter(b=>{const x=l[b.producto_id];return x?x.hasta===null||x.hasta===void 0?!1:x.hasta<=c:!0}),m=s.length-p.length;window._ordenesData={sugerencias:p,proveedores:d,sucursalId:n},window._ordenSeleccion={};const u=p.filter(b=>b.urgente),g=p.filter(b=>!b.urgente),y=p.reduce((b,x)=>b+x.cantidad_sugerida*x.costo_unitario,0);e.innerHTML=`
              ...
              <div class="orden-item" data-urgente="${b.urgente}" style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
                ...
                <div style="flex:1;min-width:140px">
                  ...
                  <div style="margin-top:6px;display:flex;flex-wrap:wrap;gap:4px">
                    ${b.variantes.map(x=>{const v=[x.talla,x.color].filter(Boolean).join(" / "),w=x.sin_stock;return`<span style="
                      ...
                      " title="${w?"Sin stock":"Stock: "+x.stock}">${v}${w?" ✗":""}</span>`}).join("")}
                  </div>`:""}
                </div>
...
¿Quieres reactivar todos?`)&&(localStorage.removeItem("ordenes_pospuestos"),Q())};window.guardarOrdenCompra2=async()=>{var r,i,s,d;const{seleccionados:e,sucursalId:t}=window._ordenModal||{};if(!e)return;const a=(r=document.getElementById("orden-fecha"))==null?void 0:r.value,o=((i=document.getElementById("orden-notas"))==null?void 0:i.value)||"",n={};e.forEach(l=>{var u,g;const c=l.proveedor_id||"sin-proveedor",p=((u=l.proveedor)==null?void 0:u.nombre)||"Sin proveedor";n[c]||(n[c]={nombre:p,items:[]});const m=l.variantes||[];if(m.length===0){const y=parseInt(((g=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:g.value)||l.cantidad_sugerida);n[c].items.push({variante_id:null,cantidad:y,costo_unitario:l.costo_unitario})}else m.forEach(y=>{var v;const b=document.getElementById("chk-var-"+y.id);if(!(b!=null&&b.checked))return;const x=parseInt(((v=document.getElementById("qty-var-"+y.id))==null?void 0:v.value)||0);x<=0||n[c].items.push({variante_id:y.id,cantidad:x,costo_unitario:l.costo_unitario})})});try{for(const[l,c]of Object.entries(n)){if(c.items.length===0)continue;const p=c.items.reduce((y,b)=>y+b.cantidad*b.costo_unitario,0),g=(s=(await(await fetch(f+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:l==="sin-proveedor"?null:l,sucursal_id:t,status:"borrador",total:p,notas:o,fecha_entrega_estimada:a||null})})).json())[0])==null?void 0:s.id;if(g)for(const y of c.items)await fetch(f+"/finanzas/ordenes/"+g+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...y,subtotal:y.cantidad*y.costo_unitario})})}(d=document.getElementById("modal-orden"))==null||d.remove(),alert("Orden de compra guardada"),Q()}catch(l){alert("Error guardando orden: "+l.message)}};function Be(){return`
  ...
  `}async function ee(){var t,a,o,n,r,i;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando finanzas...</p>';try{const d=await(await fetch(f+"/sucursales/")).json(),l=(t=d[0])==null?void 0:t.id,[c,p,m,u,g,y,b]=await Promise.all([fetch(f+"/finanzas/caja/hoy/"+l),fetch(f+"/finanzas/reporte/"+l),fetch(f+"/finanzas/gastos/"+l),fetch(f+"/finanzas/estado-resultados/"+l),fetch(f+"/finanzas/flujo/"+l),fetch(f+"/finanzas/cuentas-por-cobrar"),fetch(f+"/finanzas/gastos-categorias/"+l)]),x=await c.json(),v=await p.json(),w=await m.json(),z=await u.json(),h=await g.json(),k=await y.json(),_=await b.json(),E=x.find(C=>C.status==="abierta"),T=new Date().toISOString().split("T")[0],O=w.filter(C=>{var j;return(j=C.created_at)==null?void 0:j.startsWith(T)}),I=O.reduce((C,j)=>C+parseFloat(j.monto||0),0),S=k.reduce((C,j)=>C+parseFloat(j.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
      ...
      <div style="background:${E?"#e8f5e9":"#ffebee"};border-radius:12px;padding:1.25rem;border:1px solid ${E?"#a5d6a7":"#ffcdd2"};margin-bottom:1.5rem;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
        ...
        ${E?`
          <div style="display:flex;gap:16px;flex-wrap:wrap">
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#2e7d32">$${(((a=h.hoy)==null?void 0:a.efectivo)||0).toFixed(0)}</p>
              <p style="font-size:0.65rem;color:#888">Efectivo</p>
            </div>
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#1565c0">$${(((o=h.hoy)==null?void 0:o.tarjeta)||0).toFixed(0)}</p>
              <p style="font-size:0.65rem;color:#888">Tarjeta</p>
            </div>
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#6a1b9a">$${(((n=h.hoy)==null?void 0:n.spei)||0).toFixed(0)}</p>
              <p style="font-size:0.65rem;color:#888">SPEI</p>
            </div>
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#E91E8C">$${(((r=h.hoy)==null?void 0:r.total)||0).toFixed(0)}</p>
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          <p style="font-size:1.5rem;font-weight:700;color:#333">$${(((i=h.semana)==null?void 0:i.ingresos)||0).toFixed(0)}</p>
    ...
    `,window._finanzasData={sucursalId:l,gastosHoy:O,totalGastosHoy:I,estadoResultados:z,flujo:h,cxc:k,categorias:_,historial:[]},window._finanzasSucursalId=l;const $=await(await fetch(f+"/finanzas/caja/historial/"+l)).json();window._finanzasData.historial=$,mostrarTabFinanzas("gastos")}catch(s){e.innerHTML='<p style="padding:2rem;color:red">Error cargando finanzas: '+s.message+"</p>"}}window.mostrarTabFinanzas=e=>{var c,p,m,u,g,y,b,x,v,w,z,h,k;const{gastosHoy:t,totalGastosHoy:a,estadoResultados:o,flujo:n,cxc:r,categorias:i,historial:s,sucursalId:d}=window._finanzasData,l=document.getElementById("fin-tab-contenido");if(l)if(e==="gastos"){const _=i.reduce((E,T)=>E+T.total,0);l.innerHTML=`
      ...
      <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
        ...
        <div style="padding:1rem 1.5rem;background:#f9f9f9;display:flex;gap:2rem;flex-wrap:wrap">
          <div>
            ...
            <p style="font-weight:700;color:#E91E8C">$${o.reduce((_,E)=>_+E.ventas,0).toFixed(0)}</p>
          </div>
          <div>
            <p style="font-size:0.72rem;color:#888">Total gastos 6 meses</p>
            <p style="font-weight:700;color:#c62828">$${o.reduce((_,E)=>_+E.gastos,0).toFixed(0)}</p>
          </div>
          <div>
            <p style="font-size:0.72rem;color:#888">Utilidad total</p>
            <p style="font-weight:700;color:#2e7d32">$${o.reduce((_,E)=>_+E.utilidad,0).toFixed(0)}</p>
          </div>
        </div>
      </div>
    `:e==="flujo"?l.innerHTML=`
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;margin-bottom:1rem">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            ...
            <span style="font-weight:700;color:${(((x=n.semana)==null?void 0:x.neto)||0)>=0?"#2e7d32":"#c62828"};font-size:1.1rem">$${(((v=n.semana)==null?void 0:v.neto)||0).toFixed(0)}</span>
          </div>
        </div>
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            <span style="font-size:0.85rem;font-weight:700">Neto</span>
            <span style="font-weight:700;color:${(((h=n.mes)==null?void 0:h.neto)||0)>=0?"#2e7d32":"#c62828"};font-size:1.1rem">$${(((k=n.mes)==null?void 0:k.neto)||0).toFixed(0)}</span>
          </div>
        </div>
      </div>
    `:e==="caja"?l.innerHTML=`
...
Diferencia: $${(n=i.diferencia)==null?void 0:n.toFixed(2)}`),ee()):alert("Error: "+JSON.stringify(i))}catch{alert("Error cerrando caja")}};window.agregarGasto=e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",t.innerHTML=`
  ...
  `,document.body.appendChild(a),a.addEventListener("click",o=>{o.target===a&&a.remove()})};window.guardarProveedor=async e=>{const t={nombre:document.getElementById("prov-nombre").value,contacto:document.getElementById("prov-contacto").value,telefono:document.getElementById("prov-telefono").value,email:document.getElementById("prov-email").value,ciudad:document.getElementById("prov-ciudad").value,direccion:document.getElementById("prov-direccion").value,notas:document.getElementById("prov-notas").value};if(!t.nombre){alert("El nombre es requerido");return}try{e?await fetch(f+"/finanzas/proveedores/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):await fetch(f+"/finanzas/proveedores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),document.querySelector('div[style*="position:fixed"]').remove(),ye()}catch{alert("Error guardando proveedor")}};window.editarProveedor=async e=>{const o=(await(await fetch(f+"/finanzas/proveedores")).json()).find(n=>n.id===e);o&&mostrarFormProveedor(o)};async function Pe(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando análisis...</p>';try{const[t,a,o,n]=await Promise.all([fetch(f+"/productos/"),fetch(f+"/variantes/"),fetch(f+"/movimientos/"),fetch(f+"/inventario/")]),r=await t.json(),i=await a.json(),s=await o.json(),d=await n.json(),l=new Date,c=new Date(l-30*24*60*60*1e3),p=new Date(l-60*24*60*60*1e3),m=new Date(l-90*24*60*60*1e3),u={};s.filter(b=>b.tipo==="venta").forEach(b=>{const x=i.find(h=>h.id===b.variante_id);if(!x)return;const v=x.producto_id;u[v]||(u[v]={d30:0,d60:0,d90:0});const w=new Date(b.created_at),z=Math.abs(b.cantidad);w>=c&&(u[v].d30+=z),w>=p&&(u[v].d60+=z),w>=m&&(u[v].d90+=z)});const g=r.map(b=>{const x=u[b.id]||{d30:0,d60:0,d90:0},v=d.filter(_=>i.find(E=>E.id===_.variante_id&&E.producto_id===b.id)).reduce((_,E)=>_+E.cantidad,0),w=x.d30/4,z=w>0?Math.round(v/w*7):null;let h="gris",k="Sin ventas recientes";return x.d30>=6?(h="verde",k="Rota bien — considerar resurtido"):x.d30>=2?(h="amarillo",k="Rotacion moderada"):x.d90===0&&v>0?(h="rojo",k="Sin movimiento en 90 dias — revisar"):x.d30>0&&(h="amarillo",k="Rotacion lenta"),{...b,ventas:x,stockTotal:v,ventasSemana:w,diasInventario:z,semaforo:h,recomendacion:k}}).sort((b,x)=>x.ventas.d30-b.ventas.d30),y={verde:{bg:"#e8f5e9",color:"#2e7d32",texto:"🟢 Rota bien"},amarillo:{bg:"#fff8e1",color:"#f57f17",texto:"🟡 Rotacion lenta"},rojo:{bg:"#ffebee",color:"#c62828",texto:"🔴 Sin movimiento"},gris:{bg:"#f5f5f5",color:"#888",texto:"⚪ Sin datos"}};e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:12px;margin-bottom:2rem">
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#E91E8C">${g.reduce((b,x)=>b+x.ventas.d30,0)}</p>
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#E91E8C">${g.reduce((b,x)=>b+x.ventas.d90,0)}</p>
          <p style="font-size:0.75rem;color:#aaa">pares</p>
        </div>
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
  ...
  <button class="btn btn-secondary" style="padding:4px 10px;font-size:0.75rem;background:#ffebee;border-color:#c62828;color:#c62828" onclick="filtrarRotacion('rojo')">🔴 Sin movimiento</button>
        ...
        <div id="rotacion-lista">
          ${g.map(b=>{const x=y[b.semaforo];return`
              <div class="rotacion-item" data-semaforo="${b.semaforo}" style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
                ...
                <div style="flex:1;min-width:140px">
                  ...
                  <span style="display:inline-block;margin-top:4px;padding:2px 8px;border-radius:100px;font-size:0.68rem;font-weight:600;background:${x.bg};color:${x.color}">${x.texto}</span>
                </div>
    ...
    `,window._rotacionData=g}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando análisis</p>'}}window.filtrarRotacion=e=>{document.querySelectorAll(".rotacion-item").forEach(t=>{t.style.display=e==="todos"||t.dataset.semaforo===e?"":"none"})};async function ve(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando CRM...</p>';try{const[t,a,o]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/"),fetch(f+"/crm/seguimientos/pendientes/todos")]),n=await t.json(),r=await a.json(),i=await o.json(),s=new Date,d=new Date(s-30*24*60*60*1e3),l=new Date(s-60*24*60*60*1e3),c=new Date(s-90*24*60*60*1e3),p=n.map(v=>{const w=r.filter(T=>T.cliente_id===v.id&&(T.status==="confirmado"||T.status==="pagado")),z=w.reduce((T,O)=>T+parseFloat(O.total||0),0),h=w.length>0?new Date(w[0].created_at):null,k=h?Math.floor((s-h)/(1e3*60*60*24)):null,_=w.filter(T=>new Date(T.created_at)>=d).length;let E="nuevo";return w.length===0?E="nuevo":z>=5e3&&_>=1?E="vip":k>90?E="inactivo":k>30?E="riesgo":_>=2?E="frecuente":E="activo",{...v,totalGastado:z,ultimoPedido:h,diasSinComprar:k,pedidos30:_,segmento:E,totalPedidos:w.length}}),m=p.filter(v=>v.segmento==="vip"),u=p.filter(v=>v.segmento==="riesgo").sort((v,w)=>w.totalGastado-v.totalGastado),g=p.filter(v=>v.segmento==="inactivo").sort((v,w)=>w.totalGastado-v.totalGastado),y=[...p].sort((v,w)=>w.totalGastado-v.totalGastado).slice(0,10),b=r.filter(v=>new Date(v.created_at).toDateString()===s.toDateString()&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,w)=>v+parseFloat(w.total||0),0),x=r.filter(v=>new Date(v.created_at)>=d&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,w)=>v+parseFloat(w.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
      ...
      <p style="font-size:0.82rem;color:#888">Conectando con WhatsApp Business</p>
        ...
        <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
          ...
          <div style="display:flex;gap:1rem;justify-content:center">
            <div style="text-align:center">
              <p style="font-size:1.5rem;font-weight:700;color:#25D366">${h}</p>
          ...
          ${w>0&&((_=v.resultados)!=null&&_.length)?`
            <div style="margin-top:1rem;max-height:120px;overflow-y:auto;border-top:1px solid #f5f5f5;padding-top:0.75rem">
        ...
        </div>`};window._campanaJobId=g;const x=setInterval(async()=>{try{const w=await(await fetch(f+"/campanas/estado/"+g)).json();b(w),w.terminado&&(clearInterval(x),window._campanaUltimosResultados=w.resultados||[],setTimeout(()=>{const z=w.enviados||0,h=w.fallidos||0;l.innerHTML=`
              <div style="background:white;border-radius:16px;padding:2.5rem;max-width:400px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
                <div style="font-size:3.5rem;margin-bottom:1rem">${h===0?"🎉":"✅"}</div>
                ...
                ${h>0?`
                  <p style="color:#e53e3e;font-size:0.8rem;margin-bottom:0.5rem">${h} no se pudieron enviar</p>
...
`,renderInventario()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.renderInventario=()=>{const{sucursales:e,productos:t,variantes:a,inventario:o}=window._invData,n=(document.getElementById("inv-buscar")?document.getElementById("inv-buscar").value:"").toLowerCase(),r=document.getElementById("inv-categoria")?document.getElementById("inv-categoria").value:"",i=document.getElementById("inv-talla")?document.getElementById("inv-talla").value:"",s=document.getElementById("inv-estado")?document.getElementById("inv-estado").value:"",d=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],l=t.filter(m=>!(!m.activo||n&&!m.nombre.toLowerCase().includes(n)&&!(m.sku_interno||"").toLowerCase().includes(n)||r&&m.categoria!==r)),c=e.map(m=>{const u=o.filter(y=>y.sucursal_id===m.id),g=l.map(y=>{const b=a.filter(z=>z.producto_id===y.id);if(b.length===0)return"";const v=[...new Set(b.map(z=>z.color).filter(Boolean))].map(z=>{const h=b.filter(T=>T.color===z).sort((T,O)=>d.indexOf(T.talla)-d.indexOf(O.talla));if(i&&!h.find(T=>T.talla===i))return"";const k=h[0]?h[0].color_hex:"#888",_=h[0]?h[0].foto_url:null,E=h.map(T=>{const O=u.find(C=>C.variante_id===T.id),I=O?O.cantidad:null,S=O?O.stock_minimo:3;if(i&&T.talla!==i||s&&(s==="agotado"&&I!==0||s==="bajo"&&(I===null||I===0||I>S)||s==="disponible"&&(I===null||I===0||I<=S)))return"";let P,$;return I===null?(P="#f0f0f0",$="#aaa"):I===0?(P="#ffebee",$="#c62828"):I<=S?(P="#fff8e1",$="#f57f17"):(P="#e8f5e9",$="#2e7d32"),`
            <div style="display:flex;align-items:center;justify-content:space-between;background:${P};border-radius:10px;padding:8px 12px;border:1px solid ${$}30">
              <span style="font-size:0.85rem;font-weight:600;color:#555;min-width:44px">T${T.talla}</span>
              <div style="display:flex;align-items:center;gap:8px">
                <button onclick="cambiarStockInventario('${T.id}', '${m.id}', ${I!==null?I:0}, ${S}, -1)"
                ...
                <span id="stock-${T.id}-${m.id}" style="font-size:1.1rem;font-weight:700;color:${$};min-width:32px;text-align:center">${I!==null?I:"—"}</span>
                <button onclick="cambiarStockInventario('${T.id}', '${m.id}', ${I!==null?I:0}, ${S}, 1)"
                        style="background:#fff;border:1px solid #ddd;border-radius:6px;width:34px;height:34px;cursor:pointer;font-size:1.2rem;font-weight:700;touch-action:manipulation">+</button>
              </div>
            </div>
          ...
          <div style="background:#fafafa;border-radius:12px;padding:1rem;margin-bottom:10px;border:1px solid #eee">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
              ${_?`<img src="${_}" style="width:52px;height:52px;object-fit:cover;border-radius:8px;border:1px solid #eee;flex-shrink:0">`:`<div style="width:52px;height:52px;background:${k};border-radius:8px;border:1px solid #eee;flex-shrink:0;opacity:0.7"></div>`}
              <div style="display:flex;align-items:center;gap:8px">
...
${a.telefono?'<a href="https://wa.me/'+(a.lada||"52")+a.telefono.replace(/\D/g,"")+'" target="_blank" class="btn btn-secondary" style="background:#25D366;color:white;border-color:#25D366;margin-left:auto">WhatsApp</a>':""}      </div>
  ...
  `};window.guardarSalida=async()=>{const e=document.getElementById("sal").value,t=document.getElementById("sal-sucursal").value,a=document.getElementById("sal-cantidad").value,o=document.getElementById("sal-motivo").value;if(!e||!t||!a){alert("Por favor completa todos los campos");return}try{const r=await(await fetch(f+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:-parseInt(a),motivo:o})})).json();r.ok?(alert("Salida registrada. Anterior: "+r.cantidad_anterior+" pares ÔåÆ Nuevo: "+r.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(r))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const a=await(await fetch(f+"/sucursales/")).json(),n=await(await fetch(f+"/productos/")).json(),i=await(await fetch(f+"/variantes/")).json(),d=await(await fetch(f+"/inventario/")).json(),l=[...new Set(n.map(p=>p.categoria).filter(Boolean))],c=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:a,productos:n,variantes:i,inventario:d},e.innerHTML=`
    ...
    `,renderTablasMasivo()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:e,variantes:t,inventario:a}=window._invMasivo,o=document.getElementById("im-sucursal").value,n=document.getElementById("im-categoria").value,r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],i=e.filter(c=>!(n&&c.categoria!==n)),s=a.filter(c=>c.sucursal_id===o),d=i.map(c=>{const p=t.filter(g=>g.producto_id===c.id);if(p.length===0)return"";const u=[...new Set(p.map(g=>g.color).filter(Boolean))].map(g=>{const y=p.filter(x=>x.color===g).sort((x,v)=>r.indexOf(x.talla)-r.indexOf(v.talla));return`
        <div style="margin-bottom:1rem">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap">
            ${y.map(x=>{const v=s.find(k=>k.variante_id===x.id),w=v?v.cantidad:0,z=v?v.stock_minimo:3;let h="#ddd";return w===0?h="#ffcdd2":w<=z?h="#ffe082":h="#a5d6a7",`
                <div style="text-align:center">
                  ...
                  <input type="number" min="0"
                         ...
                         data-variante="${x.id}"
                         data-anterior="${w}"
                         style="width:58px;text-align:center;padding:6px 4px;border:2px solid ${h};border-radius:8px;font-size:0.9rem;font-weight:600"
  ...
  `};window.guardarTraspaso=async()=>{const e=document.getElementById("tra").value,t=document.getElementById("tra-origen").value,a=document.getElementById("tra-destino").value,o=document.getElementById("tra-cantidad").value;if(!e||!t||!a||!o){alert("Por favor completa todos los campos");return}if(t===a){alert("La sucursal origen y destino no pueden ser la misma");return}try{const r=await(await fetch(f+"/movimientos/traspaso",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_origen_id:t,sucursal_destino_id:a,cantidad:parseInt(o)})})).json();r.ok?(alert("Traspaso realizado correctamente. Se movieron "+r.cantidad_movida+" pares."),navegarA("inventario")):alert("Error: "+(r.error||JSON.stringify(r)))}catch{alert("Error conectando con el servidor")}};async function we(){const e=document.getElementById("content");try{const a=await(await fetch(f+"/pedidos/")).json();e.innerHTML=`
      <div style="margin-bottom:1rem;display:flex;gap:8px;flex-wrap:wrap;align-items:center">
  ...
  `).join(""),a.style.display="block"};window.seleccionarClientePOS=(e,t)=>{document.getElementById("pos-cliente").value=e,document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-resultados").style.display="none";const a=document.getElementById("pos-cliente-seleccionado");a.textContent="✔ "+t+" — toca para cambiar",a.style.display="block"};window.limpiarClientePOS=()=>{document.getElementById("pos-cliente").value="",document.getElementById("pos-cliente-seleccionado").style.display="none",document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-buscar").focus()};window.renderProductosPOS=e=>{const{variantes:t,inventario:a}=window._posData,o=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=a.filter(i=>i.sucursal_id===o),r=document.getElementById("pos-productos-grid");r&&(r.innerHTML=e.filter(i=>i.activo).map(i=>{const s=t.filter(c=>c.producto_id===i.id),d=[...new Set(s.map(c=>c.color).filter(Boolean))],l=s.reduce((c,p)=>{const m=n.find(u=>u.variante_id===p.id);return c+(m?m.cantidad:0)},0);return`
    ...
    <div style="background:white;border-radius:16px;max-width:640px;width:100%;height:90vh;display:flex;flex-direction:column;overflow:hidden">
      ...
      <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
          ${l.map(p=>{const m=d.find(g=>g.color===p),u=d.filter(g=>g.color===p).reduce((g,y)=>{const b=s.find(x=>x.variante_id===y.id);return g+(b?b.cantidad:0)},0);return`
  ...
  `,document.body.appendChild(c),c.addEventListener("click",p=>{p.target===c&&c.remove()}),window._posSeleccion={productoId:e,color:null},window._posBuffer={}};window.mostrarCorridaModalPOS=e=>{const{variantes:t,inventario:a}=window._posData,o=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=a.filter(p=>p.sucursal_id===o),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],i=[...new Set(t.filter(p=>p.producto_id===e).map(p=>p.color).filter(Boolean))],s=document.querySelector(`button[onclick="mostrarCorridaModalPOS('${e}')"]`);s&&(s.style.display="none"),document.querySelectorAll("#pos-modal").forEach(p=>{p!==document.getElementById("pos-modal")&&p.remove()}),window._posSeleccion.color=null,window._corridaCantidades={};const d=document.getElementById("pos-tallas-panel");if(!d)return;const l=p=>{const m=t.filter(u=>u.producto_id===e&&u.color===p).sort((u,g)=>r.indexOf(u.talla)-r.indexOf(g.talla));m.filter(u=>{const g=n.find(y=>y.variante_id===u.id);return g&&g.cantidad>0}),d.innerHTML=`
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:16px">
        ${i.map(u=>{const g=t.find(v=>v.producto_id===e&&v.color===u),y=g?g.color_hex:"#888",b=g?g.foto_url:null,x=Object.entries(window._corridaCantidades).filter(([v])=>t.find(w=>w.id===v&&w.color===u)).reduce((v,[,w])=>v+w,0);return`
          ...
          `}).join("")}
           ...
           <div style="display:flex;flex-direction:column;gap:8px">
        ${m.map(u=>{const g=n.find(x=>x.variante_id===u.id),y=g?g.cantidad:0,b=window._corridaCantidades[u.id]||0;return`
    ...
    `)};window.sugerirCorrida=(e,t)=>{const{variantes:a,inventario:o}=window._posData,n=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=o.filter(c=>c.sucursal_id===n),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],s=a.filter(c=>c.producto_id===e&&c.color===t).sort((c,p)=>i.indexOf(c.talla)-i.indexOf(p.talla)),d=s.filter(c=>{const p=r.find(m=>m.variante_id===c.id);return p&&p.cantidad>0}),l=d.some(c=>c.talla.includes("."));if(s.forEach(c=>{window._corridaCantidades[c.id]=0}),l)d.slice(0,6).forEach(c=>{window._corridaCantidades[c.id]=1});else{const c=d.slice(0,5);c.length>=4?c.forEach((p,m)=>{window._corridaCantidades[p.id]=m===1||m===2?2:1}):d.slice(0,6).forEach(p=>{window._corridaCantidades[p.id]=Math.ceil(6/d.length)})}window.renderCorridaColor(t)};window.confirmarCorridaNueva=e=>{const{variantes:t}=window._posData,a=window._posData.productos.find(r=>r.id===e);if(!a)return;let o=0;if(Object.entries(window._corridaCantidades).forEach(([r,i])=>{var l;if(i<=0)return;const s=t.find(c=>c.id===r);if(!s)return;const d=window._posCarrito.find(c=>c.variante_id===r&&c.es_corrida);d?(d.cantidad+=i,d.es_corrida=!0):window._posCarrito.push({variante_id:r,producto_id:e,nombre:a.nombre,color:s.color,talla:s.talla,cantidad:i,precio_menudeo:parseFloat(a.precio_menudeo)||0,precio_mayoreo3:parseFloat(a.precio_mayoreo3)||parseFloat(a.precio_menudeo)-30,precio_mayoreo6:parseFloat(a.precio_mayoreo6)||parseFloat(a.precio_menudeo)-70,precio_corrida:parseFloat(a.precio_corrida)||parseFloat(a.precio_menudeo)-100,es_corrida:!0,imagen:((l=window._posData.variantes.find(c=>c.id===r))==null?void 0:l.foto_url)||a.imagen_principal||null,precio_unitario:parseFloat(a.precio_corrida)||parseFloat(a.precio_menudeo)-100}),o++}),o===0){alert("Agrega al menos una talla");return}const n=document.getElementById("pos-modal");n&&n.remove(),window._corridaCantidades={},renderCarritoPOS()};window.seleccionarColorModalPOS=(e,t)=>{const{variantes:a,inventario:o}=window._posData,n=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=o.filter(u=>u.sucursal_id===n),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._posSeleccion&&window._posSeleccion.color&&guardarBufferColor(e,window._posSeleccion.color),document.querySelectorAll('[id^="pos-color-btn-"]').forEach(u=>{u.style.borderColor="#ddd",u.style.background="transparent"});const s=document.getElementById("pos-color-btn-"+t.replace(/\s/g,"_"));s&&(s.style.borderColor="#E91E8C",s.style.background="#fce4f3"),window._posSeleccion.color=t;const d=a.filter(u=>u.producto_id===e&&u.color===t).sort((u,g)=>i.indexOf(u.talla)-i.indexOf(g.talla)),l=d[0]?d[0].foto_url:null,c=document.getElementById("pos-modal-img");c&&l&&(c.src=l);const p=window._posBuffer[t]||{},m=document.getElementById("pos-tallas-panel");m&&(m.innerHTML=`
      ...
      <div style="display:flex;flex-direction:column;gap:8px">
        ${d.map(u=>{const g=r.find(x=>x.variante_id===u.id),y=g?g.cantidad:0,b=p[u.id]||0;return`
            <div style="display:flex;align-items:center;gap:10px;opacity:${y===0?"0.4":"1"}">
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
        ...
        </tr>`}).join(""))};async function Fe(){try{const t=await(await fetch(f+"/pedidos/")).json(),o=await(await fetch(f+"/clientes/")).json(),r=await(await fetch(f+"/inventario/alertas")).json(),i=new Date;i.setHours(0,0,0,0);const s=new Date(i);s.setDate(s.getDate()-7);const d=new Date(i);d.setDate(d.getDate()-30);const l=t.filter($=>$.status==="confirmado"||$.status==="pagado"),c=l.filter($=>new Date($.created_at)>=i),p=l.filter($=>new Date($.created_at)>=s),m=c.reduce(($,C)=>$+parseFloat(C.total||0),0),u=p.reduce(($,C)=>$+parseFloat(C.total||0),0),g=o.filter($=>$.created_at&&new Date($.created_at)>=d).length,y=["Dom","Lun","Mar","Mie","Jue","Vie","Sab"],b={};y.forEach($=>b[$]=0),l.filter($=>new Date($.created_at)>=d).forEach($=>{const C=y[new Date($.created_at).getDay()];b[C]+=parseFloat($.total||0)});const x={};l.forEach($=>{x[$.canal||"sucursal"]=(x[$.canal||"sucursal"]||0)+parseFloat($.total||0)});const v={};l.forEach($=>{v[$.forma_pago||"efectivo"]=(v[$.forma_pago||"efectivo"]||0)+1});const w={};l.forEach($=>{w[$.empleado||"Admin"]=(w[$.empleado||"Admin"]||0)+parseFloat($.total||0)});const z={};l.forEach($=>{const C=new Date($.created_at).toLocaleDateString("es-MX",{month:"short",year:"numeric"});z[C]=(z[C]||0)+parseFloat($.total||0)});const h={};l.forEach($=>{$.clientes&&(h[$.clientes.nombre]=(h[$.clientes.nombre]||0)+parseFloat($.total||0))});const k=Object.entries(h).sort(($,C)=>C[1]-$[1]).slice(0,5),_=Object.entries(b).sort(($,C)=>C[1]-$[1])[0],E=Object.entries(w).sort(($,C)=>C[1]-$[1])[0],T=document.getElementById("dashboard-contenido");if(!T)return;const O=T.querySelectorAll(".stat-card"),I=[{val:"$"+m.toFixed(0),sub:c.length+" pedidos hoy",color:"var(--pink)"},{val:c.length,sub:"confirmados hoy"},{val:"$"+u.toFixed(0),sub:p.length+" pedidos"},{val:g,sub:"ultimos 30 dias"},{val:r.length,sub:"por reabastecer",color:r.length>0?"var(--amber)":"var(--green)"},{val:_?_[0]:"—",sub:_?"$"+_[1].toFixed(0)+" prom.":""},{val:E?E[0]:"—",sub:E?"$"+E[1].toFixed(0):"",small:!0},{val:o.length,sub:"registrados"}];O.forEach(($,C)=>{if(!I[C])return;const j=$.querySelector(".stat-value"),B=$.querySelector(".stat-sub");j&&(j.textContent=I[C].val,j.style.color=I[C].color||"var(--text-primary)",I[C].small&&(j.style.fontSize="1rem")),B&&(B.textContent=I[C].sub||"")});const S=document.getElementById("dash-top-clientes");S&&(S.innerHTML=k.length===0?'<p style="color:var(--text-muted);font-size:0.85rem">Sin datos aun</p>':k.map(([$,C],j)=>`
          <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px">
            ...
            <strong style="color:var(--pink)">$${C.toFixed(0)}</strong>
          </div>`).join(""));const P=document.getElementById("dash-ultimos-pedidos");P&&(P.innerHTML=t.slice(0,5).map($=>`
        ...
        </div>`).join("")),setTimeout(()=>{const $={responsive:!0,plugins:{legend:{labels:{color:"#666",font:{size:11}}}},scales:{x:{ticks:{color:"#666",font:{size:11}},grid:{color:"rgba(0,0,0,0.05)"}},y:{ticks:{color:"#666",font:{size:11}},grid:{color:"rgba(0,0,0,0.05)"}}}},C=document.getElementById("chart-dias");C&&window.Chart&&new Chart(C,{type:"bar",data:{labels:y,datasets:[{data:y.map(X=>b[X]||0),backgroundColor:"rgba(233,30,140,0.2)",borderColor:"#E91E8C",borderWidth:2,borderRadius:6}]},options:{...$,plugins:{legend:{display:!1}}}});const j=document.getElementById("chart-canales");j&&window.Chart&&Object.keys(x).length>0&&new Chart(j,{type:"doughnut",data:{labels:Object.keys(x),datasets:[{data:Object.values(x),backgroundColor:["rgba(233,30,140,0.7)","rgba(0,151,178,0.7)","rgba(124,58,237,0.7)","rgba(46,125,50,0.7)"],borderColor:["#E91E8C","#0097b2","#7c3aed","#2e7d32"],borderWidth:2}]},options:{responsive:!0,cutout:"65%",plugins:{legend:{position:"bottom",labels:{color:"#666",font:{size:11},padding:12}}}}});const B=document.getElementById("chart-meses");if(B&&window.Chart){const X=Object.entries(z).slice(-6);new Chart(B,{type:"line",data:{labels:X.map(([V])=>V),datasets:[{data:X.map(([,V])=>V),borderColor:"#0097b2",backgroundColor:"rgba(0,151,178,0.08)",borderWidth:2,pointBackgroundColor:"#0097b2",pointRadius:4,fill:!0,tension:.4}]},options:{...$,plugins:{legend:{display:!1}}}})}const H=document.getElementById("chart-pagos");H&&window.Chart&&Object.keys(v).length>0&&new Chart(H,{type:"doughnut",data:{labels:Object.keys(v),datasets:[{data:Object.values(v),backgroundColor:["rgba(46,125,50,0.7)","rgba(245,127,23,0.7)","rgba(233,30,140,0.7)","rgba(124,58,237,0.7)"],borderColor:["#2e7d32","#f57f17","#E91E8C","#7c3aed"],borderWidth:2}]},options:{responsive:!0,cutout:"65%",plugins:{legend:{position:"bottom",labels:{color:"#666",font:{size:11},padding:12}}}}})},300);try{const C=await(await fetch(f+"/chatbot/tareas-hoy")).json(),j=document.createElement("div");j.style.cssText="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem;margin-top:1.5rem",j.innerHTML=`
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem">
        <h3 style="font-size:1rem;font-weight:700;margin:0">✅ Tareas pendientes hoy</h3>
        <span style="background:#e91e8c;color:white;border-radius:100px;padding:2px 10px;font-size:0.75rem">${C.filter(B=>!B.completada).length} pendientes</span>
      </div>
      ${C.length===0?'<p style="color:#aaa;font-size:0.85rem;text-align:center;padding:1rem">Sin tareas pendientes</p>':C.map(B=>`
        ...
        `).join("")}
    `,document.getElementById("dashboard-contenido").appendChild(j)}catch($){console.error("tareas:",$)}}catch(e){console.error("Error dashboard:",e)}}window.eliminarItemPedido=e=>{window._pedidoItems.splice(e,1),window.recalcularTotal(),window.renderItemsPedido()};window.cerrarSesionPanel=()=>{confirm("Cerrar sesion?")&&(sessionStorage.removeItem("erp_empleado"),sessionStorage.removeItem("erp_token"),window._empleadoActual=null,location.reload())};async function _e(){const e=document.getElementById("content");try{const a=await(await fetch(f+"/empleados/",{headers:window.authHeaders()})).json();e.innerHTML=`
      <div class="table-card">
        <div class="table-header">
...
<div>
  ...
  <div style="display:flex;gap:1rem;flex-wrap:wrap">
    ...
    <div class="table-card">
      ...
      </div>`}catch(a){t.innerHTML='<p style="color:red">Error: '+a.message+"</p>"}}window._toggleGenProd=function(e){const{seleccionados:t}=window._generadorData,a=document.getElementById("gen-item-"+e),o=document.getElementById("gen-colores-"+e);t.has(e)?(t.delete(e),a.style.borderColor="transparent",o&&(o.style.opacity="0.35",o.style.pointerEvents="none")):(t.add(e),a.style.borderColor="#C8967A",o&&(o.style.opacity="1",o.style.pointerEvents="auto")),document.getElementById("gen-count").textContent=t.size+" seleccionados"};window._toggleColorGen=function(e,t){var n,r;const a=document.getElementById(`gen-col-${e}-${t}`);if(!a)return;const o=a.dataset.sel==="1";a.dataset.sel=o?"0":"1",a.style.borderColor=o?"#ccc":"#C8967A",a.style.opacity=o?"0.3":"1",a.title=(((r=(n=window._generadorData.coloresPorProd[e])==null?void 0:n[t])==null?void 0:r.color)||"")+(o?" (excluido)":"")};window._selTodosGenerador=function(){const{productos:e,seleccionados:t}=window._generadorData,a=t.size===e.length;t.clear(),e.forEach((o,n)=>{const r=document.getElementById("gen-item-"+n);a?r&&(r.style.borderColor="transparent"):(t.add(n),r&&(r.style.borderColor="#C8967A"))}),document.getElementById("gen-count").textContent=t.size+" seleccionados"};function ne(e){return new Promise(t=>{const a=new Image;a.crossOrigin="anonymous",a.onload=()=>t(a),a.onerror=()=>t(null),a.src=e+(e.includes("?")?"&":"?")+"_t="+Date.now()})}function ce(e,t,a,o,n,r){const i=t.split(" ");let s="",d=o;for(let l of i){const c=s+(s?" ":"")+l;e.measureText(c).width>n&&s?(e.fillText(s,a,d),s=l,d+=r):s=c}return s&&e.fillText(s,a,d),d+r}window.generarPaginasCanvas=async function(e){const{productos:t,variantes:a,seleccionados:o,coloresPorProd:n}=window._generadorData;if(!o.size){alert("Selecciona al menos un producto");return}const r=document.getElementById("gen-layout").value,i=r==="1e"?1:parseInt(r),s=(b,x)=>{const v=a.filter(h=>h.producto_id===b.id&&h.activa!==!1),w=n?n[x]:[];if(!w||w.length<=1)return v;const z=new Set(w.filter((h,k)=>{const _=document.getElementById(`gen-col-${x}-${k}`);return!_||_.dataset.sel!=="0"}).map(h=>h.color));return z.size?v.filter(h=>{const k=(h.color||"").trim();return!k||z.has(k)}):v},d=Array.from(o).map(b=>({prod:t[b],origIdx:b})),l=[];for(let b=0;b<d.length;b+=i)l.push(d.slice(b,b+i));const c=document.getElementById("btn-generar"),p=document.getElementById("gen-progress"),m=document.getElementById("gen-msg"),u=document.getElementById("gen-bar");c.disabled=!0,p.style.display="block";const{paginas:g}=window._catalogoPaginasData;let y=g.length>0?Math.max(...g.map(b=>b.pagina_numero))+1:1;for(let b=0;b<l.length;b++){const x=l[b],v=E=>(E==null?void 0:E.prod)??E,w=E=>(E==null?void 0:E.origIdx)??t.indexOf((E==null?void 0:E.prod)??E);m.textContent=`Generando página ${b+1} de ${l.length}...`,u.style.width=b/l.length*100+"%";const z=document.createElement("canvas");z.width=1080,z.height=1440;const h=z.getContext("2d");if(h.fillStyle="#FAFAF8",h.fillRect(0,0,1080,1440),h.fillStyle="#C8967A",h.fillRect(60,48,960,1),h.fillStyle="#2A1A0E",h.font="300 22px DM Sans, sans-serif",h.textAlign="center",h.letterSpacing="8px",h.fillText("ZAPATILLAS MAY",540,42),h.letterSpacing="0px",h.fillStyle="#C8967A",h.fillRect(60,58,960,1),r==="1e"){const E=x[0],T=v(E),O=w(E),I=s(T,O),S=[],P=new Set,$=A=>{A&&!P.has(A)&&(P.add(A),S.push(A))};I.length>0&&I[0].foto_url?$(I[0].foto_url):$(T.imagen_principal);for(const A of I)if($(A.foto_url),Array.isArray(A.imagenes)&&A.imagenes.forEach($),S.length>=3)break;const C=S.length,j=[],B=new Set;for(const A of I){const M=(A.color||"").trim();M&&!B.has(M)&&(B.add(M),j.push({color:M,hex:A.color_hex}))}const H={negro:"#1C1C1C",blanco:"#F8F8F8",hueso:"#F0EBE1",beige:"#D9C9A8",camel:"#C19A6B","cafe claro":"#A0725A","cafe medio":"#7A4A30","cafe oscuro":"#4A2010",cafe:"#6B3A2A",chocolate:"#3D1C02",cognac:"#9B4421",taupe:"#8B7355",nude:"#D4A97A","nude claro":"#E8C9A8","nude oscuro":"#C0886A","nude rosa":"#DDA090","palo de rosa":"#D4A0A0",salmon:"#FA8072",coral:"#FF6B4A",rojo:"#CC2200",vino:"#722F37",bordo:"#800020","rosa claro":"#F9C0CB",rosa:"#F4607A",fusha:"#E91E8C",naranja:"#FF8C00",amarillo:"#F5C518",dorado:"#D4AF37",oro:"#CFB53B","oro rosa":"#E8B4B8",plateado:"#C0C0C0","azul claro":"#5B8DB8",azul:"#1E4080","azul marino":"#001F5B",turquesa:"#40C4AA",verde:"#2D6A4F","verde menta":"#98D8C8","gris claro":"#C8C8C8",gris:"#909090","gris oscuro":"#505050",morado:"#7B2D8B",lila:"#C8A0D8",multicolor:"#CCAA88"},X=({color:A,hex:M})=>{if(M&&M.startsWith("#"))return M;const L=(A||"").toLowerCase();if(H[L])return H[L];for(const[D,F]of Object.entries(H))if(L.includes(D))return F;return"#BBAA99"},V=(A,M,L,D,F)=>{if(h.save(),h.fillStyle="#FFFFFF",h.fillRect(M,L,D,F),A){h.beginPath(),h.rect(M,L,D,F),h.clip();const q=A.naturalWidth/A.naturalHeight,G=D/F;let R,te,W,K;q>G?(W=D,K=D/q,R=M,te=L+(F-K)/2):(K=F,W=F*q,te=L,R=M+(D-W)/2),h.drawImage(A,R,te,W,K)}h.restore()},J=62,N=1080,U=J+N+12;if(C>=3){const[A,M,L]=await Promise.all(S.slice(0,3).map(ne)),D=10,F=10,q=648,G=1080-q-D,R=Math.floor((N-F)/2);V(A,0,J,q,N),V(M,q+D,J,G,R),V(L,q+D,J+R+F,G,R)}else if(C===2){const[A,M]=await Promise.all(S.map(ne)),L=10,D=Math.floor((1080-L)/2);V(A,0,J,D,N),V(M,D+L,J,D,N)}else{const[A]=await Promise.all([ne(S[0])]);V(A,40,J,1e3,N)}if(h.fillStyle="#E8DDD5",h.fillRect(0,U,1080,1),h.fillStyle="#2A1A0E",h.textAlign="center",h.font="300 28px DM Sans, sans-serif",h.letterSpacing="3px",ce(h,T.nombre.toUpperCase(),540,U+42,960,38),h.letterSpacing="0px",T.sku&&(h.fillStyle="#A07860",h.font="400 14px DM Mono, monospace",h.fillText(T.sku,540,U+66)),j.length>0){const L=Math.min(j.length,14),D=L*(11*2)+(L-1)*8;let F=Math.round(540-D/2+11);const q=U+100;for(let G=0;G<L;G++){const R=F+G*30;h.beginPath(),h.arc(R,q,11,0,Math.PI*2),h.fillStyle=X(j[G]),h.fill(),h.strokeStyle="rgba(0,0,0,0.18)",h.lineWidth=1.5,h.stroke()}}}else{const E=i<=2?i:2,T=i===4?2:1,O=80,I=100,S=i===1?0:20,P=i===4?20:0,$=i===1?40:28,C=(1080-$*2-S*(E-1))/E,j=(1440-O-I-P*(T-1))/T;for(let B=0;B<x.length;B++){const H=v(x[B]),X=w(x[B]),V=B%E,J=Math.floor(B/E),N=$+V*(C+S),U=O+J*(j+P),A=i===1?120:i===2?90:70,M=j-A,L=s(H,X),D=L.length>0&&L[0].foto_url?L[0].foto_url:H.imagen_principal,F=await ne(D);if(h.save(),h.fillStyle="#FFFFFF",h.fillRect(N,U,C,M),F){h.beginPath(),h.rect(N,U,C,M),h.clip();const R=F.naturalWidth/F.naturalHeight,te=C/M;let W,K,oe,ae;R>te?(oe=C,ae=C/R,W=N,K=U+(M-ae)/2):(ae=M,oe=M*R,K=U,W=N+(C-oe)/2),h.drawImage(F,W,K,oe,ae)}h.restore(),h.fillStyle="#E8DDD5",h.fillRect(N,U+M,C,1);const q=U+M+A/2;h.fillStyle="#2A1A0E",h.textAlign="center";const G=i===1?34:i===2?24:19;h.font=`300 ${G}px DM Sans, sans-serif`,h.letterSpacing="2px",ce(h,H.nombre.toUpperCase(),N+C/2,q-8,C-32,G+10),h.letterSpacing="0px",H.sku&&(h.fillStyle="#A07860",h.font=`400 ${i===1?18:13}px DM Mono, monospace`,h.fillText(H.sku,N+C/2,q+(i===1?36:26)))}}h.fillStyle="#C8967A",h.fillRect(60,1340,960,1),h.fillStyle="#A07860",h.font="300 18px DM Sans, sans-serif",h.textAlign="center",h.letterSpacing="3px",h.fillText("@ZAPATILLASMAY",540,1368),h.letterSpacing="0px",h.fillStyle="#C0A898",h.font="300 15px DM Sans, sans-serif",h.fillText("zapatillasmay.mx  ·  León, Guanajuato",540,1394);const k=await new Promise(E=>z.toBlob(E,"image/jpeg",.92)),_=new FormData;_.append("archivo",k,`catalogo-pag-${y}.jpg`);try{const T=await(await fetch(f+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:_})).json();T.url&&await fetch(f+"/catalogos/"+e+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:T.url,pagina_numero:y++})})}catch(E){console.error("Error subiendo página generada",E)}}u.style.width="100%",m.textContent=`✅ ${l.length} páginas generadas`,setTimeout(()=>{p.style.display="none"},2e3),c.disabled=!1,await gestionarPaginas(e,window._catalogoPaginasData.nombre)};window.subirPaginasCatalogo=async function(e,t){const a=Array.from(e.files||e);if(!a.length)return;const o=document.getElementById("upload-progress"),n=document.getElementById("upload-msg"),r=document.getElementById("upload-bar");o&&(o.style.display="block");const{paginas:i}=window._catalogoPaginasData;let s=i.length>0?Math.max(...i.map(d=>d.pagina_numero))+1:1;for(let d=0;d<a.length;d++){n&&(n.textContent=`Subiendo ${d+1} de ${a.length}...`),r&&(r.style.width=d/a.length*100+"%");try{const l=new FormData;l.append("archivo",a[d]);const p=await(await fetch(f+"/imagenes/subir?carpeta=catalogos",{method:"POST",body:l})).json();p.url&&await fetch(f+"/catalogos/"+t+"/paginas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:p.url,pagina_numero:s++})})}catch(l){console.error("Error subiendo página "+(d+1),l)}}r&&(r.style.width="100%"),n&&(n.textContent="✅ Listo"),setTimeout(()=>{o&&(o.style.display="none")},1500),e.value!==void 0&&(e.value=""),await gestionarPaginas(t,window._catalogoPaginasData.nombre)};window.moverPagina=async function(e,t){const{paginas:a,catalogoId:o,nombre:n}=window._catalogoPaginasData,r=a.findIndex(l=>l.id===e);if(r===-1)return;const i=t==="up"?r-1:r+1;if(i<0||i>=a.length)return;const s=a[r].pagina_numero,d=a[i].pagina_numero;await Promise.all([fetch(f+"/catalogos/paginas/"+a[r].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:d})}),fetch(f+"/catalogos/paginas/"+a[i].id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({pagina_numero:s})})]),await gestionarPaginas(o,n)};window.eliminarPagina=async function(e,t){confirm("¿Eliminar esta página?")&&(await fetch(f+"/catalogos/paginas/"+e,{method:"DELETE"}),await gestionarPaginas(t,window._catalogoPaginasData.nombre))};window.usarComoPortada=async function(e,t){await fetch(f+"/catalogos/"+t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({portada_url:e})}),alert("✅ Portada actualizada")};window.descargarExcelTikTok=async function(e,t,a){const o=e.innerHTML;try{e.innerHTML="⏳ Generando...",e.disabled=!0;const n=await fetch(`${f}/tiktok/${t}`);if(!n.ok){const d=await n.text();throw new Error(`Error ${n.status}: ${d}`)}const r=await n.blob(),i=URL.createObjectURL(r),s=document.createElement("a");s.href=i,s.download=a,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(i)}catch(n){alert("Error al descargar el archivo: "+n.message)}finally{e.innerHTML=o,e.disabled=!1}};document.querySelector("#app").style.cssText="display:flex;min-height:100vh;width:100%";const ze="erp_empleado";function pe(){document.querySelector("#app").innerHTML=`
  ...
  `,window.hacerLogin=async()=>{const t=document.getElementById("login-email").value,a=document.getElementById("login-password").value,o=document.getElementById("btn-login");if(document.getElementById("login-error"),!t||!a){e("Por favor completa todos los campos");return}o.textContent="Verificando...",o.disabled=!0;try{const n=await fetch("/api/empleados/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),r=await n.json();n.ok?(sessionStorage.setItem(ze,JSON.stringify(r)),r.token&&sessionStorage.setItem("erp_token",r.token),window._empleadoActual=r,fe()):(e(r.error||"Email o contrasena incorrectos"),o.textContent="Iniciar sesion",o.disabled=!1)}catch{e("Error conectando con el servidor"),o.textContent="Iniciar sesion",o.disabled=!1}};function e(t){const a=document.getElementById("login-error");a&&(a.textContent=t,a.style.display="block")}}window.authHeaders=()=>{const e=sessionStorage.getItem("erp_token");return e?{"Content-Type":"application/json",Authorization:`Bearer ${e}`}:{"Content-Type":"application/json"}};const me=sessionStorage.getItem(ze);if(me)try{window._empleadoActual=JSON.parse(me),fe()}catch{pe()}else pe();
