(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function n(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(o){if(o.ep)return;o.ep=!0;const i=n(o);fetch(o.href,i)}})();const g="https://zapatillasmay-production.up.railway.app",J=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],re=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],se=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],M=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"}];var U;let O=((U=window._empleadoActual)==null?void 0:U.rol)==="admin"?"dashboard":"pos",R=1;function W(){var n,a;const e=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),t=((n=window._empleadoActual)==null?void 0:n.rol)==="admin"?"dashboard":"pos";O=e||t,document.querySelector("#app").innerHTML=`
    ...
    <div class="main">
      <div class="topbar">
        <div style="display:flex;align-items:center;gap:1rem">
          ...
          <h1 id="topbar-title">${((a=M.find(o=>o.id===O))==null?void 0:a.label)||"Dashboard"}</h1>
        </div>
  ...
  `).join("")}async function K(e){const t=document.getElementById("content");switch(t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>',e){case"dashboard":t.innerHTML=ce(),setTimeout(()=>ye(),100);break;case"productos":await H();break;case"clientes":await me();break;case"pedidos":await te();break;case"sucursales":await ue();break;case"inventario":await fe();break;case"pos":await oe();break;case"historial":await ae();break;case"empleados":await ne();break;case"seo":await ve();break;case"analisis":await pe();break;case"crm":await Y();break;case"finanzas":await D();break;case"proveedores":await Z();break;case"ordenes":await L();break;case"conversaciones":await cargarConversaciones();break;case"envios":await cargarEnviosMasivos();break}}function le(){return setTimeout(()=>{document.querySelectorAll(".nav-item").forEach(a=>a.classList.remove("active"));const e=document.querySelector('[data-modulo="'+O+'"]');e&&e.classList.add("active");const t=document.getElementById("topbar-title"),n=M.find(a=>a.id===O);t&&n&&(t.textContent=n.label),K(O)},100),'<div style="padding:2rem;color:#888;text-align:center">Cargando...</div>'}async function L(){var t;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando sugerencias...</p>';try{const a=await(await fetch(g+"/sucursales/")).json(),o=(t=a[0])==null?void 0:t.id,[i,r]=await Promise.all([fetch(g+"/finanzas/sugerencias-recompra/"+o),fetch(g+"/finanzas/proveedores")]),s=await i.json(),d=await r.json(),l=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),p=new Date().toISOString().split("T")[0],c=s.filter(b=>{const h=l[b.producto_id];return h?h.hasta===null||h.hasta===void 0?!1:h.hasta<=p:!0}),m=s.length-c.length;window._ordenesData={sugerencias:c,proveedores:d,sucursalId:o},window._ordenSeleccion={};const f=c.filter(b=>b.urgente),u=c.filter(b=>!b.urgente),y=c.reduce((b,h)=>b+h.cantidad_sugerida*h.costo_unitario,0);e.innerHTML=`
      ...
      ${c.length===0?`<div style="background:white;border-radius:12px;padding:3rem;text-align:center;border:1px solid #eee">
              ...
              <div class="orden-item" data-urgente="${b.urgente}" style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
                ...
                <div style="flex:1;min-width:140px">
                  ...
                  <div style="margin-top:6px;display:flex;flex-wrap:wrap;gap:4px">
                    ${b.variantes.map(h=>{const v=[h.talla,h.color].filter(Boolean).join(" / "),x=h.sin_stock;return`<span style="
        ...
        `}
    `}catch(n){e.innerHTML='<p style="padding:2rem;color:red">Error: '+n.message+"</p>"}}window.seleccionarTodos=e=>{document.querySelectorAll(".orden-check").forEach(t=>{t.checked=e;const n=t.dataset.id;window._ordenSeleccion[n]=e}),actualizarCostoOrden()};window.actualizarSeleccion=(e,t)=>{window._ordenSeleccion[e]=t,actualizarCostoOrden()};window.actualizarCostoOrden=()=>{const{sugerencias:e}=window._ordenesData;let t=0,n=0;e.forEach(i=>{var r;if(window._ordenSeleccion[i.producto_id]){const d=parseInt(((r=document.getElementById("qty-orden-"+i.producto_id))==null?void 0:r.value)||i.cantidad_sugerida)*i.costo_unitario;t+=d,n++;const l=document.getElementById("sub-"+i.producto_id);l&&(l.textContent="$"+d.toFixed(0))}});const a=document.getElementById("ord-total"),o=document.getElementById("ord-seleccionados");a&&(a.textContent="$"+t.toFixed(0)),o&&(o.textContent=n+" productos seleccionados")};window.filtrarOrdenes=e=>{document.querySelectorAll(".orden-item").forEach(t=>{t.style.display=e==="todos"||e==="urgente"&&t.dataset.urgente==="true"?"":"none"})};window.recargarOrdenes=async e=>{const t=await fetch(g+"/finanzas/sugerencias-recompra/"+e);window._ordenesData.sugerencias=await t.json(),window._ordenesData.sucursalId=e,L()};window.generarOrden=()=>{const{sugerencias:e,proveedores:t,sucursalId:n}=window._ordenesData,a=e.filter(i=>window._ordenSeleccion[i.producto_id]);if(a.length===0){alert("Selecciona al menos un producto para generar la orden");return}window._ordenModal={seleccionados:a,sucursalId:n};const o=document.createElement("div");o.id="modal-orden",o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem;overflow-y:auto",o.innerHTML=`
  ...
  `,document.body.appendChild(o),o.addEventListener("click",i=>{i.target===o&&o.remove()}),setTimeout(ordenRecalcTotal,50)};window.guardarOrdenCompra=async e=>{var o,i,r;const t=(o=document.getElementById("orden-fecha"))==null?void 0:o.value,n=((i=document.getElementById("orden-notas"))==null?void 0:i.value)||"",a=window._ordenesData.sucursalId;try{const s=typeof e=="string"?JSON.parse(e):e;for(const[d,l]of s){const p=l.productos.reduce((u,y)=>u+y.cantidad_final*y.costo_unitario,0),f=(r=(await(await fetch(g+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:d==="sin-proveedor"?null:d,sucursal_id:a,status:"borrador",total:p,notas:n,fecha_entrega_estimada:t||null})})).json())[0])==null?void 0:r.id;if(f)for(const u of l.productos)await fetch(g+"/finanzas/ordenes/"+f+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:null,cantidad:u.cantidad_final,costo_unitario:u.costo_unitario,subtotal:u.cantidad_final*u.costo_unitario})})}document.querySelector('div[style*="position:fixed"]').remove(),alert("Orden de compra guardada exitosamente"),L()}catch(s){alert("Error guardando orden: "+s.message)}};window.ordenToggleVar=(e,t)=>{const n=document.getElementById("qty-var-"+e);n&&(n.disabled=!t,n.style.opacity=t?"1":"0.35",n.style.borderColor=t?"#E91E8C":"#ddd",t&&(!n.value||n.value==="0")?n.value=1:t||(n.value=0),ordenRecalcTotal())};window.ordenRecalcTotal=()=>{const{seleccionados:e}=window._ordenModal||{};if(!e)return;let t=0;e.forEach(a=>{var o;if((a.variantes||[]).forEach(i=>{var d;const r=document.getElementById("chk-var-"+i.id),s=parseInt(((d=document.getElementById("qty-var-"+i.id))==null?void 0:d.value)||0);r!=null&&r.checked&&s>0&&(t+=s*a.costo_unitario)}),!a.variantes||a.variantes.length===0){const i=parseInt(((o=document.getElementById("qty-orden-"+a.producto_id))==null?void 0:o.value)||a.cantidad_sugerida);t+=i*a.costo_unitario}});const n=document.getElementById("orden-total-general");n&&(n.textContent="$"+t.toFixed(0))};window.imprimirOrden=()=>{var s,d;const{seleccionados:e}=window._ordenModal||{};if(!e)return;const t=((s=document.getElementById("orden-fecha"))==null?void 0:s.value)||"",n=((d=document.getElementById("orden-notas"))==null?void 0:d.value)||"",a=new Date().toLocaleDateString("es-MX");let o="",i=0;e.forEach(l=>{var c;const p=l.variantes||[];if(p.length===0){const m=parseInt(((c=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:c.value)||l.cantidad_sugerida),f=m*l.costo_unitario;i+=f,o+=`<tr><td>${l.nombre}</td><td>${l.sku||""}</td><td>—</td><td>—</td><td style="text-align:center">${m}</td><td style="text-align:right">$${f.toFixed(0)}</td></tr>`}else p.forEach(m=>{var b;const f=document.getElementById("chk-var-"+m.id);if(!(f!=null&&f.checked))return;const u=parseInt(((b=document.getElementById("qty-var-"+m.id))==null?void 0:b.value)||0);if(u<=0)return;const y=u*l.costo_unitario;i+=y,o+=`<tr style="${m.sin_stock?"background:#fff5f5":""}">
...
<style>
  ...
  <script>window.onload = () => window.print()<\/script>
</body></html>`),r.document.close()};window.posponerProducto=(e,t)=>{const n=document.getElementById("modal-posponer");n&&n.remove();const a=document.createElement("div");a.id="modal-posponer",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.4);z-index:1100;display:flex;align-items:center;justify-content:center",a.innerHTML=`
    ...
    </div>`,a.addEventListener("click",o=>{o.target===a&&a.remove()}),document.body.appendChild(a)};window.aplicarPosponer=(e,t)=>{var o;const n=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}");let a=null;if(t!==null){const i=new Date;i.setDate(i.getDate()+t),a=i.toISOString().split("T")[0]}n[e]={hasta:a},localStorage.setItem("ordenes_pospuestos",JSON.stringify(n)),(o=document.getElementById("modal-posponer"))==null||o.remove(),L()};window.verPospuestos=()=>{const e=JSON.parse(localStorage.getItem("ordenes_pospuestos")||"{}"),{sugerencias:t}=window._ordenesData;new Date().toISOString().split("T")[0];const n=Object.entries(e).map(([o,i])=>{const r=i.nombre||o,s=i.hasta?"hasta "+i.hasta:"indefinido";return`• ${r} — ${s}`}).join(`
`);if(!n){alert("No hay productos pospuestos.");return}confirm(`Productos pospuestos:

`+n+`

¿Quieres reactivar todos?`)&&(localStorage.removeItem("ordenes_pospuestos"),L())};window.guardarOrdenCompra2=async()=>{var i,r,s,d;const{seleccionados:e,sucursalId:t}=window._ordenModal||{};if(!e)return;const n=(i=document.getElementById("orden-fecha"))==null?void 0:i.value,a=((r=document.getElementById("orden-notas"))==null?void 0:r.value)||"",o={};e.forEach(l=>{var f,u;const p=l.proveedor_id||"sin-proveedor",c=((f=l.proveedor)==null?void 0:f.nombre)||"Sin proveedor";o[p]||(o[p]={nombre:c,items:[]});const m=l.variantes||[];if(m.length===0){const y=parseInt(((u=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:u.value)||l.cantidad_sugerida);o[p].items.push({variante_id:null,cantidad:y,costo_unitario:l.costo_unitario})}else m.forEach(y=>{var v;const b=document.getElementById("chk-var-"+y.id);if(!(b!=null&&b.checked))return;const h=parseInt(((v=document.getElementById("qty-var-"+y.id))==null?void 0:v.value)||0);h<=0||o[p].items.push({variante_id:y.id,cantidad:h,costo_unitario:l.costo_unitario})})});try{for(const[l,p]of Object.entries(o)){if(p.items.length===0)continue;const c=p.items.reduce((y,b)=>y+b.cantidad*b.costo_unitario,0),u=(s=(await(await fetch(g+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:l==="sin-proveedor"?null:l,sucursal_id:t,status:"borrador",total:c,notas:a,fecha_entrega_estimada:n||null})})).json())[0])==null?void 0:s.id;if(u)for(const y of p.items)await fetch(g+"/finanzas/ordenes/"+u+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...y,subtotal:y.cantidad*y.costo_unitario})})}(d=document.getElementById("modal-orden"))==null||d.remove(),alert("Orden de compra guardada"),L()}catch(l){alert("Error guardando orden: "+l.message)}};function ce(){return`
  ...
  `}async function D(){var t,n,a,o,i,r;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando finanzas...</p>';try{const d=await(await fetch(g+"/sucursales/")).json(),l=(t=d[0])==null?void 0:t.id,[p,c,m,f,u,y,b]=await Promise.all([fetch(g+"/finanzas/caja/hoy/"+l),fetch(g+"/finanzas/reporte/"+l),fetch(g+"/finanzas/gastos/"+l),fetch(g+"/finanzas/estado-resultados/"+l),fetch(g+"/finanzas/flujo/"+l),fetch(g+"/finanzas/cuentas-por-cobrar"),fetch(g+"/finanzas/gastos-categorias/"+l)]),h=await p.json(),v=await c.json(),x=await m.json(),k=await f.json(),E=await u.json(),C=await y.json(),w=await b.json(),_=h.find(z=>z.status==="abierta"),I=new Date().toISOString().split("T")[0],T=x.filter(z=>{var j;return(j=z.created_at)==null?void 0:j.startsWith(I)}),S=T.reduce((z,j)=>z+parseFloat(j.monto||0),0),P=C.reduce((z,j)=>z+parseFloat(j.total||0),0);e.innerHTML=`
      ...
      <div style="background:${_?"#e8f5e9":"#ffebee"};border-radius:12px;padding:1.25rem;border:1px solid ${_?"#a5d6a7":"#ffcdd2"};margin-bottom:1.5rem;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
        ...
        ${_?`
          <div style="display:flex;gap:16px;flex-wrap:wrap">
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#2e7d32">$${(((n=E.hoy)==null?void 0:n.efectivo)||0).toFixed(0)}</p>
              <p style="font-size:0.65rem;color:#888">Efectivo</p>
            </div>
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#1565c0">$${(((a=E.hoy)==null?void 0:a.tarjeta)||0).toFixed(0)}</p>
    ...
    `,window._finanzasData={sucursalId:l,gastosHoy:T,totalGastosHoy:S,estadoResultados:k,flujo:E,cxc:C,categorias:w,historial:[]},window._finanzasSucursalId=l;const $=await(await fetch(g+"/finanzas/caja/historial/"+l)).json();window._finanzasData.historial=$,mostrarTabFinanzas("gastos")}catch(s){e.innerHTML='<p style="padding:2rem;color:red">Error cargando finanzas: '+s.message+"</p>"}}window.mostrarTabFinanzas=e=>{var p,c,m,f,u,y,b,h,v,x,k,E,C;const{gastosHoy:t,totalGastosHoy:n,estadoResultados:a,flujo:o,cxc:i,categorias:r,historial:s,sucursalId:d}=window._finanzasData,l=document.getElementById("fin-tab-contenido");if(l)if(e==="gastos"){const w=r.reduce((_,I)=>_+I.total,0);l.innerHTML=`
      ...
      <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
        ...
        <div style="padding:1rem 1.5rem;background:#f9f9f9;display:flex;gap:2rem;flex-wrap:wrap">
          <div>
            ...
            <p style="font-weight:700;color:#E91E8C">$${a.reduce((w,_)=>w+_.ventas,0).toFixed(0)}</p>
          </div>
          <div>
            <p style="font-size:0.72rem;color:#888">Total gastos 6 meses</p>
            <p style="font-weight:700;color:#c62828">$${a.reduce((w,_)=>w+_.gastos,0).toFixed(0)}</p>
          </div>
          <div>
            <p style="font-size:0.72rem;color:#888">Utilidad total</p>
            <p style="font-weight:700;color:#2e7d32">$${a.reduce((w,_)=>w+_.utilidad,0).toFixed(0)}</p>
          </div>
        </div>
      </div>
    `:e==="flujo"?l.innerHTML=`
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;margin-bottom:1rem">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f5f5f5">
            ...
            <span style="font-weight:700;color:#2e7d32">$${(((y=o.semana)==null?void 0:y.ingresos)||0).toFixed(0)}</span>
          </div>
          <div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f5f5f5">
            <span style="font-size:0.82rem;color:#888">Gastos</span>
            <span style="font-weight:700;color:#c62828">-$${(((b=o.semana)==null?void 0:b.gastos)||0).toFixed(0)}</span>
          </div>
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f5f5f5">
            <span style="font-size:0.82rem;color:#888">Gastos</span>
            <span style="font-weight:700;color:#c62828">-$${(((k=o.mes)==null?void 0:k.gastos)||0).toFixed(0)}</span>
          </div>
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            <span style="font-size:0.85rem;font-weight:700">Neto</span>
            <span style="font-weight:700;color:${(((E=o.mes)==null?void 0:E.neto)||0)>=0?"#2e7d32":"#c62828"};font-size:1.1rem">$${(((C=o.mes)==null?void 0:C.neto)||0).toFixed(0)}</span>
          </div>
        </div>
      </div>
    `:e==="caja"?l.innerHTML=`
    ...
    `:e==="cxc"&&mostrarCxC()};window.mostrarCxC=()=>{const{cxc:e}=window._finanzasData,t=document.getElementById("fin-tab-contenido");if(!t)return;const n=new Date;t.innerHTML=`
    <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
      <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee;display:flex;justify-content:space-between;align-items:center">
        <p style="font-weight:700;font-size:0.9rem">📑 Cuentas por cobrar</p>
        <span style="font-size:0.78rem;color:#888">${e.length} pendientes · $${e.reduce((a,o)=>a+parseFloat(o.total||0),0).toFixed(0)} total</span>
      </div>
      ${e.length===0?'<div style="padding:2rem;text-align:center;color:#888">Sin cuentas por cobrar</div>':e.map(a=>{var i,r;const o=Math.floor((n-new Date(a.created_at))/864e5);return`
            <div style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
              <div style="flex:1">
  ...
  `};window.abrirCaja=async e=>{var n;const t=prompt("¿Cuánto efectivo hay en caja para empezar? (fondo de caja)");if(t!==null)try{const o=await(await fetch(g+"/finanzas/caja/abrir",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sucursal_id:e,monto_apertura:parseFloat(t)||0,empleado:((n=window._empleadoActual)==null?void 0:n.nombre)||"Admin"})})).json();if(o.error){alert("Error: "+o.error);return}D()}catch{alert("Error abriendo caja")}};window.cerrarCaja=async e=>{var a,o;const t=prompt("¿Cuánto efectivo hay físicamente en caja al cerrar?");if(t===null)return;const n=prompt("Notas del cierre (opcional):")||"";try{const r=await(await fetch(g+"/finanzas/caja/"+e+"/cerrar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({monto_cierre:parseFloat(t)||0,notas:n})})).json();r.ok?(alert(`Caja cerrada.
...
Diferencia: $${(o=r.diferencia)==null?void 0:o.toFixed(2)}`),D()):alert("Error: "+JSON.stringify(r))}catch{alert("Error cerrando caja")}};window.agregarGasto=e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",t.innerHTML=`
  ...
  `,document.body.appendChild(t),t.addEventListener("click",n=>{n.target===t&&t.remove()})};window.guardarGasto=async(e,t)=>{var i;const n=document.getElementById("gasto-concepto").value,a=document.getElementById("gasto-monto").value,o=document.getElementById("gasto-categoria").value;if(!n||!a){alert("Completa concepto y monto");return}try{await fetch(g+"/finanzas/gastos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sucursal_id:e,concepto:n,monto:parseFloat(a),categoria:o,empleado:((i=window._empleadoActual)==null?void 0:i.nombre)||"Admin"})}),t.closest('div[style*="position:fixed"]').remove(),D()}catch{alert("Error guardando gasto")}};window.eliminarGasto=async e=>{if(confirm("¿Eliminar este gasto?"))try{await fetch(g+"/finanzas/gastos/"+e,{method:"DELETE"}),D()}catch{alert("Error eliminando gasto")}};async function Z(){const e=document.getElementById("content");try{const n=await(await fetch(g+"/finanzas/proveedores")).json();e.innerHTML=`
    ...
    `}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando proveedores</p>'}}window.mostrarFormProveedor=e=>{const t=e||{},n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",n.innerHTML=`
  ...
  `,document.body.appendChild(n),n.addEventListener("click",a=>{a.target===n&&n.remove()})};window.guardarProveedor=async e=>{const t={nombre:document.getElementById("prov-nombre").value,contacto:document.getElementById("prov-contacto").value,telefono:document.getElementById("prov-telefono").value,email:document.getElementById("prov-email").value,ciudad:document.getElementById("prov-ciudad").value,direccion:document.getElementById("prov-direccion").value,notas:document.getElementById("prov-notas").value};if(!t.nombre){alert("El nombre es requerido");return}try{e?await fetch(g+"/finanzas/proveedores/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):await fetch(g+"/finanzas/proveedores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),document.querySelector('div[style*="position:fixed"]').remove(),Z()}catch{alert("Error guardando proveedor")}};window.editarProveedor=async e=>{const a=(await(await fetch(g+"/finanzas/proveedores")).json()).find(o=>o.id===e);a&&mostrarFormProveedor(a)};async function pe(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando análisis...</p>';try{const[t,n,a,o]=await Promise.all([fetch(g+"/productos/"),fetch(g+"/variantes/"),fetch(g+"/movimientos/"),fetch(g+"/inventario/")]),i=await t.json(),r=await n.json(),s=await a.json(),d=await o.json(),l=new Date,p=new Date(l-30*24*60*60*1e3),c=new Date(l-60*24*60*60*1e3),m=new Date(l-90*24*60*60*1e3),f={};s.filter(b=>b.tipo==="venta").forEach(b=>{const h=r.find(E=>E.id===b.variante_id);if(!h)return;const v=h.producto_id;f[v]||(f[v]={d30:0,d60:0,d90:0});const x=new Date(b.created_at),k=Math.abs(b.cantidad);x>=p&&(f[v].d30+=k),x>=c&&(f[v].d60+=k),x>=m&&(f[v].d90+=k)});const u=i.map(b=>{const h=f[b.id]||{d30:0,d60:0,d90:0},v=d.filter(w=>r.find(_=>_.id===w.variante_id&&_.producto_id===b.id)).reduce((w,_)=>w+_.cantidad,0),x=h.d30/4,k=x>0?Math.round(v/x*7):null;let E="gris",C="Sin ventas recientes";return h.d30>=6?(E="verde",C="Rota bien — considerar resurtido"):h.d30>=2?(E="amarillo",C="Rotacion moderada"):h.d90===0&&v>0?(E="rojo",C="Sin movimiento en 90 dias — revisar"):h.d30>0&&(E="amarillo",C="Rotacion lenta"),{...b,ventas:h,stockTotal:v,ventasSemana:x,diasInventario:k,semaforo:E,recomendacion:C}}).sort((b,h)=>h.ventas.d30-b.ventas.d30),y={verde:{bg:"#e8f5e9",color:"#2e7d32",texto:"🟢 Rota bien"},amarillo:{bg:"#fff8e1",color:"#f57f17",texto:"🟡 Rotacion lenta"},rojo:{bg:"#ffebee",color:"#c62828",texto:"🔴 Sin movimiento"},gris:{bg:"#f5f5f5",color:"#888",texto:"⚪ Sin datos"}};e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:12px;margin-bottom:2rem">
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#E91E8C">${u.reduce((b,h)=>b+h.ventas.d30,0)}</p>
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#E91E8C">${u.reduce((b,h)=>b+h.ventas.d90,0)}</p>
          <p style="font-size:0.75rem;color:#aaa">pares</p>
        </div>
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          <p style="font-size:0.72rem;color:#888;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:6px">Rotan bien</p>
          <p style="font-size:1.8rem;font-weight:700;color:#2e7d32">${u.filter(b=>b.semaforo==="verde").length}</p>
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          ...
          <p style="font-size:1.8rem;font-weight:700;color:#c62828">${u.filter(b=>b.semaforo==="rojo").length}</p>
          <p style="font-size:0.75rem;color:#aaa">modelos</p>
        </div>
      </div>
  ...
  <button class="btn btn-secondary" style="padding:4px 10px;font-size:0.75rem;background:#ffebee;border-color:#c62828;color:#c62828" onclick="filtrarRotacion('rojo')">🔴 Sin movimiento</button>
        ...
        <div id="rotacion-lista">
          ${u.map(b=>{const h=y[b.semaforo];return`
    ...
    `,window._rotacionData=u}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando análisis</p>'}}window.filtrarRotacion=e=>{document.querySelectorAll(".rotacion-item").forEach(t=>{t.style.display=e==="todos"||t.dataset.semaforo===e?"":"none"})};async function Y(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando CRM...</p>';try{const[t,n,a]=await Promise.all([fetch(g+"/clientes/"),fetch(g+"/pedidos/"),fetch(g+"/crm/seguimientos/pendientes/todos")]),o=await t.json(),i=await n.json(),r=await a.json(),s=new Date,d=new Date(s-30*24*60*60*1e3),l=new Date(s-60*24*60*60*1e3),p=new Date(s-90*24*60*60*1e3),c=o.map(v=>{const x=i.filter(I=>I.cliente_id===v.id&&(I.status==="confirmado"||I.status==="pagado")),k=x.reduce((I,T)=>I+parseFloat(T.total||0),0),E=x.length>0?new Date(x[0].created_at):null,C=E?Math.floor((s-E)/(1e3*60*60*24)):null,w=x.filter(I=>new Date(I.created_at)>=d).length;let _="nuevo";return x.length===0?_="nuevo":k>=5e3&&w>=1?_="vip":C>90?_="inactivo":C>30?_="riesgo":w>=2?_="frecuente":_="activo",{...v,totalGastado:k,ultimoPedido:E,diasSinComprar:C,pedidos30:w,segmento:_,totalPedidos:x.length}}),m=c.filter(v=>v.segmento==="vip"),f=c.filter(v=>v.segmento==="riesgo").sort((v,x)=>x.totalGastado-v.totalGastado),u=c.filter(v=>v.segmento==="inactivo").sort((v,x)=>x.totalGastado-v.totalGastado),y=[...c].sort((v,x)=>x.totalGastado-v.totalGastado).slice(0,10),b=i.filter(v=>new Date(v.created_at).toDateString()===s.toDateString()&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,x)=>v+parseFloat(x.total||0),0),h=i.filter(v=>new Date(v.created_at)>=d&&(v.status==="confirmado"||v.status==="pagado")).reduce((v,x)=>v+parseFloat(x.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
    ...
    `,window._crmData={clientes:c,pedidos:i,recordatorios:r}}catch(t){e.innerHTML='<p style="padding:2rem;color:red">Error cargando CRM: '+t.message+"</p>"}}window.mostrarSegmento=e=>{const{clientes:t}=window._crmData||{};if(!t)return;const n=t.filter(i=>i.segmento===e).sort((i,r)=>r.totalGastado-i.totalGastado),a={vip:"⭐ Clientes VIP",riesgo:"🟡 En riesgo",inactivo:"🔴 Inactivos",frecuente:"🟢 Frecuentes"},o=document.getElementById("crm-segmento-detalle");o.style.display="block",o.innerHTML=`
    <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
      <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee;display:flex;justify-content:space-between;align-items:center">
        <p style="font-weight:700;font-size:0.9rem">${a[e]||e} (${n.length})</p>
  ...
  `,o.scrollIntoView({behavior:"smooth"})};window.completarRecordatorio=async e=>{try{await fetch(g+"/crm/seguimientos/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({completado:!0})}),Y()}catch{alert("Error al completar recordatorio")}};window.mostrarPipeline=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando pipeline...</p>';try{const n=await(await fetch(g+"/crm/oportunidades")).json(),a=[{id:"contacto",label:"📞 Contacto",color:"#e3f2fd",colorText:"#1565c0"},{id:"interes",label:"👀 Interés",color:"#f3e5f5",colorText:"#6a1b9a"},{id:"cotizacion",label:"📋 Cotización",color:"#fff8e1",colorText:"#f57f17"},{id:"negociacion",label:"🤝 Negociación",color:"#fce4f3",colorText:"#E91E8C"},{id:"ganado",label:"✅ Ganado",color:"#e8f5e9",colorText:"#2e7d32"},{id:"perdido",label:"❌ Perdido",color:"#ffebee",colorText:"#c62828"}];e.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:12px">
        ${a.map(o=>{const i=n.filter(s=>s.etapa===o.id),r=i.reduce((s,d)=>s+parseFloat(d.monto_estimado||0),0);return`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.remove()})};window.buscarClienteOportunidad=e=>{const{clientes:t}=window._crmData||{};if(!t)return;const n=document.getElementById("op-cliente-resultados");if(!e||e.length<2){n.style.display="none";return}const a=t.filter(o=>o.nombre.toLowerCase().includes(e.toLowerCase())).slice(0,5);if(!a.length){n.style.display="none";return}n.style.display="block",n.innerHTML=a.map(o=>`
  ...
  `).join("")};window.seleccionarClienteOportunidad=(e,t)=>{document.getElementById("op-cliente-id").value=e,document.getElementById("op-cliente-buscar").value=t,document.getElementById("op-cliente-resultados").style.display="none"};window.guardarOportunidad=async()=>{const e=document.getElementById("op-titulo").value,t=document.getElementById("op-cliente-id").value,n=document.getElementById("op-monto").value,a=document.getElementById("op-etapa").value,o=document.getElementById("op-fecha").value,i=document.getElementById("op-notas").value;if(!e){alert("El título es requerido");return}try{await fetch(g+"/crm/oportunidades",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({titulo:e,cliente_id:t||null,monto_estimado:parseFloat(n)||0,etapa:a,fecha_cierre_estimada:o||null,notas:i})}),document.getElementById("modal-oportunidad").remove(),mostrarPipeline()}catch{alert("Error guardando oportunidad")}};async function H(e,t=!1){const n=document.getElementById("content");try{const o=await(await fetch(g+"/productos/")).json(),i=o.filter(p=>p.activo),r=o.filter(p=>!p.activo),s=t?r:i;console.log("mostrarInactivos:",t,"base:",s.length,"inactivos:",r.length);const d=[...new Set(i.map(p=>p.categoria).filter(Boolean))],l=e?s.filter(p=>p.categoria===e):s;n.innerHTML=`
    ...
    `}catch{n.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.cargarProductos=H;window.mostrarCampanas=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando campañas...</p>';try{const[t,n]=await Promise.all([fetch(g+"/clientes/"),fetch(g+"/pedidos/")]),a=await t.json(),o=await n.json(),i=new Date,r=new Date(i-30*24*60*60*1e3),s=new Date(i-90*24*60*60*1e3),d=a.map(c=>{const m=o.filter(v=>v.cliente_id===c.id&&(v.status==="confirmado"||v.status==="pagado")),f=m.reduce((v,x)=>v+parseFloat(x.total||0),0),u=m.length>0?new Date(m[0].created_at):null,y=u?Math.floor((i-u)/(1e3*60*60*24)):null,b=m.filter(v=>new Date(v.created_at)>=r).length;let h="nuevo";return m.length===0?h="nuevo":f>=5e3&&b>=1?h="vip":y>90?h="inactivo":y>30?h="riesgo":b>=2?h="frecuente":h="activo",{...c,totalGastado:f,diasSinComprar:y,segmento:h}}).filter(c=>c.telefono);window._campanaClientes=d;const l=[{id:"catalogo",nombre:"👠 Catálogo completo",descripcion:"Envía el catálogo completo de productos",mensaje:c=>`Hola ${c}! 👋
...
`},{id:"catalogo_interactivo",nombre:"🛍️ Catálogo interactivo (API)",descripcion:"Envía hasta 30 productos como tarjetas comprables desde WhatsApp",mensaje:()=>"[Mensaje interactivo — tarjetas de producto del catálogo]"}],p=[{id:"todos",label:"Todos los clientes",count:d.length},{id:"vip",label:"⭐ VIP",count:d.filter(c=>c.segmento==="vip").length},{id:"frecuente",label:"🟢 Frecuentes",count:d.filter(c=>c.segmento==="frecuente").length},{id:"riesgo",label:"🟡 En riesgo",count:d.filter(c=>c.segmento==="riesgo").length},{id:"inactivo",label:"🔴 Inactivos",count:d.filter(c=>c.segmento==="inactivo").length},{id:"mayoreo",label:"📦 Mayoreo",count:d.filter(c=>c.tipo==="mayoreo").length},{id:"zapateria",label:"🏪 Corridas",count:d.filter(c=>c.tipo==="zapateria").length},{id:"menudeo",label:"🛍️ Menudeo",count:d.filter(c=>c.tipo==="menudeo").length}];e.innerHTML=`
    ...
    `,window._plantillasCampana=l,window._campanaImagenUrl="",actualizarVistaCampana(),cargarProductosCampana()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando campañas</p>'}};window.actualizarVistaCampana=()=>{var m,f,u,y;const e=((m=document.querySelector('input[name="campana-segmento"]:checked'))==null?void 0:m.value)||"todos",t=((f=document.querySelector('input[name="campana-plantilla"]:checked'))==null?void 0:f.value)||"catalogo",n=(u=window._plantillasCampana)==null?void 0:u.find(b=>b.id===t),a=window._campanaClientes||[],o=document.getElementById("mensaje-personalizado");o&&(o.style.display=t==="personalizado"?"block":"none");let i=a;e!=="todos"&&(["menudeo","mayoreo","zapateria"].includes(e)?i=a.filter(b=>b.tipo===e):i=a.filter(b=>b.segmento===e)),t==="nuevos"&&cargarFotosNuevosModelos(),t==="catalogo_interactivo"&&cargarProductosInteractivo();const r=document.getElementById("campana-foto-manual");r&&(r.style.display=t==="nuevos"||t==="catalogo_interactivo"?"none":"block");const s=document.getElementById("campana-fotos-nuevos");s&&(s.style.display=t==="nuevos"?"block":"none");const d=document.getElementById("campana-productos-interactivo");d&&(d.style.display=t==="catalogo_interactivo"?"block":"none");const l=document.getElementById("mensaje-preview");if(l){if(t==="catalogo_interactivo")l.style.background="#e3f2fd",l.style.borderColor="#90caf9",l.style.color="#1565c0",l.textContent=`🛍️ Los productos seleccionados se enviarán como tarjetas interactivas en WhatsApp.

El cliente puede ver cada modelo, elegir talla/color y hacer su pedido directamente desde el chat.

⚠️ Requiere que los productos estén en el catálogo de Meta Commerce.`;else if(l.style.background="#e8f5e9",l.style.borderColor="#a5d6a7",l.style.color="#333",n){let b;t==="personalizado"?b=(((y=document.getElementById("texto-personalizado"))==null?void 0:y.value)||"").replace("{nombre}","María"):b=n.mensaje("María"),l.textContent=b}}const p=document.getElementById("campana-count");p&&(p.textContent=i.length+" clientes");const c=document.getElementById("campana-lista");if(c){if(!i.length){c.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No hay clientes en este segmento con teléfono registrado</div>';return}window._campanaFiltrados=i,window._campanaPlantillaId=t,c.innerHTML=i.map((b,h)=>{var E;let v;t==="personalizado"?v=(((E=document.getElementById("texto-personalizado"))==null?void 0:E.value)||"").replace("{nombre}",b.nombre.split(" ")[0]):v=n.mensaje(b.nombre.split(" ")[0]);const x=encodeURIComponent(v),k=(b.lada||"52")+b.telefono.replace(/\D/g,"");return`
      <div class="campana-cli-row" data-idx="${h}" style="padding:0.75rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:12px;transition:background 0.15s">
        <input type="checkbox" class="campana-cli-check" data-idx="${h}"
        ...
        <a href="https://wa.me/${k}?text=${x}" target="_blank"
    ...
    `}).join(""),actualizarContadorCampana()}};window.actualizarContadorCampana=()=>{const t=document.querySelectorAll(".campana-cli-check:checked").length;document.querySelectorAll("#campana-sel-count, #campana-sel-count-auto").forEach(i=>{i&&(i.textContent=t)});const n=document.getElementById("btn-campana-seleccionados"),a=document.getElementById("btn-campana-auto");n&&(n.style.display=t>0?"inline-flex":"none"),a&&(a.style.display=t>0?"inline-flex":"none"),document.querySelectorAll(".campana-cli-check").forEach(i=>i.disabled=!1);const o=document.getElementById("campana-sel-todos");if(o){const i=document.querySelectorAll(".campana-cli-check").length;o.checked=t>0&&t===i,o.indeterminate=t>0&&t<i}};window.filtrarClientesCampana=e=>{var s;const t=(e||"").toLowerCase().trim(),n=window._campanaFiltrados||[],a=window._campanaPlantillaId||"catalogo",o=(s=window._plantillasCampana)==null?void 0:s.find(d=>d.id===a),i=document.getElementById("campana-lista");if(!i)return;const r=t?n.filter(d=>d.nombre.toLowerCase().includes(t)||(d.telefono||"").includes(t)):n;if(!r.length){i.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No se encontraron clientes</div>';return}i.innerHTML=r.map(d=>{var f;const l=n.indexOf(d);let p;a==="personalizado"?p=(((f=document.getElementById("texto-personalizado"))==null?void 0:f.value)||"").replace("{nombre}",d.nombre.split(" ")[0]):p=o?o.mensaje(d.nombre.split(" ")[0]):"";const c=encodeURIComponent(p),m=(d.lada||"52")+d.telefono.replace(/\D/g,"");return`
    ...
    `}).join("")};window.cargarFotosNuevosModelos=async()=>{const e=document.getElementById("campana-fotos-nuevos-grid");if(document.getElementById("campana-fotos-count"),!!e)try{const n=await(await fetch(g+"/productos/?activo=eq.true&imagen_principal=not.is.null&select=id,nombre,sku_interno,imagen_principal&order=created_at.desc&limit=20")).json();if(window._campanaFotosNuevos=n,!n.length){e.innerHTML='<p style="font-size:0.8rem;color:#aaa">No hay productos con foto portada</p>';return}e.innerHTML=n.map((a,o)=>`
      <div style="position:relative;cursor:pointer" onclick="toggleFotoNuevo(${o}, this)">
        <img src="${a.imagen_principal}" style="width:72px;height:72px;object-fit:cover;border-radius:8px;border:3px solid #E91E8C;display:block">
        ...
        <p style="font-size:0.6rem;color:#666;text-align:center;margin-top:3px;max-width:72px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${a.nombre||a.sku_interno}</p>
      </div>
    `).join(""),window._campanaFotosSeleccionadas=new Set(n.map((a,o)=>o)),actualizarCountFotos()}catch{e&&(e.innerHTML='<p style="color:red;font-size:0.8rem">Error cargando fotos</p>')}};window.toggleFotoNuevo=(e,t)=>{window._campanaFotosSeleccionadas||(window._campanaFotosSeleccionadas=new Set);const n=t.querySelector("img");document.getElementById("foto-check-"+e),window._campanaFotosSeleccionadas.has(e)?(window._campanaFotosSeleccionadas.delete(e),n.style.border="3px solid #ddd",t.querySelector("div").style.background="#ccc"):(window._campanaFotosSeleccionadas.add(e),n.style.border="3px solid #E91E8C",t.querySelector("div").style.background="#E91E8C"),actualizarCountFotos()};window.actualizarCountFotos=()=>{var n;const e=document.getElementById("campana-fotos-count");if(!e)return;const t=((n=window._campanaFotosSeleccionadas)==null?void 0:n.size)||0;e.textContent=t>0?`${t} foto${t>1?"s":""} seleccionada${t>1?"s":""} — se enviarán ${t} mensaje${t>1?"s":""} por cliente`:"Ninguna foto seleccionada"};window.cargarProductosCampana=async()=>{const e=document.getElementById("campana-producto-sel");if(e)try{const n=await(await fetch(g+"/productos/?activo=eq.true&select=id,nombre,sku_interno,imagen_principal&order=created_at.desc&limit=60")).json();e.innerHTML='<option value="">— Sin foto —</option>'+n.filter(a=>a.imagen_principal).map(a=>`<option value="${a.imagen_principal}" data-nombre="${a.nombre}">${a.nombre||a.sku_interno}</option>`).join("")}catch(t){console.error("Error cargando productos campana:",t)}};window.seleccionarProductoCampana=e=>{window._campanaImagenUrl=e||"";const t=document.getElementById("campana-foto-preview"),n=document.getElementById("campana-foto-img");t&&n&&(e?(n.src=e,t.style.display="block"):(t.style.display="none",n.src=""))};window.quitarFotoCampana=()=>{window._campanaImagenUrl="";const e=document.getElementById("campana-producto-sel");e&&(e.value="");const t=document.getElementById("campana-foto-preview");t&&(t.style.display="none")};window.cargarProductosInteractivo=async()=>{const e=document.getElementById("campana-prod-grid");if(e){if(window._campanaProdInteractivoCargado){renderizarProductosInteractivo(window._campanaProdInteractivo||[]);return}e.innerHTML='<p style="font-size:0.8rem;color:#aaa;padding:8px">Cargando...</p>';try{const n=await(await fetch(g+"/productos/?activo=eq.true&select=id,nombre,sku_interno,categoria,imagen_principal&order=nombre.asc&limit=300")).json();window._campanaProdInteractivo=n,window._campanaProdSeleccionados=new Set,window._campanaProdInteractivoCargado=!0,renderizarProductosInteractivo(n)}catch{e&&(e.innerHTML='<p style="color:red;font-size:0.8rem;padding:8px">Error cargando productos</p>')}}};window.renderizarProductosInteractivo=e=>{const t=document.getElementById("campana-prod-grid");if(!t)return;const n=window._campanaProdSeleccionados||new Set;if(!e.length){t.innerHTML='<p style="font-size:0.8rem;color:#aaa;padding:8px">No hay productos</p>';return}t.innerHTML=e.map(a=>{const o=a.sku_interno||a.id,i=n.has(o);return`<label style="display:flex;align-items:center;gap:8px;padding:5px 8px;border-radius:6px;cursor:pointer;border:1px solid ${i?"#E91E8C":"#f0f0f0"};background:${i?"#fff0f8":"white"};transition:all 0.1s" id="prod-lbl-${o}">
      ...
      <div style="min-width:0;flex:1">
        <p style="font-size:0.78rem;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${a.nombre||o}</p>
        <p style="font-size:0.68rem;color:#aaa">${o}${a.categoria?" · "+a.categoria:""}</p>
      </div>
    </label>`}).join(""),actualizarCountProdInteractivo()};window.toggleProdInteractivo=(e,t)=>{window._campanaProdSeleccionados||(window._campanaProdSeleccionados=new Set);const n=document.getElementById("prod-lbl-"+e);if(t.checked){if(window._campanaProdSeleccionados.size>=30){t.checked=!1,alert("Máximo 30 productos por mensaje interactivo");return}window._campanaProdSeleccionados.add(e),n&&(n.style.borderColor="#E91E8C",n.style.background="#fff0f8")}else window._campanaProdSeleccionados.delete(e),n&&(n.style.borderColor="#f0f0f0",n.style.background="white");actualizarCountProdInteractivo()};window.actualizarCountProdInteractivo=()=>{var n;const e=document.getElementById("campana-prod-count");if(!e)return;const t=((n=window._campanaProdSeleccionados)==null?void 0:n.size)||0;e.textContent=t>0?`${t}/30 producto${t>1?"s":""} seleccionado${t>1?"s":""}`:"Ningún producto seleccionado"};window.filtrarProductosInteractivo=e=>{const t=(e||"").toLowerCase().trim(),n=window._campanaProdInteractivo||[],a=t?n.filter(o=>(o.nombre||"").toLowerCase().includes(t)||(o.sku_interno||"").toLowerCase().includes(t)||(o.categoria||"").toLowerCase().includes(t)):n;renderizarProductosInteractivo(a)};window.enviarCatalogoInteractivo=async e=>{var i;const t=window._campanaFiltrados||[],n=Array.from(window._campanaProdSeleccionados||new Set);if(!n.length){alert("Selecciona al menos un producto");return}const a=e.map(r=>t[r]).filter(Boolean).map(r=>({telefono:r.telefono,nombre:r.nombre}));if(!a.length)return;const o=document.createElement("div");o.id="campana-auto-overlay",o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9999;display:flex;align-items:center;justify-content:center;padding:1rem",o.innerHTML=`<div style="background:white;border-radius:16px;padding:2rem;max-width:400px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
    <div style="font-size:2.5rem;margin-bottom:0.75rem">🛍️</div>
    <h3 style="font-size:1rem;font-weight:700;margin-bottom:0.5rem">Enviando catálogo interactivo…</h3>
    <p style="font-size:0.82rem;color:#888">${a.length} contacto${a.length>1?"s":""} · ${n.length} producto${n.length>1?"s":""}</p>
  </div>`,document.body.appendChild(o);try{const s=await(await fetch(g+"/envio-productos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contactos:a,skus:n,titulo:"Nuestros modelos 👠",cuerpo:"Mira los modelos disponibles. ¡Elige el tuyo!",pie:"Zapatillas May · León, Gto."})})).json();o.innerHTML=`<div style="background:white;border-radius:16px;padding:2.5rem;max-width:400px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
    ...
    </div>`}catch(r){o.remove(),alert("Error: "+r.message)}};window.enviarCampanaAutomatica=async()=>{var l,p;const e=document.querySelectorAll(".campana-cli-check:checked"),t=Array.from(e).map(c=>parseInt(c.dataset.idx)),n=window._campanaFiltrados||[],a=window._campanaPlantillaId||"catalogo";if(a==="catalogo_interactivo")return enviarCatalogoInteractivo(t);const o=(l=window._plantillasCampana)==null?void 0:l.find(c=>c.id===a),i=window._campanaImagenUrl||"";let r=[];if(a==="nuevos"&&((p=window._campanaFotosNuevos)!=null&&p.length)){const c=window._campanaFotosSeleccionadas||new Set;r=window._campanaFotosNuevos.filter((m,f)=>c.has(f)).map(m=>m.imagen_principal)}else i&&(r=[i]);const s=t.map(c=>n[c]).filter(Boolean).map(c=>{var f;let m;return a==="personalizado"?m=(((f=document.getElementById("texto-personalizado"))==null?void 0:f.value)||"").replace("{nombre}",c.nombre.split(" ")[0]):m=o.mensaje(c.nombre.split(" ")[0]),{nombre:c.nombre,telefono:c.telefono,lada:c.lada||"52",mensaje:m}});if(!s.length)return;const d=document.createElement("div");d.id="campana-auto-overlay",d.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9999;display:flex;align-items:center;justify-content:center;padding:1rem",d.innerHTML=`
      ...
      <p style="font-size:0.82rem;color:#888">Conectando con WhatsApp Business</p>
        ...
        <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
          ...
          <div style="display:flex;gap:1rem;justify-content:center">
            <div style="text-align:center">
              <p style="font-size:1.5rem;font-weight:700;color:#25D366">${k}</p>
          ...
          ${v>0&&((C=h.resultados)!=null&&C.length)?`
            <div style="margin-top:1rem;max-height:120px;overflow-y:auto;border-top:1px solid #f5f5f5;padding-top:0.75rem">
        ...
        </div>`};window._campanaJobId=f;const b=setInterval(async()=>{try{const v=await(await fetch(g+"/campanas/estado/"+f)).json();y(v),v.terminado&&(clearInterval(b),setTimeout(()=>{const x=v.enviados||0,k=v.fallidos||0;d.innerHTML=`
              <div style="background:white;border-radius:16px;padding:2.5rem;max-width:400px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
                <div style="font-size:3.5rem;margin-bottom:1rem">${k===0?"🎉":"✅"}</div>
                ...
                ${k>0?`<p style="color:#e53e3e;font-size:0.8rem;margin-bottom:1rem">${k} fallaron (ventana de 24h cerrada — esos clientes no han escrito recientemente)</p>`:'<p style="font-size:0.8rem;color:#888;margin-bottom:1rem">¡Todo perfecto!</p>'}
                <button onclick="document.getElementById('campana-auto-overlay').remove()"
    ...
    `};window._campanaAvanzar=()=>{if(r++,r>=i.length){s.innerHTML=`
      ...
      `;return}d()},d(),document.body.appendChild(s)};async function me(){const e=document.getElementById("content");try{const[t,n]=await Promise.all([fetch(g+"/clientes/"),fetch(g+"/pedidos/")]),a=await t.json(),o=await n.json(),i=new Date,r=new Date(i-30*24*60*60*1e3),s=new Date(i-90*24*60*60*1e3),d=a.map(f=>{const u=o.filter(w=>w.cliente_id===f.id&&(w.status==="confirmado"||w.status==="pagado")),y=u.reduce((w,_)=>w+parseFloat(_.total||0),0),b=u.length>0?new Date(u[0].created_at):null,h=u.filter(w=>new Date(w.created_at)>=r).length,v=b?Math.floor((i-b)/(1e3*60*60*24)):null;let x="nuevo",k="⚪ Nuevo",E="#f5f5f5",C="#888";return u.length===0?(x="nuevo",k="⚪ Sin compras",E="#f5f5f5",C="#888"):y>=5e3&&h>=1?(x="vip",k="⭐ VIP",E="#fff8e1",C="#f57f17"):v>90?(x="inactivo",k="🔴 Inactivo",E="#ffebee",C="#c62828"):v>30?(x="riesgo",k="🟡 En riesgo",E="#fff8e1",C="#f57f17"):h>=2?(x="frecuente",k="🟢 Frecuente",E="#e8f5e9",C="#2e7d32"):(x="activo",k="🔵 Activo",E="#e3f2fd",C="#1565c0"),{...f,totalGastado:y,ultimoPedido:b,pedidos30:h,diasSinComprar:v,segmento:x,segmentoLabel:k,segmentoBg:E,segmentoColor:C,totalPedidos:u.length}}).sort((f,u)=>u.totalGastado-f.totalGastado),l=d.filter(f=>f.segmento==="vip").length,p=d.filter(f=>f.segmento==="inactivo").length,c=d.filter(f=>f.segmento==="riesgo").length,m=d.filter(f=>f.segmento==="frecuente"||f.segmento==="activo").length;window._clientesData=d,e.innerHTML=`
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
    ...
    `}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}async function fe(){const e=document.getElementById("content");try{const n=await(await fetch(g+"/sucursales/")).json(),o=await(await fetch(g+"/productos/")).json(),r=await(await fetch(g+"/variantes/")).json(),d=await(await fetch(g+"/inventario/")).json();window._invData={sucursales:n,productos:o,variantes:r,inventario:d},e.innerHTML=`
  <div style="margin-bottom:1.5rem">
...
`,renderInventario()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.renderInventario=()=>{const{sucursales:e,productos:t,variantes:n,inventario:a}=window._invData,o=(document.getElementById("inv-buscar")?document.getElementById("inv-buscar").value:"").toLowerCase(),i=document.getElementById("inv-categoria")?document.getElementById("inv-categoria").value:"",r=document.getElementById("inv-talla")?document.getElementById("inv-talla").value:"",s=document.getElementById("inv-estado")?document.getElementById("inv-estado").value:"",d=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],l=t.filter(m=>!(!m.activo||o&&!m.nombre.toLowerCase().includes(o)&&!(m.sku_interno||"").toLowerCase().includes(o)||i&&m.categoria!==i)),p=e.map(m=>{const f=a.filter(y=>y.sucursal_id===m.id),u=l.map(y=>{const b=n.filter(k=>k.producto_id===y.id);if(b.length===0)return"";const v=[...new Set(b.map(k=>k.color).filter(Boolean))].map(k=>{const E=b.filter(I=>I.color===k).sort((I,T)=>d.indexOf(I.talla)-d.indexOf(T.talla));if(r&&!E.find(I=>I.talla===r))return"";const C=E[0]?E[0].color_hex:"#888",w=E[0]?E[0].foto_url:null,_=E.map(I=>{const T=f.find(z=>z.variante_id===I.id),S=T?T.cantidad:null,P=T?T.stock_minimo:3;if(r&&I.talla!==r||s&&(s==="agotado"&&S!==0||s==="bajo"&&(S===null||S===0||S>P)||s==="disponible"&&(S===null||S===0||S<=P)))return"";let A,$;return S===null?(A="#f0f0f0",$="#aaa"):S===0?(A="#ffebee",$="#c62828"):S<=P?(A="#fff8e1",$="#f57f17"):(A="#e8f5e9",$="#2e7d32"),`
          ...
          <div style="background:#fafafa;border-radius:12px;padding:1rem;margin-bottom:10px;border:1px solid #eee">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
              ${w?`<img src="${w}" style="width:52px;height:52px;object-fit:cover;border-radius:8px;border:1px solid #eee;flex-shrink:0">`:`<div style="width:52px;height:52px;background:${C};border-radius:8px;border:1px solid #eee;flex-shrink:0;opacity:0.7"></div>`}
              <div style="display:flex;align-items:center;gap:8px">
        ...
        `:""}).join("");if(!v.trim())return"";const x=y.imagen_principal;return`
    ...
    `:""}).join(""),c=document.getElementById("inv-contenido");c&&(c.innerHTML=p||'<div style="text-align:center;padding:3rem;color:#888"><p>No hay inventario registrado</p></div>')};window.cambiarStockInventario=async(e,t,n,a,o)=>{const i=Math.max(0,n+o);try{if((await fetch(g+"/inventario/actualizar",{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:i,stock_minimo:a})})).ok){const s=document.getElementById("stock-"+e+"-"+t);if(s){s.textContent=i;let p;i===0?p="#c62828":i<=a?p="#f57f17":p="#2e7d32",s.style.color=p}const d=window._invData.inventario.find(p=>p.variante_id===e&&p.sucursal_id===t);d&&(d.cantidad=i),document.querySelectorAll(`button[onclick*="${e}"][onclick*="${t}"]`).forEach(p=>{p.setAttribute("onclick",p.getAttribute("onclick").replace(/cambiarStockInventario\('[^']+', '[^']+', \d+,/,`cambiarStockInventario('${e}', '${t}', ${i},`))})}}catch{alert("Error actualizando stock")}};window.editarStock=async(e,t,n,a)=>{const o=prompt("Nueva cantidad:",n);if(o===null)return;const i=prompt("Stock minimo de alerta:",a);if(i!==null)try{if((await fetch(g+"/inventario/actualizar",{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:parseInt(o),stock_minimo:parseInt(i)})})).ok){const s=await fetch(g+"/inventario/");window._invData.inventario=await s.json(),renderInventario()}}catch{alert("Error conectando con el servidor")}};window.mostrarFormInventario=async()=>{const t=await(await fetch(g+"/sucursales/")).json(),a=await(await fetch(g+"/variantes/")).json();window._variantesCache=a;const o=document.getElementById("content");o.innerHTML=`
  ...
  `};window.guardarInventario=async()=>{const e=document.getElementById("inv-sucursal").value,t=document.getElementById("inv-v").value,n=document.getElementById("inv-cantidad").value,a=document.getElementById("inv-minimo").value||3;if(!e||!t||n===""){alert("Por favor completa todos los campos");return}try{(await fetch(g+"/inventario/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sucursal_id:e,variante_id:t,cantidad:parseInt(n),stock_minimo:parseInt(a)})})).ok?(alert("Stock guardado correctamente"),navegarA("inventario")):alert("Error al guardar stock")}catch{alert("Error conectando con el servidor")}};window.mostrarAlertas=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando alertas...</p>';try{const n=await(await fetch(g+"/inventario/alertas")).json();e.innerHTML=`
      ...
      ${n.length===0?'<div class="table-card" style="padding:3rem;text-align:center;color:#888"><p>Todo el inventario esta en buen nivel</p></div>':`<div class="table-card"><table>
          ...
          <tbody>
            ${n.map(a=>{const o=a.cantidad||0,i=a.stock_minimo||3,r=o===0;return`
                <tr style="background:${r?"#fff5f5":"#fffdf0"}">
                  ...
                  <td><button class="btn btn-primary" style="padding:4px 10px;font-size:0.75rem" onclick="editarStock('${a.variante_id}', '${a.sucursal_id}', ${o}, ${i})">Reabastecer</button></td>
                </tr>
              `}).join("")}
          </tbody></table></div>`}
    `}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando alertas</p>'}};window.mostrarAjuste=async()=>{const t=await(await fetch(g+"/sucursales/")).json(),a=await(await fetch(g+"/variantes/")).json();window._variantesCache=a;const o=document.getElementById("content");o.innerHTML=`
    <div class="table-card" style="padding:2rem;max-width:600px">
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem">
        <button class="btn btn-secondary" onclick="navegarA('inventario')">← Volver</button>
  ...
  `};window.guardarAjuste=async()=>{const e=document.getElementById("aj").value,t=document.getElementById("aj-sucursal").value,n=document.getElementById("aj-cantidad").value,a=document.getElementById("aj-motivo").value;if(!e||!t||n===""){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(g+"/movimientos/ajuste",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:parseInt(n),motivo:a})})).json();i.ok?(alert("Ajuste guardado. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarCambio=async()=>{const t=await(await fetch(g+"/sucursales/")).json(),a=await(await fetch(g+"/variantes/")).json();window._variantesCache=a;const o=document.getElementById("content");o.innerHTML=`
  ...
  `};window.guardarCambio=async()=>{const e=document.getElementById("cam-origen").value,t=document.getElementById("cam-destino").value,n=document.getElementById("cam-sucursal").value,a=document.getElementById("cam-motivo").value;if(!e||!t||!n){alert("Por favor selecciona ambos productos y la sucursal");return}if(e===t){alert("El producto que regresa y el que se lleva deben ser diferentes");return}try{const i=await(await fetch(g+"/movimientos/cambio",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_origen_id:e,variante_destino_id:t,sucursal_id:n,motivo:a})})).json();i.ok?(alert("Cambio registrado. El inventario se actualizo automaticamente."),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.buscarVariante=(e,t)=>{const n=window._variantesCache||[],a=document.getElementById(t+"-resultados");if(!a)return;if(!e||e.length<2){a.style.display="none";return}const o=e.toLowerCase().split(" ").filter(s=>s),i=n.filter(s=>{const d=(s.productos&&s.productos.nombre||"").toLowerCase(),l=(s.color||"").toLowerCase(),p=(s.talla||"").toLowerCase(),c=(s.sku||"").toLowerCase(),m=d+" "+l+" "+p+" "+c;return o.every(f=>m.includes(f))}).slice(0,15);if(i.length===0){a.innerHTML='<div style="padding:10px 14px;color:#888;font-size:0.85rem">No se encontraron resultados</div>',a.style.display="block";return}const r=t==="ped-prod";a.innerHTML=i.map(s=>{const d=(s.productos&&s.productos.nombre||"")+" - "+s.color+" - T"+s.talla;return`
    ...
    `}).join(""),a.style.display="block"};window.seleccionarVariante=(e,t,n)=>{const a=document.getElementById(n);a&&(a.value=e);const o=document.getElementById(n+"-seleccionado");o&&(o.textContent="Ô£ô "+t,o.style.display="block");const i=document.getElementById(n+"-resultados");i&&(i.style.display="none")};function N(e,t){const n=t||{},a=!t;let o="";n.imagenes&&n.imagenes.length>0?o=n.imagenes.map((s,d)=>{const l=d===0;return`<div style="position:relative;cursor:pointer" data-url="${s}" data-es-portada="${l}" data-file-idx="${d}">
  <img src="${s}" style="width:72px;height:72px;object-fit:cover;border-radius:10px;border:3px solid ${l?"#E91E8C":"#eee"}" onclick="seleccionarPortadaExistente(${e}, ${d})">
      ...
      </div>`}).join(""):n.foto_url&&(o=`<div style="position:relative" data-url="${n.foto_url}" data-es-portada="true" data-file-idx="0">
    ...
    </div>`);const i=n.imagenes&&n.imagenes[0]||n.foto_url||"",r=i?`<img src="${i}" style="width:36px;height:36px;object-fit:cover;border-radius:6px;border:1px solid #eee;flex-shrink:0">`:'<div style="width:36px;height:36px;background:#f0f0f0;border-radius:6px;border:2px dashed #ddd;display:flex;align-items:center;justify-content:center;font-size:1rem;color:#ccc;flex-shrink:0">📷</div>';return`
    <div class="variante-item" id="variante-${e}" style="margin-bottom:0.625rem;border-radius:12px;border:1px solid #eee;box-shadow:0 1px 4px rgba(0,0,0,0.05);overflow:hidden">
      ...
      <div id="v${e}-body" style="display:${a?"block":"none"};padding:1rem;background:#fafafa;border-top:1px solid #f0f0f0">
        ...
        <div style="display:flex;gap:10px;align-items:center;margin-bottom:0.75rem;flex-wrap:wrap">
          <input type="color" id="v${e}-hex" value="${n.color_hex||"#000000"}"
  ...
  `}window.eliminarColorVariante=async(e,t)=>{const n=document.getElementById("v"+e+"-nombre"),a=n?n.value:null;if(a&&window._productoEditandoId&&window._coloresExistentes){if(!confirm("Eliminar el color "+a+" y todas sus variantes?"))return;try{const r=(await(await fetch(g+"/variantes/producto/"+window._productoEditandoId)).json()).filter(s=>s.color===a);for(const s of r)await fetch(g+"/variantes/"+s.id+"/eliminar",{method:"POST",headers:{"Content-Type":"application/json"}});window._coloresExistentes=window._coloresExistentes.filter(s=>s.color!==a),window._coloresEliminados||(window._coloresEliminados=[]),window._coloresEliminados.push(a),alert("Color eliminado correctamente")}catch{alert("Error eliminando el color");return}}t.closest(".variante-item").remove(),actualizarTablaStock()};window.eliminarFotoExistente=(e,t)=>{const n=t.parentElement,a=n.dataset.url,o=document.getElementById("v"+e+"-preview");n.remove();const i=document.getElementById("v"+e+"-nombre");if(i&&window._coloresExistentes){const r=i.value,s=window._coloresExistentes.find(d=>d.color===r);s&&(s.imagenes&&(s.imagenes=s.imagenes.filter(d=>d!==a)),s.foto_url===a&&(s.foto_url=s.imagenes&&s.imagenes.length>0?s.imagenes[0]:null))}if(n.dataset.esPortada==="true"&&o){const r=o.querySelector("div[data-url]");if(r){r.dataset.esPortada="true",r.querySelector("img").style.border="2px solid #E91E8C";const s=document.createElement("span");s.className="portada-badge",s.style.cssText="position:absolute;top:-6px;left:-6px;background:#E91E8C;color:white;font-size:0.55rem;padding:1px 4px;border-radius:100px;pointer-events:none",s.textContent="PORTADA",r.appendChild(s)}}};window.seleccionarPortadaExistente=(e,t)=>{const n=document.getElementById("v"+e+"-preview");if(!n)return;n.querySelectorAll(".portada-badge").forEach(o=>o.remove()),n.querySelectorAll("img").forEach(o=>o.style.border="2px solid #ddd"),n.querySelectorAll("[data-es-portada]").forEach(o=>o.dataset.esPortada="false");const a=n.querySelectorAll("div[data-file-idx]");if(a[t]){a[t].dataset.esPortada="true",a[t].querySelector("img").style.border="2px solid #E91E8C";const o=document.createElement("span");o.className="portada-badge",o.style.cssText="position:absolute;top:-6px;left:-6px;background:#E91E8C;color:white;font-size:0.55rem;padding:1px 4px;border-radius:100px;pointer-events:none",o.textContent="PORTADA",a[t].appendChild(o)}};window.mostrarFormProducto=e=>{e||(window._coloresExistentes=null),R=window._coloresExistentes&&window._coloresExistentes.length>0?window._coloresExistentes.length:1;const t=e||{},n=document.getElementById("content");R=window._coloresExistentes&&window._coloresExistentes.length>0?window._coloresExistentes.length:1,e||(window._coloresExistentes=null),n.innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem">
        <div>
          ...
          <select class="form-input" id="f-categoria" required onchange="actualizarSKU()">
            ...
            ${se.map(a=>`<option value="${a.value}" ${t.categoria===a.value?"selected":""}>${a.label}</option>`).join("")}
          </select>
        </div>
        <div>
  ...
  <div style="background:#e8f5e9;border-radius:8px;padding:1rem;margin-bottom:1rem;border:1px solid #a5d6a7">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap">
      ${window._coloresExistentes.map((a,o)=>`
...
<div id="variantes-container">
  ${window._coloresExistentes&&window._coloresExistentes.length>0?window._coloresExistentes.map((a,o)=>N(o,a)).join(""):N(0,null)}
</div>
  ...
  `,fetch(g+"/sucursales/").then(a=>a.json()).then(a=>{const o=document.getElementById("f-sucursal-stock");o&&(o.innerHTML=a.map(i=>`<option value="${i.id}">${i.nombre}</option>`).join("")),setTimeout(()=>actualizarTablaStock(),100)})};window.seleccionarColorPortada=e=>{if(!window._coloresExistentes)return;const t=window._coloresExistentes.splice(e,1)[0];window._coloresExistentes.unshift(t),document.querySelectorAll('[id^="portada-color-"]').forEach((a,o)=>{const i=o===0;a.style.borderColor=i?"#2e7d32":"#ddd",a.style.background=i?"#e8f5e9":"white",a.innerHTML=`
    ...
    `,a.setAttribute("onclick","seleccionarColorPortada("+o+")")});const n=document.getElementById("variantes-container");n&&(n.innerHTML=window._coloresExistentes.map((a,o)=>N(o,a)).join(""))};const Q=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-").replace(/^-+|-+$/g,"");window.actualizarSKU=async()=>{const e=document.getElementById("f-nombre")?document.getElementById("f-nombre").value:"",t=document.getElementById("f-categoria")?document.getElementById("f-categoria").value:"",n=document.getElementById("f-proveedor")?document.getElementById("f-proveedor").value:"",a=document.getElementById("f-sku");if(a&&!a.value&&e&&t&&n)try{const i=await(await fetch(g+"/productos/siguiente-sku/"+t+"/"+encodeURIComponent(n))).json();a.value=i.sku_base}catch{}if(e){const o=document.getElementById("f-slug");o&&!o.value&&(o.value=Q(e));const i=document.getElementById("f-metatitulo");i&&!i.value&&(i.value=e.trim()+" | Zapatillas May")}};window.regenerarSKU=async()=>{const e=document.getElementById("f-categoria")?document.getElementById("f-categoria").value:"",t=document.getElementById("f-proveedor")?document.getElementById("f-proveedor").value:"";if(e&&t)try{const a=await(await fetch(g+"/productos/siguiente-sku/"+e+"/"+encodeURIComponent(t))).json(),o=document.getElementById("f-sku");o&&(o.value=a.sku_base)}catch{}else alert("Selecciona categoria y escribe el proveedor primero")};function ge(e,t,n,a,o,i,r){const s=document.getElementById("f-slug"),d=document.getElementById("f-metatitulo"),l=document.getElementById("f-metadesc");s&&!s.value&&(s.value=Q(e)),d&&!d.value&&(d.value=e+" | Zapatillas May");const p=["Compra "+e+" en Zapatillas May."];if(t){const m=t.split(/[.!?\n]/)[0].trim();m.length>10&&p.push(m.slice(0,65)+(m.length>65?"...":""))}else if(n){const m={sandalia:"Sandalia elegante para dama",bota:"Bota de moda para dama",tenis:"Tenis casual para dama",mocasin:"Mocasín cómodo para dama",zapatilla:"Zapatilla de moda para dama",plataforma:"Plataforma cómoda para dama"};p.push((m[n]||n)+".")}a&&p.push("Material "+a+"."),o&&i?p.push("Tacón "+i+" "+o+" cm."):o&&p.push("Tacón "+o+" cm."),r&&p.push("Desde $"+parseInt(r).toLocaleString("es-MX")+" MXN."),p.push("Envío a todo México.");let c=p.join(" ");c.length>160&&(c=c.slice(0,157)+"..."),l&&ee(c)}function ee(e){const t=document.getElementById("f-metadesc");if(t){t.value=e;const n=document.getElementById("metadesc-counter");n&&(n.textContent=e.length+"/160",n.style.color=e.length>160?"#c62828":e.length>140?"#e65100":"#4caf50")}}window.generarSEO=async()=>{var l,p,c,m,f,u,y,b;const e=(((l=document.getElementById("f-nombre"))==null?void 0:l.value)||"").trim(),t=(((p=document.getElementById("f-descripcion"))==null?void 0:p.value)||"").trim(),n=(((c=document.getElementById("f-categoria"))==null?void 0:c.value)||"").trim(),a=(((m=document.getElementById("f-material"))==null?void 0:m.value)||"").trim(),o=(((f=document.getElementById("f-tacon"))==null?void 0:f.value)||"").trim(),i=(((u=document.getElementById("f-tipotacon"))==null?void 0:u.value)||"").trim(),r=(((y=document.getElementById("f-menudeo"))==null?void 0:y.value)||"").trim(),s=(((b=document.getElementById("f-horma"))==null?void 0:b.value)||"").trim();if(!e&&!t){alert("Escribe el nombre o la descripción del producto primero");return}const d=document.getElementById("btn-generar-seo");d&&(d.innerHTML='<span style="display:inline-block;animation:spin 0.8s linear infinite">⏳</span> Analizando...',d.disabled=!0,d.style.opacity="0.7");try{const v=await(await fetch(g+"/productos/generar-seo",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({nombre:e,descripcion:t,categoria:n,material:a,tacon:o,tipo_tacon:i,precio:r,horma:s})})).json();if(v.error)throw new Error(v.error);const x=document.getElementById("f-slug"),k=document.getElementById("f-metatitulo");if(x&&v.slug&&(x.value=v.slug),k&&v.meta_titulo&&(k.value=v.meta_titulo),v.meta_descripcion&&ee(v.meta_descripcion),v.nombre_producto&&e!==v.nombre_producto){const E=document.getElementById("f-nombre");if(E){let C=document.getElementById("seo-nombre-sugerido");C||(C=document.createElement("div"),C.id="seo-nombre-sugerido",C.style.cssText="margin-top:6px;padding:8px 12px;background:#f3e5f5;border-radius:8px;border:1px solid #ce93d8;font-size:0.78rem;color:#6a1b9a;display:flex;align-items:center;justify-content:space-between;gap:8px",E.parentElement.appendChild(C)),C.dataset.sugerido=v.nombre_producto,C.innerHTML="<span>✨ Nombre sugerido para la tienda: <strong>"+v.nombre_producto+`</strong></span><button onclick="var p=this.closest('#seo-nombre-sugerido');document.getElementById('f-nombre').value=p.dataset.sugerido;p.remove()" style="background:#6a1b9a;color:white;border:none;border-radius:6px;padding:3px 10px;cursor:pointer;font-size:0.75rem;white-space:nowrap">Usar este</button>`}}d&&(d.innerHTML="✅ SEO generado con IA",d.style.background="#e8f5e9",d.style.color="#2e7d32",d.style.borderColor="#a5d6a7",d.style.opacity="1",d.disabled=!1,setTimeout(()=>{d.innerHTML="✨ Generar SEO",d.style.background="",d.style.color="",d.style.borderColor=""},3e3))}catch{ge(e,t,n,a,o,i,r),d&&(d.innerHTML="✅ SEO generado",d.style.background="#fff8e1",d.style.color="#f57f17",d.style.borderColor="#ffe082",d.style.opacity="1",d.disabled=!1,setTimeout(()=>{d.innerHTML="✨ Generar SEO",d.style.background="",d.style.color="",d.style.borderColor=""},3e3))}};window.seleccionarColor=(e,t,n)=>{const a=document.getElementById("v"+e+"-hex"),o=document.getElementById("v"+e+"-nombre");if(a){a.value=t;const i=document.getElementById("v"+e+"-swatch-header");i&&(i.style.background=t)}if(o){o.value=n;const i=document.getElementById("v"+e+"-header-label");i&&(i.textContent=n)}actualizarTablaStock()};window.toggleVariante=e=>{const t=document.getElementById("v"+e+"-body"),n=document.getElementById("v"+e+"-chevron");if(!t)return;const a=t.style.display!=="none";t.style.display=a?"none":"block",n&&(n.style.transform=a?"rotate(0deg)":"rotate(180deg)")};window.agregarVariante=()=>{document.querySelectorAll(".variante-item").forEach(o=>{const i=o.id&&o.id.match(/^variante-(\d+)$/);if(i){const r=i[1],s=document.getElementById("v"+r+"-body"),d=document.getElementById("v"+r+"-chevron");s&&(s.style.display="none"),d&&(d.style.transform="rotate(0deg)")}});const e=R++,t=document.getElementById("variantes-container"),n=document.createElement("div");n.innerHTML=N(e,null),t.appendChild(n.firstElementChild);const a=document.getElementById("variante-"+e);a&&setTimeout(()=>a.scrollIntoView({behavior:"smooth",block:"nearest"}),60)};window.previsualizarImagenes=(e,t)=>{const n=document.getElementById("v"+t+"-preview");n&&(n.querySelectorAll("[data-existente]"),Array.from(e.files).forEach((a,o)=>{const i=new FileReader;i.onload=r=>{const s=document.createElement("div");s.style.cssText="position:relative;cursor:pointer",s.dataset.fileIdx=o,s.innerHTML=`
      ...
      `,n.appendChild(s),n.querySelectorAll(".portada-badge").length===0&&seleccionarPortada(t,s.querySelector("img"))},i.readAsDataURL(a)}))};window.seleccionarPortada=(e,t)=>{const n=document.getElementById("v"+e+"-preview");if(!n)return;n.querySelectorAll(".portada-badge").forEach(o=>o.remove()),n.querySelectorAll("img").forEach(o=>o.style.border="2px solid #ddd"),t.style.border="2px solid #E91E8C";const a=document.createElement("span");a.className="portada-badge",a.style.cssText="position:absolute;top:-6px;left:-6px;background:#E91E8C;color:white;font-size:0.55rem;padding:1px 4px;border-radius:100px;pointer-events:none",a.textContent="PORTADA",t.parentElement.appendChild(a),t.parentElement.dataset.esPortada="true",n.querySelectorAll("[data-es-portada]").forEach(o=>{o!==t.parentElement&&delete o.dataset.esPortada})};window.toggleDescuento=()=>{const e=document.getElementById("f-descuento"),t=document.getElementById("descuento-pct");e&&t&&(t.style.display=e.checked?"flex":"none")};window.toggleTalla=e=>{const t=e.closest(".talla-label");e.checked?(t.style.borderColor="#E91E8C",t.style.background="#fce4f3"):(t.style.borderColor="transparent",t.style.background="#f5f5f5"),actualizarTablaStock()};window.actualizarTablaStock=()=>{const e=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],t=[...document.querySelectorAll(".talla-label input:checked")].map(i=>i.value).sort((i,r)=>e.indexOf(i)-e.indexOf(r)),n=document.querySelectorAll(".variante-item"),a=[];n.forEach(i=>{const r=i.id.replace("variante-",""),s=document.getElementById("v"+r+"-nombre"),d=document.getElementById("v"+r+"-hex");s&&s.value&&a.push({nombre:s.value,hex:d?d.value:"#000",id:r})});const o=document.getElementById("stock-inicial-container");if(o){if(t.length===0||a.length===0){o.innerHTML='<p style="color:#888;font-size:0.85rem">Selecciona tallas y agrega colores para ver la tabla de stock inicial</p>';return}o.innerHTML=a.map(i=>`
    <div style="background:#f9f9f9;border-radius:10px;padding:1rem;margin-bottom:1rem;border:1px solid #eee">
  ...
  `).join("")}};window.actualizarTotalColor=e=>{const t=document.querySelectorAll('[id^="stock-ini-'+e+'-"]');let n=0;t.forEach(o=>n+=parseInt(o.value)||0);const a=document.getElementById("total-color-"+e);a&&(a.textContent=n)};async function be(){const e=document.querySelectorAll(".variante-item"),t=[];for(const n of e){const a=n.id.replace("variante-",""),o=document.getElementById("v"+a+"-hex"),i=document.getElementById("v"+a+"-nombre"),r=document.getElementById("v"+a+"-imgs"),s=document.getElementById("v"+a+"-preview");if(!i||!i.value)continue;const d=[];if(s&&s.querySelectorAll("div[data-url]").forEach(l=>{const p=l.dataset.url;p&&!d.includes(p)&&d.push(p)}),r&&r.files.length>0){const l=s?s.querySelector('[data-es-portada="true"]'):null,p=l?parseInt(l.dataset.fileIdx):0,c=Array.from(r.files),m=[...c.filter((f,u)=>u===p),...c.filter((f,u)=>u!==p)];for(const f of m){const u=new FormData;u.append("archivo",f);try{const b=await(await fetch(g+"/imagenes/subir",{method:"POST",body:u})).json();b.url&&d.push(b.url)}catch{}}}t.push({color:i.value,color_hex:o?o.value:"#000000",imagenes:d})}return t}window.guardarProducto=async()=>{const e=document.getElementById("f-producto-id")?document.getElementById("f-producto-id").value:"";e&&(window._productoEditandoId=e);const t=document.getElementById("f-nombre")?document.getElementById("f-nombre").value:"",n=document.getElementById("f-costo")?document.getElementById("f-costo").value:"",a=document.getElementById("f-menudeo")?document.getElementById("f-menudeo").value:"",o=document.getElementById("f-categoria")?document.getElementById("f-categoria").value:"";if(!t||!n||!a||!o){alert("Por favor completa los campos obligatorios: Nombre, Categoria, Costo y Precio menudeo");return}const i=document.getElementById("btn-guardar");i&&(i.textContent="Guardando...",i.disabled=!0);const r=[...document.querySelectorAll(".talla-label input:checked")].map(m=>m.value),s=await be(),d=[];document.querySelectorAll(".variante-item").forEach(m=>{const f=m.id.replace("variante-",""),u=document.getElementById("v"+f+"-nombre"),y=document.getElementById("v"+f+"-hex");u&&u.value&&d.push({id:f,nombre:u.value,hex:y?y.value:"#000"})});const l=document.getElementById("f-peso")?document.getElementById("f-peso").value:"",p=l?Math.round(parseFloat(l)*1e3):null,c={nombre:t,sku_interno:document.getElementById("f-sku")&&document.getElementById("f-sku").value||null,marca:document.getElementById("f-marca")&&document.getElementById("f-marca").value||null,proveedor:document.getElementById("f-proveedor")&&document.getElementById("f-proveedor").value||null,categoria:o,subcategoria:document.getElementById("f-subcategoria")&&document.getElementById("f-subcategoria").value||null,descripcion:document.getElementById("f-descripcion")&&document.getElementById("f-descripcion").value||null,material:document.getElementById("f-material")&&document.getElementById("f-material").value||null,material_suela:document.getElementById("f-suela")&&document.getElementById("f-suela").value||null,forro:document.getElementById("f-forro")&&document.getElementById("f-forro").value||null,horma:document.getElementById("f-horma")&&document.getElementById("f-horma").value||null,altura_tacon:document.getElementById("f-tacon")&&document.getElementById("f-tacon").value?parseFloat(document.getElementById("f-tacon").value):null,tipo_tacon:document.getElementById("f-tipotacon")&&document.getElementById("f-tipotacon").value||null,costo:parseFloat(n),precio_menudeo:parseFloat(a),precio_mayoreo3:document.getElementById("f-mayoreo3")&&document.getElementById("f-mayoreo3").value?parseFloat(document.getElementById("f-mayoreo3").value):null,precio_mayoreo6:document.getElementById("f-mayoreo6")&&document.getElementById("f-mayoreo6").value?parseFloat(document.getElementById("f-mayoreo6").value):null,precio_corrida:document.getElementById("f-corrida")&&document.getElementById("f-corrida").value?parseFloat(document.getElementById("f-corrida").value):null,precio_antes:document.getElementById("f-antes")&&document.getElementById("f-antes").value?parseFloat(document.getElementById("f-antes").value):null,tiene_descuento:document.getElementById("f-descuento")?document.getElementById("f-descuento").checked:!1,porcentaje_descuento:document.getElementById("f-pct")&&document.getElementById("f-pct").value?parseInt(document.getElementById("f-pct").value):0,corrida_activa:document.getElementById("f-corrida-activa")?document.getElementById("f-corrida-activa").checked:!1,es_oferta:document.getElementById("f-oferta")?document.getElementById("f-oferta").checked:!1,tallas_disponibles:r,peso_gramos:p,slug:document.getElementById("f-slug")&&document.getElementById("f-slug").value?document.getElementById("f-slug").value.toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,""):null,meta_titulo:document.getElementById("f-metatitulo")&&document.getElementById("f-metatitulo").value||null,meta_descripcion:document.getElementById("f-metadesc")&&document.getElementById("f-metadesc").value||null,imagen_principal:s.length>0&&s[0].imagenes.length>0?s[0].imagenes[0]:null,activo:!0,nuevo:!window._productoEditandoId};try{console.log("Editando ID:",window._productoEditandoId);const m=window._productoEditandoId?"PATCH":"POST",f=window._productoEditandoId?g+"/productos/"+window._productoEditandoId:g+"/productos/",u=await fetch(f,{method:m,headers:{"Content-Type":"application/json"},body:JSON.stringify(c)});if(u.ok){const y=await u.json(),b=window._productoEditandoId||(y&&y.length>0?y[0].id:null);if(b&&s.length>0){const v=r.length>0?r:["Unica"];let x=[];window._productoEditandoId&&(x=await(await fetch(g+"/variantes/producto/"+b)).json(),window._coloresEliminados&&window._coloresEliminados.length>0&&(x=x.filter(C=>!window._coloresEliminados.includes(C.color))));const k=[];for(const E of s)for(const C of v){const w=x.find(_=>_.color.trim().toLowerCase()===E.color.trim().toLowerCase()&&_.talla===C);if(w){const _={color_hex:E.color_hex};_.foto_url=E.imagenes.length>0?E.imagenes[0]:null,_.imagenes=E.imagenes,k.push(fetch(g+"/variantes/"+w.id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(_)}))}else k.push(fetch(g+"/variantes/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({producto_id:b,color:E.color,color_hex:E.color_hex,talla:C,foto_url:E.imagenes[0]||null,imagenes:E.imagenes||[]})}).catch(_=>console.log("Variante ya existe:",E.color,C)))}await Promise.all(k)}console.log("Colores:",d),console.log("Tallas:",r),console.log("Sucursal stock:",document.getElementById("f-sucursal-stock")?document.getElementById("f-sucursal-stock").value:"no encontrado"),console.log("PID editando:",window._productoEditandoId);const h=document.getElementById("f-sucursal-stock")?document.getElementById("f-sucursal-stock").value:"";if(h&&b){const x=await(await fetch(g+"/variantes/producto/"+b)).json(),k=r.length>0?r:["Unica"];for(const E of d)for(const C of k){const w=C.replace(".","_"),_=document.getElementById("stock-ini-"+E.id+"-"+w),I=_&&parseInt(_.value)||0;if(I<=0)continue;const T=x.find(S=>S.color===E.nombre&&S.talla===C);T&&(window._productoEditandoId?await fetch(g+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:T.id,sucursal_id:h,cantidad:I,motivo:"Resurtido desde edicion de producto"})}):await fetch(g+"/inventario/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:T.id,sucursal_id:h,cantidad:I,stock_minimo:1})}))}}if(y&&y.error){alert("Error: "+y.error),i&&(i.textContent="Guardar producto",i.disabled=!1);return}alert("Producto guardado correctamente"),window._productoEditandoId=null,navegarA("productos")}else{const y=await u.text();alert("Error al guardar: "+y),i&&(i.textContent="Guardar producto",i.disabled=!1)}window._coloresEliminados=[]}catch{alert("Error conectando con el servidor"),i&&(i.textContent="Guardar producto",i.disabled=!1)}};window.editarProducto=async e=>{window._coloresEliminados=[],window._coloresExistentes=null,window._productoEditandoId=null;try{const[t,n]=await Promise.all([fetch(g+"/productos/"+e),fetch(g+"/variantes/producto/"+e)]),a=await t.json(),o=await n.json();if(!a||a.length===0){alert("Producto no encontrado");return}const i=[],r=new Set;o.filter(s=>s.producto_id===e).forEach(s=>{r.has(s.color)||(r.add(s.color),i.push({color:s.color,color_hex:s.color_hex,foto_url:s.foto_url,imagenes:s.imagenes||[]}))}),window._productoEditandoId=e,window._coloresExistentes=i.length>0?i:null,mostrarFormProducto(a[0])}catch{alert("Error cargando el producto")}};window.duplicarProducto=async e=>{try{const n=await(await fetch(g+"/productos/"+e)).json();if(n&&n.length>0){const a=Object.assign({},n[0]);delete a.id,delete a.created_at,delete a.updated_at,a.nombre=a.nombre+" (copia)",a.slug=a.slug?a.slug+"-copia":null,a.sku_interno=null,window._productoEditandoId=null,mostrarFormProducto(a)}}catch{alert("Error duplicando el producto")}};window.cargarProductosFiltro=e=>H(e,!1);window.filtrarProductos=()=>{const e=document.getElementById("prod-buscar").value.toLowerCase();document.querySelectorAll("#content tbody tr").forEach(n=>{const a=n.textContent.toLowerCase();n.style.display=a.includes(e)?"":"none"})};window.toggleProducto=async(e,t)=>{const n=t?"desactivar":"activar";if(confirm(t?"Desactivar este producto?":"Activar este producto?"))try{(await fetch(g+"/productos/"+e+"/"+n,{method:"PATCH",headers:{"Content-Type":"application/json"}})).ok?H():alert("Error al cambiar el estado")}catch{alert("Error conectando con el servidor")}};window.filtrarClientes=()=>{var i,r;const e=(((i=document.getElementById("cli-buscar"))==null?void 0:i.value)||"").toLowerCase().trim(),t=((r=document.getElementById("cli-tipo"))==null?void 0:r.value)||"",n=document.querySelectorAll(".cli-item");let a=0;n.forEach(s=>{const d=(s.dataset.nombre||"").toLowerCase(),l=s.dataset.tel||"",p=s.dataset.tipo||"",f=(!e||d.includes(e)||l.includes(e))&&(!t||p===t);s.style.display=f?"":"none",f&&a++});const o=document.getElementById("cli-count");o&&(o.textContent=a)};window.mostrarFormCliente=async e=>{const t=document.getElementById("content");let n={};if(e)try{const o=await(await fetch(g+"/clientes/"+e)).json();o&&o.length>0&&(n=o[0])}catch{}t.innerHTML=`
...
${n.telefono?'<a href="https://wa.me/'+(n.lada||"52")+n.telefono.replace(/\D/g,"")+'" target="_blank" class="btn btn-secondary" style="background:#25D366;color:white;border-color:#25D366;margin-left:auto">WhatsApp</a>':""}      </div>
  ...
  `};window.guardarCliente=async e=>{const t=document.getElementById("cli-nombre").value;if(!t){alert("El nombre del cliente es obligatorio");return}const n=document.getElementById("btn-cli-guardar");n&&(n.textContent="Guardando...",n.disabled=!0);const a={nombre:t,telefono:document.getElementById("cli-telefono").value||null,email:document.getElementById("cli-email").value||null,tipo:document.getElementById("cli-tipo").value,direccion:document.getElementById("cli-direccion").value||null,lada:document.getElementById("cli-lada").value||"52",ciudad:document.getElementById("cli-ciudad").value||null,estado:document.getElementById("cli-estado").value||null,codigo_postal:document.getElementById("cli-cp").value||null,limite_credito:parseFloat(document.getElementById("cli-credito").value)||0,dias_credito:parseInt(document.getElementById("cli-dias").value)||0,comentarios_internos:document.getElementById("cli-comentarios").value||null,activo:!0};try{const o=e?"PATCH":"POST",i=e?g+"/clientes/"+e:g+"/clientes/",r=await fetch(i,{method:o,headers:{"Content-Type":"application/json"},body:JSON.stringify(a)});if(r.ok)alert("Cliente guardado correctamente"),navegarA("clientes");else{const s=await r.text();alert("Error al guardar: "+s),n&&(n.textContent="Guardar cliente",n.disabled=!1)}}catch{alert("Error conectando con el servidor"),n&&(n.textContent="Guardar cliente",n.disabled=!1)}};window.verCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[n,a]=await Promise.all([fetch(g+"/clientes/"+e),fetch(g+"/pedidos/")]),o=await n.json(),i=await a.json();if(!o||o.length===0){alert("Cliente no encontrado");return}const r=o[0],s=i.filter(u=>u.cliente_id===e),d=s.filter(u=>u.status==="confirmado"||u.status==="pagado"),l=d.reduce((u,y)=>u+parseFloat(y.total||0),0),p=d.length>0?l/d.length:0,c=s.length>0?new Date(s[0].created_at):null,m=c?Math.floor((new Date-c)/(1e3*60*60*24)):null,f={};d.forEach(u=>{const y=new Date(u.created_at).toLocaleDateString("es-MX",{month:"short",year:"2-digit"});f[y]=(f[y]||0)+parseFloat(u.total||0)}),t.innerHTML=`
    ...
    `}catch{t.innerHTML='<p style="padding:2rem;color:red">Error cargando cliente</p>'}};window.guardarNotasCliente=async e=>{var n;const t=((n=document.getElementById("cli-notas-"+e))==null?void 0:n.value)||"";try{await fetch(g+"/clientes/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({comentarios_internos:t})});const a=document.querySelector(`button[onclick="guardarNotasCliente('${e}')"]`);a&&(a.textContent="✅ Guardado",setTimeout(()=>a.textContent="💾 Guardar notas",2e3))}catch{alert("Error guardando notas")}};window.editarCliente=e=>{mostrarFormCliente(e)};window.nuevoPedidoCliente=async(e,t)=>{await oe(),setTimeout(()=>{const n=document.getElementById("pos-cliente-buscar"),a=document.getElementById("pos-cliente"),o=document.getElementById("pos-cliente-seleccionado");n&&(n.value=""),a&&(a.value=e),o&&(o.textContent="✔ "+t+" — toca para cambiar",o.style.display="block");const i=document.getElementById("topbar-title");i&&(i.textContent="Punto de venta")},300)};window.verHistorialCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando historial...</p>';try{const o=(await(await fetch(g+"/pedidos/")).json()).filter(s=>s.cliente_id===e),i=o.length>0&&o[0].clientes?o[0].clientes:{},r=o.filter(s=>s.status==="confirmado"||s.status==="pagado").reduce((s,d)=>s+parseFloat(d.total||0),0);t.innerHTML=`
      <div class="table-card" style="padding:2rem">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;flex-wrap:wrap">
          <button class="btn btn-secondary" onclick="navegarA('clientes')">← Volver</button>
    ...
    `}catch{t.innerHTML='<p style="padding:2rem;color:red">Error cargando historial</p>'}};window.mostrarEntrada=async()=>{const t=await(await fetch(g+"/sucursales/")).json(),a=await(await fetch(g+"/variantes/")).json();window._variantesCache=a;const o=document.getElementById("content");o.innerHTML=`
    <div class="table-card" style="padding:2rem;max-width:600px">
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem">
        <button class="btn btn-secondary" onclick="navegarA('inventario')">← Volver</button>
  ...
  `};window.guardarEntrada=async()=>{const e=document.getElementById("ent").value,t=document.getElementById("ent-sucursal").value,n=document.getElementById("ent-cantidad").value,a=document.getElementById("ent-motivo").value;if(!e||!t||!n){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(g+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:parseInt(n),motivo:a})})).json();i.ok?(alert("Entrada guardada. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarSalida=async()=>{const t=await(await fetch(g+"/sucursales/")).json(),a=await(await fetch(g+"/variantes/")).json();window._variantesCache=a;const o=document.getElementById("content");o.innerHTML=`
    <div class="table-card" style="padding:2rem;max-width:600px">
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem">
        <button class="btn btn-secondary" onclick="navegarA('inventario')">← Volver</button>
  ...
  `};window.guardarSalida=async()=>{const e=document.getElementById("sal").value,t=document.getElementById("sal-sucursal").value,n=document.getElementById("sal-cantidad").value,a=document.getElementById("sal-motivo").value;if(!e||!t||!n){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(g+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:-parseInt(n),motivo:a})})).json();i.ok?(alert("Salida registrada. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const n=await(await fetch(g+"/sucursales/")).json(),o=await(await fetch(g+"/productos/")).json(),r=await(await fetch(g+"/variantes/")).json(),d=await(await fetch(g+"/inventario/")).json(),l=[...new Set(o.map(c=>c.categoria).filter(Boolean))],p=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:n,productos:o,variantes:r,inventario:d},e.innerHTML=`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr auto;gap:1rem;align-items:end">
          <div>
            ...
            <select class="form-input" id="im-sucursal" onchange="renderTablasMasivo()">
              ${n.map(c=>`<option value="${c.id}">${c.nombre}</option>`).join("")}
            </select>
          </div>
          <div>
            <label class="form-label">Categoria</label>
    ...
    `,renderTablasMasivo()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:e,variantes:t,inventario:n}=window._invMasivo,a=document.getElementById("im-sucursal").value,o=document.getElementById("im-categoria").value,i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],r=e.filter(p=>!(o&&p.categoria!==o)),s=n.filter(p=>p.sucursal_id===a),d=r.map(p=>{const c=t.filter(u=>u.producto_id===p.id);if(c.length===0)return"";const f=[...new Set(c.map(u=>u.color).filter(Boolean))].map(u=>{const y=c.filter(h=>h.color===u).sort((h,v)=>i.indexOf(h.talla)-i.indexOf(v.talla));return`
        <div style="margin-bottom:1rem">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap">
            ${y.map(h=>{const v=s.find(C=>C.variante_id===h.id),x=v?v.cantidad:0,k=v?v.stock_minimo:3;let E="#ddd";return x===0?E="#ffcdd2":x<=k?E="#ffe082":E="#a5d6a7",`
                <div style="text-align:center">
    ...
    `}).join(""),l=document.getElementById("im-tablas");l&&(l.innerHTML=d||'<div style="padding:2rem;text-align:center;color:#888">No hay productos en esta categoria</div>')};window.guardarInventarioMasivo=async()=>{const e=document.getElementById("im-sucursal").value,t=document.querySelectorAll("[data-variante]");let n=0,a=0,o=0;const i=document.querySelector('[onclick="guardarInventarioMasivo()"]');i&&(i.textContent="Guardando...",i.disabled=!0);for(const r of t){const s=r.dataset.variante,d=parseInt(r.dataset.anterior)||0,l=parseInt(r.value)||0;if(l===d){o++;continue}try{(await(await fetch(g+"/movimientos/ajuste",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:s,sucursal_id:e,cantidad:l,motivo:"Inventario masivo"})})).json()).ok?(n++,r.dataset.anterior=l,r.style.borderColor="#a5d6a7"):(a++,r.style.borderColor="#ffcdd2")}catch{a++}}i&&(i.textContent="Guardar todo",i.disabled=!1),a>0?alert(`Guardados: ${n}, Errores: ${a}, Sin cambios: ${o}`):alert(`Inventario actualizado. ${n} cambios guardados, ${o} sin cambios.`)};window.mostrarFormSucursal=async e=>{const t=document.getElementById("content");let n={};if(e)try{n=(await(await fetch(g+"/sucursales/")).json()).find(i=>i.id===e)||{}}catch{}t.innerHTML=`
    <div class="table-card" style="padding:2rem;max-width:600px">
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem">
  ...
  `};window.guardarSucursal=async e=>{const t=document.getElementById("suc-nombre").value;if(!t){alert("El nombre es obligatorio");return}const n={nombre:t,tipo:document.getElementById("suc-tipo").value,direccion:document.getElementById("suc-direccion").value||null,telefono:document.getElementById("suc-telefono").value||null};try{const a=e?"PATCH":"POST",o=e?g+"/sucursales/"+e:g+"/sucursales/";(await fetch(o,{method:a,headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).ok?(alert("Sucursal guardada"),navegarA("sucursales")):alert("Error al guardar")}catch{alert("Error conectando con el servidor")}};window.toggleSucursalDestino=(e,t)=>{const n=document.getElementById(e+"-sucursal-destino-container");n&&(n.style.display=t==="Traspaso entre sucursales"?"block":"none")};window.mostrarTraspaso=async()=>{const t=await(await fetch(g+"/sucursales/")).json(),a=await(await fetch(g+"/variantes/")).json();window._variantesCache=a;const o=document.getElementById("content");o.innerHTML=`
    <div class="table-card" style="padding:2rem;max-width:600px">
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem">
        <button class="btn btn-secondary" onclick="navegarA('inventario')">← Volver</button>
  ...
  `};window.guardarTraspaso=async()=>{const e=document.getElementById("tra").value,t=document.getElementById("tra-origen").value,n=document.getElementById("tra-destino").value,a=document.getElementById("tra-cantidad").value;if(!e||!t||!n||!a){alert("Por favor completa todos los campos");return}if(t===n){alert("La sucursal origen y destino no pueden ser la misma");return}try{const i=await(await fetch(g+"/movimientos/traspaso",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_origen_id:t,sucursal_destino_id:n,cantidad:parseInt(a)})})).json();i.ok?(alert("Traspaso realizado correctamente. Se movieron "+i.cantidad_movida+" pares."),navegarA("inventario")):alert("Error: "+(i.error||JSON.stringify(i)))}catch{alert("Error conectando con el servidor")}};async function te(){const e=document.getElementById("content");try{const n=await(await fetch(g+"/pedidos/")).json();e.innerHTML=`
      <div style="margin-bottom:1rem;display:flex;gap:8px;flex-wrap:wrap;align-items:center">
      ...
      <div class="table-card">
        <table>
          ...
          <tbody>
            ${n.length===0?'<tr><td colspan="8" style="text-align:center;color:#888;padding:2rem">No hay pedidos</td></tr>':n.map(a=>{const o={borrador:"badge-warning",pendiente_pago:"badge-warning",confirmado:"badge-success",cancelado:"badge-danger",pagado:"badge-success"}[a.status]||"badge-warning";return`
                  <tr>
                    ...
                    <td><span class="badge ${o}">${a.status||"borrador"}</span></td>
    ...
    `,window._pedidosData=n}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.filtrarPedidos=()=>{const e=document.getElementById("ped-buscar").value.toLowerCase();document.querySelectorAll("#content tbody tr").forEach(n=>{const a=n.textContent.toLowerCase();n.style.display=a.includes(e)?"":"none"})};window.cargarPedidosFiltro=async e=>{document.getElementById("content");try{const n=await(await fetch(g+"/pedidos/")).json();let a=n;e==="pendiente_pago"?a=n.filter(o=>o.status==="pendiente_pago"):e==="credito"?a=n.filter(o=>o.forma_pago==="credito"):e&&(a=n.filter(o=>o.canal===e)),await te()}catch{}};window.mostrarFormPedido=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const n=await(await fetch(g+"/clientes/")).json(),o=await(await fetch(g+"/sucursales/")).json(),r=await(await fetch(g+"/productos/")).json(),d=await(await fetch(g+"/variantes/")).json();window._variantesCache=d,window._productosCache=r,window._pedidoItems=[],e.innerHTML=`
      <div class="table-card" style="padding:2rem">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem">
  ...
  `).join(""),window.recalcularTotal()}};window.cambiarCantidadItem=async(e,t)=>{if(t>0){const n=window._pedidoItems[e],a=document.getElementById("ped-sucursal")?document.getElementById("ped-sucursal").value:"";if(a)try{const r=(await(await fetch(g+"/inventario/sucursal/"+a)).json()).find(d=>d.variante_id===n.variante_id),s=r?r.cantidad:0;if(n.cantidad>=s){alert("No hay mas existencia disponible. Maximo: "+s+" pares");return}}catch{}}window._pedidoItems[e].cantidad=Math.max(1,window._pedidoItems[e].cantidad+t),window.recalcularTotal(),renderItemsPedido()};window.guardarPedido=async()=>{const e=document.getElementById("ped-cliente").value,t=document.getElementById("ped-canal").value,n=document.getElementById("ped-sucursal").value,a=document.getElementById("ped-pago").value,o=document.getElementById("ped-comentarios").value;if(!e){alert("Selecciona un cliente");return}if(window._pedidoItems.length===0){alert("Agrega al menos un producto");return}const i=document.getElementById("btn-ped-guardar");i&&(i.textContent="Guardando...",i.disabled=!0);const r=window._pedidoItems.reduce((d,l)=>d+l.cantidad*l.precio_unitario,0),s=a==="spei"?"pendiente_pago":"confirmado";try{const d=await fetch(g+"/pedidos/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cliente_id:e,canal:t,sucursal_id:n,forma_pago:a,comentarios:o||null,total:r,subtotal:r,status:s})});if(!d.ok){alert("Error creando pedido"),i&&(i.textContent="Crear pedido",i.disabled=!1);return}const p=(await d.json())[0].id;for(const c of window._pedidoItems)await fetch(g+"/pedidos/"+p+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:c.variante_id,cantidad:c.cantidad,precio_unitario:c.precio_unitario,subtotal:c.cantidad*c.precio_unitario})});a!=="spei"&&a!=="mercadopago"&&await fetch(g+"/pedidos/"+p+"/confirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({forma_pago:a})}),alert("Pedido creado correctamente"),window._pedidoItems=[],verPedido(p)}catch{alert("Error conectando con el servidor"),i&&(i.textContent="Crear pedido",i.disabled=!1)}};window.verPedido=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando pedido...</p>';try{const a=await(await fetch(g+"/pedidos/"+e)).json();if(!a||a.length===0){alert("Pedido no encontrado");return}const o=a[0],i=o.pedido_items||[],r=o.clientes||{},s={borrador:"#f57f17",pendiente_pago:"#f57f17",confirmado:"#2e7d32",pagado:"#2e7d32",cancelado:"#c62828"}[o.status]||"#888";t.innerHTML=`
      <div class="table-card" style="padding:2rem">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;flex-wrap:wrap">
          <button class="btn btn-secondary" onclick="navegarA('pedidos')">← Volver</button>
  ...
  <button class="btn btn-secondary" onclick="imprimirTicketPOS('${o.id}',${o.total},${o.pedido_items?o.pedido_items.reduce((d,l)=>d+l.cantidad,0):0},'${o.forma_pago||"efectivo"}')">Reimprimir ticket</button>
    ...
    `}catch{t.innerHTML='<p style="padding:2rem;color:red">Error cargando pedido</p>'}};window.cancelarPedido=async e=>{if(confirm("¿Cancelar este pedido? Si ya estaba confirmado se devolverá el stock automáticamente."))try{const n=await(await fetch(g+"/pedidos/"+e+"/cancelar",{method:"POST"})).json();n.ok?(alert(n.stock_devuelto?"Pedido cancelado. Stock devuelto al inventario.":"Pedido cancelado."),verPedido(e)):alert("Error: "+JSON.stringify(n))}catch{alert("Error conectando con el servidor")}};window.reconfirmarPedido=async e=>{if(confirm("¿Reconfirmar este pedido? Se descontará el stock del inventario nuevamente."))try{const n=await(await fetch(g+"/pedidos/"+e+"/reconfirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({})})).json();n.ok?(alert("Pedido reconfirmado correctamente."),verPedido(e)):alert("Error: "+JSON.stringify(n))}catch{alert("Error conectando con el servidor")}};window.confirmarPagoSPEI=async e=>{if(confirm("Confirmar que recibiste el pago por SPEI?"))try{const n=await(await fetch(g+"/pedidos/"+e+"/confirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({forma_pago:"spei"})})).json();n.ok?(alert("Pago confirmado. Inventario actualizado."),verPedido(e)):alert("Error: "+JSON.stringify(n))}catch{alert("Error conectando con el servidor")}};window.confirmarPedidoAdmin=async e=>{if(confirm("Confirmar este pedido? El inventario se descontara."))try{const n=await(await fetch(g+"/pedidos/"+e+"/confirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({forma_pago:"efectivo"})})).json();n.ok?(alert("Pedido confirmado correctamente."),verPedido(e)):alert("Error: "+JSON.stringify(n))}catch{alert("Error conectando con el servidor")}};window.recalcularTotal=()=>{const e=window._pedidoItems||[],t=e.reduce((o,i)=>o+i.cantidad,0);e.forEach(o=>{o.es_oferta?o.precio_unitario=o.precio_menudeo:t>=6?o.precio_unitario=o.precio_mayoreo6||o.precio_menudeo-70:t>=3?o.precio_unitario=o.precio_mayoreo3||o.precio_menudeo-30:o.precio_unitario=o.precio_menudeo});const n=e.reduce((o,i)=>o+i.cantidad*i.precio_unitario,0),a=document.getElementById("ped-total");a&&(a.textContent="$"+n.toFixed(2))};async function oe(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando punto de venta...</p>';try{const n=await(await fetch(g+"/productos/")).json(),o=await(await fetch(g+"/variantes/")).json(),r=await(await fetch(g+"/sucursales/")).json(),d=await(await fetch(g+"/clientes/")).json(),p=await(await fetch(g+"/inventario/")).json();window._posData={productos:n,variantes:o,sucursales:r,clientes:d,inventario:p},window._posCarrito=[],window._posClienteId=null,e.innerHTML=`
  ...
  <select class="form-input" id="pos-sucursal" style="width:100%" onchange="actualizarInventarioPOS()">
    ${r.map(c=>`<option value="${c.id}">${c.nombre}</option>`).join("")}
            ...
            <div style="display:flex;gap:6px;flex-wrap:wrap" id="pos-categorias">
              ...
              ${[...new Set(n.map(c=>c.categoria).filter(Boolean))].map(c=>`
    ...
    `,renderProductosPOS(n.filter(c=>c.activo))}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando punto de venta</p>'}}window.abrirDrawerPOS=()=>{renderDrawerPOS();const e=document.getElementById("pos-drawer"),t=document.getElementById("pos-drawer-overlay");e&&e.classList.add("open"),t&&t.classList.add("active"),document.body.style.overflow="hidden"};window.cerrarDrawerPOS=()=>{const e=document.getElementById("pos-drawer"),t=document.getElementById("pos-drawer-overlay");e&&e.classList.remove("open"),t&&t.classList.remove("active"),document.body.style.overflow=""};window.renderDrawerPOS=()=>{const e=window._posCarrito,t=document.getElementById("pos-drawer-items");if(!t)return;const n=e.reduce((c,m)=>c+m.cantidad,0),a=e.reduce((c,m)=>c+m.cantidad*m.precio_unitario,0),o=e.some(c=>c.es_corrida)?"Corrida":n>=6?"Mayoreo 6+":n>=3?"Mayoreo 3+":"Menudeo",i=document.getElementById("pos-drawer-pares"),r=document.getElementById("pos-drawer-total"),s=document.getElementById("pos-drawer-tipo");if(i&&(i.textContent=n),r&&(r.textContent="$"+a.toFixed(2)),s&&(s.textContent=o),!e.length){t.innerHTML='<p style="color:#888;text-align:center;padding:2rem">El carrito esta vacio</p>';return}const d=e.filter(c=>!c.es_corrida),l=e.filter(c=>c.es_corrida),p={};l.forEach(c=>{const m=c.producto_id+"|"+c.color;p[m]||(p[m]={nombre:c.nombre,color:c.color,producto_id:c.producto_id,tallas:[],subtotal:0,imagen:c.imagen||null}),p[m].tallas.push({talla:c.talla,cantidad:c.cantidad}),p[m].subtotal+=c.cantidad*c.precio_unitario}),t.innerHTML=`
  ...
  <div style="display:flex;gap:10px;margin-bottom:8px;align-items:start">
    ...
    `).join("")}
  `};window.cobrarPOSM=async()=>{const e=document.getElementById("pos-pago-m"),t=document.getElementById("pos-pago");e&&t&&(t.value=e.value),cerrarDrawerPOS(),await cobrarPOS()};window.buscarClientePOSM=e=>{const{clientes:t}=window._posData,n=document.getElementById("pos-cliente-resultados-m");if(!e||e.length<2){n.style.display="none";return}const a=t.filter(o=>o.nombre.toLowerCase().includes(e.toLowerCase())).slice(0,5);if(!a.length){n.style.display="none";return}n.style.display="block",n.innerHTML=a.map(o=>`
    <div onclick="seleccionarClientePOSM('${o.id}','${o.nombre}')"
         style="padding:8px 12px;cursor:pointer;border-bottom:1px solid #f5f5f5;font-size:0.85rem"
         onmouseover="this.style.background='#f5f5f5'" onmouseout="this.style.background='white'">
      <strong>${o.nombre}</strong>${o.telefono?" · "+o.telefono:""}
    </div>
  `).join("")};window.seleccionarClientePOSM=(e,t)=>{document.getElementById("pos-cliente").value=e,document.getElementById("pos-cliente-buscar-m").value="",document.getElementById("pos-cliente-resultados-m").style.display="none";const n=document.getElementById("pos-cliente-sel-m");n.textContent="✔ "+t+" — toca para cambiar",n.style.display="block"};window.limpiarClientePOSM=()=>{document.getElementById("pos-cliente").value="",document.getElementById("pos-cliente-sel-m").style.display="none",document.getElementById("pos-cliente-buscar-m").value=""};window.aplicarDescuentoPOS=e=>{const t=parseFloat(e)||0;window._posCarrito.forEach(i=>{const r=window._posCarrito.reduce((d,l)=>d+l.cantidad,0);let s;i.precio_base_original||(i.es_corrida?s=i.precio_corrida:r>=6?s=i.precio_mayoreo6:r>=3?s=i.precio_mayoreo3:s=i.precio_menudeo,i.precio_base_original=s),i.precio_unitario=Math.max(0,parseFloat((i.precio_base_original-t).toFixed(2))),i.precio_manual=t>0});const n=window._posCarrito.reduce((i,r)=>i+r.cantidad*r.precio_unitario,0),a=document.getElementById("pos-total");a&&(a.textContent="$"+n.toFixed(2));const o=document.getElementById("pos-descuento-info");if(o){const i=window._posCarrito.reduce((r,s)=>r+s.cantidad,0);o.textContent=t>0?`Ahorro total: $${(t*i).toFixed(2)} en ${i} pares`:""}renderCarritoPOS(),setTimeout(()=>{var l;const i=document.getElementById("pos-descuento");i&&(i.value=t);const r=document.getElementById("pos-descuento-m");r&&(r.value=t);const s=window._posCarrito.reduce((p,c)=>p+c.cantidad*c.precio_unitario,0),d=document.getElementById("pos-drawer-total");d&&(d.textContent="$"+s.toFixed(2)),(l=document.getElementById("pos-drawer"))!=null&&l.classList.contains("open")&&renderDrawerPOS()},50)};window.buscarClientePOS=e=>{const t=window._posData?window._posData.clientes:[],n=document.getElementById("pos-cliente-resultados");if(!n)return;if(!e||e.length<2){n.style.display="none";return}const a=t.filter(o=>o.nombre.toLowerCase().includes(e.toLowerCase())||(o.telefono||"").includes(e)).slice(0,8);if(a.length===0){n.innerHTML='<div style="padding:10px 14px;color:#888;font-size:0.85rem">No se encontraron clientes</div>',n.style.display="block";return}n.innerHTML=a.map(o=>`
  ...
  `).join(""),n.style.display="block"};window.seleccionarClientePOS=(e,t)=>{document.getElementById("pos-cliente").value=e,document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-resultados").style.display="none";const n=document.getElementById("pos-cliente-seleccionado");n.textContent="✔ "+t+" — toca para cambiar",n.style.display="block"};window.limpiarClientePOS=()=>{document.getElementById("pos-cliente").value="",document.getElementById("pos-cliente-seleccionado").style.display="none",document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-buscar").focus()};window.renderProductosPOS=e=>{const{variantes:t,inventario:n}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",o=n.filter(r=>r.sucursal_id===a),i=document.getElementById("pos-productos-grid");i&&(i.innerHTML=e.filter(r=>r.activo).map(r=>{const s=t.filter(p=>p.producto_id===r.id),d=[...new Set(s.map(p=>p.color).filter(Boolean))],l=s.reduce((p,c)=>{const m=o.find(f=>f.variante_id===c.id);return p+(m?m.cantidad:0)},0);return`
    ...
    `}).join(""))};window.buscarPOS=e=>{const{productos:t}=window._posData;if(!e){renderProductosPOS(t);return}const n=e.toLowerCase().split(" ").filter(o=>o),a=t.filter(o=>{const i=o.nombre.toLowerCase(),r=(o.sku_interno||"").toLowerCase(),s=(o.categoria||"").toLowerCase(),d=i+" "+r+" "+s;return n.every(l=>d.includes(l))});renderProductosPOS(a)};window.filtrarPOS=e=>{const{productos:t}=window._posData,n=e?t.filter(a=>a.categoria===e):t;renderProductosPOS(n),document.querySelectorAll("#pos-categorias button").forEach(a=>{a.className="btn btn-secondary",a.style.cssText="padding:4px 12px;font-size:0.8rem"}),event.target.className="btn btn-primary",event.target.style.cssText="padding:4px 12px;font-size:0.8rem"};window.actualizarInventarioPOS=async()=>{const e=document.getElementById("pos-sucursal").value;try{const t=await fetch(g+"/inventario/sucursal/"+e);window._posData.inventario=await t.json();const{productos:n}=window._posData;renderProductosPOS(n)}catch{}};window.abrirProductoPOS=e=>{const t=document.getElementById("pos-modal");t&&t.remove();const{productos:n,variantes:a,inventario:o}=window._posData,i=n.find(c=>c.id===e);if(!i)return;const r=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",s=o.filter(c=>c.sucursal_id===r),d=a.filter(c=>c.producto_id===e),l=[...new Set(d.map(c=>c.color).filter(Boolean))];window._posBuffer={};const p=document.createElement("div");p.id="pos-modal",p.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",p.innerHTML=`
    <div style="background:white;border-radius:16px;max-width:640px;width:100%;height:90vh;display:flex;flex-direction:column;overflow:hidden">
      ...
      <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
          ${l.map(c=>{const m=d.find(u=>u.color===c),f=d.filter(u=>u.color===c).reduce((u,y)=>{const b=s.find(h=>h.variante_id===y.id);return u+(b?b.cantidad:0)},0);return`
  ...
  `,document.body.appendChild(p),p.addEventListener("click",c=>{c.target===p&&p.remove()}),window._posSeleccion={productoId:e,color:null},window._posBuffer={}};window.mostrarCorridaModalPOS=e=>{const{variantes:t,inventario:n}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",o=n.filter(c=>c.sucursal_id===a),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],r=[...new Set(t.filter(c=>c.producto_id===e).map(c=>c.color).filter(Boolean))],s=document.querySelector(`button[onclick="mostrarCorridaModalPOS('${e}')"]`);s&&(s.style.display="none"),document.querySelectorAll("#pos-modal").forEach(c=>{c!==document.getElementById("pos-modal")&&c.remove()}),window._posSeleccion.color=null,window._corridaCantidades={};const d=document.getElementById("pos-tallas-panel");if(!d)return;const l=c=>{const m=t.filter(f=>f.producto_id===e&&f.color===c).sort((f,u)=>i.indexOf(f.talla)-i.indexOf(u.talla));m.filter(f=>{const u=o.find(y=>y.variante_id===f.id);return u&&u.cantidad>0}),d.innerHTML=`
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:16px">
        ${r.map(f=>{const u=t.find(v=>v.producto_id===e&&v.color===f),y=u?u.color_hex:"#888",b=u?u.foto_url:null,h=Object.entries(window._corridaCantidades).filter(([v])=>t.find(x=>x.id===v&&x.color===f)).reduce((v,[,x])=>v+x,0);return`
          ...
          `}).join("")}
           ...
           <div style="display:flex;flex-direction:column;gap:8px">
        ${m.map(f=>{const u=o.find(h=>h.variante_id===f.id),y=u?u.cantidad:0,b=window._corridaCantidades[f.id]||0;return`
            <div style="display:flex;align-items:center;gap:10px;opacity:${y===0?"0.4":"1"}">
              ...
              <div style="display:flex;align-items:center;gap:6px">
                ...
                <input type="number" min="0" max="${y}"
                       ...
                       oninput="window._corridaCantidades['${f.id}']=Math.min(${y},Math.max(0,parseInt(this.value)||0));this.value=window._corridaCantidades['${f.id}']">
                <button ${y===0?"disabled":""}
                        onclick="const i=document.getElementById('qty-corrida-${f.id}');const val=Math.min(${y},(parseInt(i.value)||0)+1);i.value=val;window._corridaCantidades['${f.id}']=val;renderCorridaColor('${c}')"
                        style="background:#f0f0f0;border:none;border-radius:8px;width:40px;height:40px;cursor:pointer;font-size:1.3rem;font-weight:700;touch-action:manipulation">+</button>
              </div>
    ...
    `)};window.sugerirCorrida=(e,t)=>{const{variantes:n,inventario:a}=window._posData,o=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",i=a.filter(p=>p.sucursal_id===o),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],s=n.filter(p=>p.producto_id===e&&p.color===t).sort((p,c)=>r.indexOf(p.talla)-r.indexOf(c.talla)),d=s.filter(p=>{const c=i.find(m=>m.variante_id===p.id);return c&&c.cantidad>0}),l=d.some(p=>p.talla.includes("."));if(s.forEach(p=>{window._corridaCantidades[p.id]=0}),l)d.slice(0,6).forEach(p=>{window._corridaCantidades[p.id]=1});else{const p=d.slice(0,5);p.length>=4?p.forEach((c,m)=>{window._corridaCantidades[c.id]=m===1||m===2?2:1}):d.slice(0,6).forEach(c=>{window._corridaCantidades[c.id]=Math.ceil(6/d.length)})}window.renderCorridaColor(t)};window.confirmarCorridaNueva=e=>{const{variantes:t}=window._posData,n=window._posData.productos.find(i=>i.id===e);if(!n)return;let a=0;if(Object.entries(window._corridaCantidades).forEach(([i,r])=>{var l;if(r<=0)return;const s=t.find(p=>p.id===i);if(!s)return;const d=window._posCarrito.find(p=>p.variante_id===i&&p.es_corrida);d?(d.cantidad+=r,d.es_corrida=!0):window._posCarrito.push({variante_id:i,producto_id:e,nombre:n.nombre,color:s.color,talla:s.talla,cantidad:r,precio_menudeo:parseFloat(n.precio_menudeo)||0,precio_mayoreo3:parseFloat(n.precio_mayoreo3)||parseFloat(n.precio_menudeo)-30,precio_mayoreo6:parseFloat(n.precio_mayoreo6)||parseFloat(n.precio_menudeo)-70,precio_corrida:parseFloat(n.precio_corrida)||parseFloat(n.precio_menudeo)-110,es_corrida:!0,imagen:((l=window._posData.variantes.find(p=>p.id===i))==null?void 0:l.foto_url)||n.imagen_principal||null,precio_unitario:parseFloat(n.precio_corrida)||parseFloat(n.precio_menudeo)-110}),a++}),a===0){alert("Agrega al menos una talla");return}const o=document.getElementById("pos-modal");o&&o.remove(),window._corridaCantidades={},renderCarritoPOS()};window.seleccionarColorModalPOS=(e,t)=>{const{variantes:n,inventario:a}=window._posData,o=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",i=a.filter(f=>f.sucursal_id===o),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._posSeleccion&&window._posSeleccion.color&&guardarBufferColor(e,window._posSeleccion.color),document.querySelectorAll('[id^="pos-color-btn-"]').forEach(f=>{f.style.borderColor="#ddd",f.style.background="transparent"});const s=document.getElementById("pos-color-btn-"+t.replace(/\s/g,"_"));s&&(s.style.borderColor="#E91E8C",s.style.background="#fce4f3"),window._posSeleccion.color=t;const d=n.filter(f=>f.producto_id===e&&f.color===t).sort((f,u)=>r.indexOf(f.talla)-r.indexOf(u.talla)),l=d[0]?d[0].foto_url:null,p=document.getElementById("pos-modal-img");p&&l&&(p.src=l);const c=window._posBuffer[t]||{},m=document.getElementById("pos-tallas-panel");m&&(m.innerHTML=`
      <p style="font-size:0.75rem;color:#888;font-weight:600;margin-bottom:10px">TALLAS — ${t}</p>
      <div style="display:flex;flex-direction:column;gap:8px">
        ${d.map(f=>{const u=i.find(h=>h.variante_id===f.id),y=u?u.cantidad:0,b=c[f.id]||0;return`
            <div style="display:flex;align-items:center;gap:10px;opacity:${y===0?"0.4":"1"}">
              ...
              <div style="display:flex;align-items:center;gap:6px">
                <button onclick="cambiarCantidadTallaPOS('modal-${f.id}', -1, ${y})"
                        ${y===0?"disabled":""}
                ...
                <input type="number" min="0" max="${y}"
                       ...
                       oninput="validarCantidadTalla('modal-${f.id}', ${y}); actualizarBadgeColor('${e}', '${t}')">
                <button onclick="cambiarCantidadTallaPOS('modal-${f.id}', 1, ${y})"
                        ${y===0?"disabled":""}
                        style="background:#f0f0f0;border:none;border-radius:6px;width:30px;height:30px;cursor:pointer;font-size:1.1rem;font-weight:600">+</button>
              </div>
    ...
    `)};window.guardarBufferColor=(e,t)=>{const{variantes:n}=window._posData,a=n.filter(o=>o.producto_id===e&&o.color===t);window._posBuffer[t]||(window._posBuffer[t]={}),a.forEach(o=>{const i=document.getElementById("qty-modal-"+o.id);window._posBuffer[t][o.id]=i&&parseInt(i.value)||0}),actualizarBadgeColor(e,t)};window.actualizarBadgeColor=(e,t)=>{const{variantes:n}=window._posData,a=n.filter(r=>r.producto_id===e&&r.color===t);let o=0;a.forEach(r=>{const s=document.getElementById("qty-modal-"+r.id);o+=s&&parseInt(s.value)||0});const i=document.getElementById("pos-color-badge-"+t.replace(/\s/g,"_"));i&&(o>0?(i.textContent=o+" par"+(o>1?"es":""),i.style.display="block"):i.style.display="none"),actualizarResumenModalPOS(e)};window.actualizarResumenModalPOS=e=>{const{variantes:t}=window._posData;let n=0;const a=[];Object.entries(window._posBuffer).forEach(([s,d])=>{Object.entries(d).forEach(([l,p])=>{if(p>0){const c=t.find(m=>m.id===l);c&&(a.push({color:s,talla:c.talla,cantidad:p}),n+=p)}})});const o=window._posSeleccion?window._posSeleccion.color:null;o&&!window._posBuffer[o]&&t.filter(d=>d.producto_id===e&&d.color===o).forEach(d=>{const l=document.getElementById("qty-modal-"+d.id),p=l&&parseInt(l.value)||0;p>0&&(a.push({color:o,talla:d.talla,cantidad:p}),n+=p)});const i=document.getElementById("pos-modal-resumen"),r=document.getElementById("pos-btn-confirmar");n>0?(i&&(i.style.display="block",i.innerHTML=`
      ...
      `),r&&(r.textContent=`✅ Agregar ${n} pares al carrito`,r.disabled=!1)):(i&&(i.style.display="none"),r&&(r.textContent="Selecciona al menos una talla",r.disabled=!0))};window.confirmarModalPOS=e=>{window._posSeleccion&&window._posSeleccion.color;const{productos:t,variantes:n}=window._posData,a=t.find(i=>i.id===e);if(!a)return;window._posSeleccion&&window._posSeleccion.color?guardarBufferColor(e,window._posSeleccion.color):document.querySelectorAll('[id^="qty-modal-"]').forEach(r=>{const s=r.id.replace("qty-modal-",""),d=n.find(p=>p.id===s);if(!d)return;const l=parseInt(r.value)||0;window._posBuffer[d.color]||(window._posBuffer[d.color]={}),window._posBuffer[d.color][s]=l});let o=0;if(Object.entries(window._posBuffer).forEach(([i,r])=>{Object.entries(r).forEach(([s,d])=>{var c;if(d<=0)return;const l=n.find(m=>m.id===s),p=window._posCarrito.find(m=>m.variante_id===s&&!m.es_corrida);p?p.cantidad+=d:window._posCarrito.push({variante_id:s,producto_id:e,nombre:a.nombre,color:l?l.color:i,talla:l?l.talla:"",cantidad:d,precio_menudeo:parseFloat(a.precio_menudeo)||0,precio_mayoreo3:parseFloat(a.precio_mayoreo3)||parseFloat(a.precio_menudeo)-30,precio_mayoreo6:parseFloat(a.precio_mayoreo6)||parseFloat(a.precio_menudeo)-70,precio_corrida:parseFloat(a.precio_corrida)||parseFloat(a.precio_menudeo)-110,es_oferta:a.es_oferta||!1,es_corrida:!1,imagen:window._posBuffer[l?l.color:i]&&((c=window._posData.variantes.find(m=>m.id===s))==null?void 0:c.foto_url)||a.imagen_principal||null,precio_unitario:parseFloat(a.precio_menudeo)||0}),o++})}),o===0){alert("Pon al menos 1 par en alguna talla");return}document.getElementById("pos-modal").remove(),window._posBuffer={},renderCarritoPOS()};window.seleccionarColorPOS=(e,t)=>{const{variantes:n,inventario:a}=window._posData,o=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",i=a.filter(m=>m.sucursal_id===o),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];document.querySelectorAll('[id^="pos-color-"]').forEach(m=>{m.style.borderColor="transparent",m.style.background="transparent"});const s=document.getElementById("pos-color-"+t.replace(/\s/g,"_"));s&&(s.style.borderColor="#E91E8C",s.style.background="#fce4f3"),window._posSeleccion.color=t,window._posSeleccion.talla=null;const d=n.filter(m=>m.producto_id===e&&m.color===t).sort((m,f)=>r.indexOf(m.talla)-r.indexOf(f.talla)),l=d[0]?d[0].foto_url:null,p=document.getElementById("pos-modal-img");p&&l&&(p.src=l);const c=document.getElementById("pos-tallas-container");c&&(c.innerHTML=`
  ...
  `)};window.cambiarCantidadTallaPOS=(e,t,n)=>{const a=document.getElementById("qty-"+e);if(!a)return;const o=Math.min(n,Math.max(0,(parseInt(a.value)||0)+t));a.value=o,window._posSeleccion&&actualizarBadgeColor(window._posSeleccion.productoId,window._posSeleccion.color)};window.agregarTallasPOS=(e,t)=>{const{productos:n,variantes:a}=window._posData,o=n.find(d=>d.id===e);if(!o)return;const i=a.filter(d=>d.producto_id===e&&d.color===t);let r=0;if(i.forEach(d=>{const l=document.getElementById("qty-"+d.id),p=l&&parseInt(l.value)||0;if(p<=0)return;const c=window._posCarrito.find(m=>m.variante_id===d.id);c?c.cantidad+=p:window._posCarrito.push({variante_id:d.id,producto_id:e,nombre:o.nombre,color:t,talla:d.talla,cantidad:p,precio_menudeo:parseFloat(o.precio_menudeo)||0,precio_mayoreo3:parseFloat(o.precio_mayoreo3)||parseFloat(o.precio_menudeo)-30,precio_mayoreo6:parseFloat(o.precio_mayoreo6)||parseFloat(o.precio_menudeo)-70,precio_corrida:parseFloat(o.precio_corrida)||parseFloat(o.precio_menudeo)-110,imagen:o.imagen_principal||null,es_oferta:o.es_oferta||!1,precio_unitario:parseFloat(o.precio_menudeo)||0}),r++}),r===0){alert("Pon al menos 1 par en alguna talla");return}const s=document.querySelector(`button[onclick="agregarTallasPOS('${e}', '${t}')"]`);s&&(s.textContent="✅ Agregado — selecciona otro color o cierra",s.style.background="#2e7d32",s.style.borderColor="#2e7d32",s.disabled=!0),i.forEach(d=>{const l=document.getElementById("qty-"+d.id);l&&(l.value=0)}),actualizarResumenModal(e)};window.actualizarResumenModal=e=>{const t=window._posCarrito.filter(o=>o.producto_id===e),n=t.reduce((o,i)=>o+i.cantidad,0);let a=document.getElementById("pos-modal-resumen");if(!a){a=document.createElement("div"),a.id="pos-modal-resumen",a.style.cssText="background:#e8f5e9;border-radius:8px;padding:0.75rem;margin-top:10px;border:1px solid #a5d6a7";const o=document.querySelector("#pos-modal > div > div:last-child");o&&o.insertBefore(a,o.firstChild)}a.innerHTML=`
  ...
  `};window.seleccionarTallaPOS=(e,t)=>{window._posSeleccion.talla=t,window._posSeleccion.varianteId=e,document.querySelectorAll('[id^="pos-talla-"]').forEach(o=>{o.style.borderColor="#ddd",o.style.background="white",o.style.color="#333"});const n=document.getElementById("pos-talla-"+t.replace(".","_"));n&&(n.style.borderColor="#E91E8C",n.style.background="#fce4f3",n.style.color="#E91E8C");const a=document.getElementById("pos-btn-agregar");a&&(a.textContent="+ Agregar al carrito",a.disabled=!1)};window.agregarAlCarritoPOS=e=>{const{productos:t,variantes:n}=window._posData,{varianteId:a,color:o,talla:i}=window._posSeleccion;if(!a||!o||!i)return;const r=t.find(d=>d.id===e);if(!r)return;const s=window._posCarrito.find(d=>d.variante_id===a);s?s.cantidad++:window._posCarrito.push({variante_id:a,producto_id:e,nombre:r.nombre,color:o,talla:i,cantidad:1,precio_menudeo:parseFloat(r.precio_menudeo)||0,precio_mayoreo3:parseFloat(r.precio_mayoreo3)||parseFloat(r.precio_menudeo)-30,precio_mayoreo6:parseFloat(r.precio_mayoreo6)||parseFloat(r.precio_menudeo)-70,precio_corrida:parseFloat(r.precio_corrida)||parseFloat(r.precio_menudeo)-110,imagen:r.imagen_principal||null,es_oferta:r.es_oferta||!1,precio_unitario:parseFloat(r.precio_menudeo)||0}),document.getElementById("pos-modal").remove(),renderCarritoPOS()};window.agregarCorridaPOS=e=>{const{productos:t,variantes:n,inventario:a}=window._posData,{color:o}=window._posSeleccion;if(!o){alert("Selecciona un color primero");return}t.find(m=>m.id===e);const i=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=a.filter(m=>m.sucursal_id===i),s=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=n.filter(m=>m.producto_id===e&&m.color===o).sort((m,f)=>s.indexOf(m.talla)-s.indexOf(f.talla)),p=document.getElementById("pos-modal").querySelector("div > div:last-child"),c=`
  ...
  `;p&&p.insertAdjacentHTML("beforeend",c)};window.confirmarCorridaPOS=(e,t)=>{const{productos:n,variantes:a}=window._posData,o=n.find(r=>r.id===e);a.filter(r=>r.producto_id===e&&r.color===t).forEach(r=>{const s=document.getElementById("qty-corrida-"+r.id),d=s&&parseInt(s.value)||0;if(d<=0)return;const l=window._posCarrito.find(p=>p.variante_id===r.id);l?(l.cantidad+=d,l.es_corrida=!0):window._posCarrito.push({variante_id:r.id,producto_id:e,nombre:o.nombre,color:t,talla:r.talla,cantidad:d,precio_menudeo:parseFloat(o.precio_menudeo)||0,precio_mayoreo3:parseFloat(o.precio_mayoreo3)||parseFloat(o.precio_menudeo)-30,precio_mayoreo6:parseFloat(o.precio_mayoreo6)||parseFloat(o.precio_menudeo)-70,precio_corrida:parseFloat(o.precio_corrida)||parseFloat(o.precio_menudeo)-110,imagen:o.imagen_principal||null,es_oferta:o.es_oferta||!1,es_corrida:!0,precio_unitario:parseFloat(o.precio_menudeo)||0})}),document.getElementById("pos-modal").remove(),renderCarritoPOS()};window.renderCarritoPOS=()=>{var f;const e=window._posCarrito,t=document.getElementById("pos-carrito-items");if(!t)return;const n=e.reduce((u,y)=>u+y.cantidad,0);e.forEach(u=>{u.precio_manual||(u.es_oferta?u.precio_unitario=u.precio_menudeo:u.es_corrida?u.precio_unitario=u.precio_corrida:n>=6?u.precio_unitario=u.precio_mayoreo6:n>=3?u.precio_unitario=u.precio_mayoreo3:u.precio_unitario=u.precio_menudeo)});const a=e.reduce((u,y)=>u+y.cantidad*y.precio_unitario,0),o=e.some(u=>u.es_corrida)?"Corrida":n>=6?"Mayoreo 6+":n>=3?"Mayoreo 3+":"Menudeo",i=e.filter(u=>!u.es_corrida),r=e.filter(u=>u.es_corrida),s={};r.forEach(u=>{const y=u.producto_id+"|"+u.color;s[y]||(s[y]={nombre:u.nombre,color:u.color,producto_id:u.producto_id,tallas:[],subtotal:0,imagen:u.imagen||null}),s[y].tallas.push({talla:u.talla,cantidad:u.cantidad,variante_id:u.variante_id}),s[y].subtotal+=u.cantidad*u.precio_unitario}),e.length===0?t.innerHTML='<p style="color:#888;font-size:0.85rem;text-align:center;padding:2rem">El carrito esta vacio</p>':t.innerHTML=`
      ${i.map(u=>`
...
`).join("")}
    `;const d=document.getElementById("pos-total"),l=document.getElementById("pos-total-pares"),p=document.getElementById("pos-tipo-precio");d&&(d.textContent="$"+a.toFixed(2)),l&&(l.textContent=n),p&&(p.textContent=o);const c=document.getElementById("pos-flotante-pares"),m=document.getElementById("pos-flotante-total");c&&(c.textContent=n+" pares"),m&&(m.textContent="$"+a.toFixed(2)),(f=document.getElementById("pos-drawer"))!=null&&f.classList.contains("open")&&renderDrawerPOS()};window.editarPrecioPOS=(e,t)=>{if(!window._posCarrito[e])return;const n=parseFloat(t)||0;window._posCarrito[e].precio_unitario=n,window._posCarrito[e].precio_manual=!0;const a=window._posCarrito[e].cantidad,o=document.getElementById("subtotal-item-"+e);o&&(o.textContent="$"+(a*n).toFixed(2));const i=window._posCarrito.reduce((s,d)=>s+d.cantidad*d.precio_unitario,0),r=document.getElementById("pos-total");r&&(r.textContent="$"+i.toFixed(2))};window.editarPrecioCorridaPOS=(e,t)=>{const[n,a]=e.split("|"),o=parseFloat(t)||0;window._posCarrito.forEach(p=>{p.producto_id===n&&p.color===a&&p.es_corrida&&(p.precio_unitario=o,p.precio_manual=!0)});const r=window._posCarrito.filter(p=>p.producto_id===n&&p.color===a&&p.es_corrida).reduce((p,c)=>p+c.cantidad*c.precio_unitario,0),s=document.getElementById("subtotal-corrida-"+e.replace("|","-"));s&&(s.textContent="$"+r.toFixed(2));const d=window._posCarrito.reduce((p,c)=>p+c.cantidad*c.precio_unitario,0),l=document.getElementById("pos-total");l&&(l.textContent="$"+d.toFixed(2))};window.editarCorridaEnCarrito=e=>{const[t,n]=e.split("|"),{inventario:a,variantes:o}=window._posData,i=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",r=a.filter(p=>p.sucursal_id===i),s=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=o.filter(p=>p.producto_id===t&&p.color===n).sort((p,c)=>s.indexOf(p.talla)-s.indexOf(c.talla)),l=document.createElement("div");l.id="pos-modal-editar-corrida",l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",l.innerHTML=`
    <div style="background:white;border-radius:16px;max-width:400px;width:100%;padding:1.5rem;max-height:90vh;overflow-y:auto">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${d.map(p=>{const c=r.find(y=>y.variante_id===p.id),m=c?c.cantidad:0,f=window._posCarrito.find(y=>y.variante_id===p.id&&y.es_corrida),u=f?f.cantidad:0;return`
            <div style="display:flex;align-items:center;gap:10px">
      ...
      <button onclick="guardarEdicionCorridaPOS('${t}', '${n}')"
              class="btn btn-primary"
              style="width:100%;margin-top:1.5rem;padding:12px;background:#6a1b9a;border-color:#6a1b9a">
        ✅ Guardar cambios
      </button>
    </div>
  `,document.body.appendChild(l),l.addEventListener("click",p=>{p.target===l&&l.remove()})};window.guardarEdicionCorridaPOS=(e,t)=>{const{variantes:n,productos:a}=window._posData,o=window._posCarrito.filter(l=>l.producto_id===e&&l.color===t&&l.es_corrida),i=o.length>0&&o[0].precio_manual?o[0].precio_unitario:null;window._posCarrito=window._posCarrito.filter(l=>!(l.producto_id===e&&l.color===t&&l.es_corrida));const r=n.filter(l=>l.producto_id===e&&l.color===t),s=a.find(l=>l.id===e);if(!s)return;const d=i!==null?i:parseFloat(s.precio_corrida)||parseFloat(s.precio_menudeo)-110;r.forEach(l=>{const p=document.getElementById("edit-corrida-"+l.id),c=p&&parseInt(p.value)||0;c<=0||window._posCarrito.push({variante_id:l.id,producto_id:e,nombre:s.nombre,color:t,talla:l.talla,cantidad:c,precio_menudeo:parseFloat(s.precio_menudeo)||0,precio_mayoreo3:parseFloat(s.precio_mayoreo3)||parseFloat(s.precio_menudeo)-30,precio_mayoreo6:parseFloat(s.precio_mayoreo6)||parseFloat(s.precio_menudeo)-70,precio_corrida:parseFloat(s.precio_corrida)||parseFloat(s.precio_menudeo)-110,es_oferta:s.es_oferta||!1,imagen:s.imagen_principal||null,es_corrida:!0,precio_manual:i!==null,precio_unitario:d})}),document.getElementById("pos-modal-editar-corrida").remove(),renderCarritoPOS()};window.eliminarCorridaPOS=e=>{const[t,n]=e.split("|");window._posCarrito=window._posCarrito.filter(a=>!(a.producto_id===t&&a.color===n&&a.es_corrida)),renderCarritoPOS()};window.cambiarCantidadPOS=async(e,t)=>{const n=window._posCarrito[e];if(n){if(t>0){const a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"";try{const r=(await(await fetch(g+"/inventario/sucursal/"+a)).json()).find(l=>l.variante_id===n.variante_id),s=r?r.cantidad:0;if(window._posCarrito.filter(l=>l.variante_id===n.variante_id).reduce((l,p)=>l+p.cantidad,0)>=s){alert("No hay más existencia disponible. Stock: "+s+" pares");return}}catch(o){console.error("Error verificando stock",o)}}n.cantidad=Math.max(1,n.cantidad+t),renderCarritoPOS()}};window.eliminarItemPOS=e=>{window._posCarrito.splice(e,1),renderCarritoPOS()};window.limpiarCarritoPOS=()=>{window._posCarrito.length>0&&!confirm("Limpiar el carrito?")||(window._posCarrito=[],renderCarritoPOS())};window.cobrarPOS=async()=>{if(window._posCarrito.length===0){alert("El carrito esta vacio");return}const e=document.querySelector('button[onclick="cobrarPOS()"]');if(e){if(e.disabled)return;e.disabled=!0,e.textContent="Procesando..."}const t=document.getElementById("pos-cliente").value||null,n=document.getElementById("pos-sucursal").value,a=document.getElementById("pos-pago").value,o=window._posCarrito.reduce((i,r)=>i+r.cantidad*r.precio_unitario,0);try{const s=(await(await fetch(g+"/pedidos/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cliente_id:t,canal:"sucursal",sucursal_id:n,forma_pago:a,total:o,subtotal:o,status:a==="spei"?"pendiente_pago":"confirmado"})})).json())[0].id;for(const p of window._posCarrito)await fetch(g+"/pedidos/"+s+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:p.variante_id,cantidad:p.cantidad,precio_unitario:p.precio_unitario,subtotal:p.cantidad*p.precio_unitario})});a!=="spei"&&await fetch(g+"/pedidos/"+s+"/confirmar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({forma_pago:a})});const d=window._posCarrito.reduce((p,c)=>p+c.cantidad,0);window._posCarrito=[],renderCarritoPOS(),imprimirTicketPOS(s,o,d,a);const l=await fetch(g+"/inventario/sucursal/"+n);window._posData.inventario=await l.json(),renderProductosPOS(window._posData.productos)}catch{alert("Error procesando la venta");const r=document.querySelector('button[onclick="cobrarPOS()"]');r&&(r.disabled=!1,r.textContent="Cobrar")}};window.imprimirTicketPOS=async(e,t,n,a)=>{const i=await(await fetch(g+"/pedidos/"+e)).json();if(!i||i.length===0)return;const r=i[0],s=r.pedido_items||[],d=r.clientes||{},l=new Date().toLocaleString("es-MX"),p=window.open("","_blank","width=400,height=600");p.document.write(`
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="UTF-8">
    ...
    <body>
      ...
      <div class="divider"></div>
      ${(()=>{const c={};return s.forEach(m=>{const f=m.variantes||{},u=f.productos||{},y=(u.nombre||"—")+"|"+(f.color||"");c[y]||(c[y]={nombre:u.nombre||"—",color:f.color||"",cantidad:0,subtotal:0}),c[y].cantidad+=m.cantidad,c[y].subtotal+=parseFloat(m.subtotal)||m.cantidad*m.precio_unitario}),`
  ...
  `),p.document.close()};window.generarPDFPedido=async e=>{const n=await(await fetch(g+"/pedidos/"+e)).json();if(!n||n.length===0)return;const a=n[0],o=a.pedido_items||[],i=a.clientes||{},r=new Date(a.created_at).toLocaleDateString("es-MX",{year:"numeric",month:"long",day:"numeric"}),s=a.total||0,d=o.reduce((p,c)=>p+c.cantidad,0),l=window.open("","_blank");l.document.write(`
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="UTF-8">
  ...
  `),l.document.close()};async function ae(){const e=document.getElementById("content");try{const n=await(await fetch(g+"/movimientos/")).json(),a={venta:{label:"Venta",badge:"badge-success"},entrada:{label:"Entrada",badge:"badge-info"},ajuste:{label:"Ajuste",badge:"badge-warning"},traspaso_salida:{label:"Traspaso salida",badge:"badge-danger"},traspaso_entrada:{label:"Traspaso entrada",badge:"badge-info"},cambio_salida:{label:"Cambio salida",badge:"badge-info"},cambio_entrada:{label:"Cambio entrada",badge:"badge-info"}};e.innerHTML=`
      <div class="table-card">
        ...
        <table>
          ...
          <tbody id="hist-tbody">
            ${n.length===0?'<tr><td colspan="9" style="text-align:center;color:var(--text-muted);padding:2rem">No hay movimientos registrados</td></tr>':n.map(o=>{const i=a[o.tipo]||{label:o.tipo,badge:"badge-warning"},r=o.cantidad||0;return`<tr>
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
      ...
      </div>`,window._historialData=n}catch{e.innerHTML='<p style="padding:2rem;color:var(--red)">Error conectando con el servidor</p>'}}window.cancelarMovimiento=async(e,t,n,a,o)=>{if(confirm("¿Cancelar este movimiento? Se revertirá el cambio en el inventario."))try{const r=await(await fetch(g+"/inventario/?variante_id=eq."+n+"&sucursal_id=eq."+a)).json(),s=r&&r.length>0?r[0].cantidad:0,d=o==="venta"?s+t:Math.max(0,s-t);(await fetch(g+"/inventario/actualizar",{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:n,sucursal_id:a,cantidad:d,stock_minimo:r&&r.length>0?r[0].stock_minimo:3})})).ok?(alert("Movimiento cancelado. Inventario actualizado."),ae()):alert("Error al actualizar inventario")}catch{alert("Error conectando con el servidor")}};window.filtrarHistorial=()=>{const e=document.getElementById("hist-tipo").value,t=document.getElementById("hist-buscar").value.toLowerCase(),n=window._historialData||[],a={venta:{label:"Venta",badge:"badge-success"},entrada:{label:"Entrada",badge:"badge-info"},ajuste:{label:"Ajuste",badge:"badge-warning"},traspaso_salida:{label:"Traspaso salida",badge:"badge-danger"},traspaso_entrada:{label:"Traspaso entrada",badge:"badge-info"},cambio_salida:{label:"Cambio salida",badge:"badge-info"},cambio_entrada:{label:"Cambio entrada",badge:"badge-info"}},o=n.filter(r=>{if(e&&r.tipo!==e)return!1;if(t){const s=(r.variantes&&r.variantes.productos?r.variantes.productos.nombre:"").toLowerCase(),d=(r.motivo||"").toLowerCase();if(!s.includes(t)&&!d.includes(t))return!1}return!0}),i=document.getElementById("hist-tbody");i&&(i.innerHTML=o.length===0?'<tr><td colspan="9" style="text-align:center;color:var(--text-muted);padding:2rem">No se encontraron movimientos</td></tr>':o.map(r=>{const s=a[r.tipo]||{label:r.tipo,badge:"badge-warning"},d=r.cantidad||0;return`<tr>
        ...
        </tr>`}).join(""))};async function ye(){try{const t=await(await fetch(g+"/pedidos/")).json(),a=await(await fetch(g+"/clientes/")).json(),i=await(await fetch(g+"/inventario/alertas")).json(),r=new Date;r.setHours(0,0,0,0);const s=new Date(r);s.setDate(s.getDate()-7);const d=new Date(r);d.setDate(d.getDate()-30);const l=t.filter($=>$.status==="confirmado"||$.status==="pagado"),p=l.filter($=>new Date($.created_at)>=r),c=l.filter($=>new Date($.created_at)>=s),m=p.reduce(($,z)=>$+parseFloat(z.total||0),0),f=c.reduce(($,z)=>$+parseFloat(z.total||0),0),u=a.filter($=>$.created_at&&new Date($.created_at)>=d).length,y=["Dom","Lun","Mar","Mie","Jue","Vie","Sab"],b={};y.forEach($=>b[$]=0),l.filter($=>new Date($.created_at)>=d).forEach($=>{const z=y[new Date($.created_at).getDay()];b[z]+=parseFloat($.total||0)});const h={};l.forEach($=>{h[$.canal||"sucursal"]=(h[$.canal||"sucursal"]||0)+parseFloat($.total||0)});const v={};l.forEach($=>{v[$.forma_pago||"efectivo"]=(v[$.forma_pago||"efectivo"]||0)+1});const x={};l.forEach($=>{x[$.empleado||"Admin"]=(x[$.empleado||"Admin"]||0)+parseFloat($.total||0)});const k={};l.forEach($=>{const z=new Date($.created_at).toLocaleDateString("es-MX",{month:"short",year:"numeric"});k[z]=(k[z]||0)+parseFloat($.total||0)});const E={};l.forEach($=>{$.clientes&&(E[$.clientes.nombre]=(E[$.clientes.nombre]||0)+parseFloat($.total||0))});const C=Object.entries(E).sort(($,z)=>z[1]-$[1]).slice(0,5),w=Object.entries(b).sort(($,z)=>z[1]-$[1])[0],_=Object.entries(x).sort(($,z)=>z[1]-$[1])[0],I=document.getElementById("dashboard-contenido");if(!I)return;const T=I.querySelectorAll(".stat-card"),S=[{val:"$"+m.toFixed(0),sub:p.length+" pedidos hoy",color:"var(--pink)"},{val:p.length,sub:"confirmados hoy"},{val:"$"+f.toFixed(0),sub:c.length+" pedidos"},{val:u,sub:"ultimos 30 dias"},{val:i.length,sub:"por reabastecer",color:i.length>0?"var(--amber)":"var(--green)"},{val:w?w[0]:"—",sub:w?"$"+w[1].toFixed(0)+" prom.":""},{val:_?_[0]:"—",sub:_?"$"+_[1].toFixed(0):"",small:!0},{val:a.length,sub:"registrados"}];T.forEach(($,z)=>{if(!S[z])return;const j=$.querySelector(".stat-value"),B=$.querySelector(".stat-sub");j&&(j.textContent=S[z].val,j.style.color=S[z].color||"var(--text-primary)",S[z].small&&(j.style.fontSize="1rem")),B&&(B.textContent=S[z].sub||"")});const P=document.getElementById("dash-top-clientes");P&&(P.innerHTML=C.length===0?'<p style="color:var(--text-muted);font-size:0.85rem">Sin datos aun</p>':C.map(([$,z],j)=>`
    ...
    `,document.getElementById("dashboard-contenido").appendChild(j)}catch($){console.error("tareas:",$)}}catch(e){console.error("Error dashboard:",e)}}window.eliminarItemPedido=e=>{window._pedidoItems.splice(e,1),window.recalcularTotal(),window.renderItemsPedido()};window.cerrarSesionPanel=()=>{confirm("Cerrar sesion?")&&(sessionStorage.removeItem("erp_empleado"),window._empleadoActual=null,location.reload())};async function ne(){const e=document.getElementById("content");try{const n=await(await fetch(g+"/empleados/")).json();e.innerHTML=`
      ...
      </div>`}catch{e.innerHTML='<p style="padding:2rem;color:var(--red)">Error conectando con el servidor</p>'}}window.mostrarFormEmpleado=async e=>{const t=document.getElementById("content");let n={};if(e)try{n=(await(await fetch(g+"/empleados/")).json()).find(i=>i.id===e)||{}}catch{}t.innerHTML=`
    ...
    </div>`};window.guardarEmpleado=async e=>{const t=document.getElementById("emp-nombre").value,n=document.getElementById("emp-email").value,a=document.getElementById("emp-password").value,o=document.getElementById("emp-rol").value;if(!t||!n){alert("Nombre y email son obligatorios");return}if(!e&&!a){alert("La contrasena es obligatoria para nuevos empleados");return}try{const i=e?"PATCH":"POST",r=e?g+"/empleados/"+e:g+"/empleados/",s={nombre:t,email:n,rol:o};a&&(s.password=a);const d=await fetch(r,{method:i,headers:{"Content-Type":"application/json"},body:JSON.stringify(s)});if(d.ok)alert("Empleado guardado correctamente"),navegarA("empleados");else{const l=await d.json();alert("Error: "+(l.error||"No se pudo guardar"))}}catch{alert("Error conectando con el servidor")}};window.toggleEmpleado=async(e,t)=>{if(confirm(t?"Desactivar este empleado?":"Activar este empleado?"))try{(await fetch(g+"/empleados/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({activo:!t})})).ok?ne():alert("Error al cambiar estado")}catch{alert("Error conectando con el servidor")}};window.resetearPassword=async(e,t)=>{const n=prompt("Nueva contrasena para "+t+":");if(n){if(n.length<4){alert("La contrasena debe tener al menos 4 caracteres");return}try{const a=await fetch(g+"/empleados/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:n})});if(a.ok)alert("Contrasena actualizada correctamente");else{const o=await a.json();alert("Error: "+(o.error||"No se pudo actualizar"))}}catch{alert("Error conectando con el servidor")}}};window.cargarConversaciones=async function(){var n;document.title="Zapatillas May";const e=document.querySelector('[data-modulo="conversaciones"]');e&&((n=e.querySelector(".nav-badge"))==null||n.remove());const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const o=await(await fetch(g+"/chatbot/chats")).json(),r=await(await fetch(g+"/productos/?select=id,nombre,imagen_principal,precio_menudeo,precio_mayoreo3,precio_mayoreo6,precio_corrida,corrida_activa,activo")).json();window._chatsData={},o.forEach(d=>window._chatsData[d.telefono]=d),window._productosWA=r.filter(d=>d.activo);const s=o.reduce((d,l)=>d+(l.no_leidos||0),0);t.innerHTML=`
  <div style="display:flex;gap:8px;margin-bottom:1rem">
  ...
  <div id="wa-tab-content">
    ...
    `}catch(a){t.innerHTML='<p style="padding:2rem;color:red">Error: '+a.message+"</p>"}};window.mostrarTabWA=async e=>{const t=document.getElementById("tab-chats"),n=document.getElementById("tab-config");t&&t.classList.toggle("activo",e==="chats"),n&&n.classList.toggle("activo",e==="config"),e==="chats"?await window.cargarConversaciones():await mostrarConfigWA()};window.filtrarEtiqueta=e=>{document.querySelectorAll(".wa-pill").forEach(t=>t.classList.remove("activa")),event.target.classList.add("activa"),document.querySelectorAll(".wa-chat-item").forEach(t=>{const n=t.dataset.etiqueta||"";t.style.display=!e||n===e?"":"none"})};window.mostrarConfigWA=async()=>{const e=document.getElementById("content");try{const[t,n]=await Promise.all([fetch(g+"/chatbot/config").then(o=>o.json()),fetch(g+"/chatbot/respuestas-rapidas").then(o=>o.json())]),a=document.getElementById("wa-tab-content")||e;a.innerHTML=`
...
`)[0].trim()+'" style="max-width:200px;border-radius:8px;display:block">':"<p>"+i.mensaje.replace(/\[.+?\]:\s*/,"")+"</p>",l=new Date(i.created_at).toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"});return`
  ...
  `,document.body.appendChild(a),a.addEventListener("click",o=>{o.target===a&&a.remove()})};window.cargarNotasTareas=async e=>{var r;(r=window._empleadoActual)!=null&&r.nombre;const t=new Date().toISOString().split("T")[0],[n,a]=await Promise.all([fetch(g+"/chatbot/notas/"+e).then(s=>s.json()),fetch(g+"/chatbot/tareas/"+e).then(s=>s.json())]),o=document.getElementById("notas-lista-"+e);o&&(o.innerHTML=n.length===0?'<p style="font-size:0.73rem;color:var(--text-3);text-align:center;padding:8px">Sin notas</p>':n.map(s=>`
        <div class="wa-nota">
          <p>${s.nota}</p>
          <div style="display:flex;justify-content:space-between;align-items:center">
      ...
      `).join(""));const i=document.getElementById("tareas-lista-"+e);i&&(i.innerHTML=a.length===0?'<p style="font-size:0.73rem;color:var(--text-3);text-align:center;padding:8px">Sin tareas</p>':a.map(s=>{const d=s.fecha_vence===t,l=s.fecha_vence&&s.fecha_vence<t&&!s.completada;return`
          ...
          `}).join(""))};window.agregarNota=async e=>{var a;const t=prompt("Escribe la nota:");if(!t)return;const n=((a=window._empleadoActual)==null?void 0:a.nombre)||"Admin";await fetch(g+"/chatbot/notas/"+e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({nota:t,agente:n})}),cargarNotasTareas(e)};window.eliminarNota=async(e,t)=>{confirm("¿Eliminar nota?")&&(await fetch(g+"/chatbot/notas/"+e,{method:"DELETE"}),cargarNotasTareas(t))};window.agregarTarea=async e=>{var o;const t=prompt("Título de la tarea:");if(!t)return;const n=prompt("Fecha límite (YYYY-MM-DD) o déjala vacía:"),a=((o=window._empleadoActual)==null?void 0:o.nombre)||"Admin";await fetch(g+"/chatbot/tareas/"+e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({titulo:t,fecha_vence:n||null,agente:a})}),cargarNotasTareas(e)};window.completarTarea=async(e,t,n)=>{await fetch(g+"/chatbot/tareas/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({completada:t})}),cargarNotasTareas(n)};window.eliminarTarea=async(e,t)=>{confirm("¿Eliminar tarea?")&&(await fetch(g+"/chatbot/tareas/"+e,{method:"DELETE"}),cargarNotasTareas(t))};window.usarRespuestaRapida=(e,t)=>{var a;(a=document.getElementById("modal-rapidas"))==null||a.remove();const n=document.getElementById("msg-input-"+e);n&&(n.value=t,n.focus(),enviarMensajeWA(e))};window.enviarMensajeWA=async e=>{var o,i;const t=document.getElementById("msg-input-"+e),n=(o=t==null?void 0:t.value)==null?void 0:o.trim();if(!n)return;t.value="";const a=((i=window._empleadoActual)==null?void 0:i.nombre)||"Admin";try{await fetch(g+"/chatbot/chats/"+e+"/mensaje",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mensaje:n,agente:a})});const s=await(await fetch(g+"/chatbot/chats")).json();window._chatsData={},s.forEach(d=>window._chatsData[d.telefono]=d),abrirChat(e)}catch{alert("Error enviando mensaje")}};window.cambiarEtiqueta=async(e,t)=>{try{await fetch(g+"/chatbot/chats/"+e+"/etiqueta",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({etiqueta:t})}),window._chatsData[e]&&(window._chatsData[e].etiqueta=t)}catch{alert("Error guardando etiqueta")}};window.toggleControl=async(e,t)=>{var a;const n=((a=window._empleadoActual)==null?void 0:a.nombre)||"Admin";try{(await(await fetch(g+"/chatbot/chats/"+e+"/control",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({en_control:t,agente:n})})).json()).ok&&(window._chatsData[e]&&(window._chatsData[e].en_control=t,window._chatsData[e].agente=n),abrirChat(e))}catch{alert("Error cambiando control")}};window.mostrarCatalogoWA=e=>{const t=window._productosWA||[],n=document.createElement("div");n.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",n.innerHTML=`
...
🛍️ Ver y comprar: https://zapatillasmay.mx`:""};window.enviarProductoWA=async(e,t,n)=>{var i;console.log("imagenUrl:",t,"caption:",n);const a=document.querySelector('div[style*="position:fixed"][style*="z-index:1000"]');a&&a.remove(),console.log("enviando a:",e,t);const o=((i=window._empleadoActual)==null?void 0:i.nombre)||"Admin";try{if(t){const d=n.replace(/\\n/g,`
`);await fetch(g+"/chatbot/chats/"+e+"/imagen",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:t,caption:d,agente:o})})}else await fetch(g+"/chatbot/chats/"+e+"/mensaje",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mensaje:n,agente:o})});await new Promise(d=>setTimeout(d,1500));const s=await(await fetch(g+"/chatbot/chats")).json();window._chatsData={},s.forEach(d=>window._chatsData[d.telefono]=d),abrirChat(e)}catch{alert("Error enviando producto")}};window.cargarEnviosMasivos=async function(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[t,n,a]=await Promise.all([fetch(g+"/chatbot/plantillas").then(r=>r.json()),fetch(g+"/clientes/").then(r=>r.json()),fetch(g+"/chatbot/chats").then(r=>r.json())]),o={};n.forEach(r=>{r.telefono&&(o[r.telefono]={telefono:r.telefono,nombre:r.nombre,fuente:"cliente"})}),a.forEach(r=>{o[r.telefono]||(o[r.telefono]={telefono:r.telefono,nombre:r.nombre||r.telefono,fuente:"whatsapp",etiqueta:r.etiqueta})});const i=Object.values(o);window._envioContactos=i,window._envioChats=a,window._envioClientes=n,e.innerHTML=`
  ...
  `).join("")};window.iniciarEnvioMasivo=async()=>{var o;const e=window._envioContactos||[];if(e.length===0){alert("No hay contactos seleccionados");return}const t=document.getElementById("envio-plantilla").value,n=document.getElementById("envio-imagen").value;if(!confirm(`¿Enviar "${t}" a ${e.length} contactos?`))return;const a=document.getElementById("btn-enviar-masivo");a.textContent="Enviando...",a.disabled=!0;try{const r=await(await fetch(g+"/chatbot/envio-masivo",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({plantilla:t,imagen_url:n,contactos:e})})).json(),s=document.getElementById("envio-resultado");s.style.display="block",s.style.background=r.fallidos>0?"#fff8e1":"#e8f5e9",s.innerHTML=`
      ...
      <div style="background:white;border-radius:16px;padding:2rem;max-width:480px;width:100%;max-height:90vh;overflow-y:auto">
        <div style="display:flex;justify-content:space-between;align-items:start;margin-bottom:1.5rem">
          <div>
            ...
            <p style="font-size:0.82rem;color:#888">${((n=i.clientes)==null?void 0:n.nombre)||"Sin cliente"}</p>
          </div>
          <button onclick="this.closest('div[style*=fixed]').remove()" style="background:none;border:none;font-size:1.5rem;cursor:pointer;color:#888">✕</button>
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1.5rem">
...
<div>
  ...
  `,window.hacerLogin=async()=>{const t=document.getElementById("login-email").value,n=document.getElementById("login-password").value,a=document.getElementById("btn-login");if(document.getElementById("login-error"),!t||!n){e("Por favor completa todos los campos");return}a.textContent="Verificando...",a.disabled=!0;try{const o=await fetch("/api/empleados/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:n})}),i=await o.json();o.ok?(sessionStorage.setItem(ie,JSON.stringify(i)),window._empleadoActual=i,W()):(e(i.error||"Email o contrasena incorrectos"),a.textContent="Iniciar sesion",a.disabled=!1)}catch{e("Error conectando con el servidor"),a.textContent="Iniciar sesion",a.disabled=!1}};function e(t){const n=document.getElementById("login-error");n&&(n.textContent=t,n.style.display="block")}}const X=sessionStorage.getItem(ie);if(X)try{window._empleadoActual=JSON.parse(X),W()}catch{G()}else G();
