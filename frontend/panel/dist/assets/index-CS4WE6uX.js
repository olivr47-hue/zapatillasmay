...
¿Quieres reactivar todos?`)&&(localStorage.removeItem("ordenes_pospuestos"),oe())};window.guardarOrdenCompra2=async()=>{var r,i,s,d;const{seleccionados:e,sucursalId:t}=window._ordenModal||{};if(!e)return;const o=(r=document.getElementById("orden-fecha"))==null?void 0:r.value,a=((i=document.getElementById("orden-notas"))==null?void 0:i.value)||"",n={};e.forEach(l=>{var u,g;const c=l.proveedor_id||"sin-proveedor",p=((u=l.proveedor)==null?void 0:u.nombre)||"Sin proveedor";n[c]||(n[c]={nombre:p,items:[]});const m=l.variantes||[];if(m.length===0){const y=parseInt(((g=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:g.value)||l.cantidad_sugerida);n[c].items.push({variante_id:null,cantidad:y,costo_unitario:l.costo_unitario})}else m.forEach(y=>{var v;const b=document.getElementById("chk-var-"+y.id);if(!(b!=null&&b.checked))return;const h=parseInt(((v=document.getElementById("qty-var-"+y.id))==null?void 0:v.value)||0);h<=0||n[c].items.push({variante_id:y.id,cantidad:h,costo_unitario:l.costo_unitario})})});try{for(const[l,c]of Object.entries(n)){if(c.items.length===0)continue;const p=c.items.reduce((y,b)=>y+b.cantidad*b.costo_unitario,0),g=(s=(await(await fetch(f+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:l==="sin-proveedor"?null:l,sucursal_id:t,status:"borrador",total:p,notas:a,fecha_entrega_estimada:o||null})})).json())[0])==null?void 0:s.id;if(g)for(const y of c.items)await fetch(f+"/finanzas/ordenes/"+g+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...y,subtotal:y.cantidad*y.costo_unitario})})}(d=document.getElementById("modal-orden"))==null||d.remove(),alert("Orden de compra guardada"),oe()}catch(l){alert("Error guardando orden: "+l.message)}};function Fe(){return`
  ...
  `}async function ae(){var t,o,a,n,r,i;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando finanzas...</p>';try{const d=await(await fetch(f+"/sucursales/")).json(),l=(t=d[0])==null?void 0:t.id,[c,p,m,u,g,y,b]=await Promise.all([fetch(f+"/finanzas/caja/hoy/"+l),fetch(f+"/finanzas/reporte/"+l),fetch(f+"/finanzas/gastos/"+l),fetch(f+"/finanzas/estado-resultados/"+l),fetch(f+"/finanzas/flujo/"+l),fetch(f+"/finanzas/cuentas-por-cobrar"),fetch(f+"/finanzas/gastos-categorias/"+l)]),h=await c.json(),v=await p.json(),w=await m.json(),I=await u.json(),x=await g.json(),z=await y.json(),_=await b.json(),E=h.find(A=>A.status==="abierta"),P=new Date().toISOString().split("T")[0],M=w.filter(A=>{var $;return($=A.created_at)==null?void 0:$.startsWith(P)}),C=M.reduce((A,$)=>A+parseFloat($.monto||0),0),S=z.reduce((A,$)=>A+parseFloat($.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
...
⚠️ Requiere que los productos estén en el catálogo de Meta Commerce.`;else if(d.style.background="#e8f5e9",d.style.borderColor="#a5d6a7",d.style.color="#333",o){let y;t==="personalizado"?y=(((g=document.getElementById("texto-personalizado"))==null?void 0:g.value)||"").replace("{nombre}","María"):y=o.mensaje("María"),d.textContent=y}}const l=document.getElementById("campana-count");l&&(l.textContent=r.length+" clientes");const c=document.getElementById("campana-lista");if(c){if(!r.length){c.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No hay clientes en este segmento con teléfono registrado</div>';return}window._campanaFiltrados=r,window._campanaPlantillaId=t,c.innerHTML=r.map((y,b)=>{var I;let h;t==="personalizado"?h=(((I=document.getElementById("texto-personalizado"))==null?void 0:I.value)||"").replace("{nombre}",y.nombre.split(" ")[0]):h=o.mensaje(y.nombre.split(" ")[0]);const v=encodeURIComponent(h),w=(y.lada||"52")+y.telefono.replace(/\D/g,"");return`
    ...
    <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);text-align:center">
      ...
      <p style="font-size:0.82rem;color:#888">Conectando con WhatsApp Business</p>
        ...
        </div>`};window._campanaJobId=g;const h=setInterval(async()=>{try{const w=await(await fetch(f+"/campanas/estado/"+g)).json();b(w),w.terminado&&(clearInterval(h),window._campanaUltimosResultados=w.resultados||[],setTimeout(()=>{const I=w.enviados||0,x=w.fallidos||0;l.innerHTML=`
...
`,renderInventario()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.renderInventario=()=>{const{sucursales:e,productos:t,variantes:o,inventario:a}=window._invData,n=(document.getElementById("inv-buscar")?document.getElementById("inv-buscar").value:"").toLowerCase(),r=document.getElementById("inv-categoria")?document.getElementById("inv-categoria").value:"",i=document.getElementById("inv-talla")?document.getElementById("inv-talla").value:"",s=document.getElementById("inv-estado")?document.getElementById("inv-estado").value:"",d=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],l=t.filter(m=>!(!m.activo||n&&!m.nombre.toLowerCase().includes(n)&&!(m.sku_interno||"").toLowerCase().includes(n)||r&&m.categoria!==r)),c=e.map(m=>{const u=a.filter(y=>y.sucursal_id===m.id),g=l.map(y=>{const b=o.filter(I=>I.producto_id===y.id);if(b.length===0)return"";const v=[...new Set(b.map(I=>I.color).filter(Boolean))].map(I=>{const x=b.filter(P=>P.color===I).sort((P,M)=>d.indexOf(P.talla)-d.indexOf(M.talla));if(i&&!x.find(P=>P.talla===i))return"";const z=x[0]?x[0].color_hex:"#888",_=x[0]?x[0].foto_url:null,E=x.map(P=>{const M=u.find(A=>A.variante_id===P.id),C=M?M.cantidad:null,S=M?M.stock_minimo:3;if(i&&P.talla!==i||s&&(s==="agotado"&&C!==0||s==="bajo"&&(C===null||C===0||C>S)||s==="disponible"&&(C===null||C===0||C<=S)))return"";let j,k;return C===null?(j="#f0f0f0",k="#aaa"):C===0?(j="#ffebee",k="#c62828"):C<=S?(j="#fff8e1",k="#f57f17"):(j="#e8f5e9",k="#2e7d32"),`
            <div style="display:flex;align-items:center;justify-content:space-between;background:${j};border-radius:10px;padding:8px 12px;border:1px solid ${k}30">
  ...
  `};window.guardarSalida=async()=>{const e=document.getElementById("sal").value,t=document.getElementById("sal-sucursal").value,o=document.getElementById("sal-cantidad").value,a=document.getElementById("sal-motivo").value;if(!e||!t||!o){alert("Por favor completa todos los campos");return}try{const r=await(await fetch(f+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:-parseInt(o),motivo:a})})).json();r.ok?(alert("Salida registrada. Anterior: "+r.cantidad_anterior+" pares ÔåÆ Nuevo: "+r.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(r))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const o=await(await fetch(f+"/sucursales/")).json(),n=await(await fetch(f+"/productos/")).json(),i=await(await fetch(f+"/variantes/")).json(),d=await(await fetch(f+"/inventario/")).json(),l=[...new Set(n.map(p=>p.categoria).filter(Boolean))],c=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:o,productos:n,variantes:i,inventario:d},e.innerHTML=`
    ...
    `,renderTablasMasivo()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:e,variantes:t,inventario:o}=window._invMasivo,a=document.getElementById("im-sucursal").value,n=document.getElementById("im-categoria").value,r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],i=e.filter(c=>!(n&&c.categoria!==n)),s=o.filter(c=>c.sucursal_id===a),d=i.map(c=>{const p=t.filter(g=>g.producto_id===c.id);if(p.length===0)return"";const u=[...new Set(p.map(g=>g.color).filter(Boolean))].map(g=>{const y=p.filter(h=>h.color===g).sort((h,v)=>r.indexOf(h.talla)-r.indexOf(v.talla));return`
        <div style="margin-bottom:1rem">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap">
            ${y.map(h=>{const v=s.find(z=>z.variante_id===h.id),w=v?v.cantidad:0,I=v?v.stock_minimo:3;let x="#ddd";return w===0?x="#ffcdd2":w<=I?x="#ffe082":x="#a5d6a7",`
                <div style="text-align:center">
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
        ...
        </tr>`}).join(""))};async function Ue(){try{const t=await(await fetch(f+"/pedidos/")).json(),a=await(await fetch(f+"/clientes/")).json(),r=await(await fetch(f+"/inventario/alertas")).json(),i=new Date;i.setHours(0,0,0,0);const s=new Date(i);s.setDate(s.getDate()-7);const d=new Date(i);d.setDate(d.getDate()-30);const l=t.filter($=>$.status==="confirmado"||$.status==="pagado"),c=l.filter($=>new Date($.created_at)>=i),p=l.filter($=>new Date($.created_at)>=s),m=c.reduce(($,T)=>$+parseFloat(T.total||0),0),u=p.reduce(($,T)=>$+parseFloat(T.total||0),0),g=a.filter($=>$.created_at&&new Date($.created_at)>=d).length,y=["Dom","Lun","Mar","Mie","Jue","Vie","Sab"],b={};y.forEach($=>b[$]=0),l.filter($=>new Date($.created_at)>=d).forEach($=>{const T=y[new Date($.created_at).getDay()];b[T]+=parseFloat($.total||0)});const h={};l.forEach($=>{h[$.canal||"sucursal"]=(h[$.canal||"sucursal"]||0)+parseFloat($.total||0)});const v={};l.forEach($=>{v[$.forma_pago||"efectivo"]=(v[$.forma_pago||"efectivo"]||0)+1});const w={};l.forEach($=>{w[$.empleado||"Admin"]=(w[$.empleado||"Admin"]||0)+parseFloat($.total||0)});const I={};l.forEach($=>{const T=new Date($.created_at).toLocaleDateString("es-MX",{month:"short",year:"numeric"});I[T]=(I[T]||0)+parseFloat($.total||0)});const x={};l.forEach($=>{$.clientes&&(x[$.clientes.nombre]=(x[$.clientes.nombre]||0)+parseFloat($.total||0))});const z=Object.entries(x).sort(($,T)=>T[1]-$[1]).slice(0,5),_=Object.entries(b).sort(($,T)=>T[1]-$[1])[0],E=Object.entries(w).sort(($,T)=>T[1]-$[1])[0];if(!document.getElementById("dashboard-contenido"))return;const M=l.filter($=>new Date($.created_at)>=d),C=M.reduce(($,T)=>$+parseFloat(T.total||0),0),S=[];for(let $=6;$>=0;$--){const T=new Date(i);T.setDate(T.getDate()-$);const D=T.toISOString().split("T")[0],L=T.toLocaleDateString("es-MX",{weekday:"short",day:"numeric"}),H=l.filter(O=>{var B;return(B=O.created_at)==null?void 0:B.startsWith(D)}).reduce((O,B)=>O+parseFloat(B.total||0),0);S.push({label:L,total:H,ds:D})}const j=($,T,D,L)=>{const H=document.getElementById($),O=document.getElementById($+"-sub");H&&(H.textContent=T,L&&(H.style.color=L)),O&&D&&(O.textContent=D)};j("kpi-ventas-hoy","$"+m.toLocaleString("es-MX",{maximumFractionDigits:0}),c.length+" pedidos","#C8967A"),j("kpi-pedidos-hoy",c.length,"confirmados"),j("kpi-ventas-7d","$"+u.toLocaleString("es-MX",{maximumFractionDigits:0}),p.length+" pedidos"),j("kpi-ventas-30d","$"+C.toLocaleString("es-MX",{maximumFractionDigits:0}),M.length+" pedidos"),j("kpi-clientes-nuevos",g,"últimos 30 días"),j("kpi-stock-bajo",r.length,r.length>0?"⚠ reabastecer":"✓ ok",r.length>0?"#f59e0b":"#10b981"),j("kpi-mejor-dia",_?_[0]:"—",_?"$"+_[1].toLocaleString("es-MX",{maximumFractionDigits:0}):""),j("kpi-total-clientes",a.length,"registrados");const k=document.getElementById("dash-top-clientes");k&&(k.innerHTML=z.length===0?'<p style="color:var(--text-muted);font-size:0.85rem">Sin datos aun</p>':z.map(([$,T],D)=>`
          <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px">
            ...
            <strong style="color:#C8967A;font-family:'DM Mono',monospace;font-size:0.88rem">$${T.toLocaleString("es-MX",{maximumFractionDigits:0})}</strong>
          </div>`).join(""));const A=document.getElementById("dash-ultimos-pedidos");A&&(A.innerHTML=t.slice(0,6).map($=>`
        ...
        </div>`).join("")),setTimeout(()=>{const $="#C8967A",T="#b5687a",D="#d4b8a8",L="#8B6A54",H=["rgba(200,150,122,0.75)","rgba(181,104,122,0.75)","rgba(139,106,84,0.75)","rgba(212,184,168,0.75)","rgba(160,120,96,0.75)","rgba(90,60,40,0.75)"],O=["#C8967A","#b5687a","#8B6A54","#d4b8a8","#a07060","#5a3c28"],B={ticks:{color:"#C4A38A",font:{size:10}},grid:{color:"rgba(200,150,122,0.08)"}},R={responsive:!0,plugins:{legend:{labels:{color:"#8B6A54",font:{size:11}}}},scales:{x:B,y:B}},F=document.getElementById("chart-tendencia");F&&window.Chart&&new Chart(F,{type:"line",data:{labels:S.map(q=>q.label),datasets:[{data:S.map(q=>q.total),borderColor:$,backgroundColor:"rgba(200,150,122,0.10)",borderWidth:2.5,pointBackgroundColor:$,pointBorderColor:"white",pointBorderWidth:2,pointRadius:5,pointHoverRadius:7,fill:!0,tension:.4}]},options:{...R,plugins:{legend:{display:!1},tooltip:{callbacks:{label:q=>" $"+q.parsed.y.toLocaleString("es-MX",{maximumFractionDigits:0})}}}}});const N=document.getElementById("chart-dias");N&&window.Chart&&new Chart(N,{type:"bar",data:{labels:y,datasets:[{data:y.map(q=>b[q]||0),backgroundColor:H,borderColor:O,borderWidth:1.5,borderRadius:6}]},options:{...R,plugins:{legend:{display:!1}}}});const V=document.getElementById("chart-canales");V&&window.Chart&&Object.keys(h).length>0&&new Chart(V,{type:"doughnut",data:{labels:Object.keys(h),datasets:[{data:Object.values(h),backgroundColor:H,borderColor:O,borderWidth:2}]},options:{responsive:!0,cutout:"68%",plugins:{legend:{position:"bottom",labels:{color:"#8B6A54",font:{size:11},padding:10}}}}});const G=document.getElementById("chart-meses");if(G&&window.Chart){const q=Object.entries(I).slice(-6);new Chart(G,{type:"line",data:{labels:q.map(([J])=>J),datasets:[{data:q.map(([,J])=>J),borderColor:T,backgroundColor:"rgba(181,104,122,0.08)",borderWidth:2,pointBackgroundColor:T,pointBorderColor:"white",pointBorderWidth:2,pointRadius:4,fill:!0,tension:.4}]},options:{...R,plugins:{legend:{display:!1}}}})}const X=document.getElementById("chart-pagos");X&&window.Chart&&Object.keys(v).length>0&&new Chart(X,{type:"doughnut",data:{labels:Object.keys(v),datasets:[{data:Object.values(v),backgroundColor:H,borderColor:O,borderWidth:2}]},options:{responsive:!0,cutout:"68%",plugins:{legend:{position:"bottom",labels:{color:"#8B6A54",font:{size:11},padding:10}}}}})},300);try{const T=await(await fetch(f+"/chatbot/tareas-hoy")).json(),D=document.createElement("div");D.style.cssText="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem;margin-top:1.5rem",D.innerHTML=`
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem">
        <h3 style="font-size:1rem;font-weight:700;margin:0">✅ Tareas pendientes hoy</h3>
        <span style="background:#e91e8c;color:white;border-radius:100px;padding:2px 10px;font-size:0.75rem">${T.filter(L=>!L.completada).length} pendientes</span>
      </div>
      ${T.length===0?'<p style="color:#aaa;font-size:0.85rem;text-align:center;padding:1rem">Sin tareas pendientes</p>':T.map(L=>`
...
`);await fetch(f+"/chatbot/chats/"+e+"/imagen",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({imagen_url:t,caption:d,agente:n})})}else await fetch(f+"/chatbot/chats/"+e+"/mensaje",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mensaje:o,agente:n})});await new Promise(d=>setTimeout(d,1500));const s=await(await fetch(f+"/chatbot/chats")).json();window._chatsData={},s.forEach(d=>window._chatsData[d.telefono]=d),abrirChat(e)}catch{alert("Error enviando producto")}};window.cargarEnviosMasivos=async function(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[t,o,a]=await Promise.all([fetch(f+"/chatbot/plantillas").then(i=>i.json()),fetch(f+"/clientes/").then(i=>i.json()),fetch(f+"/chatbot/chats").then(i=>i.json())]),n={};o.forEach(i=>{i.telefono&&(n[i.telefono]={telefono:i.telefono,nombre:i.nombre,fuente:"cliente"})}),a.forEach(i=>{n[i.telefono]||(n[i.telefono]={telefono:i.telefono,nombre:i.nombre||i.telefono,fuente:"whatsapp",etiqueta:i.etiqueta})});const r=Object.values(n);window._envioContactos=r,window._envioChats=a,window._envioClientes=o,e.innerHTML=`
  ...
  `).join("")};window.iniciarEnvioMasivo=async()=>{var n;const e=window._envioContactos||[];if(e.length===0){alert("No hay contactos seleccionados");return}const t=document.getElementById("envio-plantilla").value,o=document.getElementById("envio-imagen").value;if(!confirm(`¿Enviar "${t}" a ${e.length} contactos?`))return;const a=document.getElementById("btn-enviar-masivo");a.textContent="Enviando...",a.disabled=!0;try{const i=await(await fetch(f+"/chatbot/envio-masivo",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({plantilla:t,imagen_url:o,contactos:e})})).json(),s=document.getElementById("envio-resultado");s.style.display="block",s.style.background=i.fallidos>0?"#fff8e1":"#e8f5e9",s.innerHTML=`
    ...
    `,document.body.appendChild(s),s.addEventListener("click",d=>{d.target===s&&s.remove()})}catch(a){console.error("Error verOportunidad",a)}};window.actualizarEtapaOportunidad=async(e,t)=>{var o;try{await fetch(f+"/crm/oportunidades/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({etapa:t})}),(o=document.querySelector('div[style*="position:fixed"][style*="z-index:1000"]'))==null||o.remove(),mostrarPipeline()}catch{alert("Error actualizando etapa")}};window.completarTareaDashboard=async(e,t)=>{try{await fetch(f+"/chatbot/tareas/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({completada:t})})}catch(o){console.error(o)}};async function Xe(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:var(--text-muted)">Cargando...</p>';try{const o=await(await fetch(f+"/config/envio")).json();e.innerHTML=`
          ...
          <div style="display:grid;gap:1.2rem">
            ...
            <div>
              ...
              <div style="display:flex;align-items:center;gap:8px">
                ...
                <input type="number" id="envio-costo" value="${o.costo||99}"
                  min="0" step="1"
            ...
            <div style="background:var(--bg);border-radius:10px;padding:1rem;font-size:0.82rem;color:var(--text-muted);border:1px solid var(--border)">
              ...
              Si el pedido es menor a <strong id="preview-desde">$${o.gratis_desde||1299}</strong> MXN →
              se cobra <strong id="preview-costo">$${o.costo||99}</strong> MXN de envío.<br>
      ...
      </div>`,document.getElementById("envio-costo").addEventListener("input",a=>{document.getElementById("preview-costo").textContent="$"+(a.target.value||0)}),document.getElementById("envio-gratis-desde").addEventListener("input",a=>{document.getElementById("preview-desde").textContent="$"+(a.target.value||0)})}catch(t){document.getElementById("content").innerHTML=`<p style="padding:2rem;color:red">Error: ${t.message}</p>`}}window.guardarEnvio=async function(){const e=parseFloat(document.getElementById("envio-costo").value),t=parseFloat(document.getElementById("envio-gratis-desde").value);if(isNaN(e)||isNaN(t))return;const o=document.getElementById("envio-msg");try{const n=await(await fetch(f+"/config/envio",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({costo:e,gratis_desde:t})})).json();o.style.display="",n.ok?(o.style.background="#e8f5e9",o.style.color="#2e7d32",o.textContent="✅ Configuración guardada correctamente"):(o.style.background="#fdecea",o.style.color="#c62828",o.textContent="❌ Error: "+(n.error||"desconocido")),setTimeout(()=>{o.style.display="none"},3e3)}catch{o.style.display="",o.style.background="#fdecea",o.style.color="#c62828",o.textContent="❌ Error al guardar"}};async function Je(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:var(--text-muted)">Cargando...</p>';try{const o=await(await fetch(f+"/seo/config")).json(),a={};o.forEach(n=>a[n.clave]=n.valor||""),e.innerHTML=`
...
`})})),n.textContent=b}}catch(m){n.style.display="block",n.textContent="Error inesperado: "+m.message}finally{t.innerHTML=r,t.disabled=!1}}window.mlPublicarPreview=function(e){Pe(!0,e)};window.mlPublicarReal=function(e){confirm("¿Publicar TODAS las variantes activas de este producto en MercadoLibre? Esto creará nuevos items en tu cuenta.")&&Pe(!1,e)};window.descargarExcelTikTok=async function(e,t,o){const a=e.innerHTML;try{e.innerHTML="⏳ Generando...",e.disabled=!0;const n=await fetch(`${f}/tiktok/${t}`);if(!n.ok){const d=await n.text();throw new Error(`Error ${n.status}: ${d}`)}const r=await n.blob(),i=URL.createObjectURL(r),s=document.createElement("a");s.href=i,s.download=o,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(i)}catch(n){alert("Error al descargar el archivo: "+n.message)}finally{e.innerHTML=a,e.disabled=!1}};async function Ke(){const e=document.getElementById("content");e.innerHTML=`
  ...
  `,document.getElementById("ml-titulo").addEventListener("input",function(){document.getElementById("ml-titulo-count").textContent=this.value.length}),window.mlGenerarPreview=async()=>{var l,c,p,m;const o=document.getElementById("ml-sku").value.trim().toUpperCase(),a=document.getElementById("ml-listing").value,n=document.getElementById("ml-titulo").value.trim(),r=document.getElementById("ml-precio").value.trim(),i=r?parseFloat(r):null;if(!o){alert("Ingresa el SKU del producto");return}if(!n){alert("Ingresa el título para ML");return}if(n.length>60){alert("El título no puede superar 60 caracteres");return}if(i!==null&&(isNaN(i)||i<=0)){alert("El precio debe ser mayor a 0");return}const s=document.getElementById("ml-btn-preview");s.textContent="⏳ Generando...",s.disabled=!0;let d=0;try{const u=await fetch(`${f}/ml/publicar`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sku_interno:o,listing_type:a,solo_preview:!0})}),g=await u.json();if(!u.ok){alert("Error: "+(g.detail||JSON.stringify(g)));return}const y=g.resultados||[];if(!y.length){alert("No se encontraron variantes activas");return}const b=document.getElementById("ml-descripcion"),h=((p=(c=(l=y[0])==null?void 0:l.preview)==null?void 0:c.description)==null?void 0:p.plain_text)||"";b.value.trim()||(b.value=h);const v=new Set,w=[];for(const x of y)for(const z of((m=x.preview)==null?void 0:m.pictures)||[])z.source&&!v.has(z.source)&&(v.add(z.source),w.push(z));if(w.length>=1){const x=document.getElementById("ml-fotos-wrap"),z=document.getElementById("ml-fotos-grid");z.innerHTML=w.map((_,E)=>`
      ...
      `).join("")||'<p style="color:#888">Sin detalles</p>'}catch(l){s.textContent="❌ Error de conexión",d.innerHTML=`<p style="color:red">${l.message}</p>`}finally{r.textContent="🚀 Publicar todas en ML",r.disabled=!1}}}let U=[],Q="";async function Ze(){const e=document.getElementById("content");e.innerHTML=`
    <style>
  ...
  `,await Qe(),Y=setInterval(async()=>{document.getElementById("ga-activos")?await Be():(clearInterval(Y),Y=null)},3e4)}async function Qe(){await Promise.all([Be(),et(),tt()]),document.getElementById("ga-ultima-act").textContent="Actualizado: "+new Date().toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}async function Be(){var e;try{const o=await(await fetch(`${f}/analytics/tiempo-real`)).json();if(!o.configurado){ot(o);return}const a=document.getElementById("ga-activos");if(!a)return;a.textContent=o.activos_ahora??0;const n=document.getElementById("ga-dispositivos");n&&o.por_dispositivo&&(n.textContent=Object.entries(o.por_dispositivo).map(([i,s])=>`${i}: ${s}`).join(" · "));const r=document.getElementById("ga-paginas-rt");r&&((e=o.por_pais)!=null&&e.length)?r.innerHTML='<div style="font-size:0.65rem;color:#aaa;margin-bottom:4px;text-transform:uppercase;letter-spacing:.05em">Por país</div>'+o.por_pais.map(i=>`
          ...
          </div>`).join(""):i.innerHTML='<p style="color:#bbb;font-size:0.82rem;margin:0">Sin datos de páginas aún</p>')}catch(t){console.warn("GA hoy:",t.message)}}async function tt(){var e;try{const o=await(await fetch(`${f}/analytics/semana`)).json();if(!o.configurado||!((e=o.dias)!=null&&e.length))return;const a=document.getElementById("ga-chart");if(!a||!window.Chart)return;a._chartInstance&&a._chartInstance.destroy(),a._chartInstance=new Chart(a,{type:"bar",data:{labels:o.dias.map(n=>n.fecha),datasets:[{label:"Sesiones",data:o.dias.map(n=>n.sesiones),backgroundColor:"rgba(52,131,250,0.7)",borderRadius:4},{label:"Usuarios",data:o.dias.map(n=>n.usuarios),backgroundColor:"rgba(34,197,94,0.5)",borderRadius:4}]},options:{responsive:!0,plugins:{legend:{position:"top"}},scales:{y:{beginAtZero:!0,ticks:{precision:0}}}}})}catch(t){console.warn("GA semana:",t.message)}}function ot(e){const t=document.getElementById("ga-setup"),o=document.getElementById("ga-setup-body");!t||!o||(t.style.display="block",o.innerHTML=`
    ...
    `}catch(t){e.innerHTML=`<p style="padding:2rem;color:red">Error cargando referidos: ${t.message}</p>`}}function at(e,t){const o=parseFloat(e.credito_disponible||0),a=e.referido_por?t[e.referido_por]||e.referido_por:"—",n=o>0?"#2e7d32":"#aaa";return`<tr id="ref-row-${e.id}" style="border-bottom:1px solid #f5f5f5">
