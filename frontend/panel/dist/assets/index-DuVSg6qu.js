(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function o(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=o(n);fetch(n.href,i)}})();const f="/api",Se=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],We=[{nombre:"Negro",hex:"#000000"},{nombre:"Blanco",hex:"#FFFFFF"},{nombre:"Hueso",hex:"#F5F0E8"},{nombre:"Nude claro",hex:"#F5DCC8"},{nombre:"Nude",hex:"#E8C4A0"},{nombre:"Nude oscuro",hex:"#C49A7A"},{nombre:"Nude rosa",hex:"#F2C4B0"},{nombre:"Palo de rosa",hex:"#D4A096"},{nombre:"Beige",hex:"#E8D5B0"},{nombre:"Camel",hex:"#C19A6B"},{nombre:"Miel",hex:"#B8860B"},{nombre:"Cafe claro",hex:"#A0785A"},{nombre:"Cafe medio",hex:"#7B4F2E"},{nombre:"Cafe oscuro",hex:"#4A2C1A"},{nombre:"Chocolate",hex:"#3B1F0E"},{nombre:"Cognac",hex:"#8B4513"},{nombre:"Taupe",hex:"#8B7D6B"},{nombre:"Gris claro",hex:"#C0C0C0"},{nombre:"Gris",hex:"#808080"},{nombre:"Gris oscuro",hex:"#404040"},{nombre:"Rojo",hex:"#CC0000"},{nombre:"Vino",hex:"#722F37"},{nombre:"Bordo",hex:"#800020"},{nombre:"Rosa claro",hex:"#FFB6C1"},{nombre:"Rosa",hex:"#FF69B4"},{nombre:"Fusha",hex:"#E91E8C"},{nombre:"Coral",hex:"#FF6B6B"},{nombre:"Salmon",hex:"#FA8072"},{nombre:"Naranja",hex:"#FF6600"},{nombre:"Amarillo",hex:"#FFD700"},{nombre:"Dorado",hex:"#C8A951"},{nombre:"Plateado",hex:"#A8A8A8"},{nombre:"Azul claro",hex:"#6CA0DC"},{nombre:"Azul",hex:"#0000CC"},{nombre:"Azul marino",hex:"#001F5B"},{nombre:"Turquesa",hex:"#40E0D0"},{nombre:"Verde",hex:"#006400"},{nombre:"Verde menta",hex:"#98FF98"},{nombre:"Morado",hex:"#800080"},{nombre:"Lila",hex:"#C8A2C8"},{nombre:"Multicolor",hex:"#FF69B4"}],Ke=[{value:"tacones",label:"Tacones",prefix:"TAC"},{value:"sandalias",label:"Sandalias",prefix:"SAN"},{value:"botas",label:"Botas",prefix:"BOT"},{value:"botines",label:"Botines",prefix:"BTN"},{value:"flats",label:"Flats",prefix:"FLT"},{value:"plataformas",label:"Plataformas",prefix:"PLT"},{value:"tenis",label:"Tenis",prefix:"TEN"},{value:"nina",label:"Calzado de nina",prefix:"NIN"},{value:"accesorios",label:"Accesorios",prefix:"ACC"}],ie=[{id:"dashboard",icon:"📊",label:"Dashboard",section:"Principal",soloAdmin:!0},{id:"pos",icon:"🛒",label:"Punto de venta",section:"Principal"},{id:"productos",icon:"👠",label:"Productos",section:"Catalogo"},{id:"inventario",icon:"📦",label:"Inventario",section:"Catalogo"},{id:"carritos",icon:"🛒",label:"Carritos",section:"Ventas"},{id:"pedidos",icon:"🛍️",label:"Pedidos",section:"Ventas"},{id:"clientes",icon:"👥",label:"Clientes",section:"Ventas"},{id:"historial",icon:"📋",label:"Historial",section:"Ventas"},{id:"analisis",icon:"📈",label:"Analisis",section:"Ventas"},{id:"crm",icon:"🎯",label:"CRM",section:"Ventas"},{id:"finanzas",icon:"💰",label:"Finanzas",section:"Finanzas",soloAdmin:!0},{id:"proveedores",icon:"🏭",label:"Proveedores",section:"Finanzas",soloAdmin:!0},{id:"sucursales",icon:"🏪",label:"Sucursales",section:"Configuracion",soloAdmin:!0},{id:"empleados",icon:"👤",label:"Empleados",section:"Configuracion",soloAdmin:!0},{id:"seo",icon:"🔍",label:"SEO y Sitio",section:"Configuracion",soloAdmin:!0},{id:"envio",icon:"🚚",label:"Envíos",section:"Configuracion",soloAdmin:!0},{id:"ordenes",icon:"🛒",label:"Órdenes de compra",section:"Finanzas",soloAdmin:!0},{id:"conversaciones",icon:"💬",label:"Conversaciones",section:"Ventas"},{id:"envios",icon:"📣",label:"Envíos masivos",section:"Ventas"},{id:"catalogos",icon:"📖",label:"Catálogos",section:"Catalogo",soloAdmin:!0},{id:"orden-home",icon:"🏠",label:"Orden en Home",section:"Catalogo",soloAdmin:!0},{id:"generar-nombres",icon:"✏️",label:"Generar nombres",section:"Catalogo",soloAdmin:!0},{id:"mercadolibre",icon:"🛒",label:"MercadoLibre",section:"Integraciones",soloAdmin:!0},{id:"analytics",icon:"📊",label:"Google Analytics",section:"Integraciones",soloAdmin:!0},{id:"referidos",icon:"🎁",label:"Referidos",section:"Ventas",soloAdmin:!0},{id:"carritos-abandonados",icon:"🛒",label:"Carritos abandonados",section:"Ventas",soloAdmin:!0}];var ze;let te=((ze=window._empleadoActual)==null?void 0:ze.rol)==="admin"?"dashboard":"pos",ge=1;function Ie(){var i,s;const e=(()=>{try{return localStorage.getItem("zm_panel_modulo")}catch{return null}})(),t=((i=window._empleadoActual)==null?void 0:i.rol)==="admin"?"dashboard":"pos";te=e||t,document.querySelector("#app").innerHTML=`
  ...
  `,window.toggleSidebar=()=>{const r=document.getElementById("sidebar"),d=document.getElementById("sidebar-overlay"),l=r.classList.toggle("open");d.classList.toggle("active",l),document.body.style.overflow=l?"hidden":""},window._conversacionesInterval&&clearInterval(window._conversacionesInterval),window._conversacionesInterval=setInterval(async()=>{try{const r=await window._recargarChats(),d=window._totalNoLeidos||0,l=r.reduce((c,p)=>c+(p.no_leidos||0),0);if(window._totalNoLeidos=l,l>d){document.title=`(${l}) Zapatillas May`;const c=document.querySelector('[data-modulo="conversaciones"]');if(c){let p=c.querySelector(".nav-badge");p||(p=document.createElement("span"),p.className="nav-badge",p.style.cssText="background:#e91e8c;color:white;border-radius:100px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:auto",c.appendChild(p)),p.textContent=l}try{const p=new(window.AudioContext||window.webkitAudioContext),m=p.createOscillator(),g=p.createGain();m.connect(g),g.connect(p.destination),m.frequency.value=523,g.gain.setValueAtTime(.5,p.currentTime),g.gain.exponentialRampToValueAtTime(.001,p.currentTime+.2),m.start(p.currentTime),m.stop(p.currentTime+.2);const u=p.createOscillator(),b=p.createGain();u.connect(b),b.connect(p.destination),u.frequency.value=783,b.gain.setValueAtTime(.5,p.currentTime+.2),b.gain.exponentialRampToValueAtTime(.001,p.currentTime+.5),u.start(p.currentTime+.2),u.stop(p.currentTime+.5)}catch{}}if(window._chatActivo&&window._chatsData[window._chatActivo]){const c=window._chatsData[window._chatActivo],p=document.getElementById("mensajes-area");if(p){const m=p.scrollHeight-p.scrollTop<=p.clientHeight+60;p.innerHTML=window._renderBurbujas(c),m&&(p.scrollTop=p.scrollHeight)}}}catch{}},8e3);let o=new Set;async function a(){try{const r=await fetch(f+"/pedidos/?status=pagado");if(!r.ok)return;const l=(await r.json()).filter(u=>u.mp_preference_id),c=l.length,p=document.getElementById("badge-pedidos-enviar");p&&(p.textContent=c,p.style.display=c>0?"inline":"none");const m=new Set(l.map(u=>u.id)),g=l.filter(u=>!o.has(u.id));g.length>0&&o.size>0&&g.forEach(u=>{const b=u.nombre_cliente||"Cliente",y=parseFloat(u.total||0).toLocaleString("es-MX",{maximumFractionDigits:0});n(`🛍️ Nuevo pedido de ${b} — $${y} MXN`)}),o=m}catch{}}function n(r){const d=document.createElement("div");d.style.cssText="position:fixed;bottom:24px;right:24px;background:#1a1a2e;color:white;padding:14px 20px;border-radius:12px;font-size:0.85rem;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3);z-index:9999;cursor:pointer;max-width:320px;line-height:1.4;border-left:4px solid #e53935",d.textContent=r,d.onclick=()=>{navegarA("pedidos"),d.remove()},document.body.appendChild(d),setTimeout(()=>d.remove(),8e3),Notification.permission==="granted"?new Notification("Zapatillas May — Panel",{body:r,icon:"/favicon.ico"}):Notification.permission==="default"&&Notification.requestPermission();try{const l=new AudioContext,c=l.createOscillator(),p=l.createGain();c.connect(p),p.connect(l.destination),c.frequency.setValueAtTime(880,l.currentTime),c.frequency.setValueAtTime(1100,l.currentTime+.1),p.gain.setValueAtTime(.15,l.currentTime),p.gain.exponentialRampToValueAtTime(.001,l.currentTime+.4),c.start(),c.stop(l.currentTime+.4)}catch{}}window._limpiarBadgePedidos=function(){const r=document.getElementById("badge-pedidos-enviar");r&&(r.style.display="none"),o=new Set([...o])},a(),setInterval(a,6e4),window.navegarA=r=>{var m;const d=((m=window._empleadoActual)==null?void 0:m.rol)==="admin",l=ie.find(g=>g.id===r);if(l!=null&&l.soloAdmin&&!d){alert("No tienes permisos para acceder a este módulo");return}te=r;try{localStorage.setItem("zm_panel_modulo",r)}catch{}const c=document.getElementById("sidebar"),p=document.getElementById("sidebar-overlay");c.classList.contains("open")&&(c.classList.remove("open"),p.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(g=>g.classList.remove("active")),document.querySelector('[data-modulo="'+r+'"]').classList.add("active"),document.getElementById("topbar-title").textContent=ie.find(g=>g.id===r).label,Te(r)}}function Ye(){var o;const e=((o=window._empleadoActual)==null?void 0:o.rol)==="admin";return[...new Set(ie.filter(a=>e||!a.soloAdmin).map(a=>a.section))].map(a=>`
              ...
              <div class="orden-item" data-urgente="${y.urgente}" style="padding:1rem 1.5rem;border-bottom:1px solid #f5f5f5;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
                ...
                <div style="flex:1;min-width:140px">
                  ...
                  <div style="margin-top:6px;display:flex;flex-wrap:wrap;gap:4px">
                    ${y.variantes.map(x=>{const v=[x.talla,x.color].filter(Boolean).join(" / "),$=x.sin_stock;return`<span style="
                      ...
                      " title="${$?"Sin stock":"Stock: "+x.stock}">${v}${$?" ✗":""}</span>`}).join("")}
                  </div>`:""}
                </div>
  ...
  `,document.body.appendChild(n),n.addEventListener("click",i=>{i.target===n&&n.remove()}),setTimeout(ordenRecalcTotal,50)};window.guardarOrdenCompra=async e=>{var n,i,s;const t=(n=document.getElementById("orden-fecha"))==null?void 0:n.value,o=((i=document.getElementById("orden-notas"))==null?void 0:i.value)||"",a=window._ordenesData.sucursalId;try{const r=typeof e=="string"?JSON.parse(e):e;for(const[d,l]of r){const c=l.productos.reduce((u,b)=>u+b.cantidad_final*b.costo_unitario,0),g=(s=(await(await fetch(f+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:d==="sin-proveedor"?null:d,sucursal_id:a,status:"borrador",total:c,notas:o,fecha_entrega_estimada:t||null})})).json())[0])==null?void 0:s.id;if(g)for(const u of l.productos)await fetch(f+"/finanzas/ordenes/"+g+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:null,cantidad:u.cantidad_final,costo_unitario:u.costo_unitario,subtotal:u.cantidad_final*u.costo_unitario})})}document.querySelector('div[style*="position:fixed"]').remove(),alert("Orden de compra guardada exitosamente"),re()}catch(r){alert("Error guardando orden: "+r.message)}};window.ordenToggleVar=(e,t)=>{const o=document.getElementById("qty-var-"+e);o&&(o.disabled=!t,o.style.opacity=t?"1":"0.35",o.style.borderColor=t?"#E91E8C":"#ddd",t&&(!o.value||o.value==="0")?o.value=1:t||(o.value=0),ordenRecalcTotal())};window.ordenRecalcTotal=()=>{const{seleccionados:e}=window._ordenModal||{};if(!e)return;let t=0;e.forEach(a=>{var n;if((a.variantes||[]).forEach(i=>{var d;const s=document.getElementById("chk-var-"+i.id),r=parseInt(((d=document.getElementById("qty-var-"+i.id))==null?void 0:d.value)||0);s!=null&&s.checked&&r>0&&(t+=r*a.costo_unitario)}),!a.variantes||a.variantes.length===0){const i=parseInt(((n=document.getElementById("qty-orden-"+a.producto_id))==null?void 0:n.value)||a.cantidad_sugerida);t+=i*a.costo_unitario}});const o=document.getElementById("orden-total-general");o&&(o.textContent="$"+t.toFixed(0))};window.imprimirOrden=()=>{var r,d;const{seleccionados:e}=window._ordenModal||{};if(!e)return;const t=((r=document.getElementById("orden-fecha"))==null?void 0:r.value)||"",o=((d=document.getElementById("orden-notas"))==null?void 0:d.value)||"",a=new Date().toLocaleDateString("es-MX");let n="",i=0;e.forEach(l=>{var p;const c=l.variantes||[];if(c.length===0){const m=parseInt(((p=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:p.value)||l.cantidad_sugerida),g=m*l.costo_unitario;i+=g,n+=`<tr><td>${l.nombre}</td><td>${l.sku||""}</td><td>—</td><td>—</td><td style="text-align:center">${m}</td><td style="text-align:right">$${g.toFixed(0)}</td></tr>`}else c.forEach(m=>{var y;const g=document.getElementById("chk-var-"+m.id);if(!(g!=null&&g.checked))return;const u=parseInt(((y=document.getElementById("qty-var-"+m.id))==null?void 0:y.value)||0);if(u<=0)return;const b=u*l.costo_unitario;i+=b,n+=`<tr style="${m.sin_stock?"background:#fff5f5":""}">
...
¿Quieres reactivar todos?`)&&(localStorage.removeItem("ordenes_pospuestos"),re())};window.guardarOrdenCompra2=async()=>{var i,s,r,d;const{seleccionados:e,sucursalId:t}=window._ordenModal||{};if(!e)return;const o=(i=document.getElementById("orden-fecha"))==null?void 0:i.value,a=((s=document.getElementById("orden-notas"))==null?void 0:s.value)||"",n={};e.forEach(l=>{var g,u;const c=l.proveedor_id||"sin-proveedor",p=((g=l.proveedor)==null?void 0:g.nombre)||"Sin proveedor";n[c]||(n[c]={nombre:p,items:[]});const m=l.variantes||[];if(m.length===0){const b=parseInt(((u=document.getElementById("qty-orden-"+l.producto_id))==null?void 0:u.value)||l.cantidad_sugerida);n[c].items.push({variante_id:null,cantidad:b,costo_unitario:l.costo_unitario})}else m.forEach(b=>{var v;const y=document.getElementById("chk-var-"+b.id);if(!(y!=null&&y.checked))return;const x=parseInt(((v=document.getElementById("qty-var-"+b.id))==null?void 0:v.value)||0);x<=0||n[c].items.push({variante_id:b.id,cantidad:x,costo_unitario:l.costo_unitario})})});try{for(const[l,c]of Object.entries(n)){if(c.items.length===0)continue;const p=c.items.reduce((b,y)=>b+y.cantidad*y.costo_unitario,0),u=(r=(await(await fetch(f+"/finanzas/ordenes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({proveedor_id:l==="sin-proveedor"?null:l,sucursal_id:t,status:"borrador",total:p,notas:a,fecha_entrega_estimada:o||null})})).json())[0])==null?void 0:r.id;if(u)for(const b of c.items)await fetch(f+"/finanzas/ordenes/"+u+"/items",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...b,subtotal:b.cantidad*b.costo_unitario})})}(d=document.getElementById("modal-orden"))==null||d.remove(),alert("Orden de compra guardada"),re()}catch(l){alert("Error guardando orden: "+l.message)}};function Qe(){var o;const e=new Date().toLocaleDateString("es-MX",{weekday:"long",day:"numeric",month:"long"});return`
  ...
  `}async function se(){var t,o,a,n,i,s;const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando finanzas...</p>';try{const d=await(await fetch(f+"/sucursales/")).json(),l=(t=d[0])==null?void 0:t.id,[c,p,m,g,u,b,y]=await Promise.all([fetch(f+"/finanzas/caja/hoy/"+l),fetch(f+"/finanzas/reporte/"+l),fetch(f+"/finanzas/gastos/"+l),fetch(f+"/finanzas/estado-resultados/"+l),fetch(f+"/finanzas/flujo/"+l),fetch(f+"/finanzas/cuentas-por-cobrar"),fetch(f+"/finanzas/gastos-categorias/"+l)]),x=await c.json(),v=await p.json(),$=await m.json(),E=await g.json(),h=await u.json(),P=await b.json(),L=await y.json(),w=x.find(B=>B.status==="abierta"),C=new Date().toISOString().split("T")[0],q=$.filter(B=>{var k;return(k=B.created_at)==null?void 0:k.startsWith(C)}),z=q.reduce((B,k)=>B+parseFloat(k.monto||0),0),T=P.reduce((B,k)=>B+parseFloat(k.total||0),0);e.innerHTML=`
      <div style="margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
        <div>
      ...
      <div style="background:${w?"#e8f5e9":"#ffebee"};border-radius:12px;padding:1.25rem;border:1px solid ${w?"#a5d6a7":"#ffcdd2"};margin-bottom:1.5rem;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
        ...
        ${w?`
          <div style="display:flex;gap:16px;flex-wrap:wrap">
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#2e7d32">$${(((o=h.hoy)==null?void 0:o.efectivo)||0).toFixed(0)}</p>
              <p style="font-size:0.65rem;color:#888">Efectivo</p>
            </div>
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#1565c0">$${(((a=h.hoy)==null?void 0:a.tarjeta)||0).toFixed(0)}</p>
            ...
            <div style="text-align:center">
              <p style="font-size:1.2rem;font-weight:700;color:#E91E8C">$${(((i=h.hoy)==null?void 0:i.total)||0).toFixed(0)}</p>
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
        ...
        <div style="background:white;border-radius:12px;padding:1.25rem;border:1px solid #eee;text-align:center">
          <p style="font-size:1.5rem;font-weight:700;color:#333">$${(((s=h.semana)==null?void 0:s.ingresos)||0).toFixed(0)}</p>
    ...
    `,window._finanzasData={sucursalId:l,gastosHoy:q,totalGastosHoy:z,estadoResultados:E,flujo:h,cxc:P,categorias:L,historial:[],reporte:v},window._finanzasSucursalId=l;const S=await(await fetch(f+"/finanzas/caja/historial/"+l)).json();window._finanzasData.historial=S,mostrarTabFinanzas("gastos")}catch(r){e.innerHTML='<p style="padding:2rem;color:red">Error cargando finanzas: '+r.message+"</p>"}}window.mostrarTabFinanzas=e=>{var c,p,m,g,u,b,y,x,v,$,E,h,P,L;const{gastosHoy:t,totalGastosHoy:o,estadoResultados:a,flujo:n,cxc:i,categorias:s,historial:r,sucursalId:d}=window._finanzasData,l=document.getElementById("fin-tab-contenido");if(l)if(e==="cmv"){const w=((c=window._finanzasData.reporte)==null?void 0:c.desglose_cmv)||[],C=window._finanzasData.reporte||{},q=w.reduce((B,k)=>B+k.subtotal_costo,0),z=w.reduce((B,k)=>B+k.subtotal_venta,0),T=z>0?(z-q)/z*100:0,I=C.num_pedidos_sin_desglose||0,S=C.total_sin_desglose||0;l.innerHTML=`
      <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden">
        <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
    ...
    `:e==="flujo"?l.innerHTML=`
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;margin-bottom:1rem">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;padding:1.5rem">
          ...
          <div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f5f5f5">
            <span style="font-size:0.82rem;color:#888">Gastos</span>
            <span style="font-weight:700;color:#c62828">-$${(((h=n.mes)==null?void 0:h.gastos)||0).toFixed(0)}</span>
          </div>
          <div style="display:flex;justify-content:space-between;padding:8px 0;margin-top:4px">
            <span style="font-size:0.85rem;font-weight:700">Neto</span>
...
Diferencia: $${(n=s.diferencia)==null?void 0:n.toFixed(2)}`),se()):alert("Error: "+JSON.stringify(s))}catch{alert("Error cerrando caja")}};window.agregarGasto=e=>{const t=document.createElement("div");t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",t.innerHTML=`
  ...
  `,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()})};window.guardarProveedor=async e=>{const t={nombre:document.getElementById("prov-nombre").value,contacto:document.getElementById("prov-contacto").value,telefono:document.getElementById("prov-telefono").value,email:document.getElementById("prov-email").value,ciudad:document.getElementById("prov-ciudad").value,direccion:document.getElementById("prov-direccion").value,notas:document.getElementById("prov-notas").value};if(!t.nombre){alert("El nombre es requerido");return}try{e?await fetch(f+"/finanzas/proveedores/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):await fetch(f+"/finanzas/proveedores",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),document.querySelector('div[style*="position:fixed"]').remove(),je()}catch{alert("Error guardando proveedor")}};window.editarProveedor=async e=>{const a=(await(await fetch(f+"/finanzas/proveedores")).json()).find(n=>n.id===e);a&&mostrarFormProveedor(a)};async function et(){const e=document.getElementById("content");e.innerHTML=`
    ...
    <style>@keyframes pulse{0%,100%{opacity:1}50%{opacity:0.5}}</style>`;try{let B=function(_,O,F){return`<div style="display:flex;align-items:center;gap:6px">
        ...
        <div id="rotacion-lista" style="display:flex;flex-direction:column;gap:8px">
          ${C.map(_=>{const O=S[_.semaforo],F=Math.max(...C.map(j=>j.ventas.d30),1);return`
        ...
        </div>`},M=function(_){_=(_||"").toLowerCase();const O=C.filter(A=>(A.tallasDesglosadas.length>0||A.tallasData.some(R=>R.total>0))&&(!_||A.nombre.toLowerCase().includes(_)||(A.sku_interno||"").toLowerCase().includes(_))),F=C.filter(A=>A.tallasData.some(R=>R.total>0)).length,j=`
      ...
      `},D=function(){const _=C.filter(O=>O.variantesData.some(F=>F.total>0));return _.length===0?'<div style="padding:3rem;text-align:center;color:#94a3b8;font-size:0.9rem">No hay datos de ventas por variante aún</div>':_.map(O=>{const F=O.variantesData.slice(0,8),j=Math.max(...F.map(A=>A.total),1),G=F[0];return`
        <div style="background:white;border:1px solid #e2e8f0;border-radius:12px;padding:16px;margin-bottom:10px">
        ...
        </div>`}).join("")};var t=B,o=k,a=M,n=D;const[i,s,r,d]=await Promise.all([fetch(f+"/productos/"),fetch(f+"/variantes/?activa=eq.true"),fetch(f+"/movimientos/"),fetch(f+"/inventario/slim")]),l=await i.json(),c=await s.json(),p=await r.json(),m=await d.json(),g={},u={};c.forEach(_=>{g[_.id]=_,u[_.producto_id]||(u[_.producto_id]=[]),u[_.producto_id].push(_.id)});const b={};m.forEach(_=>{b[_.variante_id]=(b[_.variante_id]||0)+_.cantidad});const y=new Date,x=new Date(y-30*24*60*60*1e3),v=new Date(y-60*24*60*60*1e3),$=new Date(y-90*24*60*60*1e3),E={},h={},P={},L={};p.filter(_=>_.tipo==="venta").forEach(_=>{const O=g[_.variante_id];if(!O)return;const F=O.producto_id,j=Math.abs(_.cantidad),G=new Date(_.created_at);E[F]||(E[F]={d30:0,d60:0,d90:0,total:0}),E[F].total+=j,G>=x&&(E[F].d30+=j),G>=v&&(E[F].d60+=j),G>=$&&(E[F].d90+=j),h[_.variante_id]||(h[_.variante_id]={d30:0,d90:0,total:0}),h[_.variante_id].total+=j,G>=x&&(h[_.variante_id].d30+=j),G>=$&&(h[_.variante_id].d90+=j);const A=O.talla||"S/T",R=`${F}|${A}`;P[R]||(P[R]={talla:A,d30:0,d90:0,total:0}),P[R].total+=j,G>=x&&(P[R].d30+=j),G>=$&&(P[R].d90+=j);const V=O.color||"Sin color",H=`${F}|${V}|${A}`;L[H]||(L[H]={talla:A,color:V,d30:0,d90:0,total:0}),L[H].total+=j,G>=x&&(L[H].d30+=j),G>=$&&(L[H].d90+=j)});const C=l.map(_=>{const O=E[_.id]||{d30:0,d60:0,d90:0,total:0},F=u[_.id]||[],j=F.reduce((N,U)=>N+(b[U]||0),0),G=O.d30/4,A=G>0?Math.round(j/G*7):null;let R="gris",V="Sin ventas recientes";O.d30>=6?(R="verde",V="Rota bien — considerar resurtido"):O.d30>=2?(R="amarillo",V="Rotación moderada"):O.d90===0&&j>0?(R="rojo",V="Sin movimiento en 90 días — revisar"):O.d30>0&&(R="amarillo",V="Rotación lenta");const H=F.map(N=>{var U;return(U=g[N])==null?void 0:U.talla}).filter(Boolean).filter((N,U,Y)=>Y.indexOf(N)===U).map(N=>({talla:N,...P[`${_.id}|${N}`]||{d30:0,d90:0,total:0}})).sort((N,U)=>U.total-N.total),X=[...new Set(F.map(N=>{var U;return(U=g[N])==null?void 0:U.color}).filter(Boolean))].map(N=>{const U=F.filter(J=>{var Z;return((Z=g[J])==null?void 0:Z.color)===N}).map(J=>{var Z;return(Z=g[J])==null?void 0:Z.talla}).filter(Boolean).filter((J,Z,Je)=>Je.indexOf(J)===Z).map(J=>({talla:J,...L[`${_.id}|${N}|${J}`]||{d30:0,d90:0,total:0}})).sort((J,Z)=>parseFloat(J.talla)-parseFloat(Z.talla)),Y=U.reduce((J,Z)=>J+Z.total,0);return{color:N,tallas:U,total:Y}}).filter(N=>N.total>0).sort((N,U)=>U.total-N.total),Q=F.map(N=>{const U=g[N];if(!U)return null;const Y=h[N]||{d30:0,d90:0,total:0},J=b[N]||0;return{id:N,label:[U.talla,U.color].filter(Boolean).join(" / ")||N,stock:J,...Y}}).filter(Boolean).sort((N,U)=>U.total-N.total);return{..._,ventas:O,stockTotal:j,ventasSemana:G,diasInventario:A,semaforo:R,recomendacion:V,tallasData:H,tallasDesglosadas:X,variantesData:Q}}).sort((_,O)=>O.ventas.d30-_.ventas.d30);window._analisisData={productosConRotacion:C,ventasPorTalla:P};const q=C.reduce((_,O)=>_+O.ventas.d30,0),z=C.reduce((_,O)=>_+O.ventas.d90,0),T=C.filter(_=>_.semaforo==="verde").length,I=C.filter(_=>_.semaforo==="rojo").length,S={verde:{bg:"#dcfce7",color:"#166534",dot:"#16a34a",txt:"Rota bien"},amarillo:{bg:"#fef9c3",color:"#854d0e",dot:"#ca8a04",txt:"Rotación lenta"},rojo:{bg:"#fee2e2",color:"#991b1b",dot:"#dc2626",txt:"Sin movimiento"},gris:{bg:"#f1f5f9",color:"#64748b",dot:"#94a3b8",txt:"Sin datos"}};window._renderTabRotacion=k,window._renderTabTallas=M,window._renderTabVariantes=D,e.innerHTML=`
  ...
  `).join("")};window.seleccionarClienteOportunidad=(e,t)=>{document.getElementById("op-cliente-id").value=e,document.getElementById("op-cliente-buscar").value=t,document.getElementById("op-cliente-resultados").style.display="none"};window.guardarOportunidad=async()=>{const e=document.getElementById("op-titulo").value,t=document.getElementById("op-cliente-id").value,o=document.getElementById("op-monto").value,a=document.getElementById("op-etapa").value,n=document.getElementById("op-fecha").value,i=document.getElementById("op-notas").value;if(!e){alert("El título es requerido");return}try{await fetch(f+"/crm/oportunidades",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({titulo:e,cliente_id:t||null,monto_estimado:parseFloat(o)||0,etapa:a,fecha_cierre_estimada:n||null,notas:i})}),document.getElementById("modal-oportunidad").remove(),mostrarPipeline()}catch{alert("Error guardando oportunidad")}};async function pe(e,t=!1){const o=document.getElementById("content");try{const n=await(await fetch(f+"/productos/")).json(),i=n.filter(c=>c.activo),s=n.filter(c=>!c.activo),r=t?s:i;console.log("mostrarInactivos:",t,"base:",r.length,"inactivos:",s.length);const d=[...new Set(i.map(c=>c.categoria).filter(Boolean))],l=e?r.filter(c=>c.categoria===e):r;o.innerHTML=`
    ...
    `}catch{o.innerHTML='<p style="padding:2rem;color:red">Error conectando con el servidor</p>'}}window.cargarProductos=pe;window.mostrarCampanas=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando campañas...</p>';try{const[t,o]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/")]),a=await t.json(),n=await o.json(),i=new Date,s=new Date(i-30*24*60*60*1e3),r=new Date(i-90*24*60*60*1e3),d=a.map(p=>{const m=n.filter(v=>v.cliente_id===p.id&&(v.status==="confirmado"||v.status==="pagado")),g=m.reduce((v,$)=>v+parseFloat($.total||0),0),u=m.length>0?new Date(m[0].created_at):null,b=u?Math.floor((i-u)/(1e3*60*60*24)):null,y=m.filter(v=>new Date(v.created_at)>=s).length;let x="nuevo";return m.length===0?x="nuevo":g>=5e3&&y>=1?x="vip":b>90?x="inactivo":b>30?x="riesgo":y>=2?x="frecuente":x="activo",{...p,totalGastado:g,diasSinComprar:b,segmento:x}}).filter(p=>p.telefono);window._campanaClientes=d;const l=[{id:"catalogo",nombre:"👠 Catálogo completo",descripcion:"Envía el catálogo completo de productos",mensaje:p=>`Hola ${p}! 👋
...
⚠️ Requiere que los productos estén en el catálogo de Meta Commerce.`;else if(d.style.background="#e8f5e9",d.style.borderColor="#a5d6a7",d.style.color="#333",o){let b;t==="personalizado"?b=(((u=document.getElementById("texto-personalizado"))==null?void 0:u.value)||"").replace("{nombre}","María"):b=o.mensaje("María"),d.textContent=b}}const l=document.getElementById("campana-count");l&&(l.textContent=i.length+" clientes");const c=document.getElementById("campana-lista");if(c){if(!i.length){c.innerHTML='<div style="padding:2rem;text-align:center;color:#888;font-size:0.85rem">No hay clientes en este segmento con teléfono registrado</div>';return}window._campanaFiltrados=i,window._campanaPlantillaId=t,c.innerHTML=i.map((b,y)=>{var E;let x;t==="personalizado"?x=(((E=document.getElementById("texto-personalizado"))==null?void 0:E.value)||"").replace("{nombre}",b.nombre.split(" ")[0]):x=o.mensaje(b.nombre.split(" ")[0]);const v=encodeURIComponent(x),$=(b.lada||"52")+b.telefono.replace(/\D/g,"");return`
    ...
    <div style="background:white;border-radius:16px;padding:2rem;max-width:440px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.3);text-align:center">
      ...
      <p style="font-size:0.82rem;color:#888">Conectando con WhatsApp Business</p>
        ...
        </div>`};window._campanaJobId=u;const x=setInterval(async()=>{try{const $=await(await fetch(f+"/campanas/estado/"+u)).json();y($),$.terminado&&(clearInterval(x),window._campanaUltimosResultados=$.resultados||[],setTimeout(()=>{const E=$.enviados||0,h=$.fallidos||0;l.innerHTML=`
    ...
    `};window._campanaAvanzar=()=>{if(s++,s>=i.length){r.innerHTML=`
      ...
      `;return}d()},d(),document.body.appendChild(r)};async function Be(){const e=document.getElementById("content");try{const[t,o]=await Promise.all([fetch(f+"/clientes/"),fetch(f+"/pedidos/")]),a=await t.json(),n=await o.json(),i=new Date,s=new Date(i-30*24*60*60*1e3),r=new Date(i-90*24*60*60*1e3),d=a.map(u=>{const b=n.filter(w=>w.cliente_id===u.id&&(w.status==="confirmado"||w.status==="pagado")),y=b.reduce((w,C)=>w+parseFloat(C.total||0),0),x=b.length>0?new Date(b[0].created_at):null,v=b.filter(w=>new Date(w.created_at)>=s).length,$=x?Math.floor((i-x)/(1e3*60*60*24)):null;let E="nuevo",h="⚪ Nuevo",P="#f5f5f5",L="#888";return b.length===0?(E="nuevo",h="⚪ Sin compras",P="#f5f5f5",L="#888"):y>=5e3&&v>=1?(E="vip",h="⭐ VIP",P="#fff8e1",L="#f57f17"):$>90?(E="inactivo",h="🔴 Inactivo",P="#ffebee",L="#c62828"):$>30?(E="riesgo",h="🟡 En riesgo",P="#fff8e1",L="#f57f17"):v>=2?(E="frecuente",h="🟢 Frecuente",P="#e8f5e9",L="#2e7d32"):(E="activo",h="🔵 Activo",P="#e3f2fd",L="#1565c0"),{...u,totalGastado:y,ultimoPedido:x,pedidos30:v,diasSinComprar:$,segmento:E,segmentoLabel:h,segmentoBg:P,segmentoColor:L,totalPedidos:b.length}}).sort((u,b)=>b.totalGastado-u.totalGastado),l=d.filter(u=>u.segmento==="vip").length,c=d.filter(u=>u.segmento==="inactivo").length,p=d.filter(u=>u.segmento==="riesgo").length,m=d.filter(u=>u.segmento==="frecuente"||u.segmento==="activo").length,g=d.filter(u=>u.origen==="tienda").length;window._clientesData=d,e.innerHTML=`
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:1.5rem">
...
${o.telefono?'<a href="https://wa.me/'+(o.lada||"52")+o.telefono.replace(/\D/g,"")+'" target="_blank" class="btn btn-secondary" style="background:#25D366;color:white;border-color:#25D366;margin-left:auto">WhatsApp</a>':""}      </div>
  ...
  `};window.guardarCliente=async e=>{const t=document.getElementById("cli-nombre").value;if(!t){alert("El nombre del cliente es obligatorio");return}const o=document.getElementById("btn-cli-guardar");o&&(o.textContent="Guardando...",o.disabled=!0);const a={nombre:t,telefono:document.getElementById("cli-telefono").value||null,email:document.getElementById("cli-email").value||null,tipo:document.getElementById("cli-tipo").value,direccion:document.getElementById("cli-direccion").value||null,lada:document.getElementById("cli-lada").value||"52",ciudad:document.getElementById("cli-ciudad").value||null,estado:document.getElementById("cli-estado").value||null,codigo_postal:document.getElementById("cli-cp").value||null,limite_credito:parseFloat(document.getElementById("cli-credito").value)||0,dias_credito:parseInt(document.getElementById("cli-dias").value)||0,comentarios_internos:document.getElementById("cli-comentarios").value||null,activo:!0};try{const n=e?"PATCH":"POST",i=e?f+"/clientes/"+e:f+"/clientes/",s=await fetch(i,{method:n,headers:{"Content-Type":"application/json"},body:JSON.stringify(a)});if(s.ok)alert("Cliente guardado correctamente"),navegarA("clientes");else{const r=await s.text();alert("Error al guardar: "+r),o&&(o.textContent="Guardar cliente",o.disabled=!1)}}catch{alert("Error conectando con el servidor"),o&&(o.textContent="Guardar cliente",o.disabled=!1)}};window.verCliente=async e=>{const t=document.getElementById("content");t.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const[o,a]=await Promise.all([fetch(f+"/clientes/"+e),fetch(f+"/pedidos/")]),n=await o.json(),i=await a.json();if(!n||n.length===0){alert("Cliente no encontrado");return}const s=n[0],r=i.filter(u=>u.cliente_id===e),d=r.filter(u=>u.status==="confirmado"||u.status==="pagado"),l=d.reduce((u,b)=>u+parseFloat(b.total||0),0),c=d.length>0?l/d.length:0,p=r.length>0?new Date(r[0].created_at):null,m=p?Math.floor((new Date-p)/(1e3*60*60*24)):null,g={};d.forEach(u=>{const b=new Date(u.created_at).toLocaleDateString("es-MX",{month:"short",year:"2-digit"});g[b]=(g[b]||0)+parseFloat(u.total||0)}),t.innerHTML=`
      <div style="max-width:900px;margin:0 auto">
        ...
        <div style="background:white;border-radius:12px;border:1px solid #eee;overflow:hidden;margin-bottom:1rem">
          ...
          ${r.length===0?'<div style="text-align:center;padding:2rem;color:#888">Sin pedidos registrados</div>':r.map(u=>{const b={confirmado:"#2e7d32",pagado:"#2e7d32",pendiente_pago:"#f57f17",cancelado:"#c62828",borrador:"#f57f17"}[u.status]||"#888",y={confirmado:"#e8f5e9",pagado:"#e8f5e9",pendiente_pago:"#fff8e1",cancelado:"#ffebee",borrador:"#fff8e1"}[u.status]||"#f5f5f5";return`
  ...
  `};window.guardarSalida=async()=>{const e=document.getElementById("sal").value,t=document.getElementById("sal-sucursal").value,o=document.getElementById("sal-cantidad").value,a=document.getElementById("sal-motivo").value;if(!e||!t||!o){alert("Por favor completa todos los campos");return}try{const i=await(await fetch(f+"/movimientos/entrada",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({variante_id:e,sucursal_id:t,cantidad:-parseInt(o),motivo:a})})).json();i.ok?(alert("Salida registrada. Anterior: "+i.cantidad_anterior+" pares ÔåÆ Nuevo: "+i.cantidad_nueva+" pares"),navegarA("inventario")):alert("Error: "+JSON.stringify(i))}catch{alert("Error conectando con el servidor")}};window.mostrarInventarioMasivo=async()=>{const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando...</p>';try{const o=await(await fetch(f+"/sucursales/")).json(),n=await(await fetch(f+"/productos/")).json(),s=await(await fetch(f+"/variantes/")).json(),d=await(await fetch(f+"/inventario/")).json(),l=[...new Set(n.map(p=>p.categoria).filter(Boolean))],c=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"];window._invMasivo={sucursales:o,productos:n,variantes:s,inventario:d},e.innerHTML=`
    ...
    `,renderTablasMasivo()}catch{e.innerHTML='<p style="padding:2rem;color:red">Error cargando inventario</p>'}};window.renderTablasMasivo=()=>{const{productos:e,variantes:t,inventario:o}=window._invMasivo,a=document.getElementById("im-sucursal").value,n=document.getElementById("im-categoria").value,i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],s=e.filter(c=>!(n&&c.categoria!==n)),r=o.filter(c=>c.sucursal_id===a),d=s.map(c=>{const p=t.filter(u=>u.producto_id===c.id);if(p.length===0)return"";const g=[...new Set(p.map(u=>u.color).filter(Boolean))].map(u=>{const b=p.filter(x=>x.color===u).sort((x,v)=>i.indexOf(x.talla)-i.indexOf(v.talla));return`
        <div style="margin-bottom:1rem">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap">
            ${b.map(x=>{const v=r.find(P=>P.variante_id===x.id),$=v?v.cantidad:0,E=v?v.stock_minimo:3;let h="#ddd";return $===0?h="#ffcdd2":$<=E?h="#ffe082":h="#a5d6a7",`
                <div style="text-align:center">
  ...
  `,document.body.appendChild(o),o.addEventListener("click",a=>{a.target===o&&o.remove()})};window.confirmarEnvio=async function(e){const t=document.getElementById("env-paqueteria").value,o=document.getElementById("env-guia").value.trim(),a=document.getElementById("env-error"),n=document.getElementById("btn-confirmar-envio");if(!t||!o){a.textContent="Selecciona paquetería e ingresa el número de guía.",a.style.display="block";return}n.disabled=!0,n.textContent="Guardando...",a.style.display="none";try{const i=await fetch(f+`/pedidos/${e}/marcar-enviado`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({paqueteria:t,numero_guia:o})}),s=await i.json();if(!i.ok)throw new Error(s.error||"Error al guardar");try{const r=await fetch(f+"/pedidos/"+e).then(c=>c.json()),d=r.telefono_cliente,l=(r.nombre_cliente||"Cliente").split(" ")[0];d&&await fetch(f+"/chatbot/templates/enviar",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({telefono:d,template:"aviso_envio",params:[l,String(e).slice(-6),o,t]})})}catch{}document.getElementById("modal-envio").remove(),mostrarToast("✅ Pedido enviado — WhatsApp de tracking enviado al cliente"),await Oe()}catch(i){a.textContent=i.message,a.style.display="block",n.disabled=!1,n.textContent="Confirmar envío ✓"}};async function Oe(){const e=document.getElementById("content");try{const o=await(await fetch(f+"/pedidos/")).json(),a=new Date,n=new Date(a.getFullYear(),a.getMonth(),a.getDate()),i=new Date(a-7*24*60*60*1e3),s=o.filter(u=>u.status!=="cancelado"&&u.status!=="borrador"),r=s.filter(u=>new Date(u.created_at)>=n),d=r.reduce((u,b)=>u+parseFloat(b.total||0),0),l=s.filter(u=>new Date(u.created_at)>=i).reduce((u,b)=>u+parseFloat(b.total||0),0),c=o.filter(u=>u.status==="pendiente_pago").length,p=o.filter(u=>u.status==="pagado"&&u.mp_preference_id).length,m=o.filter(u=>u.forma_pago==="credito"&&u.status!=="cancelado").length,g=(u,b,y,x,v,$,E)=>`
      <div style="background:${v};border-radius:14px;padding:1.1rem 1.25rem;border:1px solid ${$};cursor:${E?"pointer":"default"};transition:transform 0.15s,box-shadow 0.15s"
        ...
        <p style="font-size:1.55rem;font-weight:800;color:${x};line-height:1;margin-bottom:3px;letter-spacing:-0.5px">${u}</p>
        <p style="font-size:0.7rem;font-weight:600;color:${x};opacity:0.85;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:1px">${b}</p>
      ...
      <div style="margin-bottom:1.25rem">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:10px;margin-bottom:16px">
          ...
          ${g("$"+Math.round(l/1e3)+"k","7 días",`${s.filter(u=>new Date(u.created_at)>=i).length} pedidos`,"#7c3aed","#f5f3ff","#ddd6fe","")}
  ...
  `).join(""),o.style.display="block"};window.seleccionarClientePOS=(e,t)=>{document.getElementById("pos-cliente").value=e,document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-resultados").style.display="none";const o=document.getElementById("pos-cliente-seleccionado");o.textContent="✔ "+t+" — toca para cambiar",o.style.display="block"};window.limpiarClientePOS=()=>{document.getElementById("pos-cliente").value="",document.getElementById("pos-cliente-seleccionado").style.display="none",document.getElementById("pos-cliente-buscar").value="",document.getElementById("pos-cliente-buscar").focus()};window.renderProductosPOS=e=>{const{variantes:t,inventario:o}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=o.filter(s=>s.sucursal_id===a),i=document.getElementById("pos-productos-grid");i&&(i.innerHTML=e.filter(s=>s.activo).map(s=>{const r=t.filter(c=>c.producto_id===s.id),d=[...new Set(r.map(c=>c.color).filter(Boolean))],l=r.reduce((c,p)=>{const m=n.find(g=>g.variante_id===p.id);return c+(m?m.cantidad:0)},0);return`
    ...
    <div style="background:white;border-radius:16px;max-width:640px;width:100%;height:90vh;display:flex;flex-direction:column;overflow:hidden">
      ...
      <div style="padding:1rem 1.5rem;border-bottom:1px solid #eee">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
          ${l.map(p=>{const m=d.find(u=>u.color===p),g=d.filter(u=>u.color===p).reduce((u,b)=>{const y=r.find(x=>x.variante_id===b.id);return u+(y?y.cantidad:0)},0);return`
  ...
  `,document.body.appendChild(c),c.addEventListener("click",p=>{p.target===c&&c.remove()}),window._posSeleccion={productoId:e,color:null},window._posBuffer={}};window.mostrarCorridaModalPOS=e=>{const{variantes:t,inventario:o}=window._posData,a=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",n=o.filter(p=>p.sucursal_id===a),i=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],s=[...new Set(t.filter(p=>p.producto_id===e).map(p=>p.color).filter(Boolean))],r=document.querySelector(`button[onclick="mostrarCorridaModalPOS('${e}')"]`);r&&(r.style.display="none"),document.querySelectorAll("#pos-modal").forEach(p=>{p!==document.getElementById("pos-modal")&&p.remove()}),window._posSeleccion.color=null,window._corridaCantidades={};const d=document.getElementById("pos-tallas-panel");if(!d)return;const l=p=>{const m=t.filter(g=>g.producto_id===e&&g.color===p).sort((g,u)=>i.indexOf(g.talla)-i.indexOf(u.talla));m.filter(g=>{const u=n.find(b=>b.variante_id===g.id);return u&&u.cantidad>0}),d.innerHTML=`
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:16px">
        ${s.map(g=>{const u=t.find(v=>v.producto_id===e&&v.color===g),b=u?u.color_hex:"#888",y=u?u.foto_url:null,x=Object.entries(window._corridaCantidades).filter(([v])=>t.find($=>$.id===v&&$.color===g)).reduce((v,[,$])=>v+$,0);return`
          ...
          `}).join("")}
           ...
           <div style="display:flex;flex-direction:column;gap:8px">
        ${m.map(g=>{const u=n.find(x=>x.variante_id===g.id),b=u?u.cantidad:0,y=window._corridaCantidades[g.id]||0;return`
  ...
  `};window.seleccionarTallaPOS=(e,t)=>{window._posSeleccion.talla=t,window._posSeleccion.varianteId=e,document.querySelectorAll('[id^="pos-talla-"]').forEach(n=>{n.style.borderColor="#ddd",n.style.background="white",n.style.color="#333"});const o=document.getElementById("pos-talla-"+t.replace(".","_"));o&&(o.style.borderColor="#E91E8C",o.style.background="#fce4f3",o.style.color="#E91E8C");const a=document.getElementById("pos-btn-agregar");a&&(a.textContent="+ Agregar al carrito",a.disabled=!1)};window.agregarAlCarritoPOS=e=>{const{productos:t,variantes:o}=window._posData,{varianteId:a,color:n,talla:i}=window._posSeleccion;if(!a||!n||!i)return;const s=t.find(d=>d.id===e);if(!s)return;const r=window._posCarrito.find(d=>d.variante_id===a);r?r.cantidad++:window._posCarrito.push({variante_id:a,producto_id:e,nombre:s.nombre,color:n,talla:i,cantidad:1,precio_menudeo:parseFloat(s.precio_menudeo)||0,precio_mayoreo3:parseFloat(s.precio_mayoreo3)||parseFloat(s.precio_menudeo)-30,precio_mayoreo6:parseFloat(s.precio_mayoreo6)||parseFloat(s.precio_menudeo)-70,precio_corrida:parseFloat(s.precio_corrida)||parseFloat(s.precio_menudeo)-100,imagen:s.imagen_principal||null,es_oferta:s.es_oferta||!1,precio_unitario:parseFloat(s.precio_menudeo)||0}),document.getElementById("pos-modal").remove(),renderCarritoPOS()};window.agregarCorridaPOS=e=>{const{productos:t,variantes:o,inventario:a}=window._posData,{color:n}=window._posSeleccion;if(!n){alert("Selecciona un color primero");return}t.find(m=>m.id===e);const i=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",s=a.filter(m=>m.sucursal_id===i),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=o.filter(m=>m.producto_id===e&&m.color===n).sort((m,g)=>r.indexOf(m.talla)-r.indexOf(g.talla)),c=document.getElementById("pos-modal").querySelector("div > div:last-child"),p=`
    <div style="background:#f3e5f5;border-radius:8px;padding:1rem;margin-top:1rem;border:1px solid #ce93d8">
      ...
      <div style="display:flex;flex-direction:column;gap:6px">
        ${d.map(m=>{const g=s.find(b=>b.variante_id===m.id),u=g?g.cantidad:0;return`
            <div style="display:flex;align-items:center;gap:8px">
...
`).join("")}
    `;const d=document.getElementById("pos-total"),l=document.getElementById("pos-total-pares"),c=document.getElementById("pos-tipo-precio");d&&(d.textContent="$"+a.toFixed(2)),l&&(l.textContent=o),c&&(c.textContent=n);const p=document.getElementById("pos-flotante-pares"),m=document.getElementById("pos-flotante-total");p&&(p.textContent=o+" pares"),m&&(m.textContent="$"+a.toFixed(2)),(g=document.getElementById("pos-drawer"))!=null&&g.classList.contains("open")&&renderDrawerPOS()};window.editarPrecioPOS=(e,t)=>{if(!window._posCarrito[e])return;const o=parseFloat(t);if(!o||o<=0){alert("El precio debe ser mayor a $0");return}window._posCarrito[e].precio_unitario=o,window._posCarrito[e].precio_manual=!0;const a=window._posCarrito[e].cantidad,n=document.getElementById("subtotal-item-"+e);n&&(n.textContent="$"+(a*o).toFixed(2));const i=window._posCarrito.reduce((r,d)=>r+d.cantidad*d.precio_unitario,0),s=document.getElementById("pos-total");s&&(s.textContent="$"+i.toFixed(2))};window.editarPrecioCorridaPOS=(e,t)=>{const[o,a]=e.split("|"),n=parseFloat(t);if(!n||n<=0){alert("El precio debe ser mayor a $0");return}window._posCarrito.forEach(c=>{c.producto_id===o&&c.color===a&&c.es_corrida&&(c.precio_unitario=n,c.precio_manual=!0)});const s=window._posCarrito.filter(c=>c.producto_id===o&&c.color===a&&c.es_corrida).reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),r=document.getElementById("subtotal-corrida-"+e.replace("|","-"));r&&(r.textContent="$"+s.toFixed(2));const d=window._posCarrito.reduce((c,p)=>c+p.cantidad*p.precio_unitario,0),l=document.getElementById("pos-total");l&&(l.textContent="$"+d.toFixed(2))};window.editarCorridaEnCarrito=e=>{const[t,o]=e.split("|"),{inventario:a,variantes:n}=window._posData,i=document.getElementById("pos-sucursal")?document.getElementById("pos-sucursal").value:"",s=a.filter(c=>c.sucursal_id===i),r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=n.filter(c=>c.producto_id===t&&c.color===o).sort((c,p)=>r.indexOf(c.talla)-r.indexOf(p.talla)),l=document.createElement("div");l.id="pos-modal-editar-corrida",l.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;display:flex;align-items:center;justify-content:center;padding:1rem",l.innerHTML=`
    <div style="background:white;border-radius:16px;max-width:400px;width:100%;padding:1.5rem;max-height:90vh;overflow-y:auto">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${d.map(c=>{const p=s.find(b=>b.variante_id===c.id),m=p?p.cantidad:0,g=window._posCarrito.find(b=>b.variante_id===c.id&&b.es_corrida),u=g?g.cantidad:0;return`
            <div style="display:flex;align-items:center;gap:10px">
...
`+((l==null?void 0:l.message)||l)),[e,t].forEach(c=>{c&&(c.disabled=!1,c.textContent="Cobrar")})}};window.imprimirTicketPOS=async(e,t,o,a)=>{const i=await(await fetch(f+"/pedidos/"+e)).json();if(!i||i.length===0)return;const s=i[0],r=s.pedido_items||[],d=s.clientes||{},l=new Date().toLocaleString("es-MX"),c=window.open("","_blank","width=400,height=600");c.document.write(`
    ...
    <body>
      ...
      <div class="divider"></div>
      ${(()=>{const p={};return r.forEach(m=>{const g=m.variantes||{},u=g.productos||{},b=(u.nombre||"—")+"|"+(g.color||"");p[b]||(p[b]={nombre:u.nombre||"—",color:g.color||"",cantidad:0,subtotal:0}),p[b].cantidad+=m.cantidad,p[b].subtotal+=parseFloat(m.subtotal)||m.cantidad*m.precio_unitario}),`
...
<td>
  ...
  <button class="btn btn-secondary" style="padding:4px 8px;font-size:0.72rem;color:#c62828;border-color:#c62828" 
    ...
    Cancelar
        ...
        </tr>`}).join(""))};async function it(){try{const t=await(await fetch(f+"/pedidos/")).json(),a=await(await fetch(f+"/clientes/")).json(),i=await(await fetch(f+"/inventario/alertas")).json(),s=new Date;s.setHours(0,0,0,0);const r=new Date(s);r.setDate(r.getDate()-7);const d=new Date(s);d.setDate(d.getDate()-30);const l=t.filter(k=>["confirmado","pagado","enviado"].includes(k.status)),c=l.filter(k=>new Date(k.created_at)>=s),p=l.filter(k=>new Date(k.created_at)>=r),m=c.reduce((k,M)=>k+parseFloat(M.total||0),0),g=p.reduce((k,M)=>k+parseFloat(M.total||0),0),u=a.filter(k=>k.created_at&&new Date(k.created_at)>=d).length,b=["Dom","Lun","Mar","Mie","Jue","Vie","Sab"],y={};b.forEach(k=>y[k]=0),l.filter(k=>new Date(k.created_at)>=d).forEach(k=>{const M=b[new Date(k.created_at).getDay()];y[M]+=parseFloat(k.total||0)});const x={};l.forEach(k=>{x[k.canal||"sucursal"]=(x[k.canal||"sucursal"]||0)+parseFloat(k.total||0)});const v={};l.forEach(k=>{v[k.forma_pago||"efectivo"]=(v[k.forma_pago||"efectivo"]||0)+1});const $={};l.forEach(k=>{$[k.empleado||"Admin"]=($[k.empleado||"Admin"]||0)+parseFloat(k.total||0)});const E={};l.forEach(k=>{const M=new Date(k.created_at).toLocaleDateString("es-MX",{month:"short",year:"numeric"});E[M]=(E[M]||0)+parseFloat(k.total||0)});const h={};l.forEach(k=>{k.clientes&&(h[k.clientes.nombre]=(h[k.clientes.nombre]||0)+parseFloat(k.total||0))});const P=Object.entries(h).sort((k,M)=>M[1]-k[1]).slice(0,5),L=Object.entries(y).sort((k,M)=>M[1]-k[1])[0],w=Object.entries($).sort((k,M)=>M[1]-k[1])[0];if(!document.getElementById("dashboard-contenido"))return;const q=l.filter(k=>new Date(k.created_at)>=d),z=q.reduce((k,M)=>k+parseFloat(M.total||0),0),T=[];for(let k=6;k>=0;k--){const M=new Date(s);M.setDate(M.getDate()-k);const D=M.toISOString().split("T")[0],_=M.toLocaleDateString("es-MX",{weekday:"short",day:"numeric"}),O=l.filter(F=>{var j;return(j=F.created_at)==null?void 0:j.startsWith(D)}).reduce((F,j)=>F+parseFloat(j.total||0),0);T.push({label:_,total:O,ds:D})}const I=(k,M,D,_)=>{const O=document.getElementById(k),F=document.getElementById(k+"-sub");O&&(O.textContent=M,_&&(O.style.color=_)),F&&D&&(F.textContent=D)};I("kpi-ventas-hoy","$"+m.toLocaleString("es-MX",{maximumFractionDigits:0}),c.length+" pedidos","#C8967A"),I("kpi-pedidos-hoy",c.length,"confirmados"),I("kpi-ventas-7d","$"+g.toLocaleString("es-MX",{maximumFractionDigits:0}),p.length+" pedidos"),I("kpi-ventas-30d","$"+z.toLocaleString("es-MX",{maximumFractionDigits:0}),q.length+" pedidos"),I("kpi-clientes-nuevos",u,"últimos 30 días"),I("kpi-stock-bajo",i.length,i.length>0?"⚠ reabastecer":"✓ ok",i.length>0?"#f59e0b":"#10b981"),I("kpi-mejor-dia",L?L[0]:"—",L?"$"+L[1].toLocaleString("es-MX",{maximumFractionDigits:0}):""),I("kpi-total-clientes",a.length,"registrados");const S=document.getElementById("dash-top-clientes");S&&(S.innerHTML=P.length===0?'<p style="color:var(--text-muted);font-size:0.85rem">Sin datos aun</p>':P.map(([k,M],D)=>`
        ...
        </div>`}).join("")}setTimeout(()=>{const k="#E91E8C",M="#7c3aed",D="#0891b2",_="#059669",O=["rgba(233,30,140,0.8)","rgba(124,58,237,0.8)","rgba(8,145,178,0.8)","rgba(5,150,105,0.8)","rgba(217,119,6,0.8)","rgba(220,38,38,0.8)"],F=["#E91E8C","#7c3aed","#0891b2","#059669","#d97706","#dc2626"],j={ticks:{color:"#94a3b8",font:{size:9}},grid:{color:"rgba(148,163,184,0.08)"}},G={responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:j,y:j}},A=document.getElementById("chart-tendencia");A&&window.Chart&&new Chart(A,{type:"line",data:{labels:T.map(N=>N.label),datasets:[{data:T.map(N=>N.total),borderColor:k,backgroundColor:"rgba(233,30,140,0.08)",borderWidth:2.5,pointBackgroundColor:k,pointBorderColor:"white",pointBorderWidth:2,pointRadius:5,pointHoverRadius:7,fill:!0,tension:.4}]},options:{...G,plugins:{legend:{display:!1},tooltip:{callbacks:{label:N=>" $"+N.parsed.y.toLocaleString("es-MX",{maximumFractionDigits:0})}}}}});const R=document.getElementById("chart-dias");R&&window.Chart&&new Chart(R,{type:"bar",data:{labels:b,datasets:[{data:b.map(N=>y[N]||0),backgroundColor:O,borderColor:F,borderWidth:1.5,borderRadius:6}]},options:{...G,plugins:{legend:{display:!1}}}});const V=document.getElementById("chart-canales"),H=Object.keys(x),W=Object.values(x);if(V&&window.Chart&&H.length>0){new Chart(V,{type:"doughnut",data:{labels:H,datasets:[{data:W,backgroundColor:O,borderColor:F,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"72%",plugins:{legend:{display:!1},tooltip:{callbacks:{label:Y=>` ${Y.label}: $${Y.parsed.toLocaleString("es-MX",{maximumFractionDigits:0})}`}}}}});const N=W.reduce((Y,J)=>Y+J,0),U=document.getElementById("dash-canales-lista");U&&(U.innerHTML=H.map((Y,J)=>`
...
`)[0].trim();l=y.match(/^https?:\/\/.+\.(jpg|jpeg|png|webp|gif)/i)?`<img src="${y}" style="max-width:200px;border-radius:8px;display:block;cursor:pointer" onclick="window.open('${y}')">`:`<p>${d}</p>`}else if(a.tipo==="documento_saliente"){const y=d.replace("[Documento] ","").split(" "),x=y[0]||"documento";l=`<a href="${y[1]||""}" target="_blank" class="wa-doc-link">
        ...
        <p style="margin:4px 0 0;font-size:0.72rem;color:#94a3b8">📋 Plantilla enviada</p>`;else if(a.tipo==="button_reply")l=`<p style="margin:0;color:#0891b2;font-size:0.85rem">👆 ${d.replace("[Botón] ","")}</p>`;else if(a.tipo==="list_reply")l=`<p style="margin:0;color:#0891b2;font-size:0.85rem">☰ ${d.replace("[Lista] ","")}</p>`;else if(a.tipo==="ubicacion_saliente"){const y=((b=d.match(/https:\/\/maps\.google\.com\/\?q=[\d.,]+/))==null?void 0:b[0])||"",x=d.replace("[Ubicación] ","").replace(/ https:.*/,"");l=`<a href="${y}" target="_blank" class="wa-doc-link" style="color:#0891b2;text-decoration:none">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
        ${x||"Ubicación"}</a>`}else a.tipo==="contacto_saliente"?l=`<span class="wa-doc-link" style="color:#0f172a">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
        ${d.replace("[Contacto] ","")}</span>`:a.tipo==="imagen"?l='<p style="color:#64748b;font-size:0.8rem">[Imagen recibida]</p>':l=`<p>${d}</p>`;let c="";if(i){const y=e.cliente_leyo_at?new Date(e.cliente_leyo_at):null,x=e.cliente_entrego_at?new Date(e.cliente_entrego_at):null,v=new Date(a.created_at);n===o?y&&y>=v?c=`<span class="wa-read-receipt read" title="Visto ${y.toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"})}">✓✓</span>`:x&&x>=v?c='<span class="wa-read-receipt delivered" title="Entregado">✓✓</span>':y?c='<span class="wa-read-receipt read" title="Visto">✓✓</span>':x?c='<span class="wa-read-receipt delivered" title="Entregado">✓✓</span>':c='<span class="wa-read-receipt sent" title="Enviado">✓</span>':c='<span class="wa-read-receipt sent">✓</span>'}const p=`<button class="wa-reply-btn" onclick="iniciarReply('${e.telefono}','${(a.wa_message_id||"").replace(/'/g,"")}')" title="Responder">
...
`)||"(sin contenido)",n.style.display="block";const m=document.getElementById("envio-seccion-foto");if(m){m.style.display="block";const x=m.querySelector("p");x&&(x.innerHTML=p?'<span style="font-weight:700;font-size:0.9rem">2️⃣ Foto de portada del catálogo</span> <span style="font-weight:400;color:#aaa;font-size:0.78rem">(imagen principal que verá el cliente)</span>':'<span style="font-weight:700;font-size:0.9rem">2️⃣ Foto del modelo</span> <span style="font-weight:400;color:#aaa;font-size:0.78rem">(opcional — para plantillas con imagen)</span>')}const g=document.getElementById("envio-mpm-aviso");g&&(g.style.display=p?"block":"none"),window._envioEsMPM=p,window._envioHeaderTipo=(r==null?void 0:r.format)||(r!=null&&r.text?"TEXT":"NONE");const u=(d==null?void 0:d.text)||"",b=u.match(/\{\{[\d]*\}\}/g)||[];window._envioBodyVarsCount=b.length||(u.includes("{{")?1:0);const y=document.getElementById("envio-seccion-foto");y&&(y.style.display=window._envioHeaderTipo==="IMAGE"?"block":"none"),document.querySelectorAll('input[name="envio-plantilla-radio"]').forEach(x=>{const v=x.closest("label");v&&(v.style.borderColor=x.value===e?"#E91E8C":"#eee",v.style.background=x.value===e?"#fff0f8":"")})};const Ne=e=>{const t=document.getElementById("envio-lista");t&&(t.innerHTML=e.map(o=>{var i;const a=(i=window._envioSeleccionados)==null?void 0:i.has(o.telefono),n=o.telefono.replace(/\D/g,"");return`<label style="display:flex;align-items:center;gap:10px;padding:8px 10px;border-radius:8px;cursor:pointer;border:1.5px solid ${a?"#E91E8C":"#f0f0f0"};background:${a?"#fff0f8":"white"}" id="envio-row-${n}">
    ...
    </div>`,document.body.appendChild(l);const c=l.querySelector("#envio-progress-bar");l.querySelector("#envio-progress-txt"),c&&(c.style.width="15%");try{const u=await(await fetch(f+"/chatbot/envio-masivo",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({plantilla:n,idioma:i,imagen_url:s,contactos:o,skus_mpm:d,body_vars_count:window._envioBodyVarsCount||0,header_tipo:window._envioHeaderTipo||"NONE"})})).json();if(u.error){l.innerHTML=`<div style="background:white;border-radius:16px;padding:2.5rem;max-width:400px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
                ...
                <tbody>
                  ${i.map(l=>{const c=l.nombre_cliente||"—",p=l.email_cliente||"",m=l.telefono_cliente||"",g=l.horas_pendiente!=null?l.horas_pendiente<1?"hace &lt;1h":`hace ${l.horas_pendiente}h`:"—",u=!!l.recordatorio_pago_enviado_at;return`<tr data-pedido-id="${l.id}" style="border-bottom:1px solid var(--border)">
                      ...
                      <td style="padding:10px 14px">
                        ...
                        ${u?`<div style="font-size:0.68rem;color:#aaa;margin-top:4px">Avisado ${s(l.recordatorio_pago_enviado_at)}</div>`:""}
                      </td>
                    </tr>`}).join("")}
                </tbody>
              </table>
...
Cuando realices el pago lo procesamos de inmediato. Si tienes alguna duda estamos para ayudarte 😊`;(c=document.getElementById("modal-recordatorio"))==null||c.remove();let r="",d=[];if(i){try{d=await(await fetch(f+"/chatbot/plantillas")).json(),Array.isArray(d)||(d=[])}catch{d=[]}d.length?r=`
        ...
        </div>`:r=`<div style="background:#fff3cd;border:1px solid #ffc107;border-radius:8px;padding:10px 12px;margin-bottom:10px;font-size:0.78rem;color:#856404">
  ...
  <div style="display:flex;gap:1rem;flex-wrap:wrap">
    ...
    <div class="table-card">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(130px,1fr));gap:8px;max-height:460px;overflow-y:auto;padding:4px">
        ${n.map((r,d)=>{const l=i.filter(g=>g.producto_id===r.id),c=r.precio_menudeo||0,p=s[d],m=p.length>1?`<div id="gen-colores-${d}" style="display:flex;flex-wrap:wrap;gap:3px;margin-top:5px;opacity:0.35;pointer-events:none">
                ${p.map((g,u)=>`
                  <div id="gen-col-${d}-${u}"
                       title="${g.color}"
...
... y ${g.total-1} variantes más con la misma estructura.`,n.textContent=y}else{const u=((c=g.resultados)==null?void 0:c.filter(x=>x.status==="publicado"))||[],b=((p=g.resultados)==null?void 0:p.filter(x=>x.status==="error"))||[];let y=`=== RESULTADO — ${g.producto} ===
`;y+=`✅ Publicados: ${u.length}   ❌ Errores: ${b.length}

`,u.length&&(y+=`PUBLICADOS:
`,u.forEach(x=>{y+=`  ${x.sku} → ${x.item_id}
  ${x.permalink||""}
`})),b.length&&(y+=`
ERRORES:
`,b.forEach(x=>{var v;y+=`  ${x.sku}  [${x.codigo}] ${x.error}
`,(v=x.causas)!=null&&v.length&&x.causas.forEach($=>{y+=`    ↳ ${$.code}: ${$.message}
`})})),n.textContent=y}}catch(m){n.style.display="block",n.textContent="Error inesperado: "+m.message}finally{t.innerHTML=i,t.disabled=!1}}window.mlPublicarPreview=function(e){Ge(!0,e)};window.mlPublicarReal=function(e){confirm("¿Publicar TODAS las variantes activas de este producto en MercadoLibre? Esto creará nuevos items en tu cuenta.")&&Ge(!1,e)};window.descargarExcelTikTok=async function(e,t,o){const a=e.innerHTML;try{e.innerHTML="⏳ Generando...",e.disabled=!0;const n=await fetch(`${f}/tiktok/${t}`);if(!n.ok){const d=await n.text();throw new Error(`Error ${n.status}: ${d}`)}const i=await n.blob(),s=URL.createObjectURL(i),r=document.createElement("a");r.href=s,r.download=o,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(s)}catch(n){alert("Error al descargar el archivo: "+n.message)}finally{e.innerHTML=a,e.disabled=!1}};async function ct(){const e=document.getElementById("content");e.innerHTML=`
  ...
  `,document.getElementById("ml-titulo").addEventListener("input",function(){document.getElementById("ml-titulo-count").textContent=this.value.length}),window.mlGenerarPreview=async()=>{var d,l,c,p;const o=document.getElementById("ml-sku").value.trim().toUpperCase(),a=document.getElementById("ml-listing").value,n=document.getElementById("ml-titulo").value.trim(),i=document.getElementById("ml-precio").value.trim(),s=i?parseFloat(i):null;if(!o){alert("Ingresa el SKU del producto");return}if(!n){alert("Ingresa el título para ML");return}if(n.length>60){alert("El título no puede superar 60 caracteres");return}if(s!==null&&(isNaN(s)||s<=0)){alert("El precio debe ser mayor a 0");return}const r=document.getElementById("ml-btn-preview");r.textContent="⏳ Generando...",r.disabled=!0;try{const m=await fetch(`${f}/ml/publicar`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sku_interno:o,listing_type:a,solo_preview:!0})}),g=await m.json();if(!m.ok){alert("Error: "+(g.detail||JSON.stringify(g)));return}const u=g.resultados||[];if(!u.length){alert("No se encontraron variantes activas");return}const b=document.getElementById("ml-descripcion"),y=((c=(l=(d=u[0])==null?void 0:d.preview)==null?void 0:l.description)==null?void 0:c.plain_text)||"";b.value.trim()||(b.value=y);const x={},v=[],$=new Set;for(const C of u){const q=C.color||"Sin color";x[q]||(x[q]=[]);for(const z of((p=C.preview)==null?void 0:p.pictures)||[])z.source&&(x[q].find(T=>T.source===z.source)||x[q].push(z),$.has(z.source)||($.add(z.source),v.push(z)))}const E={},h=new Set;for(const C of Object.keys(x))E[C]=0,h.add(C);const P=Object.keys(x);if(P.length>0){const C=document.getElementById("ml-fotos-wrap"),q=document.getElementById("ml-fotos-grid"),z=()=>{T();const I=u.filter(S=>h.has(S.color||"Sin color"));t(I,n,s,E,b.value.trim(),x)},T=()=>{q.innerHTML=P.map(I=>{const S=x[I];if(!S.length)return"";const B=h.has(I),k=I.replace(/'/g,"\\'"),M=I.replace(/[^a-zA-Z0-9]/g,"_");return`
              ...
              </div>`}).join("")};T(),C.style.display="block",window.mlToggleColor=I=>{h.has(I)?h.delete(I):h.add(I),z()},window.mlSeleccionarPortadaColor=(I,S)=>{E[I]=S,z()}}const L=u.filter(C=>h.has(C.color||"Sin color"));t(L,n,s,E,b.value.trim(),x);const w=document.getElementById("ml-variantes-wrap");w.style.display="block",w.scrollIntoView({behavior:"smooth",block:"start"})}catch(m){alert("Error de conexión: "+m.message)}finally{r.textContent="🔍 Generar preview",r.disabled=!1}};function t(o,a,n,i,s,r){const d=document.getElementById("ml-variantes-titulo"),l=document.getElementById("ml-variantes-list");d.textContent=`Paso 2 — Revisa y edita (${o.length} variantes, título aplicado a todas)`,l.innerHTML=o.map((c,p)=>{const m={...c.preview,family_name:a};if(delete m.title,n!==null&&(m.price=n),s&&(m.description={plain_text:s}),r){const g=c.color||"Sin color",u=r[g]||[],b=i&&i[g]||0;let y=[...u];if(b>0&&b<y.length){const[x]=y.splice(b,1);y.unshift(x)}if(y.length<3&&r){for(const[x,v]of Object.entries(r))if(x!==g){for(const $ of v)if(y.find(E=>E.source===$.source)||y.push($),y.length>=12)break;if(y.length>=12)break}}m.pictures=y.slice(0,12)}return`
  ...
  `,await ut(),oe=setInterval(async()=>{document.getElementById("ga-activos")?await Ue():(clearInterval(oe),oe=null)},3e4)}async function we(e,t=8e3){const o=new AbortController,a=setTimeout(()=>o.abort(),t);try{const n=await fetch(e,{signal:o.signal});return clearTimeout(a),n}catch(n){throw clearTimeout(a),n.name==="AbortError"?new Error("timeout"):n}}async function ut(){const e=[Ue().catch(()=>ue("ga-activos","—")),gt().catch(()=>ue("ga-sesiones","—")),ft().catch(()=>ue("ga-chart",null))];await Promise.allSettled(e);const t=document.getElementById("ga-ultima-act");t&&(t.textContent="Actualizado: "+new Date().toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit",second:"2-digit"}))}function ue(e,t){const o=document.getElementById(e);o&&t!==null&&(o.textContent=t)}async function Ue(){var e;try{const o=await(await we(`${f}/analytics/tiempo-real`)).json();if(!o.configurado){bt(o);return}const a=document.getElementById("ga-activos");if(!a)return;a.textContent=o.activos_ahora??0;const n=document.getElementById("ga-dispositivos");n&&o.por_dispositivo&&(n.textContent=Object.entries(o.por_dispositivo).map(([s,r])=>`${s}: ${r}`).join(" · "));const i=document.getElementById("ga-paginas-rt");i&&((e=o.por_pais)!=null&&e.length)?i.innerHTML='<div style="font-size:0.65rem;color:#aaa;margin-bottom:4px;text-transform:uppercase;letter-spacing:.05em">Por país</div>'+o.por_pais.map(s=>`
...
Nuevo monto:`,o);if(a===null)return;const n=parseFloat(a);if(isNaN(n)||n<0)return alert("Monto inválido");try{(await fetch(f+"/clientes/"+e,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({credito_disponible:n})})).ok?await $e():alert("Error actualizando crédito")}catch(i){alert("Error: "+i.message)}};async function Ee(){const e=document.getElementById("content");e.innerHTML='<p style="padding:2rem;color:#888">Cargando carritos...</p>';try{const[t,o,a]=await Promise.all([fetch(f+"/pedidos/?status=borrador").then(i=>i.json()).catch(()=>[]),fetch(f+"/clientes/").then(i=>i.json()),fetch(f+"/sucursales/").then(i=>i.json())]),n=Array.isArray(t)?t.filter(i=>i.status==="borrador"&&(!i.canal||i.canal==="sucursal"||i.canal==="mayoreo")):[];e.innerHTML=`
    ...
    <div style="max-width:860px">
      ...
      <div class="table-card" style="padding:1.2rem">
        ...
        <div id="carrito-items-lista">
          ...
          ${(()=>{const m={};return a.forEach((g,u)=>{const b=g.variantes||{},y=b.productos||{},x=y.nombre||g.nombre||"—",v=b.color||g.color||"",$=!!g.es_corrida,E=$?"c|"+x+"|"+v:"s|"+g.id;m[E]||(m[E]={nombre:x,color:v,esCorrida:$,items:[],imagen:b.foto_url||y.imagen_principal||null}),m[E].items.push({...g,_idx:u})}),Object.values(m).map(g=>{const u=g.esCorrida,b=g.imagen;if(u){const y=g.items.reduce((E,h)=>E+h.cantidad,0),x=g.items.reduce((E,h)=>E+h.cantidad*h.precio_unitario,0),v=(x/y).toFixed(2),$=g.items.map(E=>E.id).join(",");return`
                  <div style="background:#fdf4ff;border-radius:8px;padding:12px;margin-bottom:8px;border:1px solid #e8d5f5">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px">
                      <span id="corrida-header-${$.replace(/,/g,"_").substring(0,20)}" style="font-size:0.85rem;color:#888">${y} pares · <strong style="color:#6a1b9a">$${x.toFixed(2)}</strong></span>
                      <div style="display:flex;align-items:center;gap:4px">
                        <span style="font-size:0.72rem;color:#888">$</span>
                  ...
                  </div>`}else{const y=g.items[0],x=y.variantes||{};x.productos;const v=x.talla||y.talla||"",$=s.find(h=>h.variante_id===y.variante_id&&(r?h.sucursal_id===r:!0)),E=$?$.cantidad:null;return`
  ...
  `).join("")};window.seleccionarModeloCorrida=(e,t)=>{const{variantes:o,productos:a,inventario:n,sucursalId:i}=window._carritoActivo,s=a.find(m=>m.id===e);document.getElementById("c-buscar-corrida").value=`${(s==null?void 0:s.nombre)||""} · ${t}`,document.getElementById("c-corrida-resultados").style.display="none";const r=["22","22.5","23","23.5","24","24.5","25","25.5","26","26.5","27","Unica"],d=o.filter(m=>m.producto_id===e&&m.color===t).sort((m,g)=>r.indexOf(m.talla)-r.indexOf(g.talla)),l=parseFloat(s==null?void 0:s.precio_menudeo)||0,c=parseFloat(s==null?void 0:s.precio_corrida)||(l>0?Math.round(l-100):0);document.getElementById("c-precio-corrida").value=c||"",window._corridaSeleccionada={productoId:e,color:t,variantes:d,prod:s,precioCorrida:c};const p=document.getElementById("c-corrida-tallas-grid");p.innerHTML=d.map(m=>{const g=n.find(y=>y.variante_id===m.id&&(i?y.sucursal_id===i:!0)),u=g?g.cantidad:null,b=u!==null&&u===0;return`
